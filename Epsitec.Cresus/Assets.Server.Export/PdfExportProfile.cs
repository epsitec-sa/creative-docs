...
namespace Epsitec.Cresus.Assets.Server.Export
{
	...
	public class PdfExportProfile : AbstractExportProfile
	{
		public PdfExportProfile(PdfStyle style, Size pageSize, Margins pageMargins, Margins cellMargins,
			double fontSize, bool automaticColumnWidths,
		...
		public static PdfExportProfile Default = new PdfExportProfile (PdfStyle.Factory (PdfPredefinedStyle.Default), new Size (297.0, 210.0), new Margins (10.0), new Margins (1.0), 10.0, false, "Crésus Immobilisations", "Epsitec SA", ".   ", "SPECIMEN");
