...
namespace Epsitec.Cresus.Core.Library.UI
{
	public static class Res
	{
		...
		public static class Strings
		{
			...
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Cresus.Core.Library.UI.Res.Strings.GetString (bundle, path));
			}
			
			private static global::Epsitec.Common.Types.FormattedText GetText(global::Epsitec.Common.Support.Druid druid)
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Cresus.Core.Library.UI.Res.Strings.GetString (druid));
			}
		...
		static Res()
		{
			...
			Res._manager.DefineDefaultModuleName ("Cresus.Core.Library.UI");
			Strings._Initialize ();
		}
		...
		private const int _moduleId = 1012;
	}
}
