    ...
    public class GeneralExceptionCatcher
    {
        public static void Setup()
        {
            ...
            System.Windows.Forms.Application.ThreadException += (sender, e) =>
                GeneralExceptionCatcher.ProcessException(e.Exception);
            System.AppDomain.CurrentDomain.UnhandledException += (sender, e) =>
                GeneralExceptionCatcher.ProcessException(e.ExceptionObject as System.Exception);
        ...
        {
            get { return GeneralExceptionCatcher.isActive; }
        }

        public static bool AbortOnException
        {
            get { return GeneralExceptionCatcher.abortOnException; }
            set { GeneralExceptionCatcher.abortOnException = value; }
        }
        ...
        private static readonly List<System.Action<System.Exception>> handlers =
            new List<System.Action<System.Exception>>();
