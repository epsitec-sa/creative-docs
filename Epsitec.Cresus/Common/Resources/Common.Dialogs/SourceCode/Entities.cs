...
namespace Epsitec.Common.Dialogs.Entities
{
    ...
    public static partial class ISearchableInterfaceImplementation
    {
        ...
        {
            global::Epsitec.Common.Support.EntityEngine.AbstractEntity entity =
                obj as global::Epsitec.Common.Support.EntityEngine.AbstractEntity;
            return entity.GetField<string>("[6016]");
        }

        public static void SetSearchValue(
            global::Epsitec.Common.Dialogs.Entities.ISearchable obj,
            string value
        )
        {
            global::Epsitec.Common.Support.EntityEngine.AbstractEntity entity =
        ...
        static partial void OnSearchValueChanged(
            global::Epsitec.Common.Dialogs.Entities.ISearchable obj,
            string oldValue,
            string newValue
        );

        static partial void OnSearchValueChanging(
            global::Epsitec.Common.Dialogs.Entities.ISearchable obj,
            string oldValue,
            string newValue
        );
