...
namespace Epsitec.Common.Text.Tests
{
    ...
    public sealed class CheckProperties
    {
        ...
        {
            Properties.FontSizeProperty fontSizeA = new Properties.FontSizeProperty(
                12.0,
                Properties.SizeUnits.Points
            );
            Properties.FontSizeProperty fontSizeB = new Properties.FontSizeProperty(
                50.0 / 100,
                Properties.SizeUnits.Percent
            );
            Properties.FontSizeProperty fontSizeC = new Properties.FontSizeProperty(
                -2.0,
                Properties.SizeUnits.DeltaPoints
            );
            Properties.FontSizeProperty fontSizeD = new Properties.FontSizeProperty(
                200.0 / 100,
                Properties.SizeUnits.Percent
            );

            Properties.FontSizeProperty fontSizeAb =
                fontSizeA.GetCombination(fontSizeB) as Properties.FontSizeProperty;
            Properties.FontSizeProperty fontSizeBa =
                fontSizeB.GetCombination(fontSizeA) as Properties.FontSizeProperty;
            Properties.FontSizeProperty fontSizeAc =
                fontSizeA.GetCombination(fontSizeC) as Properties.FontSizeProperty;
            Properties.FontSizeProperty fontSizeCb =
                fontSizeC.GetCombination(fontSizeB) as Properties.FontSizeProperty;
            Properties.FontSizeProperty fontSizeBd =
                fontSizeB.GetCombination(fontSizeD) as Properties.FontSizeProperty;
        ...
        private static void TestMargins()
        {
            ...
            Properties.MarginsProperty marginsB = new Properties.MarginsProperty(
                15.0,
                20.0,
                0.0,
                0.0,
            ...
            Properties.MarginsProperty marginsC =
                marginsA.GetCombination(marginsB) as Properties.MarginsProperty;
            Properties.MarginsProperty marginsD =
                marginsB.GetCombination(marginsA) as Properties.MarginsProperty;

            marginsA = new Properties.MarginsProperty(
                double.NaN,
                10,
                double.NaN,
                10,
            ...
            Properties.MarginsProperty marginsE =
                marginsA.GetCombination(marginsB) as Properties.MarginsProperty;
            Properties.MarginsProperty marginsF =
                marginsB.GetCombination(marginsA) as Properties.MarginsProperty;
        ...
        private static void TestXlines()
        {
            ...
            properties.Add(
                new Properties.UnderlineProperty(
                    double.NaN,
            ...
            properties.Add(
                new Properties.StrikeoutProperty(
                    double.NaN,
                    Properties.SizeUnits.None,
                    double.NaN,
                    Properties.SizeUnits.None,
            ...
            properties.Add(
                new Properties.TextBoxProperty(
                    double.NaN,
                    Properties.SizeUnits.None,
                    double.NaN,
                    Properties.SizeUnits.None,
            ...
            properties.Add(
                new Properties.OverlineProperty(
                    double.NaN,
                    Properties.SizeUnits.None,
                    2.0,
                    Properties.SizeUnits.Points,
        ...
        private static void TestSerialization()
        {
            ...
            Properties.FontSizeProperty p2 = new Properties.FontSizeProperty(
                12.0,
                Properties.SizeUnits.Points
            );
            Properties.MarginsProperty p3 = new Properties.MarginsProperty(
                15.0,
                20.0,
                0.0,
                0.0,
        ...
        private static void TestGeneratorProperties()
        {
            ...
            Cursors.GeneratorCursor[] cursors = Internal.GeneratorEnumerator.CreateCursors(
                story,
                "G1"
            );
        ...
        {
            Properties.FontSizeProperty a = new Properties.FontSizeProperty(
                80.0 / 100,
                Properties.SizeUnits.Percent
            );
            Properties.FontSizeProperty b = new Properties.FontSizeProperty(
                -5.0,
                Properties.SizeUnits.DeltaPoints
            );
