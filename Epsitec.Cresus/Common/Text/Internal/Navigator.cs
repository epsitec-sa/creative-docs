...
namespace Epsitec.Common.Text.Internal
{
    ...
    public sealed class Navigator
    {
            ...
            if (infos.Length > 0)
            {
                ...
                for (int i = 0; i < infos.Length; i++)
                {
                    Cursors.FitterCursor fitterCursor =
                        text.GetCursorInstance(infos[i].CursorId) as Cursors.FitterCursor;
        ...
        {
            if (
                Unicode.Bits.GetUnicodeCode(story.ReadChar(cursor, offset - 1))
                == Unicode.Code.LineSeparator
            )
            {
                return true;
            }
        ...
        public static void GetParagraphPositions(
            TextStory story,
            int pos,
            out int start,
            out int end
        ...
        public static void GetExtendedParagraphPositions(
            TextStory story,
            int pos,
            out int start,
            out int end
        ...
        public static int GetParagraphStartOffset(TextStory story, ICursor cursor)
        {
            ...
            TextStory.CodeCallback callback = new TextStory.CodeCallback(
                Navigator.IsParagraphSeparator
            );
        ...
        public static int GetParagraphGroupStartOffset(TextStory story, ICursor cursor, int skip)
        {
            ...
            TextStory.CodeCallback callback = new TextStory.CodeCallback(
                new ParagraphGroupStartFinder(story.TextContext, skip).Check
            );
        ...
        private class ParagraphGroupStartFinder
        {
            ...
            public bool Check(ulong code)
            {
                ...
                if (Navigator.IsParagraphSeparator(code))
                {
                    ...
                    if (
                        (keep != null) && (keep.KeepWithNextParagraph == Properties.ThreeState.True)
                    )
                    {
        ...
        public static int GetRunStartOffset(TextStory story, ICursor cursor, Property property)
        {
            ...
            Navigator.PropertyFinder finder = new PropertyFinder(
                story.StyleList,
                property,
                story.ReadChar(cursor)
            );
        ...
        public static bool GetFlattenedProperties(
            TextStory story,
            ICursor cursor,
            int offset,
        ...
        )
        {
            ...
            return Navigator.GetFlattenedProperties(
                story,
                story.ReadChar(cursor, offset),
                out properties
            );
        }
        ...
        public static bool GetFlattenedPropertiesExcludingStylesAndProperties(
            TextStory story,
            ICursor cursor,
            int offset,
            out Property[] properties
        ...
        public static bool GetManagedParagraphProperties(
            TextStory story,
            ICursor cursor,
            int offset,
            out Properties.ManagedParagraphProperty[] properties
        )
        {
            ulong code = story.ReadChar(cursor, offset);
        ...
        public static void HandleManagedParagraphPropertiesChange(
            TextStory story,
            ICursor cursor,
            int offset,
            Properties.ManagedParagraphProperty[] oldProperties,
            Properties.ManagedParagraphProperty[] newProperties
        )
        {
            ...
            if (offset != 0)
            {
                ...
                try
                {
                    Navigator.HandleManagedParagraphPropertiesChange(
                        story,
                        tempCursor,
                        0,
                        oldProperties,
            ...
            for (int i = 0; i < nOld; i++)
            {
                ...
                if (!same)
                {
                    list[oldProperties[i].ManagerName]
                        .DetachFromParagraph(story, cursor, oldProperties[i]);
                }
            }
            ...
            for (int i = 0; i < nNew; i++)
            {
                ...
                if (same)
                {
                    list[newProperties[i].ManagerName]
                        .RefreshParagraph(story, cursor, newProperties[i]);
                }
                else
                {
                    list[newProperties[i].ManagerName]
                        .AttachToParagraph(story, cursor, newProperties[i]);
                }
            }
        }

        public static bool GetParagraphStyles(
            TextStory story,
            ICursor cursor,
            int offset,
            out TextStyle[] styles
        )
        {
            ...
            int count = Properties.StylesProperty.CountMatchingStyles(
                allStyles,
        ...
        public static bool GetUniformMetaProperties(
            TextStory story,
            ICursor cursor,
            int offset,
            out TextStyle[] styles
        )
        {
            ...
            {
                if (
                    (allStyles[i].TextStyleClass == TextStyleClass.MetaProperty)
        ...
        public static bool GetParagraphProperties(
            TextStory story,
            ICursor cursor,
            int offset,
            out Property[] properties
        ...
        public static void Insert(
            ...
            ICursor cursor,
            Unicode.Code code,
            System.Collections.ICollection styles,
        ...
        )
        {
            ...
            if (
                (Navigator.GetParagraphStyles(story, cursor, offset, out paragraphStyles))
            ...
            )
            {
                ...
                story.ConvertToStyledText(
                    utf32,
                    story.FlattenStylesAndProperties(allStyles, allProperties),
                    out text
                );
        ...
        public static void SetParagraphStyles(
            TextStory story,
            ICursor cursor,
            System.Collections.ICollection styles
        )
        ...
        public static void SetSymbolStyles(
            TextStory story,
            ICursor cursor,
            int length,
            params TextStyle[] styles
        ...
        public static void SetTextStyles(
            TextStory story,
            ICursor cursor,
            int length,
            params TextStyle[] styles
        ...
        public static void SetParagraphMetaProperties(
            TextStory story,
            ICursor cursor,
            Properties.ApplyMode mode,
            params TextStyle[] metaProperties
        )
        {
        ...
        public static void SetMetaProperties(
            TextStory story,
            ICursor cursor,
            int length,
            Properties.ApplyMode mode,
        ...
        )
        {
            ...
            if (metaProperties == null)
                metaProperties = new TextStyle[0];
        ...
        public static void SetParagraphProperties(
            TextStory story,
            ICursor cursor,
            Properties.ApplyMode mode,
            params Property[] properties
        )
        {
            ...
            Navigator.SetParagraphProperties(
                story,
                cursor,
                offsetStart,
                offsetEnd,
        ...
        private static void SetParagraphStyles(
            TextStory story,
            ulong[] text,
            ulong code,
            int offset,
        ...
        )
        {
            ...
            int nParaStyles = Properties.StylesProperty.CountMatchingStyles(
                oldStyles,
                TextStyleClass.Paragraph
            );
            ...
            System.Collections.ArrayList flat = story.FlattenStylesAndProperties(
                newStyles,
                Property.Filter(properties, Properties.PropertyFilter.NonUniformOnly)
            );
        ...
        private static void SetTextProperties(
            TextStory story,
            ulong[] text,
            ulong code,
            int offset,
        ...
        )
        {
            ...
            if ((length == 0) || (mode == Properties.ApplyMode.None))
            {
                return;
            }
            ...
            System.Diagnostics.Debug.Assert(
                Properties.PropertiesProperty.ContainsPropertiesProperties(currentProperties)
                    == false
            );
            System.Diagnostics.Debug.Assert(
                Properties.PropertiesProperty.ContainsPropertiesProperties(textProperties) == false
            );
            System.Diagnostics.Debug.Assert(
                Properties.StylesProperty.ContainsStylesProperties(currentProperties) == false
            );
            System.Diagnostics.Debug.Assert(
                Properties.StylesProperty.ContainsStylesProperties(textProperties) == false
            );
            ...
            allProperties.AddRange(
                Property.Filter(currentProperties, Properties.PropertyFilter.UniformOnly)
            );
            allProperties.AddRange(
                Navigator.Combine(
                    Property.Filter(currentProperties, Properties.PropertyFilter.NonUniformOnly),
                    textProperties,
                    mode
                )
            );
        ...
        private static void SetMetaProperties(
            TextStory story,
            ulong[] text,
            ulong code,
            int offset,
            int length,
            TextStyle[] metaProperties,
            Properties.ApplyMode mode
        )
        {
            ...
            List<TextStyle> allStyles = new List<TextStyle>();
            ICollection<TextStyle> combined = Navigator.Combine(
                TextStyle.FilterStyles(currentStyles, TextStyleClass.MetaProperty),
                metaProperties,
                mode
            );
        ...
        )
        {
            ...
            System.Diagnostics.Debug.Assert(
                Properties.PropertiesProperty.ContainsPropertiesProperties(paragraphProperties)
                    == false
            );
            System.Diagnostics.Debug.Assert(
                Properties.StylesProperty.ContainsStylesProperties(currentProperties) == false
            ...
            System.Diagnostics.Debug.Assert(
                Properties.StylesProperty.ContainsStylesProperties(paragraphProperties) == false
            );
        ...
        private static void SetSymbolStyles(
            TextStory story,
            ulong[] text,
            ulong code,
            int offset,
            int length,
            TextStyle[] characterStyles
        )
        {
            ...
            TextStyle[] filteredStyles = TextStyle.FilterStyles(
                currentStyles,
                TextStyleClass.Paragraph,
                TextStyleClass.Text,
                TextStyleClass.MetaProperty
            );
        ...
        private static void SetTextStyles(
            TextStory story,
            ulong[] text,
            ulong code,
            int offset,
        ...
        internal static ICollection<Property> Combine(
            Property[] a,
            Property[] b,
            Properties.ApplyMode mode
        )
        {
            switch (mode)
            {
                case Properties.ApplyMode.Overwrite:
                    return Navigator.CombineOverwrite(a, b);
                case Properties.ApplyMode.Clear:
                    return Navigator.CombineClear(a, b);
                case Properties.ApplyMode.Set:
                    return Navigator.CombineSet(a, b);
                case Properties.ApplyMode.Combine:
                    return Navigator.CombineAccumulate(a, b);

                default:
                    throw new System.InvalidOperationException(
                        string.Format("ApplyMode.{0} not valid here.", mode)
                    );
            }
        }

        internal static ICollection<TextStyle> Combine(
            TextStyle[] a,
            TextStyle[] b,
            Properties.ApplyMode mode
        )
        ...
        private static List<Property> CombineClear(Property[] a, Property[] b)
        {
            ...
            foreach (Property p in a)
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format("Found: {0} - {1}.", p.WellKnownType, p.ToString())
                );
            }
            ...
            foreach (Property p in b)
            {
                ...
                for (int i = 0; i < list.Count; )
                {
                    ...
                    {
                        System.Diagnostics.Debug.WriteLine(
                            string.Format("Removed: {0} - {1}.", p.WellKnownType, p.ToString())
                        );
                        list.RemoveAt(i);
                    }
                    else
        ...
        private static List<Property> CombineSet(Property[] a, Property[] b)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format("Added: {0} - {1}.", p.WellKnownType, p.ToString())
                );
            }
            return list;
        }
        ...
        {
            Styles.PropertyContainer.Accumulator accumulator =
                new Styles.PropertyContainer.Accumulator();
