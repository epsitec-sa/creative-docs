...
namespace Epsitec.Common.Text.Exchange
{
    ...
    {
        public HtmlToTextWriter(
            HtmlDocument thehtmldoc,
        ...
        private void ProcessSpan(HtmlElement htmlelement)
        {
            ...
            if (style.Length > 0)
            {
                ...
                else
                {
                        ...
                        if (ptindex != -1)
                        {
                            ...
                            if (size != 0.0)
                            {
                                ...
                                if (size != 0)
                                {
                                    ...
                                    this.textWrapper.Defined.Units = Common
                                        .Text
                                        .Properties
                                        .SizeUnits
                                        .Points;
                    ...
                    {
                        Epsitec.Common.Drawing.RichColor richcolor =
                            Epsitec.Common.Drawing.RichColor.FromName(fontcolor);
                        this.textWrapper.Defined.Color = Epsitec.Common.Drawing.RichColor.ToString(
                            richcolor
                        );
                    }
        ...
        private void ProcessFont(HtmlElement element)
        {
            ...
            if (fontsize.Length > 0)
            {
                ...
                if (size != 0)
                {
                    this.textWrapper.Defined.FontSize =
                        HtmlTextOut.HtmlFontSizeToPointFontSize(size) * HtmlTextOut.FontSizeFactor;
        ...
        private void ProcessDiv(HtmlElement element)
        {
            ...
            Wrappers.JustificationMode oldjustificationmode = this.paraWrapper
                .Defined
                .JustificationMode;
    ...
    struct HtmlFontProperties
    {
        ...
        {
            get { return isUnitsDefined; }
            set { isUnitsDefined = value; }
        }

        public bool IsFontSizeDefined
        {
            get { return isFontSizeDefined; }
            set { isFontSizeDefined = value; }
        }

        public bool IsFontFaceDefined
        {
            get { return isFontFaceDefined; }
            set { isFontFaceDefined = value; }
        }

        public bool IsColorDefined
        {
            get { return isColorDefined; }
            set { isColorDefined = value; }
        }
