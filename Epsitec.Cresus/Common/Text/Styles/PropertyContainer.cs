...
namespace Epsitec.Common.Text.Styles
{
            ...
            System.Collections.IEnumerable
    {
        ...
        {
            get { return (this.properties == null) ? 0 : this.properties.Length; }
        }

        public bool IsEmpty
        {
            get { return (this.properties == null) || (this.properties.Length == 0); }
        }
        ...
        public bool Contains(Property property)
        {
            ...
            for (int i = 0; i < this.properties.Length; i++)
            {
                ...
                if (found == search)
                {
                    ...
                    if (
                        (
                            property.GetContentsSignature()
                            == this.properties[i].GetContentsSignature()
        ...
        public Property[] FindProperties(params Properties.WellKnownType[] types)
        {
            ...
            if ((this.properties != null) && (types.Length > 0))
            {
        ...
        public class Accumulator
        {
            ...
            {
                get { return this.skipSymbolProperties; }
                set { this.skipSymbolProperties = value; }
            }
            ...
            public Property[] AccumulatedProperties
            {
                get
                {
                    ...
                    if (this.hash != null)
                        list.AddRange(this.hash.Values);
        ...
        public static bool CompareEqualContents(
            Styles.PropertyContainer a,
            Styles.PropertyContainer b
        )
        {
