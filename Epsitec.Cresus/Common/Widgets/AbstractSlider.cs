...
namespace Epsitec.Common.Widgets
{
    ...
    public abstract class AbstractSlider
        : Widget,
            Behaviors.IDragBehaviorHost,
            Support.Data.INumValue
    {
        protected AbstractSlider(bool vertical, bool hasButtons)
        {
            ...
            this.ContainerLayoutMode = this.isVertical
                ? ContainerLayoutMode.VerticalFlow
                : ContainerLayoutMode.HorizontalFlow;
        ...
        {
            get { return this.useArrowGlyphs; }
            set
            {
        ...
        public bool ShowMinMaxButtons
        {
            ...
            get { return this.showMinMaxButtons; }
            set
            {
        ...
        public bool ShowScrollButtons
        {
            ...
            get { return this.showScrollButtons; }
            set
            {
        ...
        public decimal SmallChange
        {
            ...
            get { return this.buttonStep; }
            set { this.buttonStep = value; }
        }
        ...
        protected virtual void UpdateGeometry()
        {
            ...
            else
            {
                ...
                )
                {
                    ...
                    arrowLength = System.Math.Floor(
                        (totalLength - AbstractSlider.minimalThumb) / buttonCount
                    );
                ...
                Drawing.Size buttonSize = this.isVertical
                    ? new Size(0, arrowLength)
                    : new Size(arrowLength, 0);
        ...
        {
            get { return this.thumbRect.Location; }
        }
        ...
        {
            this.ScrollByDragging(
                this.isVertical ? e.ToPoint.Y : e.ToPoint.X,
                this.isFirstDragging
            );
        ...
        {
            get { return (decimal)this.GetValue(AbstractSlider.ValueProperty); }
            set
            {
        ...
        {
            get { return this.logarithmicDivisor; }
            set { this.logarithmicDivisor = value; }
        }
        ...
        public decimal LogarithmicValue
        {
            get
            {
                ...
                else
                {
                    ...
                    norm = (decimal)
                        System.Math.Pow((double)norm, (double)(1.0M / this.logarithmicDivisor));
        ...
        {
            get { return this.isInitialChange; }
        }
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
            "Value",
            typeof(decimal),
            typeof(AbstractSlider),
            new Helpers.VisualPropertyMetadata(
                0M,
                AbstractSlider.NotifyValueChanged,
                AbstractSlider.CoerceValue,
