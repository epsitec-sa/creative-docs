...
namespace Epsitec.Common.Widgets
{
	...
	public sealed class Shortcut : DependencyObject, System.IEquatable<Shortcut>
	{
		...
		public static readonly DependencyProperty ShortcutsProperty = DependencyProperty<Shortcut>.RegisterAttached<Collections.ShortcutCollection> ("Shortcuts", new DependencyPropertyMetadata (Shortcut.GetShortcutsValue));
