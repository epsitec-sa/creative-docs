...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class TextFieldMultiEx : AbstractTextField
    {
        ...
        {
            get { return this.preferredLayout; }
            set
            {
        ...
        {
            if ((this.IsValid) && (this.IsEditing) && (this.CheckAcceptEdition()))
            {
        ...
        public override Drawing.Rectangle GetButtonBounds()
        {
            ...
            {
                double height = System.Math.Min(
                    this.ActualHeight,
                    TextFieldMultiEx.SingleLineDefaultHeight
                );

                rect.Left =
                    this.ActualWidth - adorner.GeometryComboRightMargin - this.buttonsRightMargin;
            ...
            if (this.preferredLayout == TextFieldMultiExPreferredLayout.PreserveScrollerHeight)
            {
                ...
                rect.Left =
                    this.ActualWidth
                    - this.scrollerRightMargin
                    - adorner.GeometryComboRightMargin
                    - this.buttonsRightMargin;
                rect.Right =
                    this.ActualWidth - this.scrollerRightMargin - adorner.GeometryComboRightMargin;
                rect.Bottom = adorner.GeometryComboBottomMargin;
                rect.Top = height - adorner.GeometryComboTopMargin;
            }
        ...
        private Drawing.Margins GetScrollerMargins()
        {
            ...
            if (
                this.buttonsRightMargin > 0
                && this.preferredLayout == TextFieldMultiExPreferredLayout.PreserveTextWidth
            ) // boutons Accept/Reject visibles ?
            {
        ...
        private double ScrollerRightMargin
        {
            ...
            get { return this.scrollerRightMargin; }
            set
            {
        ...
        private double ButtonsRightMargin
        {
            ...
            get { return this.buttonsRightMargin; }
            set
            {
        ...
        private void UpdateRightMargin()
        {
            ...
            if (this.preferredLayout == TextFieldMultiExPreferredLayout.PreserveTextWidth)
            {
                this.margins.Right = System.Math.Max(
                    this.scrollerRightMargin,
                    this.buttonsRightMargin
                );
            }
        ...
        public static double SingleLineDefaultHeight
        {
            ...
            get
            {
                return Widget.DefaultFontHeight
