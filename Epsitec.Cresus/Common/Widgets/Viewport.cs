...
namespace Epsitec.Common.Widgets
{
    ...
    public class Viewport : AbstractGroup
    {
        ...
        public Viewport(Widget embedder)
            : this()
        {
        ...
        public double SurfaceWidth
        {
            ...
            set { this.SurfaceSize = new Drawing.Size(value, this.surfaceSize.Height); }
        }

        public double SurfaceHeight
        {
            get { return this.SurfaceSize.Height; }
            set { this.SurfaceSize = new Drawing.Size(this.surfaceSize.Width, value); }
        }
        ...
        {
            add { this.AddUserEventHandler("SurfaceSizeChanged", value); }
            remove { this.RemoveUserEventHandler("SurfaceSizeChanged", value); }
        }

        public event EventHandler IsAutoFittingChanged
        {
            add { this.AddUserEventHandler("IsAutoFittingChanged", value); }
            remove { this.RemoveUserEventHandler("IsAutoFittingChanged", value); }
        }
