namespace Epsitec.Common.Widgets.Adorners
{
    ...
    public class LookPastel : AbstractAdorner
    {
        ...
        protected override void RefreshColors()
        {
            ...
            this.colorCaptionProposal = Drawing.Color.FromRgb(
                240.0 / 255.0,
                203.0 / 255.0,
                0.0 / 255.0
            );
        ...
        )
        {
            ...
            if (rect.IntersectsWith(paintRect))
            {
                ...
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(205.0 / 255.0, 232.0 / 255.0, 253.0 / 255.0)
                );
            }
        ...
        )
        {
            ...
            Drawing.Color topColor = Drawing.Color.FromRgb(
                198.0 / 255.0,
                225.0 / 255.0,
                255.0 / 255.0
            );
            Drawing.Color bottomColor = Drawing.Color.FromRgb(
                249.0 / 255.0,
                252.0 / 255.0,
                255.0 / 255.0
            );
        ...
        )
        {
            ...
            if (dir == Direction.Down || dir == Direction.Up)
            {
                ...
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(255.0 / 255.0, 255.0 / 255.0, 255.0 / 255.0)
                );

                x = rect.Left + 1.5;
                graphics.AddLine(x, rect.Bottom, x, rect.Top);
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(209.0 / 255.0, 230.0 / 255.0, 251.0 / 255.0)
                );

                x = rect.Right - 1.5;
                graphics.AddLine(x, rect.Bottom, x, rect.Top);
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(157.0 / 255.0, 182.0 / 255.0, 202.0 / 255.0)
                );

                x = rect.Right - 0.5;
                graphics.AddLine(x, rect.Bottom, x, rect.Top);
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(122.0 / 255.0, 148.0 / 255.0, 170.0 / 255.0)
                );
            }
            else
            {
        ...
        )
        {
            ...
            graphics.AddFilledRectangle(rect);
            graphics.RenderSolid(
                Drawing.Color.FromRgb(212.0 / 255.0, 234.0 / 255.0, 252.0 / 255.0)
            );
        ...
        public override void PaintFocusBox(Drawing.Graphics graphics, Drawing.Rectangle rect)
        {
            ...
            rect.Inflate(0.5);
            AbstractAdorner.DrawFocusedRectangle(
                graphics,
                rect,
                Drawing.Color.FromRgb(143.0 / 255.0, 201.0 / 255.0, 255.0 / 255.0)
            );
        }
        ...
        )
        {
            ...
            if (angle == 0)
                ...
                t = t.Scale(rect.Height / 100 / 2, rect.Width / 100 / 2);
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(198.0 / 255.0, 230.0 / 255.0, 255.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(255.0 / 255.0, 246.0 / 255.0, 200.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
        ...
        {
            get { return new Drawing.Margins(0, 4, 0, 4); }
        }
