namespace Epsitec.Common.Widgets.Adorners
{
    ...
    public class LookBlue : AbstractAdorner
    {
        ...
        )
        {
            ...
            graphics.Rasterizer.AddSurface(pRect);
            graphics.RenderSolid(
                Drawing.Color.FromAlphaRgb(0.7, 178 / 255.0, 198.0 / 255.0, 221.0 / 255.0)
            );
        ...
        )
        {
            if (paintStyle == Drawing.GlyphPaintStyle.Disabled)
            {
                ...
                color = Drawing.Color.FromAlphaRgb(
                    alpha,
                    color.R,
                    System.Math.Min(color.G * 1.1, 1.0),
                    System.Math.Min(color.B * 1.2, 1.0)
                ); // bleuté
            }
