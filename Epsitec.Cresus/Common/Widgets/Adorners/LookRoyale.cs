namespace Epsitec.Common.Widgets.Adorners
{
    ...
    public class LookRoyale : AbstractAdorner
    {
        ...
        protected override void RefreshColors()
        {
            ...
            this.colorBorderLight = Drawing.Color.FromRgb(
                210.0 / 255.0,
                210.0 / 255.0,
                212.0 / 255.0
            );
            this.colorBorderButton = Drawing.Color.FromRgb(
                43.0 / 255.0,
                79.0 / 255.0,
                130.0 / 255.0
            );
            ...
            this.colorCaptionText = Drawing.Color.FromRgb(
                255.0 / 255.0,
                255.0 / 255.0,
                255.0 / 255.0
            );
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(171.0 / 255.0, 189.0 / 255.0, 211.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(221.0 / 255.0, 205.0 / 255.0, 188.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
        ...
        {
            get { return new Drawing.Margins(0, 0, 0, 2); }
        }
