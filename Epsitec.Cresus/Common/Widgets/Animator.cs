...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class Animator : System.IDisposable
    {
        ...
        public void SetCallback<T>(
            System.Action<T> callbackChanged,
            System.Action<Animator> callbackFinished = null
        )
        {
        ...
        public void SetCallback<T1, T2>(
            System.Action<T1, T2> callbackChanged,
            System.Action<Animator> callbackFinished = null
        )
        {
            this.callbackChanged = () =>
                callbackChanged(this.GetValue<T1>(0), this.GetValue<T2>(1));
            this.callbackFinished = callbackFinished;
        }
        ...
        {
            get { return (long)(this.timeSpan * 10000000); }
        }
