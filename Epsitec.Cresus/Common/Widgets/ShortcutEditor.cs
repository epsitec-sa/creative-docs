    ...
    public class ShortcutEditor : Widget
    {
        public ShortcutEditor()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.fieldModifier,
                Res.Strings.ShortcutEditor.Modifier.Tooltip
            );
        ...
        public ShortcutEditor(Widget embedder)
            : this()
        {
        ...
        protected void UpdateFieldModifier()
        {
            ...
            this.ComboAddModifier(
                KeyCode.ModifierShift | KeyCode.ModifierControl | KeyCode.ModifierAlt
            );
        }
        ...
        protected void ComboAddModifier(KeyCode code)
        {
            ...
            this.fieldModifier.Items.Add(
                TextLayout.ConvertToTaggedText(ShortcutEditor.GetModifierText(code))
            );
        ...
        protected void ComboAddCode(KeyCode code)
        {
            ...
            this.fieldCode.Items.Add(
                TextLayout.ConvertToTaggedText(ShortcutEditor.GetCodeText(code))
            );
            this.listCode.Add(code);
        }

        protected static string GetModifierText(KeyCode code)
        {
        ...
        protected static string GetCodeText(KeyCode code)
        {
        ...
        {
            add { this.AddUserEventHandler("EditedShortcutChanged", value); }
            remove { this.RemoveUserEventHandler("EditedShortcutChanged", value); }
        }
        #endregion
