...
namespace Epsitec.Common.Widgets
{
            ...
            Support.Data.IKeyedStringSelection
    {
        ...
        public TextFieldCombo(Widget embedder)
            : this()
        {
        ...
        {
            get { return this.button.PreferredWidth; }
            set
            {
        ...
        {
            get { return this.comboArrowMode; }
            set { this.comboArrowMode = value; }
        }

        public System.Converter<string, string> ItemTextConverter
        {
            get { return this.itemTextConverter; }
            set { this.itemTextConverter = value; }
        }

        public System.Converter<string, string> ListTextConverter
        {
            get { return this.listTextConverter; }
            set { this.listTextConverter = value; }
        }
        ...
        protected override bool ProcessKeyDown(Message message, Point pos)
        {
            ...
            if ((this.IsComboOpen) && (Feel.Factory.Active.TestCancelKey(message)))
            {
        ...
        {
            if ((this.IsReadOnly) && (this.ProcessKeyPressInSelectItemBehavior(message)))
            {
                return true;
            }
