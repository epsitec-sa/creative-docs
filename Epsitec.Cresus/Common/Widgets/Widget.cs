...
//-				}
		...
		public void SetFocusOnTabWidget()
		{
			...
			var navigator = new TabNavigator (TabNavigationDir.Forwards, TabNavigationMode.ActivateOnTab);
		...
		protected virtual bool FilterTabNavigationSibling(Widget sibling, TabNavigationDir dir, TabNavigationMode mode)
		{
			return true;
		}
