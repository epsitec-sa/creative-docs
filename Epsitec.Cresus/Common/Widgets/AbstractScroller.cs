...
namespace Epsitec.Common.Widgets
{
            ...
            Support.Data.INumValue
    {
        ...
        protected AbstractScroller(Widget embedder, bool vertical)
            : this(vertical)
        {
        ...
        static AbstractScroller()
        {
            Types.DependencyPropertyMetadata metadata =
                Widget.AutoCaptureProperty.DefaultMetadata.Clone();
        ...
        {
            if ((this.arrowDown == null) || (this.arrowUp == null))
            {
                return;
            }
        ...
        )
        {
            ...
            //	Dessine le fond.
            adorner.PaintScrollerBackground(
                graphics,
                this.Client.Bounds,
                this.thumbRect,
                this.tabRect,
        ...
        {
            get { return this.range.Constrain(this.position + this.range.Minimum); }
            set
            {
