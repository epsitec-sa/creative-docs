...
namespace Epsitec.Common.Widgets
{
    ...
    public abstract class AbstractCellArray : AbstractGroup
    {
        ...
        {
            get { return this.drawHiliteFocus; }
            set { this.drawHiliteFocus = value; }
        }
        ...
        public double SeparatorAlpha
        {
            ...
            get { return this.separatorAlpha; }
            set { this.separatorAlpha = value; }
        }
        ...
        public int ColumnsToSkipFromLeftForSeparator
        {
            ...
            get { return this.columnsToSkipFromLeftForSeparator; }
            set { this.columnsToSkipFromLeftForSeparator = value; }
        }

        public CellArrayStyles StyleH
        {
            //	Sytle pour l'en-tête supérieur et l'ascenseur horizontal.
            get { return this.styleH; }
            set
            {
        ...
        public bool IsCompactStyle
        {
            ...
            get { return this.isCompactStyle; }
            set { this.isCompactStyle = value; }
        }

        public double OffsetH
        {
            //	Offset horizontal dû au scrolling.
            get { return this.offsetH; }
            set
            {
        ...
        public int VisibleColumns
        {
            ...
            get { return this.visibleColumns; }
        }
        ...
        {
            Drawing.Margins padding = new Drawing.Margins(
                this.margins.Left + this.leftMargin,
        ...
        public virtual void SetWidthColumn(int rank, double width)
        {
            ...
            else
            {
                ...
                {
                    width = System.Math.Min(
                        width,
                        this.widthColumns[rank] + this.widthColumns[rank + 1] - this.minWidth
                    );
        ...
        public virtual void SetHeightRow(int rank, double height)
        {
            ...
            else
            {
                ...
                {
                    height = System.Math.Min(
                        height,
                        this.heightRows[rank] + this.heightRows[rank + 1] - this.minHeight
                    );
        ...
        protected void StretchColumns(double actualWidth, double actualHeight)
        {
            ...
            double areaWidth =
                actualWidth - this.margins.Width - this.leftMargin - this.rightMargin;
            double totalWidth = 0;
            for (int i = 0; i < this.maxColumns; i++)
            {
        ...
        protected void StretchRows(double actualWidth, double actualHeight)
        {
            ...
            double areaHeight =
                actualHeight - this.margins.Height - this.bottomMargin - this.topMargin;
        ...
        {
            if (column < 0 || column >= this.visibleColumns || row < 0 || row >= this.visibleRows)
            {
                throw new System.ArgumentOutOfRangeException();
            }
        ...
        protected override void ProcessMessage(Message message, Drawing.Point pos)
        {
            ...
            switch (message.MessageType)
            {
                ...
                case MessageType.MouseWheel:
                    if (message.Wheel < 0)
                        this.OffsetV = System.Math.Min(
                            this.OffsetV + this.defHeight,
                            this.scrollerV.DoubleRange
                        );
                    if (message.Wheel > 0)
        ...
        protected bool ProcessKeyDown(ModifierKeys modifier, KeyCode key)
        {
            ...
            if (
                ...
                || (modifier == ModifierKeys.Shift && (style & CellArrayStyles.SelectMulti) != 0)
            )
            {
                switch (key)
                {
        ...
        )
        {
            ...
            if (
                (style.HasFlag(CellArrayStyles.SelectCell) == false)
            ...
            if (
                (style.HasFlag(CellArrayStyles.SelectMulti)) && (isControlPressed || isShiftPressed)
            )
            {
            ...
            if (this.Detect(pos, out row, out column)) // détecte la cellule visée par la souris
            {
                ...
                if ((style.HasFlag(CellArrayStyles.SelectMulti)) && (isShiftPressed))
                {
                    this.SelectZone(
                        marks,
                        column,
        ...
        {
            //	Sélectionne une cellule.
            if ((row < 0) || (row >= this.maxRows) || (column < 0) || (column >= this.maxColumns))
            {
                return;
            }
        ...
        public void ShowCell(int showRow, int showColumn)
        {
            ...
            if (
                (this.styleV & CellArrayStyles.Stretch) == 0
            ...
            if (
                (this.styleH & CellArrayStyles.Stretch) == 0
        ...
        protected override void ArrangeOverride(
            Epsitec.Common.Widgets.Layouts.LayoutContext context
        )
        {
        ...
        protected void UpdateGeometry()
        {
            ...
            Drawing.Rectangle iRect = new Drawing.Rectangle(
                this.margins.Left,
                this.margins.Bottom,
                rect.Width - this.margins.Width,
                rect.Height - this.margins.Height
            );
            ...
            else
            {
                ...
                for (int i = 0; i < this.maxRows; i++)
                {
                    ...
                    if (
                        (this.styleV & CellArrayStyles.Mobile) == 0
            ...
            else
            {
                ...
                for (int i = 0; i < this.maxColumns; i++)
                {
                    ...
                    if (
                        (this.styleH & CellArrayStyles.Mobile) == 0
                        || (
        ...
        protected void UpdateScrollers(double actualWidth, double actualHeight)
        {
            ...
            if (this.showScrollerV)
            {
                ...
                if (totalHeight <= areaHeight || totalHeight <= 0 || areaHeight <= 0)
                {
            ...
            if (this.showScrollerH)
            {
                ...
                if (totalWidth <= areaWidth || totalWidth <= 0 || areaWidth <= 0)
                {
        ...
        protected void UpdateArrayGeometry(Drawing.Rectangle rect)
        {
            ...
            for (int y = 0; y < this.maxRows; y++)
            {
                ...
                for (int x = 0; x < this.maxColumns; x++)
                {
                    ...
                    if (
                        cRect.Right > 0
                        && cRect.Left < rect.Width
                        && cRect.Top > 0
                        && cRect.Bottom < rect.Height
                    )
                    {
        ...
        protected void SetFocusedCell(Cell cell)
        {
            if (this.focusedCell != cell)
            {
                ...
                {
                    this.focusedWidget.KeyboardFocusChanged -=
                        this.HandleFocusedWidgetKeyboardFocusChanged;
        ...
        private void HandleFocusedWidgetKeyboardFocusChanged(
            object sender,
        ...
        )
        {
            ...
            Drawing.Color separatorColor = Drawing.Color.FromAlphaRgb(
                this.separatorAlpha,
                color.R,
                color.G,
                color.B
        ...
        {
            add { this.AddUserEventHandler("FinalSelectionChanged", value); }
            remove { this.RemoveUserEventHandler("FinalSelectionChanged", value); }
        }
        ...
        {
            add { this.AddUserEventHandler("FlyOverChanged", value); }
            remove { this.RemoveUserEventHandler("FlyOverChanged", value); }
        }
