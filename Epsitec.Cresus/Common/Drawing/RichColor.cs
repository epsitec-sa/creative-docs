...
namespace Epsitec.Common.Drawing
{
    ...
    public struct RichColor : System.Runtime.Serialization.ISerializable
    {
        ...
        {
            get { return this.isValid && this.alpha == 0.0; }
        }

        public bool IsOpaque
        {
            get { return this.isValid && this.alpha == 1.0; }
        }
        ...
        public ColorSpace ColorSpace
        {
            ...
            set
            {
                if (this.colorSpace != value)
                {
                    ...
                    {
                        if (value == ColorSpace.Cmyk)
                            this.RgbToCmyk();
                        if (value == ColorSpace.Gray)
                            this.RgbToGray();
                    }

                    if (this.colorSpace == ColorSpace.Cmyk)
                    {
                        if (value == ColorSpace.Rgb)
                            this.CmykToRgb();
                        if (value == ColorSpace.Gray)
                            this.CmykToGray();
                    }
        ...
        public static void RgbToGray(double r, double g, double b, out double gray)
        {
            gray = Color.GetBrightness(r, g, b);
        }

        public static void GrayToRgb(double gray, out double r, out double g, out double b)
        {
            r = gray;
            g = gray;
            b = gray;
        ...
        public static void CmykToGray(double c, double m, double y, double k, out double gray)
        {
            double r,
                g,
                b;
        ...
        public static RichColor Parse(string value)
        {
            ...
            switch (args[0])
            {
                ...
                case "αG":
                    if (args.Length == 3)
                    {
                        return RichColor.FromAGray(
                            Color.ColorComponentToDouble(args[1]),
                            Color.ColorComponentToDouble(args[2])
                        );
                    }
                    break;
                ...
                case "RGB":
                    if (args.Length == 4)
                    {
                        return RichColor.FromAlphaRgb(
                            1.0,
                            Color.ColorComponentToDouble(args[1]),
                            Color.ColorComponentToDouble(args[2]),
                            Color.ColorComponentToDouble(args[3])
                        );
                    }
                    break;
                ...
                case "αRGB":
                    if (args.Length == 5)
                    {
                        return RichColor.FromAlphaRgb(
                            ...
                            Color.ColorComponentToDouble(args[2]),
                            Color.ColorComponentToDouble(args[3]),
                            Color.ColorComponentToDouble(args[4])
                        );
                    }
                    break;
                ...
                case "CMYK":
                    if (args.Length == 5)
                    {
                        return RichColor.FromAlphaCmyk(
                            1.0,
                            Color.ColorComponentToDouble(args[1]),
                            Color.ColorComponentToDouble(args[2]),
                            Color.ColorComponentToDouble(args[3]),
                ...
                case "αCMYK":
                    if (args.Length == 6)
                    {
                        return RichColor.FromAlphaCmyk(
                            ...
                            Color.ColorComponentToDouble(args[3]),
                            Color.ColorComponentToDouble(args[4]),
                            Color.ColorComponentToDouble(args[5])
                        );
                    }
                    break;
            }
            ...
            switch (color.ColorSpace)
            {
                case ColorSpace.Gray:
                    if (color.IsOpaque)
                    {
                        return string.Format(
                            ...
                            "G;{0}",
                            Color.DoubleToColorComponent(color.Gray)
                        );
                    }
                    else
                    {
                ...
                case ColorSpace.Cmyk:
                    if (color.IsOpaque)
                    {
                        return string.Format(
                            System.Globalization.CultureInfo.InvariantCulture,
                            "CMYK;{0};{1};{2};{3}",
                            Color.DoubleToColorComponent(color.C),
                            Color.DoubleToColorComponent(color.M),
                            Color.DoubleToColorComponent(color.Y),
                            Color.DoubleToColorComponent(color.K)
                        );
                    }
                    else
                    {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("ColorSpace.{0} not supported", color.ColorSpace)
                    );
            }
        }
            ...
            switch (this.colorSpace)
            {
                case ColorSpace.Rgb:
                    return System.String.Format(
                        System.Globalization.CultureInfo.InvariantCulture,
                        "{{R={0:0.00},G={1:0.00},B={2:0.00},A={3:0.00}}}",
                        this.value1,
                        this.value2,
                        this.value3,
                        this.alpha
                ...
                case ColorSpace.Cmyk:
                    return System.String.Format(
                        System.Globalization.CultureInfo.InvariantCulture,
                        "{{C={0:0.00},M={1:0.00},Y={2:0.00},K={3:0.00},A={4:0.00}}}",
                        this.value1,
                        this.value2,
                        this.value3,
                        this.value4,
