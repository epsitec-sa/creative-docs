...
namespace Epsitec.Common.OpenType
{
    ...
    public class Tables
    {
        ...
        {
            get { return this.data.Length - this.offset; }
        }
    ...
    {
        public TableEntry(byte[] data, int offset)
            : base(data, offset) { }
        ...
        public int Checksum
        {
            get { return this.ReadInt32(4); }
        }

        public int Offset
        {
            get { return this.ReadInt32(8); }
        }

        public int Length
        {
            get { return this.ReadInt32(12); }
        }
    }
    ...
    public class TableDirectory : Tables
    {
        ...
        {
            get { return this.ReadInt16(6); }
        }

        public int EntrySelector
        {
            get { return this.ReadInt16(8); }
        }

        public int RangeShift
        {
            get { return this.ReadInt16(10); }
        }
    ...
    {
        public TableTtcf(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public TableHead(byte[] data, int offset)
            : base(data, offset) { }

        public TableHead(TableEntry entry)
        ...
        public int Flags
        {
            get { return this.ReadInt16(16); }
        }

        public int UnitsPerEm
        {
            get { return this.ReadInt16(18); }
        }
        ...
        public int XMin
        {
            get { return (short)this.ReadInt16(36); }
        }

        public int YMin
        {
            get { return (short)this.ReadInt16(38); }
        }

        public int XMax
        {
            get { return (short)this.ReadInt16(40); }
        }

        public int YMax
        {
            get { return (short)this.ReadInt16(42); }
        }

        public int MacStyle
        {
            get { return this.ReadInt16(44); }
        }

        public int LowestRecPpEm
        {
            get { return this.ReadInt16(46); }
        }

        public int FontDirectionHint
        {
            get { return this.ReadInt16(48); }
        }

        public int IndexToLocFormat
        {
            get { return this.ReadInt16(50); }
        }

        public int GlyphDataFormat
        {
            get { return this.ReadInt16(52); }
        }
    }

    public class TableGlyf : Tables
    {
        public TableGlyf(byte[] data, int offset)
            : base(data, offset) { }

        public TableGlyf(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }

        public int NumContours
        {
            get { return this.ReadInt16(0); }
        }

        public int XMin
        {
            get { return (short)this.ReadInt16(2); }
        }

        public int YMin
        {
            get { return (short)this.ReadInt16(4); }
        }

        public int XMax
        {
            get { return (short)this.ReadInt16(6); }
        }

        public int YMax
        {
            get { return (short)this.ReadInt16(8); }
        }

        public bool IsSimpleGlyph
        {
            get { return this.NumContours > 0; }
        }

        public bool IsCompositeGlyph
        {
            get { return this.NumContours == 0xffff; }
        }
        ...
        public int GetSimpleFlag(int n)
        {
            return this.ReadInt8(
                (int)(10 + 2 * this.NumContours + 2 + this.GetSimpleInstructionLength() + n)
            );
        }
        ...
        {
            get { return this.ReadInt16(12); }
        }
    }

    public class TablePost : Tables
    {
        public TablePost(byte[] data, int offset)
            : base(data, offset) { }

        public TablePost(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        {
            get { return this.ReadInt16(4 + 4 + 0); }
        }

        public int UnderlineThickness
        {
            get { return this.ReadInt16(4 + 4 + 2); }
        }

        public bool IsFixedPitch
        {
            get { return this.ReadInt32(4 + 4 + 4) != 0; }
        }
        ...
        public int GetGlyphNameIndex(int glyph)
        {
            if (this.Version == 0x00020000)
            {
                if ((glyph < 0) || (glyph >= this.NumberOfGlyphs))
                {
                    return -1;
                }
                else
        ...
        private static string GetMacGlyphName(int index)
        {
    ...
    {
        public TableLocaShort(byte[] data, int offset)
            : base(data, offset) { }

        public TableLocaShort(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
    ...
    {
        public TableLocaLong(byte[] data, int offset)
            : base(data, offset) { }

        public TableLocaLong(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
    ...
    {
        public TableMaxp(byte[] data, int offset)
            : base(data, offset) { }

        public TableMaxp(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        {
            get { return this.ReadInt16(20); }
        }

        public int MaxInstructionDefs
        {
            get { return this.ReadInt16(22); }
        }

        public int MaxStackElements
        {
            get { return this.ReadInt16(24); }
        }

        public int MaxSizeOfInstructions
        {
            get { return this.ReadInt16(26); }
        }

        public int MaxComponentElements
        {
            get { return this.ReadInt16(28); }
        }

        public int MaxComponentDepth
        {
            get { return this.ReadInt16(30); }
        }
    }

    public class TableCmap : Tables
    {
        public TableCmap(byte[] data, int offset)
            : base(data, offset)
        {
            //	http://partners.adobe.com/public/developer/opentype/index_cmap.html
        }

        public TableCmap(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        public IndexMappingTable FindFormatSubTable(int platform, int encoding, int format)
        {
            ...
            {
                if (
                    (this.GetSubTablePlatformId(i) == platform)
                ...
                )
                {
                    ...
                    if (fmt.Format == format)
                    {
                        ...
                        {
                            case 0:
                                return new IndexMappingTable0(
                                    this.data,
                                    this.offset + (int)this.GetSubTableOffset(i)
                                );
                            case 4:
                                return new IndexMappingTable4(
                                    this.data,
                                    this.offset + (int)this.GetSubTableOffset(i)
                                );
                            case 12:
                                return new IndexMappingTable12(
                                    this.data,
                                    this.offset + (int)this.GetSubTableOffset(i)
                                );
                        }
    ...
    {
        public IndexMappingTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public IndexMappingTable0(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public IndexMappingTable4(byte[] data, int offset)
            : base(data, offset) { }
                    ...
                    if (start <= code)
                    {
                        ...
                        if (idRangeOffset != 0)
                        {
                            index = this.ReadInt16(
                                oIdRangeO + i + (int)idRangeOffset + 2 * (int)(code - start)
                            );
    ...
    {
        public IndexMappingTable12(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public TableName(byte[] data, int offset)
            : base(data, offset) { }

        public TableName(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        public string GetLatinName(int language, NameId name, PlatformId platform)
        {
            ...
            {
                if (
                    (this.ReadInt16(i * 12 + oPlatformId) == platId)
                    &&
                ...
                )
                {
                    ...
                    int offset = (int)(
                        this.ReadInt16(i * 12 + oStringOffset) + this.StorageAreaOffset
                    );
    ...
    {
        public TableHhea(byte[] data, int offset)
            : base(data, offset)
        {
            //	http://partners.adobe.com/public/developer/opentype/index_hhea.html
        }

        public TableHhea(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        {
            get { return (short)this.ReadInt16(10); }
        }

        public int MinLeftSideBearing
        {
            get { return (short)this.ReadInt16(12); }
        }

        public int MinRightSideBearing
        {
            get { return (short)this.ReadInt16(14); }
        }

        public int XMaxExtent
        {
            get { return (short)this.ReadInt16(16); }
        }

        public int CaretSlopeRise
        {
            get { return (short)this.ReadInt16(18); }
        }

        public int CaretSlopeRun
        {
            get { return (short)this.ReadInt16(20); }
        }

        public int CaretOffset
        {
            get { return (short)this.ReadInt16(22); }
        }

        public int MetricDataFormat
        {
            get { return this.ReadInt16(32); }
        }

        public int NumHMetrics
        {
            get { return this.ReadInt16(34); }
        }
    }
    ...
    public class TableOS2 : Tables
    {
        ...
        public int XHeight
        {
            get { return this.TableVersion < 3 ? 0 : this.ReadInt16(86); }
        }

        public int CapHeight
        {
            get { return this.TableVersion < 3 ? 0 : this.ReadInt16(88); }
        }
...
USHORT usMaxContext			94
    ...
    {
        public Tablehmtx(byte[] data, int offset)
            : base(data, offset)
        {
            //	http://partners.adobe.com/public/developer/opentype/index_hmtx.html
        }

        public Tablehmtx(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
    ...
    {
        public TableKern(byte[] data, int offset)
            : base(data, offset) { }

        public TableKern(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
    ...
    {
        public KerningTable(byte[] data, int offset)
            : base(data, offset) { }
        ...
        {
            get { return (this.Coverage & 0x0001) == 0x0001; }
        }

        public bool HasMinimumValues
        {
            get { return (this.Coverage & 0x0002) == 0x0002; }
        }

        public bool IsCrossStream
        {
            get { return (this.Coverage & 0x0004) == 0x0004; }
        }

        public bool IsOverride
        {
            get { return (this.Coverage & 0x0008) == 0x0008; }
        }

        public int SubtableFormat
        {
            get { return (this.Coverage & 0xff00) >> 8; }
        }
    ...
    {
        public KerningTableFormat0(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public TableGDEF(byte[] data, int offset)
            : base(data, offset)
        {
        ...
        public TableGDEF(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
        ...
        public LigatureCaretListTable LigatureCaretListTable
        {
            get
            {
                ...
                {
                    return new LigatureCaretListTable(
                        this.data,
                        this.offset + this.LigatureCaretListOffset
                    );
                }
                else
                {
    ...
    {
        public LigatureCaretListTable(byte[] data, int offset)
            : base(data, offset) { }
        ...
        {
            get { return new Coverage(this.data, this.offset + (int)this.CoverageOffset); }
        }
        ...
        {
            return new LigatureGlyphTable(
                this.data,
                this.offset + (int)this.GetLigatureGlyphOffset(n)
            );
        }
    }
    ...
    {
        public LigatureGlyphTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public TableGSUB(byte[] data, int offset)
            : base(data, offset)
        {
        ...
        public TableGSUB(TableEntry entry)
            : base(entry.BaseData, entry.Offset) { }
    ...
    {
        public ScriptListTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public ScriptTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public LangSysTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public FeatureListTable(byte[] data, int offset)
            : base(data, offset) { }
        ...
        {
            return new TaggedFeatureTable(
                this.data,
                this.offset + (int)this.GetFeatureOffset(n),
                this.GetFeatureTag(n)
            );
        }
    ...
    {
        public FeatureTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public TaggedFeatureTable(byte[] data, int offset, string tag)
            : base(data, offset)
        {
            this.tag = tag;
        }
    ...
    {
        public LookupListTable(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public Coverage(byte[] data, int offset)
            : base(data, offset) { }
        ...
        public int FindIndex(int glyph)
        {
            ...
            {
                case 1:
                    return this.FindIndexFmt1(glyph);
                case 2:
                    return this.FindIndexFmt2(glyph);
    ...
    {
        public BaseSubstitution(byte[] data, int offset)
            : base(data, offset) { }

        public virtual bool ProcessSubstitution(
            ushort[] iGlyphs,
            ref int iOffset,
            int length,
            ushort[] oGlyphs,
    ...
    {
        public SingleSubstitution(SubstSubTable sub)
            : base(sub.BaseData, sub.BaseOffset) { }

        public SingleSubstitution(byte[] data, int offset)
            : base(data, offset) { }
        ...
        public ushort FindSubstitution(int glyph)
        {
            ...
            {
                case 1:
                    return this.FindSubstitutionFmt1(glyph);
                case 2:
                    return this.FindSubstitutionFmt2(glyph);
        ...
        public override bool ProcessSubstitution(
            ushort[] iGlyphs,
            ref int iOffset,
            int length,
            ushort[] oGlyphs,
    ...
    {
        public AlternateSubstitution(SubstSubTable sub)
            : base(sub.BaseData, sub.BaseOffset)
        {
            //	http://partners.adobe.com/public/developer/opentype/index_table_formats1.html#ASF1
        }

        public AlternateSubstitution(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public ChainingContextSubstitution(SubstSubTable sub)
            : base(sub.BaseData, sub.BaseOffset) { }

        public ChainingContextSubstitution(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public LigatureSubstitution(SubstSubTable sub)
            : base(sub.BaseData, sub.BaseOffset) { }

        public LigatureSubstitution(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public LigatureSet(byte[] data, int offset)
            : base(data, offset) { }
    ...
    {
        public LigatureInfo(byte[] data, int offset)
            : base(data, offset) { }
