...
namespace Epsitec.Common.OpenType.Platform
{
    internal sealed class Win32
    {
        ...
        static extern IntPtr CreateFontIndirect(
            [In, MarshalAs(UnmanagedType.LPStruct)] LogFont logFont
        );

        [DllImport("gdi32.dll", CharSet = CharSet.Unicode)]
        static extern IntPtr CreateFontIndirect(
            [In, MarshalAs(UnmanagedType.LPStruct)] EnumLogFontEx logFont
        );
        ...
        [DllImport("gdi32.dll", CharSet = CharSet.Unicode)]
        static extern bool GetTextMetrics(IntPtr hdc, [Out] TextMetric buffer);
        ...
        static extern bool ExtTextOut(
            ...
            int y,
            int options,
            [In, MarshalAs(UnmanagedType.LPStruct)] Rect rect,
            [In] ushort[] text,
            int count,
            [In] int[] dx
        );
        ...
        delegate int EnumFontFamExProc(
            EnumLogFontEx logFontEx,
            NewTextMetricEx textMetrics,
            int fontType,
            IntPtr lParam
        );
        #endregion
        ...
        internal sealed class TempDC : System.IDisposable
        {
            ...
            public TempDC(System.IntPtr font)
                : this()
            {
        ...
        private class FontEnumerator
        {
            ...
            {
                get { return this.fullHash; }
                set { this.fullHash = value; }
            }
            ...
            {
                get { return this.logFont; }
            }

            public int ProcessFamily(
                EnumLogFontEx logFontEx,
                NewTextMetricEx textMetrics,
                int fontType,
                IntPtr lParam
            )
            {
                ...
                )
                {
                    ...
                    if (
                        ((NewTextMetricEx.Flags.TrueTypeOpenType & flags) != 0)
