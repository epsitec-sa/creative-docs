...
{
    public class DialogData<T> : DialogData
    ...
    public class DialogData
    {
        ...
        {
            get { return this.defaultContext; }
        }
        ...
        public void RevertChanges()
        {
            ...
            {
                while (
                    this.ForEachChange(change =>
                        change.Path.NavigateWrite(this.internalData, change.OldValue)
                    )
                )
                {
        ...
        public void BindToUserInterface(UI.Panel panel)
        {
            ...
            if (panel != null)
            {
                ...
                foreach (
                    UI.AbstractPlaceholder placeholder in panel.FindAllChildren(child =>
                        child is UI.AbstractPlaceholder
                    )
                )
                {
                    placeholder.SuggestionMode = Epsitec
                        .Common
                        .UI
                        .PlaceholderSuggestionMode
        ...
        internal class FieldProxy : IEntityProxy, INullable
        {
            ...
            )
            {
                ...
                StructuredTypeField field = host.defaultContext.GetStructuredTypeField(
                    externalData,
                    nodeId
                );
            ...
            public object GetReadEntityValue(IValueStore store, string id)
            {
                ...
                if (
                    (this.host.mode == DialogDataMode.Isolated)
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        StructuredTypeField field = context.GetStructuredTypeField(
                            this.externalData,
                            this.nodeId
                        );
            ...
            /// </returns>
            public bool DiscardWriteEntityValue(
                IValueStore internalStore,
                string id,
                ref object value
            )
            {
                ...
                if (this.host.mode == DialogDataMode.RealTime)
                {
                    ...
                    switch (this.relation)
                    {
                        ...
                        case FieldRelation.Reference:
                            ...
                            externalStore.SetValue(
                                id,
                                FieldProxy.Unwrap(value),
                                ValueStoreSetMode.ShortCircuit
                            );
                            internalStore.SetValue(
                                id,
                                this.Wrap(value as AbstractEntity),
                                ValueStoreSetMode.ShortCircuit
                            );
                            break;
            ...
            public bool IsNull
            {
                get { return (this.proxy != null) && (this.proxySource == null); }
            }
            ...
            private AbstractEntity Wrap(AbstractEntity reference)
            {
                ...
                if (provider == null)
                {
                    ...
                    proxy.proxy = this.host.CreateNullProxy(
                        proxy,
                        context,
                        type.GetField(this.nodeId).TypeId
                    );
        ...
        private AbstractEntity CreateNullProxy(
            FieldProxy parent,
        ...
        private void OnExternalDataChanged(AbstractEntity oldValue, AbstractEntity newValue)
        {
            ...
            {
                this.ExternalDataChanged(
                    this,
                    new DependencyPropertyChangedEventArgs("ExternalData", oldValue, newValue)
                );
            }
        }
