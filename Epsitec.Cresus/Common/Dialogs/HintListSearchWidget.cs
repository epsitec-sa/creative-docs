...
namespace Epsitec.Common.Dialogs
{
    ...
    public class HintListSearchWidget : FrameBox
    {
        ...
        public HintListWidget HintListWidget { get; internal set; }
        ...
        )
        {
            ...
            else
            {
                ...
                while (Widgets.Helpers.VisualTree.IsAncestor(focus, this.sourceWidget))
                {
                    ...
                    if ((focus == null) || (stop.Contains(focus)))
                    {
        ...
        {
            add { this.AddEventHandler(HintListSearchWidget.ValueProperty, value); }
            remove { this.RemoveEventHandler(HintListSearchWidget.ValueProperty, value); }
        }
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
            "Value",
            typeof(string),
            typeof(HintListSearchWidget),
            new DependencyPropertyMetadata(
                HintListSearchWidget.GetValue,
                HintListSearchWidget.SetValue
            )
        );
