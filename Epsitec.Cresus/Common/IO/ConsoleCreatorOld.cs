    ...
    public static class ConsoleCreatorOld
    {
        ...
        internal static bool CreateConsole()
        {
            if (System.Threading.Interlocked.Increment(ref ConsoleCreatorOld.counter) == 1)
            {
                ...
                var currentHandle = ConsoleCreatorOld.GetStdHandle(
                    ConsoleCreatorOld.StdOutputHandle
                );
        ...
        public static bool IsOutputRedirected =>
            FileType.Char != GetFileType(GetStdHandle(StdHandle.Stdout));

        public static bool IsInputRedirected =>
            FileType.Char != GetFileType(GetStdHandle(StdHandle.Stdin));

        public static bool IsErrorRedirected =>
            FileType.Char != GetFileType(GetStdHandle(StdHandle.Stderr));
