...
namespace Epsitec.Common.IO
{
    ...
    public static class Ascii85
    {
        ...
        {
            Engine engine = new Engine() { EnforceMarks = outputMarks };
        ...
        {
            Engine engine = new Engine() { EnforceMarks = enforceMarks };
                ...
                switch (c)
                {
                    ...
                    case '~':
                        throw new System.FormatException(
                            "Invalid XML-transparent ASCII 85 character found"
                        );
        ...
        public sealed class Engine
        {
            ...
            public string Encode(byte[] ba)
            {
                System.Text.StringBuilder sb = new System.Text.StringBuilder(
                    (int)(ba.Length * (Ascii85.encodedBlockLength / Ascii85.decodedBlockLength))
                );
                this.Encode(ba, sb);
                return sb.ToString();
            }
