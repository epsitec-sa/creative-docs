...
namespace Epsitec.Common.UI
{
    ...
    public sealed class TextStyleManager : DependencyObject
    {
        ...
        {
            get { return this.staticTextStyle; }
            set
            {
        ...
        {
            this.staticTextStyleLive = TextStyleManager.MergeStyles(
                this.staticTextStyle,
                parent.staticTextStyleLive
            );
            this.textFieldStyleLive = TextStyleManager.MergeStyles(
                this.textFieldStyle,
                parent.textFieldStyleLive
            );
        }
        ...
        {
            if ((widget.TextLayout != null) && (widget.TextLayout.Style.IsReadOnly))
            {
        ...
        private void HandleRootMeasuring(object sender)
        {
            ...
            else
            {
                ...
                Widgets.Widget root =
                    Widgets.Helpers.VisualTree.GetRoot(this.root) as Widgets.Widget;
        ...
        private static Drawing.TextStyle MergeStyles(
            Drawing.TextStyle localStyle,
            Drawing.TextStyle parentStyle
        )
        {
            if (localStyle == null)
            {
        ...
        {
            Widgets.WindowRoot root =
                Widgets.Helpers.VisualTree.GetRoot(widget) as Widgets.WindowRoot;
        ...
        public static readonly DependencyProperty TextStyleManagerProperty =
            DependencyProperty.RegisterAttached(
                "TextStyleManager",
                typeof(TextStyleManager),
                typeof(TextStyleManager)
            );
