...
namespace Epsitec.Common.UI
{
    public class TablePlaceholder : AbstractPlaceholder, Types.Serialization.IDeserialization
    {
            ...
            set
            {
                if (this.sourceTypeId != value)
                {
                    ...
                    this.InvalidateProperty(
                        TablePlaceholder.SourceTypeProperty,
                        oldValue,
                        newValue
                    );
                }
        ...
        {
            if ((this.suspendUpdates == 0) && (this.sourceTypeId.IsValid))
            {
        ...
        bool Epsitec.Common.Types.Serialization.IDeserialization.NotifyDeserializationStarted(
            Epsitec.Common.Types.Serialization.Context context
        )
        {
            this.suspendUpdates++;
            return true;
        ...
        void Epsitec.Common.Types.Serialization.IDeserialization.NotifyDeserializationCompleted(
            Epsitec.Common.Types.Serialization.Context context
        )
        {
            this.suspendUpdates--;
        ...
        public static readonly DependencyProperty ItemsProperty = DependencyProperty.Register(
            ...
            new DependencyPropertyMetadata(
                TablePlaceholder.NotifyItemsChanged
            ).MakeNotSerializable()
        );
        public static readonly DependencyProperty ColumnsProperty =
            DependencyProperty.RegisterReadOnly(
                "Columns",
                typeof(ItemTableColumnCollection),
                typeof(TablePlaceholder),
                new DependencyPropertyMetadata(
                    TablePlaceholder.GetColumnsValue
        ...
        public static readonly DependencyProperty SourceTypeProperty = DependencyProperty.Register(
            ...
            typeof(TablePlaceholder),
            new DependencyPropertyMetadata(
                TablePlaceholder.GetSourceTypeValue,
                TablePlaceholder.SetSourceTypeValue
            )
        );
