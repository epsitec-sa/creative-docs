...
namespace Epsitec.Common.BigList
{
    ...
    public class ItemState : System.IEquatable<ItemState>
    {
        ...
        public bool Hilite1 { get; set; }

        public bool Hilite2 { get; set; }
        ...
        public bool RequiresExtraState
        {
            ...
            {
                if (
                    (this.height + 1 > ItemState.MaxCompactHeight)
                    || (this.MarginBefore != 0)
                    || (this.MarginAfter != 0)
            ...
            set
            {
                if (value < 0)
                {
                    throw new System.ArgumentOutOfRangeException(
                        "value",
                        string.Format("Height may not be negative: {0}", value)
                    );
                }
        ...
        public int MarginBefore { get; set; }

        public int MarginAfter { get; set; }
        ...
        {
            get { return new ItemState() { IsEmpty = true }; }
        }
