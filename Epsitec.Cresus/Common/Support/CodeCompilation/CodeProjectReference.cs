...
namespace Epsitec.Common.Support.CodeCompilation
{
    ...
    public class CodeProjectReference : System.IEquatable<CodeProjectReference>
    {
        ...
        {
            get { return this.assemblyPublicKeyToken; }
            set { this.assemblyPublicKeyToken = value; }
        }
        ...
        {
            get { return this.assemblyHintPath; }
            set { this.assemblyHintPath = value; }
        }
        ...
        public static CodeProjectReference FromAssembly(System.Reflection.Assembly assembly)
        {
            ...
            CodeProjectReference reference = CodeProjectReference.FromAssemblyName(
                assembly.GetName()
            );
        ...
        /// </returns>
        public static CodeProjectReference FromAssemblyName(
