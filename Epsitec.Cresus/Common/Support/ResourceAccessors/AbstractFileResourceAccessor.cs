...
namespace Epsitec.Common.Support.ResourceAccessors
{
    ...
    public abstract class AbstractFileResourceAccessor : DependencyObject, IResourceAccessor
    {
        ...
        {
            get { return this.forceModuleMerge; }
            set { this.forceModuleMerge = value; }
        }
        ...
        public void Load(ResourceManager manager)
        {
            ...
            if (this.manager.BasedOnPatchModule)
            {
                ...
                using (this.SuspendNotifications())
                {
                    ...
                    {
                        ResourceBundle patchBundle = patchBundles.Find(b =>
                            b.Name == refBundle.Name
                        );
        ...
        {
            string[] names = manager.GetBundleIds(
                "*",
                this.GetResourceFileType(),
        ...
        {
            get { return this.manager.BasedOnPatchModule; }
        }

        public bool ContainsChanges
        {
            get { return this.dirtyItems.Count > 0; }
        }

        public IDataBroker GetDataBroker(
            Epsitec.Common.Types.StructuredData container,
            string fieldId
        )
        {
            return null;
        ...
        {
            CultureMapSource source = this.manager.BasedOnPatchModule
                ? CultureMapSource.PatchModule
        ...
        )
        {
            if (this.suspendNotifications == 0)
            {
                ...
                if ((this.BasedOnPatchModule) && (item.Source == CultureMapSource.ReferenceModule))
                {
                    if (
                        (e != null)
        ...
        public void NotifyCultureDataCleared(
            CultureMap item,
            string twoLetterISOLanguageName,
            Epsitec.Common.Types.StructuredData data
        ) { }
        ...
        protected abstract void FillDataFromBundle(
            CultureMapSource source,
            StructuredData data,
            ResourceBundle bundle,
        ...
        protected void HandleItemsCollectionChanged(
            object sender,
            Types.CollectionChangedEventArgs e
        )
        {
            if (this.suspendNotifications == 0)
            {
                switch (e.Action)
                {
                    case Epsitec.Common.Types.CollectionChangedAction.Reset:
                        throw new System.InvalidOperationException(
                            "The collection may not be reset"
                        );
                    ...
                    default:
                        throw new System.InvalidOperationException(
                            string.Format("Unknown operation {0} applied to collection", e.Action)
                        );
                }
            }
        }
        ...
        protected void DeleteItem(CultureMap item)
        {
            ...
            ResourceBundle bundle =
                data.GetValue(Res.Fields.ResourceBaseFile.Bundle) as ResourceBundle;
        ...
        private void RecordBundleAsEdited(ResourceBundle bundle)
        {
            ...
            if ((!this.createdBundles.Contains(bundle)) && (!this.editedBundles.Contains(bundle)))
            {
        ...
        private void RenumberBundles()
        {
            ...
            foreach (CultureMap item in this.Collection)
            {
                ...
                if ((bundle != null) && (bundle.Rank != rank))
                {
        ...
        private Druid CreateId()
        {
            return AbstractResourceAccessor.CreateId(
                ...
                this.manager.DefaultModuleId,
                this.manager.PatchDepth,
                null
            );
        }
        ...
        {
            AccessorsCollection accessors = AbstractFileResourceAccessor.GetAccessors(
                this.manager.Pool
            );
        ...
        {
            return obj.GetValue(AbstractFileResourceAccessor.AccessorsProperty)
        ...
        private static DependencyProperty AccessorsProperty = DependencyProperty.RegisterAttached(
            ...
            typeof(AbstractFileResourceAccessor),
