...
namespace Epsitec.Common.Support.CodeGeneration
{
    ...
    public static class CodeHelper
    {
        ...
        {
            string text =
                Epsitec.Common.Support.Res.Strings.CodeGenerator.SourceFileHeader.ToSimpleText();
        ...
        public static readonly CodeAttributes PublicAttributes = new CodeAttributes(
            CodeVisibility.Public
        );

        public static readonly CodeAttributes PublicStaticMethodAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Static
        );
        public static readonly CodeAttributes PrivateStaticMethodAttributes = new CodeAttributes(
            CodeVisibility.Private,
            CodeAccessibility.Static
        );
        public static readonly CodeAttributes PublicOverrideMethodAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Override
        );
        public static readonly CodeAttributes PublicStaticPartialClassAttributes =
            new CodeAttributes(
                CodeVisibility.Public,
                CodeAccessibility.Static,
                CodeAttributes.PartialAttribute
            );
        public static readonly CodeAttributes PublicStaticReadOnlyFieldAttributes =
            new CodeAttributes(
                CodeVisibility.Public,
                CodeAccessibility.Static,
                CodeAttributes.ReadOnlyAttribute
            );
        public static readonly CodeAttributes PublicConstFieldAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAttributes.ConstAttribute
        );
        public static readonly CodeAttributes PublicStaticNewReadOnlyFieldAttributes =
            new CodeAttributes(
                CodeVisibility.Public,
                CodeAccessibility.Static,
                CodeAttributes.ReadOnlyAttribute,
                CodeAttributes.NewAttribute
            );
        public static readonly CodeAttributes PublicInterfaceAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Default
        );
        public static readonly CodeAttributes PublicStaticPropertyAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Static
        );
        public static readonly CodeAttributes PublicPropertyAttributes = new CodeAttributes(
            CodeVisibility.Public
        );
        public static readonly CodeAttributes PublicVirtualPropertyAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Virtual
        );
        public static readonly CodeAttributes PublicOverridePropertyAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Override
        );

        public static readonly CodeAttributes PublicStaticClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Static
        );
        public static readonly CodeAttributes EntityClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Default,
            CodeAttributes.PartialAttribute
        );
        public static readonly CodeAttributes AbstractEntityClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Abstract,
            CodeAttributes.PartialAttribute
        );
        public static readonly CodeAttributes RepositoryClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Default,
            CodeAttributes.PartialAttribute
        );
        public static readonly CodeAttributes RepositoryNewClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Default,
            CodeAttributes.PartialAttribute,
            CodeAttributes.NewAttribute
        );
        public static readonly CodeAttributes FormIdsClassAttributes = new CodeAttributes(
            CodeVisibility.Public,
            CodeAccessibility.Static
        );

        public static readonly CodeAttributes PrivateStaticReadOnlyFieldAttributes =
            new CodeAttributes(
                CodeVisibility.Private,
                CodeAccessibility.Static,
                CodeAttributes.ReadOnlyAttribute
            );
        public static readonly CodeAttributes PrivateConstFieldAttributes = new CodeAttributes(
            CodeVisibility.Private,
            CodeAttributes.ConstAttribute
        );
        public static readonly CodeAttributes InternalStaticReadOnlyFieldAttributes =
            new CodeAttributes(
                CodeVisibility.Internal,
                CodeAccessibility.Static,
                CodeAttributes.ReadOnlyAttribute
            );
        public static readonly CodeAttributes InternalStaticMethodAttributes = new CodeAttributes(
            CodeVisibility.Internal,
            CodeAccessibility.Static
        );

        public static readonly CodeAttributes PartialMethodAttributes = new CodeAttributes(
            CodeVisibility.None,
            CodeAccessibility.Default,
            CodeAttributes.PartialDefinitionAttribute
        );
        public static readonly CodeAttributes PartialStaticMethodAttributes = new CodeAttributes(
            CodeVisibility.None,
            CodeAccessibility.Static,
            CodeAttributes.PartialDefinitionAttribute
        );

        public static readonly CodeAttributes StaticClassConstructorAttributes = new CodeAttributes(
            CodeVisibility.None,
            CodeAccessibility.Static
        );
        ...
        public static class Keywords
        {
            ...
            public const string QualifiedGenericRepositoryBase =
                "global::Epsitec.Cresus.Core.Repositories.Repository";
            public const string QualifiedCoreData = "global::Epsitec.Cresus.Core.CoreData";
            public const string QualifiedDataContext =
                "global::Epsitec.Cresus.DataLayer.Context.DataContext";
            public const string QualifiedDataLifetime =
                "global::Epsitec.Common.Types.DataLifetimeExpectancy";
            ...
            public const string AbstractEntity =
                "Epsitec.Common.Support.EntityEngine.AbstractEntity";
