...
namespace Epsitec.Common.Types
{
    ...
    public class Collection
    {
        ...
        public static void RemoveDuplicatesInSortedList<T>(IList<T> list)
            where T : System.IEquatable<T>
        {
            int index = 0;
        ...
        /// </returns>
        public static bool CompareEqual<T>(ICollection<T> a, ICollection<T> b)
            where T : System.IEquatable<T>
        {
            if (a == b)
            {
        ...
        /// 	<c>true</c> if both collections have an equal content; otherwise, <c>false</c>.
        /// </returns>
        public static bool CompareEqual<T>(IEnumerable<T> a, IEnumerable<T> b)
            where T : System.IEquatable<T>
        {
            if (a == b)
            {
        ...
        public static bool CompareEqual(
        ...
        /// 	<c>true</c> if both collections have an equal content; otherwise, <c>false</c>.
        /// </returns>
        public static bool CompareEqual<T>(
            IEnumerable<T> a,
            IEnumerable<T> b,
        ...
        private static bool CompareEqualNotChecked<T>(IEnumerable<T> a, IEnumerable<T> b)
            where T : System.IEquatable<T>
        {
            return Collection.CompareEqualNotChecked(
                a,
                b,
        ...
        private static bool CompareEqualNotChecked<T>(
            IEnumerable<T> a,
            IEnumerable<T> b,
            Predicate<T> predicate
        )
        ...
        private static bool CompareEqualNotChecked(
            System.Collections.IEnumerable a,
            System.Collections.IEnumerable b
        )
        {
