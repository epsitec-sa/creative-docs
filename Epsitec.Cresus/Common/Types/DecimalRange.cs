...
namespace Epsitec.Common.Types
{
    ...
    public struct DecimalRange : System.IEquatable<DecimalRange>
    {
        ...
        public bool IsEmpty
        {
            get { return (this.digitsDiv == 0) || (this.digitsMul == 0); }
        }
        ...
        public int GetMaximumDigitCount()
        {
            return System.Math.Max(
                this.GetIntegerDigitCount(this.Maximum * this.digitsMul),
        ...
        {
            return this.minimum.GetHashCode()
            ...
            public object ConvertFromString(string value, IContextResolver context)
            {
                ...
                if (args.Length != 3)
                {
                    throw new System.FormatException(
                        string.Format("{0} is not a serialized DecimalRange")
                    );
                }

                decimal min = decimal.Parse(
                    args[0],
                    System.Globalization.CultureInfo.InvariantCulture
                );
