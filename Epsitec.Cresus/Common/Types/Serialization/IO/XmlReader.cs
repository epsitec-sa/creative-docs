    ...
    public class XmlReader : AbstractReader
    {
            ...
            while (this.xml.Read())
            {
                if (this.xml.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        ...
                        rootId = Context.ParseId(
                            this.xml.GetAttribute("root", Xml.StructureNamespace)
                        );

                        externalCount = Context.ParseNum(
                            this.xml.GetAttribute("n_ext", Xml.StructureNamespace)
                        );
                        typeCount = Context.ParseNum(
                            this.xml.GetAttribute("n_typ", Xml.StructureNamespace)
                        );
                        objectCount = Context.ParseNum(
                            this.xml.GetAttribute("n_obj", Xml.StructureNamespace)
                        );
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Element <{0}> not expected here; expected <storage>",
                                this.xml.Name
                            )
                        );
                    }
        ...
        public override void EndStorageBundle()
        {
            ...
            while (this.xml.Read())
            {
                ...
                if (
                    (this.xml.NodeType != System.Xml.XmlNodeType.EndElement)
                    || (this.xml.LocalName != "storage")
                    || (this.xml.NamespaceURI != Xml.StructureNamespace)
                )
                {
            ...
            while (this.xml.Read())
            {
                if (this.xml.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Element <{0}> not expected here; expected <external>",
                                this.xml.Name
                            )
                        );
                    }
                ...
                if (this.xml.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        ...
                        if (elementId != expectedId)
                        {
                            throw new System.FormatException(
                                string.Format(
                                    "Element <type> id={0}; expected id={1}",
                                    elementId,
                                    expectedId
                                )
                            );
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Element <{0}> not expected here; expected <type>",
                                this.xml.Name
                            )
                        );
                    }
                ...
                if (this.xml.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        ...
                        if (elementId != expectedId)
                        {
                            throw new System.FormatException(
                                string.Format(
                                    "Element <object> id={0}; expected id={1}",
                                    elementId,
                                    expectedId
                                )
                            );
                        ...
                        return Context.ParseId(
                            this.xml.GetAttribute("type", Xml.StructureNamespace)
                        );
                    }
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Element <{0}> not expected here; expected <object>",
                                this.xml.Name
                            )
                        );
                    }
                ...
                if (this.xml.NodeType == System.Xml.XmlNodeType.Element)
                {
                    ...
                    )
                    {
                        ...
                        if (elementId != expectedId)
                        {
                            throw new System.FormatException(
                                string.Format(
                                    "Element <data> id={0}; expected id={1}",
                                    elementId,
                                    expectedId
                                )
                            );
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Element <{0}> not expected here; expected <data>",
                                this.xml.Name
                            )
                        );
                    }
        ...
        public override bool ReadObjectFieldValue(
