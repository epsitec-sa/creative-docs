            ...
            IReadOnlyLock
    {
        ...
        public virtual void AddRange(IEnumerable<T> collection)
        {
            ...
            if (items.Length > 0)
            {
                ...
                that.OnCollectionChanged(
                    new CollectionChangedEventArgs(CollectionChangedAction.Add, index, items)
                );
            }
        }
        ...
        private sealed class DeferredNotifier : System.IDisposable
        {
            ...
            public void RecordEvent(System.Delegate invocation, CollectionChangedEventArgs e)
            {
                ...
                else
                {
                    ...
                    this.events[pos] = new Event(
                        invocation,
                        CollectionChangedEventArgs.Merge(this.events[pos].EventArgs, e)
                    );
                }
            }
