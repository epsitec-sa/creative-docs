...
namespace Epsitec.Common.Types.Converters
{
    ...
    public sealed class AutomaticValueConverter : IValueConverter
    {
        ...
        )
        {
            ...
            if ((expectedType == typeof(object)) || (expectedType == sourceType))
            {
                return value;
            }
            ...
            try
            {
                ...
                if (
                    (sourceTypeCode == System.TypeCode.String)
                ...
                if (
                    (sourceTypeCode == System.TypeCode.DateTime)
                ...
                if (
                    (sourceTypeCode != System.TypeCode.Object)
                ...
                return AutomaticValueConverter.ConvertUsingTypeConverter(
                    value,
                    sourceType,
                    expectedType,
                    culture
            ...
            {
                if ((ex.InnerException != null) && (ex.InnerException is System.FormatException))
                {
                    return InvalidValue.Value;
                }
        ...
        private static object ConvertUsingTypeConverter(
            object value,
