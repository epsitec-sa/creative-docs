...
namespace Epsitec.Common.Text.Properties
{
	...
	public class UnderlineProperty : AbstractXlineProperty
	{
		...
		public UnderlineProperty(double position, SizeUnits position_units, double thickness, SizeUnits thickness_units, string line_class, string line_style) : base (position, position_units, thickness, thickness_units, line_class, line_style)
		{
		}
