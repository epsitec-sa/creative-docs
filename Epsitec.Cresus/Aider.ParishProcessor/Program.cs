...
namespace AIDER.ParishPreprocessor
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			string inputPath = System.IO.Path.Combine (dataDir, "2023-02-xx Clean Parish Info.txt");
			string input2Path = System.IO.Path.Combine (dataDir, "2023-02-xx parish names.txt");
			string outputPath = System.IO.Path.Combine (dataDir, "2023-02-xx parishes.txt");
			string missingPath = System.IO.Path.Combine (dataDir, "2023-02-xx missing.txt");
