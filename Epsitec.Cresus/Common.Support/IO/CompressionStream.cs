...
{
	/// <summary>
	/// La classe CompressionStream donne accès aux divers streams comprimés
	/// (BZip2, GZip, Deflate = LZW & Huffman, ZIP).
	/// </summary>
	public class CompressionStream : AbstractStream
	{
		protected CompressionStream(System.IO.Stream stream)
		{
			this.Stream = stream;
		}
		...
		public static System.IO.Stream CreateBZip2(System.IO.Stream stream)
		{
			...
			return new CompressionStream (compressor);
		}
		
		public static System.IO.Stream CreateZip(System.IO.Stream stream, string name)
		{
		...
		public static System.IO.Stream CreateDeflate(System.IO.Stream stream, int level)
		{
		...
		public static System.IO.Stream CreateGZip(System.IO.Stream stream)
		{
