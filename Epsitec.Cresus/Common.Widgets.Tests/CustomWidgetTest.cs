...
namespace Epsitec.Common.Widgets
{
	...
	public class CustomWidgetTest
	{
		...
		[Test] public void CheckCustomWidgetSimpleWindow()
		{
			...
			a.Name = "A"; a.AnchorMargins = new Margins (0, 10, 0, 40); a.Size = new Size (80, 20); a.Text = "OK";     a.Anchor = AnchorStyles.BottomRight;
			b.Name = "B"; b.AnchorMargins = new Margins (0, 10, 0, 10); b.Size = new Size (80, 20); b.Text = "Cancel"; b.Anchor = AnchorStyles.BottomRight;
