...
namespace Epsitec.Common.Tests
{
	...
	public class FicheTest
	{
		...
		protected void CreateLayout()
		{
			...
			fileMenu.Items.Add(new MenuSeparator ());
			fileMenu.Items.Add(new MenuItem ("print", "file:..\\..\\print.png", "Imprimer...", "Ctrl+P"));
			fileMenu.Items.Add(new MenuItem ("preview", "file:..\\..\\preview.png", "Apercu avant impression", ""));
			...
			editMenu.Items.Add(new MenuItem ("cut", "file:..\\..\\cut.png", "Couper", "Ctrl+X"));
			editMenu.Items.Add(new MenuItem ("copy", "file:..\\..\\copy.png", "Copier", "Ctrl+C"));
			editMenu.Items.Add(new MenuItem ("paste", "file:..\\..\\paste.png", "Coller", "Ctrl+V"));
			editMenu.AdjustSize();
			...
			optMenu.Items.Add(new MenuItem ("print", "file:..\\..\\print.png", "Impression...", ""));
			optMenu.Items.Add(new MenuItem ("open", "file:..\\..\\open.png", "Fichiers...", ""));
			optMenu.AdjustSize();
			...
			helpMenu.Items.Add(new MenuItem ("ctxhelp", "file:..\\..\\help.png", "Aide contextuelle", ""));
