...
[assembly: global::Epsitec.Common.Support.EntityClass ("[L0AAB]", typeof (Epsitec.Cresus.Core.Entities.TotalDocumentItemEntity))]
...
namespace Epsitec.Cresus.Core.Entities
{
	...
	{
		///	<summary>
		///	The <c>ItemGroup</c> field.
		///	designer:fld/L0AJ3/L0AP6
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[L0AP6]")]
		public string ItemGroup
		{
			get
			{
				return this.GetField<string> ("[L0AP6]");
			}
			set
			{
				string oldValue = this.ItemGroup;
				if (oldValue != value)
				{
					this.OnItemGroupChanging (oldValue, value);
					this.SetField<string> ("[L0AP6]", oldValue, value);
					this.OnItemGroupChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>ItemLayoutSettings</c> field.
		///	designer:fld/L0AJ3/L0AQ6
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[L0AQ6]")]
		public string ItemLayoutSettings
		{
			get
			{
				return this.GetField<string> ("[L0AQ6]");
			}
			set
			{
				string oldValue = this.ItemLayoutSettings;
				if (oldValue != value)
				{
					this.OnItemLayoutSettingsChanging (oldValue, value);
					this.SetField<string> ("[L0AQ6]", oldValue, value);
					this.OnItemLayoutSettingsChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		///	<summary>
		///	The <c>TraceabilityDetails</c> field.
		///	designer:fld/L0AJ3/L0AG6
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[L0AG6]")]
		public global::System.Collections.Generic.IList<global::Epsitec.Cresus.Core.Entities.ArticleTraceabilityDetailsEntity> TraceabilityDetails
		{
			get
			{
				return this.GetFieldCollection<global::Epsitec.Cresus.Core.Entities.ArticleTraceabilityDetailsEntity> ("[L0AG6]");
			}
		}
		///	<summary>
		///	The <c>Quantities</c> field.
		///	designer:fld/L0AJ3/L0AP5
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[L0AP5]")]
		public global::System.Collections.Generic.IList<global::Epsitec.Cresus.Core.Entities.ArticleQuantityEntity> Quantities
		{
			get
			{
				return this.GetFieldCollection<global::Epsitec.Cresus.Core.Entities.ArticleQuantityEntity> ("[L0AP5]");
			}
		}
		///	<summary>
		...
		partial void OnItemGroupChanging(string oldValue, string newValue);
		partial void OnItemGroupChanged(string oldValue, string newValue);
		partial void OnItemLayoutSettingsChanging(string oldValue, string newValue);
		partial void OnItemLayoutSettingsChanged(string oldValue, string newValue);
...
namespace Epsitec.Cresus.Core.Entities
{
	...
	public partial class ArticleDocumentItemEntity : global::Epsitec.Cresus.Core.Entities.AbstractDocumentItemEntity, global::Epsitec.Cresus.Core.Entities.IDateRange
	{
		...
		///	<summary>
		///	The <c>ArticleShortDescription</c> field.
		...
		public string ArticleShortDescription
		{
			...
			set
			{
				string oldValue = this.ArticleShortDescription;
				if (oldValue != value)
				{
					this.OnArticleShortDescriptionChanging (oldValue, value);
					this.SetField<string> ("[L0AVA]", oldValue, value);
					this.OnArticleShortDescriptionChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>ArticleLongDescription</c> field.
		...
		public string ArticleLongDescription
		{
			...
			set
			{
				string oldValue = this.ArticleLongDescription;
				if (oldValue != value)
				{
					this.OnArticleLongDescriptionChanging (oldValue, value);
					this.SetField<string> ("[L0A0B]", oldValue, value);
					this.OnArticleLongDescriptionChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		partial void OnArticleShortDescriptionChanging(string oldValue, string newValue);
		partial void OnArticleShortDescriptionChanged(string oldValue, string newValue);
		partial void OnArticleLongDescriptionChanging(string oldValue, string newValue);
		partial void OnArticleLongDescriptionChanged(string oldValue, string newValue);
