...
namespace Epsitec.Cresus.Core.Printers
{
	public class XmlJobPrintEngine : IPrintEngine
	{
		...
		public void PrepareNewPage(PageSettings pageSettings)
		{
			...
			this.printerUnit = Common.GetPrinterUnit (section.PrinterLogicalName);
			...
			if (this.printerUnit != null)
			{
				// TODO: Hélas, cela semble n'avoir aucun effet lors d'une impression réelle !
				pageSettings.PrinterSettings.Duplex = this.printerUnit.PhysicalDuplexMode;
			}
		...
		public PrintEngineStatus PrintPage(PrintPort port)
		{
			...
			if (this.printerUnit != null)
			{
				xOffset = this.printerUnit.XOffset;
				yOffset = this.printerUnit.YOffset;
			}
		...
		private PrinterUnit							printerUnit;
		private bool								swap;
	}
}
