...
namespace Epsitec.Cresus.Core.Controllers.EditionControllers
{
	public class EditionUnitOfMeasureViewController : EditionViewController<Entities.UnitOfMeasureEntity>
	{
		...
		private void CreateUIMain(UIBuilder builder)
		{
			...
			builder.CreateAutoCompleteTextField (tile, 100, "Catégorie", Marshaler.Create (() => this.Entity.Category, x => this.Entity.Category = x), Enumerations.GetAllPossibleUnitOfMeasureCategories (), x => TextFormater.FormatText (x.Values));
