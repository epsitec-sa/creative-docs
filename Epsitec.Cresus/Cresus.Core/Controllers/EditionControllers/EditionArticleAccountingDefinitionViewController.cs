	...
	public class EditionArticleAccountingDefinitionViewController : EditionViewController<Entities.ArticleAccountingDefinitionEntity>
	{
		...
		protected override void CreateBricks(BrickWall<ArticleAccountingDefinitionEntity> wall)
		{
			wall.AddBrick ()
				...
				.Separator ()
				.Input ()
				  .Field (x => x.SaleBookAccount)
				  .Field (x => x.SaleVatBookAccount)
				  .Field (x => x.SaleDiscountBookAccount)
				  .Field (x => x.SaleRoundingBookAccount)
				  .Field (x => x.SaleVatCode)
				.End ()
				.Separator ()
				.Input ()
				  .Field (x => x.PurchaseBookAccount)
				  .Field (x => x.PurchaseVatBookAccount)
				  .Field (x => x.PurchaseDiscountBookAccount)
				  .Field (x => x.PurchaseRoundingBookAccount)
				  .Field (x => x.PurchaseVatCode)
				.End ()
				.Separator ()
				.Input ()
