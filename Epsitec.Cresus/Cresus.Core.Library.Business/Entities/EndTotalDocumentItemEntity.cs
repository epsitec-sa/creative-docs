...
{
	public partial class EndTotalDocumentItemEntity : ICloneable<EndTotalDocumentItemEntity>
	{
		...
		void ICloneable<EndTotalDocumentItemEntity>.CopyTo(IBusinessContext businessContext, EndTotalDocumentItemEntity copy)
		{
