...
namespace Epsitec.Cresus.Core.Controllers.BusinessDocumentControllers
{
	public sealed class BusinessDocumentLinesController : System.IDisposable
	{
		...
		private void UpdateCommands()
		{
			...
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.CreateGroupSeparator, true);
			...
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.Flat,      true);
		}
