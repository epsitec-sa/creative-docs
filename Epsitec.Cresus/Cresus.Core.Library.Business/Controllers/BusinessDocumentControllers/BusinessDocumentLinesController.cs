...
namespace Epsitec.Cresus.Core.Controllers.BusinessDocumentControllers
{
	public class BusinessDocumentLinesController
	{
		...
		private void UpdateCommands()
		{
			...
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.MoveUp,    selection.Count == 1 && (isArticle || isText || isSubTotal));
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.MoveDown,  selection.Count == 1 && (isArticle || isText || isSubTotal));
			...
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.Group,    selection.Count != 0 && !isEndTotal);
			this.commandContext.SetLocalEnable (Library.Business.Res.Commands.Lines.Ungroup,  selection.Count != 0 && !isEndTotal);
		}
