...
namespace Epsitec.Cresus.Core.Controllers.BusinessDocumentControllers
{
	public class BusinessDocumentLinesController
	{
		...
		private void UpdateCommands()
		{
			...
			this.commandContext.GetCommandState (Library.Business.Res.Commands.Lines.Duplicate).Enable = selection.Count == 1 && !autoGenerated;
			this.commandContext.GetCommandState (Library.Business.Res.Commands.Lines.Delete).Enable    = selection.Count == 1 && !autoGenerated;
