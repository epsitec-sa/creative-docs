...
{
	public class DocumentCategoryController : IEntitySpecialController
	{
		public DocumentCategoryController(TileContainer tileContainer, DocumentCategoryEntity documentCategoryEntity)
		{
		...
		private class Factory : DefaultEntitySpecialControllerFactory<DocumentCategoryEntity>
		{
			...
			{
				return new DocumentCategoryController (container, entity);
			}
		}
