...
namespace Epsitec.Aider.Data.Eerv
{
	...
	internal class EervParishDataLoader
	{
		...
		private EervAddress GetAddress(Dictionary<PersonHeader, string> record)
		{
			...
			if (countryCode == "CH")
			{
				this.addressChecker.FixZipCodeAndTown (ref zipCode, ref town);
				this.addressChecker.FixStreetName (ref firstAddressLine, ref streetName, houseNumber, ref zipCode, ref town);
			}
