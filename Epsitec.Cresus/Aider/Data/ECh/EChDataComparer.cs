...
namespace Epsitec.Aider.Data.ECh
{
	...
	class EChDataComparer
	{
		...
		private void AddNewFamilyToResult(EChReportedPerson family)
		{
			...
			{
				this.NewFamilies = new Dictionary<string, EChReportedPerson> ();
			}

			this.NewFamilies.Add (family.FamilyKey,family);
		}
		...
		//Result dictionnary
		private Dictionary<string,EChReportedPerson> NewFamilies;
