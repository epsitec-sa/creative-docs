...
namespace Epsitec.Aider.Entities
{
	...
	public partial class eCH_PersonEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		...
		///	<summary>
		///	The <c>NationalityCountryName</c> field.
		///	designer:fld/LVA/LVGT32
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVGT32]", IsVirtual=true)]
		public string NationalityCountryName
		{
			get
			{
				string value = default (string);
				this.GetNationalityCountryName (ref value);
				return value;
			}
			set
			{
				string oldValue = this.NationalityCountryName;
				if (oldValue != value || !this.IsFieldDefined("[LVGT32]"))
				{
					this.OnNationalityCountryNameChanging (oldValue, value);
					this.SetNationalityCountryName (value);
					this.OnNationalityCountryNameChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		partial void OnNationalityCountryNameChanging(string oldValue, string newValue);
		partial void OnNationalityCountryNameChanged(string oldValue, string newValue);
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVAF
	///	</summary>
	public partial class AiderPersonEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		...
		///	<summary>
		///	The <c>GeoParishGroupPathCache</c> field.
		///	designer:fld/LVAF/LVOH13
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOH13]")]
		public string GeoParishGroupPathCache
		{
			get
			{
				return this.GetField<string> ("[LVOH13]");
			}
			set
			{
				string oldValue = this.GeoParishGroupPathCache;
				if (oldValue != value || !this.IsFieldDefined("[LVOH13]"))
				{
					this.OnGeoParishGroupPathCacheChanging (oldValue, value);
					this.SetField<string> ("[LVOH13]", oldValue, value);
					this.OnGeoParishGroupPathCacheChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAEH]", IsVirtual=true)]
		public global::Epsitec.Aider.Entities.AiderContactEntity MainContact
		{
			get
			{
				global::Epsitec.Aider.Entities.AiderContactEntity value = default (global::Epsitec.Aider.Entities.AiderContactEntity);
				this.GetMainContact (ref value);
				return value;
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderContactEntity oldValue = this.MainContact;
				if (oldValue != value || !this.IsFieldDefined("[LVAEH]"))
				{
					this.OnMainContactChanging (oldValue, value);
					this.SetMainContact (value);
					this.OnMainContactChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>HouseholdContact</c> field.
		///	designer:fld/LVAF/LVAFH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAFH]", IsVirtual=true)]
		public global::Epsitec.Aider.Entities.AiderContactEntity HouseholdContact
		{
			get
			{
				global::Epsitec.Aider.Entities.AiderContactEntity value = default (global::Epsitec.Aider.Entities.AiderContactEntity);
				this.GetHouseholdContact (ref value);
				return value;
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderContactEntity oldValue = this.HouseholdContact;
				if (oldValue != value || !this.IsFieldDefined("[LVAFH]"))
				{
					this.OnHouseholdContactChanging (oldValue, value);
					this.SetHouseholdContact (value);
					this.OnHouseholdContactChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>AllPhoneNumbers</c> field.
		///	designer:fld/LVAF/LVAHH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAHH]", IsVirtual=true)]
		public string AllPhoneNumbers
		{
			get
			{
				string value = default (string);
				this.GetAllPhoneNumbers (ref value);
				return value;
			}
			set
			{
				string oldValue = this.AllPhoneNumbers;
				if (oldValue != value || !this.IsFieldDefined("[LVAHH]"))
				{
					this.OnAllPhoneNumbersChanging (oldValue, value);
					this.SetAllPhoneNumbers (value);
					this.OnAllPhoneNumbersChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>AllEmails</c> field.
		///	designer:fld/LVAF/LVAIH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAIH]", IsVirtual=true)]
		public string AllEmails
		{
			get
			{
				string value = default (string);
				this.GetAllEmails (ref value);
				return value;
			}
			set
			{
				string oldValue = this.AllEmails;
				if (oldValue != value || !this.IsFieldDefined("[LVAIH]"))
				{
					this.OnAllEmailsChanging (oldValue, value);
					this.SetAllEmails (value);
					this.OnAllEmailsChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		///	<summary>
		///	The <c>MainPhone</c> field.
		///	designer:fld/LVAF/LVOD33
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOD33]", IsVirtual=true)]
		public string MainPhone
		{
			get
			{
				string value = default (string);
				this.GetMainPhone (ref value);
				return value;
			}
			set
			{
				string oldValue = this.MainPhone;
				if (oldValue != value || !this.IsFieldDefined("[LVOD33]"))
				{
					this.OnMainPhoneChanging (oldValue, value);
					this.SetMainPhone (value);
					this.OnMainPhoneChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>SecondaryPhone</c> field.
		///	designer:fld/LVAF/LVOE33
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOE33]", IsVirtual=true)]
		public string SecondaryPhone
		{
			get
			{
				string value = default (string);
				this.GetSecondaryPhone (ref value);
				return value;
			}
			set
			{
				string oldValue = this.SecondaryPhone;
				if (oldValue != value || !this.IsFieldDefined("[LVOE33]"))
				{
					this.OnSecondaryPhoneChanging (oldValue, value);
					this.SetSecondaryPhone (value);
					this.OnSecondaryPhoneChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>Events</c> field.
		///	designer:fld/LVAF/LVOG73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOG73]")]
		...
		partial void OnGeoParishGroupPathCacheChanging(string oldValue, string newValue);
		...
		partial void OnHouseholdContactChanged(global::Epsitec.Aider.Entities.AiderContactEntity oldValue, global::Epsitec.Aider.Entities.AiderContactEntity newValue);
		partial void OnAllPhoneNumbersChanging(string oldValue, string newValue);
		...
		partial void OnMainPhoneChanging(string oldValue, string newValue);
		...
		partial void SetHouseholdContact(global::Epsitec.Aider.Entities.AiderContactEntity value);
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVAI2
	///	</summary>
	public partial class AiderHouseholdEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		#region IComment Members
		///	<summary>
		///	The <c>Comment</c> field.
		...
		///	<summary>
		///	The <c>Contacts</c> field.
		///	designer:fld/LVAI2/LVAGF
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAGF]", IsVirtual=true)]
		public global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderContactEntity> Contacts
		{
			get
			{
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVA93
	///	</summary>
	public partial class AiderEventEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		#region IComment Members
		///	<summary>
		///	The <c>Comment</c> field.
		...
		///	<summary>
		///	The <c>State</c> field.
		///	designer:fld/LVA93/LVOF53
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOF53]")]
		public global::Epsitec.Aider.Enumerations.EventState State
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Enumerations.EventState> ("[LVOF53]");
			}
			set
			{
				global::Epsitec.Aider.Enumerations.EventState oldValue = this.State;
				if (oldValue != value || !this.IsFieldDefined("[LVOF53]"))
				{
					this.OnStateChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Enumerations.EventState> ("[LVOF53]", oldValue, value);
		...
		///	designer:fld/LVA93/LVO253
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO253]")]
		public global::Epsitec.Aider.Entities.AiderOfficeManagementEntity Office
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderOfficeManagementEntity> ("[LVO253]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderOfficeManagementEntity oldValue = this.Office;
				if (oldValue != value || !this.IsFieldDefined("[LVO253]"))
				{
					this.OnOfficeChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderOfficeManagementEntity> ("[LVO253]", oldValue, value);
		...
		///	<summary>
		///	The <c>Town</c> field.
		///	designer:fld/LVA93/LVOA53
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOA53]")]
		public global::Epsitec.Aider.Entities.AiderTownEntity Town
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderTownEntity> ("[LVOA53]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderTownEntity oldValue = this.Town;
				if (oldValue != value || !this.IsFieldDefined("[LVOA53]"))
				{
					this.OnTownChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderTownEntity> ("[LVOA53]", oldValue, value);
					this.OnTownChanged (oldValue, value);
				}
			}
		}
		...
		///	<summary>
		///	The <c>Kind</c> field.
		///	designer:fld/LVA93/LVO163
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO163]")]
		public global::Epsitec.Aider.Enumerations.EventKind? Kind
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Enumerations.EventKind?> ("[LVO163]");
			}
			set
			{
				global::Epsitec.Aider.Enumerations.EventKind? oldValue = this.Kind;
				if (oldValue != value || !this.IsFieldDefined("[LVO163]"))
				{
					this.OnKindChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Enumerations.EventKind?> ("[LVO163]", oldValue, value);
		...
		partial void OnStateChanging(global::Epsitec.Aider.Enumerations.EventState oldValue, global::Epsitec.Aider.Enumerations.EventState newValue);
		partial void OnStateChanged(global::Epsitec.Aider.Enumerations.EventState oldValue, global::Epsitec.Aider.Enumerations.EventState newValue);
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderEventParticipantEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		...
		///	<summary>
		///	The <c>IsExternal</c> field.
		///	designer:fld/LVAA3/LVO273
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO273]")]
		public bool IsExternal
		{
			get
			{
				return this.GetField<bool> ("[LVO273]");
			}
			set
			{
				bool oldValue = this.IsExternal;
				if (oldValue != value || !this.IsFieldDefined("[LVO273]"))
				{
					this.OnIsExternalChanging (oldValue, value);
					this.SetField<bool> ("[LVO273]", oldValue, value);
					this.OnIsExternalChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		///	<summary>
		///	The <c>ParishName</c> field.
		///	designer:fld/LVAA3/LVOM73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOM73]")]
		public string ParishName
		{
			get
			{
				return this.GetField<string> ("[LVOM73]");
			}
			set
			{
				string oldValue = this.ParishName;
				if (oldValue != value || !this.IsFieldDefined("[LVOM73]"))
				{
					this.OnParishNameChanging (oldValue, value);
					this.SetField<string> ("[LVOM73]", oldValue, value);
					this.OnParishNameChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>BirthDate</c> field.
		///	designer:fld/LVAA3/LVON73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVON73]")]
		public global::Epsitec.Common.Types.Date? BirthDate
		{
			get
			{
				return this.GetField<global::Epsitec.Common.Types.Date?> ("[LVON73]");
			}
			set
			{
				global::Epsitec.Common.Types.Date? oldValue = this.BirthDate;
				if (oldValue != value || !this.IsFieldDefined("[LVON73]"))
				{
					this.OnBirthDateChanging (oldValue, value);
					this.SetField<global::Epsitec.Common.Types.Date?> ("[LVON73]", oldValue, value);
		...
		partial void OnTownChanging(string oldValue, string newValue);
		partial void OnTownChanged(string oldValue, string newValue);
		partial void OnParishNameChanging(string oldValue, string newValue);
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVA54
	///	</summary>
	public partial class AiderGroupEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IDateRange, global::Epsitec.Aider.Entities.IComment
	{
		#region IComment Members
		///	<summary>
		///	The <c>Comment</c> field.
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVAR6
	///	</summary>
	public partial class AiderLegalPersonEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		#region IComment Members
		///	<summary>
		///	The <c>Comment</c> field.
		...
		///	<summary>
		///	The <c>Contacts</c> field.
		///	designer:fld/LVAR6/LVAHF
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAHF]", IsVirtual=true)]
		public global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderContactEntity> Contacts
		{
			get
			{
		...
		///	<summary>
		///	The <c>MainEmail</c> field.
		///	designer:fld/LVAR6/LVOG63
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOG63]", IsVirtual=true)]
		public string MainEmail
		{
			get
			{
			...
			{
				string oldValue = this.MainEmail;
				if (oldValue != value || !this.IsFieldDefined("[LVOG63]"))
				{
					this.OnMainEmailChanging (oldValue, value);
					this.SetMainEmail (value);
					this.OnMainEmailChanged (oldValue, value);
		...
		///	<summary>
		///	The <c>SecondaryEmail</c> field.
		///	designer:fld/LVAR6/LVOH63
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOH63]", IsVirtual=true)]
		public string SecondaryEmail
		{
			get
			{
			...
			{
				string oldValue = this.SecondaryEmail;
				if (oldValue != value || !this.IsFieldDefined("[LVOH63]"))
				{
					this.OnSecondaryEmailChanging (oldValue, value);
					this.SetSecondaryEmail (value);
					this.OnSecondaryEmailChanged (oldValue, value);
		...
		///	<summary>
		///	The <c>MainPhone</c> field.
		///	designer:fld/LVAR6/LVOI63
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOI63]", IsVirtual=true)]
		public string MainPhone
		{
			get
			{
			...
			{
				string oldValue = this.MainPhone;
				if (oldValue != value || !this.IsFieldDefined("[LVOI63]"))
				{
					this.OnMainPhoneChanging (oldValue, value);
					this.SetMainPhone (value);
					this.OnMainPhoneChanged (oldValue, value);
		...
		///	<summary>
		///	The <c>SecondaryPhone</c> field.
		///	designer:fld/LVAR6/LVOJ63
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOJ63]", IsVirtual=true)]
		public string SecondaryPhone
		{
			get
			{
			...
			{
				string oldValue = this.SecondaryPhone;
				if (oldValue != value || !this.IsFieldDefined("[LVOJ63]"))
				{
					this.OnSecondaryPhoneChanging (oldValue, value);
					this.SetSecondaryPhone (value);
					this.OnSecondaryPhoneChanged (oldValue, value);
...
namespace Epsitec.Aider.Entities
{
	...
	///	designer:cap/LVA2A
	///	</summary>
	public partial class AiderGroupDefEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IComment
	{
		#region IComment Members
		///	<summary>
		///	The <c>Comment</c> field.
		...
		///	designer:fld/LVA2A/LVABG
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVABG]")]
		public global::Epsitec.Aider.Entities.AiderGroupDefEntity Function
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderGroupDefEntity> ("[LVABG]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderGroupDefEntity oldValue = this.Function;
				if (oldValue != value || !this.IsFieldDefined("[LVABG]"))
				{
					this.OnFunctionChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderGroupDefEntity> ("[LVABG]", oldValue, value);
...
namespace Epsitec.Aider.Entities
{
	...
	public interface IAiderWarning : global::Epsitec.Aider.Entities.IDateRange
	{
		...
		///	<summary>
		///	The <c>WarningTarget</c> field.
		///	designer:fld/LVAEB/LVA5G
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVA5G]")]
		global::Epsitec.Aider.Enumerations.WarningTarget WarningTarget
		{
			get;
			set;
		}
	...
	public static partial class IAiderWarningInterfaceImplementation
	{
		...
		public static global::Epsitec.Aider.Enumerations.WarningTarget GetWarningTarget(global::Epsitec.Aider.Entities.IAiderWarning obj)
		{
			global::Epsitec.Common.Support.EntityEngine.AbstractEntity entity = obj as global::Epsitec.Common.Support.EntityEngine.AbstractEntity;
			return entity.GetField<global::Epsitec.Aider.Enumerations.WarningTarget> ("[LVA5G]");
		}
		public static void SetWarningTarget(global::Epsitec.Aider.Entities.IAiderWarning obj, global::Epsitec.Aider.Enumerations.WarningTarget value)
		{
			global::Epsitec.Common.Support.EntityEngine.AbstractEntity entity = obj as global::Epsitec.Common.Support.EntityEngine.AbstractEntity;
			global::Epsitec.Aider.Enumerations.WarningTarget oldValue = obj.WarningTarget;
			if (oldValue != value || !entity.IsFieldDefined("[LVA5G]"))
			{
				IAiderWarningInterfaceImplementation.OnWarningTargetChanging (obj, oldValue, value);
				entity.SetField<global::Epsitec.Aider.Enumerations.WarningTarget> ("[LVA5G]", oldValue, value);
				IAiderWarningInterfaceImplementation.OnWarningTargetChanged (obj, oldValue, value);
			}
		}
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderPersonWarningEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity, global::Epsitec.Aider.Entities.IAiderWarning
	{
		...
		///	<summary>
		///	The <c>WarningTarget</c> field.
		///	designer:fld/LVALB/LVA5G
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVA5G]")]
		public global::Epsitec.Aider.Enumerations.WarningTarget WarningTarget
		{
			get
			{
				return global::Epsitec.Aider.Entities.IAiderWarningInterfaceImplementation.GetWarningTarget (this);
			}
			set
			{
		...
		public string ParishGroupPath
		{
			get
			{
				return this.GetField<string> ("[LVQ002]");
			}
			set
			{
...
#region Epsitec.Aider.AiderDataManagers Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderDataManagers</c> entity.
	///	designer:cap/LVATF
	///	</summary>
	public partial class AiderDataManagersEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		///	<summary>
		///	The <c>DisplayName</c> field.
		///	designer:fld/LVATF/LVA4G
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVA4G]")]
		public string DisplayName
		{
			get
			{
				return this.GetField<string> ("[LVA4G]");
			}
			set
			{
				string oldValue = this.DisplayName;
				if (oldValue != value || !this.IsFieldDefined("[LVA4G]"))
				{
					this.OnDisplayNameChanging (oldValue, value);
					this.SetField<string> ("[LVA4G]", oldValue, value);
					this.OnDisplayNameChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>Users</c> field.
		///	designer:fld/LVATF/LVAUF
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAUF]")]
		public global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderUserEntity> Users
		{
			get
			{
				return this.GetFieldCollection<global::Epsitec.Aider.Entities.AiderUserEntity> ("[LVAUF]");
			}
		}
		///	<summary>
		///	The <c>ParishGroup</c> field.
		///	designer:fld/LVATF/LVA2G
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVA2G]")]
		public global::Epsitec.Aider.Entities.AiderGroupEntity ParishGroup
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVA2G]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderGroupEntity oldValue = this.ParishGroup;
				if (oldValue != value || !this.IsFieldDefined("[LVA2G]"))
				{
					this.OnParishGroupChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVA2G]", oldValue, value);
					this.OnParishGroupChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>ParishGroupPathCache</c> field.
		///	designer:fld/LVATF/LVA3G
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVA3G]")]
		public string ParishGroupPathCache
		{
			get
			{
				return this.GetField<string> ("[LVA3G]");
			}
			set
			{
				string oldValue = this.ParishGroupPathCache;
				if (oldValue != value || !this.IsFieldDefined("[LVA3G]"))
				{
					this.OnParishGroupPathCacheChanging (oldValue, value);
					this.SetField<string> ("[LVA3G]", oldValue, value);
					this.OnParishGroupPathCacheChanged (oldValue, value);
				}
			}
		}
		...
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderDataManagersEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderDataManagersEntity.EntityStructuredTypeKey;
		}
		public static readonly global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 10, 509);	// [LVATF]
		public static readonly string EntityStructuredTypeKey = "[LVATF]";
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderMailingEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		...
		public global::Epsitec.Aider.Entities.AiderMailingCategoryEntity Category
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderMailingCategoryEntity> ("[LVO313]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderMailingCategoryEntity oldValue = this.Category;
				if (oldValue != value || !this.IsFieldDefined("[LVO313]"))
				{
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderMailingParticipantEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		...
		///	<summary>
		///	The <c>ParticipantType</c> field.
		///	designer:fld/LVOL03/LVASH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVASH]")]
		public global::Epsitec.Aider.Enumerations.MailingParticipantType ParticipantType
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Enumerations.MailingParticipantType> ("[LVASH]");
			}
			set
			{
				global::Epsitec.Aider.Enumerations.MailingParticipantType oldValue = this.ParticipantType;
				if (oldValue != value || !this.IsFieldDefined("[LVASH]"))
				{
					this.OnParticipantTypeChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Enumerations.MailingParticipantType> ("[LVASH]", oldValue, value);
					this.OnParticipantTypeChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>IsExcluded</c> field.
		///	designer:fld/LVOL03/LVATH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVATH]")]
		public bool IsExcluded
		{
			get
			{
				return this.GetField<bool> ("[LVATH]");
			}
			set
			{
				bool oldValue = this.IsExcluded;
				if (oldValue != value || !this.IsFieldDefined("[LVATH]"))
				{
					this.OnIsExcludedChanging (oldValue, value);
					this.SetField<bool> ("[LVATH]", oldValue, value);
					this.OnIsExcludedChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		partial void OnParticipantTypeChanging(global::Epsitec.Aider.Enumerations.MailingParticipantType oldValue, global::Epsitec.Aider.Enumerations.MailingParticipantType newValue);
...
#region Epsitec.Aider.AiderMailingCategory Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderMailingCategory</c> entity.
	///	designer:cap/LVO013
	///	</summary>
	public partial class AiderMailingCategoryEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		...
		public string Name
		{
			get
			{
				return this.GetField<string> ("[LVO113]");
			}
			set
			{
				string oldValue = this.Name;
				if (oldValue != value || !this.IsFieldDefined("[LVO113]"))
				{
					this.OnNameChanging (oldValue, value);
					this.SetField<string> ("[LVO113]", oldValue, value);
					this.OnNameChanged (oldValue, value);
				}
			}
		}
		...
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVAKH]")]
		public global::Epsitec.Aider.Entities.AiderGroupEntity Group
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVAKH]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderGroupEntity oldValue = this.Group;
				if (oldValue != value || !this.IsFieldDefined("[LVAKH]"))
				{
					this.OnGroupChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVAKH]", oldValue, value);
					this.OnGroupChanged (oldValue, value);
				}
			}
		}
		...
		///	designer:fld/LVO013/LVALH
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVALH]")]
		public string GroupPathCache
		{
			get
			{
				return this.GetField<string> ("[LVALH]");
			}
			set
			{
				string oldValue = this.GroupPathCache;
				if (oldValue != value || !this.IsFieldDefined("[LVALH]"))
				{
					this.OnGroupPathCacheChanging (oldValue, value);
					this.SetField<string> ("[LVALH]", oldValue, value);
		...
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderMailingCategoryEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderMailingCategoryEntity.EntityStructuredTypeKey;
		}
		public static readonly global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 32);	// [LVO013]
		public static readonly string EntityStructuredTypeKey = "[LVO013]";
...
#region Epsitec.Aider.AiderOfficeManagement Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderOfficeManagement</c> entity.
	///	designer:cap/LVO613
	///	</summary>
	public partial class AiderOfficeManagementEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		///	<summary>
		///	The <c>OfficeName</c> field.
		///	designer:fld/LVO613/LVO913
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO913]")]
		public string OfficeName
		{
			get
			{
				return this.GetField<string> ("[LVO913]");
			}
			set
			{
				string oldValue = this.OfficeName;
				if (oldValue != value || !this.IsFieldDefined("[LVO913]"))
				{
					this.OnOfficeNameChanging (oldValue, value);
					this.SetField<string> ("[LVO913]", oldValue, value);
					this.OnOfficeNameChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO713]")]
		public global::Epsitec.Aider.Entities.AiderGroupEntity ParishGroup
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVO713]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderGroupEntity oldValue = this.ParishGroup;
				if (oldValue != value || !this.IsFieldDefined("[LVO713]"))
				{
					this.OnParishGroupChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderGroupEntity> ("[LVO713]", oldValue, value);
					this.OnParishGroupChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>ParishGroupPathCache</c> field.
		///	designer:fld/LVO613/LVO813
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVO813]")]
		public string ParishGroupPathCache
		{
			get
			{
				return this.GetField<string> ("[LVO813]");
			}
			set
			{
				string oldValue = this.ParishGroupPathCache;
				if (oldValue != value || !this.IsFieldDefined("[LVO813]"))
				{
					this.OnParishGroupPathCacheChanging (oldValue, value);
					this.SetField<string> ("[LVO813]", oldValue, value);
					this.OnParishGroupPathCacheChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>OfficeMainContact</c> field.
		///	designer:fld/LVO613/LVOU23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOU23]")]
		public global::Epsitec.Aider.Entities.AiderContactEntity OfficeMainContact
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOU23]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderContactEntity oldValue = this.OfficeMainContact;
				if (oldValue != value || !this.IsFieldDefined("[LVOU23]"))
				{
					this.OnOfficeMainContactChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOU23]", oldValue, value);
					this.OnOfficeMainContactChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>PostalTown</c> field.
		///	designer:fld/LVO613/LVOV23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOV23]")]
		public global::Epsitec.Aider.Entities.AiderTownEntity PostalTown
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderTownEntity> ("[LVOV23]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderTownEntity oldValue = this.PostalTown;
				if (oldValue != value || !this.IsFieldDefined("[LVOV23]"))
				{
					this.OnPostalTownChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderTownEntity> ("[LVOV23]", oldValue, value);
		...
		///	<summary>
		///	The <c>EventsInPreparation</c> field.
		///	designer:fld/LVO613/LVOG53
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOG53]", IsVirtual=true)]
		public global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderEventEntity> EventsInPreparation
		{
			get
			{
				...
				this.GetEventsInPreparation (ref value);
				return value;
			}
		}
		///	<summary>
		///	The <c>EventsToValidate</c> field.
		///	designer:fld/LVO613/LVOH53
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOH53]", IsVirtual=true)]
		public global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderEventEntity> EventsToValidate
		{
			get
			{
				global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderEventEntity> value = default (global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderEventEntity>);
				this.GetEventsToValidate (ref value);
				return value;
			}
		}
		///	<summary>
		...
		partial void OnParishGroupPathCacheChanging(string oldValue, string newValue);
		partial void OnParishGroupPathCacheChanged(string oldValue, string newValue);
		partial void OnOfficeMainContactChanging(global::Epsitec.Aider.Entities.AiderContactEntity oldValue, global::Epsitec.Aider.Entities.AiderContactEntity newValue);
		...
		partial void GetEventsToValidate(ref global::System.Collections.Generic.IList<global::Epsitec.Aider.Entities.AiderEventEntity> value);
		...
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeManagementEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeManagementEntity.EntityStructuredTypeKey;
		}
		public static readonly global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 38);	// [LVO613]
		public static readonly string EntityStructuredTypeKey = "[LVO613]";
		
		#region Repository Class
		public partial class Repository : global::Epsitec.Cresus.Core.Repositories.Repository<AiderOfficeManagementEntity>
		{
			public Repository(global::Epsitec.Cresus.Core.CoreData data, global::Epsitec.Cresus.DataLayer.Context.DataContext dataContext) : base(data, dataContext, global::Epsitec.Common.Types.DataLifetimeExpectancy.Stable)
			{
			}
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderOfficeSenderEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		///	<summary>
		///	The <c>Name</c> field.
		///	designer:fld/LVOA13/LVOK13
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOK13]")]
		public string Name
		{
			get
			{
				return this.GetField<string> ("[LVOK13]");
			}
			set
			{
				string oldValue = this.Name;
				if (oldValue != value || !this.IsFieldDefined("[LVOK13]"))
				{
					this.OnNameChanging (oldValue, value);
					this.SetField<string> ("[LVOK13]", oldValue, value);
					this.OnNameChanged (oldValue, value);
				}
			}
		}
		...
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOI13]")]
		public global::Epsitec.Aider.Entities.AiderOfficeManagementEntity Office
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderOfficeManagementEntity> ("[LVOI13]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderOfficeManagementEntity oldValue = this.Office;
				if (oldValue != value || !this.IsFieldDefined("[LVOI13]"))
				{
					this.OnOfficeChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderOfficeManagementEntity> ("[LVOI13]", oldValue, value);
					this.OnOfficeChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>OfficialContact</c> field.
		///	designer:fld/LVOA13/LVOD13
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOD13]")]
		public global::Epsitec.Aider.Entities.AiderContactEntity OfficialContact
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOD13]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderContactEntity oldValue = this.OfficialContact;
				if (oldValue != value || !this.IsFieldDefined("[LVOD13]"))
				{
					this.OnOfficialContactChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOD13]", oldValue, value);
					this.OnOfficialContactChanged (oldValue, value);
				}
			}
		}
...
namespace Epsitec.Aider.Entities
{
	...
	public partial class AiderOfficeReportEntity : global::Epsitec.Common.Support.EntityEngine.AbstractEntity
	{
		///	<summary>
		///	The <c>Name</c> field.
		///	designer:fld/LVOE23/LVOF23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOF23]")]
		public string Name
		{
			get
			{
				return this.GetField<string> ("[LVOF23]");
			}
			set
			{
				string oldValue = this.Name;
				if (oldValue != value || !this.IsFieldDefined("[LVOF23]"))
				{
					this.OnNameChanging (oldValue, value);
					this.SetField<string> ("[LVOF23]", oldValue, value);
					this.OnNameChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>CreationDate</c> field.
		///	designer:fld/LVOE23/LVOG23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOG23]")]
		public global::Epsitec.Common.Types.Date CreationDate
		{
			get
			{
				return this.GetField<global::Epsitec.Common.Types.Date> ("[LVOG23]");
			}
			set
			{
				global::Epsitec.Common.Types.Date oldValue = this.CreationDate;
				if (oldValue != value || !this.IsFieldDefined("[LVOG23]"))
				{
					this.OnCreationDateChanging (oldValue, value);
					this.SetField<global::Epsitec.Common.Types.Date> ("[LVOG23]", oldValue, value);
					this.OnCreationDateChanged (oldValue, value);
				}
			}
		}
		...
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOM23]")]
		public global::Epsitec.Aider.Entities.AiderOfficeManagementEntity Office
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderOfficeManagementEntity> ("[LVOM23]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderOfficeManagementEntity oldValue = this.Office;
				if (oldValue != value || !this.IsFieldDefined("[LVOM23]"))
				{
					this.OnOfficeChanging (oldValue, value);
		...
		///	<summary>
		///	The <c>ProcessorUrl</c> field.
		///	designer:fld/LVOE23/LVOT23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOT23]")]
		public string ProcessorUrl
		{
			get
			{
				return this.GetField<string> ("[LVOT23]");
			}
			set
			{
				string oldValue = this.ProcessorUrl;
				if (oldValue != value || !this.IsFieldDefined("[LVOT23]"))
				{
					this.OnProcessorUrlChanging (oldValue, value);
					this.SetField<string> ("[LVOT23]", oldValue, value);
					this.OnProcessorUrlChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		public static readonly global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 78);	// [LVOE23]
		public static readonly string EntityStructuredTypeKey = "[LVOE23]";
...
#region Epsitec.Aider.AiderOfficeLetterReport Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderOfficeLetterReport</c> entity.
	///	designer:cap/LVOI23
	///	</summary>
	public partial class AiderOfficeLetterReportEntity : global::Epsitec.Aider.Entities.AiderOfficeReportEntity
	{
		///	<summary>
		///	The <c>RecipientContact</c> field.
		///	designer:fld/LVOI23/LVOJ23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOJ23]")]
		public global::Epsitec.Aider.Entities.AiderContactEntity RecipientContact
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOJ23]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderContactEntity oldValue = this.RecipientContact;
				if (oldValue != value || !this.IsFieldDefined("[LVOJ23]"))
				{
					this.OnRecipientContactChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderContactEntity> ("[LVOJ23]", oldValue, value);
					this.OnRecipientContactChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>TownAndDate</c> field.
		///	designer:fld/LVOI23/LVOK23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOK23]")]
		public string TownAndDate
		{
			get
			{
				return this.GetField<string> ("[LVOK23]");
			}
			set
			{
				string oldValue = this.TownAndDate;
				if (oldValue != value || !this.IsFieldDefined("[LVOK23]"))
				{
					this.OnTownAndDateChanging (oldValue, value);
					this.SetField<string> ("[LVOK23]", oldValue, value);
					this.OnTownAndDateChanged (oldValue, value);
				}
			}
		}
		...
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeLetterReportEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeLetterReportEntity.EntityStructuredTypeKey;
		}
		public static readonly new global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 82);	// [LVOI23]
		public static readonly new string EntityStructuredTypeKey = "[LVOI23]";
		
		#region Repository Class
		public new partial class Repository : global::Epsitec.Cresus.Core.Repositories.Repository<AiderOfficeLetterReportEntity>
		{
			public Repository(global::Epsitec.Cresus.Core.CoreData data, global::Epsitec.Cresus.DataLayer.Context.DataContext dataContext) : base(data, dataContext, global::Epsitec.Common.Types.DataLifetimeExpectancy.Volatile)
			{
			}
...
#region Epsitec.Aider.AiderOfficeGroupParticipantReport Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderOfficeGroupParticipantReport</c> entity.
	///	designer:cap/LVOP23
	///	</summary>
	public partial class AiderOfficeGroupParticipantReportEntity : global::Epsitec.Aider.Entities.AiderOfficeReportEntity
	{
		///	<summary>
		///	The <c>Title</c> field.
		///	designer:fld/LVOP23/LVOQ23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOQ23]")]
		public string Title
		{
			get
			{
				return this.GetField<string> ("[LVOQ23]");
			}
			set
			{
				string oldValue = this.Title;
				if (oldValue != value || !this.IsFieldDefined("[LVOQ23]"))
				{
					this.OnTitleChanging (oldValue, value);
					this.SetField<string> ("[LVOQ23]", oldValue, value);
					this.OnTitleChanged (oldValue, value);
				}
			}
		}
		...
		///	designer:fld/LVOP23/LVOS23
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOS23]")]
		public global::System.Byte[] Content
		{
			get
			{
				return this.GetField<global::System.Byte[]> ("[LVOS23]");
			}
			set
			{
				global::System.Byte[] oldValue = this.Content;
				if (oldValue != value || !this.IsFieldDefined("[LVOS23]"))
				{
					this.OnContentChanging (oldValue, value);
					this.SetField<global::System.Byte[]> ("[LVOS23]", oldValue, value);
					this.OnContentChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		...
		partial void OnTitleChanging(string oldValue, string newValue);
		partial void OnTitleChanged(string oldValue, string newValue);
		partial void OnContentChanging(global::System.Byte[] oldValue, global::System.Byte[] newValue);
		partial void OnContentChanged(global::System.Byte[] oldValue, global::System.Byte[] newValue);
		partial void OnGroupChanging(global::Epsitec.Aider.Entities.AiderGroupEntity oldValue, global::Epsitec.Aider.Entities.AiderGroupEntity newValue);
		partial void OnGroupChanged(global::Epsitec.Aider.Entities.AiderGroupEntity oldValue, global::Epsitec.Aider.Entities.AiderGroupEntity newValue);
		...
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeGroupParticipantReportEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderOfficeGroupParticipantReportEntity.EntityStructuredTypeKey;
		}
		public static readonly new global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 89);	// [LVOP23]
		public static readonly new string EntityStructuredTypeKey = "[LVOP23]";
...
#region Epsitec.Aider.AiderEventOfficeReport Entity
namespace Epsitec.Aider.Entities
{
	///	<summary>
	///	The <c>AiderEventOfficeReport</c> entity.
	///	designer:cap/LVOB63
	///	</summary>
	public partial class AiderEventOfficeReportEntity : global::Epsitec.Aider.Entities.AiderOfficeReportEntity
	{
		///	<summary>
		///	The <c>Event</c> field.
		///	designer:fld/LVOB63/LVOC63
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOC63]")]
		public global::Epsitec.Aider.Entities.AiderEventEntity Event
		{
			get
			{
				return this.GetField<global::Epsitec.Aider.Entities.AiderEventEntity> ("[LVOC63]");
			}
			set
			{
				global::Epsitec.Aider.Entities.AiderEventEntity oldValue = this.Event;
				if (oldValue != value || !this.IsFieldDefined("[LVOC63]"))
				{
					this.OnEventChanging (oldValue, value);
					this.SetField<global::Epsitec.Aider.Entities.AiderEventEntity> ("[LVOC63]", oldValue, value);
					this.OnEventChanged (oldValue, value);
				}
			}
		}
		...
		///	<summary>
		///	Par année et registre
		///	designer:fld/LVOB63/LVOO73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOO73]")]
		public int EventNumberByYearAndRegistry
		{
			get
			{
				return this.GetField<int> ("[LVOO73]");
			}
			set
			{
				int oldValue = this.EventNumberByYearAndRegistry;
				if (oldValue != value || !this.IsFieldDefined("[LVOO73]"))
				{
					this.OnEventNumberByYearAndRegistryChanging (oldValue, value);
					this.SetField<int> ("[LVOO73]", oldValue, value);
					this.OnEventNumberByYearAndRegistryChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>EventCode</c> field.
		///	designer:fld/LVOB63/LVOQ73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOQ73]", IsVirtual=true)]
		public string EventCode
		{
			get
			{
				string value = default (string);
				this.GetEventCode (ref value);
				return value;
			}
			set
			{
				string oldValue = this.EventCode;
				if (oldValue != value || !this.IsFieldDefined("[LVOQ73]"))
				{
					this.OnEventCodeChanging (oldValue, value);
					this.SetEventCode (value);
					this.OnEventCodeChanged (oldValue, value);
				}
			}
		}
		///	<summary>
		///	The <c>Year</c> field.
		///	designer:fld/LVOB63/LVOR73
		///	</summary>
		[global::Epsitec.Common.Support.EntityField ("[LVOR73]")]
		public int Year
		{
			get
			{
				return this.GetField<int> ("[LVOR73]");
			}
			set
			{
				int oldValue = this.Year;
				if (oldValue != value || !this.IsFieldDefined("[LVOR73]"))
				{
					this.OnYearChanging (oldValue, value);
					this.SetField<int> ("[LVOR73]", oldValue, value);
					this.OnYearChanged (oldValue, value);
				}
			}
		}
		...
		partial void OnEventNumberByYearAndRegistryChanging(int oldValue, int newValue);
		partial void OnEventNumberByYearAndRegistryChanged(int oldValue, int newValue);
		partial void OnEventCodeChanging(string oldValue, string newValue);
		partial void OnEventCodeChanged(string oldValue, string newValue);
		partial void OnYearChanging(int oldValue, int newValue);
		partial void OnYearChanged(int oldValue, int newValue);
		
		partial void GetEventCode(ref string value);
		partial void SetEventCode(string value);
		
		public override global::Epsitec.Common.Support.Druid GetEntityStructuredTypeId()
		{
			return global::Epsitec.Aider.Entities.AiderEventOfficeReportEntity.EntityStructuredTypeId;
		}
		public override string GetEntityStructuredTypeKey()
		{
			return global::Epsitec.Aider.Entities.AiderEventOfficeReportEntity.EntityStructuredTypeKey;
		}
		public static readonly new global::Epsitec.Common.Support.Druid EntityStructuredTypeId = new global::Epsitec.Common.Support.Druid (1013, 120, 203);	// [LVOB63]
		public static readonly new string EntityStructuredTypeKey = "[LVOB63]";
