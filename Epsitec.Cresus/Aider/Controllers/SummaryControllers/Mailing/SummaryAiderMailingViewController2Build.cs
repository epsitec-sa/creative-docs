	...
	public sealed class SummaryAiderMailingViewController2Build : SummaryViewController<AiderMailingEntity>
	{
		protected override void CreateBricks(BrickWall<AiderMailingEntity> wall)
		{
			...
			wall.AddBrick (p => p.Queries)
					...
					.EnableActionMenu<ActionAiderMailingViewController25AddAiderEmployeeQuery> ()
					.EnableActionButton<ActionAiderMailingViewController25AddAiderEmployeeQuery> ()
					.EnableActionMenu<ActionAiderMailingViewController21AddEmployeeQuery> ()
					...
					.EnableActionMenu<ActionAiderMailingViewController24AddLegalPersonQuery> ()
					.EnableActionButton<ActionAiderMailingViewController24AddLegalPersonQuery> ()
