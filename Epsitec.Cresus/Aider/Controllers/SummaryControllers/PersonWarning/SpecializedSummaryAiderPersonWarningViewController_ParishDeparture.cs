...
{
	public sealed class SpecializedSummaryAiderPersonWarningViewController_ParishDeparture : SpecializedSummaryAiderPersonWarningViewController
	{
		protected override void CreateBricks(BrickWall<AiderPersonWarningEntity> wall)
		{
			wall.AddBrick ()
				...
				.EnableActionButton<ActionAiderPersonWarningViewController31ProcessParishDeparture> ();
		}
	}
}
