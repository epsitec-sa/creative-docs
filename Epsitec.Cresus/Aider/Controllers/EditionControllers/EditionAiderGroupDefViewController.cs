	...
	public sealed class EditionAiderGroupDefViewController : EditionViewController<AiderGroupDefEntity>
	{
		protected override void CreateBricks(BrickWall<AiderGroupDefEntity> wall)
		{
			...
			wall.AddBrick ()
				...
				.EnableActionMenu<ActionAiderGroupDefViewController5DeleteFunction> ().IfTrue (this.Entity.Classification == Enumerations.GroupClassification.Function)
				.EnableActionMenu<ActionAiderGroupDefViewController1AssignFunctions> ().IfTrue (this.Entity.Classification != Enumerations.GroupClassification.Function)
				.EnableActionMenu<ActionAiderGroupDefViewController2DeleteAll> ().IfTrue (this.Entity.Classification != Enumerations.GroupClassification.Function)
				.EnableActionMenu<ActionAiderGroupDefViewController3Move> ().IfTrue (this.Entity.Classification != Enumerations.GroupClassification.Function)
