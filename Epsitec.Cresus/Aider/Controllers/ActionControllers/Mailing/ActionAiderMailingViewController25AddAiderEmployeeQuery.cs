...
{
	[ControllerSubType (25)]
	public sealed class ActionAiderMailingViewController25AddAiderEmployeeQuery : ActionViewController<AiderMailingEntity>
	{
		...
		{
			return Resources.FormattedText ("AIDER");
		}
		...
		protected override void GetForm(ActionBrick<AiderMailingEntity, SimpleBrick<AiderMailingEntity>> form)
		{
			...
			form
				.Title ("Ajouter une requête sur les collaborateurs AIDER")
				.Field<List<string>> ()
					.Title ("Requête")
