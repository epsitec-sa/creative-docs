...
{
	[ControllerSubType (23)]
	public sealed class ActionAiderMailingViewController23AddHouseholdQuery : ActionViewController<AiderMailingEntity>
	{
		...
		{
			var contactDataset      = Res.Commands.Base.ShowAiderHousehold.CommandId;
		...
		{
			var dataset   = Res.Commands.Base.ShowAiderHousehold.CommandId;
