...
{
	[ControllerSubType (24)]
	public sealed class ActionAiderMailingViewController24AddLegalPersonQuery : ActionViewController<AiderMailingEntity>
	{
		...
		{
			return Resources.FormattedText ("P. Morales");
		}
		...
		{
			var contactDataset      = Res.Commands.Base.ShowAiderLegalPerson.CommandId;
			...
			form
				.Title ("Ajouter une requête sur les p. morales")
				.Field<List<string>> ()
					.Title ("Requête")
		...
		{
			var dataset   = Res.Commands.Base.ShowAiderLegalPerson.CommandId;
