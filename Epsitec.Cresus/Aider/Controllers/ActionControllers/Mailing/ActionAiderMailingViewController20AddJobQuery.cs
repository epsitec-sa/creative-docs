...
namespace Epsitec.Aider.Controllers.ActionControllers
{
	...
	public sealed class ActionAiderMailingViewController20AddJobQuery : ActionViewController<AiderMailingEntity>
	{
		...
		{
			return Resources.FormattedText ("Postes");
		}
		...
		{
			var contactDataset      = Res.Commands.Base.ShowAiderEmployeeJobOnlyJobs.CommandId;
			...
			form
				.Title ("Ajouter une requête sur les postes")
				.Field<List<string>> ()
					.Title ("Requête")
		...
		{
			var dataset   = Res.Commands.Base.ShowAiderEmployeeJobOnlyJobs.CommandId;
