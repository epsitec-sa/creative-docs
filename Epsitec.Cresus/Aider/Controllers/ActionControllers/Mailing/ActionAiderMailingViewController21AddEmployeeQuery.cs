...
namespace Epsitec.Aider.Controllers.ActionControllers
{
	...
	public sealed class ActionAiderMailingViewController21AddEmployeeQuery : ActionViewController<AiderMailingEntity>
	{
		...
		{
			var contactDataset      = Res.Commands.Base.ShowAiderEmployee.CommandId;
		...
		{
			var dataset   = Res.Commands.Base.ShowAiderEmployee.CommandId;
