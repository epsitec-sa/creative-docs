...
namespace Epsitec.Common.Widgets
{
	...
	/// </summary>
	public class IconEditor : Widget
	{
		public IconEditor()
		{
			Epsitec.Common.Support.ImageProvider.RegisterAssembly("Epsitec.Common.NiceIcon", this.GetType().Assembly);
		...
		protected void CreateLayout()
		{
			...
			this.toolBar.Items.Add(new IconButton(@"manifest:Epsitec.Common.NiceIcon/Images.new.png"));
