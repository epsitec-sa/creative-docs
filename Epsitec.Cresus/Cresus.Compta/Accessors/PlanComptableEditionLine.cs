	...
	public class PlanComptableEditionLine : AbstractEditionLine
	{
		...
		private void ValidateNuméro(EditionData data)
		{
			...
			if (data.HasText)
			{
				...
				var himself = (this.controller.DataAccessor.JustCreated || this.controller.EditionController.Duplicate) ? null : this.controller.DataAccessor.GetEditionEntity (this.controller.DataAccessor.FirstEditedRow) as ComptaCompteEntity;
