...
{
	public class OpenMetaController : AbstractMetaController
	{
		public OpenMetaController(ComptaApplication app, BusinessContext businessContext, MainWindowController mainWindowController)
		...
		protected override MetaControllerType MetaControllerType
		{
			get
			{
				return MetaControllerType.Open;
			}
		}
