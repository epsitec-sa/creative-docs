...
{
	public class JournalMetaController : AbstractMetaController
	{
		public JournalMetaController(ComptaApplication app, BusinessContext businessContext, MainWindowController mainWindowController)
		...
		protected override MetaControllerType MetaControllerType
		{
			get
			{
				return MetaControllerType.Journal;
			}
		}
