...
{
	public class RéglagesMetaController : AbstractMetaController
	{
		public RéglagesMetaController(ComptaApplication app, BusinessContext businessContext, MainWindowController mainWindowController)
		...
		protected override MetaControllerType MetaControllerType
		{
			get
			{
				return MetaControllerType.Réglages;
			}
		}
