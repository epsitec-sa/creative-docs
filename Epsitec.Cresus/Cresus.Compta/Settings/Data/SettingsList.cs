...
namespace Epsitec.Cresus.Compta.Settings.Data
{
	...
	public class SettingsList
	{
		...
		private void Initialize()
		{
			...
			this.Add (new BoolSettingData    (SettingsGroup.Ecriture, SettingsType.EcritureMontantZéro,      false));
			...
			this.Add (new IntSettingData     (SettingsGroup.Ecriture, SettingsType.EcritureMultiEditionLineCount, 20, 3, 50));
