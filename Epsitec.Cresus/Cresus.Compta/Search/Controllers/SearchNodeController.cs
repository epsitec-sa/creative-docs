...
{
	/// <summary>
	/// Contrôleur gérant la saisie du noeud d'un critère SearchNodeData pour les recherches ou les filtres.
	/// Ce contrôleur utilise SearchTabController pour les lignes.
	/// </summary>
