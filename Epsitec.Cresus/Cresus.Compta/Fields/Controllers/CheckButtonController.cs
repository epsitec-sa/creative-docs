...
namespace Epsitec.Cresus.Compta.Fields.Controllers
{
	...
	{
		public CheckButtonController(AbstractController controller, int line, ColumnMapper columnMapper, System.Action<int, ColumnType> setFocusAction = null, System.Action contentChangedAction = null)
		...
		public override void CreateUI(Widget parent)
		{
			...
			this.editWidget = new CheckButton
			{
				...
				Dock            = DockStyle.Fill,
				TabIndex        = 1,
				Margins         = new Margins (this.HasRighrFooter ? 0:10, 0, 0, 0),
			};
