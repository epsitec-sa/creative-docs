...
{
	/// <summary>
	/// Contrôleur générique permettant l'édition d'un champ "mot de passe".
	/// </summary>
	public class PasswordFieldController : AbstractFieldController
	{
		public PasswordFieldController(AbstractController controller, int line, ColumnMapper columnMapper, System.Action<int, ColumnType> setFocusAction = null, System.Action contentChangedAction = null)
		...
		public override void WidgetToEditionData()
		{
			if (this.editionData != null)
			{
				if (this.dirty)
				{
					this.editionData.Text = Strings.ComputeMd5Hash (this.InternalField.Text);
				}
