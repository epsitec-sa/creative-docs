...
namespace Epsitec.Cresus.Compta.Controllers
{
	...
	public class LibellésController : AbstractController
	{
			...
			: base (app, businessContext, mainWindowController)
		{
			...
			this.viewSettingsList = this.mainWindowController.GetViewSettingsList ("Présentation.Libellés.ViewSettings");
		}
		...
		{
			this.editionController = new LibellésEditorController (this);
