...
namespace Epsitec.Cresus.Compta.Controllers
{
	...
	public class BudgetsController : AbstractController
	{
		...
		public override ControllerType ControllerType
		{
			get
			{
				return Controllers.ControllerType.Budgets;
			}
		}
		...
		private void PutContextMenuPlanComptable(VMenu menu)
		{
			...
			var item = this.PutContextMenuItem (menu, Présentations.GetIcon (ControllerType.PlanComptable), string.Format ("Définition du compte {0}", compte.Numéro));
