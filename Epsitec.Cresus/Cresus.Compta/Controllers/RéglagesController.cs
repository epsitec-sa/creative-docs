...
namespace Epsitec.Cresus.Compta.Controllers
{
	...
	public class RéglagesController : AbstractController
	{
		...
		protected override ViewSettingsList DirectViewSettingsList
		{
			get
			{
				return this.mainWindowController.GetViewSettingsList (Présentations.GetViewSettingsKey (ControllerType.Réglages));
			}
		}
		...
		protected override ControllerType ControllerType
		{
			get
			{
				return Controllers.ControllerType.Réglages;
			}
		}
