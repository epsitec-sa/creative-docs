...
namespace Epsitec.Product.Aider
{
	public static class Res
	{
		...
		{
			//	designer:str/GUA0001
			public static global::Epsitec.Common.Types.FormattedText ProductName
			{
				get
				{
					return global::Epsitec.Product.Aider.Res.Strings.GetText (global::Epsitec.Common.Support.Druid.FromFieldId (167772160));
				}
			}
			...
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Product.Aider.Res.Strings.GetString (bundle, path));
			}
			
			private static global::Epsitec.Common.Types.FormattedText GetText(global::Epsitec.Common.Support.Druid druid)
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Product.Aider.Res.Strings.GetString (druid));
			}
		...
		static Res()
		{
			...
			Res._manager.DefineDefaultModuleName ("Product.Aider");
		}
		...
		private const int _moduleId = 2000;
	}
}
