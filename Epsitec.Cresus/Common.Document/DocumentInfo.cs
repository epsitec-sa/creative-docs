...
namespace Epsitec.Common.Document
{
    ...
    public abstract class DocumentInfo : ISerializable, IDocumentInfo
    {
        ...
        {
            get { return new Size(this.PageWidth, this.PageHeight); }
            set
            {
        ...
        public int ComplexObjectCount
        {
            ...
            get { return this.complexCount; }
            set { this.complexCount = value; }
        }

        public int FontCount
        {
            //	Nombre total de polices.
            get { return this.fontCount; }
            set { this.fontCount = value; }
        }
        ...
        public int ImageCount
        {
            ...
            set { this.imageCount = value; }
        }

        public long DocumentVersion
        {
            get { return this.documentVersion; }
            set { this.documentVersion = value; }
        }
        ...
        public void DefineDocumentVersion(System.Reflection.Assembly assembly)
        {
            ...
            this.documentVersion =
                ((long)(revision) << 32) + ((long)(version) << 16) + (long)(subversion);
        }
