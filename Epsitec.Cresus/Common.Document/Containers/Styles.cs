...
namespace Epsitec.Common.Document.Containers
{
    ...
    {
        public Styles(Document document)
            : base(document)
        {
            ...
            this.colorSelector.ColorPalette.ColorCollection = this.document
                .GlobalSettings
                .ColorCollection;
            this.colorSelector.CloseButtonVisibility = true;
            this.colorSelector.ColorChanged += new EventHandler<DependencyPropertyChangedEventArgs>(
                this.HandleColorSelectorChanged
            );
        ...
        protected void CreateAggregateToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.buttonAggregateNewEmpty,
                Res.Strings.Action.AggregateNewEmpty
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonAggregateNewAll,
                Res.Strings.Action.AggregateNewAll
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonAggregateDuplicate,
                Res.Strings.Action.AggregateDuplicate
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonAggregateDelete,
                Res.Strings.Action.AggregateDelete
            );
        }
        ...
        protected void CreateChildrenToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.dummyChildren,
                Res.Strings.Panel.AggregateChildren.Tooltip.Name
            );
        ...
        protected void CreateSelectorToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.buttonStyleDelete,
                Res.Strings.Action.AggregateStyleDelete
            );
        ...
        protected override void DoUpdateContent()
        {
            ...
            this.paragraphList.SelectedRank = this.document.GetSelectedTextStyle(
            ...
            this.characterList.SelectedRank = this.document.GetSelectedTextStyle(
                StyleCategory.Character
            );
        ...
        protected override void DoUpdateTextStyles(System.Collections.ArrayList textStyleList)
        {
            ...
            foreach (Text.TextStyle textStyle in textStyleList)
            {
                ...
                {
                    if (
                        textStyle.TextStyleClass == Common.Text.TextStyleClass.Paragraph
                    ...
                    if (
                        textStyle.TextStyleClass == Common.Text.TextStyleClass.Text
        ...
        protected void UpdateToolBar()
        {
            ...
            if (this.category == StyleCategory.Graphic)
            {
                ...
                this.buttonAggregateNewAll.Enable = (
                    !this.document.Modifier.IsTool || this.document.Modifier.TotalSelected > 0
                );
            ...
            if (
                this.category == StyleCategory.Paragraph
                || this.category == StyleCategory.Character
            )
            {
                ...
                if (sel != -1)
                {
                    ...
                    enableDelete =
                        !this.document.TextContext.StyleList.IsDefaultParagraphTextStyle(style)
                        && !this.document.TextContext.StyleList.IsDefaultTextTextStyle(style);
                }
        ...
        protected void UpdateSelector()
        {
                ...
                if (agg != null)
                {
                    ...
                    for (int i = 0; i < 100; i++)
                    {
                        if (table[i] != 0)
                        {
                            ...
                            IconButtonMark button = this.UpdateSelectorAdd(
                                width,
                                true,
                                name,
                                icon,
            ...
            if (this.category == StyleCategory.Paragraph)
            {
                ...
                if (sel != -1)
                {
                    ...
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Justif",
                        "TextJustif",
                        Res.Strings.TextPanel.Justif.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Leading",
                        "TextLeading",
                        Res.Strings.TextPanel.Leading.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Margins",
                        "TextMargins",
                        Res.Strings.TextPanel.Margins.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Spaces",
                        "TextSpaces",
                        Res.Strings.TextPanel.Spaces.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Keep",
                        "TextKeep",
                        Res.Strings.TextPanel.Keep.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Tabs",
                        "TextTabs",
                        Res.Strings.TextPanel.Tabs.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        enable,
                        "Generator",
                        "TextGenerator",
                        Res.Strings.TextPanel.Generator.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                        "Font",
                        "TextFont",
                        Res.Strings.TextPanel.Font.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        true,
                    ...
                    this.UpdateSelectorAdd(
                        ...
                        "Language",
                        "TextLanguage",
                        Res.Strings.TextPanel.Language.Title
                    );
                }
            }
            ...
            if (this.category == StyleCategory.Character)
            {
                ...
                if (sel != -1)
                {
                    ...
                    this.UpdateSelectorAdd(
                        ...
                        "Xscript",
                        "TextXscript",
                        Res.Strings.TextPanel.Xscript.Title
                    );
                    this.UpdateSelectorAdd(
                        Styles.selectorSize,
                        enable,
        ...
        protected IconButtonMark UpdateSelectorAdd(
            double width,
            bool enable,
            string name,
            string icon,
                ...
                if (sel != -1)
                {
                    ...
                    for (int i = 0; i < parents.Length; i++)
                    {
                        ...
                        if (builder.Length != 0)
                            builder.Append(", ");
                        builder.Append(
                            Misc.UserTextStyleName(
                                this.document.TextContext.StyleList.StyleMap.GetCaption(parent)
                            )
                        );
                    }
                }
        ...
        protected void UpdatePanel()
        {
            ...
            if (this.category == StyleCategory.Graphic)
            {
                ...
                if (property == null)
                {
                    ...
                    Properties.Aggregate agg =
                        this.document.Aggregates[sel] as Properties.Aggregate;
                    ...
                    this.styleBriefPanel.PreferredHeight = this
                        .styleBriefPanel.GetBestFitSize()
                        .Height;
            ...
            )
            {
                ...
                if (sel == -1)
                    return;
                Common.Text.TextStyle style = this.TextStyleList.List[sel];
                this.document.Wrappers.StyleTextWrapper.Attach(
                    style,
                    this.document.TextContext,
                    this.document.Modifier.OpletQueue
                );
                this.document.Wrappers.StyleParagraphWrapper.Attach(
                    style,
                    this.document.TextContext,
                    this.document.Modifier.OpletQueue
                );
        ...
        public void SetCategory(string name)
        {
            ...
            this.SetCategory(
                ...
                Res.Strings.Panel.AggregateCategory.Graphic,
                (this.category == StyleCategory.Graphic)
            );
            this.SetCategory(
                this.categoryParagraph,
                Res.Strings.Panel.AggregateCategory.Paragraph,
                (this.category == StyleCategory.Paragraph)
            );
            this.SetCategory(
                this.categoryCharacter,
                Res.Strings.Panel.AggregateCategory.Character,
                (this.category == StyleCategory.Character)
            );
        }
        ...
        protected void StylesShiftRanks(int startRank)
        {
            ...
            foreach (Text.TextStyle style in styles)
            {
                ...
                if (rank >= startRank)
                {
                    this.document.TextContext.StyleList.StyleMap.SetRank(
                        this.document.Modifier.OpletQueue,
                        style,
                        rank + 1
                    );
        ...
        private void HandleButtonAggregateNewEmpty(object sender, MessageEventArgs e)
        {
            ...
            {
                Common.Text.TextStyleClass type =
                    (this.category == StyleCategory.Paragraph)
                        ? Common.Text.TextStyleClass.Paragraph
                        : Common.Text.TextStyleClass.Text;
                ...
                this.document.Modifier.OpletQueueBeginAction(
                    (this.category == StyleCategory.Paragraph)
                        ? Res.Strings.Action.AggregateNewParagraph
                        : Res.Strings.Action.AggregateNewCharacter
                );

                Text.TextStyle style = this.document.TextContext.StyleList.NewTextStyle(
                    this.document.Modifier.OpletQueue,
                    null,
                    type,
                    properties,
                ...
                this.document.TextContext.StyleList.StyleMap.SetCaption(
                    this.document.Modifier.OpletQueue,
                    style,
                    this.document.Modifier.GetNextTextStyleName(this.category)
                );
                this.document.TextContext.StyleList.StyleMap.SetRank(
                    this.document.Modifier.OpletQueue,
                    style,
        ...
        private void HandleButtonAggregateDuplicate(object sender, MessageEventArgs e)
        {
            ...
            )
            {
                ...
                string initialName = this.document.TextContext.StyleList.StyleMap.GetCaption(
                    initialStyle
                );
                ...
                this.document.TextContext.StyleList.SetNextStyle(
                    this.document.Modifier.OpletQueue,
                    style,
        ...
        private void HandleButtonAggregateDelete(object sender, MessageEventArgs e)
        {
            ...
            )
            {
                ...
                this.document.TextContext.StyleList.DeleteTextStyle(
                    this.document.Modifier.OpletQueue,
                    style
                );
        ...
        private void HandleButtonStyleDelete(object sender, MessageEventArgs e)
        {
            ...
            System.Diagnostics.Debug.Assert(this.category == StyleCategory.Graphic);
            Properties.Aggregate agg = this.GetAggregate();
            this.document.Modifier.AggregateStyleDelete(
                agg,
                Properties.Abstract.TypeName(this.SelectorName)
            );
            this.UpdateSelector();
            this.UpdatePanel();
        }
            ...
            if (this.category == StyleCategory.Paragraph)
            {
                ...
                for (int i = 1; i < styles.Length; i++) // saute le style de base (toujours le premier)
                {
                    ...
                    MenuItem item = new MenuItem(
                        ...
                        line,
                        "",
                        (i + 10000).ToString(System.Globalization.CultureInfo.InvariantCulture)
                    );
                    item.Pressed += this.HandleMenuChildrenPressed;
                    menu.Items.Add(item);
                    used++;
        ...
        private void HandleMenuChildrenPressed(object sender, MessageEventArgs e)
        {
            ...
            )
            {
                ...
                if (
                    this.category == StyleCategory.Paragraph
                    && newStyle.TextStyleClass == Common.Text.TextStyleClass.Paragraph
                )
                {
                    int j = 0;
                ...
                this.document.TextContext.StyleList.RedefineTextStyle(
                    this.document.Modifier.OpletQueue,
                    currentStyle,
        ...
        protected Properties.Aggregate GetAggregate()
        {
            ...
            if (sel == -1)
                return null;
            if (sel >= this.document.Aggregates.Count)
                return null;
        ...
        protected Widgets.TextStylesList TextStyleList
        {
            ...
            get
            {
                ...
                throw new System.ArgumentException(
                    "TextStyleList(" + this.category.ToString() + ")"
                );
            }
        }
