...
{
	/// <summary>
	/// La classe PanelLayerName permet de choisir le nom d'un calque.
	/// </summary>
	[SuppressBundleSupport]
	public class PanelLayerName : AbstractPanel
	{
		public PanelLayerName(Document document) : base(document)
		{
