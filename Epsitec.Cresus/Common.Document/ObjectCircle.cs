...
namespace Epsitec.Common.Document
{
	...
	{
		public ObjectCircle(Document document, AbstractObject model) : base(document, model)
		{
		...
		protected Path PathCircle(DrawingContext drawingContext, Point c, double rx, double ry)
		{
			...
			PropertyArc arc = this.PropertyArc;
			double a1, a2;
		...
		protected ObjectCircle(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		#endregion
	}
