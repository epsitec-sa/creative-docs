...
namespace Epsitec.Common.Document
{
	...
	{
		public PropertyJustif(Document document) : base(document)
		{
		...
		{
			return new PanelJustif(document);
		}
		...
		protected PropertyJustif(SerializationInfo info, StreamingContext context) : base(info, context)
		{
