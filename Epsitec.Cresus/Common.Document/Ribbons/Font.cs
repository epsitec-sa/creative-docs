    ...
    public class Font : Abstract
    {
        ...
        private void HandleButtonStyleClicked(object sender, MessageEventArgs e)
        {
            ...
            if (text != null)
            {
                ...
                Common.Text.TextStyle style = this.document.TextContext.StyleList[
                    "Default",
                ...
                {
                    if (
                        property.PropertyType != Common.Text.Properties.PropertyType.LocalSetting
                    ...
                    )
                    {
                        ...
                        {
                            list.Add(
                                this.document.TextContext.TabList.PromoteToSharedTabs(
                                    property as Common.Text.Properties.TabsProperty
                                )
                            );
                        }
                        else
