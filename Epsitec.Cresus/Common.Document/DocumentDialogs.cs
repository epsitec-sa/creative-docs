...
namespace Epsitec.Common.Document
{
    ...
    public class DocumentDialogs
    {
        ...
        protected void UpdateSettings(bool force)
        {
            ...
            if (!force)
            {
                if (this.windowSettings == null || !this.windowSettings.IsVisible)
                    return;
            }
        ...
        protected void UpdatePrint(bool force)
        {
            ...
            if (!force)
            {
                if (this.windowPrint == null || !this.windowPrint.IsVisible)
                    return;
            }
        ...
        protected void UpdateExport(bool force)
        {
            ...
            if (!force)
            {
                if (this.windowExport == null || !this.windowExport.IsVisible)
                    return;
            }
        ...
        protected void UpdateExportPDF(bool force)
        {
            ...
            if (!force)
            {
                if (this.windowExportPDF == null || !this.windowExportPDF.IsVisible)
                    return;
            }
        ...
        protected void UpdateExportICO(bool force)
        {
            ...
            if (!force)
            {
                if (this.windowExportICO == null || !this.windowExportICO.IsVisible)
                    return;
            }
        ...
        {
            //	Met à jour le dialogue des informations.
            if (this.windowGlyphs == null || !this.windowGlyphs.IsVisible)
                return;
        }
        #endregion
        ...
        private void HandleFilenameButtonClicked(object sender, MessageEventArgs e)
        {
            ...
            dialog.Filters.Add(
                "prn",
                TextLayout.ConvertToSimpleText(Res.Strings.Dialog.Print.ToFile.Type),
                "*.prn"
            );
        ...
        protected void UpdatePaper()
        {
            ...
            if (combo != null)
            {
                combo.SelectedItemIndex = DocumentDialogs.PaperSizeToRank(
                    this.document.DocumentSize
                );
            }
        ...
        protected static Size PaperRankToSize(int rank)
        {
            ...
            {
                case 1:
                    size = new Size(279.400, 186.182);
                    break; // Slide
                case 2:
                    size = new Size(215.900, 279.400);
                    break; // Lettre US
                case 3:
                    size = new Size(215.900, 355.600);
                    break; // Legal
                case 4:
                    size = new Size(279.400, 431.800);
                    break; // Tabloïd
                case 5:
                    size = new Size(139.700, 215.900);
                    break; // Letter - Half
                case 6:
                    size = new Size(177.800, 215.900);
                    break; // Legal - Half
                case 7:
                    size = new Size(184.150, 266.700);
                    break; // Executive US
                case 8:
                    size = new Size(279.400, 377.952);
                    break; // Listing
                case 9:
                    size = new Size(457.200, 609.600);
                    break; // Poster
                case 10:
                    size = new Size(594.000, 841.000);
                    break; // A1
                case 11:
                    size = new Size(420.000, 594.000);
                    break; // A2
                case 12:
                    size = new Size(329.000, 483.000);
                    break; // A3+
                case 13:
                    size = new Size(297.000, 420.000);
                    break; // A3
                case 14:
                    size = new Size(210.000, 297.000);
                    break; // A4
                case 15:
                    size = new Size(148.000, 210.000);
                    break; // A5
                case 16:
                    size = new Size(105.000, 148.000);
                    break; // A6
                case 17:
                    size = new Size(707.000, 1000.000);
                    break; // B1 (ISO)
                case 18:
                    size = new Size(250.000, 353.000);
                    break; // B4 (ISO)
                case 19:
                    size = new Size(176.000, 250.000);
                    break; // B5 (ISO)
                case 20:
                    size = new Size(257.000, 364.000);
                    break; // B4 (JIS)
                case 21:
                    size = new Size(182.000, 257.000);
                    break; // B5 (JIS)
                case 22:
                    size = new Size(324.000, 458.000);
                    break; // C3
                case 23:
                    size = new Size(229.000, 324.000);
                    break; // C4
                case 24:
                    size = new Size(162.000, 229.000);
                    break; // C5
                case 25:
                    size = new Size(114.000, 162.000);
                    break; // C6
                case 26:
                    size = new Size(430.000, 610.000);
                    break; // RA2
                case 27:
                    size = new Size(305.000, 430.000);
                    break; // RA3
                case 28:
                    size = new Size(215.000, 305.000);
                    break; // RA4
                case 29:
                    size = new Size(220.000, 110.000);
                    break; // DL
                case 30:
                    size = new Size(320.000, 450.000);
                    break; // SRA3
            }
            return size * 10.0;
        }
        ...
        protected static int PaperSizeToRank(Size size)
        {
            for (int rank = 1; rank <= DocumentDialogs.PaperList.Length; rank++)
            {
                ...
                if (size.Width == paper.Width && size.Height == paper.Height)
                    return rank;
                if (size.Width == paper.Height && size.Height == paper.Width)
                    return rank;
            }
            return 0;
        }
        ...
        protected void CreateRange(Widget parent, string name)
        {
            ...
            radio.ActiveState =
                (sRange.PrintRange == Settings.PrintRange.All) ? ActiveState.Yes : ActiveState.No;
            radio.TabIndex = this.tabIndex++;
            radio.TabNavigationMode = TabNavigationMode.ActivateOnTab;
        ...
        protected void UpdateDialogSettings(string dialog)
        {
            ...
            {
                Settings.Abstract setting = this.document.Settings.Get(i);
                if (dialog != this.document.Settings.GetOwnerDialog(setting.Name))
                    continue;
                ...
                if (setting is Settings.Integer)
                {
                    ...
                    TextFieldCombo combo =
                        this.WidgetsTableSearch(setting.Name, "") as TextFieldCombo;
                    if (combo != null)
                    {
                ...
                if (setting is Settings.Double)
                {
                    ...
                    TextFieldReal field =
                        this.WidgetsTableSearch(setting.Name, "") as TextFieldReal;
                    if (field != null)
                    {
                        field.InternalValue = (decimal)sDouble.Value;
                    }
            ...
            for (int i = 0; i < total; i++)
            {
                ...
                Settings.Bool sBool =
                    this.document.Settings.Get(setting.ConditionName) as Settings.Bool;
                if (sBool == null)
                    continue;
                this.EnableWidget(setting.Name, sBool.Value ^ setting.ConditionState);
            }
