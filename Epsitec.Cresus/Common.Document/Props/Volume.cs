...
namespace Epsitec.Common.Document.Properties
{
    ...
    public class Volume : Abstract
    {
        ...
        public override string SampleText
        {
            ...
            get { return Volume.GetName(this.volumeType); }
        }
        ...
        public static VolumeType ConvType(int index)
        {
            ...
            {
                case 0:
                    type = VolumeType.BoxClose;
                    break;
                case 1:
                    type = VolumeType.BoxOpen;
                    break;
                case 2:
                    type = VolumeType.Pyramid;
                    break;
                case 3:
        ...
        public static string GetName(VolumeType type)
        {
            ...
            switch (type)
            {
                case VolumeType.BoxClose:
                    name = Res.Strings.Property.Volume.BoxClose;
                    break;
                case VolumeType.BoxOpen:
                    name = Res.Strings.Property.Volume.BoxOpen;
                    break;
                case VolumeType.Pyramid:
                    name = Res.Strings.Property.Volume.Pyramid;
                    break;
                case VolumeType.Cylinder:
                    name = Res.Strings.Property.Volume.Cylinder;
                    break;
            }
            return name;
        }
        ...
        public static string GetIconText(VolumeType type)
        {
            ...
            {
                case VolumeType.BoxClose:
                    return "VolumeBoxClose";
                case VolumeType.BoxOpen:
                    return "VolumeBoxOpen";
                case VolumeType.Pyramid:
        ...
        public override bool Compare(Abstract property)
        {
            ...
            Volume p = property as Volume;
            if (p.volumeType != this.volumeType)
                return false;
            if (p.rapport != this.rapport)
                return false;
            if (p.angleLeft != this.angleLeft)
                return false;
            if (p.angleRight != this.angleRight)
                return false;
