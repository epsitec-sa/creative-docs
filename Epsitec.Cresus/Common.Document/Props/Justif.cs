...
namespace Epsitec.Common.Document.Properties
{
    ...
    public class Justif : Abstract
    {
        ...
        public static string GetName(JustifHorizontal type)
        {
            ...
            switch (type)
            {
                case JustifHorizontal.Left:
                    name = Res.Strings.Property.Justif.JustifHLeft;
                    break;
                case JustifHorizontal.Center:
                    name = Res.Strings.Property.Justif.JustifHCenter;
                    break;
                case JustifHorizontal.Right:
                    name = Res.Strings.Property.Justif.JustifHRight;
                    break;
                case JustifHorizontal.Justif:
                    name = Res.Strings.Property.Justif.JustifHJustif;
                    break;
                case JustifHorizontal.All:
                    name = Res.Strings.Property.Justif.JustifHAll;
                    break;
                case JustifHorizontal.Stretch:
                    name = Res.Strings.Property.Justif.JustifHStretch;
                    break;
            }
            return name;
        }
        ...
        public static string GetIconText(JustifHorizontal type)
        {
            ...
            switch (type)
            {
                case JustifHorizontal.Left:
                    return "JustifHLeft";
                case JustifHorizontal.Center:
                    return "JustifHCenter";
                case JustifHorizontal.Right:
                    return "JustifHRight";
                case JustifHorizontal.Justif:
                    return "JustifHJustif";
                case JustifHorizontal.All:
                    return "JustifHAll";
                case JustifHorizontal.Stretch:
                    return "JustifHStretch";
            }
            return "";
        }
        ...
        public static string GetName(JustifVertical type)
        {
            ...
            switch (type)
            {
                case JustifVertical.Top:
                    name = Res.Strings.Property.Justif.JustifVTop;
                    break;
                case JustifVertical.Center:
                    name = Res.Strings.Property.Justif.JustifVCenter;
                    break;
                case JustifVertical.Bottom:
                    name = Res.Strings.Property.Justif.JustifVBottom;
                    break;
            }
            return name;
        }
        ...
        public static string GetIconText(JustifVertical type)
        {
            ...
            switch (type)
            {
                case JustifVertical.Top:
                    return "JustifVTop";
                case JustifVertical.Center:
                    return "JustifVCenter";
                case JustifVertical.Bottom:
                    return "JustifVBottom";
            }
            return "";
        }
        ...
        public static string GetName(JustifOrientation type)
        {
            ...
            switch (type)
            {
                case JustifOrientation.LeftToRight:
                    name = Res.Strings.Property.Justif.JustifOLR;
                    break;
                case JustifOrientation.BottomToTop:
                    name = Res.Strings.Property.Justif.JustifOBT;
                    break;
                case JustifOrientation.RightToLeft:
                    name = Res.Strings.Property.Justif.JustifORL;
                    break;
                case JustifOrientation.TopToBottom:
                    name = Res.Strings.Property.Justif.JustifOTB;
                    break;
            }
            return name;
        }
        ...
        public override bool Compare(Abstract property)
        {
            ...
            if (p.horizontal != this.horizontal)
                return false;
            if (p.vertical != this.vertical)
                return false;
            if (p.orientation != this.orientation)
                return false;
            if (p.marginH != this.marginH)
                return false;
            if (p.marginV != this.marginV)
                return false;
            if (p.offsetV != this.offsetV)
                return false;
        ...
        public bool DeflateBox(ref Point pbl, ref Point pbr, ref Point ptl, ref Point ptr)
        {
            ...
            if (Point.Distance(pbl, pbr) <= mh * 2)
                return false;
            if (Point.Distance(pbl, ptl) <= mv * 2)
                return false;
        ...
        protected Justif(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
            ...
            this.orientation = (JustifOrientation)
                info.GetValue("Orientation", typeof(JustifOrientation));
