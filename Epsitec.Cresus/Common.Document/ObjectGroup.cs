...
namespace Epsitec.Common.Document
{
	...
	{
		public ObjectGroup(Document document, AbstractObject model) : base(document, model)
		{
		...
		{
			return new ObjectGroup(document, model);
		}
		...
		{
			foreach ( AbstractObject obj in this.document.Deep(this) )
			{
		...
		public void UpdateDim(Rectangle bbox)
		{
			this.InsertOpletGeometry();
		...
		protected ObjectGroup(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		#endregion
