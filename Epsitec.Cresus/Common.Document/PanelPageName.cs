...
{
	/// <summary>
	/// La classe PanelPageName permet de choisir le nom d'une page.
	/// </summary>
	[SuppressBundleSupport]
	public class PanelPageName : AbstractPanel
	{
		public PanelPageName(Document document) : base(document)
		{
