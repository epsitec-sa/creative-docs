...
namespace Epsitec.Common.Document
{
	...
	{
		public ObjectEllipse(Document document, AbstractObject model) : base(document, model)
		{
		...
		{
			return new ObjectEllipse(document, model);
		}
		...
		protected ObjectEllipse(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		#endregion
	}
