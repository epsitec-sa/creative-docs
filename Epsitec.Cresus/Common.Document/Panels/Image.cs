    ...
    public class Image : Abstract
    {
            ...
            : base(document)
        {
            ...
            ToolTip.Default.SetToolTip(
                this.fieldFilename,
                Res.Strings.Panel.Image.Tooltip.Filename
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonRotation90,
                Res.Strings.Panel.Image.Button.Rotation90
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonRotation180,
                Res.Strings.Panel.Image.Button.Rotation180
            );
            ...
            ToolTip.Default.SetToolTip(
                this.buttonRotation270,
                Res.Strings.Panel.Image.Button.Rotation270
            );
        ...
        public override double DefaultHeight
        {
            ...
            get { return (this.isExtendedSize ? this.LabelHeight + 245 : this.LabelHeight + 55); }
        }
        ...
        protected void AddFilterCombo(string icon, string text)
        {
            ...
            IconButtonCombo.Item item = new IconButtonCombo.Item(
                "",
                briefIcon,
                regularText,
                selectedText
        ...
        protected override void PropertyToWidgets()
        {
            ...
            this.buttonRotation90.ActiveState =
                p.RotationMode == Properties.Image.Rotation.Angle90
                    ? ActiveState.Yes
                    : ActiveState.No;
            this.buttonRotation180.ActiveState =
                p.RotationMode == Properties.Image.Rotation.Angle180
                    ? ActiveState.Yes
                    : ActiveState.No;
            this.buttonRotation270.ActiveState =
                p.RotationMode == Properties.Image.Rotation.Angle270
                    ? ActiveState.Yes
                    : ActiveState.No;
        ...
        protected override void WidgetsToProperty()
        {
            ...
            if (this.buttonRotation90.ActiveState == ActiveState.Yes)
                p.RotationMode = Properties.Image.Rotation.Angle90;
            else if (this.buttonRotation180.ActiveState == ActiveState.Yes)
                p.RotationMode = Properties.Image.Rotation.Angle180;
            else if (this.buttonRotation270.ActiveState == ActiveState.Yes)
                p.RotationMode = Properties.Image.Rotation.Angle270;
            else
                p.RotationMode = Properties.Image.Rotation.Angle0;
