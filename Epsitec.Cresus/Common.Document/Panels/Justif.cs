...
namespace Epsitec.Common.Document.Panels
{
    ...
    {
        public Justif(Document document)
            : base(document)
        {
            ...
            this.fieldMarginH = new Widgets.TextFieldLabel(
                this,
            ...
            this.fieldMarginV = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldOffsetV = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
        ...
        {
            this.gridHorizontal.AddRadioIcon(
                Misc.Icon(Properties.Justif.GetIconText(type)),
                Properties.Justif.GetName(type),
                (int)type,
                false
            );
        }
        ...
        {
            this.gridVertical.AddRadioIcon(
                Misc.Icon(Properties.Justif.GetIconText(type)),
                Properties.Justif.GetName(type),
                (int)type,
                false
        ...
        {
            this.gridOrientation.AddRadioIcon(
                Misc.Icon(Properties.Justif.GetIconText(type)),
                Properties.Justif.GetName(type),
                (int)type,
                false
        ...
        protected void EnableWidgets()
        {
            ...
            {
                Properties.JustifVertical v = (Properties.JustifVertical)
                    this.gridVertical.SelectedValue;
