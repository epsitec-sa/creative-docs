...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public abstract class AbstractStyleList : CellTable
    {
        ...
        {
            get { return (this.StyleH & CellArrayStyles.ScrollNorm) != 0; }
            set
            {
                if (value)
                {
        ...
        {
            get { return (this.StyleV & CellArrayStyles.ScrollNorm) != 0; }
            set
            {
                if (value)
                {
        ...
        public bool IsHiliteColumn
        {
            ...
            get { return this.isHiliteColumn; }
            set
            {
        ...
        public bool IsOrderColumn
        {
            ...
            get { return this.isOrderColumn; }
            set
            {
                this.isOrderColumn = value;
                if (this.isOrderColumn)
                    this.isHiliteColumn = false;
            }
        }
        ...
        public double FixWidth
        {
            ...
            get { return this.fixWidth; }
            set { this.fixWidth = value; }
        }
        ...
        public int RankToRow(int rank)
        {
            ...
            if (this.isNoneLine)
                rank++;
            if (this.excludeRank != -1 && rank - 1 == this.excludeRank)
                return -1;
            if (this.excludeRank != -1 && rank > this.excludeRank)
                rank--;
            return rank;
        }
        ...
        public int RowToRank(int row)
        {
            ...
            if (this.isNoneLine)
                row--;
            if (this.excludeRank != -1 && row >= this.excludeRank)
                row++;
            return row;
        }
        ...
        protected int NameColumn
        {
            ...
            get { return (this.isHiliteColumn || this.IsOrderColumn) ? 1 : 0; }
        }
