...
{
	/// <summary>
	/// La classe ContainerOper contient toutes les opérations.
	/// </summary>
	[SuppressBundleSupport]
	public class ContainerOper : AbstractContainer
	{
		public ContainerOper(Document document) : base(document)
		{
			// Déplacement.
