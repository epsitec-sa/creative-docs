...
{
	/// <summary>
	/// La classe PanelStyleName permet de choisir le nom du style.
	/// </summary>
	[SuppressBundleSupport]
	public class PanelStyleName : AbstractPanel
	{
		public PanelStyleName(Document document) : base(document)
		{
