...
{
	/// <summary>
	/// La classe ContainerPages contient tous les panneaux des pages.
	/// </summary>
	[SuppressBundleSupport]
	public class ContainerPages : AbstractContainer
	{
		public ContainerPages(Document document) : base(document)
		{
			...
			this.panelPageName = new PanelPageName(this.document);
		...
		{
			ObjectPage page = obj as ObjectPage;
		...
		protected void UpdateTable()
		{
			...
			UndoableList doc = this.document.Objects;
			for ( int i=0 ; i<rows ; i++ )
			{
				ObjectPage page = doc[i] as ObjectPage;
				this.TableFillRow(i);
		...
		protected void TableUpdateRow(int row, ObjectPage page)
		{
			DrawingContext context = this.document.Modifier.ActiveViewer.DrawingContext;
			StaticText st;
		...
		protected PanelPageName			panelPageName;
