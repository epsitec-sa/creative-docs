...
namespace Epsitec.Common.Document
{
    ...
    public class Viewer : Common.Widgets.Widget
    {
        ...
        private void HandleIsVisibleChanged(
            object sender,
        ...
        public bool IsMiniature
        {
            ...
            get { return this.isMiniature; }
            set { this.isMiniature = value; }
        }

        public bool IsLayerMiniature
        {
            //	Miniature d'un calque (si false, c'est une miniature d'une page).
            get { return this.isLayerMiniature; }
            set { this.isLayerMiniature = value; }
        }
        ...
        public double PictogramMiniatureZoom
        {
            ...
            get { return this.pictogramMiniatureZoom; }
            set { this.pictogramMiniatureZoom = value; }
        }

        public double MarkerVertical
        {
            //	Position horizontale du marqueur vertical.
            get { return this.markerVertical; }
            set
            {
        ...
        public double MarkerHorizontal
        {
            ...
            get { return this.markerHorizontal; }
            set
            {
        ...
        protected void AutoScrollTimerStart(Message message)
        {
            ...
            if (this.document.Modifier.Tool == "ToolHand")
                return;
        ...
        protected void HandleAutoScrollTimeElapsed(object sender)
        {
            ...
            if (this.mouseDragging && this.zoomShift)
                return;
            if (this.mouseDragging && this.guideInteractive != -1)
                return;
        ...
        protected override void ProcessMessage(Message message, Point pos)
        {
            ...
            //	qui est filtré ici !!!
            if (
                message.MessageType == MessageType.MouseMove
            ...
            switch (message.MessageType)
            {
                ...
                case MessageType.KeyDown:
                    ...
                    {
                        if (message.KeyCode == KeyCode.Back || message.KeyCode == KeyCode.Delete)
                        {
        ...
        protected void CreateMouseDown(Point mouse)
        {
            ...
            if (this.createRank == -1)
            {
                ...
                string name = string.Format(
                    Res.Strings.Action.ObjectCreate,
                    this.document.Modifier.ToolName(this.document.Modifier.Tool)
                );
                this.document.Modifier.OpletQueueBeginAction(name, "Create");
                Objects.Abstract obj = Objects.Abstract.CreateObject(
                    this.document,
                    this.document.Modifier.Tool,
        ...
        protected void CreateMouseUp(Point mouse)
        {
            ...
            if (obj.CreateIsEnding(this.drawingContext))
            {
                if (obj.CreateIsExist(this.drawingContext))
                {
                    ...
                    {
                        this.document.Modifier.TextFlowChange(
                            obj as Objects.AbstractText,
                            this.editFlowAfterCreate,
                            true
                        );
        ...
        protected void SelectMouseDown(Point mouse, int downCount, bool isRight, bool global)
        {
            ...
            else
            {
                ...
                if (
                    !this.drawingContext.IsShift
                    && !this.drawingContext.IsCtrl
                    && this.DetectHandle(mouse, out obj, out rank)
                )
                {
                ...
                else
                {
                    ...
                    if (obj == null)
                    {
                        ...
                        {
                            this.document.Modifier.OpletQueueNameAction(
                                Res.Strings.Action.GuideMove
                            );
                        ...
                        {
                            this.document.Modifier.OpletQueueNameAction(
                                Res.Strings.Action.SelectGlobal
                            );
                    ...
                    else
                    {
                        ...
                        {
                            this.document.Modifier.OpletQueueNameAction(
                                Res.Strings.Action.SelectObject
                            );
                            if (global)
                            {
                                this.selector.FixStarting(mouse);
                            ...
                            else
                            {
                                ...
                                if (this.selector.Visible && this.drawingContext.IsShift)
                                {
                                    ...
                                    this.SelectorInitialize(
                                        this.document.Modifier.SelectedBbox,
                                        0.0
                                    );
                                }
                            }
            ...
            if (this.mouseDragging) // bouton souris pressé ?
            {
                ...
                else if (this.moveObject != null && !this.drawingContext.IsShift)
                {
                    if (this.moveHandle != -1) // déplace une poignée ?
                    {
                        ...
                        this.moveObject.MoveHandleProcess(
                            this.moveHandle,
                            mouse,
                            this.drawingContext
                        );
                    ...
                    else // déplace tout l'objet ?
                    {
                        ...
                        {
                            this.document.Modifier.OpletQueueNameAction(
                                Res.Strings.Action.SelectAndMove
                            );
                        }
                        ...
                        if (this.moveAccept)
                        {
                            ...
                            this.hotSpotHandle.IsVisible = (
                                this.drawingContext.IsCtrl
                                || this.drawingContext.MagnetActiveAndExist
                            );
            ...
            else // bouton souris relâché ?
            {
                ...
                else if (!global && hiliteObj == null && this.GuideDetect(mouse, out guideRank))
                {
                    this.ChangeMouseCursor(
                        this.GuideIsHorizontal(guideRank)
                            ? MouseCursorType.HSplit
                            : MouseCursorType.VSplit
                    );
                }
                else
                {
                    ...
                    {
                        this.ChangeMouseCursor(
                            global ? MouseCursorType.ArrowGlobal : MouseCursorType.Arrow
                        );
                    }
                    else
                    {
        ...
        protected void SelectMouseUp(Point mouse, bool isRight, bool global)
        {
            ...
            if (this.moveAccept)
                mb = false;
            if (this.moveHandle != -1 && !Point.Equals(mouse, this.moveStart))
                mb = false;
            if (this.moveGlobal != -1)
                mb = false;
            ...
            else if (this.moveObject != null)
            {
                ...
                if (this.drawingContext.IsShift)
                {
                    ...
                    {
                        this.document.Modifier.OpletQueueNameAction(
                            Res.Strings.Action.SelectObjectAdd
                        );
                    }
                    else
                    {
                        this.document.Modifier.OpletQueueNameAction(
                            Res.Strings.Action.SelectObjectSub
                        );
                    }
                }
        ...
        protected void UpdateHotSpot()
        {
            ...
            if (this.moveObject == null || this.moveHandle != -1)
                return;
            if (this.document.Modifier.IsToolShaper)
                return;
            this.hotSpotHandle.IsVisible = (
                this.drawingContext.IsCtrl || this.drawingContext.MagnetActiveAndExist
            );
        }
        #endregion
        ...
        protected void ShaperMouseDown(Point mouse, int downCount, bool isRight)
        {
            ...
            if (this.DetectHandle(mouse, out obj, out rank))
            {
                if (this.drawingContext.IsShift)
                {
                    ...
                    {
                        this.document.Modifier.OpletQueueNameAction(
                            Res.Strings.Action.SelectHandleSub
                        );
                    }
                    else
                    {
                        this.document.Modifier.OpletQueueNameAction(
                            Res.Strings.Action.SelectHandleAdd
                        );
                    }
                }
                else
            ...
            else if (this.DetectSelectedSegmentHandle(mouse, out obj, out rank))
            {
                ...
                mouse -= this.moveOffset;
                this.moveObject.MoveSelectedSegmentStarting(
                    this.moveSelectedSegment,
                    mouse,
                    this.drawingContext
                );
            }
            else
            {
                ...
                else
                {
                    ...
                    if (this.DetectHandle(mouse, out obj, out rank))
                    {
                        ...
                        {
                            this.document.Modifier.OpletQueueNameAction(
                                Res.Strings.Action.SelectHandle
                            );
                        }
                        obj.SelectHandle(rank, this.drawingContext.IsShift);
                        this.moveHandle = rank;
                        this.moveOffset = mouse - obj.GetHandlePosition(rank);
                        this.moveObject.MoveHandleStarting(
                            this.moveHandle,
                            mouse,
                            this.drawingContext
                        );
                    ...
                    {
                        Point pos = mouse;
                        rank = this.moveObject.SelectedSegmentAdd(
                            rankSegment,
                            ref pos,
                            this.drawingContext.IsShift
                        );
            ...
            if (this.mouseDragging) // bouton souris pressé ?
            {
                ...
                if (len > this.drawingContext.MinimalSize)
                {
                    ...
                    else if (this.moveObject != null && !this.drawingContext.IsShift)
                    {
                        ...
                        {
                            mouse -= this.moveOffset;
                            this.moveObject.MoveSelectedSegmentProcess(
                                this.moveSelectedSegment,
                                mouse,
                                this.drawingContext
                            );
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (rank == -1)
                        {
                            if (
                                obj.IsSelected
                                && (obj.IsShaperHandleSelected() || obj.IsSelectedSegments())
                            )
                            {
        ...
        protected void ShaperMouseUp(Point mouse, bool isRight)
        {
            ...
            bool mb = true;
            bool hot = true;
            if (!Point.Equals(mouse, this.moveStart))
                mb = false;
            ...
            else if (this.moveObject != null)
            {
                if (this.moveHandle != -1) // déplace une poignée ?
                {
                    if (mouse.X != this.moveStart.X || mouse.Y != this.moveStart.Y)
                    {
                        this.document.Modifier.OpletQueueNameAction(Res.Strings.Action.HandleMove);
                    }
                ...
                {
                    mouse -= this.moveOffset;
                    this.moveObject.MoveSelectedSegmentEnding(
                        this.moveSelectedSegment,
                        mouse,
                        this.drawingContext
                    );
        ...
        protected void EditMouseDown(Message message, Point mouse, int downCount)
        {
            ...
            {
                Objects.AbstractText edit =
                    this.DetectEdit(mouse, out handle) as Objects.AbstractText;
                if (edit == null)
                {
                    edit = this.editFlowSrc as Objects.AbstractText;

                    if (edit is Objects.TextBox2)
                        this.document.Modifier.Tool = "ObjectTextBox2";
                    if (edit is Objects.TextLine2)
                        this.document.Modifier.Tool = "ObjectTextLine2";
            ...
            else
            {
                ...
                if (
                    handle == Objects.DetectEditType.HandleFlowPrev
        ...
        protected void EditMouseMove(Message message, Point mouse)
        {
            ...
            else
            {
                ...
                else // bouton souris relâché ?
                {
                    ...
                    if (
                        editHandle == Objects.DetectEditType.HandleFlowPrev
            ...
            if (
                !this.mouseDragging
                && editObj == null
                && !this.document.Wrappers.IsWrappersAttached
            )
            {
                this.EditCreateRect(mouse);
            }
        ...
        protected void EditMouseUp(Message message, Point mouse, bool isRight)
        {
            ...
            if (
                !this.editPosPress.IsZero
                && Point.Distance(mouse, this.editPosPress) <= this.drawingContext.MinimalSize
            )
            {
                Drawing.Rectangle box = this.GuidesSearchBox(this.editPosPress);
                if (box.IsEmpty)
                    return;
                if (!this.IsFreeForNewTextBox2(box, null))
                    return;

                string name = string.Format(
                    Res.Strings.Action.ObjectCreate,
                    this.document.Modifier.ToolName("ObjectTextBox2")
                );
                ...
                Objects.TextBox2 t2 =
                    Objects.Abstract.CreateObject(
                        this.document,
                        "ObjectTextBox2",
                        this.document.Modifier.ObjectMemoryText
                    ) as Objects.TextBox2;
                Objects.Abstract layer = this.drawingContext.RootObject();
        ...
        protected void ZoomMouseMove(Point mouse, bool isRight)
        {
            ...
            if (this.mouseDragging)
            {
                if (this.zoomShift)
                {
                    ...
                    {
                        this.drawingContext.ZoomAndCenter(
                            zoom,
                            this.moveStart - this.zoomOffset,
                            true
                        );
                    }
                }
        ...
        protected Objects.Abstract DetectEdit(Point mouse, out Objects.DetectEditType handle)
        {
            ...
            foreach (Objects.Abstract obj in this.document.FlatReverse(layer))
            {
                if (!(obj is Objects.AbstractText))
                    continue;
                if (!obj.IsSelected)
                    continue;

                handle = obj.DetectEdit(mouse);
                if (handle != Objects.DetectEditType.Out)
                    return obj;
            }
        ...
        protected bool DetectSelectedSegmentHandle(
            Point mouse,
            out Objects.Abstract detect,
            out int rank
        )
        {
        ...
        {
            //	Mode de sélection.
            get { return this.selector.TypeChoice; }
            set
            {
        ...
        {
            //	Mode de sélection.
            get { return this.selector.TypeStretch; }
            set
            {
        ...
        public bool SelectorAdaptLine
        {
            ...
            get { return this.selectorAdaptLine; }
            set
            {
        ...
        public bool SelectorAdaptText
        {
            ...
            get { return this.selectorAdaptText; }
            set
            {
        ...
        public void UpdateSelector(Rectangle rect)
        {
            ...
            if (this.document.Modifier.TotalSelected == 0 || this.document.Modifier.IsToolEdit)
            {
                this.selector.Visible = false;
                this.selector.Handles = false;
            }
        ...
        public void OpenPopupInterface(
            Widget frame,
            Objects.Abstract obj,
            System.Func<Viewer, Objects.Abstract, Point> getPosition
        )
        {
        ...
        )
        {
            ...
            double my =
                22 * this.miniBarLines
                + frame.Margin * (this.miniBarLines - 1)
                + frame.Margin * 2
        ...
        protected void ContextMenu(Point mouse, bool globalMenu)
        {
            ...
            else
            {
                ...
                exist = false;
                exist |= Menus.ContextMenuItem.MenuAddItem(
                    this.document.CommandContext,
                    listOrder,
                    "OrderUpAll"
                );
                exist |= Menus.ContextMenuItem.MenuAddItem(
            ...
            else
            {
                ...
                if (exist)
                    Menus.ContextMenuItem.MenuAddSep(listOper);
            ...
            if (globalMenu || nbSel == 0)
            {
                ...
                if (exist)
                    Menus.ContextMenuItem.MenuAddSep(list);
            ...
            else
            {
                ...
                exist = false;
                exist |= Menus.ContextMenuItem.MenuAddSubmenu(
                    list,
                    this.contextMenuOrder,
                    Misc.Icon("OrderUpAll"),
                    Res.Strings.Action.OrderMain
                );
                exist |= Menus.ContextMenuItem.MenuAddSubmenu(
                    list,
                    this.contextMenuOper,
                    Misc.Icon("MoveH"),
                    Res.Strings.Action.OperationMain
                );
                exist |= Menus.ContextMenuItem.MenuAddSubmenu(
                    list,
                    this.contextMenuGeom,
                    Misc.Icon("Combine"),
                    Res.Strings.Action.GeometryMain
                );
                exist |= Menus.ContextMenuItem.MenuAddSubmenu(
                    list,
                    this.contextMenuBool,
                    Misc.Icon("BooleanOr"),
                    Res.Strings.Action.BooleanMain
                );
            }
        ...
        protected void UpdateMouseCursor(Message message)
        {
            ...
            if (
                this.mouseCursorType == MouseCursorType.Arrow
            ...
            if (
                this.mouseCursorType == MouseCursorType.ShaperNorm
            ...
            if (
                this.mouseCursorType == MouseCursorType.Finger
            ...
            if (
                this.mouseCursorType == MouseCursorType.Zoom
        ...
        protected void UseMouseCursor()
        {
            ...
            if (this.mouseCursorTypeUse == cursor)
                return;
            ...
            switch (cursor)
            {
                ...
                case MouseCursorType.ArrowGlobal:
                    this.MouseCursorImage(
                        ref this.mouseCursorArrowGlobal,
                        Misc.Icon("ArrowGlobal")
                    );
                    break;
                ...
                case MouseCursorType.ShaperMulti:
                    this.MouseCursorImage(
                        ref this.mouseCursorShaperMulti,
                        Misc.Icon("ShaperMulti")
                    );
                    break;
                ...
                case MouseCursorType.IBeamCreate:
                    this.MouseCursorImage(
                        ref this.mouseCursorIBeamCreate,
                        Misc.Icon("IBeamCreate")
                    );
                    break;
                ...
                case MouseCursorType.ZoomShiftCtrl:
                    this.MouseCursorImage(
                        ref this.mouseCursorZoomShiftCtrl,
                        Misc.Icon("ZoomShiftCtrl")
                    );
                    break;
                ...
                case MouseCursorType.PickerEmpty:
                    this.MouseCursorImage(
                        ref this.mouseCursorPickerEmpty,
                        Misc.Icon("PickerEmpty")
                    );
                    break;
                ...
                case MouseCursorType.TextFlowCreateBox:
                    this.MouseCursorImage(
                        ref this.mouseCursorTextFlowCreateBox,
                        Misc.Icon("TextFlowCreateBox")
                    );
                    break;

                case MouseCursorType.TextFlowCreateLine:
                    this.MouseCursorImage(
                        ref this.mouseCursorTextFlowCreateLine,
                        Misc.Icon("TextFlowCreateLine")
                    );
                    break;

                case MouseCursorType.TextFlowAdd:
                    this.MouseCursorImage(
                        ref this.mouseCursorTextFlowAdd,
                        Misc.Icon("TextFlowAdd")
                    );
                    break;

                case MouseCursorType.TextFlowRemove:
                    this.MouseCursorImage(
                        ref this.mouseCursorTextFlowRemove,
                        Misc.Icon("TextFlowRemove")
                    );
                    break;
        ...
        public void GuideInteractiveStart(bool horizontal)
        {
            ...
            guide.Type = horizontal
                ? Settings.GuideType.HorizontalBottom
                : Settings.GuideType.VerticalLeft;
        ...
        protected void DrawGridForeground(Graphics graphics, Rectangle clipRect)
        {
            ...
            if (this.drawingContext.PreviewActive)
            {
                if (this.document.Type == DocumentType.Graphic)
                {
                    ...
                    if (
                        this.document.Settings.PrintInfo.Target
                        && !this.document.Settings.PrintInfo.AutoZoom
                    )
                    {
                        this.document.Printer.PaintTarget(
                            graphics,
                            this.drawingContext,
                            this.drawingContext.CurrentPage
                        );
                    }
                }
            }
            else
            {
                //	Dessine la grille.
                if (
                    this.drawingContext.GridShow
                    && this.drawingContext.GridStep.X != 0
                    && this.drawingContext.GridStep.Y != 0
                )
                {
                    double s = System.Math.Min(
                        this.drawingContext.GridStep.X * this.drawingContext.ScaleX,
                    ...
                    origin = Point.GridAlign(
                        origin,
                        -this.drawingContext.GridOffset,
                        this.drawingContext.GridStep
                    );
                    ...
                    for (
                        double pos = origin.X;
                        pos <= this.document.Modifier.SizeArea.Width;
                        pos += step
                    )
                    {
                    ...
                    for (
                        double pos = origin.Y;
                        pos <= this.document.Modifier.SizeArea.Height;
                        pos += step
                    )
                    {
                ...
                if (this.drawingContext.TextGridShow)
                {
                    ...
                    origin = Point.GridAlign(
                        origin,
                        new Point(0, -this.drawingContext.TextGridOffset),
                        new Point(0, this.drawingContext.TextGridStep)
                    );
                ...
                if (this.IsActiveViewer)
                {
                    if (this.document.Type == DocumentType.Pictogram)
                    {
                        Rectangle rect = new Rectangle(
                            0,
                            0,
                            this.document.PageSize.Width,
                            this.document.PageSize.Height
                        );
                        rect = graphics.Align(rect);
                        rect.Offset(ix, iy);
                        graphics.AddRectangle(rect);
        ...
        public void DrawGuides(Graphics graphics)
        {
            ...
            {
                Objects.Page page =
                    this.document.DocumentObjects[this.drawingContext.CurrentPage] as Objects.Page;
                ...
                this.DrawGuides(
                    graphics,
                    this.document.Settings.GuidesListGlobal,
                    this.document.Settings.GlobalGuides
                );
            }
        }
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            if (
                clipRect.Right == 1
                || // un pixel à gauche ?
                clipRect.Bottom == this.ActualHeight - 1
            ) // un pixel en haut ?
            {
                return; // ignore
            }
            ...
            if (
                this.IsActiveViewer
                && this.drawingContext.LabelsShow
                && !this.drawingContext.PreviewActive
            )
            {
            ...
            if (
                this.IsActiveViewer
                && this.drawingContext.AggregatesShow
                && !this.drawingContext.PreviewActive
            )
            {
        ...
        public Objects.TextBox2 SearchIntersectedTextBox2(
            Drawing.Rectangle box,
            Objects.Abstract exclude
        )
        {
        ...
        protected double GuidesSearchBest(
        ...
        )
        {
            ...
            {
                if (isHorizontal != guide.IsHorizontal)
                    continue;
        ...
        public bool RedrawWhenResizing
        {
            ...
            get { return this.redrawWhenResizing; }
            set { this.redrawWhenResizing = value; }
        }
        #endregion
        ...
        public bool PaintPageFrame
        {
            ...
            get { return this.paintPageFrame; }
            set { this.paintPageFrame = value; }
        }

        public bool PaintWorkSurface
        {
            //	Peint le cadre de la page et la surface de travail.
            get { return this.paintWorkSurface; }
            set { this.paintWorkSurface = value; }
        }
        #endregion
