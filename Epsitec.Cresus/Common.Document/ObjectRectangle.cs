...
namespace Epsitec.Common.Document
{
	...
	{
		public ObjectRectangle(Document document, AbstractObject model) : base(document, model)
		{
		...
		{
			return new ObjectRectangle(document, model);
		}
		...
		protected Path PathCornerRectangle(DrawingContext drawingContext, Point p1, Point p2, Point p3, Point p4, PropertyCorner corner)
		{
		...
		protected ObjectRectangle(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
		#endregion
	}
