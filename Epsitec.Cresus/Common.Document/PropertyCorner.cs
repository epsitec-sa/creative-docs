...
namespace Epsitec.Common.Document
{
	...
	{
		public PropertyCorner(Document document) : base(document)
		{
		...
		{
			if ( obj is ObjectRectangle )  return 8;
			return 2;
		}
		...
		public override Point GetHandlePosition(AbstractObject obj, int rank)
		{
			...
			if ( obj is ObjectRegular )
			{
				ObjectRegular regular = obj as ObjectRegular;
				Point a, b;
		...
		{
			return new PanelCorner(document);
		}
		...
		protected PropertyCorner(SerializationInfo info, StreamingContext context) : base(info, context)
		{
