...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Tabs(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonNew = this.CreateIconButton(
                Misc.Icon("TabNew"),
                Res.Strings.TextPanel.Tabs.Tooltip.New,
                this.HandleNewClicked,
                false
            );
            this.buttonDelete = this.CreateIconButton(
                Misc.Icon("Delete"),
                Res.Strings.TextPanel.Tabs.Tooltip.Delete,
                this.HandleDeleteClicked,
                false
            );

            this.fieldPos = new Epsitec.Common.Document.Widgets.TextFieldLabel(
                this,
            ...
            this.buttonType = this.CreateIconButton(
                Misc.Icon("TabLeft"),
                Res.Strings.Action.Text.Ruler.TabChoice,
                this.HandleTypeClicked,
                true
            );
        ...
        protected void UpdateWidgets()
        {
            ...
            else
            {
                double tabPos;
                TextTabType type;
                Objects.AbstractText.GetTextTab(
                    this.document,
                    this.tabSelected,
                    out tabPos,
                    out type
        ...
        private void HandleNewClicked(object sender, MessageEventArgs e)
        {
            ...
            Objects.AbstractText.NewTextTab(
                this.document,
                this.document.Wrappers.TextFlow,
                out this.tabSelected,
                tabPos,
                type,
                this.isStyle
            );
        ...
        private void HandleDeleteClicked(object sender, MessageEventArgs e)
        {
            ...
            Objects.AbstractText.DeleteTextTab(
                this.document,
                this.document.Wrappers.TextFlow,
                this.tabSelected,
                this.isStyle
        ...
        private void HandlePosValueChanged(object sender)
        {
            ...
            Objects.AbstractText.SetTextTab(
                this.document,
                this.document.Wrappers.TextFlow,
                ref this.tabSelected,
                tabPos,
                type,
                true,
                this.isStyle
