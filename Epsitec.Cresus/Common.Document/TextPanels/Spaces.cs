...
namespace Epsitec.Common.Document.TextPanels
{
	...
	public class Spaces : Abstract
	{
		public Spaces(Document document) : base(document)
		{
			...
			this.fieldBefore = this.CreateTextFieldLabel(Res.Strings.TextPanel.Spaces.Tooltip.Before, Res.Strings.TextPanel.Spaces.Short.Before, Res.Strings.TextPanel.Spaces.Long.Before, 0.0, 100.0, 1.0, false, new EventHandler(this.HandleBeforeChanged));
			this.fieldAfter  = this.CreateTextFieldLabel(Res.Strings.TextPanel.Spaces.Tooltip.After,  Res.Strings.TextPanel.Spaces.Short.After,  Res.Strings.TextPanel.Spaces.Long.After,  0.0, 100.0, 1.0, false, new EventHandler(this.HandleAfterChanged));
