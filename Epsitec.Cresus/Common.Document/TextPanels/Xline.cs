...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Xline(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonUnderline = this.CreateIconButton(
                Misc.Icon("FontUnderline"),
                Res.Strings.Action.FontUnderline,
                this.HandleButtonUnderlineClicked
            );
            this.buttonOverline = this.CreateIconButton(
                Misc.Icon("FontOverline"),
                Res.Strings.Action.FontOverline,
                this.HandleButtonOverlineClicked
            );
            this.buttonStrikeout = this.CreateIconButton(
                Misc.Icon("FontStrikeout"),
                Res.Strings.Action.FontStrikeout,
                this.HandleButtonStrikeoutClicked
            );

            this.fieldUnderlineThickness = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Underline.Thickness,
                Res.Strings.TextPanel.Xline.Short.Underline.Thickness,
                Res.Strings.TextPanel.Xline.Long.Underline.Thickness,
                0.0,
                0.01,
                0.0,
                0.1,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleUnderlineValueChanged
            );
            this.fieldUnderlinePosition = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Underline.Position,
                Res.Strings.TextPanel.Xline.Short.Underline.Position,
                Res.Strings.TextPanel.Xline.Long.Underline.Position,
                0.0,
                0.01,
                0.0,
                0.1,
            ...
            this.underlineColor = this.CreateColorSample(
                Res.Strings.TextPanel.Xline.Tooltip.Underline.Color,
                this.HandleSampleColorClicked,
                this.HandleSampleColorChanged
            );

            this.fieldOverlineThickness = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Overline.Thickness,
                Res.Strings.TextPanel.Xline.Short.Overline.Thickness,
                Res.Strings.TextPanel.Xline.Long.Overline.Thickness,
                0.0,
                0.01,
                0.0,
                0.1,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleOverlineValueChanged
            );
            this.fieldOverlinePosition = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Overline.Position,
            ...
            this.overlineColor = this.CreateColorSample(
                Res.Strings.TextPanel.Xline.Tooltip.Overline.Color,
                this.HandleSampleColorClicked,
                this.HandleSampleColorChanged
            );

            this.fieldStrikeoutThickness = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Strikeout.Thickness,
                Res.Strings.TextPanel.Xline.Short.Strikeout.Thickness,
                Res.Strings.TextPanel.Xline.Long.Strikeout.Thickness,
                0.0,
                0.01,
                0.0,
                0.1,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleStrikeoutValueChanged
            );
            this.fieldStrikeoutPosition = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Xline.Tooltip.Strikeout.Position,
                Res.Strings.TextPanel.Xline.Short.Strikeout.Position,
                Res.Strings.TextPanel.Xline.Long.Strikeout.Position,
                0.0,
                0.01,
                0.0,
                0.1,
            ...
            this.strikeoutColor = this.CreateColorSample(
                Res.Strings.TextPanel.Xline.Tooltip.Strikeout.Color,
                this.HandleSampleColorClicked,
                this.HandleSampleColorChanged
            );
        ...
        public override void OriginColorSelect(int rank)
        {
            ...
            if (rank != -1)
            {
                ...
                if (rank == 0)
                    this.originFieldColor = this.underlineColor;
                if (rank == 1)
                    this.originFieldColor = this.overlineColor;
                if (rank == 2)
                    this.originFieldColor = this.strikeoutColor;
            }
        ...
        protected void ColorToWrapper(ColorSample sample)
        {
            ...
            if (sample == this.underlineColor)
            {
                ...
                Common.Text.Wrappers.TextWrapper.XlineDefinition xline = this.TextWrapper
                    .Defined
                    .Underline;
                this.FillUnderlineDefinition(xline, false);
                this.TextWrapper.DefineOperationName(
                    "FontXline",
                    Res.Strings.TextPanel.Xline.Title
                );
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            if (this.TextWrapper.IsAttached == false)
                return;
            ...
            this.SetTextFieldRealValue(
                this.fieldUnderlineThickness.TextFieldReal,
                underlineThickness,
            ...
            this.SetTextFieldRealValue(
                this.fieldUnderlinePosition.TextFieldReal,
                underlinePosition,
                Common.Text.Properties.SizeUnits.Points,
                isUnderline,
                true
            ...
            this.SetTextFieldRealValue(
                this.fieldOverlineThickness.TextFieldReal,
                overlineThickness,
                Common.Text.Properties.SizeUnits.Points,
                isOverline,
                true
            ...
            this.SetTextFieldRealValue(
                this.fieldOverlinePosition.TextFieldReal,
                overlinePosition,
                Common.Text.Properties.SizeUnits.Points,
                isOverline,
                true
            ...
            this.SetTextFieldRealValue(
                this.fieldStrikeoutThickness.TextFieldReal,
                strikeoutThickness,
                Common.Text.Properties.SizeUnits.Points,
                isStrikeout,
                true
            ...
            this.SetTextFieldRealValue(
                this.fieldStrikeoutPosition.TextFieldReal,
                strikeoutPosition,
                Common.Text.Properties.SizeUnits.Points,
                isStrikeout,
                true
            ...
            if (
                this.underlineColor.ActiveState == ActiveState.Yes
        ...
        private void HandleButtonUnderlineClicked(object sender, MessageEventArgs e)
        {
            ...
            {
                if (
                    this.TextWrapper.Active.Underline.IsDisabled
        ...
        private void HandleButtonOverlineClicked(object sender, MessageEventArgs e)
        {
            ...
            {
                if (
                    this.TextWrapper.Active.Overline.IsDisabled
        ...
        private void HandleButtonStrikeoutClicked(object sender, MessageEventArgs e)
        {
            ...
            {
                if (
                    this.TextWrapper.Active.Strikeout.IsDisabled
        ...
        private void HandleSampleColorClicked(object sender, MessageEventArgs e)
        {
            ...
            if (this.originFieldColor == this.underlineColor)
                this.originFieldRank = 0;
            if (this.originFieldColor == this.overlineColor)
                this.originFieldRank = 1;
            if (this.originFieldColor == this.strikeoutColor)
                this.originFieldRank = 2;
        ...
        private void FillUnderlineDefinition(
            Common.Text.Wrappers.TextWrapper.XlineDefinition xline,
            bool def
        )
        {
        ...
        private void FillOverlineDefinition(
            Common.Text.Wrappers.TextWrapper.XlineDefinition xline,
            bool def
        )
        {
        ...
        private void FillStrikeoutDefinition(
            Common.Text.Wrappers.TextWrapper.XlineDefinition xline,
            bool def
        )
        {
