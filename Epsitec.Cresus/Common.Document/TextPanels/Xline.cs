...
namespace Epsitec.Common.Document.TextPanels
{
	...
	public class Xline : Abstract
	{
		public Xline(Document document) : base(document)
		{
			...
			this.fieldOverlinedPosition   = this.CreateTextFieldLabel(Res.Strings.TextPanel.Xline.Tooltip.Overlined.Position,   Res.Strings.TextPanel.Xline.Short.Overlined.Position,   Res.Strings.TextPanel.Xline.Long.Overlined.Position,  -0.01, 0.01, 0.1, Widgets.TextFieldLabel.Type.TextFieldReal, new EventHandler(this.HandleOverlinedValueChanged));
