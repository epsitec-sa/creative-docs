...
namespace Epsitec.Common.Document
{
	...
	{
		public PanelGradient(Document document) : base(document)
		{
		...
		protected override void PropertyToWidgets()
		{
			...
			PropertyGradient p = this.property as PropertyGradient;
			if ( p == null )  return;
			...
			switch ( p.FillType )
			{
				case GradientFillType.None:     sel = 0;  break;
				case GradientFillType.Linear:   sel = 1;  break;
				case GradientFillType.Circle:   sel = 2;  break;
				case GradientFillType.Diamond:  sel = 3;  break;
				case GradientFillType.Conic:    sel = 4;  break;
			}
		...
		protected override void WidgetsToProperty()
		{
			...
			p.FillType = GradientFillType.None;
			switch ( this.listFill.SelectedIndex )
			{
				case 0:  p.FillType = GradientFillType.None;     break;
				case 1:  p.FillType = GradientFillType.Linear;   break;
				case 2:  p.FillType = GradientFillType.Circle;   break;
				case 3:  p.FillType = GradientFillType.Diamond;  break;
				case 4:  p.FillType = GradientFillType.Conic;    break;
			}
		...
		{
			if ( this.originFieldColor == null )  return Color.FromBrightness(0);
		...
		{
			Color temp     = this.fieldColor1.Color;
