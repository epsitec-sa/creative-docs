namespace Epsitec.Common.Widgets.Adorner
{
	...
	/// </summary>
	public class LookPastel : IAdorner
	{
		public LookPastel()
		{
			this.bitmap = Drawing.Bitmap.FromManifestResource("Epsitec.Common.Widgets.Adorners.Resources.LookPastel.png", this.GetType().Assembly);
			this.RefreshColors();
		}
		...
		public void AdaptPictogramColor(ref Drawing.Color color, Drawing.GlyphPaintStyle paintStyle, Drawing.Color uniqueColor)
		{
			if ( paintStyle == Drawing.GlyphPaintStyle.Normal )
			{
				...
				intensity = 0.5+(intensity-0.5)*0.4;  // diminue le contraste
