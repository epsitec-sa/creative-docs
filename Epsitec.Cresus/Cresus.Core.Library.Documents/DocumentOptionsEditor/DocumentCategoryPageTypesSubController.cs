...
{
	public sealed class DocumentCategoryPageTypesSubController
	{
		public DocumentCategoryPageTypesSubController(IBusinessContext businessContext, DocumentCategoryEntity documentCategoryEntity)
		{
