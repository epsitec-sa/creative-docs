	...
	public sealed class UnitTestExpressionFields
	{
		...
		public void GetFieldsTestExpression1()
		{
			...
			foreach (Field field1 in this.GetSampleFields ())
			{
				foreach (Field field2 in this.GetSampleFields ())
				{
					Expression operation1 = new BinaryOperation (
					...
					{
						Expression operation2 = new BinaryOperation (
							new UnaryComparison (field1, UnaryComparator.IsNull),
							BinaryOperator.And,
						...
						{
							Expression operation3 = new BinaryOperation (
								new ComparisonFieldField (field1, BinaryComparator.IsEqual, field2),
								BinaryOperator.And,
			...
			{
				Expression comparison = new ComparisonFieldValue (field, BinaryComparator.IsEqual, new Constant (0));
			...
			foreach (Field field1 in this.GetSampleFields ())
			{
				foreach (Field field2 in this.GetSampleFields ())
				{
					Expression comparison = new ComparisonFieldField (field1, BinaryComparator.IsEqual, field2);
			...
			foreach (Field field in this.GetSampleFields ())
			{
				Expression comparison = new UnaryComparison (field, UnaryComparator.IsNull);
		...
		public void GetFieldsTestExpression2()
		{
			Expression expression = null;

			ExpressionFields_Accessor.GetFields (expression);
		}


		[TestMethod]
		[DeploymentItem ("Cresus.DataLayer.dll")]
		public void GetFieldsTestOperation1()
		{
			foreach (Field field1 in this.GetSampleFields ())
			{
				foreach (Field field2 in this.GetSampleFields ())
			...
			foreach (Field field1 in this.GetSampleFields ())
			{
				foreach (Field field2 in this.GetSampleFields ())
				{
					Operation operation1 = new BinaryOperation (
						new UnaryComparison (field1, UnaryComparator.IsNull),
						BinaryOperator.And,
						new UnaryComparison (field2, UnaryComparator.IsNull)
					);
					...
					foreach (Field field3 in this.GetSampleFields ())
					{
						Operation operation2 = new BinaryOperation (
							new UnaryComparison (field1, UnaryComparator.IsNull),
							BinaryOperator.And,
							new ComparisonFieldField (field2, BinaryComparator.IsEqual, field3)
						);
						...
						foreach (Field field4 in this.GetSampleFields ())
						{
							Operation operation3 = new BinaryOperation (
								new ComparisonFieldField (field1, BinaryComparator.IsEqual, field2),
								BinaryOperator.And,
								new ComparisonFieldField (field3, BinaryComparator.IsEqual, field4)
							);
		...
		[DeploymentItem ("Cresus.DataLayer.dll")]
		[ExpectedException (typeof (System.ArgumentNullException))]
		public void GetFieldsTestOperation2()
		{
		...
		[TestMethod]
		[DeploymentItem ("Cresus.DataLayer.dll")]
		public void GetFieldsTestComparison1()
		{
			foreach (Field field in this.GetSampleFields ())
			{
				Comparison comparison = new ComparisonFieldValue (field, BinaryComparator.IsEqual, new Constant (0));
			...
			foreach (Field field1 in this.GetSampleFields ())
			{
				foreach (Field field2 in this.GetSampleFields ())
				{
					Comparison comparison = new ComparisonFieldField (field1, BinaryComparator.IsEqual, field2);
			...
			foreach (Field field in this.GetSampleFields ())
			{
				Comparison comparison = new UnaryComparison (field, UnaryComparator.IsNull);
		...
		[DeploymentItem ("Cresus.DataLayer.dll")]
		[ExpectedException (typeof (System.ArgumentNullException))]
		public void GetFieldsTestComparison2()
		{
