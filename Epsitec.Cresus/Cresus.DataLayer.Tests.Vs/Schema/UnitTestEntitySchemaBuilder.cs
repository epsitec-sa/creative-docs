	...
	public sealed class UnitTestEntitySchemaBuilder
	{
		...
		public void SchemaBuilderConstructorTest()
		{
			using (DbInfrastructure dbInfrastructure = DbInfrastructureHelper.ConnectToTestDatabase ())
			{
				...
				new EntitySchemaBuilder (entityTypeEngine, dbInfrastructure);
			}
		}
		...
		public void SchemaBuilderConstructorArgumentCheck()
		{
			using (DbInfrastructure dbInfrastructure = DbInfrastructureHelper.ConnectToTestDatabase ())
			{
				...
				(
					() => new EntitySchemaBuilder (null, dbInfrastructure)
				);

				ExceptionAssert.Throw<System.ArgumentNullException>
				(
					() => new EntitySchemaBuilder (entityTypeEngine, null)
				);
			}
		}
		...
		public void CreateSchemaArgumentCheck()
		{
			using (DbInfrastructure dbInfrastructure = DbInfrastructureHelper.ConnectToTestDatabase ())
			{
				...
				var builder = new EntitySchemaBuilder (entityTypeEngine, dbInfrastructure);
