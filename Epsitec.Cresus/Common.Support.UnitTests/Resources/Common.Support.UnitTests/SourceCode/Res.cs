...
namespace Epsitec.Common.Support.UnitTests
{
	public static class Res
	{
		...
		public static class Strings
		{
			public static class Error
			{
				...
				public static global::Epsitec.Common.Types.FormattedText CannotConnectToLocalDatabase
				{
					get
					{
						return global::Epsitec.Common.Support.UnitTests.Res.Strings.GetText (global::Epsitec.Common.Support.Druid.FromFieldId (167772160));
					}
				}
			}
			...
			public static class Hint
			{
				public static class Error
				{
					...
					public static global::Epsitec.Common.Types.FormattedText CannotConnectToLocalDatabase
					{
						get
						{
							return global::Epsitec.Common.Support.UnitTests.Res.Strings.GetText (global::Epsitec.Common.Support.Druid.FromFieldId (167772161));
						}
					}
				}
			}
			...
			public static global::Epsitec.Common.Types.FormattedText ProductName
			{
				get
				{
					return global::Epsitec.Common.Support.UnitTests.Res.Strings.GetText (global::Epsitec.Common.Support.Druid.FromFieldId (16777216));
				}
			}
		...
		static Res()
		{
			...
			Res._manager.DefineDefaultModuleName ("Common.Support.UnitTests");
