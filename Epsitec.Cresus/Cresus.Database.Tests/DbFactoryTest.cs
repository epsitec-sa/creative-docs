...
namespace Epsitec.Cresus.Database
{
	...
	public class DbFactoryTest
	{
		...
		[Test]
		public void Check02NewDbCommand()
		{
		...
		[Test]
		public void Check03NewDataAdapter()
		{
			IDbAbstraction  db_abstraction = DbFactoryTest.CreateDbAbstraction (false);
		...
		[Test]
		public void Check04ExecuteScalar()
		{
			IDbAbstraction  db_abstraction = DbFactoryTest.CreateDbAbstraction (false);
			System.Data.IDbCommand command = db_abstraction.NewDbCommand ();
		...
		[Test]
		public void Check05ExecuteReader()
		{
			IDbAbstraction  db_abstraction = DbFactoryTest.CreateDbAbstraction (false);
			System.Data.IDbCommand command = db_abstraction.NewDbCommand ();
		...
		[Test]
		public void Check06QueryUserTableNames()
		{
			IDbAbstraction  db_abstraction = DbFactoryTest.CreateDbAbstraction (false);
		...
		[Test]
		public void Check07ReadOnlyTransaction()
		{
			IDbAbstraction  db_abstraction = DbFactoryTest.CreateDbAbstraction (false);
		...
		[Test]
		public void Check08DebugDumpRegisteredDbAbstractions()
		{
