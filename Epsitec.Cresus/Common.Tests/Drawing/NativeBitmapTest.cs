    ...
    public class NativeBitmapTest
    {
        ...
        public void TestRgbTiff()
        {
            ...
            System.IO.File.WriteAllBytes(
                "rgb-R.png",
                imageR.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "rgb-G.png",
                imageG.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "rgb-B.png",
                imageB.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "rgb-gray.png",
                imageGray.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "rgb-cmyk.tif",
                imageCmyk.SaveToMemory(
                    new BitmapFileFormat()
                    {
                        Type = BitmapFileType.Tiff,
                        TiffCompression = TiffCompressionOption.Lzw,
                        TiffCmyk = true
                    }
                )
            );
        ...
        public void TestRgbAlphaTiff()
        {
            ...
            System.IO.File.WriteAllBytes(
                "rgba-A.png",
                imageA.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );

            byte[] memory = image
                .GetChannel(BitmapColorChannel.Alpha)
                .GetRawImageDataInCompactFormFor8BitImage();
        ...
        public void TestCmykTiff()
        {
            ...
            System.IO.File.WriteAllBytes(
                "cmyk-C.png",
                imageC.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyk-M.png",
                imageM.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyk-Y.png",
                imageY.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyk-K.png",
                imageK.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyk-G.tif",
                imageGray.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            ...
            System.IO.File.WriteAllBytes(
                "cmyk-RGB32.tif",
                imageRgb32.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyk-RGB24.tif",
                imageRgb24.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
        ...
        public void TestCmykAlphaTiff()
        {
            ...
            System.IO.File.WriteAllBytes(
                "cmyka-RGB.png",
                imageRgb.SaveToMemory(new BitmapFileFormat() { Type = BitmapFileType.Png })
            );
            System.IO.File.WriteAllBytes(
                "cmyka-A.jpg",
                imageA.SaveToMemory(
                    new BitmapFileFormat() { Type = BitmapFileType.Jpeg, Quality = 80 }
                )
            );
