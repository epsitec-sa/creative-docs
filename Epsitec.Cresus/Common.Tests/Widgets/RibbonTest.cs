...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class RibbonTest
    {
        ...
        public static Window CreateAdornerWidgets()
        {
            ...
            book.TabIndex = 2;
            book.TabNavigationMode =
                TabNavigationMode.ActivateOnTab | TabNavigationMode.ForwardToChildren;
