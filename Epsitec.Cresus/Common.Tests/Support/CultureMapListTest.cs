...
namespace Epsitec.Common.Tests.Support
{
	...
	public class CultureMapListTest
	{
		...
		public void Initialize()
		{
			...
			this.list.Add (Epsitec.Common.Support.Internal.Test.CreateCultureMap (null, Druid.Parse ("[0001]"), CultureMapSource.ReferenceModule));
			this.list.Add (Epsitec.Common.Support.Internal.Test.CreateCultureMap (null, Druid.Parse ("[0002]"), CultureMapSource.ReferenceModule));
			this.list.Add (Epsitec.Common.Support.Internal.Test.CreateCultureMap (null, Druid.Parse ("[0003]"), CultureMapSource.ReferenceModule));
			this.list.Add (Epsitec.Common.Support.Internal.Test.CreateCultureMap (null, Druid.Parse ("[0004]"), CultureMapSource.ReferenceModule));
