...
namespace Epsitec.Common.Tests.Types
{
    ...
    public class BasicTypesTest
    {
        ...
        {
            System.ComponentModel.EnumConverter converter = new System.ComponentModel.EnumConverter(
                typeof(MyEnum)
            );
            ...
            System.Console.Out.WriteLine(
                "System.Enum --> {0} ---",
                value1.GetType().FullName /*, (int) value1*/
            );
            System.Console.Out.WriteLine(
                "MyEnum -------> {0} {1}",
            ...
            System.Console.Out.WriteLine(
                "object -------> {0} ---",
                value3.GetType().FullName /*, (int) value3*/
            );
        ...
        public void CheckDate()
        {
            System.ComponentModel.TypeConverter converter =
                System.ComponentModel.TypeDescriptor.GetConverter(typeof(Date));
        ...
        {
            System.ComponentModel.TypeConverter converter =
                System.ComponentModel.TypeDescriptor.GetConverter(typeof(Time));
        ...
        public void CheckTypeSerialization()
        {
            ...
            Assert.AreEqual(
                "V:" + typeof(int).FullName,
                caption.GetValue(AbstractType.SytemTypeProperty)
            );
            ...
            AbstractType type = TypeRosetta.CreateTypeObject(
                TypeRosetta.GetTypeObject("Default.Integer").Caption
            );
