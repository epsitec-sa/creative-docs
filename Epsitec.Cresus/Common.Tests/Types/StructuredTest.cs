...
namespace Epsitec.Common.Tests.Types
{
	...
	public class StructuredTest
	{
		...
		public void CheckStructuredDataWithTypeAndRelation()
		{
			...
			type1.Fields.Add (new StructuredTypeField ("A", type2, Druid.Empty, 0, FieldRelation.Reference));
			type1.Fields.Add (new StructuredTypeField ("B", type2, Druid.Empty, 1, FieldRelation.Collection));
...
//-         Assert.Throws<System.InvalidOperationException>(() => type.Fields.Add (new StructuredTypeField ("SelfName", type, Druid.Empty, 1, FieldRelation.Inclusion)));
		...
		public void CheckStructuredTypeEx3()
		{
			...
			interf.Fields.Add (new StructuredTypeField ("Name", StringType.NativeDefault, Druid.Empty, 0, FieldRelation.None));
...
//-         assert.Throws<System.ArgumentException>(() => );
		...
		public void CheckStructuredTypeRelations()
		{
			...
			interf.Fields.Add (new StructuredTypeField ("Name", StringType.NativeDefault, Druid.Empty, 0, FieldRelation.None));
			interf.Fields.Add (new StructuredTypeField ("SelfRef", interf, Druid.Empty, 1, FieldRelation.Reference));
			interf.Fields.Add (new StructuredTypeField ("SelfCollection", interf, Druid.Empty, 2, FieldRelation.Collection));
...
//-			entity.Fields.Add (new StructuredTypeField ("SelfRef", interf, Druid.Empty, 0, FieldRelation.Inclusion));
		...
		public void CheckStructuredTypeSerialization()
		{
			...
			type.Fields["Name"] = new StructuredTypeField ("Name", StringType.NativeDefault, Druid.Empty, 1);
		...
		public void CheckStructuredTypeMerge3()
		{
			...
			e2.Fields.Add (new StructuredTypeField (null, IntegerType.Default, Druid.Parse ("[400E]"), 1));
		...
		private void CreateEntities(out StructuredType e1, out StructuredType e2, out StructuredType e3)
		{
			...
			e1.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[400E]"), 0));
			e1.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[400F]"), 1));
			e2.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[400G]"), 0));
			e3.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[V002]"), 0));
			e3.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[V003]"), 1));
		...
		private StructuredType CreateInterface()
		{
			...
			i.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[400I]"), 0));
			i.Fields.Add (new StructuredTypeField (null, StringType.NativeDefault, Druid.Parse ("[400J]"), 1));
