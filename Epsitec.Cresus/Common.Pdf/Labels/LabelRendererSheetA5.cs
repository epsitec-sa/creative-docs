...
namespace Epsitec.Common.Pdf.Labels
{
	...
	/// </summary>
	public class LabelRendererSheetA5 : LabelRenderer
	{
		...
		public LabelRendererSheetA5 DefineLogo(string logoPath, Size logoSize)
		{
		...
		private void RenderPP(Port port, Rectangle bounds, LabelPageLayout layout, Rectangle textRect)
		{
			...
			using (var path = new Path ())
			{
				...
				LabelRendererSheetA5.RenderPPSymbol (port, layout, ref markRect);
				LabelRendererSheetA5.RenderPPEmitter (port, layout, text, ref markRect);

				if (this.IncludesPrioritySymbol)
				{
					LabelRendererSheetA5.RenderPrioritySymbol (port, layout, ref markRect);
				}

				LabelRendererSheetA5.RenderSwissPostLogo (port, layout, ref markRect);
			}
		}
