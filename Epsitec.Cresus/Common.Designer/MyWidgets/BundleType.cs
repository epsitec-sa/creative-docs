...
namespace Epsitec.Common.Designer.MyWidgets
{
	...
	public class BundleType : Widget
	{
		...
		{
			this.PreferredHeight = 50;  // TODO: pourquoi cela ne fonctionne pas sans cette ligne ?
			...
			this.buttonStrings.Text = "Textes";
			...
			this.buttonStrings.PreferredHeight = 20;
			...
			this.buttonPanels.Text = "Interfaces";
			...
			this.buttonPanels.PreferredHeight = 20;
			...
			this.buttonScripts.Text = "Scripts";
			...
			this.buttonScripts.PreferredHeight = 20;
