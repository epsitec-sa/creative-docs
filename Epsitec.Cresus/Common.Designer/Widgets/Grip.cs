...
namespace Epsitec.Common.Designer.Widgets
{
	...
	/// </summary>
	public class Grip : Widget, IDragBehaviorHost
	{
		public Grip()
		{
			this.grip_type  = GripType.None;
			this.grip_color = HiliteWidgetAdorner.FrameColor;
			
			this.drag_behavior = new DragBehavior (this);
		...
		protected void DefineGradientShape(Drawing.Graphics graphics)
		{
			...
			Drawing.Color color = HiliteWidgetAdorner.FrameColor;
