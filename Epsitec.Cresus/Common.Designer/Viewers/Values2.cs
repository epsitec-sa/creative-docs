...
namespace Epsitec.Common.Designer.Viewers
{
	...
	public class Values2 : AbstractCaptions2
	{
		...
		protected override void InitializeTable()
		{
			...
			cultureMapType.Fields.Add("Enum", StringType.Default);
			...
			this.table.Columns.Add(new UI.ItemTableColumn("Enum", new Widgets.Layouts.GridLength(this.GetColumnWidth(0), Widgets.Layouts.GridUnitType.Proportional)));
