...
namespace Epsitec.Common.Designer.Viewers
{
	...
	public class Fields : AbstractCaptions
	{
		...
		protected override void InitializeTable()
		{
			...
			this.table.ColumnHeader.SetColumnText(0, Res.Strings.Viewers.Column.Entity);
		...
		private static double[]				columnWidthHorizontal = { 100, 100, 100, 100, 20, 80, 50, 100, 50 };
		private static double[]				columnWidthVertical = { 120, 190, 270, 270, 20, 80, 50, 100, 50 };
	}
}
