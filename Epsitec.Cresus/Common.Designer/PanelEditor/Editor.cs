	...
	public class Editor : AbstractGroup, IPaintFilter
	{
		...
		protected bool ChangeTextResource(Widget obj)
		{
			...
			if (ObjectModifier.HasDruid(obj))
			{
				...
				var result = this.module.DesignerApplication.DlgResourceSelector(Dialogs.ResourceSelector.Operation.Selection, this.module, type, ref typeClass, ref druid, ref isNullable, exclude, Druid.Empty);
