...
namespace Epsitec.Data.Platform.MatchLight
{
	/// <summary>
	/// The <c>MatchLightStreetInformation</c> class describes a MAT[CH] street Switzerland
	/// light entry.
	/// </summary>
	public sealed class MatchLightStreetInformation : ISwissPostStreetInformation
	{
		public MatchLightStreetInformation(string line)
		{
