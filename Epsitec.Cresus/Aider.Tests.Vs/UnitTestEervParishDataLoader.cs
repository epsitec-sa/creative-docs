...
namespace Aider.Tests.Vs
{
	...
	public class UnitTestEervParishDataLoader
	{
		...
		public void LoadEervHouseholdsTest()
		{
			...
			var h1 = Tuple.Create (new EervHousehold ("4030000000", new EervAddress (null, "Genève, route de", 24, null, "1131", "Tolochenaz", "CH"), new EervCoordinates (null, "801 71 37", null, null, null), null), "02010000000");
			this.CheckForEquality (h1, households[0]);

			var h2 = Tuple.Create (new EervHousehold ("4030010010", new EervAddress (null, "Reneveyres, avenue des", 14, "B", "1110", "Morges", "CH"), new EervCoordinates ("801 89 10", null, null, null, null), null), "02010000000");
			this.CheckForEquality (h2, households[7]);

			var h3 = Tuple.Create (new EervHousehold ("4030044894", new EervAddress (null, "Pré, chemin du", 3, null, "1110", "Morges", "CH"), new EervCoordinates ("802 20 26", null, null, "802 63 39", null), null), "02010000000");
			this.CheckForEquality (h3, households[1235]);

			var h4 = Tuple.Create (new EervHousehold ("4030042257", new EervAddress ("Bureau d'ingénieurs SIA", "Charpentiers, rue des", 36, null, "1110", "Morges", "CH"), new EervCoordinates ("021 802 32 55", "021 804 75 40", null, null, null), null), "02010000000");
		...
		public void LoadEervLegalPersonsTest()
		{
			...
			var t1 = Tuple.Create (new EervLegalPerson ("4030043016", "Services sociaux Couvaloup", new EervAddress (null, "Couvaloup, rue de", 10, null, "1110", "Morges", "CH"), new EervCoordinates (null, null, null, null, null), new EervPerson ("4030043016", "Jacques", "Baudat", null, null, null, "Monsieur", PersonSex.Male, PersonMaritalStatus.None, null, null, PersonConfession.Protestant, null, null, null, null, null, null, null, null, null, null, null, new EervCoordinates (null, null, null, null, null))), "02010000000");
			this.CheckForEquality (t1, legalPersons[0]);

			var t2 = Tuple.Create (new EervLegalPerson ("4030043037", "Paroisse catholique de Morges", new EervAddress (null, "Rond-Point, rue du", 2, null, "1110", "Morges", "CH"), new EervCoordinates ("801 24 35", null, null, "803 14 94", null), new EervPerson ("4030043037", null, "Secrétariat", null, null, null, null, PersonSex.Unknown, PersonMaritalStatus.None, null, null, PersonConfession.Unknown, null, null, null, null, null, null, null, null, null, null, null, new EervCoordinates (null, null, null, null, null))), "02010000000");
		...
		public void LoadEervGroupsTest()
		{
			...
			var g1 = Tuple.Create (new EervGroup ("0403110100", "Office de Taizé"), "02010000000");
			this.CheckForEquality (g1, groups[0]);

			var g2 = Tuple.Create (new EervGroup ("0403111700", "Groupes d'adultes"), "02010000000");
			this.CheckForEquality (g2, groups[16]);

			var g3 = Tuple.Create (new EervGroup ("0403120000", "St-Nicolas"), "02010000000");
		...
		public void LoadEervActivitiesTest()
		{
			...
			var a1 = Tuple.Create (Tuple.Create (new EervActivity (new Date (2004, 8, 20), null, null), "4030010057", "0403050209"), "02010000000");
			this.CheckForEquality (a1, activities[0]);

			var a2 = Tuple.Create (Tuple.Create (new EervActivity (new Date (2005, 8, 22), new Date (2006, 8, 21), null), "4030042696", "0403112400"), "02010000000");
