...
namespace Epsitec.Common.DocumentEditor.Dialogs
{
    ...
    {
        public PageStack(DocumentEditor editor)
            : base(editor) { }
        ...
        public override void Show()
        {
            ...
            if (this.window == null)
            {
                ...
                ToolTip.Default.SetToolTip(
                    this.buttonCurrent,
                    Res.Strings.Dialog.PageStack.Tooltip.Current
                );
            }

            this.showedPage = this.editor
                .CurrentDocument
                .Modifier
                .ActiveViewer
                .DrawingContext
        ...
        protected void UpdateTable()
        {
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                Common.Document.Modifier.PageStackInfos info =
                    infos[i] as Common.Document.Modifier.PageStackInfos;
                StaticText st;
