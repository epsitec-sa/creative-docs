...
namespace Epsitec.Cresus.CorePlugIn.WorkflowDesigner
{
	public class ZoomMenu : System.IComparable
	{
		...
		public static VMenu CreateZoomMenu(double zoomDefault, double zoomCurrent, double zoomPage, EventHandler<MessageEventArgs> message)
		{
			...
			ZoomMenu.Add(list, zoomPage,    "Zoom sur la page");
