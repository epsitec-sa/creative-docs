      ...
      statics:
    {
        handleError: function (response) {
            ...
            if ("code" in errors) {
                ...
                Epsitec.Cresus.Core.Static.ErrorHandler.handleErrorTitleAndMessage(title, message);
            }
            else {
        ...
        handleErrorDefault: function () {
            Ext.Msg.alert("Error", "Something wrong happened and you shouldn't have seen this message if only I did my job properly!");
        },
