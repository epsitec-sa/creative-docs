	...
	public static class DummyMandat
	{
		...
		internal static void AddObjects(DataMandat mandat)
		{
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (3000000.0m)));
				...
				{
					{
						...
						e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (a1, a2)));
					}
				}
			}
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (4550000.0m)));
			...
			objects.Add (o113);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (2000000.0m)));
			...
			objects.Add (o121);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (10400000.0m)));
			...
			objects.Add (o122);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (8000000.0m)));
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (2100000.0m)));
			...
			objects.Add (o132);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (5320000.0m)));
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (1200000.0m)));
			...
			objects.Add (o211);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (150000.0m)));
			...
			objects.Add (o212);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (180000.0m)));
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (90000.0m)));
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (110000.0m)));
			...
			objects.Add (o215);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (195000.0m)));
			...
			objects.Add (o221);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (25000.0m)));
			...
			objects.Add (o222);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (30000.0m)));
			...
			objects.Add (o231);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (22000.0m)));
			...
			objects.Add (o232);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (9000.0m)));
			...
			objects.Add (o233);
			{
				...
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (8000.0m)));
			...
			objects.Add (o235);
			{
				...
				e.AddProperty (new DataStringProperty         (DummyMandat.fieldName,         "Fiat Uno"));
				e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (12000.0m)));
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (16000.0m)));
...

				{
					...
					o236.AddEvent (e);
					e.AddProperty (new DataStringProperty (ObjectField.OneShotNumber, (DummyMandat.EventNumber++).ToString ()));
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (16000.0m, 14500.0m)));
				}
			...
			{
				{
					...
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (5000.0m)));
...

				{
					...
					o237.AddEvent (e);
					e.AddProperty (new DataStringProperty (ObjectField.OneShotNumber, (DummyMandat.EventNumber++).ToString ()));
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (5000.0m, 5200.0m)));
				}
...

				{
					...
					o237.AddEvent (e);
					e.AddProperty (new DataStringProperty (ObjectField.OneShotNumber, (DummyMandat.EventNumber++).ToString ()));
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (5200.0m, 4600.0m)));
				}
...

				{
					...
					o237.AddEvent (e);
					e.AddProperty (new DataStringProperty (ObjectField.OneShotNumber, (DummyMandat.EventNumber++).ToString ()));
					e.AddProperty (new DataAmortizedAmountProperty (ObjectField.MainValue, DummyMandat.NewAmortizedAmount (4600.0m, 2100.0m)));
				}
			}
		}


		private static AmortizedAmount NewAmortizedAmount(decimal value)
		{
		...
		private static AmortizedAmount NewAmortizedAmount(decimal initialAmount, decimal finalAmount)
		{
			var aa = new AmortizedAmount (null)
			{
				AmortizationType = AmortizationType.Degressive,
				InitialAmount    = initialAmount,
				BaseAmount       = initialAmount,
				EffectiveRate    = 1.0m - (finalAmount / initialAmount),
			};
