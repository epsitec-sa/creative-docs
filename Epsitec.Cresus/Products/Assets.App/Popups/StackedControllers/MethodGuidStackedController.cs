...
{
	public class MethodGuidStackedController : AbstractStackedController
	{
		public MethodGuidStackedController(DataAccessor accessor, StackedControllerDescription description)
		...
		public override void CreateUI(Widget parent, int labelWidth, ref int tabIndex)
		{
			...
			TreeTableFiller<SortableNode>.FillColumns (this.controller, this.dataFiller, "Controller.Stacked.Expressions");
			this.UpdateController ();
