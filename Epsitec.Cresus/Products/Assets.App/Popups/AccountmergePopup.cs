...
{
	/// <summary>
	/// Choix de comment il faut fusionner un compte.
	/// </summary>
	public class AccountMergePopup : AbstractPopup
	{
		public AccountMergePopup(DataAccessor accessor, Guid selectedGuid)
		{
		...
		{
			this.CreateTitle ("Choix comment fusionner le compte");
		...
		private Size GetSize()
		{
			...
			int max = (int) (h*0.5) / AccountMergePopup.rowHeight;
			...
			int dy = AbstractPopup.titleHeight
				   + rows * AccountMergePopup.rowHeight
				   + (int) AbstractScroller.DefaultBreadth;
