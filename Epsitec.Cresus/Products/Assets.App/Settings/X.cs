...
namespace Epsitec.Cresus.Assets.App.Settings
{
	public static class X
	{
		...
		public const string ExportCsvFilename = "ExportCsvFilename";
		...
		public const string ExportJsonFilename = "ExportJsonFilename";
		public const string ExportJsonProfile = "ExportJsonProfile";
		public const string ExportPdfFilename = "ExportPdfFilename";
		public const string ExportPdfProfile = "ExportPdfProfile";
		public const string ExportTxtFilename = "ExportTxtFilename";
		public const string ExportTxtProfile = "ExportTxtProfile";
		public const string ExportXmlFilename = "ExportXmlFilename";
		public const string ExportXmlProfile = "ExportXmlProfile";
		public const string ExportYamlFilename = "ExportYamlFilename";
