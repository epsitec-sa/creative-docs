...
{
	public class EventsCategoriesTreeTableFiller2 : AbstractTreeTableFiller2<GuidNode>
	{
		public EventsCategoriesTreeTableFiller2(DataAccessor accessor, BaseType baseType, AbstractNodesGetter<GuidNode> nodesGetter)
