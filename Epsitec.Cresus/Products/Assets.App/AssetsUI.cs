...
namespace Epsitec.Cresus.Assets.App
{
	public class AssetsUI
	{
		...
		private void CreateTimeline(Widget parent)
		{
			...
			this.timelineController.SetRows (AssetsUI.GetRows (false));
			this.UpdateTimelineController ();
		...
		{
			var date = AssetsUI.AddDays (timelineStart, this.timelineController.LeftVisibleCell);
			...
			AssetsUI.InitialiseTimeline (this.timelineController, date, cellsCount, selection, false);
		}
		...
		private static void InitialiseTimeline(NavigationTimelineController timeline, System.DateTime start, int cellsCount, int selection, bool all)
		{
			...
			{
				var date = AssetsUI.AddDays (start, i);
		...
		private void CreateTreeTable(Widget parent)
		{
			...
			this.treeTableController.SetColumns (AssetsUI.GetColumns (), 2);
			this.UpdateTreeTableController ();
		...
		private void UpdateTreeTableController()
		{
			...
			AssetsUI.InitialiseTreeTable (this.treeTableController, first, selection);
		}
