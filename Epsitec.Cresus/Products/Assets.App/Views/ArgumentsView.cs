...
{
	public class ArgumentsView : AbstractView, System.IDisposable
	{
		public ArgumentsView(DataAccessor accessor, CommandContext commandContext, MainToolbar toolbar, ViewType viewType)
			: base (accessor, commandContext, toolbar, viewType)
		{
			this.baseType = BaseType.Arguments;

			this.listController = new ArgumentsToolbarTreeTableController (this.accessor, this.commandContext, BaseType.Arguments);
		...
		public static AbstractViewState GetViewState(Guid expressionGuid, ObjectField field)
		{
		...
		public override AbstractViewState ViewState
		{
			...
			set
			{
				var viewState = value as ArgumentsViewState;
		...
		private readonly ArgumentsToolbarTreeTableController listController;
