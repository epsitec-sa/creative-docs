...
{
	/// <summary>
	/// Permet de choisir un centre de charge, soit en éditant directement le numéro, soit en
	/// choisissant dans une liste.
	/// </summary>
	public class CenterFieldController : AbstractFieldController
	{
		public CenterFieldController(DataAccessor accessor)
			: base (accessor)
		{
		}
		...
		{
			//	Lorsque le widget a le focus, on affiche juste le centre de charge.
		...
		private void ShowPopup()
		{
			...
			var baseType = this.accessor.Mandat.GetCentersBase (this.EffectiveDate);

			CentersPopup.Show (this.textField, this.accessor, baseType, this.Label, this.Value,
				delegate (string center)
			{
				this.Value = center;
