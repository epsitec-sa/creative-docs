	...
	public class ObjectsToolbarTreeTableController : AbstractToolbarTreeTableController<TreeNode>
	{
		...
		protected override void CreateNodeFiller()
		{
			switch (this.baseType)
			{
				...
				case BaseType.Categories:
					this.dataFiller2 = new CategoriesTreeTableFiller2 (this.accessor, this.nodesGetter);
					break;

				case BaseType.Groups:
					this.dataFiller2 = new GroupsTreeTableFiller2 (this.accessor, this.nodesGetter);
					break;
			}
