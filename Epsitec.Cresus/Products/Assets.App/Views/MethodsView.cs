...
{
	public class MethodsView : AbstractView, System.IDisposable
	{
		public MethodsView(DataAccessor accessor, CommandContext commandContext, MainToolbar toolbar, ViewType viewType)
			: base (accessor, commandContext, toolbar, viewType)
		{
			this.baseType = BaseType.Methods;

			this.listController = new MethodsToolbarTreeTableController (this.accessor, this.commandContext, BaseType.Methods);
		...
		public static AbstractViewState GetViewState(Guid expressionGuid, ObjectField field)
		{
			...
			{
				return new MethodsViewState
				{
					ViewType     = ViewType.Methods,
		...
		public override AbstractViewState ViewState
		{
			...
			set
			{
				var viewState = value as MethodsViewState;
		...
		private readonly MethodsToolbarTreeTableController listController;
