...
{
	public class EditorPageUserValues : AbstractEditorPage
	{
		public EditorPageUserValues(DataAccessor accessor, BaseType baseType, BaseType subBaseType, bool isTimeless)
