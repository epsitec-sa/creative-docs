...
namespace Epsitec.Cresus.Assets.Core
{
	public static class Res
	{
		...
		public static class Strings
		{
			...
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Cresus.Assets.Core.Res.Strings.GetString (bundle, path));
			}
			
			private static global::Epsitec.Common.Types.FormattedText GetText(global::Epsitec.Common.Support.Druid druid)
			{
				return new global::Epsitec.Common.Types.FormattedText (global::Epsitec.Cresus.Assets.Core.Res.Strings.GetString (druid));
			}
		...
		static Res()
		{
			...
			Res._manager.DefineDefaultModuleName ("Assets.Core");
			Strings._Initialize ();
		}
