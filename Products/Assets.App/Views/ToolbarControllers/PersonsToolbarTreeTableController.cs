...
namespace Epsitec.Cresus.Assets.App.Views.ToolbarControllers
{
	public class PersonsToolbarTreeTableController : AbstractToolbarBothTreesController<SortableNode>, IDirty, System.IDisposable
	{
		...
		private void CreateObject(IEnumerable<AbstractDataProperty> requiredProperties, Guid model)
		{
			...
			var guid = this.accessor.CreateObject (BaseType.Persons, date, Guid.Empty, false, requiredProperties.ToArray ());
		...
		protected override void UpdateToolbar()
		{
			...
			this.toolbar.SetEnable (Res.Commands.Persons.Export, !this.IsEmpty);
		}
