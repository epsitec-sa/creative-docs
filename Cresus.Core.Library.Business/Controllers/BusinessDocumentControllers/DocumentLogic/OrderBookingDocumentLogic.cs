...
namespace Epsitec.Cresus.Core.Controllers.BusinessDocumentControllers
{
	...
	/// Bon pour commande.
	/// </summary>
	public class OrderBookingDocumentLogic : AbstractDocumentLogic
	{
		public OrderBookingDocumentLogic(BusinessContext businessContext, DocumentMetadataEntity documentMetadataEntity)
