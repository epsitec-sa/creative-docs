...
namespace Epsitec.Common.Drawing
{
    ...
    public sealed class TextStyle : System.ICloneable, IReadOnly, IReadOnlyLock, System.IDisposable
    {
        ...
        {
            get { return this.isDefaultStyle; }
        }
        ...
        {
            get { return (this.fontSize == 0) ? this.parent.FontSize : this.fontSize; }
            set
            {
                this.CheckForDefaultStyle();
        ...
        public RichColor FontRichColor
        {
            get
            {
                return (this.fontColor.IsEmpty)
                    ? new RichColor(this.parent.FontColor)
                    : this.fontColor;
            }
            set
            {
        ...
        {
            get { return (this.fontColor.IsEmpty) ? this.parent.FontColor : this.fontColor.Basic; }
            set
            {
                this.CheckForDefaultStyle();
        ...
        {
            get { return (this.anchorColor.IsEmpty) ? this.parent.AnchorColor : this.anchorColor; }
            set
            {
                this.CheckForDefaultStyle();
        ...
        {
            get { return (this.waveColor.IsEmpty) ? this.parent.WaveColor : this.waveColor; }
            set
            {
                this.CheckForDefaultStyle();
        ...
        public ContentAlignment Alignment
        {
            get
            {
                return (this.alignment == ContentAlignment.None)
        ...
        public TextBreakMode BreakMode
        {
            get
            {
                return (this.breakMode == TextBreakMode.None)
                    ? this.parent.BreakMode
                    : this.breakMode;
            }
            set
            {
        ...
        public TextJustifMode JustifMode
        {
            get
            {
                return (this.justifMode == TextJustifMode.Undefined)
                    ? this.parent.JustifMode
                    : this.justifMode;
            }
            set
            {
        ...
        public bool ShowLineBreaks
        {
            get
            {
                ...
                throw new System.InvalidOperationException(
                    "TextStyle has invalid ShowLineBreak state."
                );
            }
            set
            {
        ...
        {
            get { return (this.language == null) ? this.parent.Language : this.language; }
            set
            {
                this.CheckForDefaultStyle();
        ...
        public double DefaultTabWidth
        {
            get
            {
                return (this.defaultTabWidth == 0.0)
                    ? this.parent.DefaultTabWidth
        ...
        {
            get { return TextStyle.defaultStyle; }
        }
        ...
        {
            TextStyle.defaultStyle.fontSize =
                (fontSize.IsSafeNaN() || fontSize <= 0) ? Font.DefaultFontSize : fontSize;
        }
        ...
        {
            this.changedListeners.Invoke(
                this,
                new DependencyPropertyChangedEventArgs(propertyName)
            );
        }
        ...
        public struct Tab : System.IEquatable<Tab>
        {
            ...
            public static readonly Tab Empty = new Tab(
                double.NaN,
                TextTabType.None,
                TextTabLine.None
            );
            ...
            {
                if ((this.Pos.IsSafeNaN()) && (other.Pos.IsSafeNaN()))
                {
                    //	Same...
                }
        ...
        {
            add { this.changedListeners.Add(value); }
            remove { this.changedListeners.Remove(value); }
        }
