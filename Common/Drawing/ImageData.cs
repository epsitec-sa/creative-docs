...
namespace Epsitec.Common.Drawing
{
    public class ImageData : IQueueable, System.IDisposable
    {
        ...
        {
            get { return System.IO.Path.GetFileName(this.ImageFilePath); }
        }
            ...
            internal set
            {
                lock (this.exclusion)
                {
                    if (this.thumbnail != null)
                    {
                        ...
                        this.thumbnail.Information =
                            this.thumbnail.Information + "/dead " + System.Environment.TickCount;
                    }
                    ...
                    if ((value != null) && (value.IsValid))
                    {
                        ...
                        this.thumbnail.Information =
                            "THUMB:" + this.imageFilePath + "/" + System.Environment.TickCount;
            ...
            internal set
            {
                lock (this.exclusion)
                {
                    if (this.sampleImage != null)
                    {
                        ...
                        this.sampleImage.Information =
                            this.sampleImage.Information + "/dead " + System.Environment.TickCount;
                    }
                    ...
                    if ((value != null) && (value.IsValid))
                    {
                        ...
                        this.sampleImage.Information =
                            "SAMPLE:" + this.imageFilePath + "/" + System.Environment.TickCount;
        ...
        {
            if ((this.compressedThumbnail != null) && (this.thumbnail == null))
            {
        ...
        {
            if ((this.compressedSampleImage != null) && (this.sampleImage == null))
            {
        ...
        private void CompressThumbnail()
        {
            if ((this.compressedThumbnail == null) && (this.thumbnail != null))
            {
                this.compressedThumbnail = this.thumbnail.SaveToMemory(
                    new BitmapFileFormat() { Type = BitmapFileType.Jpeg, Quality = 75 }
                );
        ...
        private void CompressSampleImage()
        {
            if ((this.compressedSampleImage == null) && (this.sampleImage != null))
            {
                this.compressedSampleImage = this.sampleImage.SaveToMemory(
                    new BitmapFileFormat() { Type = BitmapFileType.Jpeg, Quality = 75 }
                );
        ...
        private void CreateThumbnailWithActiveExclusion()
        {
            ...
            try
            {
                ...
                if (sampleImage == null)
                {
                    byte[] cachedSampleImageData = ImageManager.ImageStore.LoadImageData(
                        this.imageId,
                        this.imageFileDate,
                        this.engine.SampleImageSize,
                        out this.width,
                        out this.height
                    );
                    ...
                    System.Diagnostics.Debug.Assert(
                        ...
                        "CompressedSampleImage not null"
                    );

                    if ((cachedSampleImageData == null) || (cachedSampleImageData.Length == 0))
                    {
                        this.LoadImageData();

                        if ((this.fullImage == null) || (this.fullImage.IsValid == false))
                        {
                            return;
                        }
                        ...
                        if (sampleImage != null)
                        {
                            if (ImageManager.ImageStore != null)
                            {
                                this.compressedSampleImage = ImageManager.ImageStore.SaveImageData(
                                    this.imageId,
                                    this.imageFileDate,
                                    this.engine.SampleImageSize,
                                    this.width,
                ...
                if (thumbnail == null)
                {
                    byte[] cachedThumbnailData = ImageManager.ImageStore.LoadImageData(
                        this.imageId,
                        this.imageFileDate,
                        this.engine.ThumbnailSize,
                        out this.width,
                        out this.height
                    );
                    ...
                    System.Diagnostics.Debug.Assert(
                        ...
                        "CompressedThumbnail not null"
                    );

                    if ((cachedThumbnailData == null) || (cachedThumbnailData.Length == 0))
                    {
                        thumbnail = sampleImage.MakeThumbnail(this.engine.ThumbnailSize);

                        if (thumbnail != null)
                        {
                            this.compressedThumbnail = ImageManager.ImageStore.SaveImageData(
                                this.imageId,
                                this.imageFileDate,
                                this.engine.ThumbnailSize,
                                this.width,
        ...
        {
            if ((oldStatus == QueueStatus.Working) && (newStatus == QueueStatus.Pending))
            {
                System.Diagnostics.Debug.WriteLine("Should not happen: working->pending");
            }
            if ((oldStatus == QueueStatus.Inactive) && (newStatus == QueueStatus.Working))
            {
