...
namespace Epsitec.Common.Drawing.Platform
{
    ...
    internal static class SystemDrawingBitmapHelper
    {
        ...
        public static System.Drawing.Bitmap Generate1BppBitmapMask(NativeBitmap source)
        {
            ...
            SystemDrawingBitmapHelper.CopyPalette(
                bitmap,
                SystemDrawingBitmapHelper.GetMonochromePalette()
            );
        ...
        public static System.Drawing.Bitmap Generate8BppAlphaMask(
            NativeBitmap source,
            bool invertAlpha
        )
        {
            ...
            SystemDrawingBitmapHelper.CopyPalette(
                bitmap,
                SystemDrawingBitmapHelper.Get256GrayPalette()
            );
        ...
        public static System.Drawing.Bitmap Generate4BppBitmapWithFixedPalette(NativeBitmap source)
        {
            System.Drawing.Color[] fixedPalette =
                SystemDrawingBitmapHelper.GetWindows16ColorPalette();
        ...
        /// <param name="source">The image source.</param>
        /// <returns>The 4 bit per pixel bitmap.</returns>
        public static System.Drawing.Bitmap Generate4BppBitmapWithTransparentColor(
            NativeBitmap source
        )
        {
            NativeBitmap source32 = source.ConvertToPremultipliedArgb32();
            ...
            System.Drawing.Color[] palette = source8
                .GetPalette()
                .Concat(SystemDrawingBitmapHelper.GetInfiniteTransparentPalette())
                .Take(16)
                .Select(x => System.Drawing.Color.FromArgb(x.A, x.R, x.G, x.B))
                .ToArray();
        ...
        public static System.Drawing.Bitmap Generate8BppBitmapWithTransparentColor(
            NativeBitmap source
        )
        {
            NativeBitmap source32 = source.ConvertToPremultipliedArgb32();
        ...
        internal static NativeBitmap Create24bppImage(System.Drawing.Bitmap bitmap)
        {
            ...
            unsafe
            {
                ...
                for (int y = 0; y < dy; y++)
                {
                    ...
                    output.WritePixels(
                        new System.Windows.Int32Rect(0, y, dx, 1),
                        rawDst,
                        dx * 3,
                        0
                    );
