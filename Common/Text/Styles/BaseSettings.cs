...
namespace Epsitec.Common.Text.Styles
{
            ...
            Common.Support.IXMLWritable
    {
        ...
        protected BaseSettings(System.Collections.ICollection properties)
            : base(properties) { }
        ...
        public int CoreIndex
        {
            ...
            get { return this.coreIndex; }
            set { this.coreIndex = value; }
        }

        public int CountLocalSettings
        {
            get { return this.localSettings == null ? 0 : this.localSettings.Length; }
        }

        public int CountExtraSettings
        {
            get { return this.extraSettings == null ? 0 : this.extraSettings.Length; }
        }
        ...
        public bool Contains(
            ulong code,
            Properties.WellKnownType wellKnownType,
        ...
        internal void Serialize(System.Text.StringBuilder buffer)
        {
            ...
            if ((this.localSettings != null) && (this.localSettings.Length > 0))
            {
            ...
            if ((this.extraSettings != null) && (this.extraSettings.Length > 0))
            {
