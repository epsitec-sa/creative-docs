...
namespace Epsitec.Common.Text
{
            ...
            Common.Support.IXMLWritable
    {
        ...
        public abstract Properties.WellKnownType WellKnownType { get; }

        public abstract Properties.PropertyType PropertyType { get; }

        public virtual Properties.PropertyAffinity PropertyAffinity
        {
            get { return Properties.PropertyAffinity.Text; }
        }

        public virtual Properties.CombinationMode CombinationMode
        {
            get { return Properties.CombinationMode.Combine; }
        }
        ...
        public abstract void DeserializeFromText(
            TextContext context,
            string text,
            int pos,
            int length
        ...
        public static bool CompareEqualContents(Property[] a, Property[] b)
        {
            ...
            if (((a == null) && (b.Length == 0)) || ((b == null) && (a.Length == 0)))
            {
                return true;
            }
            if ((a == null) || (b == null))
        ...
        )
        {
            ...
            if (((a == null) && (b.Count == 0)) || ((b == null) && (a.Count == 0)))
            {
                return true;
            }
            if ((a == null) || (b == null))
        ...
        public static Property[] DeserializeProperties(TextContext context, string text)
        {
            ...
            {
                properties[i] = Property.Deserialize(
                    context,
                    version,
        ...
        public static void SerializeToText(System.Text.StringBuilder buffer, Property property)
        {
            ...
            if ((property.internalName != null) && (property.internalName.Length > 0))
            {
                buffer.Append(",");
        ...
        )
        {
            ...
            if (template == null)
            {
                ...
                string typeName = string.Concat(
                    "Epsitec.Common.Text.Properties.",
                    propName,
                    "Property"
                );
        ...
        public static Property[] Filter(
            ...
            Properties.PropertyFilter filter
        )
        {
            switch (filter)
            {
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Filter {0} not supported", filter)
                    );
            }
        }
        ...
        private static Property[] FilterNonUniformParagraph(
            System.Collections.ICollection properties
        )
        {
            int count = 0;
