...
namespace Epsitec.Common.Text
{
    ...
    public static class Unicode
    {
                ...
                if (Unicode.breakAnalyzer == null)
                {
                    ...
                    using (
                        System.IO.Stream stream = assembly.GetManifestResourceStream(
                            "Epsitec.Common.Text.Resources.LineBreak.compressed"
                        )
                    )
                    {
        ...
        public class BreakAnalyzer
        {
            ...
            public Unicode.BreakClass this[int code]
            {
                get
                {
                    ...
                    else
                    {
                        ...
                        {
                            if ((elem.codeBegin <= code) && (elem.codeEnd >= code))
                            {
            ...
            public static void GetStretchClass(
                ulong[] text,
                int start,
                int length,
                byte[] attributes
            ...
            )
            {
                ...
                for (int i = 0; i < length; i++)
                {
                    ...
                    switch (curClass)
                    {
                        ...
                        case Unicode.BreakClass.SP_Space:
                            if (
                                (prvClass == Unicode.BreakClass.OP_OpeningPunctuation)
                                || (
                        ...
                        case Unicode.BreakClass.AL_OrdinaryAlphabeticAndSymbol:
                            if (
                                ...
                                && (
                                    cclass[i - 2]
                                    == Unicode.BreakClass.AL_OrdinaryAlphabeticAndSymbol
                                )
                                && (prvUnicode == '\'')
                            )
                            {
                ...
                breaks[0] =
                    cclass[0] == Unicode.BreakClass.BK_MandatoryBreak
                        ? Unicode.BreakInfo.Yes
                        : Unicode.BreakInfo.No;
                ...
                for (int i = 1; i < length; i++)
                {
                    ...
                    if (
                        (cclass[i] == Unicode.BreakClass.BK_MandatoryBreak)
                    ...
                    if (
                        (cclass[i + 1] == Unicode.BreakClass.CL_ClosingPunctuation)
		...
		if (cclass[i] == agg::unicode_helper::CL_ClosingPunctuation)				//	LB 11 / Don't break within ']<non starter>', even with intervening spaces
		{
			...
			if (cclass[j] == agg::unicode_helper::NS_NonStarter)
			{
				...
				continue;
                    ...
                    if (
                        (cclass[i] == Unicode.BreakClass.GL_NonBreakingGlue)
                    ...
                    if (
                        (cclass[i] == Unicode.BreakClass.QU_AmbiguousQuotation)
                    ...
                    if (
                        (cclass[i + 1] == Unicode.BreakClass.BA_BreakOpportunityAfter)
                    ...
                    if (
                        (cclass[i] == Unicode.BreakClass.HY_Hyphen)
                    ...
                    {
                        if (
                            (cclass[i] == Unicode.BreakClass.AL_OrdinaryAlphabeticAndSymbol)
                    ...
                    {
                        if (
                            (cclass[i] == Unicode.BreakClass.CL_ClosingPunctuation)
                            || (cclass[i] == Unicode.BreakClass.NU_Numeric)
                        )
                        {
                            breaks[i] = Unicode.BreakInfo.No;
            ...
            public static double GetSpaceWidth(
                ulong code,
                double spaceWidth,
                double enWidth,
                double emWidth,
            ...
            {
                return BreakAnalyzer.GetSpaceWidth(
                    (Unicode.Code)code,
                    spaceWidth,
                    enWidth,
                    emWidth,
            ...
            private static Unicode.BreakClass ParseBreakClass(string token)
            {
                switch (token)
                {
                    case "XX":
                        return Unicode.BreakClass.XX_Unknown;
                    case "BK":
                        return Unicode.BreakClass.BK_MandatoryBreak;
                    case "CR":
                        return Unicode.BreakClass.CR_CarriageReturn;
                    case "LF":
                        return Unicode.BreakClass.LF_LineFeed;
                    case "CM":
                        return Unicode.BreakClass.CM_CombiningMarks;
                    case "SG":
                        return Unicode.BreakClass.SG_Surrogates;
                    case "GL":
                        return Unicode.BreakClass.GL_NonBreakingGlue;
                    case "CB":
                        return Unicode.BreakClass.CB_ContingentBreakOpportunity;
                    case "SP":
                        return Unicode.BreakClass.SP_Space;
                    case "ZW":
                        return Unicode.BreakClass.ZW_ZeroWidthSpace;
                    case "NL":
                        return Unicode.BreakClass.NL_NewLine;
                    case "WJ":
                        return Unicode.BreakClass.WJ_WordJoiner;
                    case "BA":
                        return Unicode.BreakClass.BA_BreakOpportunityAfter;
                    case "BB":
                        return Unicode.BreakClass.BB_BreakOpportunityBefore;
                    case "B2":
                        return Unicode.BreakClass.B2_BreakOpportunityBeforeAndAfter;
                    case "HY":
                        return Unicode.BreakClass.HY_Hyphen;
                    case "IN":
                        return Unicode.BreakClass.IN_Inseparable;
                    case "NS":
                        return Unicode.BreakClass.NS_NonStarter;
                    case "OP":
                        return Unicode.BreakClass.OP_OpeningPunctuation;
                    case "CL":
                        return Unicode.BreakClass.CL_ClosingPunctuation;
                    case "QU":
                        return Unicode.BreakClass.QU_AmbiguousQuotation;
                    case "EX":
                        return Unicode.BreakClass.EX_ExclamationInterrogation;
                    case "NU":
                        return Unicode.BreakClass.NU_Numeric;
                    case "IS":
                        return Unicode.BreakClass.IS_InfixSeparatorNumeric;
                    case "SY":
                        return Unicode.BreakClass.SY_SymbolsAllowingBreaks;
                    case "PR":
                        return Unicode.BreakClass.PR_PrefixNumeric;
                    case "PO":
                        return Unicode.BreakClass.PO_PostfixNumeric;
                    case "AL":
                        return Unicode.BreakClass.AL_OrdinaryAlphabeticAndSymbol;
                    case "ID":
                        return Unicode.BreakClass.ID_Ideographic;
                    case "AI":
                        return Unicode.BreakClass.AI_AmbiguousAlphabeticOrIdeographic;
                    case "SA":
                        return Unicode.BreakClass.SA_ComplexContextSouthEastAsian;

                    case "JL":
                    case "JV":
                    case "JT": //	Jamo, 4.1.0
                    case "H2":
                    case "H3": //	Hangul, 4.1.0
                        return Unicode.BreakClass.ID_Ideographic;
                }
            ...
            {
                get { return this.elements[this.elements.Count - 1] as Element; }
            }
