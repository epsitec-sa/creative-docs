...
namespace Epsitec.Common.Text.ParagraphManagers
{
    ...
    public class ItemListManager : ParagraphManager
    {
        ...
        public override void AttachToParagraph(
            TextStory story,
            ICursor cursor,
        ...
        )
        {
            ...
            Properties.GeneratorProperty generatorProp = new Properties.GeneratorProperty(
                p.Generator.Name,
                0,
                context.GenerateUniqueId()
            );
        ...
        public override void DetachFromParagraph(
            TextStory story,
            ICursor cursor,
            Properties.ManagedParagraphProperty property
        )
        {
            ...
            System.Diagnostics.Debug.Assert(
                context.ContainsProperty(story, cursor, 0, property) == false
            );
            ...
            Properties.AutoTextProperty autoTextProp = Properties.AutoTextProperty.Find(
                flattenedProperties,
                this.Name
            );
        ...
        public override void RefreshParagraph(
            TextStory story,
            ICursor cursor,
            Properties.ManagedParagraphProperty property
        )
        ...
        public class Parameters
        {
            ...
            public Properties.TabProperty TabItem
            {
                ...
                set { this.tabItem = value; }
            }

            public Properties.TabProperty TabBody
            {
                get { return this.tabBody; }
                set { this.tabBody = value; }
            }
            ...
            public Properties.FontOffsetProperty FontOffset
            {
                ...
                set { this.fontOffset = value; }
            }

            public void Load(TextContext context, string[] parameters)
            {
                System.Diagnostics.Debug.Assert(
                    (parameters.Length == 3) || (parameters.Length == 6)
                );
