...
namespace Epsitec.Common.Text
{
    ...
    public class TextContext : ILanguageRecognizer, Common.Support.IXMLSerializable<TextContext>
    {
        ...
        {
            get { return this.generatorList; }
        }

        public ParagraphManagerList ParagraphManagerList
        {
            get { return this.pManagerList; }
        }
        ...
        {
            get { return this.defaultParaStyle; }
            set { this.defaultParaStyle = value; }
        }

        public TextStyle DefaultTextStyle
        {
            get { return this.defaultTextStyle; }
            set { this.defaultTextStyle = value; }
        }

        public bool ShowControlCharacters
        {
            get { return this.showControlCharacters; }
            set { this.showControlCharacters = value; }
        }

        public bool IsDegradedLayoutEnabled
        {
            get { return this.isDegradedLayoutEnabled; }
            set { this.isDegradedLayoutEnabled = value; }
        }

        public bool IsPropertiesPropertyEnabled
        {
            get { return this.isPropertiesPropertyEnabled; }
            set { this.isPropertiesPropertyEnabled = value; }
        }
        ...
        public string SerializeToString()
        {
            ...
            string defaultParaStyleName =
                this.defaultParaStyle == null ? null : this.defaultParaStyle.Name;
            string defaultTextStyleName =
                this.defaultTextStyle == null ? null : this.defaultTextStyle.Name;
        ...
        public void DeserializeFromString(string data)
        {
            ...
            if (version >= 2)
            {
                ...
                this.defaultParaStyle = this.styleList[
                    defaultParaStyleName,
        ...
        public bool GetGlyphAndFontForSpecialCode(
            ulong code,
            out ushort specialGlyph,
            out OpenType.Font specialFont
        )
        {
        ...
        {
            if ((this.resources != null) && (this.resources.Contains(name)))
            {
        ...
        {
            OpenType.FontCollection.FontListFilter = delegate(string family)
            {
        ...
        public static string[] GetAvailableFontFaces()
        {
            ...
            Dictionary<string, OpenType.FontIdentity> hash =
                new Dictionary<string, OpenType.FontIdentity>();
        ...
        public void GetFontSize(
            ...
            Properties.FontSizeProperty fontSizeProperty,
            Properties.FontXscriptProperty fontXscriptProperty,
            out double fontSize,
        ...
        )
        {
            ...
            fontScale =
                (fontXscriptProperty == null) || (fontXscriptProperty.IsDisabled)
                    ? 1.0
                    : fontXscriptProperty.Scale;
            fontGlue = fontSizeProperty.Glue.IsSafeNaN() ? 0 : fontSize * fontSizeProperty.Glue;
        }
        ...
        public void GetFontBaselineOffset(
            double fontPtSize,
            Property[] properties,
            out double offset
        )
        {
            ...
            offset =
                (fontOffsetProperty == null) ? 0 : fontOffsetProperty.GetOffsetInPoints(fontPtSize);

            if ((fontXscriptProperty != null) && (fontXscriptProperty.IsDisabled == false))
            {
        ...
        public void GetFontOffsets(ulong code, out double baselineOffset, out double advanceOffset)
        {
            ...
            Properties.FontXscriptProperty fontXscriptP =
                coreSettings[Properties.WellKnownType.FontXscript]
                as Properties.FontXscriptProperty;

            if (localSettings != null)
            {
                Properties.FontOffsetProperty fontOffsetP =
                    localSettings[Properties.WellKnownType.FontOffset]
                    as Properties.FontOffsetProperty;
                Properties.FontKernProperty fontKernP =
                    localSettings[Properties.WellKnownType.FontKern] as Properties.FontKernProperty;
            ...
            if ((fontXscriptP != null) && (fontXscriptP.IsDisabled == false))
            {
        ...
        public void GetColor(ulong code, out string color)
        {
            ...
            Properties.FontColorProperty colorP =
                extraSettings[Properties.WellKnownType.FontColor] as Properties.FontColorProperty;
        ...
        public void GetOpenType(ulong code, out Properties.OpenTypeProperty property)
        {
            ...
            {
                property =
                    localSettings[Properties.WellKnownType.OpenType] as Properties.OpenTypeProperty;
            }
        }
        ...
        public void GetLanguage(ulong code, out Properties.LanguageProperty property)
        {
            ...
            Styles.ExtraSettings extraSettings =
                coreSettings == null ? null : coreSettings.GetExtraSettings(code);

            property =
                extraSettings == null
                    ? null
                    : extraSettings[Properties.WellKnownType.Language]
        ...
        public IParagraphManager GetParagraphManager(ulong code)
        {
            ...
            if ((code != 0) && (this.GetManagedParagraph(code, out mpp)))
            {
        ...
        public bool GetManagedParagraph(
            ulong code,
            out Properties.ManagedParagraphProperty property
        )
        {
            int currentStyleIndex = Internal.CharMarker.GetCoreIndex(code);
            long currentStyleVersion = this.styleList.Version;
            ...
            property =
                coreSettings[Properties.WellKnownType.ManagedParagraph]
        ...
        public void GetManagedInfo(
            ulong code,
            string name,
            out Properties.ManagedInfoProperty property
        )
        {
            Styles.CoreSettings coreSettings = this.styleList[code];
            Styles.ExtraSettings extraSettings = coreSettings.GetExtraSettings(code);
        ...
        public bool GetAutoText(ulong code, out Properties.AutoTextProperty property)
        {
            ...
            property =
                extraSettings == null
                    ? null
                    : extraSettings[Properties.WellKnownType.AutoText]
                        as Properties.AutoTextProperty;
        ...
        public bool GetGenerator(ulong code, out Properties.GeneratorProperty property)
        {
            ...
            property =
                extraSettings == null
                    ? null
                    : extraSettings[Properties.WellKnownType.Generator]
                        as Properties.GeneratorProperty;
        ...
        public void GetConditions(
            ulong code,
            out Properties.ConditionalProperty[] properties,
            out bool summary
        )
        {
            int currentStyleIndex = Internal.CharMarker.GetCoreIndex(code);
            ...
            {
                Styles.CoreSettings coreSettings = this.styleList.GetCoreFromIndex(
                    currentStyleIndex
                );

                Property[] props = coreSettings.FindProperties(
                ...
                foreach (Properties.ConditionalProperty conditionP in props)
                {
                    ...
                    if ((showIf && !isTrue) || (!showIf && isTrue))
                    {
                        ok = false;
                        break;
                    }
            ...
            if (this.getConditionLastProperties.Length > 0)
            {
                ...
                properties = new Properties.ConditionalProperty[
                    this.getConditionLastProperties.Length
                ];
        ...
        public void GetProperties(ulong code, out Property[] properties)
        {
            if (this.IsPropertiesPropertyEnabled)
            {
                ...
                )
                {
                    ...
                    Properties.PropertiesProperty props =
                        coreSettings == null
                            ? null
                            : coreSettings[Properties.WellKnownType.Properties]
                                as Properties.PropertiesProperty;
                    ...
                    else
                    {
                        ...
                        {
                            this.getPropertiesLastProperties =
                                Properties.PropertiesProperty.DeserializePropertiesFromStringArray(
                                    this,
                                    serialized
                                );
                        }
        ...
        public void GetStylesAndProperties(
            ulong code,
        ...
        public void GetStyles(ulong code, out TextStyle[] styles)
        {
            ...
            )
            {
                ...
                {
                    props =
                        coreSettings[Properties.WellKnownType.Styles] as Properties.StylesProperty;
        ...
        public TextStyle[] AddDefaultTextStyleIfNeeded(TextStyle[] styles)
        {
            ...
            {
                if (
                    (styles[i] == this.defaultTextStyle)
        ...
        internal void GetFlatProperties(
        ...
        internal void GetPropertiesQuickAndDirty(
            ulong code,
            out TextStyle[] styles,
            out Property[] properties
        )
        {
            ...
            foreach (Property property in allProperties)
            {
                ...
                else if (property.WellKnownType == Properties.WellKnownType.Tabs)
                {
                    ...
                    (property.WellKnownType == Properties.WellKnownType.Generator)
                    ||
        ...
        internal void AccumulateProperties(
            System.Collections.ICollection textProperties,
            out Property[] properties
        )
        {
        ...
        public void GetXlines(ulong code, out Properties.AbstractXlineProperty[] properties)
        {
            ...
            )
            {
                ...
                if (extraSettings != null)
                {
                    baseProps = extraSettings.FindProperties(
                        Properties.WellKnownType.Underline,
                        Properties.WellKnownType.Strikeout,
                        Properties.WellKnownType.Overline,
                        Properties.WellKnownType.TextBox,
            ...
            if (
                (this.getUnderlinesLastProperties != null)
        ...
        public void GetLinks(ulong code, out Properties.LinkProperty[] properties)
        {
            ...
            if ((this.getLinksLastProperties != null) && (this.getLinksLastProperties.Length > 0))
            {
        ...
        public void GetUserTags(ulong code, out Properties.UserTagProperty[] properties)
        {
            ...
            if (
                (this.getUsertagsLastProperties != null)
        ...
        public void GetLayoutEngine(
            ulong code,
            out Layout.BaseEngine engine,
            out Properties.LayoutProperty property
        )
        {
            int currentStyleIndex = Internal.CharMarker.GetCoreIndex(code);
            long currentStyleVersion = this.styleList.Version;
        ...
        public void GetBreak(ulong code, out Properties.BreakProperty property)
        {
            ...
            {
                property =
                    localSettings[Properties.WellKnownType.Break] as Properties.BreakProperty;
            }
        }
        ...
        public void GetTabAndTabs(
            ulong code,
            out Properties.TabProperty tabProperty,
            out Properties.TabsProperty tabsProperty
        )
        {
            code = Internal.CharMarker.ExtractCoreAndSettings(code);
            ...
            {
                tabsProperty =
                    extraSettings[Properties.WellKnownType.Tabs] as Properties.TabsProperty;
            }
        }
        ...
        public void GetImage(ulong code, out Properties.ImageProperty property)
        {
            ...
            {
                property =
                    localSettings[Properties.WellKnownType.Image] as Properties.ImageProperty;
            }
            else
            {
                property = null;
        ...
        public bool ContainsProperty(TextStory story, ICursor cursor, int offset, Property property)
        {
            ...
            if (code != 0)
            {
                ...
                if ((coreSettings != null) && (coreSettings.Contains(code, property)))
                {
                    return true;
                }
            }
        ...
        private class TextFinder
        {
            ...
            {
                get { return new TextStory.CodeCallback(this.Find); }
            }
        ...
        public class DefaultMarkers
        {
            ...
            {
                get { return this.requiresSpellChecking; }
            }

            public ulong SpellCheckingError
            {
                get { return this.spellCheckingError; }
            }
        ...
        )
        {
            ...
            Properties.FontProperty fontP =
                coreSettings[Properties.WellKnownType.Font] as Properties.FontProperty;
            Properties.FontSizeProperty fontSizeP =
                coreSettings[Properties.WellKnownType.FontSize] as Properties.FontSizeProperty;
            Properties.FontXscriptProperty fontXscriptP =
                coreSettings[Properties.WellKnownType.FontXscript]
                as Properties.FontXscriptProperty;
        ...
        static Dictionary<string, List<OpenType.FontIdentity>> fontIds =
            new Dictionary<string, List<Epsitec.Common.OpenType.FontIdentity>>();
