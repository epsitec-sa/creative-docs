...
namespace Epsitec.Common.Text.Internal
{
    ...
    /// </summary>
    public class GeneratorEnumerator
        : System.IDisposable,
            ...
            System.Collections.IEnumerable
    {
        ...
        public GeneratorEnumerator(TextStory story, Properties.GeneratorProperty generator)
            : this(story, null, generator.Generator) { }
        ...
        {
            get { return this.state == State.Restarted; }
        }
        ...
        public bool MoveNext()
        {
            ...
            for (; ; )
            {
                ...
                length = this.story.TextTable.GetRunLength(
                ...
                if (this.failureCache.Contains(code))
                {
                    ...
                    {
                        this.Process(
                            this.failureCache[code] as Properties.ManagedParagraphProperty
                        );
                    }
                ...
                if (generator != null)
                {
                    if ((pos > 0) && (generator.UniqueId == this.generatorUniqueId))
                    {
                        continue;
                    }
                ...
                if (this.property != null)
                {
                    Properties.ManagedParagraphProperty managed = this.GetManagedParagraphProperty(
                        code
                    );
        ...
        {
            if ((this.state == State.Continue) || (this.state == State.Restarted))
            {
                if (property == null)
                {
        ...
        public Properties.ManagedParagraphProperty GetManagedParagraphProperty(ulong code)
        {
            ...
            return core[Properties.WellKnownType.ManagedParagraph]
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (disposing)
            {
                if ((this.story != null) && (this.cursor != null))
                {
