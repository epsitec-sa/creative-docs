...
namespace Epsitec.Common.Text.Cursors
{
    ...
    public class FitterCursor : Cursors.TempCursor
    {
        ...
        {
            get { return this.paragraphY; }
        }

        public double ParagraphNextY
        {
            get { return this.paragraphNextY; }
        }

        public double SpaceAfterParagraph
        {
            get { return this.spaceAfterParagraph; }
        }

        public bool KeepWithNextParagraph
        {
            get { return this.keepWithNextParagraph; }
        }
        ...
        {
            get { return new CursorInfo.Filter(FitterCursor.FilterCallback); }
        }
        ...
        internal int GetElementStartPosition(int index)
        {
            if ((index < 0) || (index >= this.elements.Length))
            {
                throw new System.ArgumentOutOfRangeException(
                    "index",
                    index,
                    string.Format("Index {0} not in 0..{1}", index, this.elements.Length)
                );
            }
        ...
        public struct Element
        {
            ...
            {
                get { return this.lineStartX; }
                set { this.lineStartX = value; }
            }

            public double LineOriginX
            {
                get { return this.lineOriginX; }
                set { this.lineOriginX = value; }
            }

            public double LineBaseY
            {
                get { return this.lineBaseY; }
                set { this.lineBaseY = value; }
            }

            public double LineY1
            {
                get { return this.lineY1; }
                set { this.lineY1 = value; }
            }

            public double LineY2
            {
                get { return this.lineY2; }
                set { this.lineY2 = value; }
            }
            ...
            {
                get { return this.lineAscender; }
                set { this.lineAscender = value; }
            }

            public double LineDescender
            {
                get { return this.lineDescender; }
                set { this.lineDescender = value; }
            }

            public bool IsTabulation
            {
                get { return this.isTabulation; }
                set { this.isTabulation = value; }
            }

            public bool IsNewLine
            {
                get { return this.isNewLine; }
                set { this.isNewLine = value; }
            }
