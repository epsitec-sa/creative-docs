...
namespace Epsitec.Common.Text
{
    ...
    public sealed class TextStyle
        : Styles.PropertyContainer,
            IContentsComparer,
            Common.Support.IXMLSerializable<TextStyle>
    {
        internal TextStyle() { }
        ...
        )
        {
            ...
            if ((parentStyles == null) || (parentStyles.Count == 0))
            {
        ...
        {
            get { return this.textStyleClass; }
        }
        ...
        public TextStyle[] ParentStyles
        {
            get
            {
                if (this.parentStyles != null)
                {
                    ...
                    {
                        if ((style != null) && (style.IsDeleted == false))
                        {
                            list.Add(style);
                        }
                    }
        ...
        {
            get { return new TextStyleComparer(); }
        }
        ...
        internal void Serialize(System.Text.StringBuilder buffer)
        {
            ...
            int nStyles = this.parentStyles?.Length ?? 0;
        ...
        public override XElement ToXML()
        {
            ...
            if (this.styleProperties != null)
            {
                root.Add(
                    new XElement(
                        "StyleProperties",
                        this.styleProperties.Select(prop => prop.ToXML())
                    )
                );
            }
            return root;
        ...
        internal void Deserialize(TextContext context, int version, string[] args, ref int offset)
        {
            ...
            TextStyleClass tsc = (TextStyleClass)
                SerializerSupport.DeserializeEnum(typeof(TextStyleClass), args[offset++]);
        ...
        {
            if (
                (a.textStyleClass == b.textStyleClass)
                && (a.metaId == b.metaId)
        ...
        public static TextStyle[] FilterStyles(
            System.Collections.ICollection styles,
            params TextStyleClass[] textStyleClasses
        )
        {
            int count = 0;
