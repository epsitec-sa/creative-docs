...
namespace Epsitec.Common.Text.Properties
{
    ...
    public sealed class UnitsTools
    {
            ...
            switch (bUnits)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("Unsupported units: {0}.", bUnits)
                    );
            }
        }
        ...
        {
            if ((units == SizeUnits.Percent) || (units == SizeUnits.PercentNotCombining))
            {
                value *= 100;
            }
            ...
            return string.Format(
                ...
                "{0} {1}",
                value,
                UnitsTools.SerializeSizeUnits(units)
            );
        }
        ...
        public static SizeUnits DeserializeSizeUnits(string text)
        {
            ...
            {
                case "":
                    return SizeUnits.None;
                case "pt":
                    return SizeUnits.Points;
                case "mm":
                    return SizeUnits.Millimeters;
                case "in":
                    return SizeUnits.Inches;
                case "+pt":
                    return SizeUnits.DeltaPoints;
                case "+mm":
                    return SizeUnits.DeltaMillimeters;
                case "+in":
                    return SizeUnits.DeltaInches;
                case "%":
                    return SizeUnits.Percent;
                case "!%":
                    return SizeUnits.PercentNotCombining;
            }
            ...
            switch (units)
            {
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Cannot convert from {0} to {1}.", units, SizeUnits.Points)
                    );
            }
        }
        ...
        public static double ConvertToInches(double value, SizeUnits units)
        {
            switch (units)
            {
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Cannot convert from {0} to {1}.", units, SizeUnits.Inches)
                    );
            }
        }
        ...
        public static double ConvertToScale(double value, SizeUnits units)
        {
            switch (units)
            {
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Cannot convert from {0} to {1}.", units, SizeUnits.Percent)
                    );
            }
        }

        public static double ConvertToSizeUnits(
            double value,
            SizeUnits fromUnits,
            SizeUnits toUnits
        )
        {
            ...
            throw new System.InvalidOperationException(
                string.Format("Cannot convert from {0} to {1}.", fromUnits, toUnits)
            );
        }
    }
}
