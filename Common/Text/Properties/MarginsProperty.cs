...
namespace Epsitec.Common.Text.Properties
{
    ...
    public class MarginsProperty : Property, Common.Support.IXMLSerializable<MarginsProperty>
    {
        ...
        public MarginsProperty(
            double leftMarginFirstLine,
            double leftMarginBody,
            double rightMarginFirstLine,
            double rightMarginBody,
            SizeUnits units,
            double justificationBody,
            double justificationLastLine,
            double disposition,
            double breakFenceBefore,
            double breakFenceAfter,
            ThreeState enableHyphenation
        )
            : this(
                leftMarginFirstLine,
                leftMarginBody,
                rightMarginFirstLine,
                rightMarginBody,
                units,
                justificationBody,
                justificationLastLine,
                disposition,
                breakFenceBefore,
                breakFenceAfter,
                enableHyphenation,
        ...
        {
            get { return WellKnownType.Margins; }
        }
        ...
        {
            get { return this.leftMarginFirstLine; }
        }

        public double LeftMarginBody
        {
            get { return this.leftMarginBody; }
        }

        public double RightMarginFirstLine
        {
            get { return this.rightMarginFirstLine; }
        }

        public double RightMarginBody
        {
            get { return this.rightMarginBody; }
        }
        ...
        {
            get { return this.justificationBody; }
        }

        public double JustificationLastLine
        {
            get { return this.justificationLastLine; }
        }
        ...
        {
            get { return this.levelAttribute; }
        }
        ...
        )
        {
            ...
            string levelAttribute =
                (args.Length < 13) ? null : SerializerSupport.DeserializeString(args[12]);
        ...
        public override Property GetCombination(Property property)
        {
            ...
            {
                c.leftMarginFirstLine = NumberSupport.Combine(
                    UnitsTools.ConvertToSizeUnits(a.leftMarginFirstLine, a.units, b.units),
                    b.leftMarginFirstLine
                );
                c.leftMarginBody = NumberSupport.Combine(
                    UnitsTools.ConvertToSizeUnits(a.leftMarginBody, a.units, b.units),
                    b.leftMarginBody
                );
                c.rightMarginFirstLine = NumberSupport.Combine(
                    UnitsTools.ConvertToSizeUnits(a.rightMarginFirstLine, a.units, b.units),
                    b.rightMarginFirstLine
                );
                c.rightMarginBody = NumberSupport.Combine(
                    UnitsTools.ConvertToSizeUnits(a.rightMarginBody, a.units, b.units),
                    b.rightMarginBody
                );
                c.units = b.units;
            }
            ...
            c.justificationLastLine = NumberSupport.Combine(
                a.justificationLastLine,
                b.justificationLastLine
            );
            ...
            c.enableHyphenation =
                b.enableHyphenation == ThreeState.Undefined
                    ? a.enableHyphenation
                    : b.enableHyphenation;
