...
namespace Epsitec.Common.Text.Properties
{
    ...
    public class PropertiesProperty : Property, Common.Support.IXMLSerializable<PropertiesProperty>
    {
        ...
        {
            this.serializedProperties = Epsitec
                .Common
                .Types
                .Collections
                .EmptyArray<string>
        ...
        {
            get { return WellKnownType.Properties; }
        }

        public string[] SerializedProperties
        {
            get { return this.serializedProperties.Clone() as string[]; }
        }
        ...
        public static Property[] DeserializePropertiesFromStringArray(
            TextContext context,
        ...
        )
        {
            ...
            for (int i = 0; i < properties.Length; i++)
            {
                properties[i] = PropertiesProperty.DeserializeProperty(
                    context,
                    serializedProperties[i]
                );
            }
        ...
        {
            Property property;
            Property.DeserializeFromText(
                context,
                serializedProperty,
                2,
                serializedProperty.Length - 2,
                out property
            );
            return property;
        }
        ...
        public override Property GetCombination(Property property)
        {
            ...
            c.serializedProperties = new string[
                a.serializedProperties.Length + b.serializedProperties.Length
            ];
        ...
        public static Property[] RemovePropertiesProperties(
