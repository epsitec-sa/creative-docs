...
namespace Epsitec.Common.Text.Exchange
{
    ...
    public class Rosetta
    {
        ...
        public static void PasteHtmlText(TextStory story, TextNavigator navigator)
        {
            ...
            {
                HtmlToTextWriter theWriter = new HtmlToTextWriter(
                    thehtmldoc,
                    cpContext,
                    Rosetta.pasteMode
                );
        ...
        public static void PasteNativeText(
            TextStory story,
        ...
        )
        {
            ...
            using (CopyPasteContext cpContext = new CopyPasteContext(story, navigator))
            {
                NativeToTextWriter theWriter = new NativeToTextWriter(
                    text,
                    cpContext,
                    Rosetta.pasteMode
                );
        ...
        )
        {
            ...
            using (CopyPasteContext cpContext = new CopyPasteContext(story))
            {
                ...
                clipboard.Add(
                    Internal.FormattedText.ClipboardFormat.Name,
        ...
        )
        {
            ...
            while (true)
            {
                ...
                else
                {
                    ...
                    htmlText.SetFontSize(
                        cpContext.TextWrapper.Active.IsFontSizeDefined
                            ? cpContext.TextWrapper.Active.FontSize
                            : 0
                    );
        ...
        private static void CopyNativeText(
            TextStory story,
            TextNavigator usernavigator,
            NativeTextOut nativeText,
            CopyPasteContext cpContext
        )
        {
            if (!usernavigator.HasSelection)
        ...
        private static SimpleXScript GetSimpleXScript(Wrappers.TextWrapper wrapper)
        {
        ...
        public static void TestCode(TextStory story, TextNavigator navigator)
        {
            ...
            while (true)
            {
                ...
                {
                    if (
                        style.TextStyleClass == TextStyleClass.Paragraph
                        || style.TextStyleClass == TextStyleClass.Text
                    )
                    {
                ...
                bool b =
                    textWrapper.Defined.IsInvertItalicDefined && textWrapper.Defined.InvertItalic;
        ...
        public static void TestCode6(TextStory story, TextNavigator navigator)
        {
            ...
            Text.TextStyle style = context.StyleList.NewTextStyle( /*this.document.Modifier.OpletQueue*/
                null,
                null,
...
#endif
            context.StyleList.StyleMap.SetCaption(
                null /*this.document.Modifier.OpletQueue*/
                ,
                style,
                "Style créé par MW"
            );
