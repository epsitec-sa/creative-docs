...
namespace Epsitec.Common.Text
{
    ...
    public class TextStory : System.IDisposable
    {
        ...
        {
            get { return this.context.StyleList; }
        }
        ...
        public int TextChangeMarkStart
        {
            ...
            get { return System.Math.Min(this.textChangeMarkStart, this.TextLength); }
        }

        public int TextChangeMarkEnd
        {
            get { return System.Math.Min(this.textChangeMarkEnd, this.TextLength); }
        }

        public bool HasTextChangeMarks
        {
            get { return this.TextChangeMarkStart < this.TextChangeMarkEnd; }
        }
        ...
        {
            get { return this.debugDisableOplet; }
            set { this.debugDisableOplet = value; }
        }

        public bool DebugDisableOpletMerge
        {
            get { return this.debugDisableMerge; }
            set { this.debugDisableMerge = value; }
        }
        ...
        public bool IsOpletQueueEnabled
        {
            get
            {
                return (this.DebugDisableOpletQueue || (this.opletQueue == null))
                    ? false
                    : (this.opletQueueDisable == 0);
            }
        }
        ...
        public void MoveCursor(ICursor cursor, int distance)
        {
            ...
            else
            {
                ...
                if ((oldPos != newPos) && (this.IsOpletQueueEnabled))
                {
        ...
        public void ValidateAction()
        {
            if (this.IsOpletQueueEnabled)
            {
                ...
                Common.Support.OpletQueue.MergeMode merge2 =
                    this.opletQueue.LastActionMinusOneMergeMode;

                if (
                    (merge1 == Common.Support.OpletQueue.MergeMode.Disabled)
                ...
                else
                {
                    ...
                    if ((oplets1.Length == 1) && (oplets2.Length == 1))
                    {
        ...
        public void GetOpletsText(
            System.Collections.ICollection rawOplets,
            out string inserted,
            out string deleted
        )
        {
        ...
        {
            if ((this.opletQueue.LastActionName == null) || (force))
            {
                Common.Support.IOplet[] oplets = this.FindTextOplets(
                    this.opletQueue.LastActionOplets
                );
        ...
        public void SetCursorPosition(ICursor cursor, int position, int direction)
        {
            ...
            else
            {
                ...
                if ((oldPos != newPos) || (oldDir != newDir))
                {
                    this.InternalAddOplet(new CursorMoveOplet(this, cursor, oldPos, oldDir));
                }
            }
        ...
        public void InsertText(ICursor cursor, ulong[] text)
        {
            ...
            {
                this.InternalAddOplet(
                    new TextInsertOplet(this, position, length, cursor, direction)
                );
        ...
        public void DeleteText(ICursor cursor, int length)
        {
            ...
            {
                this.InternalAddOplet(
                    new TextDeleteOplet(this, position, length, cursors, cursor, direction)
                );
        ...
        public bool ReplaceText(ICursor cursor, int length, string simpleText)
        {
            ...
            ulong mask =
                Internal.CharMarker.CoreAndSettingsMask | this.TextContext.Markers.Selected;
            ulong code = 0;
            ...
            if (data.Length == text.Length)
            {
                for (int i = 0; i < text.Length; i++)
                {
                    if (
                        (
                            data[i]
                            & (Internal.CharMarker.CoreAndSettingsMask | Unicode.Bits.FullCodeMask)
                        )
                        != (
                            text[i]
                            & (Internal.CharMarker.CoreAndSettingsMask | Unicode.Bits.FullCodeMask)
        ...
        public bool ReplaceTextSequence(
            ICursor cursor,
            int length,
            Properties.AutoTextProperty autoText,
            Properties.GeneratorProperty generator,
            Generator.TextRange[] ranges
        )
        {
        ...
        public void ResumeTextChanged()
        {
            ...
            {
                OpletEventArgs[] args = (OpletEventArgs[])
                    this.pendingOpletExecutedNotifications.ToArray(typeof(OpletEventArgs));
        ...
        private void GenerateDebugStyledTextForRun(
            ulong[] text,
            ulong code,
            int offset,
            int length,
        ...
        public void ConvertToStyledText(
            string simpleText,
            TextStyle textStyle,
            out ulong[] styledText
        )
        {
        ...
        )
        {
            TextStyle[] textStyles =
                (textStyle == null) ? new TextStyle[0] : new TextStyle[] { textStyle };
        ...
        public void ConvertToStyledText(
            string simpleText,
            System.Collections.ICollection textStyles,
            System.Collections.ICollection properties,
            out ulong[] styledText
        )
        {
            this.ConvertToStyledText(
                simpleText,
                this.FlattenStylesAndProperties(textStyles, properties),
                out styledText
            );
        }
        ...
        public void ConvertToStyledText(System.Collections.ICollection properties, out ulong style)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                switch (propMixed[i].PropertyType)
                {
                    case Properties.PropertyType.CoreSetting:
                        coreAcc.Accumulate(propMixed[i]);
                        break;
                    case Properties.PropertyType.LocalSetting:
                        localAcc.Accumulate(propMixed[i]);
                        break;
                    case Properties.PropertyType.ExtraSetting:
                        extraAcc.Accumulate(propMixed[i]);
                        break;
                    ...
                    case Properties.PropertyType.Polymorph:
                        ...
                        else
                        {
                            System.Diagnostics.Debug.Assert(
                                polymorph.WellKnownType == propMixed[i].WellKnownType
                            );
            ...
            this.StyleList.InternalSettingsTable.Attach(
                ref style,
                searchCore,
                searchLocal,
                searchExtra
            ...
            if (
                (coreAcc.RequiresSpecialCodeProcessing)
        ...
        public System.Collections.ArrayList FlattenStylesAndProperties(
            System.Collections.ICollection textStyles,
            System.Collections.ICollection properties
        )
        {
        ...
        public System.Collections.ArrayList FlattenStylesAndProperties(
            System.Collections.ICollection textStyles,
            System.Collections.ICollection properties,
            bool generateStylesProperty
        )
        {
            System.Collections.ArrayList list = new System.Collections.ArrayList();

            if ((textStyles != null) && (textStyles.Count > 0))
            {
        ...
        private void IncrementUserCount(ulong[] text, int length)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                if (core != null)
                    core.IncrementUserCount();
                if (local != null)
                    local.IncrementUserCount();
                if (extra != null)
                    extra.IncrementUserCount();

                if ((extra != null) && (extra.UserCount == 1))
                {
                    Properties.TabsProperty tabs =
                        extra[Properties.WellKnownType.Tabs] as Properties.TabsProperty;
        ...
        private void DecrementUserCount(ulong[] text, int length)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                if (core != null)
                    core.DecrementUserCount();
                if (local != null)
                    local.DecrementUserCount();
                if (extra != null)
                    extra.DecrementUserCount();

                if ((extra != null) && (extra.UserCount == 0))
                {
                    Properties.TabsProperty tabs =
                        extra[Properties.WellKnownType.Tabs] as Properties.TabsProperty;
        ...
        private void InternalAddOplet(Common.Support.IOplet oplet)
        {
            if (this.IsOpletQueueEnabled)
            {
                ...
                bool enableMerge =
                    (
                        this.opletQueue.LastActionMergeMode
                        != Common.Support.OpletQueue.MergeMode.Disabled
                    )
                    &&
                    /**/(
                        this.opletQueue.PendingMergeMode
                        != Common.Support.OpletQueue.MergeMode.Disabled
                    );
                ...
                if ((lastOplets.Length == 1) && (this.debugDisableMerge == false) && (enableMerge))
                {
        ...
        internal static void InsertOplet(
            Common.Support.OpletQueue queue,
            Common.Support.IOplet oplet
        )
        {
            ...
            else
            {
                ...
                bool enableEerge =
                    (queue.LastActionMergeMode != Common.Support.OpletQueue.MergeMode.Disabled)
                    &&
                    /**/(queue.PendingMergeMode != Common.Support.OpletQueue.MergeMode.Disabled);

                if ((lastOplets.Length == 1) && (enableEerge))
                {
                    Common.Support.IOplet last = lastOplets[0];
        ...
        protected void UpdateTextBreakInformation(int position, int length)
        {
            ...
            if (areaEnd > areaStart)
            {
                ...
                {
                    if (
                        Unicode.Bits.GetBreakInfo(text[i - areaStart]) == Unicode.BreakInfo.Optional
                    )
                    {
                        wordStart = i + 1;
                        break;
                ...
                Internal.CharMarker.SetMarkers(
                    this.context.Markers.RequiresSpellChecking,
                    text,
                    textOffset,
                    textLength
                );
                ...
                Internal.Navigator.GetExtendedParagraphPositions(
                    this,
                    wordStart,
                    out paraStart,
                    out paraEnd
                ...
                Internal.Navigator.GetParagraphPositions(
                    this,
                    wordStart,
                    out paraStart1,
                    out paraEnd1
        ...
        protected void InternalDeleteText(
            int position,
            int length,
            out CursorInfo[] infos,
            bool bookKeeping
        )
        {
            if (bookKeeping)
        ...
        protected void InternalMoveText(int fromPos, int toPos, int length)
        {
            ...
            if ((infos != null) && (infos.Length > 0))
            {
                ...
                infos = this.text.FilterCursors(
                    infos,
                    new CursorInfo.Filter(this.FilterSaveCursors)
                );
        ...
        {
            public BaseCursorOplet(TextStory story, ICursor cursor)
                : base(story)
            {
                this.cursor = cursor;
            }
        ...
        {
            public TextInsertOplet(TextStory story, int position, int length)
                : base(story)
            {
            ...
            {
                this.story.InternalSaveCursorPositions(
                    this.position,
                    this.length,
                    out this.cursors
                );
                ...
                if (this.cursor != null)
                {
                    ...
                    System.Diagnostics.Debug.Assert(
                        this.story.text.GetCursorPosition(this.cursor.CursorId) == this.position
                    );
                }
        ...
        {
            public TextDeleteOplet(TextStory story, int position, int length, CursorInfo[] cursors)
                : base(story)
            {
                this.position = position;
                this.length = length;
            ...
            public TextDeleteOplet(
                ...
                : this(story, position, length, cursors)
            {
                this.cursor = cursor;
                this.direction = direction;
            }
        ...
        {
            public TextChangeOplet(TextStory story, int position, int length, ulong[] oldText)
                : base(story)
            {
                this.position = position;
                this.length = length;
            ...
            {
                if ((this.position == other.position) && (this.length == other.length))
                {
                    return true;
                }
        ...
        {
            public CursorMoveOplet(TextStory story, ICursor cursor, int position, int direction)
                : base(story, cursor)
            {
                this.position = position;
                this.direction = direction;
