...
namespace Epsitec.Common.Text
{
    ...
    public sealed class TabList : Common.Support.IXMLSerializable<TabList>
    {
        ...
        public long Version
        {
            get { return this.version.Current; }
        }

        public Properties.TabProperty this[string tag]
        {
            get { return this.GetTabProperty(tag); }
        }

        public Properties.TabProperty NewTab(
            string tag,
            double position,
        ...
        public Properties.TabProperty FindAutoTab(
            double position,
            Properties.SizeUnits units,
            double disposition,
            string dockingMark,
        ...
        public Properties.TabProperty FindSharedTab(
            double position,
            Properties.SizeUnits units,
            double disposition,
            string dockingMark,
        ...
        public Properties.TabProperty CreateOrGetAutoTab(
            double position,
            Properties.SizeUnits units,
            double disposition,
            string dockingMark,
        ...
        {
            Properties.TabProperty find = this.FindAutoTab(
                position,
                units,
                disposition,
                dockingMark,
        ...
        )
        {
            this.RedefineTab(
                queue,
                null,
                new Properties.TabProperty(tag),
                position,
                units,
                disposition,
                dockingMark,
        ...
        )
        {
            ...
            if (record == null)
            {
                throw new System.ArgumentException(
                    string.Format("TabProperty named {0} does not exist", tab.TabTag),
                    "tab"
                );
            }
        ...
        public static TabClass GetTabClass(string tag)
        {
            if ((tag != null) && (tag.Length > 3))
            {
                ...
                {
                    case TabList.AutoTagPrefix:
                        return TabClass.Auto;
                    case TabList.SharedTagPrefix:
                        return TabClass.Shared;
                }
            }
        ...
        public static Properties.TabsProperty FilterTabs(
        ...
        {
            return SerializerSupport.SerializeStringArray(
                ...
                for (int i = 0; i < args.Length; i++)
                {
                    if (args[i] != null)
                    {
                        if (args[i].StartsWith(TabList.LevelMultiplier))
                        {
                            ...
                            offset = TabList.GetLevelOffsetFromMultiplier(
                                fontSizeInPoints,
                                level,
                                value
                            );
                        ...
                        else if (args[i].StartsWith(TabList.LevelTable))
                        {
                            ...
                            offset = TabList.GetLevelOffsetFromTable(
                                fontSizeInPoints,
                                level,
                                value
                            );
            ...
            for (int i = 0; i < args.Length; i++)
            {
                if (args[i] != null)
                {
                    if (args[i].StartsWith(TabList.RelativeEmOffset))
                    {
                        ...
                        double scale = System.Double.Parse(
                            value,
        ...
        public static string CreateLevelTable(double[] offsets)
        {
            ...
            for (int i = 0; i < offsets.Length; i++)
            {
                ...
                buffer.Append(
                    Properties.UnitsTools.SerializeSizeUnits(
                        offsets[i],
                ...
                if (args[i] != null)
                {
                    if (args[i].StartsWith(TabList.LevelTable))
                    {
                        ...
                        for (int j = 0; j < nums.Length; j++)
                        {
                            double offset;
                            Properties.SizeUnits units;
                            Properties.UnitsTools.DeserializeSizeUnits(
                                nums[j],
                                out offset,
                                out units
                            );
        ...
        private static double GetLevelOffsetFromMultiplier(
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    return Properties.UnitsTools.ConvertToScale(multiplier, units)
                        * level
                        * fontSizeInPoints;
                }
                else
        ...
        private static double GetLevelOffsetFromTable(
            double fontSizeInPoints,
            int level,
            string value
        )
        ...
        public class RedefineOplet : Common.Support.AbstractOplet
        {
            ...
            {
                if ((this.list == other.list) && (this.record == other.record))
                {
                    return true;
                }
                else
                ...
                Common.Support.IXMLSerializable<TabRecord>
        {
            ...
            {
                get { return Properties.UnitsTools.ConvertToPoints(this.position, this.units); }
            }
            ...
            {
                get { return this.dockingMark; }
            }

            public TabPositionMode PositionMode
            {
                get { return this.positionMode; }
            }
            ...
            {
                get { return TabList.GetTabClass(this.tag); }
            }
            ...
            public void Deserialize(TextContext context, int version, string[] args, ref int offset)
            {
                ...
                this.positionMode = (TabPositionMode)
                    SerializerSupport.DeserializeEnum(typeof(TabPositionMode), args[offset++]);
        ...
        private string CloneTab(string tag)
        {
            ...
            {
                case TabClass.Auto:
                    newTag = this.GenerateAutoTagName();
                    break;
                case TabClass.Shared:
                    newTag = this.GenerateSharedTagName();
                    break;
            }
        ...
        private void Detach(string tag)
        {
            ...
            {
                throw new System.ArgumentException(
                    string.Format("TabProperty named {0} does not exist", tag),
                    "tag"
                );
            }
