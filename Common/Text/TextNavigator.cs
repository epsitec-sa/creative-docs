...
namespace Epsitec.Common.Text
{
    ...
    public class TextNavigator : System.IDisposable
    {
        ...
        {
            get { return this.story.TextLength; }
        }

        public TextContext TextContext
        {
            get { return this.story.TextContext; }
        }
        ...
        public int CursorPosition
        {
            ...
            get { return this.story.GetCursorPosition(this.ActiveCursor); }
        }
        ...
        public int CursorDirection
        {
            ...
            get { return this.story.GetCursorDirection(this.ActiveCursor); }
        }
        ...
        public bool IsSelectionActive
        {
            ...
            get { return this.activeSelectionCursor == null ? false : true; }
        }
        ...
        public bool HasSelection
        {
            ...
            get { return this.selectionCursors == null ? false : true; }
        }
        ...
        {
            get { return this.story.OpletQueue; }
        }
        ...
        public void InsertWithTabs(string text)
        {
            ...
            for (int i = 1; i < fragments.Length; i++)
            {
                ...
                {
                    this.Insert(
                        Text.Unicode.Code.HorizontalTab,
                        new Text.Properties.TabProperty(tag)
                    );
                }
        ...
        public void MoveTo(Target target, int count)
        {
            ...
            switch (target)
            {
                ...
                case Target.ParagraphStart:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Backward,
                        new MoveCallback(this.IsParagraphStart),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Backward;
                ...
                case Target.ParagraphEnd:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Forward,
                        new MoveCallback(this.IsParagraphEnd),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Forward;
                ...
                case Target.LineStart:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Backward,
                        new MoveCallback(this.IsLineStart),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Backward;
                ...
                case Target.LineEnd:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Forward,
                        new MoveCallback(this.IsLineEnd),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Forward;
                ...
                case Target.WordStart:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Backward,
                        new MoveCallback(this.IsWordStart),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Backward;
                ...
                case Target.WordEnd:
                    this.MoveCursor(
                        ...
                        count,
                        Direction.Forward,
                        new MoveCallback(this.IsWordEnd),
                        out newPos,
                        out newDir
                    );
                    direction = Direction.Forward;
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("Target {0} not supported", target)
                    );
            }
            ...
            if ((fixDir) && (newDir == 1))
            {
                ...
                if (
                    (Internal.Navigator.IsParagraphEnd(this.story, this.tempCursor, 0) == false)
                    && (
        ...
        public void EndSelection()
        {
            ...
            using (this.story.BeginAction())
            {
                if ((this.selectionBefore != null) && (this.selectionBefore.Length > 0))
                {
        ...
        public void ClearSelection(Direction direction)
        {
            ...
            if (this.selectionCursors != null)
            {
                ...
                using (this.story.BeginAction())
                {
                    ...
                    if ((direction != Direction.None) && (ranges.Length > 0))
                    {
                        int pos =
                            (direction == Direction.Backward)
                                ? ranges[0].Start
        ...
        {
            if ((index >= this.SelectionCount) || (index < 0))
            {
        ...
        public ulong[] GetSelectedLowLevelText(int index)
        {
            ...
            if ((this.selectionCursors == null) || (index >= this.SelectionCount))
            {
                return new ulong[0];
            }
            else
        ...
        public bool RenameTabs(string[] oldTags, string newTag)
        {
            ...
            if ((oldTags.Length > 1) || (oldTags[0] != newTag))
            {
                ...
                if ((pos1.Length > 0) || (pos2.Length > 0))
                {
                    ...
                    using (this.story.BeginAction())
                    {
                        ...
                        for (int i = 0; i < pos1.Length; i++)
                        {
                            ...
                            this.SetParagraphProperties(
                                pos1[i],
                                Properties.ApplyMode.Combine,
                                tabsChange
                            );
                        }
        ...
        )
        {
            ...
            this.TextContext.TabList.RedefineTab(
                this.OpletQueue,
                this.TextStory,
        ...
        private void InternalSetParagraphStyles(TextStyle[] styles)
        {
            ...
            newStyles.AddRange(
                TextStyle.FilterStyles(this.currentStyles, TextStyleClass.MetaProperty)
            );
        ...
        private void InternalSetTextStyles(params TextStyle[] styles)
        {
            ...
            //			else
            {
                ...
                newStyles.AddRange(
                    TextStyle.FilterStyles(this.currentStyles, TextStyleClass.Paragraph)
                );
                newStyles.AddRange(textStyles);
                newStyles.AddRange(
                    TextStyle.FilterStyles(this.currentStyles, TextStyleClass.Symbol)
                );
                newStyles.AddRange(
                    TextStyle.FilterStyles(this.currentStyles, TextStyleClass.MetaProperty)
                );
        ...
        private void InternalSetMetaProperties(Properties.ApplyMode mode, TextStyle[] styles)
        {
            ...
            TextStyle[] metaProperties = TextStyle.FilterStyles(
                styles,
        ...
        public void SetParagraphProperties(Properties.ApplyMode mode, params Property[] properties)
        {
            ...
            Property[] paragraphProperties = Property.Filter(
                properties,
                Properties.PropertyFilter.UniformOnly
            );
            ...
            //			else
            {
                ...
                Internal.Navigator.SetParagraphProperties(
                    this.story,
                    this.cursor,
                    mode,
                    paragraphProperties
                ...
                newProperties.AddRange(
                    Property.Filter(
                        this.currentProperties,
                        Properties.PropertyFilter.NonUniformOnly
                    )
                );
        ...
        public void SetTextProperties(Properties.ApplyMode mode, params Property[] properties)
        {
            ...
            Property[] textProperties = Property.Filter(
                properties,
                Properties.PropertyFilter.NonUniformOnly
            );
            ...
            //			else
            {
                ...
                newProperties.AddRange(
                    Property.Filter(this.currentProperties, Properties.PropertyFilter.UniformOnly)
                );
                newProperties.AddRange(
                    Internal.Navigator.Combine(
                        Property.Filter(
            ...
            try
            {
                ...
                if (direction < 0)
                {
                    this.MoveCursor(
                        ...
                        0,
                        Direction.Backward,
                        new MoveCallback(this.IsRawLineStart),
                        out newPos,
                        out newDir
                    );
        ...
        public bool GetCursorGeometry(
            out ITextFrame frame,
            out double cx,
            out double cy,
            out double ascender,
        ...
        )
        {
            ...
            )
            {
                ...
                if (
                    (this.CursorPosition == this.story.TextLength)
                    && (paraLine == 0)
                    && (lineChar == 0)
                )
                {
                ...
                this.story.TextContext.GetFontSize(
                    properties,
                    out ptSize,
                    out fontScale,
                    out fontGlue
        ...
        public int[] GetAdjustedSelectionCursorPositions()
        {
            ...
            for (int i = 0; i < positions.Length; i += 2)
            {
                ...
                if (
                    (this.SkipOverAutoText(ref p2, Direction.Backward))
        ...
        {
            if ((this.currentStyles == null) || (this.currentProperties == null))
            {
                this.UpdateCurrentStylesAndProperties();
            }
        }
        ...
        public void UpdateCurrentStylesAndProperties()
        {
            ...
            if ((dir > -1) && (this.IsAfterAutoText(this.cursor)))
            {
        ...
        private bool MoveCursor(ICursor cursor, int distance, out int newPos, out int newDir)
        {
            ...
            while (moved < count)
            {
                if ((direction > 0) && (pos == this.story.TextLength))
                {
                    break;
                }
                ...
                System.Diagnostics.Debug.Assert(
                    this.story.GetCursorPosition(this.tempCursor) == pos
                );
            ...
            if ((moved > 0) && (direction > 0))
            {
                if (
                    (
                        Internal.Navigator.IsLineEnd(
                            this.story,
                            this.fitter,
                            this.tempCursor,
                            0,
                            direction
                        ) && !Internal.Navigator.IsParagraphEnd(this.story, this.tempCursor, 0)
        ...
        )
        {
            ...
            System.Diagnostics.Debug.Assert(count >= 0);
            System.Diagnostics.Debug.Assert(
                (direction == Direction.Backward) || (direction == Direction.Forward)
            );
            ...
            if ((newPos != oldPos) || (newDir != oldDir))
            {
                return true;
            }
            else
        ...
        private void InsertText(string text)
        {
            ...
            using (this.story.BeginAction())
            {
                ...
                {
                    this.InternalInsertText(
                        string.Concat(
                            args[i],
                            System.Char.ToString((char)Unicode.Code.ParagraphSeparator)
                        )
                    );
        ...
        private void DeleteText(ICursor cursor, int length)
        {
            ...
            if (start < end)
            {
                ...
                if (!fixUp)
                {
                    ...
                    if (this.SkipOverAutoText(ref fence, Direction.Backward))
                    {
                        ...
                        System.Diagnostics.Debug.Assert(
                            this.story.GetCursorPosition(this.tempCursor) == fence
                        );
                        System.Diagnostics.Debug.Assert(
                            this.IsParagraphStart(0, Direction.Backward)
                        );
                ...
                else
                {
                    ...
                    if (manager != null)
                    {
                        ...
                        this.SetParagraphStyles(
                            start,
                            new TextStyle[] { this.TextContext.DefaultParagraphStyle }
                        );
            ...
            if (fixUp)
            {
                ...
                Internal.Navigator.GetParagraphProperties(
                    this.story,
                    this.tempCursor,
                    -1,
                    out props
                ...
                Internal.Navigator.SetParagraphProperties(
                    this.story,
                    this.tempCursor,
                    Properties.ApplyMode.Overwrite,
                    props
                );
            }
            ...
            System.Diagnostics.Debug.Assert(
                Properties.PropertiesProperty.ContainsPropertiesProperties(oldProperties) == false
            );
            System.Diagnostics.Debug.Assert(
                Properties.StylesProperty.ContainsStylesProperties(oldProperties) == false
            );
            ...
            newProperties.AddRange(
                Property.Filter(oldProperties, Properties.PropertyFilter.NonUniformOnly)
            );
            ...
            if (count > 0)
            {
                Properties.ManagedParagraphProperty[] mpps =
                    Properties.ManagedParagraphProperty.Filter(this.accumulatedProperties);
                ...
                if (mpps.Length > 0)
                {
                    ...
                    System.Diagnostics.Debug.Assert(
                        manager != null,
                        string.Format("Cannot find ParagraphManager '{0}'", mpp.ManagerName)
                    );

                    this.story.SetCursorPosition(this.tempCursor, this.CursorPosition);
                    this.story.MoveCursor(
                        this.tempCursor,
                        Internal.Navigator.GetParagraphStartOffset(this.story, this.tempCursor)
                    );
        ...
        protected bool IsWordStart(int offset, Direction direction)
        {
            ...
            if (
                (this.IsAfterAutoText(this.tempCursor, offset))
        ...
        protected bool IsRawLineStart(int offset, Direction direction)
        {
            ...
            if (
                Internal.Navigator.IsLineStart(
                    this.story,
                    this.fitter,
                    this.tempCursor,
                    offset,
        ...
        private void SetParagraphProperties(
            int pos,
        ...
        )
        {
            ...
            Internal.Navigator.SetTextProperties(
                this.story,
                this.tempCursor,
                length,
                mode,
        ...
        )
        {
            ...
            Internal.Navigator.SetMetaProperties(
                this.story,
                this.tempCursor,
                length,
                mode,
        ...
        private void SetParagraphMetaProperties(
            int pos,
            Properties.ApplyMode mode,
            TextStyle[] metaProperties
        )
        {
            ...
            Internal.Navigator.SetParagraphMetaProperties(
                this.story,
                this.tempCursor,
                mode,
                metaProperties
        ...
        {
            Styles.PropertyContainer.Accumulator currentAccumulator =
                new Styles.PropertyContainer.Accumulator();

            currentAccumulator.SkipSymbolProperties = true;
            currentAccumulator.Accumulate(
                this.story.FlattenStylesAndProperties(this.currentStyles, this.currentProperties)
            );
            ...
            for (int i = 0; i < this.accumulatedProperties.Length; i++)
            {
                ...
                System.Diagnostics.Debug.Assert(
                    this.accumulatedProperties[i].WellKnownType != Properties.WellKnownType.AutoText
                );
                System.Diagnostics.Debug.Assert(
                    this.accumulatedProperties[i].WellKnownType
                        != Properties.WellKnownType.Generator
                );
        ...
        private void AdjustCursor(ICursor temp, Direction direction, ref int pos, ref int dir)
        {
            ...
            if ((manager != null) && (Internal.Navigator.IsParagraphStart(this.story, temp, 0)))
            {
                switch (direction)
                {
        ...
        private void InternalInsertText(string text)
        {
            ...
            if (
                (Internal.Navigator.IsEndOfText(this.story, this.cursor, 0))
                && (Internal.Navigator.IsParagraphStart(this.story, this.cursor, 0))
            )
            {
                starts.Push(pos);
            ...
            this.story.ConvertToStyledText(
                text,
                this.currentStyles,
                this.currentProperties,
                out styledText
            ...
            Properties.ManagedParagraphProperty[] mpps = Properties.ManagedParagraphProperty.Filter(
        ...
        private void InternalSetCursor(int newPos, int newDir)
        {
            ...
            if (Internal.Navigator.IsEndOfText(this.story, this.tempCursor, -1))
            {
                ...
                newPos -= 1;
                newDir = Internal.Navigator.IsParagraphStart(this.story, this.tempCursor, -1)
                    ? -1
                    : 1;
            }
            else if (Internal.Navigator.IsEndOfText(this.story, this.tempCursor, 0))
            {
                ...
                newDir = Internal.Navigator.IsParagraphStart(this.story, this.tempCursor, 0)
                    ? -1
                    : 1;
            }
        ...
        {
            if (
                (e.Oplet is TextStory.CursorMoveOplet)
