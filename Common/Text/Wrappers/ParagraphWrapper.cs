...
namespace Epsitec.Common.Text.Wrappers
{
    ...
    public class ParagraphWrapper : AbstractWrapper
    {
        ...
        public State Active
        {
            get { return this.active_state; }
        }

        public State Defined
        {
            get { return this.defined_state; }
        }

        public State GetUnderlyingMarginsState()
        {
            State state = new State(this, AccessMode.ReadOnly);
            Properties.MarginsProperty property =
                this.ReadUnderlyingProperty(Properties.WellKnownType.Margins)
                as Properties.MarginsProperty;
        ...
        {
            State state = new State(this, AccessMode.ReadOnly);
            Properties.LeadingProperty property =
                this.ReadUnderlyingProperty(Properties.WellKnownType.Leading)
                as Properties.LeadingProperty;
        ...
        {
            State state = new State(this, AccessMode.ReadOnly);
            Properties.KeepProperty property =
                this.ReadUnderlyingProperty(Properties.WellKnownType.Keep)
                as Properties.KeepProperty;
            this.UpdateKeep(state, property);
            return state;
        }

        public static void UnwrapManagedParagraphSettings(
        ...
        public static System.Collections.ArrayList WrapManagedParagraphSettings(
            string name,
            string[] parameters
        )
        {
        ...
        public ParagraphManagers.ItemListManager.Parameters ConvertToItemListManager(
            System.Collections.ArrayList list
        )
        {
            if (list == null)
            ...
            if (name == "ItemList")
            {
                return new ParagraphManagers.ItemListManager.Parameters(
                    this.AttachedTextContext,
                    parameters
                );
            }
            else
        ...
        public System.Collections.ArrayList ConvertFromItemListManager(
            ParagraphManagers.ItemListManager.Parameters parameters
        )
        {
            if (parameters == null)
            {
        ...
        private void SynchronizeMargins()
        {
            ...
            {
                hyphenate = this.defined_state.Hyphenation
            ...
            if (changes > 0)
            {
                if (defines > 0)
                {
                    this.DefineMetaProperty(
                        ParagraphWrapper.Margins,
                        0,
        ...
        private void SynchronizeLeading()
        {
            ...
            if (
                (this.defined_state.IsValueFlagged(State.LeadingProperty))
            ...
            if (
                (this.defined_state.IsValueFlagged(State.SpaceBeforeProperty))
            ...
            if (
                (this.defined_state.IsValueFlagged(State.SpaceAfterProperty))
        ...
        private void SynchronizeKeep()
        {
            ...
            {
                keep_with_next = this.defined_state.KeepWithNextParagraph
                    ? Properties.ThreeState.True
                    : Properties.ThreeState.False;
                defines++;
            }
            ...
            {
                keep_with_previous = this.defined_state.KeepWithPreviousParagraph
                    ? Properties.ThreeState.True
                    : Properties.ThreeState.False;
                defines++;
            }
            ...
            if (changes > 0)
            {
                ...
                {
                    this.DefineMetaProperty(
                        ParagraphWrapper.Keep,
                        0,
                        new Properties.KeepProperty(
                            keep_start_lines,
                            keep_end_lines,
                            start_mode,
                            keep_with_previous,
        ...
        private void SynchronizeManaged()
        {
            ...
            if (
                (this.defined_state.IsManagedParagraphDefined)
            ...
            )
            {
                ...
                ParagraphWrapper.UnwrapManagedParagraphSettings(
                    this.defined_state.ManagedParagraph,
                    out name,
                    out parameters
                );
        ...
        private void SynchronizeTabs()
        {
            if (this.Attachment == Attachment.Style)
            {
                ...
                if (
                    (this.defined_state.IsTabsDefined)
                ...
                )
                {
                    ...
                    foreach (string tag in tabs.TabTags)
                    {
                        System.Diagnostics.Debug.Assert(
                            TabList.GetTabClass(tag) == TabClass.Shared
                        );
                    }
                }
        ...
        internal override void UpdateState(bool active)
        {
            ...
            if (state.IsDirty)
            {
                System.Diagnostics.Debug.WriteLine(
                    "Unexpected dirty flag when updating '{0}' state",
        ...
        private void UpdateMargins(State state, bool active)
        {
            ...
            {
                margins =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Margins)
                    as Properties.MarginsProperty;
            }
            else
            {
                margins =
                    this.ReadMetaProperty(
                        ParagraphWrapper.Margins,
                        Properties.WellKnownType.Margins
                    ) as Properties.MarginsProperty;
            }
        ...
        private void UpdateMargins(State state, Properties.MarginsProperty margins)
        {
            ...
            {
                if ((margins.JustificationBody == 0.0) && (margins.JustificationLastLine == 0.0))
                {
                    if (margins.Disposition == 0.0)
                    {
                        state.DefineValue(
                            State.JustificationModeProperty,
                            JustificationMode.AlignLeft
                        );
                    }
                    ...
                    else
                    {
                        state.DefineValue(
                            State.JustificationModeProperty,
                            JustificationMode.Unknown
                        );
                    }
                }
                else if (
                    (margins.JustificationBody == 1.0)
                    &&
                ...
                )
                {
                    state.DefineValue(
                        State.JustificationModeProperty,
                        JustificationMode.JustifyAlignLeft
                    );
                }
                else if (
                    (margins.JustificationBody == 1.0)
                ...
                )
                {
                    state.DefineValue(
                        State.JustificationModeProperty,
                        JustificationMode.JustifyCenter
                    );
                }
                else if (
                    (margins.JustificationBody == 1.0)
                ...
                )
                {
                    state.DefineValue(
                        State.JustificationModeProperty,
                        JustificationMode.JustifyAlignRight
                    );
                }
                else if (
                    (margins.JustificationBody == 1.0)
                ...
                )
                {
                    state.DefineValue(
                        State.JustificationModeProperty,
                        JustificationMode.JustifyJustfy
                    );
                }
                else
                {
            ...
            if ((margins != null) && (margins.Units != Properties.SizeUnits.None))
            {
            ...
            if ((margins != null) && (margins.Level > -1))
            {
            ...
            if ((margins != null) && (margins.LevelAttribute != null))
            {
        ...
        private void UpdateLeading(State state, bool active)
        {
            ...
            {
                leading =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Leading)
                    as Properties.LeadingProperty;
            }
            else
            {
                leading =
                    this.ReadMetaProperty(
                        ParagraphWrapper.Leading,
                        Properties.WellKnownType.Leading
                    ) as Properties.LeadingProperty;
            }
        ...
        private void UpdateLeading(State state, Properties.LeadingProperty leading)
        {
            ...
            if ((leading != null) && (leading.AlignMode != Properties.AlignMode.Undefined))
            {
        ...
        private void UpdateKeep(State state, bool active)
        {
            ...
            {
                keep =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Keep)
                    as Properties.KeepProperty;
            }
            else
            {
                keep =
                    this.ReadMetaProperty(ParagraphWrapper.Keep, Properties.WellKnownType.Keep)
                    as Properties.KeepProperty;
            }
        ...
        {
            if ((keep != null) && (keep.StartLines > 0))
            {
            ...
            {
                state.DefineValue(
                    State.KeepWithPreviousParagraphProperty,
            ...
            if ((keep != null) && (keep.KeepWithNextParagraph != Properties.ThreeState.Undefined))
            {
                state.DefineValue(
                    State.KeepWithNextParagraphProperty,
        ...
        private void UpdateManaged(State state, bool active)
        {
            ...
            {
                managed_info =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.ManagedInfo)
                    as Properties.ManagedInfoProperty;
                managed_paragraph =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.ManagedParagraph)
                    as Properties.ManagedParagraphProperty;
            }
            else
            {
                managed_info =
                    this.ReadMetaProperty(
                        ParagraphWrapper.Managed,
                        Properties.WellKnownType.ManagedInfo
                    ) as Properties.ManagedInfoProperty;
                managed_paragraph =
                    this.ReadMetaProperty(
                        ParagraphWrapper.Managed,
                        Properties.WellKnownType.ManagedParagraph
                    ) as Properties.ManagedParagraphProperty;
            }
        ...
        )
        {
            ...
            {
                state.DefineValue(
                    State.ManagedParagraphProperty,
                    ParagraphWrapper.WrapManagedParagraphSettings(
                        managed_paragraph.ManagerName,
                        managed_paragraph.ManagerParameters
                    )
                );
            }
            else
        ...
        private void UpdateTabs(State state, bool active)
        {
            ...
            {
                tabs =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Tabs)
                    as Properties.TabsProperty;
            }
            else
            {
                tabs =
                    this.ReadMetaProperty(ParagraphWrapper.Tabs, Properties.WellKnownType.Tabs)
                    as Properties.TabsProperty;
            }
        ...
        {
            internal State(AbstractWrapper wrapper, AccessMode access)
                : base(wrapper, access) { }

            public JustificationMode JustificationMode
            {
                get { return (JustificationMode)this.GetValue(State.JustificationModeProperty); }
                set { this.SetValue(State.JustificationModeProperty, value); }
            }

            public bool Hyphenation
            {
                get { return (bool)this.GetValue(State.HyphenationProperty); }
                set { this.SetValue(State.HyphenationProperty, value); }
            }

            public double LeftMarginFirst
            {
                get { return (double)this.GetValue(State.LeftMarginFirstProperty); }
                set { this.SetValue(State.LeftMarginFirstProperty, value); }
            }

            public double LeftMarginBody
            {
                get { return (double)this.GetValue(State.LeftMarginBodyProperty); }
                set { this.SetValue(State.LeftMarginBodyProperty, value); }
            }

            public double RightMarginFirst
            {
                get { return (double)this.GetValue(State.RightMarginFirstProperty); }
                set { this.SetValue(State.RightMarginFirstProperty, value); }
            }

            public double RightMarginBody
            {
                get { return (double)this.GetValue(State.RightMarginBodyProperty); }
                set { this.SetValue(State.RightMarginBodyProperty, value); }
            }

            public Properties.SizeUnits MarginUnits
            {
                get { return (Properties.SizeUnits)this.GetValue(State.MarginUnitsProperty); }
                set { this.SetValue(State.MarginUnitsProperty, value); }
            }

            public int IndentationLevel
            {
                get { return (int)this.GetValue(State.IndentationLevelProperty); }
                set { this.SetValue(State.IndentationLevelProperty, value); }
            }

            public string IndentationLevelAttribute
            {
                get { return (string)this.GetValue(State.IndentationLevelAttributeProperty); }
                set { this.SetValue(State.IndentationLevelAttributeProperty, value); }
            }

            public double BreakFenceBefore
            {
                get { return (double)this.GetValue(State.BreakFenceBeforeProperty); }
                set { this.SetValue(State.BreakFenceBeforeProperty, value); }
            }

            public double BreakFenceAfter
            {
                get { return (double)this.GetValue(State.BreakFenceAfterProperty); }
                set { this.SetValue(State.BreakFenceAfterProperty, value); }
            }

            public double Leading
            {
                get { return (double)this.GetValue(State.LeadingProperty); }
                set { this.SetValue(State.LeadingProperty, value); }
            }

            public Properties.SizeUnits LeadingUnits
            {
                get { return (Properties.SizeUnits)this.GetValue(State.LeadingUnitsProperty); }
                set { this.SetValue(State.LeadingUnitsProperty, value); }
            }

            public double SpaceBefore
            {
                get { return (double)this.GetValue(State.SpaceBeforeProperty); }
                set { this.SetValue(State.SpaceBeforeProperty, value); }
            }

            public Properties.SizeUnits SpaceBeforeUnits
            {
                get { return (Properties.SizeUnits)this.GetValue(State.SpaceBeforeUnitsProperty); }
                set { this.SetValue(State.SpaceBeforeUnitsProperty, value); }
            }

            public double SpaceAfter
            {
                get { return (double)this.GetValue(State.SpaceAfterProperty); }
                set { this.SetValue(State.SpaceAfterProperty, value); }
            }

            public Properties.SizeUnits SpaceAfterUnits
            {
                get { return (Properties.SizeUnits)this.GetValue(State.SpaceAfterUnitsProperty); }
                set { this.SetValue(State.SpaceAfterUnitsProperty, value); }
            }

            public Properties.AlignMode AlignMode
            {
                get { return (Properties.AlignMode)this.GetValue(State.AlignModeProperty); }
                set { this.SetValue(State.AlignModeProperty, value); }
            }

            public int KeepStartLines
            {
                get { return (int)this.GetValue(State.KeepStartLinesProperty); }
                set { this.SetValue(State.KeepStartLinesProperty, value); }
            }

            public int KeepEndLines
            {
                get { return (int)this.GetValue(State.KeepEndLinesProperty); }
                set { this.SetValue(State.KeepEndLinesProperty, value); }
            }

            public bool KeepWithNextParagraph
            {
                get { return (bool)this.GetValue(State.KeepWithNextParagraphProperty); }
                set { this.SetValue(State.KeepWithNextParagraphProperty, value); }
            }

            public bool KeepWithPreviousParagraph
            {
                get { return (bool)this.GetValue(State.KeepWithPreviousParagraphProperty); }
                set { this.SetValue(State.KeepWithPreviousParagraphProperty, value); }
            }
            ...
            public Properties.ParagraphStartMode ParagraphStartMode
            {
                get
                {
                    return (Properties.ParagraphStartMode)
                        this.GetValue(State.ParagraphStartModeProperty);
                }
                set { this.SetValue(State.ParagraphStartModeProperty, value); }
            }
            ...
            public System.Collections.ArrayList ManagedParagraph
            {
                get
                {
                    return (System.Collections.ArrayList)
                        this.GetValue(State.ManagedParagraphProperty);
                }
                set { this.SetValue(State.ManagedParagraphProperty, value); }
            }

            public string ItemListInfo
            {
                get { return (string)this.GetValue(State.ItemListInfoProperty); }
                set { this.SetValue(State.ItemListInfoProperty, value); }
            }
            ...
            public string[] Tabs
            {
                get { return (string[])this.GetValue(State.TabsProperty); }
                set
                {
            ...
            {
                get { return this.IsValueDefined(State.JustificationModeProperty); }
            }

            public bool IsHyphenationDefined
            {
                get { return this.IsValueDefined(State.HyphenationProperty); }
            }

            public bool IsLeftMarginFirstDefined
            {
                get { return this.IsValueDefined(State.LeftMarginFirstProperty); }
            }

            public bool IsLeftMarginBodyDefined
            {
                get { return this.IsValueDefined(State.LeftMarginBodyProperty); }
            }

            public bool IsRightMarginFirstDefined
            {
                get { return this.IsValueDefined(State.RightMarginFirstProperty); }
            }

            public bool IsRightMarginBodyDefined
            {
                get { return this.IsValueDefined(State.RightMarginBodyProperty); }
            }

            public bool IsMarginUnitsDefined
            {
                get { return this.IsValueDefined(State.MarginUnitsProperty); }
            }

            public bool IsIndentationLevelDefined
            {
                get { return this.IsValueDefined(State.IndentationLevelProperty); }
            }

            public bool IsIndentationLevelAttributeDefined
            {
                get { return this.IsValueDefined(State.IndentationLevelAttributeProperty); }
            }

            public bool IsBreakFenceBeforeDefined
            {
                get { return this.IsValueDefined(State.BreakFenceBeforeProperty); }
            }

            public bool IsBreakFenceAfterDefined
            {
                get { return this.IsValueDefined(State.BreakFenceAfterProperty); }
            }

            public bool IsLeadingDefined
            {
                get { return this.IsValueDefined(State.LeadingProperty); }
            }

            public bool IsLeadingUnitsDefined
            {
                get { return this.IsValueDefined(State.LeadingUnitsProperty); }
            }

            public bool IsSpaceBeforeDefined
            {
                get { return this.IsValueDefined(State.SpaceBeforeProperty); }
            }

            public bool IsSpaceBeforeUnitsDefined
            {
                get { return this.IsValueDefined(State.SpaceBeforeUnitsProperty); }
            }

            public bool IsSpaceAfterDefined
            {
                get { return this.IsValueDefined(State.SpaceAfterProperty); }
            }

            public bool IsSpaceAfterUnitsDefined
            {
                get { return this.IsValueDefined(State.SpaceAfterUnitsProperty); }
            }

            public bool IsAlignModeDefined
            {
                get { return this.IsValueDefined(State.AlignModeProperty); }
            }

            public bool IsKeepStartLinesDefined
            {
                get { return this.IsValueDefined(State.KeepStartLinesProperty); }
            }

            public bool IsKeepEndLinesDefined
            {
                get { return this.IsValueDefined(State.KeepEndLinesProperty); }
            }

            public bool IsKeepWithNextParagraphDefined
            {
                get { return this.IsValueDefined(State.KeepWithNextParagraphProperty); }
            }

            public bool IsKeepWithPreviousParagraphDefined
            {
                get { return this.IsValueDefined(State.KeepWithPreviousParagraphProperty); }
            }

            public bool IsParagraphStartModeDefined
            {
                get { return this.IsValueDefined(State.ParagraphStartModeProperty); }
            }

            public bool IsItemListInfoDefined
            {
                get { return this.IsValueDefined(State.ItemListInfoProperty); }
            }

            public bool IsManagedParagraphDefined
            {
                get { return this.IsValueDefined(State.ManagedParagraphProperty); }
            }

            public bool IsTabsDefined
            {
                get { return this.IsValueDefined(State.TabsProperty); }
            }
            ...
            public static readonly StateProperty JustificationModeProperty = new StateProperty(
                typeof(State),
                "JustificationMode",
                JustificationMode.Unknown
            );
            public static readonly StateProperty HyphenationProperty = new StateProperty(
                typeof(State),
                "Hyphenation",
                false
            );
            public static readonly StateProperty LeftMarginFirstProperty = new StateProperty(
                typeof(State),
                "LeftMarginFirst",
                double.NaN
            );
            public static readonly StateProperty LeftMarginBodyProperty = new StateProperty(
                typeof(State),
                "LeftMarginBody",
                double.NaN
            );
            public static readonly StateProperty RightMarginFirstProperty = new StateProperty(
                typeof(State),
                "RightMarginFirst",
                double.NaN
            );
            public static readonly StateProperty RightMarginBodyProperty = new StateProperty(
                typeof(State),
                "RightMarginBody",
                double.NaN
            );
            public static readonly StateProperty BreakFenceBeforeProperty = new StateProperty(
                typeof(State),
                "BreakFenceBefore",
                double.NaN
            );
            public static readonly StateProperty BreakFenceAfterProperty = new StateProperty(
                typeof(State),
                "BreakFenceAfter",
                double.NaN
            );
            public static readonly StateProperty MarginUnitsProperty = new StateProperty(
                typeof(State),
                "MarginUnits",
                Properties.SizeUnits.None
            );
            public static readonly StateProperty IndentationLevelProperty = new StateProperty(
                typeof(State),
                "IndentationLevel",
                -1
            );
            public static readonly StateProperty IndentationLevelAttributeProperty =
                new StateProperty(typeof(State), "IndentationLevelAttribute", null);
            public static readonly StateProperty LeadingProperty = new StateProperty(
                typeof(State),
                "Leading",
                double.NaN
            );
            public static readonly StateProperty LeadingUnitsProperty = new StateProperty(
                typeof(State),
                "LeadingUnits",
                Properties.SizeUnits.None
            );
            public static readonly StateProperty SpaceBeforeProperty = new StateProperty(
                typeof(State),
                "SpaceBefore",
                double.NaN
            );
            public static readonly StateProperty SpaceBeforeUnitsProperty = new StateProperty(
                typeof(State),
                "SpaceBeforeUnits",
                Properties.SizeUnits.None
            );
            public static readonly StateProperty SpaceAfterProperty = new StateProperty(
                typeof(State),
                "SpaceAfter",
                double.NaN
            );
            public static readonly StateProperty SpaceAfterUnitsProperty = new StateProperty(
                typeof(State),
                "SpaceAfterUnits",
                Properties.SizeUnits.None
            );
            public static readonly StateProperty AlignModeProperty = new StateProperty(
                typeof(State),
                "AlignMode",
                Properties.AlignMode.Undefined
            );
            public static readonly StateProperty KeepStartLinesProperty = new StateProperty(
                typeof(State),
                "KeepStartLines",
                0
            );
            public static readonly StateProperty KeepEndLinesProperty = new StateProperty(
                typeof(State),
                "KeepEndLines",
                0
            );
            public static readonly StateProperty ParagraphStartModeProperty = new StateProperty(
                typeof(State),
                "ParagraphStartMode",
                Properties.ParagraphStartMode.Undefined
            );
            public static readonly StateProperty ItemListInfoProperty = new StateProperty(
                typeof(State),
                "ItemListInfo",
                null
            );
            public static readonly StateProperty ManagedParagraphProperty = new StateProperty(
                typeof(State),
                "ManagedParagraph",
                null
            );
            public static readonly StateProperty TabsProperty = new StateProperty(
                typeof(State),
                "Tabs",
                null
            );
            public static readonly StateProperty KeepWithNextParagraphProperty = new StateProperty(
                typeof(State),
                "KeepWithNextParagraph",
                false
            );
            public static readonly StateProperty KeepWithPreviousParagraphProperty =
                new StateProperty(typeof(State), "KeepWithPreviousParagraph", false);
            #endregion
        }
