...
namespace Epsitec.Common.Text.Wrappers
{
    ...
    public class TextWrapper : AbstractWrapper
    {
        ...
        private void SynchronizeFontSize()
        {
            ...
            if (
                this.defined_state.IsValueFlagged(State.FontSizeProperty)
                || this.defined_state.IsValueFlagged(State.UnitsProperty)
            )
            {
                changes++;
            }
            if ((this.defined_state.IsFontSizeDefined) && (this.defined_state.IsUnitsDefined))
            {
                ...
                if (defines > 0)
                {
                    if (this.IsAttachedToDefaultParagraphStyle)
                    {
                        ...
                        System.Diagnostics.Debug.Assert(
                            units != Properties.SizeUnits.DeltaMillimeters
                        );
        ...
        private void SynchronizeFontGlue()
        {
            ...
            if (changes > 0)
            {
                if (defines > 0)
                {
                    Property p_size = new Properties.FontSizeProperty(
                        double.NaN,
            ...
            )
            {
                if (this.defined_state.IsValueFlagged(State.InvertBoldProperty))
                {
                    if (this.defined_state.IsInvertBoldDefined)
                    {
                        ...
                        {
                            Property p_font = new Properties.FontProperty(
                                null,
                                "!Bold",
            ...
            if (this.defined_state.IsValueFlagged(State.UnderlineProperty))
            {
                if (this.defined_state.IsUnderlineDefined)
                {
                    this.DefineMetaProperty(
                        ...
                        0,
                        this.defined_state.Underline.ToProperty()
                    );
                }
                else
                {
        ...
        private void SynchronizeOverline()
        {
            if (this.defined_state.IsValueFlagged(State.OverlineProperty))
            {
                ...
                {
                    this.DefineMetaProperty(
                        TextWrapper.Overline,
                        0,
                        this.defined_state.Overline.ToProperty()
                    );
                }
                else
                {
        ...
        private void SynchronizeStrikeout()
        {
            if (this.defined_state.IsValueFlagged(State.StrikeoutProperty))
            {
                ...
                {
                    this.DefineMetaProperty(
                        TextWrapper.Strikeout,
                        0,
                        this.defined_state.Strikeout.ToProperty()
                    );
                }
                else
                {
            ...
            if (this.defined_state.IsValueFlagged(State.TextBoxProperty))
            {
                if (this.defined_state.IsTextBoxDefined)
                {
                    this.DefineMetaProperty(
                        TextWrapper.TextBox,
                        0,
                        this.defined_state.TextBox.ToProperty()
                    );
                }
                else
                {
        ...
        private void SynchronizeTextMarker()
        {
            if (this.defined_state.IsValueFlagged(State.TextMarkerProperty))
            {
                ...
                {
                    this.DefineMetaProperty(
                        TextWrapper.TextMarker,
                        0,
                        this.defined_state.TextMarker.ToProperty()
                    );
                }
                else
                {
        ...
        private void SynchronizeXscript()
        {
            if (this.defined_state.IsValueFlagged(State.XscriptProperty))
            {
                ...
                {
                    Properties.FontXscriptProperty property =
                        this.defined_state.Xscript.ToProperty();
            ...
            if (this.defined_state.IsValueFlagged(State.ColorProperty))
            {
                if (this.defined_state.IsColorDefined)
                {
                    this.DefineMetaProperty(
                        TextWrapper.Color,
                        0,
                        new Properties.FontColorProperty(this.defined_state.Color)
                    );
                }
                else
                {
        ...
        {
            if (
                (this.defined_state.IsValueFlagged(State.LanguageLocaleProperty))
                || (this.defined_state.IsValueDefined(State.LanguageHyphenationProperty))
            )
            {
                if (
                    (this.defined_state.IsLanguageLocaleDefined)
                    || (this.defined_state.IsLanguageHyphenationDefined)
                )
                {
                    string locale = this.defined_state.IsLanguageLocaleDefined
                        ? this.defined_state.LanguageLocale
                        : null;
                    double hyphen = this.defined_state.IsLanguageHyphenationDefined
                        ? this.defined_state.LanguageHyphenation
                        : double.NaN;

                    this.DefineMetaProperty(
                        TextWrapper.Language,
                        0,
                        new Properties.LanguageProperty(locale, hyphen)
                    );
                }
                else
                {
        ...
        private void SynchronizeConditions()
        {
            if (this.defined_state.IsValueFlagged(State.ConditionsProperty))
            {
                ...
                if ((this.defined_state.IsConditionsDefined) && (conditions.Length > 0))
                {
                    Properties.ConditionalProperty[] properties =
                        new Properties.ConditionalProperty[conditions.Length];
        ...
        private void SynchronizeUserTags()
        {
            if (this.defined_state.IsValueFlagged(State.UserTagsProperty))
            {
                ...
                if ((this.defined_state.IsUserTagsDefined) && (user_tags.Length > 0))
                {
                    Properties.UserTagProperty[] properties = new Properties.UserTagProperty[
                        user_tags.Length
                    ];
        ...
        private void UpdateFontFace(State state, bool active)
        {
            ...
            {
                p_font =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Font)
                    as Properties.FontProperty;
            }
            else
            {
                p_font =
                    this.ReadMetaProperty(TextWrapper.FontFace, Properties.WellKnownType.Font)
                    as Properties.FontProperty;
            }
            ...
            if (p_font != null)
            {
                ...
                else
                {
                    ...
                    if (
                        (buffer.Length == 0) && (this.AttachedTextStyleClass == TextStyleClass.Text)
                    )
                    {
                        state.DefineValue(State.FontStyleProperty);
                    }
                    ...
                    {
                        state.DefineValue(
                            State.FontStyleProperty,
                            style_name.Length == 0 ? "Regular" : style_name
                        );
                    }
                }
            }
        ...
        private void UpdateFontFeatures(State state, bool active)
        {
            ...
            {
                p_font =
                    this.ReadMetaProperty(TextWrapper.FontFeatures, Properties.WellKnownType.Font)
                    as Properties.FontProperty;
            }

            if (p_font != null)
            {
                if ((p_font.Features == null) || (p_font.Features.Length == 0))
                {
        ...
        private void UpdateFontSize(State state, bool active)
        {
            ...
            {
                p_size =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.FontSize)
                    as Properties.FontSizeProperty;
            }
            else
            {
                p_size =
                    this.ReadMetaProperty(TextWrapper.FontSize, Properties.WellKnownType.FontSize)
                    as Properties.FontSizeProperty;
            }

            if ((p_size != null) && (p_size.Units != Properties.SizeUnits.None))
            {
        ...
        private void UpdateFontGlue(State state, bool active)
        {
            ...
            {
                p_size =
                    this.ReadMetaProperty(TextWrapper.FontGlue, Properties.WellKnownType.FontSize)
                    as Properties.FontSizeProperty;
            }

            if ((p_size != null) && (p_size.Glue.IsSafeNaN() == false))
            {
        ...
        private void UpdateInvert(State state, bool active)
        {
            ...
            {
                Properties.FontProperty p_bold =
                    this.ReadMetaProperty(TextWrapper.InvertBold, Properties.WellKnownType.Font)
                    as Properties.FontProperty;
                Properties.FontProperty p_italic =
                    this.ReadMetaProperty(TextWrapper.InvertItalic, Properties.WellKnownType.Font)
                    as Properties.FontProperty;
        ...
        private void UpdateXline(State state, bool active)
        {
            ...
            {
                p_underline =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Underline)
                    as Properties.UnderlineProperty;
                p_strikeout =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Strikeout)
                    as Properties.StrikeoutProperty;
                p_overline =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Overline)
                    as Properties.OverlineProperty;
                p_textbox =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.TextBox)
                    as Properties.TextBoxProperty;
                p_textmarker =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.TextMarker)
                    as Properties.TextMarkerProperty;
            }
            else
            {
                p_underline =
                    this.ReadMetaProperty(TextWrapper.Underline, Properties.WellKnownType.Underline)
                    as Properties.UnderlineProperty;
                p_strikeout =
                    this.ReadMetaProperty(TextWrapper.Strikeout, Properties.WellKnownType.Strikeout)
                    as Properties.StrikeoutProperty;
                p_overline =
                    this.ReadMetaProperty(TextWrapper.Overline, Properties.WellKnownType.Overline)
                    as Properties.OverlineProperty;
                p_textbox =
                    this.ReadMetaProperty(TextWrapper.TextBox, Properties.WellKnownType.TextBox)
                    as Properties.TextBoxProperty;
                p_textmarker =
                    this.ReadMetaProperty(
                        TextWrapper.TextMarker,
                        Properties.WellKnownType.TextMarker
                    ) as Properties.TextMarkerProperty;
            }
        ...
        private void UpdateXscript(State state, bool active)
        {
            ...
            {
                p_xscript =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.FontXscript)
                    as Properties.FontXscriptProperty;
            }
            else
            {
                p_xscript =
                    this.ReadMetaProperty(TextWrapper.Xscript, Properties.WellKnownType.FontXscript)
                    as Properties.FontXscriptProperty;
            }
        ...
        private void UpdateColor(State state, bool active)
        {
            ...
            {
                p_color =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.FontColor)
                    as Properties.FontColorProperty;
            }
            else
            {
                p_color =
                    this.ReadMetaProperty(TextWrapper.Color, Properties.WellKnownType.FontColor)
                    as Properties.FontColorProperty;
            }
        ...
        private void UpdateLanguage(State state, bool active)
        {
            ...
            {
                p_language =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Language)
                    as Properties.LanguageProperty;
            }
            else
            {
                p_language =
                    this.ReadMetaProperty(TextWrapper.Language, Properties.WellKnownType.Language)
                    as Properties.LanguageProperty;
            }
        ...
        private void UpdateLink(State state, bool active)
        {
            ...
            {
                p_link =
                    this.ReadAccumulatedProperty(Properties.WellKnownType.Link)
                    as Properties.LinkProperty;
            }
            else
            {
                p_link =
                    this.ReadMetaProperty(TextWrapper.Link, Properties.WellKnownType.Link)
                    as Properties.LinkProperty;
            }
        ...
        private void UpdateConditions(State state, bool active)
        {
            ...
            {
                p_conditions = this.ReadMetaProperties(
                    TextWrapper.Conditions,
                    Properties.WellKnownType.Conditional
                );
            }
        ...
        private void UpdateUserTags(State state, bool active)
        {
            ...
            {
                p_user_tags = this.ReadMetaProperties(
                    TextWrapper.UserTags,
                    Properties.WellKnownType.UserTag
                );
            }

            if ((p_user_tags == null) || (p_user_tags.Length == 0))
            {
        ...
        public class State : AbstractState
        {
            ...
            {
                get { return (string)this.GetValue(State.FontFaceProperty); }
                set { this.SetValue(State.FontFaceProperty, value); }
            }

            public string FontStyle
            {
                get { return (string)this.GetValue(State.FontStyleProperty); }
                set { this.SetValue(State.FontStyleProperty, value); }
            }

            public double FontSize
            {
                get { return (double)this.GetValue(State.FontSizeProperty); }
                set { this.SetValue(State.FontSizeProperty, value); }
            }

            public double FontGlue
            {
                get { return (double)this.GetValue(State.FontGlueProperty); }
                set { this.SetValue(State.FontGlueProperty, value); }
            }

            public string[] FontFeatures
            {
                get { return (string[])this.GetValue(State.FontFeaturesProperty); }
                set { this.SetValue(State.FontFeaturesProperty, value); }
            }

            public Properties.SizeUnits Units
            {
                get { return (Properties.SizeUnits)this.GetValue(State.UnitsProperty); }
                set { this.SetValue(State.UnitsProperty, value); }
            }

            public bool InvertBold
            {
                get { return (bool)this.GetValue(State.InvertBoldProperty); }
                set { this.SetValue(State.InvertBoldProperty, value); }
            }

            public bool InvertItalic
            {
                get { return (bool)this.GetValue(State.InvertItalicProperty); }
                set { this.SetValue(State.InvertItalicProperty, value); }
            }

            public string Color
            {
                get { return (string)this.GetValue(State.ColorProperty); }
                set { this.SetValue(State.ColorProperty, value); }
            }

            public string LanguageLocale
            {
                get { return (string)this.GetValue(State.LanguageLocaleProperty); }
                set { this.SetValue(State.LanguageLocaleProperty, value); }
            }

            public double LanguageHyphenation
            {
                get { return (double)this.GetValue(State.LanguageHyphenationProperty); }
                set { this.SetValue(State.LanguageHyphenationProperty, value); }
            }
            ...
            public XscriptDefinition Xscript
            {
                get
                {
                    XscriptDefinition value =
                        this.GetValue(State.XscriptProperty) as XscriptDefinition;

                    return value == null
                        ? new XscriptDefinition(this, State.XscriptProperty)
                        : value;
                }
            }
            ...
            public XlineDefinition Underline
            {
                get
                {
                    XlineDefinition value =
                        this.GetValue(State.UnderlineProperty) as XlineDefinition;

                    return value == null
                        ? new XlineDefinition(this, State.UnderlineProperty)
                        : value;
                }
            }
            ...
            public XlineDefinition Strikeout
            {
                ...
                {
                    XlineDefinition value =
                        this.GetValue(State.StrikeoutProperty) as XlineDefinition;

                    return value == null
                        ? new XlineDefinition(this, State.StrikeoutProperty)
                        : value;
                }
            }
            ...
            public XlineDefinition Overline
            {
                ...
                {
                    XlineDefinition value =
                        this.GetValue(State.OverlineProperty) as XlineDefinition;

                    return value == null
                        ? new XlineDefinition(this, State.OverlineProperty)
                        : value;
                }
            }
            ...
            public XlineDefinition TextMarker
            {
                ...
                {
                    XlineDefinition value =
                        this.GetValue(State.TextMarkerProperty) as XlineDefinition;

                    return value == null
                        ? new XlineDefinition(this, State.TextMarkerProperty)
                        : value;
                }
            }
            ...
            public string Link
            {
                get { return (string)this.GetValue(State.LinkProperty); }
                set { this.SetValue(State.LinkProperty, value); }
            }

            public string[] Conditions
            {
                get { return (string[])this.GetValue(State.ConditionsProperty); }
                set { this.SetValue(State.ConditionsProperty, value); }
            }

            public string[] UserTags
            {
                get { return (string[])this.GetValue(State.UserTagsProperty); }
                set { this.SetValue(State.UserTagsProperty, value); }
            }

            public bool IsFontFaceDefined
            {
                get { return this.IsValueDefined(State.FontFaceProperty); }
            }

            public bool IsFontStyleDefined
            {
                get { return this.IsValueDefined(State.FontStyleProperty); }
            }

            public bool IsFontSizeDefined
            {
                get { return this.IsValueDefined(State.FontSizeProperty); }
            }

            public bool IsFontGlueDefined
            {
                get { return this.IsValueDefined(State.FontGlueProperty); }
            }

            public bool IsFontFeaturesDefined
            {
                get { return this.IsValueDefined(State.FontFeaturesProperty); }
            }

            public bool IsUnitsDefined
            {
                get { return this.IsValueDefined(State.UnitsProperty); }
            }

            public bool IsInvertBoldDefined
            {
                get { return this.IsValueDefined(State.InvertBoldProperty); }
            }

            public bool IsInvertItalicDefined
            {
                get { return this.IsValueDefined(State.InvertItalicProperty); }
            }

            public bool IsColorDefined
            {
                get { return this.IsValueDefined(State.ColorProperty); }
            }

            public bool IsLanguageLocaleDefined
            {
                get { return this.IsValueDefined(State.LanguageLocaleProperty); }
            }

            public bool IsLanguageHyphenationDefined
            {
                get { return this.IsValueDefined(State.LanguageHyphenationProperty); }
            }

            public bool IsXscriptDefined
            {
                get { return this.IsValueDefined(State.XscriptProperty); }
            }

            public bool IsUnderlineDefined
            {
                get { return this.IsValueDefined(State.UnderlineProperty); }
            }

            public bool IsStrikeoutDefined
            {
                get { return this.IsValueDefined(State.StrikeoutProperty); }
            }

            public bool IsOverlineDefined
            {
                get { return this.IsValueDefined(State.OverlineProperty); }
            }

            public bool IsTextBoxDefined
            {
                get { return this.IsValueDefined(State.TextBoxProperty); }
            }

            public bool IsTextMarkerDefined
            {
                get { return this.IsValueDefined(State.TextMarkerProperty); }
            }

            public bool IsLinkDefined
            {
                get { return this.IsValueDefined(State.LinkProperty); }
            }

            public bool IsConditionsDefined
            {
                get { return this.IsValueDefined(State.ConditionsProperty); }
            }

            public bool IsUserTagsDefined
            {
                get { return this.IsValueDefined(State.UserTagsProperty); }
            }
            ...
            public static readonly StateProperty FontFaceProperty = new StateProperty(
                typeof(State),
                "FontFace",
                null
            );
            public static readonly StateProperty FontStyleProperty = new StateProperty(
                typeof(State),
                "FontStyle",
                null
            );
            public static readonly StateProperty FontSizeProperty = new StateProperty(
                typeof(State),
                "FontSize",
                double.NaN
            );
            public static readonly StateProperty FontGlueProperty = new StateProperty(
                typeof(State),
                "FontGlue",
                double.NaN
            );
            public static readonly StateProperty FontFeaturesProperty = new StateProperty(
                typeof(State),
                "FontFeatures",
                Epsitec.Common.Types.Collections.EmptyArray<string>.Instance
            );
            public static readonly StateProperty UnitsProperty = new StateProperty(
                typeof(State),
                "Units",
                Properties.SizeUnits.None
            );
            public static readonly StateProperty InvertBoldProperty = new StateProperty(
                typeof(State),
                "InvertBold",
                false
            );
            public static readonly StateProperty InvertItalicProperty = new StateProperty(
                typeof(State),
                "InvertItalic",
                false
            );
            public static readonly StateProperty ColorProperty = new StateProperty(
                typeof(State),
                "Color",
                null
            );
            public static readonly StateProperty LanguageLocaleProperty = new StateProperty(
                typeof(State),
                "LanguageLocale",
                null
            );
            public static readonly StateProperty LanguageHyphenationProperty = new StateProperty(
                typeof(State),
                "LanguageHyphenation",
                0
            );
            public static readonly StateProperty XscriptProperty = new StateProperty(
                typeof(State),
                "Xscript",
                null
            );
            public static readonly StateProperty UnderlineProperty = new StateProperty(
                typeof(State),
                "Underline",
                null
            );
            public static readonly StateProperty StrikeoutProperty = new StateProperty(
                typeof(State),
                "Strikeout",
                null
            );
            public static readonly StateProperty OverlineProperty = new StateProperty(
                typeof(State),
                "Overline",
                null
            );
            public static readonly StateProperty TextBoxProperty = new StateProperty(
                typeof(State),
                "TextBox",
                null
            );
            public static readonly StateProperty TextMarkerProperty = new StateProperty(
                typeof(State),
                "TextMarker",
                null
            );
            public static readonly StateProperty LinkProperty = new StateProperty(
                typeof(State),
                "Link",
                null
            );
            public static readonly StateProperty ConditionsProperty = new StateProperty(
                typeof(State),
                "Conditions",
                Epsitec.Common.Types.Collections.EmptyArray<string>.Instance
            );
            public static readonly StateProperty UserTagsProperty = new StateProperty(
                typeof(State),
                "UserTags",
                Epsitec.Common.Types.Collections.EmptyArray<string>.Instance
            );
        ...
        public class XlineDefinition
        {
            ...
            public bool IsEmpty
            {
                get { return (this.draw_style == null) && (this.draw_class == null); }
            }
            ...
            {
                get { return this.position_units; }
                set
                {
            ...
            {
                get { return this.thickness_units; }
                set
                {
            ...
            public Properties.AbstractXlineProperty ToProperty()
            {
                if (this.is_disabled)
                {
                    ...
                    {
                        case "Underline":
                            return Properties.UnderlineProperty.DisableOverride;
                        case "Strikeout":
                            return Properties.StrikeoutProperty.DisableOverride;
                        case "Overline":
                            return Properties.OverlineProperty.DisableOverride;
                        case "TextBox":
                            return Properties.TextBoxProperty.DisableOverride;
                        case "TextMarker":
                            return Properties.TextMarkerProperty.DisableOverride;
                    }
                }
                else
                {
                    ...
                    {
                        case "Underline":
                            return new Properties.UnderlineProperty(
                                this.position,
                                this.position_units,
                                this.thickness,
                        ...
                        case "Strikeout":
                            return new Properties.StrikeoutProperty(
                                this.position,
                                this.position_units,
                                this.thickness,
                                this.thickness_units,
                        ...
                        case "Overline":
                            return new Properties.OverlineProperty(
                                this.position,
                                this.position_units,
                                this.thickness,
                                this.thickness_units,
                        ...
                        case "TextBox":
                            return new Properties.TextBoxProperty(
                                this.position,
                                this.position_units,
                                this.thickness,
                                this.thickness_units,
                        ...
                        case "TextMarker":
                            return new Properties.TextMarkerProperty(
                                this.position,
                                this.position_units,
                                this.thickness,
                                this.thickness_units,
                ...
                throw new System.NotSupportedException(
                    string.Format("Property {0} not supported", this.property.Name)
                );
            }
        ...
        public class XscriptDefinition
        {
            ...
            public Properties.FontXscriptProperty ToProperty()
            {
                if (this.is_disabled)
                {
                    ...
                    {
                        case "Xscript":
                            return Properties.FontXscriptProperty.DisableOverride;
                    }
                }
                else
                {
                    ...
                    {
                        case "Xscript":
                            return new Properties.FontXscriptProperty(this.scale, this.offset);
                    }
                }
