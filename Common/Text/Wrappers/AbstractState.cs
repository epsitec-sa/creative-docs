...
namespace Epsitec.Common.Text.Wrappers
{
    ...
    public abstract class AbstractState
    {
        ...
        {
            bool changed =
                (this.IsValueDefined(property) == false)
                ||
        ...
        private class SavedState
        {
            ...
            private static void Copy(
                Dictionary<StateProperty, object> a,
                Dictionary<StateProperty, object> b
            )
            {
                b.Clear();
            ...
            private static void Copy(
                Dictionary<StateProperty, bool> a,
                Dictionary<StateProperty, bool> b
            )
            {
                b.Clear();
