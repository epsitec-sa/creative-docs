...
namespace Epsitec.Common.Text.Wrappers
{
    ...
    public abstract class AbstractWrapper
    {
        ...
        public void Attach(
            ...
            Common.Support.OpletQueue oplet_queue
        )
        {
        ...
        public void DefineOperationName(string name, string caption)
        {
            ...
            {
                if ((this.last_op_name != name) && (name != null) && (name.Length > 0))
                {
        ...
        private void RedefineStyle(System.Collections.ArrayList properties)
        {
            using (this.story.BeginAction(this.last_op_caption))
            {
                ...
                this.style_list.RedefineTextStyle(
                    this.oplet_queue,
                    this.style,
                    accumulator.AccumulatedProperties,
                    parent_styles
                );
                this.story.ValidateAction();
            }
        ...
        protected void DefineMetaProperty(string meta, int priority, params Property[] properties)
        {
            ...
            {
                TextStyle style = this.style_list.CreateOrGetMetaProperty(
                    meta,
                    priority,
                    properties
                );
        ...
        private static void RemoveStyleMetaProperties(
        ...
        private static void InsertStyleMetaProperties(
            System.Collections.ArrayList list,
            string name,
            int priority,
            Property[] properties
        ...
        protected Property ReadAccumulatedProperty(Properties.WellKnownType type)
        {
            ...
            else if (this.attachment == Attachment.Style)
            {
                ...
                accumulator.Accumulate(
                    this.story.FlattenStylesAndProperties(
                        new TextStyle[1] { this.style },
                        new Property[0]
                    )
                );
