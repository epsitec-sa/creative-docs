...
namespace Epsitec.Common.Text
{
    ...
    public sealed class SerializerSupport
    {
        ...
        public static void SerializeStringStringHash(
        ...
        public static void SerializeStringIntHash(
            System.Collections.Hashtable hash,
            System.Text.StringBuilder buffer
        )
        {
        ...
        public static void DeserializeStringIntHash(
            string[] args,
            ref int offset,
            System.Collections.Hashtable hash
        )
        ...
        public static Properties.ThreeState DeserializeThreeState(string value)
        {
            ...
            {
                case "[true]":
                    return Properties.ThreeState.True;
                case "[false]":
                    return Properties.ThreeState.False;
                case "[?]":
                    return Properties.ThreeState.Undefined;
            }
