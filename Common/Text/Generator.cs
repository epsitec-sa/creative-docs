...
namespace Epsitec.Common.Text
{
    ...
    public sealed class Generator
    {
        ...
        {
            get { return this.globalPrefix; }
            set { this.globalPrefix = value; }
        }
        ...
        public Property[] GlobalPrefixProperties
        {
            ...
            {
                if (
                    (this.globalPrefixProperties == null)
        ...
        {
            get { return this.globalSuffix; }
            set { this.globalSuffix = value; }
        }
        ...
        public Property[] GlobalSuffixProperties
        {
            ...
            {
                if (
                    (this.globalSuffixProperties == null)
        ...
        {
            get { return this.sequences[index] as Sequence; }
        }
        ...
        )
        {
            ...
            for (int i = 0; i < maxLevelCount; i++)
            {
                ...
                if ((sequence.Prefix != null) && (sequence.Prefix.Length > 0))
                {
                ...
                if ((sequence.Suffix != null) && (sequence.Suffix.Length > 0))
                {
        ...
        public void Serialize(System.Text.StringBuilder buffer)
        {
            ...
            foreach (Generator.Sequence sequence in sequences)
            {
                buffer.Append("/");
                buffer.Append(
                    SerializerSupport.SerializeString(Generator.SerializeToText(sequence))
                );
            }
            ...
            buffer.Append("/");
            buffer.Append(
                SerializerSupport.SerializeString(
                    Property.SerializeProperties(this.globalPrefixProperties)
                )
            );
            buffer.Append("/");
            buffer.Append(
                SerializerSupport.SerializeString(
                    Property.SerializeProperties(this.globalSuffixProperties)
                )
            );
            buffer.Append("/");
        ...
        public void Deserialize(TextContext context, int version, string[] args, ref int offset)
        {
            ...
            for (int i = 0; i < numSequences; i++)
            {
                ...
                Generator.DeserializeFromText(
                    context,
                    SerializerSupport.DeserializeString(args[offset++]),
                    out sequence
                );
            ...
            if (version >= 5)
            {
                this.globalPrefixProperties = Property.DeserializeProperties(
                    context,
                    SerializerSupport.DeserializeString(args[offset++])
                );
                this.globalSuffixProperties = Property.DeserializeProperties(
                    context,
                    SerializerSupport.DeserializeString(args[offset++])
                );
            ...
            public void Iterate(out TextProcessor.Status status)
            {
                if (this.enumerator.MoveNext())
                {
                    ...
                    if (pos < this.story.TextLength)
                    {
                        ...
                        if ((mInfoProperty != null) && (mInfoProperty.ManagerInfo != "auto"))
                        {
                            //	Mode spécifique :
                            //
                            ...
                            else
                            {
                                throw new System.NotSupportedException(
                                    string.Format("ManagerInfo '{0}' not supported", mode)
                                );
                            }
                        }
                        else
                        ...
                        System.Diagnostics.Debug.Assert(
                            generatorProperty.Generator == this.generator.Name
                        );

                        int length = this.context.GetTextEndDistance(
                            this.story,
                            cursor,
                            generatorProperty
                        );
                        int level = System.Math.Max(
                            generatorProperty.Level,
                            marginsProperty == null ? 0 : marginsProperty.Level
                        );
                        ...
                        if (
                            this.story.ReplaceTextSequence(
                                cursor,
                                length,
                                autoTextProperty,
                                generatorProperty,
            ...
            public static TextRange[] Simplify(System.Collections.ICollection ranges)
            {
                ...
                foreach (TextRange range in ranges)
                {
                    ...
                    if (
                        (last == null)
                        || (
                            Property.CompareEqualContents(last.properties, range.properties)
                            == false
                        )
                    )
                    {
        ...
        public class Series
        {
            ...
            public TextRange[] GetNextText(int level)
            {
                ...
                TextRange[] textRange = this.generator.GenerateText(
                    this.vector,
                    level + 1,
                    this.culture
                );
        ...
        public abstract class Sequence : ISerializableAsText
        {
            ...
            public Property[] ValueProperties
            {
                get
                {
                    if ((this.valueProperties == null) || (this.valueProperties.Length == 0))
                    {
                        return null;
                    }
                    else
            ...
            public Property[] PrefixProperties
            {
                get
                {
                    if ((this.prefixProperties == null) || (this.prefixProperties.Length == 0))
                    {
                        return null;
                    }
                    else
            ...
            public Property[] SuffixProperties
            {
                get
                {
                    if ((this.suffixProperties == null) || (this.suffixProperties.Length == 0))
                    {
                        return null;
                    }
                    else
            ...
            {
                get { return this.suppressBefore; }
                set { this.suppressBefore = value; }
            }
            ...
            public abstract SequenceType WellKnownType { get; }
            ...
            public void SerializeToText(System.Text.StringBuilder buffer)
            {
                ...
                )
                {
                    SerializerSupport.Join(
                        ...
                        /**/SerializerSupport.SerializeInt(
                            (int)this.casing | (this.suppressBefore ? 0x0100 : 0x0000)
                        ),
        ...
        public static Generator.Sequence CreateSequence(SequenceType type)
        {
            switch (type)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("SequenceType {0} not supported", type)
                    );
            }
        }

        public static Generator.Sequence CreateSequence(
            SequenceType type,
            string prefix,
            string suffix
        )
        ...
        public static void DeserializeFromText(
            TextContext context,
            string text,
        ...
        )
        {
            ...
            string typeName = string.Concat(
                "Epsitec.Common.Text.Internals.Sequences.",
                sequName,
                "Sequence"
            );

            sequence = Generator.CreateSequence(
                (SequenceType)System.Enum.Parse(typeof(SequenceType), sequName)
            );
