...
namespace Epsitec.Common.FormEngine
{
    ...
    public sealed class FieldDescription : System.IEquatable<FieldDescription>
    {
        ...
        public bool IsForwardTab
        {
            ...
            get { return this.type == FieldType.Field || this.type == FieldType.Command; }
        }
        ...
        public SeparatorType SeparatorBottom
        {
            ...
            get { return this.separatorBottom; }
            set { this.separatorBottom = value; }
        }
        ...
        public bool HasTextStyle
        {
            ...
            get { return this.HasLabelTextStyle || this.HasFieldTextStyle; }
        }
        ...
        public FontColorType LabelFontColor
        {
            ...
            get { return this.labelFontColor; }
            set { this.labelFontColor = value; }
        }

        public FontColorType FieldFontColor
        {
            //	Couleur de la police pour le champ.
            get { return this.fieldFontColor; }
            set { this.fieldFontColor = value; }
        }

        public FontFaceType LabelFontFace
        {
            //	Nom de la police pour l'étiquette.
            get { return this.labelFontFace; }
            set { this.labelFontFace = value; }
        }

        public FontFaceType FieldFontFace
        {
            //	Nom de la police pour le champ.
            get { return this.fieldFontFace; }
            set { this.fieldFontFace = value; }
        }

        public FontStyleType LabelFontStyle
        {
            //	Style de la police pour l'étiquette.
            get { return this.labelFontStyle; }
            set { this.labelFontStyle = value; }
        }

        public FontStyleType FieldFontStyle
        {
            //	Style de la police pour le champ.
            get { return this.fieldFontStyle; }
            set { this.fieldFontStyle = value; }
        }
        ...
        public FontSizeType LabelFontSize
        {
            ...
            set { this.labelFontSize = value; }
        }

        public FontSizeType FieldFontSize
        {
            //	Taille de la police pour le champ.
            get { return this.fieldFontSize; }
            set { this.fieldFontSize = value; }
        }

        public CommandButtonClass CommandButtonClassValue
        {
            //	Type d'une commande.
            get { return this.commandButtonClass; }
            set { this.commandButtonClass = value; }
        }

        public int ColumnsRequired
        {
            //	Nombre de colonnes requises [1..10].
            get { return this.columnsRequired; }
            set
            {
        ...
        public BoxLayoutType BoxLayout
        {
            ...
            get { return this.boxLayoutType; }
            set
            {
                System.Diagnostics.Debug.Assert(
                    this.type == FieldType.BoxBegin || this.type == FieldType.SubForm
                );
        ...
        public BoxPaddingType BoxPadding
        {
            ...
            get { return this.boxPaddingType; }
            set
            {
                System.Diagnostics.Debug.Assert(
                    this.type == FieldType.BoxBegin || this.type == FieldType.SubForm
        ...
        public double LineWidth
        {
            ...
            {
                System.Diagnostics.Debug.Assert(
                    this.type == FieldType.Line || this.type == FieldType.Title
                );
        ...
        public Druid LabelReplacement
        {
            ...
            get { return this.labelReplacement; }
            set { this.labelReplacement = value; }
        }
        ...
        public bool DeltaHidden
        {
            ...
            //	Guid = champ à cacher
            get { return this.deltaHidden; }
            set { this.deltaHidden = value; }
        }
        ...
        public bool DeltaShowed
        {
            ...
            get { return this.deltaShowed; }
            set { this.deltaShowed = value; }
        }
        ...
        public bool DeltaMoved
        {
            ...
            //	... = paramètres du champ
            get { return this.deltaMoved; }
            set { this.deltaMoved = value; }
        }
        ...
        public bool DeltaInserted
        {
            ...
            //	DeltaAttachGuid = champ *après* lequel on s'attache
            //	... = paramètres du champ
            get { return this.deltaInserted; }
            set { this.deltaInserted = value; }
        }
        ...
        public bool DeltaModified
        {
            ...
            //	Guid = champ modifié
            //	... = paramètres du champ
            get { return this.deltaModified; }
            set { this.deltaModified = value; }
        }
        ...
        public bool DeltaForwardTab
        {
            ...
            //	Guid = champ modifié
            //	... = paramètres du champ
            get { return this.deltaForwardTab; }
            set { this.deltaForwardTab = value; }
        }
        ...
        public System.Guid DeltaAttachGuid
        {
            ...
            get { return this.deltaAttachGuid; }
            set { this.deltaAttachGuid = value; }
        }
        ...
        public bool DeltaBrokenAttach
        {
            ...
            //	Utilisé uniquement si this.type == FieldType.DeltaAttach ou DeltaInsert !
            get { return this.deltaBrokenAttach; }
            set { this.deltaBrokenAttach = value; }
        }

        public System.Guid ForwardTabGuid
        {
            //	Retourne l'identificateur unique où doit amener la touche Tab (exception).
            get { return this.forwardTabGuid; }
            set { this.forwardTabGuid = value; }
        }
        ...
        {
            return (obj is FieldDescription)
                && (FieldDescription.Equals(this, (FieldDescription)obj));
        }
        ...
        public void WriteXml(XmlWriter writer)
        {
            ...
            if (this.type == FieldType.Node)
            {
                throw new System.InvalidOperationException(
                    "WriteXml: le type Node ne peut pas être sérialisé."
                );
            }
            ...
            if (this.commandButtonClass != CommandButtonClass.Default)
            {
                writer.WriteElementString(
                    Xml.CommandButtonClass,
                    this.commandButtonClass.ToString()
                );
            }
            ...
            writer.WriteElementString(
                Xml.ColumnsRequired,
                this.columnsRequired.ToString(System.Globalization.CultureInfo.InvariantCulture)
            );
            writer.WriteElementString(
                Xml.RowsRequired,
                this.rowsRequired.ToString(System.Globalization.CultureInfo.InvariantCulture)
            );
            ...
            writer.WriteElementString(
                Xml.BoxFrameWidth,
                this.boxFrameWidth.ToString(System.Globalization.CultureInfo.InvariantCulture)
            );
            writer.WriteElementString(
                Xml.LineWidth,
                this.lineWidth.ToString(System.Globalization.CultureInfo.InvariantCulture)
            );
            writer.WriteElementString(
                Xml.PreferredWidth,
                this.preferredWidth.ToString(System.Globalization.CultureInfo.InvariantCulture)
            );
            ...
            while (true)
            {
                if (reader.NodeType == XmlNodeType.Element)
                {
                    ...
                    else
                    {
                        ...
                        {
                            this.backColor = (BackColorType)
                                System.Enum.Parse(typeof(BackColorType), element);
                        }
                        else if (name == Xml.LabelFontColor)
                        {
                            this.labelFontColor = (FontColorType)
                                System.Enum.Parse(typeof(FontColorType), element);
                        }
                        else if (name == Xml.FieldFontColor)
                        {
                            this.fieldFontColor = (FontColorType)
                                System.Enum.Parse(typeof(FontColorType), element);
                        }
                        else if (name == Xml.LabelFontFace)
                        {
                            this.labelFontFace = (FontFaceType)
                                System.Enum.Parse(typeof(FontFaceType), element);
                        }
                        else if (name == Xml.FieldFontFace)
                        {
                            this.fieldFontFace = (FontFaceType)
                                System.Enum.Parse(typeof(FontFaceType), element);
                        }
                        else if (name == Xml.LabelFontStyle)
                        {
                            this.labelFontStyle = (FontStyleType)
                                System.Enum.Parse(typeof(FontStyleType), element);
                        }
                        else if (name == Xml.FieldFontStyle)
                        {
                            this.fieldFontStyle = (FontStyleType)
                                System.Enum.Parse(typeof(FontStyleType), element);
                        }
                        else if (name == Xml.LabelFontSize)
                        {
                            this.labelFontSize = (FontSizeType)
                                System.Enum.Parse(typeof(FontSizeType), element);
                        }
                        else if (name == Xml.FieldFontSize)
                        {
                            this.fieldFontSize = (FontSizeType)
                                System.Enum.Parse(typeof(FontSizeType), element);
                        }
                        else if (name == Xml.CommandButtonClass)
                        {
                            this.commandButtonClass = (CommandButtonClass)
                                System.Enum.Parse(typeof(CommandButtonClass), element);
                        }
                        else if (name == Xml.SeparatorBottom)
                        {
                            this.separatorBottom = (SeparatorType)
                                System.Enum.Parse(typeof(SeparatorType), element);
                        }
                        ...
                        {
                            this.boxLayoutType = (BoxLayoutType)
                                System.Enum.Parse(typeof(BoxLayoutType), element);
                        }
                        else if (name == Xml.BoxPaddingType)
                        {
                            this.boxPaddingType = (BoxPaddingType)
                                System.Enum.Parse(typeof(BoxPaddingType), element);
                        }
                        else if (name == Xml.BoxFrameEdges)
                        {
                            this.boxFrameEdges = (FrameEdges)
                                System.Enum.Parse(typeof(FrameEdges), element);
                        }
                        ...
                        {
                            this.verbosity = (UI.Verbosity)
                                System.Enum.Parse(typeof(UI.Verbosity), element);
                        }
        ...
        public static void GetRealFontStrings(
