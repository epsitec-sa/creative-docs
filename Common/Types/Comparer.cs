    ...
    public static class Comparer
    {
            ...
            where T : class
        {
            ...
            for (int i = 0; i < a.Length; i++)
            {
                if (a[i] != b[i])
                {
                    if ((a[i] == null) || (a[i].Equals(b[i]) == false))
                    {
                        return false;
                    }
                }
        ...
        public static int Compare(string a, string b, TextComparison comparison)
        {
            ...
            string textA = Comparer.ConvertForComparison(
                a.Substring(0, System.Math.Min(probeOffset, a.Length)),
                comparison
            );
            string textB = Comparer.ConvertForComparison(
                b.Substring(0, System.Math.Min(probeOffset, b.Length)),
                comparison
            );
            ...
            textA = Comparer.ConvertForComparison(
                a.Substring(probeOffset, System.Math.Max(0, a.Length - probeOffset)),
                comparison
            );
            textB = Comparer.ConvertForComparison(
                b.Substring(probeOffset, System.Math.Max(0, b.Length - probeOffset)),
                comparison
            );
            ...
            switch (comparison)
            {
                ...
                default:
                    throw new System.NotImplementedException(
                        string.Format("Support for TextComparison.{0} not implemented", comparison)
                    );
            }
        }
    }
