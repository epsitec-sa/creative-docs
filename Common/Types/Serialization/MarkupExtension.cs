...
namespace Epsitec.Common.Types.Serialization
{
    ...
    public static class MarkupExtension
    {
        ...
        public static string ResourceBindingToString(
        ...
        public static string ObjRefToString(DependencyObject value, Context context)
        {
            return string.Concat(
                "{ObjRef ",
                Context.IdToString(context.ObjectMap.GetId(value)),
                "}"
            );
        }
        ...
        )
        {
            ...
            foreach (DependencyObject node in collection)
            {
                ...
                throw new System.ArgumentException(
                    string.Format("Element {0} in collection cannot be resolved", i)
                );
            }
        ...
        )
        {
            ...
            foreach (object node in enumerable)
            {
                ...
                if ((filter != null) && (filter.IsSerializable(node, context) == false))
                {
                    continue;
                }
                ...
                buffer.Append(
                    MarkupExtension.TextToString(converter.ConvertToString(node, context))
                );
            }
        ...
        public static Binding BindingFromString(IContextResolver context, string value)
        {
            ...
            if ((args.Length == 0) || (args[0] != "Binding"))
            {
                throw new System.FormatException(
                    string.Format("String '{0}' is not a valid Binding expression", value)
                );
            }
        ...
        public static ResourceBinding ResourceBindingFromString(
        ...
        )
        {
            ...
            if ((args.Length == 0) || (args[0] != "ResBinding"))
            {
                throw new System.FormatException(
                    string.Format("String '{0}' is not a valid ResBinding expression", value)
                );
            }
        ...
        public static string[] Explode(string source)
        {
            ...
            {
                throw new System.FormatException(
                    string.Format("String '{0}' is not a valid markup extension", source)
                );
            }
        }
        ...
        private static Binding BindingFromString(IContextResolver context, string[] args)
        {
            ...
            if ((args.Length < 1) || (args[0] != "Binding"))
            {
                ...
                if (element.Length > 0)
                {
                    ...
                    else
                    {
                        ...
                        if (elems.Length != 2)
                        {
                            throw new System.FormatException(
                                string.Format(
                                    "Element '{0}' not valid in Binding expression",
                                    element
                                )
                            );
                        }
                        ...
                        switch (elems[0])
                        {
                            case "Path":
                                ...
                                break;
                            case "Source":
                                binding.Source = context.ResolveFromMarkup(
                                    elems[1],
                                    typeof(object)
                                );
                                break;
        ...
        private static ResourceBinding ResourceBindingFromString(
            IContextResolver context,
            string[] args
        )
        {
            if ((args.Length < 1) || (args[0] != "ResBinding"))
            {
            ...
            for (int i = 1; i < args.Length; i++)
            {
                ...
                if (element.Length > 0)
                {
                    ...
                    {
                        throw new System.FormatException(
                            string.Format("Element '{0}' not valid in Binding expression", element)
                        );
                    }
                    ...
                    switch (elems[0])
                    {
                        ...
                        default:
                            throw new System.FormatException(
                                string.Format(
                                    "Element '{0}' not valid in ResBinding expression",
                                    element
                                )
                            );
                    }
            ...
            object manager = context.ResolveFromMarkup(
                string.Concat("{ExtRef ", Context.WellKnownTagResourceManager, "}"),
                typeof(object)
            );
        ...
        {
            if ((args.Length != 2) || (args[0] != "ExtRef"))
            {
        ...
        {
            if ((args.Length != 2) || (args[0] != "ObjRef"))
            {
        ...
        private static object TextFromString(Context context, string markup)
        {
            ...
            return MarkupExtension.Unescape(
                markup.Substring(prefix.Length, markup.Length - prefix.Length - suffix.Length)
            );
        }
        ...
        private static object CollectionFromString(Context context, string[] args, System.Type type)
        {
            ...
            if (
                TypeRosetta.DoesTypeImplementInterface(type, typeof(System.Collections.IEnumerable))
            )
            {
        ...
        public static System.Collections.IEnumerable EnumerableFromString(
            Context context,
            string[] args,
            ISerializationConverter converter
        )
