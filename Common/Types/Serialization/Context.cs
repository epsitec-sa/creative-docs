...
namespace Epsitec.Common.Types.Serialization
{
    ...
    public class Context : IContextResolver, System.IDisposable
    {
        ...
        public System.Type RestoreTypeDefinition()
        {
            ...
            if (type == null)
            {
                throw new System.ArgumentException(
                    string.Format(
                        "Type {0} cannot be resolved. Did you forget the [assembly: Epsitec.Common.Types.DependencyClass] attribute on the specified class?",
                        name
                    )
                );
            }
        ...
        public string RestoreExternalDefinition()
        {
            ...
            {
                throw new System.ArgumentException(
                    string.Format("Required external value '{0}' not defined in context", tag)
                );
            }
        }
        ...
        public ISerializationConverter FindConverter(System.Type type)
        {
            ...
            converter = Serialization.DependencyClassManager.Current.FindSerializationConverter(
                type
            );
        ...
        public ISerializationConverter FindConverterForCollection(
            System.Type collectionType,
            out System.Type countableType
        )
        {
            //	Maybe the provided type is already an ICollection<T> interface :

            ISerializationConverter converter = this.FindConverterForCollectionInterfaceType(
                collectionType,
                out countableType
            );
            ...
            if (converter == null)
            {
                ...
                {
                    converter = this.FindConverterForCollectionInterfaceType(
                        type,
                        out countableType
                    );
        ...
        private ISerializationConverter FindConverterForCollectionInterfaceType(
            System.Type type,
            out System.Type countableType
        )
        {
            if ((type.Name == "ICollection`1") && (type.IsGenericType))
            {
        ...
        public object ResolveFromMarkup(string tagId, System.Type type)
        {
            ...
            if (MarkupExtension.IsMarkupExtension(tagId) == false)
            {
                throw new System.NotImplementedException(
                    string.Format("Cannot resolve '{0}'", tagId)
                );
            }
        ...
        public static Support.ResourceManager GetResourceManager(IContextResolver context)
        {
            ...
            {
                return context.ExternalMap.GetValue(
        ...
        protected void AssertWritable()
        {
            if (this.writer == null)
            {
                throw new System.InvalidOperationException(
                    string.Format("No writer associated with serialization context")
                );
            }
        }
        ...
        protected void AssertReadable()
        {
            ...
            {
                throw new System.InvalidOperationException(
                    string.Format("No reader associated with serialization context")
                );
            }
        }
