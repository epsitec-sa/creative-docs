...
namespace Epsitec.Common.Types
{
    ...
    public abstract class DependencyObject
        : System.IDisposable,
            IInheritedPropertyCache,
            IStructuredData,
            IStructuredTypeProvider
    {
        /// <summary>
            ...
            get
            {
                ...
                foreach (DependencyProperty property in type.GetProperties())
                {
                    if (this.properties.ContainsKey(property) == false)
                    {
                        ...
                        {
                            yield return new PropertyValuePair(
                                property,
                                metadata.GetValueOverride(this)
                            );
                        }
                    }
                }
        ...
        {
            if ((metadata.GetValueOverride != null) || (this.ContainsLocalValue(property)))
            {
                return true;
            }
            else
            ...
            if (metadata.NotifyPropertyInvalidated(this, oldValue, newValue))
            {
                if (this.HasEventHandlerForProperty(property))
                {
                    ...
                    DependencyPropertyChangedEventArgs args =
                        new DependencyPropertyChangedEventArgs(property, oldValue, newValue);
        ...
        {
            if ((this.propertyEvents != null) && (this.propertyEvents.ContainsKey(property)))
            {
                this.propertyEvents[property] = this.propertyEvents[property] - handler;
            }
        }
        ...
        {
            if ((this.userEvents != null) && (this.userEvents.ContainsKey(name)))
            {
        ...
        {
            if ((this.bindings != null) && (this.bindings.ContainsKey(property)))
            {
                return true;
            }
            else
        ...
        public IEnumerable<KeyValuePair<DependencyProperty, Binding>> GetAllBindings()
        {
            if (this.bindings != null)
            {
                ...
                {
                    yield return new KeyValuePair<DependencyProperty, Binding>(
                        entry.Key,
                        entry.Value.ParentBinding
                    );
                }
            }
        }
        ...
        public static bool EqualValues(DependencyObject a, DependencyObject b)
        {
            ...
            foreach (PropertyValuePair entry in aValues)
            {
                ...
                if (
                    (va is System.Collections.ICollection) && (vb is System.Collections.ICollection)
                )
                {
        ...
        public static void CopyAttachedProperties(
            DependencyObject source,
            DependencyObject destination
        )
        {
            try
            {
        ...
        /// <param name="destination">The destination object.</param>
        /// <param name="property">The property which must be copied.</param>
        public static void CopyDefinedProperty(
            DependencyObject source,
            DependencyObject destination,
            DependencyProperty property
        )
        ...
        /// <param name="source">The source object.</param>
        /// <param name="destination">The destination object.</param>
        public static void CopyDefinedProperties(
            DependencyObject source,
            DependencyObject destination
        )
        {
        ...
        private static bool CopyDefinedProperty(
            DependencyObject source,
            DependencyObject destination,
            DependencyProperty property,
            bool ignoreEmptyCollection
        )
        {
            if (source.ContainsValue(property))
            {
                ...
                if (collection != null)
                {
                    ...
                    if (
                        DependencyObject.CopyCollection<DependencyObject>(
                            source,
                            destination,
                            property
                        )
                    ...
                    else if (DependencyObject.CopyCollection<string>(source, destination, property))
                    {
                        ...
                        DependencyObject.CopyValueTypeOrCloneableCollection(
                            source,
                            destination,
                            property
                        )
                    ...
                    else
                    {
                        throw new System.InvalidOperationException(
                            "Cannot copy unsupported collection"
                        );
                    }
                }
                else
        ...
        private static bool CopyCollection<T>(
            DependencyObject src,
            DependencyObject dst,
            DependencyProperty property
        )
        {
            if (
            ...
            )
            {
                ...
                if (srcList.Count > 0)
                {
                    ...
                    {
                        throw new System.InvalidOperationException(
                            "Cannot copy to null destination collection"
                        );
                    }
        ...
        private static bool CopyValueTypeOrCloneableCollection(
            DependencyObject src,
            DependencyObject dst,
            DependencyProperty property
        )
        {
            ...
            if (
                ...
                && (
                    TypeRosetta.DoesTypeImplementGenericInterface(
                        property.PropertyType,
                        typeof(ICollection<>),
                        out interfaceType
                    )
            ...
            )
            {
                ...
                System.Collections.IList srcList =
                    src.GetValue(property) as System.Collections.IList;

                if (srcList.Count > 0)
                {
                    System.Collections.IList dstList =
                        dst.GetValue(property) as System.Collections.IList;
                    ...
                    if (dstList.IsReadOnly)
                    {
                        ...
                        {
                            throw new System.InvalidOperationException(
                                "Cannot copy to read only destination collection"
                            );
                        }
        ...
        protected Support.EventHandler GetUserEventHandler(string name)
        {
            ...
            if ((this.userEvents != null) && (this.userEvents.TryGetValue(name, out value)))
            {
        ...
        {
            BindingChangedEventHandler handler = this.GetUserEventHandler<BindingChangedEventArgs>(
                DependencyObject.BindingChangedString
            );
        ...
        {
            System.Type sysType = this.GetType();
            Serialization.BlackList blackList = Serialization.BlackList.GetSerializationBlackList(
                this
            );
            ...
            foreach (PropertyValuePair pair in this.DefinedEntries)
            {
                ...
                if (
                    (property.IsReadWrite && metadata.CanSerializeReadWrite)
            ...
            lock (DependencyObject.declarations)
            {
                ...
                if (property.IsAttached == false)
                {
                    ...
                    while (t != typeof(object))
                    {
                        ...
                        {
                            if (
                                (typeDeclaration.ContainsKey(name))
                                && (typeDeclaration[name].IsAttached == false)
                            )
                            {
                                throw new System.ArgumentException(
                                    string.Format(
                                        "DependencyProperty named '{0}' already exists for type {1} (defined by {2})",
                                        name,
                                        ownerType,
                                        t
                                    )
        ...
        void IInheritedPropertyCache.ClearValues(
        ...
        void IInheritedPropertyCache.SetValues(
            DependencyObject node,
            IEnumerable<PropertyValuePair> propertyValues
        )
        {
        ...
        bool IInheritedPropertyCache.TryGetValue(
            DependencyObject node,
            DependencyProperty property,
            out object value
        )
        ...
        void IInheritedPropertyCache.InheritValuesFromParent(
            DependencyObject node,
        ...
        void IStructuredData.AttachListener(
            string id,
        ...
        )
        {
            ...
            {
                throw new System.ArgumentException(
                    string.Format("Identifier '{0}' cannot map to DependencyProperty", id)
                );
            }
        ...
        void IStructuredData.DetachListener(
            string id,
            Epsitec.Common.Support.EventHandler<DependencyPropertyChangedEventArgs> handler
        )
        {
        ...
        void IValueStore.SetValue(string id, object value, ValueStoreSetMode mode)
        {
            ...
            {
                throw new System.ArgumentException(
                    string.Format("Identifier '{0}' cannot be mapped to a DependencyProperty", id)
                );
            }
        ...
        private class PropertyChangedEventDictionary
            : Dictionary<DependencyProperty, PropertyChangedEventHandler> { }
        #endregion
        ...
        private class BindingExpressionDictionary
            : Dictionary<DependencyProperty, BindingExpression> { }
        #endregion

        public event BindingChangedEventHandler BindingChanged
        {
            add { this.AddUserEventHandler(DependencyObject.BindingChangedString, value); }
            remove { this.RemoveUserEventHandler(DependencyObject.BindingChangedString, value); }
        }
        ...
        static Dictionary<System.Type, TypeDeclaration> declarations =
            new Dictionary<System.Type, TypeDeclaration>();
