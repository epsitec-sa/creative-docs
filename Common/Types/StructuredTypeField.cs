    ...
    public class StructuredTypeField
    {
        ...
        private StructuredTypeField(
            ...
            : this(
                ...
                rank,
                (FieldRelation)(
                    (flags >> StructuredTypeField.RelationShift) & StructuredTypeField.RelationMask
                ),
                (FieldMembership)(
                    (flags >> StructuredTypeField.MembershipShift)
                    & StructuredTypeField.MembershipMask
                ),
                (FieldSource)(
                    (flags >> StructuredTypeField.SourceShift) & StructuredTypeField.SourceMask
                ),
                (FieldOptions)(
                    (flags >> StructuredTypeField.OptionsShift) & StructuredTypeField.OptionsMask
                ),
                expression
            ) { }
        ...
        {
            get { return (this.Options & FieldOptions.Nullable) != 0; }
        }
        ...
        public bool IsSharedRelation
        {
            get
            {
                return (this.relation != FieldRelation.None)
                    && ((this.options & FieldOptions.PrivateRelation) == 0);
            }
        }
        ...
        {
            StructuredTypeField copy = new StructuredTypeField(
                this.id,
                null,
                this.captionId,
                this.rank,
        ...
        private int Flags
        {
            get
            {
                ...
                flags |=
                    (StructuredTypeField.RelationMask & (int)this.relation)
                    << StructuredTypeField.RelationShift;
                flags |=
                    (StructuredTypeField.MembershipMask & (int)this.membership)
                    << StructuredTypeField.MembershipShift;
                flags |=
                    (StructuredTypeField.SourceMask & (int)this.source)
                    << StructuredTypeField.SourceShift;
                flags |=
                    (StructuredTypeField.OptionsMask & (int)this.options)
                    << StructuredTypeField.OptionsShift;
        ...
        {
            if ((abstractType != null) && (abstractType != this.type))
            {
                if (this.type != null)
                {
                ...
                switch (this.relation)
                {
                    ...
                    case FieldRelation.Reference:
                        if (structType == null)
                        {
                            throw new System.ArgumentException(
                                string.Format(
                                    "Invalid type {0} in relation {1} for field {2}",
                                    abstractType.Name,
                                    this.relation,
                                    this.id
                                )
                    ...
                    default:
                        throw new System.ArgumentException(
                            string.Format(
                                "Invalid relation {0} for field {1}",
                                this.relation,
                                this.id
                            )
                        );
        ...
        public sealed class SerializationConverter : ISerializationConverter
        {
            ...
            public string ConvertToString(object value, IContextResolver context)
            {
                ...
                string rank =
                    field.rank == -1
                        ? ""
                        : field.rank.ToString(System.Globalization.CultureInfo.InvariantCulture);
                string flags =
                    field.Flags == 0
                        ? ""
                        : field.Flags.ToString(System.Globalization.CultureInfo.InvariantCulture);
            ...
            public object ConvertFromString(string value, IContextResolver context)
            {
                ...
                string rank =
                    args.Length < 3
                        ...
                        : string.IsNullOrEmpty(args[2])
                            ...
                            : args[2];
                Support.Druid captionId =
                    args.Length < 4 ? Support.Druid.Empty : Support.Druid.Parse(args[3]);
                ...
                int rankValue = System.Int32.Parse(
                    rank,
                    System.Globalization.CultureInfo.InvariantCulture
                );
                int flagsValue = System.Int32.Parse(
                    flags,
                    System.Globalization.CultureInfo.InvariantCulture
                );
        ...
        private class AlwaysNullableType : INullableType
        {
            ...
            {
                if ((parent != null) && (parent.IsNullable))
                {
                    this.parent = parent;
                }
            }
            ...
            public bool IsNullValue(object value)
            {
                ...
                if ((this.parent != null) && (this.parent.IsNullValue(value)))
                {
                    return true;
                }
