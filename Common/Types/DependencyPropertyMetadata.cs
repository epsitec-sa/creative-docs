...
namespace Epsitec.Common.Types
{
    ...
    public class DependencyPropertyMetadata : ICaption
    {
        ...
        {
            get { return this.canSerializeReadOnly; }
            set { this.canSerializeReadOnly = value; }
        }
        public bool CanSerializeReadWrite
        {
            get { return this.canSerializeReadWrite; }
            set { this.canSerializeReadWrite = value; }
        }
        ...
        public virtual IEnumerable<DependencyObject> FilterSerializableCollection(
            IEnumerable<DependencyObject> collection
        )
        {
        ...
        protected virtual DependencyPropertyMetadata CloneCopyToNewObject(
            DependencyPropertyMetadata copy
        )
        {
        ...
        internal bool NotifyPropertyInvalidated(
        ...
        protected virtual void OnPropertyInvalidated(
            DependencyObject sender,
            object oldValue,
            object newValue
        )
        ...
        protected IEnumerable<DependencyObject> ReallyFilterSerializableCollection(
            IEnumerable<DependencyObject> collection
        )
        {
