...
namespace Epsitec.Common.Types
{
    ...
    public sealed class DependencyObjectType : IStructuredType, IStructuredTypeProvider
    {
        ...
        {
            get { return this.systemType.IsAbstract && this.systemType.IsSealed; }
        }
        ...
        public bool IsSubclassOf(DependencyObjectType type)
        {
            ...
            if ((baseType != null) && (baseType.IsSubclassOf(type)))
            {
                return true;
            }
        ...
        public DependencyObject CreateEmptyObject()
        {
            if (this.allocator == null)
            {
                lock (this)
                {
                    ...
                    {
                        this.allocator =
                            Support.DynamicCodeFactory.CreateAllocator<DependencyObject>(
                                this.systemType
                            );
                    }
                }
        ...
        private void BuildPropertyList()
        {
            lock (this)
            {
                if (this.standardPropertiesArray == null)
                {
                    ...
                    DependencyProperty[] allProperties = new DependencyProperty[
                        baseProperties.Count + this.localStandardProperties.Count
                    ];
                    ...
                    this.lookup = new Dictionary<string, DependencyProperty>(
                        this.standardPropertiesArray.Length
                    );
        ...
        {
            System.Reflection.FieldInfo[] infos = this.systemType.GetFields(
        ...
        {
            get { return DependencyObjectType.typeStaticConstructorExecuting > 0; }
        }
        ...
        private static DependencyObjectType FromSystemTypeLocked(System.Type systemType)
        {
            ...
            {
                DependencyObjectType baseType = DependencyObjectType.FromSystemTypeLocked(
                    systemType.BaseType
                );
        ...
        private static readonly Dictionary<System.Type, DependencyObjectType> types =
            new Dictionary<System.Type, DependencyObjectType>();
