...
namespace Epsitec.Common.Types
{
    ...
    public class DataSource : IStructuredType, IStructuredData, IStructuredTypeProvider
    {
        ...
        public void AddDataSource(string id, IStructuredData source, Druid captionId)
        {
            if (this.Contains(id))
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot insert duplicate data source with identifier '{0}'", id)
                );
            }
        ...
        public void SetDataSource(string id, IStructuredData source)
        {
            ...
            else
            {
                ...
                if (model.Handlers != null)
                {
                    model.Handlers(
                        this,
                        new DependencyPropertyChangedEventArgs(id, model.Data, source)
                    );
                }
            }
        }
        ...
        )
        {
            ...
            if (index < 0)
            {
                throw new System.ArgumentException(
                    string.Format("Identifier '{0}' cannot be resolved", id)
                );
            }
            ...
            handlers =
                (EventHandler<DependencyPropertyChangedEventArgs>)
                    System.Delegate.Combine(handlers, handler);

            this.items[index] = new ItemRecord(
                model.FieldId,
                model.Data,
                model.CaptionId,
                handlers
        ...
        )
        {
            ...
            handlers =
                (EventHandler<DependencyPropertyChangedEventArgs>)
                    System.Delegate.Remove(handlers, handler);
        ...
        {
            throw new System.InvalidOperationException(
                "You cannot modify a DataSource with SetValue"
            );
        }
        ...
        protected struct ItemRecord
        {
            ...
            public ItemRecord(
                ...
                Druid captionId,
                EventHandler<DependencyPropertyChangedEventArgs> handlers
            )
            {
                this.data = data;
                this.fieldId = id;
            ...
            public bool IsEmpty
            {
                get { return (this.data == null) && (this.fieldId == null); }
            }
