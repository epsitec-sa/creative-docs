...
namespace Epsitec.Common.Types
{
    ...
    public abstract class AbstractDateTimeType : AbstractType
    {
        ...
        public TimeResolution Resolution
        {
            get
            {
                return (TimeResolution)
                    this.Caption.GetValue(AbstractDateTimeType.ResolutionProperty);
            }
        }
        ...
        {
            get { return (Date)this.Caption.GetValue(AbstractDateTimeType.MinimumDateProperty); }
        }
        ...
        {
            get { return (Date)this.Caption.GetValue(AbstractDateTimeType.MaximumDateProperty); }
        }
        ...
        {
            get { return (Time)this.Caption.GetValue(AbstractDateTimeType.MinimumTimeProperty); }
        }
        ...
        {
            get { return (Time)this.Caption.GetValue(AbstractDateTimeType.MaximumTimeProperty); }
        }
        ...
        public System.TimeSpan TimeStep
        {
            get
            {
                return (System.TimeSpan)
                    this.Caption.GetValue(AbstractDateTimeType.TimeStepProperty);
            }
        }
        ...
        {
            get { return (DateSpan)this.Caption.GetValue(AbstractDateTimeType.DateStepProperty); }
        }
        ...
        public static readonly DependencyProperty ResolutionProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(AbstractDateTimeType),
                new DependencyPropertyMetadata(TimeResolution.Default)
            );
        public static readonly DependencyProperty MinimumDateProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(Date),
                typeof(AbstractDateTimeType),
                new DependencyPropertyMetadata(Date.Null)
            );
        ...
        public static readonly DependencyProperty MinimumTimeProperty =
            DependencyProperty.RegisterAttached(
                "MinTime",
                typeof(Time),
                typeof(AbstractDateTimeType),
                new DependencyPropertyMetadata(Time.Null)
            );
        ...
        public static readonly DependencyProperty TimeStepProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(AbstractDateTimeType),
                new DependencyPropertyMetadata(new System.TimeSpan(0, 0, 1))
            );
        public static readonly DependencyProperty DateStepProperty =
            DependencyProperty.RegisterAttached(
                "DateStep",
                typeof(DateSpan),
                typeof(AbstractDateTimeType),
                new DependencyPropertyMetadata(new DateSpan(1))
            );
    }
}
