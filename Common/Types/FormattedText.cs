...
namespace Epsitec.Common.Types
{
    ...
    public struct FormattedText
        : System.IEquatable<FormattedText>,
            System.IComparable<FormattedText>
    {
        /// <summary>
        ...
        public FormattedText ApplyFontSize(double size)
        {
            return this.ApplyElement(
                string.Concat("<font size=\"", InvariantConverter.ToString(size), "\">"),
                "</font>"
            );
        }
        ...
        {
            return this.ApplyElement(
                string.Concat("<font color=\"#", Drawing.Color.ToHexa(color), "\">"),
                "</font>"
            );
        }
        ...
        )
        {
            ...
            else
            {
                return new FormattedText(
                    this.text.Replace(pattern.text, replacement.text, comparison)
                );
            }
        }
        ...
        public static FormattedText[] Split(
            FormattedText text,
            string separator,
            System.StringSplitOptions options = System.StringSplitOptions.None
        )
        ...
        public static string CastToString(object value)
        {
            ...
            throw new System.InvalidCastException(
                string.Format("Cannot cast value from {0} to string", value.GetType().Name)
            );
        }
