...
namespace Epsitec.Common.Types
{
    ...
    public struct Date : System.IComparable, INullable, System.IEquatable<Date>, System.IFormattable
    {
        public Date(System.DateTime dateTime)
        {
            ...
            {
                this.days =
                    ((int)(dateTimeTicks / Time.TicksPerDay) << 4)
                    | Date.FlagDayDefined
                    | Date.FlagMonthDefined
                    | Date.FlagYearDefined;
            }
        }
        ...
        public int Day
        {
            get { return this.HasDay ? this.InternalDate.Day : 0; }
        }
        ...
        public int Month
        {
            get { return this.HasMonth ? this.InternalDate.Month : 0; }
        }

        public int Year
        {
            get { return this.HasYear ? this.InternalDate.Year : 0; }
        }

        public long Ticks
        {
            get { return this.InternalDays * Time.TicksPerDay; }
        }

        public bool HasDay
        {
            get { return (this.days & Date.FlagDayDefined) != 0; }
        }

        public bool HasMonth
        {
            get { return (this.days & Date.FlagMonthDefined) != 0; }
        }

        public bool HasYear
        {
            get { return (this.days & Date.FlagYearDefined) != 0; }
        }
        ...
        private System.DateTime InternalDate
        {
            get
            {
                return new System.DateTime(
                    this.InternalDays * Time.TicksPerDay,
