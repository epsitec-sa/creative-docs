...
namespace Epsitec.Common.Types
{
    ...
    public sealed class Caption : DependencyObject, ILabelGetter
    {
        ...
        public Caption(Support.Druid id)
            : this()
        {
            this.id = id;
        }
        ...
        {
            get { return this.labels == null ? false : (this.labels.Count > 0); }
        }
        ...
        public bool HasIcon
        {
            get
            {
                return this.ContainsValue(Caption.IconProperty) && !string.IsNullOrEmpty(this.Icon);
            }
        }
        ...
        public IList<string> Labels
        {
            get
            {
                if (this.labels == null)
                {
                    this.labels = new Collections.HostedList<string>(
                        this.HandleLabelInsertion,
                        this.HandleLabelRemoval
                    );
                }
        ...
        {
            get { return (string)this.GetValue(Caption.DescriptionProperty); }
            set { this.SetValue(Caption.DescriptionProperty, value); }
        }
        ...
        public string Name
        {
            get { return (string)this.GetValue(Caption.NameProperty); }
            set
            {
                if (value == null)
                {
        ...
        public string Icon
        {
            get { return (string)this.GetValue(Caption.IconProperty); }
            set
            {
                if (value == null)
                {
        ...
        public string SerializeToString()
        {
            ...
            using (Serialization.Context context = new Serialization.SerializerContext(writer))
            {
                ...
                if (visitor.RequiresRichSerialization)
                {
                    ...
                    return Caption.CompressXml(
                        Serialization.SimpleSerialization.SerializeToString(this)
                    );
                }
                else
                {
                    ...
                    string typeElementPrefix = string.Concat(
                        @"<",
                        Serialization.IO.Xml.StructurePrefix,
                        @":type "
                    );
                    string dataElementPrefix = string.Concat(
                        @"<",
                        Serialization.IO.Xml.StructurePrefix,
                        @":data "
                    );
                    ...
                    return Caption.CompressXml(
                        xml.Substring(startElementPos, endElementPos - startElementPos)
                    );
                }
            }
        }
        ...
        public void DeserializeFromString(string value, Support.ResourceManager manager)
        {
            ...
            if (value.StartsWith("<" + Serialization.SimpleSerialization.RootElementName))
            {
                ...
                Caption caption =
                    Serialization.SimpleSerialization.DeserializeFromString(value, manager)
                    as Caption;
        ...
        public static string CompressXml(string xml)
        {
            ...
            xml = xml.Replace(
                @"s:name=""Epsitec.Common.Types.AbstractNumericType""",
                @"s:name=""*aNT"""
            );
            xml = xml.Replace(
                @"s:name=""Epsitec.Common.Types.AbstractDateTimeType""",
                @"s:name=""*aDTT"""
            );
            ...
            xml = xml.Replace(
                @"xmlns:s=""http://www.epsitec.ch/XNS/storage-structure-1""",
                @"xmlns:s=""*1"""
            );
            xml = xml.Replace(
                @"xmlns:f=""http://www.epsitec.ch/XNS/storage-fields-1""",
                @"xmlns:f=""*1"""
            );
            xml = xml.Replace(
                @"SystemType=""E:Epsitec.Common.Types.NotAnEnum, Common""",
                @"SystemType=""*NaE"""
            );
        ...
        private class Visitor : Serialization.IVisitor
        {
            ...
            {
                get { return this.requiresRichSerialization; }
            }

            #region IVisitor Members

            void Serialization.IVisitor.VisitNodeBegin(
            ...
            void Serialization.IVisitor.VisitNodeEnd(
                Serialization.Context context,
                DependencyObject obj
            )
            {
            ...
            void Serialization.IVisitor.VisitAttached(
                Serialization.Context context,
                System.Type type
            )
            {
            ...
            switch (detailLevel)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("{0} not supported", detailLevel.GetQualifiedName())
                    );
            }
        }
        ...
        public static readonly DependencyProperty NameProperty = DependencyProperty.Register(
            ...
            typeof(string),
            typeof(Caption),
            Caption.CaptionMetadataInstance
        );
        public static readonly DependencyProperty LabelsProperty =
            DependencyProperty.RegisterReadOnly(
                ...
                new DependencyPropertyMetadata(
                    Caption.GetLabelsValue,
                    Caption.NotifyLabelsChanged
