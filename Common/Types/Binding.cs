...
namespace Epsitec.Common.Types
{
    ...
    public class Binding : AbstractBinding
    {
        ...
        public Binding(object source)
            : this(BindingMode.TwoWay, source) { }

        public Binding(object source, string path)
            : this(BindingMode.TwoWay, source, path) { }
        ...
        {
            get { return this.sourceState == SourceState.Attached; }
        }
#if false
		/// <summary>
        ...
        {
            get { return this.converterCulture; }
            set { this.converterCulture = value; }
        }
            ...
            switch (mode)
            {
                ...
                default:
                    throw new System.ArgumentOutOfRangeException(
                        string.Format("BindingMode.{0} not supported", mode)
                    );
            }
        }
            ...
            if (type != null)
            {
                if ((value == null) || (value.GetType() != type))
                {
                    IValueConverter converter =
                        this.converter ?? Converters.AutomaticValueConverter.Instance;
            ...
            lock (this)
            {
                switch (this.boundExpressionsType)
                {
                    ...
                    case BoundExpressions.Several:
                        ...
                        {
                            Weak<BindingExpression>[] copy = new Weak<BindingExpression>[
        ...
        protected override void AddExpression(BindingExpression expression)
        {
            ...
            lock (this)
            {
                switch (this.boundExpressionsType)
                {
                    ...
                    case BoundExpressions.Single:
                        this.boundExpressions = new Weak<BindingExpression>[2]
                        {
                            (Weak<BindingExpression>)this.boundExpressions,
                            new Weak<BindingExpression>(expression)
                        };
                        this.boundExpressionsType = BoundExpressions.Several;
                        break;
        ...
        protected override void AttachAfterChanges()
        {
            ...
            else if (this.sourceState == SourceState.AsyncAttaching)
            {
                System.Diagnostics.Debug.Fail(
                    "Attaching while previous asynchronous attach is still running"
                );
            }
        }
