...
namespace Epsitec.Common.Types
{
            ...
            INullableType
    {
        ...
        {
            get { return (string)this.Caption.GetValue(AbstractType.DefaultControllerProperty); }
        }
        ...
        public string DefaultControllerParameters
        {
            ...
            {
                return (string)
                    this.Caption.GetValue(AbstractType.DefaultControllerParametersProperty);
            }
        }
        ...
        {
            get { return (bool)this.Caption.GetValue(AbstractType.IsNullableProperty); }
        }
        ...
        {
            get { return AbstractType.GetDefaultValue(this.Caption); }
        }
        ...
        {
            get { return AbstractType.GetSampleValue(this.Caption); }
        }
        ...
        public void DefineDefaultController(string controller, string controllerParameter)
        {
            ...
            if (this.DefaultControllerParameters != controllerParameter)
            {
                this.Caption.SetValue(
                    AbstractType.DefaultControllerParametersProperty,
                    controllerParameter
                );
            }
        }
        ...
        protected override void OnCaptionDefined()
        {
            ...
            if ((caption != null) && (this.SystemType != null))
            {
        ...
        public static string GetSystemTypeNameFromSystemType(System.Type type)
        {
            ...
            throw new System.ArgumentException(
                string.Format("Type {0} has an unsupported name", name)
            );
        }
        ...
        public static System.Type GetSystemTypeFromSystemTypeName(string name)
        {
            ...
            switch (prefix)
            {
                ...
                default:
                    throw new System.ArgumentException(
                        string.Format("Type {0} has wrong prefix ({1})", name, prefix)
                    );
            }
        ...
        public static SystemTypeFamily GetSystemTypeFamilyFromSystemTypeName(string name)
        {
            ...
            {
                case "E:":
                    return SystemTypeFamily.Enum;
                case "C:":
                    return SystemTypeFamily.Class;
                case "V:":
                    return SystemTypeFamily.ValueType;
                case "I:":
                    return SystemTypeFamily.Interface;
            }
        ...
        public static void SetSystemType(Caption caption, System.Type type)
        {
            ...
            {
                AbstractType.SetSystemType(
                    caption,
                    AbstractType.GetSystemTypeNameFromSystemType(type)
                );
            }
        }
        ...
        public static void BindComplexTypeToCaption(Caption caption)
        {
            ...
            if ((type != null) && (type.IsCaptionDefined == false) && (caption.Id.IsValid))
            {
        ...
        public static readonly DependencyProperty DefaultControllerProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(string),
                typeof(AbstractType),
                new DependencyPropertyMetadata("Numeric")
            );
        public static readonly DependencyProperty DefaultControllerParametersProperty =
            DependencyProperty.RegisterAttached(
        ...
        public static readonly DependencyProperty SytemTypeProperty =
            DependencyProperty.RegisterAttached("SystemType", typeof(string), typeof(AbstractType));
        public static readonly DependencyProperty CachedTypeProperty =
            DependencyProperty.RegisterAttached(
                "CachedType",
                typeof(AbstractType),
                typeof(AbstractType),
        ...
        public static readonly DependencyProperty ComplexTypeProperty =
            DependencyProperty.RegisterAttached(
                "ComplexType",
                typeof(AbstractType),
                typeof(AbstractType)
