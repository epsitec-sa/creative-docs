...
namespace Epsitec.Common.Types
{
    ...
    public class CollectionChangedEventArgs : System.EventArgs
    {
        ...
        {
            get { return this.newStartingIndex - 1; }
        }
        ...
        {
            get { return this.oldStartingIndex - 1; }
        }
            ...
            switch (this.action)
            {
                ...
                case CollectionChangedAction.Replace:
                    return string.Format(
                        ...
                        this.GetCountSuffix(this.NewItems)
                    );
                ...
                case CollectionChangedAction.Remove:
                    return string.Format(
                        "{0} at {1}{2}",
                        this.action,
                        this.OldStartingIndex,
                        this.GetCountSuffix(this.OldItems)
                    );
        ...
        public static CollectionChangedEventArgs Merge(
            CollectionChangedEventArgs a,
