...
namespace Epsitec.Common.Types.Internal
{
    ...
    public class CollectionViewResolver
    {
        ...
        private class Context
        {
            ...
            {
                get { return this.binding == null ? null : this.binding.Target; }
                set { this.binding = value == null ? null : new Weak<Binding>(value); }
            }
            ...
            public ViewDef GetViewDef(object collection, bool autoCreate)
            {
                lock (this.exclusion)
                {
                    ...
                    if ((index < 0) && (autoCreate))
                    {
                        ...
                        viewDef = new ViewDef(
                            collection,
                            CollectionViewResolver.CreateCollectionView(collection)
                        );
