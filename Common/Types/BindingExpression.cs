...
namespace Epsitec.Common.Types
{
    ...
    public sealed class BindingExpression : System.IDisposable
    {
        ...
        public INamedType GetSourceNamedType()
        {
            ...
            switch (this.sourceType)
            {
                case DataSourceType.PropertyObject:
                    namedType = BindingExpression.GetSourceNamedType(
                        this.sourceObject as DependencyObject,
                        this.sourceProperty as DependencyProperty
                    );
                    break;
        ...
        public Support.Druid GetSourceCaptionId()
        {
            ...
            {
                case DataSourceType.PropertyObject:
                    captionId = BindingExpression.GetSourceCaptionId(
                        this.sourceObject as DependencyObject,
                        this.sourceProperty as DependencyProperty
                    );
                    break;
                ...
                case DataSourceType.StructuredData:
                    captionId = BindingExpression.GetSourceCaptionId(
                        (IStructuredData)this.sourceObject,
                        (string)this.sourceProperty
                    );
                    break;
                case DataSourceType.SourceItself:
                case DataSourceType.Resource:
        ...
        public object GetSourceTypeObject()
        {
            ...
            switch (this.sourceType)
            {
                ...
                case DataSourceType.StructuredData:
                    typeObject = BindingExpression.GetTypeObjectFromStructuredData(
                        (IStructuredData)this.sourceObject,
                        (string)this.sourceProperty
                    );
                    break;
                ...
                case DataSourceType.Resource:
                    if (this.sourceObject != null)
                    {
                        ...
                        typeObject = TypeRosetta.GetTypeObjectFromValue(
                            resource.GetValue((string)this.sourceProperty)
                        );
                    }
                    break;
            }
        ...
        public object ConvertValue(object value)
        {
            ...
            if (
                (this.binding.Mode == BindingMode.OneTime)
        ...
        public object ConvertBackValue(object value)
        {
            ...
            switch (this.sourceType)
            {
                ...
                case DataSourceType.StructuredData:
                    type = BindingExpression.GetSystemTypeFromStructuredData(
                        this.sourceObject as IStructuredData,
                        (string)this.sourceProperty
                    );
                    break;
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Cannot convert back to source type {0}", this.sourceType)
                    );
            }
        ...
        internal static BindingExpression BindToTarget(
        ...
        private bool FindDataSource(
            out object objectSource,
            out object objectProperty,
            out DataSourceType type,
            out BindingBreadcrumbs breadcrumbs
        )
        {
            ...
            if ((root == null) || (root == Binding.DoNothing))
            {
                return false;
            }
            ...
            else
            {
                ...
                if ((doSource == null) && (sdSource == null) && (cvSource == null))
                {
                ...
                else
                {
                    ...
                    for (int i = 0; i < elements.Length; i++)
                    {
                        ...
                        if (elements[i] == "*")
                        {
                            if ((doSource != null) || (cvSource != null))
                            {
                            ...
                            if (sdSource != null)
                            {
                                ...
                                if (
                                    (UnknownValue.IsUnknownValue(star))
                        ...
                        if (cvSource != null)
                        {
                            ...
                            System.Diagnostics.Debug.Assert(
                                cvSource == null,
                                "CollectionView.CollectionView not accepted here"
                            );
                        }
        ...
        private void AddBreadcrumb(
            ref BindingBreadcrumbs breadcrumbs,
        ...
        private void ClearDataContext()
        {
            ...
            {
                this.targetObject.RemoveEventHandler(
                    DataObject.DataContextProperty,
                    this.HandleDataContextChanged
                );
        ...
        private void SetDataContext(Binding value)
        {
            ...
            {
                this.targetObject.AddEventHandler(
                    DataObject.DataContextProperty,
                    this.HandleDataContextChanged
                );
        ...
        private static System.Type GetSystemTypeFromStructuredData(
            IStructuredData source,
            string fieldId
        )
        {
        ...
        private static object GetTypeObjectFromStructuredData(
            IStructuredData source,
            string fieldId
        )
        {
            ...
            switch (this.sourceType)
            {
                case DataSourceType.PropertyObject:
                    BindingExpression.Attach(
                        this,
                        this.sourceObject as DependencyObject,
                        (DependencyProperty)this.sourceProperty
                    );
                    break;
                case DataSourceType.StructuredData:
                    BindingExpression.Attach(
        ...
        private void InternalAttachToTarget()
        {
            switch (this.binding.Mode)
            {
                ...
                case BindingMode.TwoWay:
                    this.targetObject.AddEventHandler(
                        this.targetPropery,
                        this.HandleTargetPropertyChanged
                    );
                    break;
            }
        }
        ...
        private void HandleSourcePropertyChanged(
            object sender,
        ...
        private void HandleTargetPropertyChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
            ...
            switch (this.sourceType)
            {
                ...
                default:
                    throw new System.NotImplementedException(
                        string.Format("DataSourceType {0} not implemented", this.sourceType)
                    );
            }
        ...
        private static INamedType GetSourceNamedType(
        ...
        private static Support.Druid GetSourceCaptionId(
            DependencyObject source,
            DependencyProperty property
        )
        {
        ...
        private static Support.Druid GetSourceCaptionId(IStructuredData source, string fieldId)
        {
            ...
            if ((typeProvider == null) || (fieldId == null))
            {
                return Support.Druid.Empty;
            }
