...
namespace Epsitec.Common.Types
{
    ...
    public class StructuredData
        : IStructuredTypeProvider,
            IStructuredData,
            System.IEquatable<StructuredData>
    {
        ...
        {
            get { return this.undefinedValueMode; }
            set { this.undefinedValueMode = value; }
        }
            ...
            get
            {
                ...
                foreach (Record record in this.values.Values)
                {
                    ...
                    System.Collections.ICollection collection =
                        record.Data as System.Collections.ICollection;
        ...
        public void AttachListener(string id, PropertyChangedEventHandler handler)
        {
            ...
            if (!this.CheckFieldIdValidity(id, out type))
            {
                throw new System.Collections.Generic.KeyNotFoundException(
                    string.Format(
                        "The value '{0}' does not exist; it is not defined by the structure",
                        id
                    )
                );
            }
            ...
            if (this.values == null)
            {
                throw new System.InvalidOperationException(
                    "Cannot attach a listener; no storage defined"
                );
            }
            ...
            if (this.values.TryGetValue(id, out record))
            {
                handler = (PropertyChangedEventHandler)
                    System.Delegate.Combine(record.Handler, handler);
                record = new Record(
                    record.Data,
                    record.OriginalData,
                    record.UsesOriginalData,
                    record.IsReadOnly,
                    handler
                );
            }
        ...
        public void DetachListener(string id, PropertyChangedEventHandler handler)
        {
            ...
            {
                handler = (PropertyChangedEventHandler)
                    System.Delegate.Remove(record.Handler, handler);
                record = new Record(
                    record.Data,
                    record.OriginalData,
                    record.UsesOriginalData,
                ...
                if (
                    (record.Data == UndefinedValue.Value)
        ...
        public void SetValue(string id, object value)
        {
            ...
            if (!this.CheckFieldIdValidity(id, out type))
            {
                throw new System.Collections.Generic.KeyNotFoundException(
                    string.Format(
                        "The value '{0}' cannot be set; it is not defined by the structure",
                        id
                    )
                );
            }
            ...
            if (UndefinedValue.IsUndefinedValue(value))
            {
                if (this.values != null)
                {
                    ...
                    if (this.values.TryGetValue(id, out record))
                    {
                        if ((record.IsReadOnly) && (!UndefinedValue.IsUndefinedValue(record.Data)))
                        {
                            throw new System.InvalidOperationException(
                                string.Format("Field {0} is read only", id)
                            );
                        }

                        handler = record.Handler;

                        if ((handler == null) && (record.OriginalData == UndefinedValue.Value))
                        {
                            this.values.Remove(id);
                        }
                        else
            ...
            else
            {
                if (!this.CheckValueValidity(type, value))
                {
                    System.Diagnostics.Debug.Fail(
                        string.Format("The value '{0}' has the wrong type or is not valid", id)
                    );
                ...
                {
                    throw new System.InvalidOperationException(
                        "Cannot set a value; no storage defined"
                    );
                }
                ...
                if (this.values.TryGetValue(id, out record))
                {
                    if ((record.IsReadOnly) && (!object.Equals(value, record.Data)))
                    {
                        throw new System.InvalidOperationException(
                            string.Format("Field {0} is read only", id)
                        );
        ...
        public bool Equals(StructuredData other)
        {
            ...
            if (
                Collection.CompareEqual(
                    ...
                    other.GetKeyValuePairs(),
                    delegate(
                        KeyValuePair<string, object> value1,
                        KeyValuePair<string, object> value2
                    )
                    {
        ...
        public void SilentlyCopyValueFrom(string id, StructuredData source)
        {
            ...
            if ((source.values != null) && (source.values.TryGetValue(id, out srcRecord)))
            {
                if (this.values.TryGetValue(id, out dstRecord))
                {
                    this.values[id] = new Record(
                        srcRecord.Data,
                        srcRecord.OriginalData,
                        srcRecord.UsesOriginalData,
                        srcRecord.IsReadOnly,
                        dstRecord.Handler
                    );
                }
                else
        ...
        public bool LockValue(string id)
        {
            ...
            if ((this.values != null) && (this.values.TryGetValue(id, out record)))
            {
                if ((!UndefinedValue.IsUndefinedValue(record.Data)) && (record.IsReadOnly == false))
                {
                    this.values[id] = new Record(
                        record.Data,
                        record.OriginalData,
        ...
        public bool UnlockValue(string id)
        {
            ...
            if ((this.values != null) && (this.values.TryGetValue(id, out record)))
            {
                if ((!UndefinedValue.IsUndefinedValue(record.Data)) && (record.IsReadOnly))
                {
                    this.values[id] = new Record(
                        record.Data,
                        record.OriginalData,
                ...
                switch (this.undefinedValueMode)
                {
                    ...
                    default:
                        throw new System.NotSupportedException(
                            string.Format("Mode {0} not supported", this.undefinedValueMode)
                        );
                }
        ...
        {
            this.values = new Collections.HostedDictionary<string, Record>(
        ...
        protected struct Record
        {
            ...
            public object Data
            {
                get { return this.usesOriginalData ? this.originalData : this.data; }
            }
            ...
            {
                get { return this.usesOriginalData; }
            }
