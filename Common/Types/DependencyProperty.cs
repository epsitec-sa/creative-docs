...
namespace Epsitec.Common.Types
{
    ...
    public sealed class DependencyProperty
        : System.IEquatable<DependencyProperty>,
            System.IComparable<DependencyProperty>,
            IDataConstraint,
            IName
    {
        ...
        )
        {
            ...
            if (DependencyProperty.validNameRegex.IsMatch(name) == false)
            {
                throw new System.ArgumentException(
                    string.Format("'{0}' is not a valid property name", name)
                );
            }
            ...
            this.isPropertyAnICollectionOfDependencyObject = TypeRosetta.DoesTypeImplementInterface(
                this.propertyType,
                typeof(ICollection<DependencyObject>)
            );
            this.isPropertyAnICollectionOfString = TypeRosetta.DoesTypeImplementInterface(
                this.propertyType,
                typeof(ICollection<string>)
            );
            this.isPropertyAnICollectionOfAny = TypeRosetta.DoesTypeImplementGenericInterface(
                this.propertyType,
                typeof(ICollection<>)
            );

            if (
                (this.isPropertyAnICollectionOfDependencyObject == false)
            ...
            )
            {
                ...
                )
                {
                    throw new System.ArgumentException(
                        string.Format(
                            "Property {0} uses unsupported collection type {1}",
                            name,
            ...
            if ((this.defaultMetadata.InheritsValue) && (this.propertyType == typeof(bool)))
            {
                ...
                {
                    if (
                        DependencyProperty.bitsetBasedCachedInheritedPropertyCount
                        < DependencyProperty.bitsetBasedCachedInheritedProperties.Length
                    )
                    {
        ...
        {
            get { return this.defaultMetadata; }
        }
        ...
        {
            get { return this.isPropertyDerivedFromDependencyObject; }
        }

        public bool IsPropertyTypeAnICollectionOfDependencyObject
        {
            get { return this.isPropertyAnICollectionOfDependencyObject; }
        }

        public bool IsPropertyTypeAnICollectionOfString
        {
            get { return this.isPropertyAnICollectionOfString; }
        }

        public bool IsPropertyTypeAnICollectionOfAny
        {
            get { return this.isPropertyAnICollectionOfAny; }
        }
        ...
        {
            get { return this.inheritedPropertyCacheMask; }
        }
        ...
        public DependencyProperty AddOwner(System.Type ownerType)
        {
            if (this.IsAttached)
            {
                throw new System.InvalidOperationException(
                    string.Format(
                        "Attached property {0} does not accept owner {1}",
                        this.Name,
                        ownerType
                    )
                );
            ...
            if (this.additionalOwnerTypes.Contains(ownerType))
            {
                throw new System.ArgumentException(
                    string.Format(
                        "DependencyProperty named {0} already has owner {1}",
                        this.Name,
                        ownerType
                    )
                );
        ...
        internal void AddDerivedType(System.Type derivedType)
        {
            ...
            {
                if (
                    (this.overriddenMetadata.ContainsKey(baseType))
        ...
        public static Collections.ReadOnlyList<DependencyProperty> GetAllAttachedProperties()
        {
            if (DependencyProperty.attachedPropertiesArray == null)
            {
                lock (DependencyProperty.exclusion)
                {
                    if (DependencyProperty.attachedPropertiesArray == null)
                    {
                        DependencyProperty.attachedPropertiesArray =
                            DependencyProperty.attachedPropertiesList.ToArray();
                    }
                }
            }

            return new Collections.ReadOnlyList<DependencyProperty>(
                DependencyProperty.attachedPropertiesArray
            );
        }
        ...
        public void OverrideMetadata(System.Type type, DependencyPropertyMetadata metadata)
        {
            ...
            if (this.overriddenMetadata == null)
            {
                lock (this)
                {
                    if (this.overriddenMetadata == null)
                    {
                        this.overriddenMetadata =
                            new Dictionary<System.Type, DependencyPropertyMetadata>();
                    }
                }
            }
        ...
        {
            if ((this.captionId == captionId) || (this.captionId.IsEmpty))
            {
            ...
            if (this.typeConverterOk == false)
            {
                lock (this)
                {
                    if (this.typeConverterOk == false)
                    {
                        ...
                        {
                            converter =
                                Serialization.DependencyClassManager.Current.FindSerializationConverter(
                                    this.propertyType
                                );
                        ...
                        if (this.typeConverter == null)
                        {
                            this.typeConverter = InvariantConverter.GetSerializationConverter(
                                this.propertyType
                            );
                        }
        ...
        public static DependencyProperty RegisterReadOnly(
            string name,
            System.Type propertyType,
            System.Type ownerType
        )
        ...
        {
            DependencyProperty.validNameRegex = new System.Text.RegularExpressions.Regex(
                "^[a-zA-Z][_a-zA-Z0-9]*$"
            );
        }
        ...
        private static readonly List<DependencyProperty> attachedPropertiesList =
        ...
        private static readonly DependencyProperty[] bitsetBasedCachedInheritedProperties =
            new DependencyProperty[InheritedPropertyCache.MaskBits];
