...
namespace Epsitec.Common.Types
{
    ...
    public class StructuredType
        : AbstractType,
            ...
            Serialization.IDeserialization
    {
        /// <summary>
        ...
        public StructuredType()
            : base("Structure")
        {
            this.fields = new Collections.HostedStructuredTypeFieldDictionary(
                this.NotifyFieldInsertion,
                this.NotifyFieldRemoval
            );
        }
            ...
            : this(@class)
        {
            ...
            if ((this.Class == StructuredTypeClass.Interface) && (baseTypeId.IsValid))
            {
        ...
        {
            get { return TypeCode.Structured; }
        }
        ...
        {
            get { return (StructuredTypeClass)this.GetValue(StructuredType.ClassProperty); }
        }
        ...
        public IList<Druid> InterfaceIds
        {
            get
            {
                ...
                {
                    this.interfaces = new Collections.HostedList<Druid>(
                        this.HandleInterfaceInsertion,
                        this.HandleInterfaceRemoval
                    );
                }
        ...
        {
            get { return this.GetType(this.BaseTypeId, true); }
        }
        ...
        {
            get { return (string)this.GetValue(StructuredType.SerializedDesignerLayoutsProperty); }
            set { this.SetValue(StructuredType.SerializedDesignerLayoutsProperty, value); }
        }
        ...
        void Serialization.ISerialization.NotifySerializationCompleted(
        ...
        bool Serialization.IDeserialization.NotifyDeserializationStarted(
            Serialization.Context context
        )
        {
        ...
        void Serialization.IDeserialization.NotifyDeserializationCompleted(
            Serialization.Context context
        )
        {
            System.Diagnostics.Debug.Assert(this.fieldInheritance == InheritanceMode.Disabled);
        ...
        private class RankComparerImplementation : IComparer<StructuredTypeField>
        {
            ...
            public int Compare(StructuredTypeField valX, StructuredTypeField valY)
            {
                ...
                {
                    if (
                        (valX.Membership == FieldMembership.Inherited)
        ...
        public static bool EqualTypes(IStructuredType a, IStructuredType b)
        {
            ...
            {
                if ((typeA.BaseTypeId != typeB.BaseTypeId) || (typeA.Class != typeB.Class))
                {
                    return false;
                }
        ...
        public static StructuredType Merge(StructuredType a, StructuredType b)
        {
            ...
            if (a.Class != b.Class)
            {
                throw new System.ArgumentException(
                    string.Format(
                        "Cannot merge StructuredType of Class {0} and {1}",
                        a.Class,
                        b.Class
                    )
                );
            ...
            {
                throw new System.ArgumentException(
                    "Cannot merge StructuredType with different base types"
                );
            }
            ...
            if (
                ((bool)a.GetValue(StructuredType.DebugDisableChecksProperty))
                ...
                switch (field.Membership)
                {
                    ...
                    case FieldMembership.LocalOverride:
                        if (merge.fields.ContainsKey(id))
                        {
                            ...
                            merge.fields[id] = new StructuredTypeField(
                                id,
                                field.Type,
                                field.CaptionId,
                                fieldRank,
            ...
            System.Diagnostics.Debug.Assert(
                merge.interfaceInheritance == InheritanceMode.Undefined
            );

            //	Make the merged structure type belong to the same bundle/module
            //	as the lower layer source structured type :

            ResourceManager.SetSourceBundle(
                merge.Caption,
                ResourceManager.GetSourceBundle(a.Caption)
            );
        ...
        public static bool HaveCompatibleFields(IStructuredType source, IStructuredType target)
        {
            ...
            foreach (string fieldId in source.GetFieldIds())
            {
                ...
                if ((targetField == null) || (sourceField.Relation != targetField.Relation))
                {
                    return false;
                }
                ...
                foreach (string id in type.GetFieldIds())
                {
                    if (this.fields.ContainsKey(id))
                    {
                        ...
                        if (membership == FieldMembership.Local)
                        {
                            ...
                            (membership == FieldMembership.Inherited)
                        ...
                        if (clone == null)
                        {
                            throw new System.NotImplementedException(
                                string.Format(
                                    "Unhandled field inheritance override for field {0} in type {1}",
                                    id,
                                    typeId
                                )
                            );
        ...
        private void GetInterfaceIds(IList<Druid> interfaces, bool inherit)
        {
            ...
            foreach (Druid interfaceId in this.InterfaceIds)
            {
                ...
                System.Diagnostics.Debug.Assert(
                    interfaceType.Class == StructuredTypeClass.Interface
                );
        ...
        private void NotifyFieldInsertion(string name, StructuredTypeField field)
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    if ((caption == null) || (string.IsNullOrEmpty(caption.Name)))
                    {
                        throw new System.ArgumentException(
                            string.Format(
                                "Invalid caption specified for field in {0} {1}",
                                typeClass.ToString().ToLower(),
                                this.Name
                            )
                        );
                    }
                    ...
                    if (field.Id != field.CaptionId.ToString())
                    {
                        throw new System.ArgumentException(
                            string.Format(
                                "Field {0} must specify {1} as ID in {2} {3}",
                                caption.Name,
        ...
        private ResourceManager FindAssociatedResourceManager()
        {
            ...
            ResourceManager manager =
                bundle == null
                    ? Serialization.Context.GetResourceManager(
                        Storage.CurrentDeserializationContext
                    )
            ...
            {
                manager =
                    ResourceManager.GetResourceManager(this) ?? Support.Resources.DefaultManager;
        ...
        private static object GetFieldsValue(DependencyObject obj)
        {
            ...
            Collections.StructuredTypeFieldCollection data =
                context.GetEntry(that) as Collections.StructuredTypeFieldCollection;
        ...
        public static readonly DependencyProperty DebugDisableChecksProperty =
        ...
        public static readonly DependencyProperty FieldsProperty =
            DependencyProperty.RegisterReadOnly(
                "Fields",
                typeof(Collections.StructuredTypeFieldCollection),
                typeof(StructuredType),
                new DependencyPropertyMetadata(
                    StructuredType.GetFieldsValue
                ).MakeReadOnlySerializable()
            );
        public static readonly DependencyProperty ClassProperty =
            DependencyProperty.RegisterReadOnly(
                "Class",
                typeof(StructuredTypeClass),
                typeof(StructuredType),
                new DependencyPropertyMetadata(StructuredTypeClass.None).MakeReadOnlySerializable()
            );
        public static readonly DependencyProperty BaseTypeIdProperty = DependencyProperty.Register(
            "BaseTypeId",
            typeof(Druid),
            typeof(StructuredType),
            new DependencyPropertyMetadata(Druid.Empty).MakeReadOnlySerializable()
        );
        public static readonly DependencyProperty InterfaceIdsProperty =
            DependencyProperty.RegisterReadOnly(
                "InterfaceIds",
                typeof(ICollection<Druid>),
                typeof(StructuredType),
                new DependencyPropertyMetadata(
                    StructuredType.GetInterfaceIdsValue
                ).MakeReadOnlySerializable()
            );

        public static readonly DependencyProperty FlagsProperty =
            DependencyProperty<StructuredType>.Register<StructuredTypeFlags>(x => x.Flags);
        public static readonly DependencyProperty DefaultLifetimeExpectancyProperty =
            DependencyProperty<StructuredType>.Register<DataLifetimeExpectancy>(x =>
                x.DefaultLifetimeExpectancy
            );
        public static readonly DependencyProperty SerializedDesignerLayoutsProperty =
            DependencyProperty<StructuredType>.Register<string>(x => x.SerializedDesignerLayouts);
