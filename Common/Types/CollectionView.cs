            ...
            System.IDisposable
    {
        ...
        public CollectionView(System.Collections.IList sourceList)
        {
            ...
            if (changed == null)
            {
                ...
                INotifyCollectionChangedProvider provider =
                    this.sourceList as INotifyCollectionChangedProvider;
        ...
        {
            get { return this.currentPosition == System.Int32.MaxValue; }
        }
        ...
        public Collections.ReadOnlyList<CollectionViewGroup> Groups
        {
            get
            {
                ...
                lock (this.itemExclusion)
                {
                    ...
                    {
                        this.readOnlyGroups = new Collections.ReadOnlyList<CollectionViewGroup>(
                            this.rootGroup.GetSubgroups()
                        );
                    }
                    ...
                    lock (this.exclusion)
                    {
                        if (this.groupDescriptions == null)
                        {
                            this.groupDescriptions =
                                new Collections.ObservableList<GroupDescription>();
                            this.groupDescriptions.CollectionChanged +=
                                this.HandleGroupDescriptionsCollectionChanged;
                        }
                    }
                }
                    ...
                    lock (this.exclusion)
                    {
                        if (this.sortDescriptions == null)
                        {
                            this.sortDescriptions =
                                new Collections.ObservableList<SortDescription>();
                            this.sortDescriptions.CollectionChanged +=
                                this.HandleSortDescriptionsCollectionChanged;
                        }
                    }
                }
        ...
        private struct MoveResult
        {
            ...
            public static MoveResult MoveCurrentToPosition(CollectionView view, int position)
            {
                ...
                if ((position < -1) || (position > view.Count))
                {
                ...
                if ((view.CurrentPosition != position) || (view.CurrentItem != item))
                {
        ...
        public bool HasSortDescriptions
        {
            get
            {
                lock (this.exclusion)
                {
                    return (this.sortDescriptions != null) && (this.sortDescriptions.Count > 0);
                }
            }
        }
        ...
        public bool HasGroupDescriptions
        {
            get
            {
                lock (this.exclusion)
                {
                    return (this.groupDescriptions != null) && (this.groupDescriptions.Count > 0);
                }
            }
        }
        ...
        public static IList<CollectionViewGroup> GetGroupPath(
        ...
        private static IList<CollectionViewGroup> GetGroupPath(
            IEnumerable<CollectionViewGroup> groups,
            object item,
            int depth
        )
        {
            foreach (CollectionViewGroup group in groups)
            {
                ...
                {
                    IList<CollectionViewGroup> list = CollectionView.GetGroupPath(
                        group.Subgroups,
                        item,
                        depth + 1
                    );
        ...
        private void HandleGroupDescriptionsCollectionChanged(
            object sender,
        ...
        private void HandleSortDescriptionsCollectionChanged(
            object sender,
            CollectionChangedEventArgs e
        )
        {
        ...
        private static void GroupItemsInList(
            System.Collections.IList list,
            GroupDescription[] rules,
            CollectionViewGroup rootGroup
        )
        {
            ...
            Dictionary<string, CollectionViewGroup> groupRecycler =
                new Dictionary<string, CollectionViewGroup>();

            CollectionView.GenerateSubgroups(root, rootGroup, "", groupRecycler);
        }

        private static void ClassifyItemIntoGroups(
            object item,
        ...
        private static void GenerateSubgroups(
            GroupNode node,
        ...
        private static System.Type FillFilteredList(
            ...
            foreach (object item in source)
            {
                if (item == null)
                {
                    throw new System.InvalidOperationException(
                        "Source collection contains null items"
                    );
                }
                else if ((filter == null) || (filter(item)))
                {
                    ...
                    else
                    {
                        if (listItemType != itemType)
                        {
                            throw new System.InvalidOperationException(
                                string.Format(
                                    "Source collection not orthogonal; found type {0} and {1}",
                                    listItemType.Name,
                                    itemType.Name
                                )
                            );
        ...
        )
        {
            ...
            System.Comparison<object>[] comparisons = new System.Comparison<object>[
                sortDescriptions.Count
            ];
        ...
        {
            if ((this.dirtyGroups == false) && (this.dirtySortedList == false))
            {
                //	Nothing to do...
            }
            else
            {
                ...
                lock (this.itemExclusion)
                {
                    ...
                    if (this.dirtySortedList)
                    {
                        ...
                        lock (this.sourceList.SyncRoot)
                        {
                            for (int i = 0; i < 3; i++)
                            {
                                try
                                {
                                    itemType = CollectionView.FillFilteredList(
                                        this.sourceList,
                                        list,
                                        filter
                                    );
                                ...
                                catch (System.InvalidOperationException ex)
                                {
                                    ...
                                    System.Diagnostics.Debug.WriteLine(
                                        "Should never happen: " + ex.Message
                                    );
                        ...
                        lock (this)
                        {
                            ...
                            this.readOnlySortedList = new Collections.ReadOnlyList<object>(
                                this.sortedList
                            );
                    ...
                    if (this.dirtyGroups)
                    {
                        ...
                        lock (this.exclusion)
                        {
                            groupDescriptions =
                                this.groupDescriptions == null
                                    ? null
                                    : this.groupDescriptions.ToArray();
                        }
                        ...
                        if ((groupDescriptions != null) && (groupDescriptions.Length > 0))
                        {
                            CollectionView.GroupItemsInList(
                                this.sortedList,
                                groupDescriptions,
                                this.rootGroup
                            );
        ...
        private sealed class GroupNode
        {
            ...
            {
                get { return (this.leaves != null) && (this.leaves.Count > 0); }
            }

            public bool HasSubnodes
            {
                get { return (this.subnodes != null) && (this.subnodes.Count > 0); }
            }
