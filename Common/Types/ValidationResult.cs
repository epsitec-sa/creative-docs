...
namespace Epsitec.Common.Types
{
    ...
    public sealed class ValidationResult : IValidationResult
    {
        public ValidationResult(
            ...
            FormattedText errorMessage = default(FormattedText)
        )
        {
            this.state = state;
        ...
        public bool IsValid
        {
            get { return this.State == ValidationState.Ok; }
        }
        ...
        {
            return valid ? ValidationResult.Ok : ValidationResult.Error;
        }
        ...
        public static ValidationResult CreateError(FormattedText errorMessage, string arg)
        {
            return new ValidationResult(
                ...
                FormattedText.Format(errorMessage, arg)
            );
        }
        ...
        public static ValidationResult CreateError(FormattedText errorMessage, params object[] args)
        {
            return new ValidationResult(
                ValidationState.Error,
                FormattedText.Format(errorMessage, args)
            );
        }
        ...
        public static ValidationResult CreateWarning(FormattedText warningMessage, string arg)
        {
            return new ValidationResult(
                ...
                FormattedText.Format(warningMessage, arg)
            );
        }

        public static ValidationResult CreateWarning(
            FormattedText warningMessage,
            params object[] args
        )
        {
            return new ValidationResult(
                ValidationState.Warning,
                FormattedText.Format(warningMessage, args)
            );
        }
