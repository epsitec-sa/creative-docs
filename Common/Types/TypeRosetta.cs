...
namespace Epsitec.Common.Types
{
    ...
    public static class TypeRosetta
    {
        ...
        {
            get { return TypeRosetta.creatingCaptionResolver ?? Support.Resources.DefaultManager; }
        }
        ...
        {
            var resTypes = TypeEnumerator
                .Instance.GetAllClassTypes()
                .Where(x => x.IsStaticClass() && x.IsPublic && x.Name == "Res")
                .ToList();
                        ...
                        else
                        {
                            ...
                            if (namedType == null)
                            {
                                ...
                                else
                                {
                                    ...
                                    {
                                        namedType = new AutomaticStructuredNamedType(
                                            systemType,
                                            structuredType
                                        );
                                    }
                ...
                switch (field.Relation)
                {
                    ...
                    default:
                        throw new System.NotImplementedException(
                            string.Format(
                                "Support for Relation.{0} not implemented",
                                field.Relation
                            )
                        );
                }
        ...
        public static bool IsNullable(INamedType type)
        {
            ...
            return (nullable == null)
                ? TypeRosetta.IsNullable(type.SystemType)
                : nullable.IsNullable;
        }
        ...
        public static bool IsNullable(StructuredTypeField field)
        {
            ...
            switch (field.Relation)
            {
                ...
                default:
                    throw new System.NotImplementedException(
                        string.Format("Support for Relation.{0} not implemented", field.Relation)
                    );
            }
        }
        ...
        public static bool IsValidValueForCollectionOfType(object value, INamedType namedType)
        {
            ...
            if (typeOfItems == null)
            {
                throw new System.NotSupportedException(
                    string.Format(
                        "Unsupported null system type in collection validation for {0}",
                        namedType.Name
                    )
                );
            }
            ...
            else
            {
                ...
                if (enumerable != null)
                {
                    ...
                    if (enumerator.MoveNext())
                    {
                        ...
                        if (item != null)
                        {
                            return StructuredType.HaveCompatibleFields(
                                item.StructuredType,
                                structuredType
                            );
                        }
        ...
        public static AbstractType GetTypeObject(Caption caption)
        {
            ...
            if (type == null)
            {
                ...
                System.Diagnostics.Debug.Assert(
                    (type == null) || (TypeRosetta.knownTypes.ContainsKey(caption.Id))
                );
            }
        ...
        public static AbstractType GetTypeObject(System.Type systemType)
        {
            ...
            {
                return TypeRosetta
                    .knownTypes.Values.Where(x => x.SystemType == systemType)
                    .FirstOrDefault();
            }
        }
        ...
        /// </returns>
        public static AbstractType CreateTypeObject(
        ...
        public static AbstractType CreateTypeObject(
            Caption caption,
            bool cache,
            Support.ICaptionResolver captionResolver = null
        )
        {
        ...
        private static AbstractType LockedCreateTypeObject(Caption caption, bool cache)
        {
            ...
            else
            {
                string simpleTypeName =
                    (systemTypeName.Length > 2) && (systemTypeName[1] == ':')
                        ? systemTypeName.Substring(2)
                        : systemTypeName;
        ...
        private static AbstractType CreateSystemTypeBasedTypeObject(
        ...
        )
        {
            ...
            if (systemType == null)
            {
                ...
                SystemTypeFamily family = AbstractType.GetSystemTypeFamilyFromSystemTypeName(
                    systemTypeName
                );
        ...
        internal static void InitializeKnownTypes()
        {
            if (TypeRosetta.knownTypes == null)
            {
                lock (TypeRosetta.globalExclusion)
                {
                    if (TypeRosetta.knownTypes == null)
                    {
                        Dictionary<Support.Druid, AbstractType> dict =
                            new Dictionary<Support.Druid, AbstractType>();
        ...
        private static void InitializeDictionaryWithDefaultTypes(
            Dictionary<Support.Druid, AbstractType> dict
        )
        {
        ...
        private class AutomaticNamedType : INamedType
        {
            ...
            {
                get { return Support.Druid.Empty; }
            }
        ...
        public static bool DoesTypeImplementInterface(
        ...
        /// </returns>
        public static bool DoesTypeImplementGenericInterface(
            System.Type systemType,
            System.Type genericInterfaceType,
            out System.Type interfaceType
        )
        {
            return TypeRosetta.DoesTypeImplementGenericInterface(
                systemType,
        ...
        public static bool DoesTypeImplementGenericInterface(
            System.Type systemType,
            System.Type genericInterfaceType,
            System.Predicate<System.Type> filter,
            out System.Type interfaceType
        )
        {
            if (
        ...
        public static bool DoesTypeImplementCollectionOfCompatibleObjects(
            System.Type systemType,
        ...
        )
        {
            ...
            if ((itemType != null) && (objectType.IsAssignableFrom(itemType)))
            {
                return true;
            }
            else
        ...
        public static System.Type GetSystemType(string name)
        {
            ...
            if (type == null)
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    string.Format(
                        "TypeRosetta: The type '{0}' could not be resolved by System.Type.GetType; trying using TypeEnumerator.",
                        name
                    )
                );
                ...
                if (type == null)
                {
                    System.Diagnostics.Debug.WriteLine(
                        string.Format(
                            "TypeRosetta: The type '{0}' is missing - not found in any loaded assembly.",
                            name
                        )
                    );
                }
        ...
        public static readonly DependencyProperty TypeObjectProperty =
            DependencyProperty.RegisterAttached(
                "TypeObject",
                typeof(object),
                typeof(TypeRosetta.Properties)
            );

        private static object globalExclusion = new object();

        private static Dictionary<Support.Druid, AbstractType> knownTypes;
        private static Dictionary<Support.Druid, bool> pendingTypes =
            new Dictionary<Epsitec.Common.Support.Druid, bool>();
        private static Queue<Support.SimpleCallback> fixUpQueue =
            new Queue<Epsitec.Common.Support.SimpleCallback>();
