...
namespace Epsitec.Common.Types
{
    ...
    public static class StructuredTree
    {
            ...
            while (root != null)
            {
                ...
                if (UnknownValue.IsUnknownValue(value))
                {
                    ...
                    IStructuredType type =
                        provider == null ? root as IStructuredType : provider.GetStructuredType();

                    if ((type == null) || (type.GetField(name) == null))
                    {
                        return value;
                    }
                    else
        ...
        public static void SetValue(IStructuredData root, string path, object value)
        {
            ...
            throw new System.ArgumentException(
                string.Format("Path {0} cannot be resolved", originalPath)
            );
        }
        ...
        public static object GetSampleValue(IStructuredData root, string path)
        {
            ...
            while (root != null)
            {
                ...
                if (
                    (UnknownValue.IsUnknownValue(value)) || (UndefinedValue.IsUndefinedValue(value))
                )
                {
                    IStructuredTypeProvider provider = root as IStructuredTypeProvider;
                    IStructuredType type =
                    ...
                    if ((value == null) && (fieldStructure != null))
                    {
        ...
        public static readonly string[] EmptyPath = Epsitec
            .Common
            .Types
            .Collections
            .EmptyArray<string>
