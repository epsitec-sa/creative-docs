...
namespace Epsitec.Common.Types
{
    ...
    public abstract class AbstractNumericType : AbstractType, INumericType
    {
        ...
        {
            get { return (DecimalRange)this.Caption.GetValue(AbstractNumericType.RangeProperty); }
        }
        ...
        public DecimalRange PreferredRange
        {
            ...
            {
                return (DecimalRange)
                    this.Caption.GetValue(AbstractNumericType.PreferredRangeProperty);
            }
        }
        ...
        {
            get { return (decimal)this.Caption.GetValue(AbstractNumericType.SmallStepProperty); }
        }
        ...
        {
            get { return (decimal)this.Caption.GetValue(AbstractNumericType.LargeStepProperty); }
        }
        ...
        public static readonly DependencyProperty RangeProperty =
            DependencyProperty.RegisterAttached(
                "Range",
                typeof(DecimalRange),
                typeof(AbstractNumericType),
                new DependencyPropertyMetadata(DecimalRange.Empty)
            );
        public static readonly DependencyProperty PreferredRangeProperty =
            DependencyProperty.RegisterAttached(
                "PreferredRange",
                typeof(DecimalRange),
                typeof(AbstractNumericType),
        ...
        public static readonly DependencyProperty SmallStepProperty =
            DependencyProperty.RegisterAttached(
                ...
                typeof(decimal),
                typeof(AbstractNumericType),
                new DependencyPropertyMetadata(0M)
            );
        ...
        public static readonly DependencyProperty UseCompactStorageProperty =
            DependencyProperty.RegisterAttached(
                "UseCompactStorage",
                typeof(bool),
                typeof(AbstractNumericType),
