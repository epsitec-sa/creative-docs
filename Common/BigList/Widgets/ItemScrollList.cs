...
namespace Epsitec.Common.BigList.Widgets
{
    ...
    public partial class ItemScrollList : Widget
    {
        public ItemScrollList()
        {
            ...
            this.splitView = new VSplitView() { Parent = this, Dock = DockStyle.Fill, };
        ...
        public void SetUpItemList<TData>(
        ...
        {
            this.SetUpItemList<TData, ItemState>(
                provider,
                mapper,
                itemRenderer,
                markRenderer,
        ...
        public void SetUpItemList<TData, TState>(
            IItemDataProvider<TData> provider,
            /**/IItemDataMapper<TData> mapper,
            /**/IItemDataRenderer itemRenderer,
            /**/IItemMarkRenderer markRenderer = null,
            ...
            where TState : ItemState, new()
        {
            ...
            this.contentViews.Add(
                new ContentView(
                    this,
                    itemRenderer,
                    markRenderer,
                    this.splitView.Frame1,
                    this.splitView.Scroller1
                )
            );
            this.contentViews.Add(
                new ContentView(
                    ...
                    itemRenderer,
                    markRenderer,
                    this.splitView.Frame2,
                    this.splitView.Scroller2
                )
            );
