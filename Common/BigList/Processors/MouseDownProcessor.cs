        ...
        )
        {
            ...
            this.originalSelection =
                this.selectionProcessor == null
                    ? false
                    : this.selectionProcessor.IsSelected(this.originalIndex);

            if ((this.policy.AutoScroll) && (this.scrollingProcessor != null))
            {
                ...
                case MessageType.MouseUp:
                    ...
                    if (message.Button == this.button)
                    {
                        ...
                        if (this.selectionProcessor != null)
                        {
                            ...
                            {
                                this.selectionProcessor.Select(
                                    this.originalIndex,
        ...
        private void ProcessMove(Point pos)
        {
            if (this.policy.AutoFollow)
            {
                ...
                if (newIndex != oldIndex)
                {
                    ...
                    this.selectionProcessor.Select(
                        oldIndex,
                        this.originalSelection ? ItemSelection.Select : ItemSelection.Deselect
                    );
