...
namespace Epsitec.Common.BigList
{
    public partial class ItemListVerticalContentView : Widget
    {
        ...
        public IItemDataRenderer ItemRenderer { get; set; }

        public IItemMarkRenderer MarkRenderer { get; set; }

        public int DefaultLineHeight { get; set; }

        public int ActiveIndex
        {
            get { return this.ItemList.ActiveIndex; }
        }

        public void ActivateRow(int index)
        {
            if ((index < 0) || (index >= this.ItemList.ItemCount))
            {
                return;
            }
            ...
            if (oldIndex != newIndex)
            {
                this.InvalidateProperty(
                    ItemListVerticalContentView.ActiveIndexProperty,
                    oldIndex,
                    newIndex
                );
            }
        ...
        public void Scroll(double amplitude, ScrollUnit scrollUnit, ScrollMode scrollMode)
        {
            switch (scrollMode)
            {
                ...
                case ScrollMode.MoveActiveAndSelect:
                    ...
                    if (
                        (this.ItemList.Features.SelectionMode == ItemSelectionMode.ExactlyOne)
        ...
        {
            if ((this.ItemRenderer == null) || (this.list == null))
            {
                return;
            }
        ...
        {
            if ((this.MarkRenderer == null) || (this.list == null))
            {
                return;
            }
        ...
        {
            if ((this.IsActualGeometryValid) && (this.list != null))
            {
        ...
        {
            add { this.AddEventHandler(ItemListVerticalContentView.ActiveIndexProperty, value); }
            remove
            {
        ...
        {
            add { this.AddUserEventHandler(EventNames.SelectionChanged, value); }
            remove { this.RemoveUserEventHandler(EventNames.SelectionChanged, value); }
        }
        ...
        public static DependencyProperty ActiveIndexProperty =
            DependencyProperty<ItemListVerticalContentView>.RegisterReadOnly<int>(
                x => x.ActiveIndex,
                x => x.ActiveIndex
            );
