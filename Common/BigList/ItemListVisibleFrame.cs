...
namespace Epsitec.Common.BigList
{
    public sealed class ItemListVisibleFrame
    {
        ...
        {
            get { return this.visibleOffset; }
        }

        public int VisibleHeight
        {
            get { return this.visibleHeight; }
            set
            {
        ...
        {
            get { return this.visibleRows.Count; }
        }
        ...
        {
            get { return this.visibleRows.AsReadOnly(); }
        }
        ...
        {
            if ((this.visibleRows.Count > 0) && (this.visibleRows[0].Index == index))
            {
                return;
            }
        ...
        public void MoveVisibleContent(int distance)
        {
            ...
            {
                rows = this.GetVisibleRowsStartingWith(
                    this.visibleIndex,
                    this.visibleOffset + distance
                );
            }
        ...
        public int GetFirstFullyVisibleIndex()
        {
            ...
            var row =
                this.visibleRows.FirstOrDefault(x => x.Offset >= 0)
        ...
        public int GetLastFullyVisibleIndex()
        {
            ...
            var row =
                this.visibleRows.LastOrDefault(x =>
                    (x.Offset + x.Height.TotalHeight) <= this.visibleHeight
        ...
        internal bool SetVisibleIndex(int index)
        {
            ...
            return oldVisibleIndex != this.visibleIndex || oldVisibleOffset != this.visibleOffset;
        }
        ...
        private List<ItemListRow> GetVisibleRowsEndingWith(int index)
        {
            ...
            if ((total < this.visibleHeight) && (rows.Count > 0))
            {
                ...
                rows = new List<ItemListRow>(
                    ItemListVisibleFrame.ShiftRows(rows, total - this.visibleHeight)
                );
        ...
        {
            return rows.Select(x => new ItemListRow(
                x.Index,
                x.Offset + offset,
                x.Height,
                x.IsLast
