...
namespace Epsitec.Common.IO
{
    ...
    /// </summary>
    public sealed class GenericDeserializationBinder
        : System.Runtime.Serialization.SerializationBinder
    {
        public GenericDeserializationBinder(
            System.Func<string, string, System.Type> bindToTypeFunc = null
        )
        {
        ...
        public override System.Type BindToType(string assemblyName, string typeName)
        {
            ...
            {
                type =
                    GenericDeserializationBinder.SafeGetType(fullName)
        ...
        private System.Type FindReplacementType(string assemblyName, string typeName)
        {
            ...
            if (typeName.Contains("`"))
            {
                ...
                while (pos < typeName.Length)
                {
                    ...
                    string replacement = GenericDeserializationBinder.FindReplacementTypeName(
                        partPrefix,
                        partType
                    );
            ...
            string fullName = GenericDeserializationBinder.FindReplacementTypeName(
                prefix,
                typeName
            );
        ...
        private static string FindReplacementTypeName(string prefix, string typeName)
        {
            ...
            return GenericDeserializationBinder
                .GetLoadedAssemblies()
                .Where(assembly => assembly.FullName.StartsWith(prefix))
                .Select(assembly =>
                    GenericDeserializationBinder.GetFullName(assembly.FullName, typeName)
                )
                .FirstOrDefault();
        }
        ...
        private static IEnumerable<System.Reflection.Assembly> GetLoadedAssemblies()
        {
            return from assembly in System.AppDomain.CurrentDomain.GetAssemblies()
                where assembly.IsDynamic == false && assembly.ReflectionOnly == false
                select assembly;
        }
