...
namespace Epsitec.Common.IO
{
    ...
    public sealed class ZipFile
    {
        ...
        {
            get { return this.loadFileName; }
            set { this.loadFileName = value; }
        }
        ...
        public bool LoadFile(System.IO.Stream stream, LoadPredicate loadPredicate = null)
        {
            ...
            ICSharpCode.SharpZipLib.Zip.ZipInputStream zip =
                        ...
                        if ((loadPredicate == null) || (loadPredicate(entry.Name)))
                        {
                            ...
                            this.entries.Add(
                                new Entry(
                                    ...
                                    data,
                                    entry.DateTime,
                                    (int)entry.ZipFileIndex,
                                    entry.CompressionMethod
                                        == ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated
                                )
                            );
                        }
                    }
        ...
        /// </returns>
        public bool LoadFileFromResources(
            System.Reflection.Assembly assembly,
            string path,
            LoadPredicate loadPredicate = null
        )
        {
        ...
        public void AddDirectory(string name)
        {
            ...
            if (
                this.entries.Exists(
                    delegate(Entry entry)
                    {
                        return entry.IsDirectory && entry.Name == name;
                    }
                )
            )
            {
        ...
        public static string DecompressTextFile(
        ...
        {
            ICSharpCode.SharpZipLib.Zip.ZipEntry e = new ICSharpCode.SharpZipLib.Zip.ZipEntry(
                entry.Name
            );
            ...
            else
            {
                ...
                e.CompressionMethod = entry.IsCompressed
                    ? ICSharpCode.SharpZipLib.Zip.CompressionMethod.Deflated
