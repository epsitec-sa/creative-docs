namespace Epsitec.Common.Widgets.Adorners
{
    ...
    public class LookFlat : AbstractAdorner
    {
        ...
        protected override void RefreshColors()
        {
            ...
            this.colorControlField = Drawing.Color.FromRgb(
                255.0 / 255.0,
                255.0 / 255.0,
                255.0 / 255.0
            );
            this.colorControlReadOnly = Drawing.Color.FromRgb(
                230.0 / 255.0,
                230.0 / 255.0,
                230.0 / 255.0
            );
            ...
            this.colorControlBar = Drawing.Color.FromRgb(
                204.0 / 255.0,
                204.0 / 255.0,
                204.0 / 255.0
            );
            this.colorBackDisabled = Drawing.Color.FromRgb(
                204.0 / 255.0,
                204.0 / 255.0,
                204.0 / 255.0
            );
            ...
            this.colorFrontDisabled = Drawing.Color.FromRgb(
                170.0 / 255.0,
                170.0 / 255.0,
                170.0 / 255.0
            );
            ...
            this.colorControlDark = Drawing.Color.FromRgb(
                120.0 / 255.0,
                120.0 / 255.0,
                120.0 / 255.0
            );
            ...
            this.colorThreeState = Drawing.Color.FromRgb(
                218.0 / 255.0,
                207.0 / 255.0,
                162.0 / 255.0
            );
        ...
        )
        {
            ...
            if ((state & WidgetPaintState.Enabled) != 0)
            {
                if (type == GlyphShape.Reject)
                    color = Drawing.Color.FromRgb(0.7, 0.0, 0.0); // rouge foncé
                if (type == GlyphShape.Accept)
                    color = Drawing.Color.FromRgb(0.0, 0.6, 0.0); // vert foncé
            }
            else
            {
        ...
        )
        {
            ...
            switch (type)
            {
                ...
                case GlyphShape.TriangleUp:
                    ...
                    path.LineTo(
                        center.X - rect.Width * baseShiftH,
                        center.Y - rect.Height * baseShiftV
                    );
                    path.LineTo(
                        center.X + rect.Width * baseShiftH,
                        center.Y - rect.Height * baseShiftV
                ...
                case GlyphShape.TriangleRight:
                    ...
                    path.LineTo(
                        center.X - rect.Width * baseShiftV,
                        center.Y + rect.Height * baseShiftH
                    );
                    path.LineTo(
                        center.X - rect.Width * baseShiftV,
                        center.Y - rect.Height * baseShiftH
                ...
                case GlyphShape.Menu:
                    path.MoveTo(
                        ...
                        center.Y - rect.Height * 0.25 * zoom
                    );
                    path.LineTo(
                ...
                case GlyphShape.Reject:
                    path.MoveTo(
                        ...
                        center.Y - rect.Height * 0.30 * zoom
                    );
                    path.LineTo(
                        center.X - rect.Width * 0.30 * zoom,
                ...
                if ((state & WidgetPaintState.Enabled) != 0) // bouton enable ?
                {
                    ...
                    else
                    {
                        graphics.RenderSolid(
                            readOnly ? this.colorControlReadOnly : this.colorControlField
                        );
                    }
                }
                else
			...
			if ( (state&WidgetPaintState.Enabled) != 0 )
			{
				switch ( dir )
				{
					...
					case Direction.Down:
						...
						{
							Drawing.Point p1 = graphics.Align(new Drawing.Point(thumbRect.Left+3, (thumbRect.Bottom+thumbRect.Top)/2));
							Drawing.Point p2 = graphics.Align(new Drawing.Point(thumbRect.Right-3, (thumbRect.Bottom+thumbRect.Top)/2));
							p1.Y -= 5.5;
							p2.Y -= 5.5;
							for ( int i=0 ; i<4 ; i++ )
							{
					...
					case Direction.Right:
						...
						{
							Drawing.Point p1 = graphics.Align(new Drawing.Point((thumbRect.Left+thumbRect.Right)/2, thumbRect.Bottom+3));
							Drawing.Point p2 = graphics.Align(new Drawing.Point((thumbRect.Left+thumbRect.Right)/2, thumbRect.Top-3));
							p1.X -= 5.5;
							p2.X -= 5.5;
							for ( int i=0 ; i<4 ; i++ )
							{
        ...
        {
            get { return this.colorControlBar; }
        }
        ...
        )
        {
            ...
            for (int i = 0; i < areas.Length; i++)
            {
                ...
                {
                    if (
                        mode == TextFieldDisplayMode.Default
        ...
        )
        {
            ...
            if ((state & WidgetPaintState.Enabled) != 0)
            {
                ...
                else if ((state & WidgetPaintState.Entered) != 0)
                {
                    text.Paint(
                        ...
                        clipRect,
                        Drawing.Color.Empty,
                        Drawing.GlyphPaintStyle.Entered
                    );
                }
                else
                {
            ...
            {
                if (style == PaintTextStyle.HMenu || style == PaintTextStyle.VMenu)
                {
                    text.Paint(
                        pos,
                        graphics,
                        clipRect,
                        this.colorControlField,
        ...
        protected Drawing.Path PathRoundRectangle(Drawing.Rectangle rect, double radius)
        {
            ...
            if (radius == 0)
                radius = System.Math.Min(dx, dy) / 4;
            if (radius == -1)
                radius = 0;
        ...
        {
            get { return new Drawing.Margins(0, 0, 2, 0); }
        }
