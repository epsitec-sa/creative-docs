namespace Epsitec.Common.Widgets.Adorners
{
    ...
    public class LookDraft : AbstractAdorner
    {
        ...
        protected override void RefreshColors()
        {
            ...
            this.colorBorder = Drawing.Color.FromAlphaRgb(
                0.6,
                128.0 / 255.0,
                128.0 / 255.0,
                128.0 / 255.0
            ...
            this.colorTextBackground = Drawing.Color.FromRgb(
                255.0 / 255.0,
                255.0 / 255.0,
                255.0 / 255.0
            );
        ...
        )
        {
            ...
            if ((state & WidgetPaintState.Enabled) != 0)
            {
                if (type == GlyphShape.Reject)
                    color = Drawing.Color.FromRgb(0.5, 0.0, 0.0); // rouge foncé
                if (type == GlyphShape.Accept)
                    color = Drawing.Color.FromRgb(0.0, 0.3, 0.0); // vert foncé
            }
            else
            {
        ...
        )
        {
            ...
            switch (type)
            {
                case GlyphShape.Dots:
                    path.MoveTo(
                        center.X - rect.Width * 0.30 * zoom,
                        center.Y + rect.Height * 0.06 * zoom
                    );
                    path.LineTo(
                        center.X - rect.Width * 0.18 * zoom,
                        center.Y + rect.Height * 0.06 * zoom
                    );
                    path.LineTo(
                        center.X - rect.Width * 0.18 * zoom,
                ...
                case GlyphShape.TabLeft:
                    path.MoveTo(
                        center.X - rect.Width * 0.10 * zoom,
                        center.Y + rect.Height * 0.15 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.00 * zoom,
                        center.Y + rect.Height * 0.15 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.00 * zoom,
                        center.Y - rect.Height * 0.05 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.20 * zoom,
                        center.Y - rect.Height * 0.05 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.20 * zoom,
                ...
                case GlyphShape.TabDecimal:
                    ...
                    path.MoveTo(
                        center.X + rect.Width * 0.10 * zoom,
                        center.Y + rect.Height * 0.10 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.20 * zoom,
                        center.Y + rect.Height * 0.10 * zoom
                    ...
                    path.LineTo(
                        center.X + rect.Width * 0.20 * zoom,
                        center.Y + rect.Height * 0.00 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.10 * zoom,
                        center.Y + rect.Height * 0.00 * zoom
                ...
                case GlyphShape.TabIndent:
                    path.MoveTo(
                        center.X - rect.Width * 0.10 * zoom,
                        center.Y + rect.Height * 0.20 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.20 * zoom,
                        center.Y - rect.Height * 0.00 * zoom
                ...
                case GlyphShape.Plus:
                    path.MoveTo(
                        center.X - rect.Width * 0.29 * zoom,
                        center.Y + rect.Height * 0.07 * zoom
                    );
                    path.LineTo(
                        center.X - rect.Width * 0.07 * zoom,
                        center.Y + rect.Height * 0.07 * zoom
                    );
                    path.LineTo(
                        center.X - rect.Width * 0.07 * zoom,
                        center.Y + rect.Height * 0.29 * zoom
                    );
                    path.LineTo(
                        center.X + rect.Width * 0.07 * zoom,
                        center.Y + rect.Height * 0.29 * zoom
        ...
        )
        {
            ...
            else if (style == ButtonStyle.Combo || style == ButtonStyle.ExListRight)
            {
                if ((state & WidgetPaintState.Enabled) != 0)
                {
            ...
            else if (style == ButtonStyle.ExListMiddle || style == ButtonStyle.ExListLeft)
            {
                if ((state & WidgetPaintState.Enabled) != 0)
                {
                    this.PaintImageButton(graphics, rect, 36);
        ...
        )
        {
            ...
            if (style == TextFieldStyle.Normal || style == TextFieldStyle.Combo)
            {
        ...
        )
        {
            ...
            this.PaintButtonBackground(
                ...
                rect,
                state,
                Widgets.Direction.None,
                ButtonStyle.ToolItem
            );
        }
        ...
        )
        {
            ...
            if (text != null)
            {
                ...
                text.Paint(
                    ...
                    graphics,
                    Drawing.Rectangle.MaxValue,
                    Drawing.Color.FromBrightness(0),
        ...
        protected Drawing.Path PathLeftRoundRectangle(
            Drawing.Rectangle rect,
            double radius,
            bool closed
        )
        ...
        protected void PaintImageButton(Drawing.Graphics graphics, Drawing.Rectangle rect, int rank)
        {
            //	Dessine un bouton composé plusieurs morceaux d'image.
            this.PaintImageButton(graphics, rect, rank, new Drawing.Margins(0, 0, 0, 0));
        }

        protected void PaintImageButton(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            int rank,
        ...
        )
        {
            ...
            else if ((rank >= 16 && rank < 20) || (rank >= 52 && rank < 56))
            {
            ...
            else if ((rank >= 36 && rank < 38) || (rank >= 44 && rank < 48) || rank == 22)
            {
                this.PaintImageButton9(graphics, rect, 4, icon, 7);
            }
        ...
        protected void PaintImageButton1(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
        ...
        protected void PaintImageButton3h(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            Drawing.Rectangle icon
        )
        ...
        protected void PaintImageButton3v(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            Drawing.Rectangle icon
        )
        ...
        protected void PaintImageButton9(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            double rectMargin,
            Drawing.Rectangle icon,
        ...
        protected void PaintRoundShadow(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            int deep,
            double alphaTop,
        ...
        )
        {
            ...
            for (int i = 0; i < deep; i++)
            {
                ...
                if (hole)
                    graphics.RenderSolid(Drawing.Color.FromAlphaRgb(alphaBottom, 1, 1, 1));
                else
                    graphics.RenderSolid(Drawing.Color.FromAlphaRgb(alphaBottom, 0, 0, 0));
                ...
                Drawing.Color bottomColor,
                    topColor;
                if (hole)
                    bottomColor = Drawing.Color.FromAlphaRgb(alphaBottom, 1, 1, 1);
                else
                    bottomColor = Drawing.Color.FromAlphaRgb(alphaBottom, 0, 0, 0);
                if (hole)
                    topColor = Drawing.Color.FromAlphaRgb(alphaTop, 0, 0, 0);
                else
                    topColor = Drawing.Color.FromAlphaRgb(alphaTop, 1, 1, 1);
        ...
        protected void PaintRoundTopShadow(Drawing.Graphics graphics, Drawing.Rectangle rect)
        {
            ...
            this.Gradient(
                graphics,
                up,
                Drawing.Color.FromAlphaRgb(0.0, 0, 0, 0),
                Drawing.Color.FromAlphaRgb(0.2, 0, 0, 0)
            );
        }

        protected void PaintRectTopShadow(Drawing.Graphics graphics, Drawing.Rectangle rect)
        {
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(255.0 / 255.0, 210.0 / 255.0, 0.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(255.0 / 255.0, 255.0 / 255.0, 223.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
        ...
        {
            get { return new Drawing.Margins(0, 0, 4, 0); }
        }
        public override Drawing.Margins GeometryGroupShapeMargins
        {
            get { return new Drawing.Margins(0, 0, 0, 1); }
        }
        ...
        {
            get { return new Drawing.Margins(2, 2, 0, 5); }
        }
        ...
        {
            get { return new Drawing.Margins(1, 1, 1, 1); }
        }
