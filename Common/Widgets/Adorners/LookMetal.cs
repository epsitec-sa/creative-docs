    ...
    public class LookMetal : AbstractAdorner
    {
        public LookMetal()
        {
            this.bitmap = Support.ImageProvider.Instance.GetImageFromManifestResource(
                "Epsitec.Common.Widgets.Adorners.Resources.LookMetal.png",
        ...
        )
        {
            ...
            else
            {
                graphics.AddFilledRectangle(rect);
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(221.0 / 255.0, 224.0 / 255.0, 227.0 / 255.0)
                );
            }
        ...
        )
        {
            ...
            if (dir == Widgets.Direction.Left)
            {
                ...
                graphics.AddLine(p1.X + 0.5, p1.Y - 0.5, p2.X - 0.5, p2.Y - 0.5);
                graphics.RenderSolid(
                    enabled ? this.colorControlLightLight : this.colorControlLight
                );
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(223.0 / 255.0, 240.0 / 255.0, 255.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(253.0 / 255.0, 241.0 / 255.0, 205.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
        ...
        {
            get { return new Drawing.Margins(0, 0, 0, 3); }
        }
