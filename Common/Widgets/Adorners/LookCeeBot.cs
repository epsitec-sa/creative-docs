    ...
    public class LookCeeBot : AbstractAdorner
    {
        public LookCeeBot()
        {
            this.bitmap = Support.ImageProvider.Instance.GetImageFromManifestResource(
                "Epsitec.Common.Widgets.Adorners.ResourcesLookCeeBot.png",
        ...
        )
        {
            ...
            if ((state & WidgetPaintState.Focused) != 0 && (state & WidgetPaintState.Engaged) == 0)
            {
        ...
        )
        {
            ...
            graphics.RenderSolid(
                Drawing.Color.FromAlphaRgb(0.5, 255 / 255.0, 211.0 / 255.0, 175.0 / 255.0)
            );
        ...
        public void PaintFocusBox(Drawing.Graphics graphics, Drawing.Rectangle rect, double radius)
        {
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(249.0 / 255.0, 205.0 / 255.0, 173.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(226.0 / 255.0, 209.0 / 255.0, 255.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
