    ...
    public class LookPlastic : AbstractAdorner
    {
        ...
        )
        {
            ...
            if (type == GlyphShape.Accept)
                color = Drawing.Color.FromRgb(0.0, 0.5, 0.0); // vert foncé
            ...
            if (type == GlyphShape.ResizeKnob)
            {
                ...
                graphics.RenderSolid(
                    Drawing.Color.FromRgb(
                        this.colorWindow.R - 0.1,
                        this.colorWindow.G - 0.1,
                        this.colorWindow.B - 0.1
                    )
                );
                return;
            }
        ...
        )
        {
            ...
            Drawing.Path path = this.PathRoundRectangleGroupBox(
                frameRect,
                titleRect.Left,
                titleRect.Right
            );
        ...
        protected Drawing.Path PathRoundRectangleGroupBox(
            Drawing.Rectangle rect,
            double startX,
            double endX
        )
        ...
        )
        {
            if (paintStyle == Drawing.GlyphPaintStyle.Disabled)
            {
                ...
                color = Drawing.Color.FromAlphaRgb(
                    alpha,
                    intensity,
                    System.Math.Min(intensity * 1.4, 1.0),
                    System.Math.Min(intensity * 1.4, 1.0)
                ); // bleuté
            }
            return color;
        ...
        public override Drawing.Color ColorTextDisplayMode(TextFieldDisplayMode mode)
        {
            switch (mode)
            {
                ...
                case TextFieldDisplayMode.OverriddenValue:
                    return Drawing.Color.FromRgb(255.0 / 255.0, 236.0 / 255.0, 171.0 / 255.0);
                case TextFieldDisplayMode.InheritedValue:
                    return Drawing.Color.FromRgb(186.0 / 255.0, 220.0 / 255.0, 255.0 / 255.0);
            }
            return Drawing.Color.Empty;
        }
