...
namespace Epsitec.Common.Widgets.Collections
{
    ...
    public class StringCollection : System.Collections.IList, System.IDisposable
    {
        ...
        public bool AcceptsRichText { get; set; }
        ...
        public System.Func<object, string> ValueConverter { get; set; }
        ...
        public int FindIndexByValue(
            string find,
            int startAt,
            System.Func<string, string, bool> match
        )
        {
            if (match == null)
            {
