...
namespace Epsitec.Common.Widgets
{
    ...
    public class Visual : Types.DependencyObject, Helpers.IClientInfo, System.IEquatable<Visual>
    {
        ...
        public int Index
        {
            get { return (int)this.GetValue(Visual.IndexProperty); }
            set { this.SetValue(Visual.IndexProperty, value); }
        }

        public string Group
        {
            get { return (string)this.GetValue(Visual.GroupProperty); }
            set { this.SetValue(Visual.GroupProperty, value); }
        }

        public string Name
        {
            get { return (string)this.GetValue(Visual.NameProperty); }
            set
            {
        ...
        {
            get { return Helpers.VisualTree.GetWindow(this); }
        }
        ...
        {
            get { return (Command)this.GetValue(Visual.CommandObjectProperty); }
            set { this.SetValue(Visual.CommandObjectProperty, value); }
        }
        ...
        public Druid CommandId
        {
            ...
            set
            {
                ...
                {
                    ICaptionResolver manager =
                        Visual.cachedCaptionResolver ?? Helpers.VisualTree.GetCaptionResolver(this);
        ...
        {
            get { return this.CommandObject != null; }
        }
        ...
        {
            get { return (ICaptionResolver)this.GetValue(Visual.CaptionResolverProperty); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return (Druid)this.GetValue(Visual.CaptionIdProperty); }
            set { this.SetValue(Visual.CaptionIdProperty, value); }
        }

        public AnchorStyles Anchor
        {
            get { return (AnchorStyles)this.GetValue(Visual.AnchorProperty); }
            set { this.SetValue(Visual.AnchorProperty, value); }
        }

        public DockStyle Dock
        {
            get { return (DockStyle)this.GetValue(Visual.DockProperty); }
            set { this.SetValue(Visual.DockProperty, value); }
        }

        public Drawing.Margins Margins
        {
            get { return (Drawing.Margins)this.GetValue(Visual.MarginsProperty); }
            set { this.SetValue(Visual.MarginsProperty, value); }
        }

        public Drawing.Margins Padding
        {
            get { return (Drawing.Margins)this.GetValue(Visual.PaddingProperty); }
            set { this.SetValue(Visual.PaddingProperty, value); }
        }

        public HorizontalAlignment HorizontalAlignment
        {
            get { return (HorizontalAlignment)this.GetValue(Visual.HorizontalAlignmentProperty); }
            set { this.SetValue(Visual.HorizontalAlignmentProperty, value); }
        }

        public VerticalAlignment VerticalAlignment
        {
            get { return (VerticalAlignment)this.GetValue(Visual.VerticalAlignmentProperty); }
            set { this.SetValue(Visual.VerticalAlignmentProperty, value); }
        }

        public virtual ContentAlignment ContentAlignment
        {
            get { return (ContentAlignment)this.GetValue(Visual.ContentAlignmentProperty); }
            set { this.SetValue(Visual.ContentAlignmentProperty, value); }
        }

        public ContainerLayoutMode ContainerLayoutMode
        {
            get { return (ContainerLayoutMode)this.GetValue(Visual.ContainerLayoutModeProperty); }
            set { this.SetValue(Visual.ContainerLayoutModeProperty, value); }
        }

        public Drawing.Size PreferredSize
        {
            get { return new Drawing.Size(this.PreferredWidth, this.PreferredHeight); }
            set
            {
        ...
        {
            get { return (double)this.GetValue(Visual.PreferredWidthProperty); }
            set { this.SetValue(Visual.PreferredWidthProperty, value); }
        }

        public double PreferredHeight
        {
            get { return (double)this.GetValue(Visual.PreferredHeightProperty); }
            set { this.SetValue(Visual.PreferredHeightProperty, value); }
        }

        public bool IsActualGeometryValid
        {
            get { return this.dirtyLayout == false; }
        }

        public bool IsActualGeometryDirty
        {
            get { return this.dirtyLayout; }
        }
        ...
        public bool InheritsParentFocus
        {
            ...
            set { this.SetValue(Visual.InheritsParentFocusProperty, value); }
        }

        public Drawing.Size MinSize
        {
            get { return new Drawing.Size(this.MinWidth, this.MinHeight); }
            set
            {
        ...
        {
            get { return new Drawing.Size(this.MaxWidth, this.MaxHeight); }
            set
            {
        ...
        {
            get { return (double)this.GetValue(Visual.MinWidthProperty); }
            set { this.SetValue(Visual.MinWidthProperty, value); }
        }

        public double MaxWidth
        {
            get { return (double)this.GetValue(Visual.MaxWidthProperty); }
            set { this.SetValue(Visual.MaxWidthProperty, value); }
        }

        public double MinHeight
        {
            get { return (double)this.GetValue(Visual.MinHeightProperty); }
            set { this.SetValue(Visual.MinHeightProperty, value); }
        }

        public double MaxHeight
        {
            get { return (double)this.GetValue(Visual.MaxHeightProperty); }
            set { this.SetValue(Visual.MaxHeightProperty, value); }
        }

        public ActiveState ActiveState
        {
            get { return (ActiveState)this.GetValue(Visual.ActiveStateProperty); }
        ...
        public bool Enable
        {
            get { return (bool)this.GetValue(Visual.EnableProperty); }
            set
            {
        ...
        {
            get { return (bool)this.GetValue(Visual.IsEnabledProperty); }
        }
        ...
        {
            get { return this.ActiveState == ActiveState.Yes; }
        }

        public bool IsEntered
        {
            get { return (bool)this.GetValue(Visual.EnteredProperty); }
        }

        public bool IsSelected
        {
            get { return (bool)this.GetValue(Visual.SelectedProperty); }
        }

        public bool IsEngaged
        {
            get { return (bool)this.GetValue(Visual.EngagedProperty); }
        }
        ...
        public bool IsValid
        {
            get
            {
                ...
                if ((validator != null) && (validator.State != ValidationState.Unknown))
                {
        ...
        public bool InError
        {
            get { return (bool)this.GetValue(Visual.InErrorProperty); }
        }

        public bool UndefinedLanguage
        {
            get { return (bool)this.GetValue(Visual.UndefinedLanguageProperty); }
        }

        public IValidator Validator
        {
            get { return (IValidator)this.GetValue(Visual.ValidatorProperty); }
        }

        public bool HasValidator
        {
            get { return this.ContainsLocalValue(Visual.ValidatorProperty); }
        }
        ...
        {
            get { return (string)this.GetValue(Visual.ValidationGroupsProperty); }
            set { this.SetValue(Visual.ValidationGroupsProperty, value); }
        }
        ...
        {
            get { return this.ContainsLocalValue(Visual.ValidationGroupsProperty); }
        }

        public bool SyncPaint
        {
            get { return (bool)this.GetValue(Visual.SyncPaintProperty); }
            set { this.SetValue(Visual.SyncPaintProperty, value); }
        }

        public bool AutoCapture
        {
            get { return (bool)this.GetValue(Visual.AutoCaptureProperty); }
            set { this.SetValue(Visual.AutoCaptureProperty, value); }
        }

        public bool AutoFocus
        {
            get { return (bool)this.GetValue(Visual.AutoFocusProperty); }
            set { this.SetValue(Visual.AutoFocusProperty, value); }
        }

        public bool AutoEngage
        {
            get { return (bool)this.GetValue(Visual.AutoEngageProperty); }
            set { this.SetValue(Visual.AutoEngageProperty, value); }
        }

        public bool AutoRepeat
        {
            get { return (bool)this.GetValue(Visual.AutoRepeatProperty); }
            set { this.SetValue(Visual.AutoRepeatProperty, value); }
        }

        public bool AutoToggle
        {
            get { return (bool)this.GetValue(Visual.AutoToggleProperty); }
            set { this.SetValue(Visual.AutoToggleProperty, value); }
        }

        public bool AutoRadio
        {
            get { return (bool)this.GetValue(Visual.AutoRadioProperty); }
            set { this.SetValue(Visual.AutoRadioProperty, value); }
        }

        public bool AutoDoubleClick
        {
            get { return (bool)this.GetValue(Visual.AutoDoubleClickProperty); }
            set { this.SetValue(Visual.AutoDoubleClickProperty, value); }
        }

        public bool AcceptThreeState
        {
            get { return (bool)this.GetValue(Visual.AcceptThreeStatePropery); }
            set { this.SetValue(Visual.AcceptThreeStatePropery, value); }
        }

        public bool Furtive
        {
            get { return (bool)this.GetValue(Visual.AcceptFurtivePropery); }
            set { this.SetValue(Visual.AcceptFurtivePropery, value); }
        }

        public bool DrawDesignerFrame
        {
            //	Détermine s'il faut dessiner un cadre traitillé (utilisé par Designer).
            get { return (bool)this.GetValue(Visual.DrawDesignerFrameProperty); }
            set { this.SetValue(Visual.DrawDesignerFrameProperty, value); }
        }

        public FrameEdges DrawFrameEdges
        {
            //	Détermine s'il faut dessiner un cadre dans les quatre bords du widget.
            get { return (FrameEdges)this.GetValue(Visual.DrawFrameEdgesProperty); }
            set { this.SetValue(Visual.DrawFrameEdgesProperty, value); }
        }

        public double DrawFrameWidth
        {
            //	Epaisseur du cadre dans les quatre bords du widget.
            get { return (double)this.GetValue(Visual.DrawFrameWidthProperty); }
            set { this.SetValue(Visual.DrawFrameWidthProperty, value); }
        }

        public Drawing.Color BackColor
        {
            get { return (Drawing.Color)this.GetValue(Visual.BackColorProperty); }
            set { this.SetValue(Visual.BackColorProperty, value); }
        }
        ...
        public virtual void SetManualBounds(Drawing.Rectangle value)
        {
            ...
            System.Diagnostics.Debug.Assert(
                Layouts.LayoutEngine.GetLayoutMode(this) == Layouts.LayoutMode.None
            );
        ...
        protected virtual void SetBoundsOverride(
        ...
        public void Arrange(Layouts.LayoutContext context)
        {
            ...
            if ((this.HasChildren) || (engine != null))
            {
        ...
        protected virtual void MeasureMinMax(ref Drawing.Size min, ref Drawing.Size max)
        {
            ...
            if (this.HasChildren)
            {
                ...
                if (this.children.DockLayoutCount > 0)
                {
                    Layouts.LayoutEngine.DockEngine.UpdateMinMax(
                        this,
                        context,
                        children,
                        ref min,
                ...
                if (this.children.AnchorLayoutCount > 0)
                {
                    Layouts.LayoutEngine.AnchorEngine.UpdateMinMax(
                        this,
                        context,
                        children,
                        ref min,
                ...
                if (this.children.StackLayoutCount > 0)
                {
                    Layouts.LayoutEngine.StackEngine.UpdateMinMax(
                        this,
                        context,
                        children,
                        ref min,
        ...
        public virtual Caption GetDisplayCaption()
        {
            ...
            if ((commandCaption != null) && (commandCaption.Id.IsValid))
            {
                ICaptionResolver manager =
                    Visual.cachedCaptionResolver ?? Helpers.VisualTree.GetCaptionResolver(this);
        ...
        protected virtual void OnSizeChanged(Drawing.Size oldValue, Drawing.Size newValue)
        {
            PropertyChangedEventHandler handler =
                this.GetUserEventHandler<DependencyPropertyChangedEventArgs>("SizeChanged");
        ...
        protected virtual void OnBoundsChanged(
            Drawing.Rectangle oldValue,
            Drawing.Rectangle newValue
        )
        {
            PropertyChangedEventHandler handler =
                this.GetUserEventHandler<DependencyPropertyChangedEventArgs>("BoundsChanged");
        ...
        private static void NotifyValidationGroupsChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            Visual that = o as Visual;
            that.OnValidationGroupsChanged(
                new DependencyPropertyChangedEventArgs(
                    Visual.ValidationGroupsProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        private static void NotifyParentChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            Visual that = o as Visual;
            that.OnParentChanged(
                new DependencyPropertyChangedEventArgs(Visual.ParentProperty, oldValue, newValue)
            );
        }

        private static void NotifyKeyboardFocusChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            Visual that = o as Visual;
            that.OnKeyboardFocusChanged(
                new DependencyPropertyChangedEventArgs(
                    Visual.KeyboardFocusProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        private static void NotifyCommandObjectChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            Visual that = o as Visual;
            that.OnCommandObjectChanged(
                new DependencyPropertyChangedEventArgs(
                    Visual.CommandObjectProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        private static void NotifyCaptionIdChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        {
            add { this.AddEventHandler(Visual.ParentProperty, value); }
            remove { this.RemoveEventHandler(Visual.ParentProperty, value); }
        }

        public event EventHandler ChildrenChanged
        {
            add { this.AddUserEventHandler("ChildrenChanged", value); }
        ...
        public event PropertyChangedEventHandler IsVisibleChanged
        {
            ...
            remove { this.RemoveEventHandler(Visual.IsVisibleProperty, value); }
        }

        public event PropertyChangedEventHandler IsEnabledChanged
        {
            add { this.AddEventHandler(Visual.IsEnabledProperty, value); }
            remove { this.RemoveEventHandler(Visual.IsEnabledProperty, value); }
        }

        public event PropertyChangedEventHandler IsFocusedChanged
        {
            add { this.AddEventHandler(Visual.IsFocusedProperty, value); }
            remove { this.RemoveEventHandler(Visual.IsFocusedProperty, value); }
        }

        public event PropertyChangedEventHandler KeyboardFocusChanged
        {
            add { this.AddEventHandler(Visual.KeyboardFocusProperty, value); }
            remove { this.RemoveEventHandler(Visual.KeyboardFocusProperty, value); }
        }

        public event PropertyChangedEventHandler PaddingChanged
        {
            add { this.AddEventHandler(Visual.PaddingProperty, value); }
            remove { this.RemoveEventHandler(Visual.PaddingProperty, value); }
        }

        public event PropertyChangedEventHandler MarginsChanged
        {
            add { this.AddEventHandler(Visual.MarginsProperty, value); }
            remove { this.RemoveEventHandler(Visual.MarginsProperty, value); }
        }

        public event EventHandler DisplayCaptionChanged
        {
            add { this.AddUserEventHandler("DisplayCaptionChanged", value); }
            remove { this.RemoveUserEventHandler("DisplayCaptionChanged", value); }
        }

        public event PropertyChangedEventHandler BoundsChanged
        {
            add { this.AddUserEventHandler("BoundsChanged", value); }
            remove { this.RemoveUserEventHandler("BoundsChanged", value); }
        }

        public event PropertyChangedEventHandler SizeChanged
        {
            add { this.AddUserEventHandler("SizeChanged", value); }
            remove { this.RemoveUserEventHandler("SizeChanged", value); }
        }

        public event EventHandler Measuring
        {
            add { this.AddUserEventHandler("Measuring", value); }
            remove { this.RemoveUserEventHandler("Measuring", value); }
        }
        ...
        public static readonly DependencyProperty IndexProperty = DependencyProperty.Register(
            ...
            typeof(int),
            typeof(Visual),
            new DependencyPropertyMetadata(-1)
        );
        ...
        public static readonly DependencyProperty NameProperty =
            DependencyObjectTree.NameProperty.AddOwner(typeof(Visual));
        public static readonly DependencyProperty ParentProperty =
            DependencyObjectTree.ParentProperty.AddOwner(
                typeof(Visual),
                new VisualPropertyMetadata(
                    new GetValueOverrideCallback(Visual.GetParentValue),
                    new PropertyInvalidatedCallback(Visual.NotifyParentChanged),
                    VisualPropertyMetadataOptions.None
                )
            );
        public static readonly DependencyProperty ChildrenProperty =
            DependencyObjectTree.ChildrenProperty.AddOwner(
                typeof(Visual),
                new VisualPropertyMetadata(
                    new GetValueOverrideCallback(Visual.GetChildrenValue)
                ).MakeReadOnlySerializable()
            );
        public static readonly DependencyProperty HasChildrenProperty =
            DependencyObjectTree.HasChildrenProperty.AddOwner(
                typeof(Visual),
                new VisualPropertyMetadata(new GetValueOverrideCallback(Visual.GetHasChildrenValue))
            );
        ...
        public static readonly DependencyProperty MarginsProperty = DependencyProperty.Register(
            "Margins",
            typeof(Drawing.Margins),
            typeof(Visual),
            new VisualPropertyMetadata(
                Drawing.Margins.Zero,
                VisualPropertyMetadataOptions.AffectsArrange
            )
        );
        public static readonly DependencyProperty PaddingProperty = DependencyProperty.Register(
            ...
            new VisualPropertyMetadata(
                Drawing.Margins.Zero,
                VisualPropertyMetadataOptions.AffectsChildrenLayout
                    | VisualPropertyMetadataOptions.AffectsMeasure
            )
        );
        ...
        public static readonly DependencyProperty ContentAlignmentProperty =
            DependencyProperty.Register(
                ...
                new VisualPropertyMetadata(
                    ...
                    VisualPropertyMetadataOptions.AffectsTextLayout
                )
            );
        public static readonly DependencyProperty ContainerLayoutModeProperty =
            DependencyProperty.Register(
                "ContainerLayoutMode",
                typeof(ContainerLayoutMode),
                typeof(Visual),
                new VisualPropertyMetadata(
                    ContainerLayoutMode.VerticalFlow,
                    VisualPropertyMetadataOptions.AffectsChildrenLayout
                )
            );
        ...
        public static readonly DependencyProperty PreferredWidthProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(Visual),
                new VisualPropertyMetadata(80.0, VisualPropertyMetadataOptions.AffectsMeasure)
            );
        public static readonly DependencyProperty PreferredHeightProperty =
            DependencyProperty.Register(
                ...
                typeof(double),
                typeof(Visual),
                new VisualPropertyMetadata(20.0, VisualPropertyMetadataOptions.AffectsMeasure)
            );
        ...
        public static readonly DependencyProperty MinWidthProperty = DependencyProperty.Register(
            ...
            typeof(double),
            typeof(Visual),
            new VisualPropertyMetadata(0.0, VisualPropertyMetadataOptions.AffectsMeasure)
        );
        ...
        public static readonly DependencyProperty ActiveStateProperty = DependencyProperty.Register(
            ...
            new VisualPropertyMetadata(
                ActiveState.No,
                Visual.NotifyActiveStateChanged,
        ...
        public static readonly DependencyProperty EnableProperty = DependencyProperty.Register(
            ...
            new VisualPropertyMetadata(
                true,
                new SetValueOverrideCallback(Visual.SetEnableValue),
                VisualPropertyMetadataOptions.None
            ).MakeNotSerializable()
        );
        public static readonly DependencyProperty EnteredProperty = DependencyProperty.Register(
            "Entered",
            typeof(bool),
            typeof(Visual),
            new VisualPropertyMetadata(
        ...
        public static readonly DependencyProperty InErrorProperty = DependencyProperty.Register(
            "InError",
            typeof(bool),
            typeof(Visual),
            new VisualPropertyMetadata(
        ...
        public static readonly DependencyProperty UndefinedLanguageProperty =
            DependencyProperty.Register(
                "UndefinedLanguage",
                typeof(bool),
                typeof(Visual),
        ...
        public static readonly DependencyProperty InheritsParentFocusProperty =
            DependencyProperty.Register(
                "InheritsParentFocus",
                typeof(bool),
                typeof(Visual),
                new VisualPropertyMetadata(
                    false,
                    Visual.SetInheritsParentFocus,
                    VisualPropertyMetadataOptions.None
                )
            );

        public static readonly DependencyProperty DrawDesignerFrameProperty =
            DependencyProperty.Register(
                "DrawDesignerFrame",
                typeof(bool),
                typeof(Visual),
        ...
        public static readonly DependencyProperty DrawFrameEdgesProperty =
            DependencyProperty.Register(
                "DrawFrameEdges",
                typeof(FrameEdges),
                typeof(Visual),
        ...
        public static readonly DependencyProperty DrawFrameWidthProperty =
            DependencyProperty.Register(
                "DrawFrameWidth",
                typeof(double),
                typeof(Visual),
                new VisualPropertyMetadata(1.0, VisualPropertyMetadataOptions.AffectsDisplay)
            );
        ...
        public static readonly DependencyProperty KeyboardFocusProperty =
            DependencyProperty.RegisterReadOnly(
                ...
                new VisualPropertyMetadata(
                    false,
                    new SetValueOverrideCallback(Visual.SetKeyboardFocusValue),
                    VisualPropertyMetadataOptions.AffectsDisplay
                )
            );
        public static readonly DependencyProperty ContainsKeyboardFocusProperty =
            DependencyProperty.RegisterReadOnly(
                ...
                new VisualPropertyMetadata(
                    false,
                    new GetValueOverrideCallback(Visual.GetContainsKeyboardFocusValue),
                    VisualPropertyMetadataOptions.ChangesSilently
                )
            );
        ...
        public static readonly DependencyProperty IsValidProperty =
            DependencyProperty.RegisterReadOnly(
                ...
                typeof(bool),
                typeof(Visual),
                new DependencyPropertyMetadata(Visual.GetIsValidValue)
            );
        ...
        public static readonly DependencyProperty ValidationGroupsProperty =
            DependencyProperty.Register(
                "ValidationGroups",
                typeof(string),
                typeof(Visual),
                new DependencyPropertyMetadata(Visual.NotifyValidationGroupsChanged)
            );
        public static readonly DependencyProperty CaptionResolverProperty =
            DependencyProperty.Register(
                "CaptionResolver",
                typeof(ICaptionResolver),
                typeof(Visual),
                new DependencyPropertyMetadata()
            );

        public static readonly DependencyProperty SyncPaintProperty = DependencyProperty.Register(
            "SyncPaint",
            typeof(bool),
            typeof(Visual),
            new DependencyPropertyMetadata(false)
        );
        public static readonly DependencyProperty AutoCaptureProperty = DependencyProperty.Register(
            "AutoCapture",
            typeof(bool),
            typeof(Visual),
            new DependencyPropertyMetadata(true)
        );
        ...
        public static readonly DependencyProperty AutoEngageProperty = DependencyProperty.Register(
            "AutoEngage",
            typeof(bool),
            typeof(Visual),
            new DependencyPropertyMetadata(false)
        ...
        public static readonly DependencyProperty AutoRadioProperty = DependencyProperty.Register(
            "AutoRadio",
            typeof(bool),
            typeof(Visual),
            new DependencyPropertyMetadata(false)
        );
        public static readonly DependencyProperty AutoDoubleClickProperty =
            DependencyProperty.Register(
                "AutoDoubleClick",
                typeof(bool),
                typeof(Visual),
        ...
        public static readonly DependencyProperty AcceptThreeStatePropery =
            DependencyProperty.Register(
                "AcceptThreeState",
                typeof(bool),
                typeof(Visual),
        ...
        public static readonly DependencyProperty AcceptFurtivePropery =
            DependencyProperty.Register(
                "AcceptFurtive",
                typeof(bool),
                typeof(Visual),
        ...
        public static readonly DependencyProperty CommandObjectProperty =
            DependencyProperty.Register(
                "CommandObject",
                typeof(Command),
                typeof(Visual),
                new VisualPropertyMetadata(
                    null,
                    new PropertyInvalidatedCallback(Visual.NotifyCommandObjectChanged),
                    VisualPropertyMetadataOptions.AffectsDisplay
                )
            );
        public static readonly DependencyProperty CaptionIdProperty = DependencyProperty.Register(
            ...
            new VisualPropertyMetadata(
                Druid.Empty,
                new PropertyInvalidatedCallback(Visual.NotifyCaptionIdChanged),
                VisualPropertyMetadataOptions.AffectsDisplay
            )
        );
        private static readonly DependencyProperty CommandCacheIdProperty =
            DependencyProperty.Register(
                "CommandCacheId",
                typeof(int),
                typeof(Visual),
                new VisualPropertyMetadata(-1)
            );
