...
namespace Epsitec.Common.Widgets
{
    ...
    public class GroupBox : AbstractGroup
    {
        ...
        public GroupBox(Widget embedder)
            : this()
        {
        ...
        protected override Drawing.Size GetTextLayoutSize()
        {
            ...
            else
            {
                ...
                double dx =
                    ((width == null) || width.Desired.IsSafeNaN())
                        ? this.PreferredWidth
                        : width.Desired;
                double dy =
                    ((height == null) || height.Desired.IsSafeNaN())
        ...
        public override Drawing.Margins GetInternalPadding()
        {
            ...
            return new Drawing.Margins(
                frame.Left - client.Left,
                client.Right - frame.Right,
