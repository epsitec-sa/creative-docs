...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class Shortcut : DependencyObject, System.IEquatable<Shortcut>
    {
        ...
        public Shortcut(char code, ModifierKeys modifier)
        {
            ...
            else
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format("No KeyCode mapping for shortcut char '{0}'", code)
                );
            }
        }
        ...
        public char KeyChar
        {
            get { return (char)(this.KeyCode & KeyCode.KeyCodeMask); }
        }
        ...
        {
            get { return (this.KeyCode & KeyCode.ModifierShift) != 0; }
        }
        ...
        {
            get { return (this.KeyCode & KeyCode.ModifierControl) != 0; }
        }
        ...
        {
            get { return (this.KeyCode & KeyCode.ModifierAlt) != 0; }
        }
        ...
        public bool IsEmpty
        {
            get { return this.keyCode == KeyCode.None; }
        }
        ...
        public static Shortcut FromMessage(Message message)
        {
            ...
            {
                if ((keyCode != KeyCode.None) && (message.IsAltPressed))
                {
                ...
                foreach (Shortcut shortcut in shortcuts)
                {
                    if (!shortcut.IsEmpty)
                    {
                        return string.Format(
                            Res.Strings.Shortcut.Template.TextWithShortcut.ToString(),
                            text,
                            shortcut
                        );
                    }
        ...
        public static bool HasShortcuts(DependencyObject obj)
        {
            Collections.ShortcutCollection shortcuts =
                obj.GetValueBase(Shortcut.ShortcutsProperty) as Collections.ShortcutCollection;
        ...
        public static readonly DependencyProperty ShortcutsProperty =
            DependencyProperty<Shortcut>.RegisterAttached<Collections.ShortcutCollection>(
                "Shortcuts",
                new DependencyPropertyMetadata(Shortcut.GetShortcutsValue)
            );
        public static readonly DependencyProperty KeyCodeProperty =
            DependencyProperty<Shortcut>.Register(
                x => x.KeyCode,
                typeof(string),
                new DependencyPropertyMetadata(Shortcut.GetKeyCodeValue, Shortcut.SetKeyCodeValue)
            );
