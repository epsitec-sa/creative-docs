...
namespace Epsitec.Common.Widgets
{
    ...
    public abstract class AbstractMenu : Widget, Collections.IWidgetCollectionHost<MenuItem>
    {
        ...
        public abstract MenuOrientation MenuOrientation { get; }

        public bool IsHorizontal
        {
            get { return this.MenuOrientation == MenuOrientation.Horizontal; }
        }

        public bool IsVertical
        {
            get { return this.MenuOrientation == MenuOrientation.Vertical; }
        }
        ...
        {
            get { return this.autoDisposeOnCleanup; }
            set { this.autoDisposeOnCleanup = value; }
        }
        ...
        {
            get { return MenuItem.GetMenuBehavior(this); }
        }
        ...
        private DependencyObject FindHost()
        {
            ...
            if ((window != null) && (window.ParentWidget != null))
            {
        ...
        private class MenuHost : IMenuHost
        {
            ...
            public void GetMenuDisposition(
                Widget item,
            ...
            )
            {
                ...
                {
                    Drawing.Point test = Helpers.VisualTree.MapVisualToScreen(
                        item,
                        new Drawing.Point(item.ActualWidth, 0)
                    );
                    ...
                    if (test.X <= workingArea.Right)
                    {
                        ...
                        location = Helpers.VisualTree.MapVisualToScreen(
                            item,
                            new Drawing.Point(item.ActualWidth, item.ActualHeight)
                        );
                    ...
                    else
                    {
                        ...
                        location = Helpers.VisualTree.MapVisualToScreen(
                            item,
                            new Drawing.Point(0, item.ActualHeight)
                        );
        ...
        {
            add { this.AddUserEventHandler("Accepted", value); }
            remove { this.RemoveUserEventHandler("Accepted", value); }
        }

        public event EventHandler Rejected
        {
            add { this.AddUserEventHandler("Rejected", value); }
            remove { this.RemoveUserEventHandler("Rejected", value); }
        }
