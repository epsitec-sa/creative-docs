...
namespace Epsitec.Common.Widgets
{
    ...
    /// </summary>
    public class RibbonBook
        : AbstractGroup,
            Collections.IWidgetCollectionHost<RibbonPage>,
            Collections.IWidgetCollectionHost<Button>
    {
        public RibbonBook()
        {
        ...
        public RibbonBook(Widget embedder)
            : this()
        {
        ...
        public int ActivePageIndex
        {
            ...
            {
                RibbonPage page =
                    ((value >= 0) && (value < this.PageCount)) ? this.Pages[value] : null;
        ...
        {
            get { return this.pageItems.Count; }
        }
        ...
        {
            public RibbonPageCollection(RibbonBook book)
                : base(book) { }
        ...
        protected static readonly double TabHeight =
            RibbonBook.TopMargin + RibbonButton.DefaultHeight - 1;
