...
namespace Epsitec.Common.Widgets
{
    ...
    public partial class Widget
        : Visual,
            Collections.IShortcutCollectionHost,
            Support.IIsDisposed,
            Support.IDisposed
    {
        public Widget()
        {
            if (Widget.DebugDispose)
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format("{1}+ Created {0}", this.GetType().Name, this.GetVisualSerialId())
                );
            }
        ...
        public void NotifyShortcutsChanged(
            Epsitec.Common.Widgets.Collections.ShortcutCollection collection
        )
        {
        ...
        protected override void Dispose(bool disposing)
        {
            if (Widget.DebugDispose)
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format(
                        "{2}- {0} widget {1}",
                        (disposing ? "Disposing" : "Collecting"),
                        this.ToString(),
                        this.GetVisualSerialId()
                    )
                );
            }
        ...
        {
            get { return (this.internalState & WidgetInternalState.DebugActive) != 0; }
            set
            {
                if (value)
                {
        ...
        {
            get { return Widget.debugDispose; }
            set { Widget.debugDispose = value; }
        }
        ...
        {
            get { return System.Math.Round(Drawing.TextStyle.Default.FontSize * 1.2 + 1); }
        }
        ...
        public bool IsEmbedded
        {
            ...
            get { return (this.internalState & WidgetInternalState.Embedded) != 0; }
        }
        ...
        {
            get { return (this.internalState & WidgetInternalState.Disposing) != 0; }
        }
        ...
        {
            get { return (this.internalState & WidgetInternalState.Disposed) != 0; }
        }
        ...
        {
            get { return (this.InternalState & WidgetInternalState.ExecCmdOnPressed) != 0; }
            set
            {
                if (value)
                {
        ...
        {
            get { return (this.internalState & WidgetInternalState.AutoMnemonic) != 0; }
            set
            {
        ...
        {
            get { return (this.internalState & WidgetInternalState.AutoFitWidth) != 0; }
            set
            {
        ...
        public bool CanSelect
        {
            get
            {
                return ((this.internalState & WidgetInternalState.Selectable) != 0)
                    && !this.IsFrozen;
            }
        }
        ...
        public bool CanEngage
        {
            get
            {
                return ((this.internalState & WidgetInternalState.Engageable) != 0)
                    && this.IsEnabled
                    && !this.IsFrozen;
            }
        }
        ...
        public bool PossibleContainer
        {
            get
            {
                return this.internalState.HasFlag(WidgetInternalState.PossibleContainer)
                    && !this.IsFrozen;
            }
        }
        ...
        public bool IsFence
        {
            get { return this.internalState.HasFlag(WidgetInternalState.Fence); }
            set
            {
                if (value)
                {
        ...
        {
            get { return VisualTree.GetOpletQueue(this); }
            set { throw new System.InvalidOperationException("Cannot set OpletQueue on Widget."); }
        }
        ...
        public FormattedText FormattedText
        {
            ...
            set { this.Text = value.IsNull() ? null : value.ToString(); }
        }

        public string Text
        {
            get { return (string)this.GetValueBase(Widget.TextProperty) ?? ""; }
            set
            {
        ...
        {
            get { return (string)this.GetValue(Widget.IconUriProperty); }
            set
            {
                if (string.IsNullOrEmpty(value))
                {
        ...
        public int TabIndex
        {
            get { return (int)this.GetValue(Widget.TabIndexProperty); }
            set
            {
                if (this.TabIndex != value)
                {
                    ...
                    if ((this.TabNavigationMode == TabNavigationMode.None) && (value > 0))
                    {
        ...
        {
            get { return TabNavigationMode.ActivateOnTab; }
        }

        public virtual TabNavigationMode TabNavigationMode
        {
            get { return (TabNavigationMode)this.GetValue(Widget.TabNavigationModeProperty); }
            set { this.SetValue(Widget.TabNavigationModeProperty, value); }
        }

        public Widget ForwardTabOverride
        {
            get { return (Widget)this.GetValue(Widget.ForwardTabOverrideProperty); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return (Widget)this.GetValue(Widget.BackwardTabOverrideProperty); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return (Widget)this.GetValue(Widget.ForwardEnterTabOverrideProperty); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return (Widget)this.GetValue(Widget.BackwardEnterTabOverrideProperty); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return SystemInformation.InitialKeyboardDelay; }
        }

        public virtual double AutoEngageRepeatPeriod
        {
            get { return SystemInformation.KeyboardRepeatPeriod; }
        }
        ...
        public Widget Embedder
        {
            ...
            set { this.SetEmbedder(value); }
        }

        public static readonly IComparer<Widget> TabIndexComparer =
            new TabIndexComparerImplementation();

        public virtual Drawing.Size GetBestFitSize()
        {
            Types.DependencyPropertyMetadata metadataDx = Visual.PreferredWidthProperty.GetMetadata(
                this
            );
            Types.DependencyPropertyMetadata metadataDy =
                Visual.PreferredHeightProperty.GetMetadata(this);

            return new Drawing.Size(
                (double)metadataDx.DefaultValue,
                (double)metadataDy.DefaultValue
            );
        }
        ...
        {
            if ((this.AutoRadio) && (this.ActiveState == ActiveState.Yes))
            {
                return;
            }
        ...
        {
            this.SetValue(
                Visual.ValidatorProperty,
                MulticastValidator.Combine(this.Validator, value)
            );
        ...
        public void ClearFocus()
        {
            if (this.KeyboardFocus)
            {
                ...
                if ((window != null) && (window.FocusedWidget == this))
                {
        ...
        protected void SetEntered(bool value)
        {
            if (this.IsEntered != value)
            {
                ...
                if (value)
                {
                    ...
                    this.OnEntered(
                        new MessageEventArgs(message, Message.CurrentState.LastPosition)
                    );
                }
                else
                {
        ...
        {
            Widget.ProcessEntered(candidate =>
            {
        ...
        internal static void UpdateEntered(Window window, Widget widget, Message message)
        {
            ...
            )
            {
                ...
                if ((window.EngagedWidget == widget) && (window.CapturingWidget != widget))
                {
                    window.EngagedWidget = null;
                }
            }
        ...
        public virtual Drawing.Rectangle GetClipStackBounds()
        {
            ...
            if (this.Parent != null)
            {
                clip = Drawing.Rectangle.Intersection(
                    clip,
                    this.MapParentToClient(this.Parent.GetClipStackBounds())
                );
            }
        ...
        public Drawing.Point MapRootToClient(
            Drawing.Point point,
            System.Predicate<Widget> isRoot = null
        )
        {
            if ((this.IsDisposing) || (isRoot != null && isRoot(this)))
            {
                return point;
            }
        ...
        public Drawing.Point MapClientToRoot(
            Drawing.Point point,
            System.Predicate<Widget> isRoot = null
        )
        {
        ...
        )
        {
            if (this.TextLayout != null)
            {
                ...
                this.TextLayout.GetSingleLineGeometry(
        ...
        public virtual Widget FindChild(
            Drawing.Point point,
            IEnumerable<Widget> ignore,
            WidgetChildFindMode mode
        )
        {
            ...
            for (int i = 0; i < childrenNum; i++)
            {
                ...
                if ((mode & WidgetChildFindMode.SkipMask) != WidgetChildFindMode.All)
                {
                    ...
                    {
                        if ((widget.Visibility == false) || (widget.Client.Bounds.IsSurfaceZero))
                        {
                            continue;
                        }
                    }
                ...
                if (widget.HitTest(point))
                {
                    ...
                    if ((mode & WidgetChildFindMode.Deep) != 0)
                    {
                        ...
                        Widget deep = widget.FindChild(
                            widget.MapParentToClient(point),
                            ignore,
                            mode
                        );
        ...
        public void SetFocusOnTabWidget()
        {
            ...
            var navigator = new TabNavigator(
                TabNavigationDir.Forwards,
                TabNavigationMode.ActivateOnTab
            );
            var focus = navigator.FindTabWidget(this);
            ...
            if (
                (focused == null)
                || (
                    focused.InternalAboutToLoseFocus(
                        TabNavigationDir.Forwards,
                        TabNavigationMode.ActivateOnTab
                    )
                )
        ...
        {
            var navigator = new TabNavigator(dir, mode);
            return navigator.FindTabWidget(this, acceptFocus: false);
        }
        ...
        protected virtual bool FilterTabNavigationSibling(
            Widget sibling,
        ...
        protected virtual bool ProcessTabChildrenExit(
            TabNavigationDir dir,
            TabNavigationMode mode,
            out Widget focus
        )
        ...
        internal bool InternalAboutToGetFocus(
            TabNavigationDir dir,
            TabNavigationMode mode,
            out Widget focus
        )
        ...
        protected virtual bool AboutToGetFocus(
            TabNavigationDir dir,
            TabNavigationMode mode,
            out Widget focus
        )
        ...
        {
            if ((this.HasCommand) && (this.IsEnabled))
            {
        ...
        protected virtual void UpdateCaption(bool updateIconUri)
        {
            ...
            else
            {
                ...
                if (caption != null)
                {
                        ...
                        if (
                            (
                                UndefinedValue.IsUndefinedValue(
                                    this.GetLocalValue(Visual.NameProperty)
                                )
                    ...
                    {
                        textLabel = TextLayout.SelectBestText(
                            this.TextLayout,
                            caption.SortedLabels,
                            this.GetTextLayoutSize()
                        );
                    ...
                    if (!string.IsNullOrEmpty(description))
                    {
                        ...
                        if ((this.HasTextLabel == false) || (textLabel != tip))
                        {
                    ...
                    if ((caption.HasIcon) && (updateIconUri))
                    {
        ...
        {
            Drawing.Image image = Support.ImageProvider.Instance.GetImage(
                icon,
        ...
        public virtual void PaintHandler(
            Drawing.Graphics graphics,
            Drawing.Rectangle repaint,
            IPaintFilter paintFilter
        )
        {
            if ((paintFilter != null) && (paintFilter.IsWidgetFullyDiscarded(this)))
            {
                return;
            }
            ...
            if (this.DebugActive)
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format(
                        "{0}: clip {1}, widget {2}",
                        this.ToString(),
                        graphics.SaveClippingRectangle().ToString(),
                        this.MapClientToRoot(this.Client.Bounds).ToString()
                    )
                );
            }
            ...
            if (this.PaintCheckClipping(repaint))
            {
                ...
                Drawing.Transform graphicsTransform = Drawing.Transform.CreateTranslationTransform(
                    this.ActualLocation
                );
                ...
                try
                {
                    ...
                    if (
                        (paintFilter == null) || (paintFilter.IsWidgetPaintDiscarded(this) == false)
                    )
                    {
                    ...
                    if (this.HasChildren)
                    {
                        ...
                        for (int i = 0; i < childrenNum; i++)
                        {
                            ...
                            if (
                                (widget.Visibility) && (widget.Client.Bounds.IsSurfaceZero == false)
                            )
                            {
        ...
        protected virtual void PaintBackgroundImplementation(
            Drawing.Graphics graphics,
        ...
        protected virtual void PaintForegroundImplementation(
            Drawing.Graphics graphics,
            Drawing.Rectangle clipRect
        )
        {
        ...
        public virtual void MessageHandler(Message message, Drawing.Point pos)
        {
            ...
            )
            {
                ...
                for (int i = 0; i < childrenNum; i++)
                {
                    Widget widget = children[childrenNum - 1 - i];
                    bool containsFocus =
                        (root == null) ? false : root.DoesVisualContainKeyboardFocus(widget);
                    ...
                    )
                    {
                        if (widget.IsEnabled)
                        {
                            if (message.IsMouseType)
                            {
                                ...
                                {
                                    if ((this.IsEntered) && (widget.IsEntered == false))
                                    {
                                        widget.SetEntered(true);
                                    }
            ...
            {
                if ((this.IsEntered == false) && (message.InWidget == this))
                {
                    this.SetEntered(true);
                }
            }
        ...
        protected virtual void DispatchMessage(Message message, Drawing.Point pos)
        {
                        ...
                        if (isEntered)
                        {
                            switch (message.ButtonDownCount)
                            {
                                ...
                                default:
                                    System.Diagnostics.Debug.WriteLine(
                                        string.Format(
                                            "Multiple-click (button down count is {0}) not handled",
                                            message.ButtonDownCount
                                        )
                                    );
                                    break;
                            }
            ...
            {
                System.Diagnostics.Debug.WriteLine(
                    "Dispatching to invisible widget: " + this.ToString()
                );
            }
        }
        ...
        protected virtual bool ShortcutHandler(Shortcut shortcut, bool executeFocused)
        {
            ...
            for (int i = 0; i < childrenNum; i++)
            {
                ...
                if ((widget.IsEnabled) && (widget.IsFrozen == false) && (widget.Visibility))
                {
        ...
        {
            if ((this.shortcuts != null) && (this.shortcuts.Contains(shortcut)))
            {
        ...
        protected virtual void NotifyWindowChanged(Window oldWindow, Window newWindow)
        {
            ...
            if ((newWindow != null) && (this.Validator != null))
            {
        ...
        {
            var handler = this.GetUserEventHandler<MessageEventArgs>(
                Widget.EventNames.MouseMoveEvent
            );
        ...
        {
            add { this.AddUserEventHandler("PaintBackground", value); }
            remove { this.RemoveUserEventHandler("PaintBackground", value); }
        }

        public event Support.EventHandler<PaintEventArgs> PaintForeground
        {
            add { this.AddUserEventHandler("PaintForeground", value); }
            remove { this.RemoveUserEventHandler("PaintForeground", value); }
        }
        ...
        {
            add { this.AddUserEventHandler(Widget.EventNames.MouseMoveEvent, value); }
            remove { this.RemoveUserEventHandler(Widget.EventNames.MouseMoveEvent, value); }
        }
        ...
        private static void NotifyIconUriChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty TabNavigationModeProperty =
            DependencyProperty.Register(
                "TabNavigationMode",
                typeof(TabNavigationMode),
                typeof(Widget),
                new DependencyPropertyMetadata(TabNavigationMode.None)
            );

        public static readonly DependencyProperty ForwardTabOverrideProperty =
            DependencyProperty.Register("ForwardTabOverride", typeof(Widget), typeof(Widget));
        public static readonly DependencyProperty BackwardTabOverrideProperty =
            DependencyProperty.Register("BackwardTabOverride", typeof(Widget), typeof(Widget));
        public static readonly DependencyProperty ForwardEnterTabOverrideProperty =
            DependencyProperty.Register("ForwardEnterTabOverride", typeof(Widget), typeof(Widget));
        public static readonly DependencyProperty BackwardEnterTabOverrideProperty =
            DependencyProperty.Register("BackwardEnterTabOverride", typeof(Widget), typeof(Widget));
