...
namespace Epsitec.Common.Widgets
{
    ...
    public class TabBook : AbstractGroup, Collections.IWidgetCollectionHost<TabPage>
    {
        ...
        public TabBook(Widget embedder)
            : this()
        {
        ...
        public Drawing.Margins InternalPadding { get; set; }
        ...
        public int ActivePageIndex
        {
            ...
            {
                TabPage page =
                    ((value >= 0) && (value < this.PageCount)) ? this.Items[value] : null;
        ...
        protected void UpdateOffset()
        {
            ...
            {
                this.scrollOffset = System.Math.Min(
                    this.scrollOffset,
                    this.scrollTotalWidth - this.TabOffsetMax
                );
        ...
        protected void UpdateGlyphButtons()
        {
            ...
            if (this.scrollArrow)
            {
                if (this.Arrows == TabBookArrows.LeftRight)
                {
                    ...
                    rect = new Drawing.Rectangle(
                        0,
                        this.Client.Size.Height - this.tabHeight,
                        this.tabHeight,
                        this.tabHeight
                    );
                    rect.Deflate(2, 2);
                    ...
                    this.arrowRight.Enable = (
                        this.scrollOffset < this.scrollTotalWidth - this.TabOffsetMax
                    );
                }
                else if (this.Arrows == TabBookArrows.Right)
                {
            ...
            {
                Drawing.Rectangle rect = new Drawing.Rectangle(
                    this.Client.Size.Width - (this.tabHeight - 2),
                    this.Client.Size.Height - this.tabHeight,
                    this.tabHeight,
                    this.tabHeight
                );
        ...
        )
        {
            ...
            Drawing.Rectangle part = Drawing.Rectangle.Deflate(
                this.Client.Bounds,
                new Drawing.Margins(0, 0, this.TabHeight, 0)
            );
        ...
        {
            public TabPageCollection(TabBook book)
                : base(book) { }
        }
        #endregion
        ...
        {
            add { this.AddUserEventHandler("CloseClicked", value); }
            remove { this.RemoveUserEventHandler("CloseClicked", value); }
        }

        public event EventHandler MenuClicked
        {
            add { this.AddUserEventHandler("MenuClicked", value); }
            remove { this.RemoveUserEventHandler("MenuClicked", value); }
        }

        public event EventHandler PageCountChanged
        {
            add { this.AddUserEventHandler("PageCountChanged", value); }
            remove { this.RemoveUserEventHandler("PageCountChanged", value); }
        }

        public event EventHandler<CancelEventArgs> ActivePageChanged
        {
            add { this.AddUserEventHandler("ActivePageChanged", value); }
            remove { this.RemoveUserEventHandler("ActivePageChanged", value); }
        }
