...
namespace Epsitec.Common.Widgets.Layouts
{
    ...
    public sealed class ColumnDefinition : DependencyObject
    {
        ...
        public double MinWidth
        {
            ...
            set { this.SetValue(ColumnDefinition.MinWidthProperty, value); }
        }
        ...
        public double MaxWidth
        {
            ...
            set { this.SetValue(ColumnDefinition.MaxWidthProperty, value); }
        }
        ...
        public GridLength Width
        {
            ...
            set { this.SetValue(ColumnDefinition.WidthProperty, value); }
        }
        ...
        public double LeftBorder
        {
            ...
            set { this.SetValue(ColumnDefinition.LeftBorderProperty, value); }
        }
        ...
        public double RightBorder
        {
            ...
            set { this.SetValue(ColumnDefinition.RightBorderProperty, value); }
        }
        ...
        {
            get { return (bool)this.GetValue(ColumnDefinition.VisibilityProperty); }
            set { this.SetValue(ColumnDefinition.VisibilityProperty, value); }
        }
        ...
        public static readonly DependencyProperty MinWidthProperty = DependencyProperty.Register(
            ...
            new DependencyPropertyMetadata(0.0, ColumnDefinition.NotifyPropertyInvalidated)
        );
        public static readonly DependencyProperty MaxWidthProperty = DependencyProperty.Register(
            ...
            new DependencyPropertyMetadata(
                ...
                ColumnDefinition.NotifyPropertyInvalidated
            )
        );
        ...
        public static readonly DependencyProperty LeftBorderProperty = DependencyProperty.Register(
            "LeftBorder",
            typeof(double),
            typeof(ColumnDefinition),
            new DependencyPropertyMetadata(0.0, ColumnDefinition.NotifyPropertyInvalidated)
        );
        public static readonly DependencyProperty RightBorderProperty = DependencyProperty.Register(
            "RightBorder",
            typeof(double),
            typeof(ColumnDefinition),
            new DependencyPropertyMetadata(0.0, ColumnDefinition.NotifyPropertyInvalidated)
        ...
        public static readonly DependencyProperty VisibilityProperty = DependencyProperty.Register(
            ...
            typeof(bool),
            typeof(ColumnDefinition),
            new DependencyPropertyMetadata(true, ColumnDefinition.NotifyPropertyInvalidated)
        );
