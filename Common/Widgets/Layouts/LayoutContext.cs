...
namespace Epsitec.Common.Widgets.Layouts
{
    public class LayoutContext : Types.DependencyObject
    {
        ...
        {
            get { return this.measureQueue.Count; }
        }
        public int ArrangeQueueLength
        {
            get { return this.arrangeQueue.Count; }
        }

        public int TotalMeasureCount
        {
            get { return this.totalMeasureCount; }
        }
        public int TotalArrangeCount
        {
            get { return this.totalArrangeCount; }
        }
        ...
        public static void AddToMeasureQueue(Visual visual, LayoutContext merge)
        {
            if (visual != null)
            {
                ...
                {
                    if ((merge == null) || (merge.MeasureQueueLength == 0))
                    {
                        return;
                    }
                }
        ...
        private void AddUnmeasuredChildrenToMeasureQueue(Visual visual, int depth)
        {
            ...
            if (visual.HasChildren)
            {
                foreach (Visual child in visual.Children)
                {
                    ...
                    if ((measureWidth == null) || (measureHeight == null))
                    {
        ...
        private void AddToArrangeQueue(Visual visual, int depth)
        {
            ...
            this.AddToArrangeQueue(
                visual,
                new VisualNode(visual, ++this.nodeRank, SortMode.Arrange, depth)
            );
        }
        ...
        public void ExecuteMeasure()
        {
            ...
            try
            {
                ...
                while (this.measureQueue.Count > 0)
                {
                    ...
                    this.cacheWidthMeasure = this.GetOrCreateCleanMeasure(
                        node.Visual,
                        LayoutMeasure.WidthProperty
                    );
                    this.cacheHeightMeasure = this.GetOrCreateCleanMeasure(
                        node.Visual,
                        LayoutMeasure.HeightProperty
                    );
                    ...
                    if ((this.cacheWidthMeasure.HasChanged) || (this.cacheHeightMeasure.HasChanged))
                    {
                            ...
                            if (mode != LayoutMode.None)
                            {
                                ...
                                if (Helpers.VisualTree.FindLayoutContext(visual) == null)
                                {
                                    System.Diagnostics.Debug.WriteLine(
                                        "No context for visual " + visual.ToString()
                                    );
                                }
                                if (parent == null)
                                {
                                    System.Diagnostics.Debug.WriteLine(
                                        "No parent for visual " + visual.ToString()
                                    );
                                }

                                System.Diagnostics.Debug.Assert(
                                    Helpers.VisualTree.FindLayoutContext(visual) == this
                                );
        ...
        private LayoutMeasure GetOrCreateCleanMeasure(
            Visual visual,
            Types.DependencyProperty property
        )
        {
            object value;
        ...
        private struct VisualNode : System.IEquatable<VisualNode>, System.IComparable<VisualNode>
        {
                ...
                switch (mode)
                {
                    ...
                    default:
                        throw new System.ArgumentException(
                            string.Format("SortMode.{0} not accepted")
                        );
                }
            ...
            public int Depth
            {
                get { return this.depth < 0 ? -this.depth : this.depth; }
            }
            ...
            public int CompareTo(VisualNode other)
            {
                ...
                else if (this.depth > other.depth)
                {
                    ...
                    (object.ReferenceEquals(this.visual, other.visual))
                    &&
        ...
        public static Types.DependencyProperty LayoutContextProperty =
