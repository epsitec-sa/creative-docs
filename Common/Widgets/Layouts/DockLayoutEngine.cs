    ...
    public sealed class DockLayoutEngine : ILayoutEngine
    {
        ...
        )
        {
            ...
            if (pushDy > 0)
            {
                foreach (Visual child in children)
                {
                    ...
                    if ((child.Dock != DockStyle.Bottom) || (child.Visibility == false))
                    {
                        continue;
                    }
            ...
            if (pushDx > 0)
            {
                foreach (Visual child in children)
                {
                    ...
                    if ((child.Dock != DockStyle.Right) || (child.Visibility == false))
                    {
                        continue;
                    }
        ...
        )
        {
            ...
            foreach (Visual child in children)
            {
                ...
                Drawing.Size min = new Drawing.Size(
                    measureDx.Min + margins.Width,
                    measureDy.Min + margins.Height
                );
                Drawing.Size max = new Drawing.Size(
        ...
        internal static void SetChildBounds(
            Visual child,
            Drawing.Rectangle bounds,
            double baseOffset
        )
