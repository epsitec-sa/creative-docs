    ...
    internal sealed class CommandCache
    {
        ...
        public void InvalidateGroup(string group)
        {
            ...
            for (int i = 0; i < this.records.Length; i++)
            {
                ...
                if ((command != null) && (command.Group == group))
                {
        ...
        public void InvalidateContext(CommandContext context)
        {
            ...
            {
                if (
                    (this.records[i].CommandContext == context)
        ...
        private struct Record
        {
            ...
            public bool IsAlive
            {
                get { return this.visual == null ? false : this.visual.IsAlive; }
            }
            ...
            public bool IsDirty
            {
                get { return (this.state == null) && (this.IsAlive); }
            }
            ...
            {
                get { return this.visual == null ? null : this.visual.Target; }
            }
            ...
            {
                get { return this.state == null ? null : this.state.CommandContext; }
            }
        ...
        private void SynchronizeIndex(int index)
        {
            ...
            if (visual != null)
            {
                ...
                if ((command != null) && (chain != null))
                {
                    ...
                    {
                        if ((this.dirtyCount > 0) && (this.records[index].IsDirty))
                        {
                            this.dirtyCount--;
                        }
        ...
        private void RefreshBunchOfFreeIndexes()
        {
            ...
            {
                while ((index < this.records.Length) && (this.records[index].IsAlive))
                {
                    index++;
                }
            ...
            System.Diagnostics.Debug.Assert(
                this.bunchOfFreeIndexesCount
                    == System.Math.Min(this.bunchOfFreeIndexes.Length, this.freeCount)
            );
        }
