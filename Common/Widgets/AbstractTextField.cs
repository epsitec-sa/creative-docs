...
namespace Epsitec.Common.Widgets
{
    ...
    public abstract partial class AbstractTextField : Widget, Types.IReadOnly
    {
        ...
        static AbstractTextField()
        {
            ...
            Types.DependencyPropertyMetadata metadataHeight =
                Visual.PreferredHeightProperty.DefaultMetadata.Clone();

            double height =
                Widget.DefaultFontHeight
                + 2 * (AbstractTextField.TextMargin + AbstractTextField.FrameMargin);

            metadataAlign.DefineDefaultValue(Drawing.ContentAlignment.TopLeft);
            metadataHeight.DefineDefaultValue(height);

            Visual.ContentAlignmentProperty.OverrideMetadata(
                typeof(AbstractTextField),
                metadataAlign
            );
            Visual.PreferredHeightProperty.OverrideMetadata(
                typeof(AbstractTextField),
                metadataHeight
            );
        ...
        {
            get { return this.navigator.IsReadOnly; }
            set
            {
                if (this.navigator.IsReadOnly != value)
                {
                    ...
                    if ((Message.CurrentState.LastWindow == this.Window) && (this.IsEntered))
                    {
                        ...
                        this.UpdateMouseCursor(
                            this.MapRootToClient(Message.CurrentState.LastPosition)
                        );
                    }
        ...
        public bool IsMultilingualText { get; set; }

        public bool AcceptsNullValue
        {
            get { return this.acceptsNullValue; }
            set { this.acceptsNullValue = value; }
        }
        ...
        public bool IsModal
        {
            ...
            set
            {
                if (this.isModal != value)
                {
                    ...
                    if ((window != null) && (window.ModalWidget == this))
                    {
        ...
        {
            get { return (string)this.GetValue(AbstractTextField.HintTextProperty); }
            set
            {
                if (value == null)
                {
        ...
        public System.Func<string, string> HintComparisonConverter { get; set; }

        public int HintOffset
        {
            get { return (int)this.GetValue(AbstractTextField.HintOffsetProperty); }
        }

        public bool IsTextEmpty
        {
            get { return this.navigator.IsEmpty; }
        }

        public bool IsTextNull
        {
            get { return this.Text == ResourceBundle.Field.Null; }
        }

        public bool HasEditedText
        {
            get { return this.hasEditedText; }
        }
        ...
        {
            get { return this.swallowReturn; }
            set { this.swallowReturn = value; }
        }

        public bool SwallowEscapeOnRejectEdition
        {
            get { return this.swallowEscape; }
            set { this.swallowEscape = value; }
        }

        public Drawing.Rectangle InnerTextBounds
        {
            get { return this.GetInnerTextBounds(this.Client.Bounds); }
        }

        protected Drawing.Point LastMousePosition
        {
            get { return this.lastMousePos; }
        }
            ...
            set
            {
                if (this.isEditing != value)
                {
                    ...
                    if (this.isModal)
                    {
                        ...
                        if (window != null)
                        {
                            if ((this.isEditing) && (window.ModalWidget == null))
                            {
        ...
        {
            get { return this.textFieldStyle == TextFieldStyle.Combo; }
        }

        public bool Autocompletion { get; set; }

        public System.Func<string, string> AutocompletionConverter { get; set; }
        ...
        {
            get { return this.navigator.MaxLength; }
            set { this.navigator.MaxLength = value; }
        }

        public TextFieldStyle TextFieldStyle
        {
            get { return this.textFieldStyle; }
            protected set
            {
                if (this.textFieldStyle != value)
                {
                    ...
                    throw new System.InvalidOperationException(
                        string.Format("Cannot switch from {0} to {1}.", this.textFieldStyle, value)
                    );
                }
            }
        }
        ...
        {
            get { return this.navigator.Selection; }
            set { this.navigator.Selection = value; }
        }

        public int Cursor
        {
            get { return this.navigator.Cursor; }
            set { this.navigator.Cursor = value; }
        }

        public int CursorFrom
        {
            get { return this.navigator.CursorFrom; }
            set { this.navigator.CursorFrom = value; }
        }

        public int CursorTo
        {
            get { return this.navigator.CursorTo; }
            set { this.navigator.CursorTo = value; }
        }

        public bool CursorAfter
        {
            get { return this.navigator.CursorAfter; }
            set { this.navigator.CursorAfter = value; }
        }

        public DefocusAction DefocusAction
        {
            get { return (DefocusAction)this.GetValue(AbstractTextField.DefocusActionProperty); }
            set
            {
        ...
        public ButtonShowCondition ButtonShowCondition
        {
            get
            {
                return (ButtonShowCondition)
                    this.GetValue(AbstractTextField.ButtonShowConditionProperty);
            }
            set { this.SetValue(AbstractTextField.ButtonShowConditionProperty, value); }
        }

        public TextFieldDisplayMode TextDisplayMode
        {
            get { return this.textFieldDisplayMode; }
            set
            {
        ...
        {
            get { return this.initialTextDisplayMode; }
            set { this.initialTextDisplayMode = value; }
        }
        ...
        {
            get { return base.AutoEngageDelay / 2; }
        }
        ...
        )
        {
            if (this.TextLayout != null)
            {
                ...
                Drawing.Rectangle bounds = this.GetInnerTextBounds(
                    new Drawing.Rectangle(0, 0, width, height)
                );

                Drawing.Point origin = base.GetBaseLine(
                    width,
                    bounds.Height,
                    out ascender,
                    out descender
        ...
        public Drawing.Margins GetInternalPadding(Drawing.Size size)
        {
            ...
            if (this.textFieldStyle != TextFieldStyle.Flat)
            {
                ...
                double m = this.IsMultilingualText
                    ? Adorners.AbstractAdorner.MultilingualLeftPadding
                    : 0;
        ...
        public bool StartEdition()
        {
            if (
                ...
                && (
                    ...
                    || (this.IsCombo)
                    || (this.ButtonShowCondition != ButtonShowCondition.Never)
                )
            )
            {
        ...
        {
            if ((this.IsEditing) && (this.CheckRejectEdition()))
            {
                this.IsEditing = false;
            ...
            switch (this.DefocusAction)
            {
                ...
                default:
                    throw new System.NotImplementedException(
                        string.Format("{0} not implemented.", this.DefocusAction.GetQualifiedName())
                    );
            }
        }
        ...
        {
            return this.InnerTextBounds.Location
                - this.scrollOffset
                + new Drawing.Point(0, this.GetBaseLineVerticalOffset());
        }
        ...
        internal bool DetectIndex(
            Epsitec.Common.Drawing.Point pos,
            bool select,
            out int index,
            out bool after
        )
        ...
        private void CreateCommandController()
        {
            var dispatcher = new CommandDispatcher(
                ...
                CommandDispatcherOptions.AutoForwardCommands
            );
        ...
        private void EnableScroll(Drawing.Point pos)
        {
            ...
            Drawing.Rectangle box = Drawing.Rectangle.Deflate(
                this.Client.Bounds,
                this.GetInternalPadding()
            );
        ...
        private void ShowContextMenu(bool mouseBased)
        {
            ...
            System.Diagnostics.Debug.Assert(
                context == Helpers.VisualTree.GetCommandContext(this.contextMenu)
            );
            System.Diagnostics.Debug.Assert(
                CommandDispatcherChain.BuildChain(this.contextMenu).IsEmpty == false
            );
            ...
            context.SetLocalEnable(
                ApplicationCommands.MultilingualEdition,
                this.IsMultilingualText & readWrite
            );
        ...
        private void HandleIsFocusedChanged(
            object sender,
            Types.DependencyPropertyChangedEventArgs e
        )
        {
            System.Diagnostics.Debug.Assert(
                Helpers.VisualTree.GetOpletQueue(this) == this.navigator.OpletQueue
            );
        ...
        protected virtual void OnCursorChanged(bool silent)
        {
            ...
            if ((this.navigator.Context.HasSelection) || (this.lastHasSelection))
            {
            ...
            if ((!silent) && (!this.navigator.Context.HasSelection))
            {
        ...
        protected virtual void CursorScrollText(Drawing.Rectangle cursor, bool force)
        {
            ...
            if (this.TextLayout.TotalLineCount == 1)
            {
                ...
                this.TextLayout.GetLineGeometry(
                    0,
                    out linePos,
                    out lineAscender,
                    out lineDescender,
        ...
        protected virtual void PaintTextFieldBackground(
            Drawing.Graphics graphics,
            IAdorner adorner,
        ...
        )
        {
            ...
            else
            {
                ...
                adorner.PaintTextFieldBackground(
                    graphics,
                    fill,
                    state,
                    this.textFieldStyle,
                    this.textFieldDisplayMode,
                    this.navigator.IsReadOnly && !this.IsCombo,
                    this.IsMultilingualText
                );
            }
        }

        protected virtual void PaintTextFieldText(
            Drawing.Graphics graphics,
            IAdorner adorner,
            WidgetPaintState state,
            Drawing.Rectangle clipRect,
        ...
        )
        {
            ...
            if ((this.KeyboardFocus && this.IsEnabled) || this.contextMenu != null)
            {
                ...
                if (this.IsCombo && this.navigator.IsReadOnly)
                {
                    ...
                    adorner.PaintTextSelectionBackground(
                        graphics,
                        areas,
                        state,
                        PaintTextStyle.TextField,
                        this.textFieldDisplayMode
                    );
                    adorner.PaintGeneralTextLayout(
                        ...
                        pos,
                        layout,
                        (state & ~WidgetPaintState.Focused) | WidgetPaintState.Selected,
                        PaintTextStyle.TextField,
                        this.textFieldDisplayMode,
                        this.BackColor
                    );
                ...
                else if (from == to)
                {
                    ...
                    visibleCursor =
                        TextField.showCursor && this.Window.IsFocused && !this.Window.IsSubmenuOpen;
                }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            areas[i].Rect = graphics.Align(
                                Drawing.Rectangle.Offset(areas[i].Rect, 0, -1)
                            );
                        }
        ...
        protected virtual TextLayout GetPaintTextLayout()
        {
            ...
            if (this.isPassword)
            {
                return AbstractTextField.GetPaintTextLayoutForPassword(
                    original,
        ...
        private TextLayout GetPaintTextLayoutForHint(TextLayout original, string hintText)
        {
            ...
            if (pos < 0)
            {
                return new TextLayout(original)
                {
                    Text = string.Concat(
                        fontBegin,
                        TextConverter.ConvertToTaggedText(hint),
                        fontEnd
                    )
                };
            }
            else
            {
                ...
                string hintSuffix = TextConverter.ConvertToTaggedText(
                    hint.Substring(pos + text.Length)
                );
                ...
                return new TextLayout(original)
                {
                    Text = string.Concat(
                        ...
                        hintPrefix,
                        fontEnd,
                        TextConverter.ConvertToTaggedText(text),
                        fontBegin,
                        hintSuffix,
                        fontEnd
                    )
        ...
        private static TextLayout GetPaintTextLayoutForPassword(
            TextLayout original,
            char passwordReplacementCharacter
        )
        {
        ...
        private static TextLayout GetPaintTextLayoutReplacement(
            TextLayout original,
            string hintText
        )
        {
            ...
            return new TextLayout(original) { Text = TextConverter.ConvertToTaggedText(text) };
        }
        ...
        protected sealed override void SetBoundsOverride(
            ...
            switch (this.ButtonShowCondition)
            {
                ...
                default:
                    throw new System.NotImplementedException(
                        string.Format(
                            "{0} not implemented.",
                            this.ButtonShowCondition.GetQualifiedName()
                        )
                    );
            }
        }
        ...
        {
            add { this.AddUserEventHandler("TextEdited", value); }
            remove { this.RemoveUserEventHandler("TextEdited", value); }
        }

        public event EventHandler TextInserted
        {
            add { this.AddUserEventHandler("TextInserted", value); }
            remove { this.RemoveUserEventHandler("TextInserted", value); }
        }

        public event EventHandler TextDeleted
        {
            add { this.AddUserEventHandler("TextDeleted", value); }
            remove { this.RemoveUserEventHandler("TextDeleted", value); }
        }

        public event EventHandler MultilingualEditionCalled
        {
            add { this.AddUserEventHandler("MultilingualEditionCalled", value); }
            remove { this.RemoveUserEventHandler("MultilingualEditionCalled", value); }
        }
        ...
        {
            add { this.AddUserEventHandler("CursorChanged", value); }
            remove { this.RemoveUserEventHandler("CursorChanged", value); }
        }

        public event EventHandler ReadOnlyChanged
        {
            add { this.AddUserEventHandler("ReadOnlyChanged", value); }
            remove { this.RemoveUserEventHandler("ReadOnlyChanged", value); }
        }

        public event EventHandler<CancelEventArgs> AutoSelecting
        {
            add { this.AddUserEventHandler("AutoSelecting", value); }
            remove { this.RemoveUserEventHandler("AutoSelecting", value); }
        }

        public event EventHandler<CancelEventArgs> AutoErasing
        {
            add { this.AddUserEventHandler("AutoErasing", value); }
            remove { this.RemoveUserEventHandler("AutoErasing", value); }
        }

        public event EventHandler<CancelEventArgs> EditionStarting
        {
            add { this.AddUserEventHandler("EditionStarting", value); }
            remove { this.RemoveUserEventHandler("EditionStarting", value); }
        }

        public event EventHandler EditionStarted
        {
            add { this.AddUserEventHandler("EditionStarted", value); }
            remove { this.RemoveUserEventHandler("EditionStarted", value); }
        }

        public event EventHandler EditionAccepted
        {
            add { this.AddUserEventHandler("EditionAccepted", value); }
            remove { this.RemoveUserEventHandler("EditionAccepted", value); }
        }

        public event EventHandler EditionRejected
        {
            add { this.AddUserEventHandler("EditionRejected", value); }
            remove { this.RemoveUserEventHandler("EditionRejected", value); }
        }

        public event EventHandler<CancelEventArgs> AcceptingEdition
        {
            add { this.AddUserEventHandler("AcceptingEdition", value); }
            remove { this.RemoveUserEventHandler("AcceptingEdition", value); }
        }

        public event EventHandler<CancelEventArgs> RejectingEdition
        {
            add { this.AddUserEventHandler("RejectingEdition", value); }
            remove { this.RemoveUserEventHandler("RejectingEdition", value); }
        }

        private static void NotifyButtonShowConditionChanged(
        ...
        public static readonly DependencyProperty PasswordReplacementCharacterProperty =
            DependencyProperty<AbstractTextField>.Register(
                x => x.PasswordReplacementCharacter,
        ...
        public static readonly DependencyProperty HintOffsetProperty =
            DependencyProperty<AbstractTextField>.RegisterReadOnly(
                x => x.HintOffset,
                new DependencyPropertyMetadata(0)
            );
        public static readonly DependencyProperty DefocusActionProperty =
            DependencyProperty<AbstractTextField>.Register(
                x => x.DefocusAction,
                new DependencyPropertyMetadata(DefocusAction.None)
            );
        public static readonly DependencyProperty ButtonShowConditionProperty =
            DependencyProperty<AbstractTextField>.Register(
                x => x.ButtonShowCondition,
                new DependencyPropertyMetadata(
                    ButtonShowCondition.Always,
                    AbstractTextField.NotifyButtonShowConditionChanged
                )
            );
