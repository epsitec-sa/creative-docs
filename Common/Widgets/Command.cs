...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class Command : DependencyObject, System.IEquatable<Command>, INamedType
    {
        ...
        {
            get { return new CommandParameters(Command.GetDefaultParameter(this.caption)); }
        }

        public string Name
        {
            get { return this.caption.Name; }
        }

        public string Icon
        {
            get { return this.caption.Icon; }
        }
        ...
        public string Group
        {
            get { return Command.GetGroup(this.caption); }
        }

        public bool Statefull
        {
            get { return Command.GetStatefull(this.caption); }
        }

        public bool HasShortcuts
        {
            get { return Shortcut.HasShortcuts(this.caption); }
        }

        public ShortcutCollection Shortcuts
        {
            get { return Shortcut.GetShortcuts(this.caption); }
        }
        ...
        {
            get { return this.temporary; }
        }

        public bool IsAdminLevelRequired
        {
            get { return this.CommandParameters["Level"] == "Admin"; }
        }

        public void ManuallyDefineCommand(
            string description,
            string icon,
            string group,
            bool statefull
        ...
        internal void Freeze()
        {
            if (this.temporary)
            {
                throw new System.InvalidOperationException(
                    string.Format("Temporary command {0} may not be frozen", this.CommandId)
                );
            }
        ...
        private void EnsureTemporary()
        {
            ...
            {
                throw new System.InvalidOperationException(
                    string.Format("Command {0} may not be modified", this.CommandId)
                );
            }
        }
        ...
        public static readonly DependencyProperty CaptionProperty =
            DependencyProperty<Command>.RegisterReadOnly(
                x => x.Caption,
                new DependencyPropertyMetadata(Command.GetCaptionValue)
            );
        public static readonly DependencyProperty CommandIdProperty =
            DependencyProperty<Command>.RegisterReadOnly(
                x => x.CommandId,
                new DependencyPropertyMetadata(Command.GetCommandIdValue)
            );

        public static readonly DependencyProperty GroupProperty =
            DependencyProperty<Command>.RegisterAttached<string>("Group");
        public static readonly DependencyProperty StatefullProperty =
            DependencyProperty<Command>.RegisterAttached<bool>("Statefull");
        public static readonly DependencyProperty HideWhenDisabledProperty =
            DependencyProperty<Command>.RegisterAttached<bool>("HideWhenDisabled");
        public static readonly DependencyProperty DefaultParameterProperty =
            DependencyProperty<Command>.RegisterAttached<string>("DefaultParameter");
