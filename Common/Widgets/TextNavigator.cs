...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class TextNavigator
    {
        ...
        public bool IsEmpty
        {
            get { return this.textLayout.Text.Length == 0; }
        }
        ...
        public int Cursor
        {
            get { return this.context.CursorTo; }
            set
            {
        ...
        {
            get { return this.context.CursorFrom; }
            set
            {
                value = System.Math.Max(value, 0);
                value = System.Math.Min(value, this.textLayout.MaxTextIndex);
        ...
        {
            get { return this.context.CursorAfter; }
            set
            {
        ...
        {
            get { return this.textLayout.IsSelectionBold(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.IsSelectionItalic(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.IsSelectionUnderline(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.IsSelectionSubscript(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.IsSelectionSuperscript(this.context); }
            set
            {
        ...
        public bool SelectionWaved
        {
            ...
            get { return this.textLayout.IsSelectionWaved(this.context); }
        }

        public string SelectionFontName
        {
            get { return this.textLayout.GetSelectionFontFace(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.GetSelectionFontScale(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.GetSelectionFontRichColor(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.GetSelectionFontColor(this.context); }
            set
            {
        ...
        {
            get { return this.textLayout.GetSelectionList(this.context); }
            set
            {
        ...
        public void SetCursors(int from, int to, bool after)
        {
            ...
            if (
                from != this.context.CursorFrom
                || to != this.context.CursorTo
                || after != this.context.CursorAfter
            )
            {
        ...
        public int TabCount
        {
            get { return this.textLayout.Style.TabCount; }
        }
        ...
        private bool ProcessKeyDown(KeyCode key, bool isShiftPressed, bool isControlPressed)
        {
            ...
            if (this.IsMultiLine)
            {
                switch (key)
                {
                    ...
                    case KeyCode.Tab:
                        if ((this.allowTabInsertion) && (this.BeginChange(UndoType.Insert)))
                        {
                            this.textLayout.InsertCharacter(this.context, '\t');
                            this.OnTextInserted(false);
                            return true;
        ...
        {
            if ((message.IsControlPressed) || (message.IsAltPressed))
            {
        ...
        private bool ProcessMouseDown(Drawing.Point pos)
        {
            ...
            {
                if ((this.context.CursorFrom != index) || (this.context.CursorTo != index))
                {
        ...
        private void UndoMemorize(UndoType type)
        {
            ...
            if (!this.opletQueue.CanRedo && oplets.Length == 1 && !this.context.UndoSeparator)
            {
                TextOplet lastOplet = oplets[0] as TextOplet;
                if (
                    type != UndoType.AutonomusStyle
                    && type != UndoType.Tab
                    && lastOplet != null
