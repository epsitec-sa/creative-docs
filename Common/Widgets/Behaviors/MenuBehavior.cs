    ...
    public sealed class MenuBehavior : Types.DependencyObject
    {
        ...
        public static MenuBehavior OpenItemSubmenu(Widget item, Animate animate)
        {
            ...
            if (submenu == null)
            {
                ...
                if (window != null)
                {
                    if ((window.ParentWidget == null) || (window.MenuType != MenuType.Submenu))
                    {
        ...
        private void OpenGenericMenu(MenuWindow window, Animate animate, MenuType type)
        {
            ...
            else
            {
                ...
                if (window.MenuType == MenuType.Submenu)
                {
                    ...
                    Window parentWindow =
                        parentWidget == null ? null : MenuItem.GetMenuWindow(parentWidget);
        ...
        public void HideAll()
        {
            ...
            {
                MenuWindow window =
                    this.liveMenuWindows[this.liveMenuWindows.Count - 1] as MenuWindow;
                window.Hide();
            }
        ...
        private void ShowSubmenu(MenuWindow window, Animate animate)
        {
            ...
            if ((host == null) && (parent != null) && (window.MenuType != MenuType.Popup))
            {
        ...
        internal void HandleAboutToHideMenuWindow(MenuWindow window)
        {
            ...
            System.Diagnostics.Debug.Assert(
                this.liveMenuWindows.IndexOf(window) == this.liveMenuWindows.Count - 1
            );
        ...
        private void HandleRootMenuIsVisibleChanged(
            object sender,
            ...
            if (n > 0)
            {
                ...
                this.keyboardMenuItem =
                    (
                        ...
                        && (window.ParentWidget.RootParent is WindowRoot)
                    )
                        ? window.ParentWidget as MenuItem
                        : null;
                this.keyboardMenuWindow =
                    (this.keyboardMenuItem == null) ? null : this.keyboardMenuItem.Window;
        ...
        private void KeyboardSelectItem(int direction)
        {
            ...
            if (n > 0)
            {
                ...
                else
                {
                    ...
                    MenuWindow[] live = (MenuWindow[])
                        this.liveMenuWindows.ToArray(typeof(MenuWindow));
        ...
        private void KeyboardSelectMenu(int direction)
        {
            ...
            if (
                (n > 0)
                && (
                    (this.rootWindow == this.keyboardMenuWindow)
                    || (MenuBehavior.menuLastItem == null)
                )
            )
            {
            ...
            else
            {
                ...
                {
                    Widget root =
                        this.keyboardMenuWindow == null ? null : this.keyboardMenuWindow.Root;
                ...
                else
                {
                    ...
                    else if (direction < 0)
                    {
                        ...
                        if ((parent == null) || (parent.Window == this.rootWindow))
                        {
        ...
        private void UpdateItems()
        {
            ...
            if ((hiliteBelowI > 0) && (MenuBehavior.timerKeepMenu != null))
            {
        ...
        private static Window DetectWindow(Drawing.Point pos)
        {
            ...
            for (int i = behaviors.Length - 1; i >= 0; i--)
            {
                ...
                MenuWindow[] windows = (MenuWindow[])
                    behavior.liveMenuWindows.ToArray(typeof(MenuWindow));
                ...
                for (int j = windows.Length - 1; j >= 0; j--)
                {
                    ...
                    if ((window != null) && (window.WindowBounds.Contains(pos)))
                    {
                        return window;
                    }
                }
        ...
        {
            Widget widget = window.Root.FindChild(
                pos,
                WidgetChildFindMode.SkipHidden
                    | WidgetChildFindMode.Deep
                    | WidgetChildFindMode.SkipDisabled
            );
                ...
                if ((MenuBehavior.menuList.Count > 0) && (window.CapturingWidget != null))
                {
                    ...
                    if (release)
                    {
                        System.Diagnostics.Debug.WriteLine(
                            "Released Window Capture because a menu is visible."
                        );
        ...
        private static void ProcessMouseEvent(Window window, Message message)
        {
            ...
            bool swallowMessage =
                (MenuBehavior.menuList.Count > 0) && (message.NonClient == false) && !mouseInMenu;
            ...
            switch (message.MessageType)
            {
                ...
                case MessageType.MouseUp:
                    if (item != null)
                    {
                        if ((item is MenuItemContainer) || (item is MenuSeparator))
                        {
                ...
                case MessageType.MouseMove:
                    if (
                        ...
                        && (
                            Drawing.Point.Distance(mouse, MenuBehavior.keyboardNavigationMousePos)
                            < 4
                        )
                    )
                    {
        ...
        private static void ProcessMouseMoveInItem(MenuItem item)
        {
            ...
            if ((item == null) && (MenuBehavior.keyboardNavigationActive))
            {
                return;
            }
        ...
        private static void ProcessKeyboardEvent(Window window, Message message)
        {
            ...
            if ((that == null) && (MenuBehavior.menuList.Count > 0))
            {
            ...
            if ((that.isOpen == false) && (that.keyboardMenuActive == false))
            {
                return;
            }
            ...
            if (message.MessageType == MessageType.KeyDown)
            {
                ...
                switch (message.KeyCode)
                {
                    ...
                    default:
                        if ((feel.TestSelectItemKey(message)) && (that.keyboardMenuItem != null))
                        {
