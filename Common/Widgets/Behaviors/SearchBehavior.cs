    ...
    public sealed class SearchBehavior
    {
        ...
        public void UpdateButtonGeometry()
        {
            ...
            if (text != null)
            {
                ...
                var sequence = new ButtonStyleSequence(
                    ButtonStyle.ExListRight,
                    ButtonStyle.ExListMiddle
                );
                ...
                foreach (var button in this.GetButtons().Where(x => x.Visibility).Reverse())
                {
                    ...
                    bounds = new Rectangle(
                        bounds.Left + 1 - button.PreferredWidth,
                        bounds.Bottom,
        ...
        private void UpdateButtonEnableAndVisibility()
        {
            if (this.buttonSearch != null)
            {
                ...
                this.buttonSearch.Visibility =
                    this.isVisible && this.hostPolicy.DisplaySearchButton;
            }
        }
