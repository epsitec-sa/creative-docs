...
namespace Epsitec.Common.Widgets
{
    ...
    public class IconButtonsCombo : Widget
    {
        ...
        public IconButtonsCombo(Widget embedder)
            : this()
        {
        ...
        public int FirstIconVisible
        {
            ...
            get { return this.firstIconVisible; }
            set
            {
        ...
        public double ButtonWidth
        {
            ...
            get
            {
                return System.Math.Floor(
                    (this.Client.Bounds.Width - IconButtonsCombo.menuWidth) / this.columns
                );
            }
        }
        ...
        public double ButtonHeight
        {
            ...
            get { return System.Math.Floor(this.Client.Bounds.Height / this.rows); }
        }
        ...
        public void UpdateButtons()
        {
            ...
            this.buttonNext.Enable = (
                first < ((this.items.Count - 1) / this.buttonMain.Length) * this.buttonMain.Length
            );
        ...
        protected void UpdateIcon(int rank, int index)
        {
            ...
            if (index < this.items.Count)
            {
                ...
                this.buttonMain[rank].PreferredIconSize = new Drawing.Size(
                    this.ButtonWidth,
                    this.ButtonHeight
                );
                this.buttonMain[rank].ActiveState =
                    (this.SelectedIndex == index) ? ActiveState.Yes : ActiveState.No;
        ...
        private void HandleButtonNextPressed(object sender, MessageEventArgs e)
        {
            ...
            first = System.Math.Min(
                first,
                ((this.items.Count - 1) / this.buttonMain.Length) * this.buttonMain.Length
            );
            this.FirstIconVisible = first;
        }
        ...
        private void HandleAutoFocusChanged(
            object sender,
            Types.DependencyPropertyChangedEventArgs e
        )
        {
        ...
        {
            add { this.AddUserEventHandler("FirstIconChanged", value); }
            remove { this.RemoveUserEventHandler("FirstIconChanged", value); }
        }
