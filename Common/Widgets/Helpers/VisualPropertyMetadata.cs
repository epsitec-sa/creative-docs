...
namespace Epsitec.Common.Widgets.Helpers
{
    ...
    public class VisualPropertyMetadata : Types.DependencyPropertyMetadata
    {
        ...
        public VisualPropertyMetadata(object defaultValue)
            : base(defaultValue) { }

        public VisualPropertyMetadata(
            object defaultValue,
            Types.PropertyInvalidatedCallback propertyInvalidatedCallback
        )
        ...
        public VisualPropertyMetadata(
            object defaultValue,
            Types.PropertyInvalidatedCallback propertyInvalidatedCallback,
            Types.CoerceValueCallback coerceValueCallback
        )
            : base(defaultValue, propertyInvalidatedCallback)
        {
        ...
        public VisualPropertyMetadata(Types.GetValueOverrideCallback getValueOverrideCallback)
            : base(getValueOverrideCallback) { }

        public VisualPropertyMetadata(
            Types.GetValueOverrideCallback getValueOverrideCallback,
            VisualPropertyMetadataOptions flags
        )
            : base(getValueOverrideCallback)
        {
        ...
        public VisualPropertyMetadata(object defaultValue, VisualPropertyMetadataOptions flags)
            : base(defaultValue)
        {
            this.InitializeFromFlags(flags);
        }
        ...
        public VisualPropertyMetadata(
            object defaultValue,
            Types.SetValueOverrideCallback setValueOverrideCallback,
            VisualPropertyMetadataOptions flags
        )
        ...
        {
            get { return this.affectsMeasure; }
            set { this.affectsMeasure = value; }
        }
        public bool AffectsArrange
        {
            get { return this.affectsArrange; }
            set { this.affectsArrange = value; }
        }
        public bool AffectsDisplay
        {
            get { return this.affectsDisplay; }
            set { this.affectsDisplay = value; }
        }
        public bool AffectsChildrenLayout
        {
            get { return this.affectsChildrenLayout; }
            set { this.affectsChildrenLayout = value; }
        }
        public bool AffectsTextLayout
        {
            get { return this.affectsTextLayout; }
            set { this.affectsTextLayout = value; }
        }

        public override bool InheritsValue
        {
            get { return this.inheritsValue; }
        }
        ...
        {
            get { return this.notifiesChanges; }
        }
        ...
        public override bool FilterSerializableItem(object item)
        {
            ...
            if ((widget != null) && (widget.IsEmbedded))
            {
                return false;
            }
            else
        ...
        protected virtual void InitializeFromFlags(VisualPropertyMetadataOptions flags)
        {
            ...
            this.affectsChildrenLayout =
                (flags & VisualPropertyMetadataOptions.AffectsChildrenLayout) != 0;
        ...
        protected override Types.DependencyPropertyMetadata CloneCopyToNewObject(
            Types.DependencyPropertyMetadata copy
        )
        {
