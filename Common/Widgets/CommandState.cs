...
namespace Epsitec.Common.Widgets
{
    ...
    public class CommandState : DependencyObject
    {
        ...
        {
            get { return (Command)this.GetValue(CommandState.CommandProperty); }
        }
        ...
        {
            get { return (CommandContext)this.GetValue(CommandState.CommandContextProperty); }
        }
        ...
        {
            get { return CommandState.GetAdvancedState(this); }
            set
            {
        ...
        public static readonly DependencyProperty AdvancedStateProperty =
            DependencyProperty<CommandState>.RegisterAttached<string>("AdvancedState");
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty<CommandState>.RegisterReadOnly(x => x.Command);
        public static readonly DependencyProperty CommandContextProperty =
            DependencyProperty<CommandState>.RegisterReadOnly(x => x.CommandContext);
