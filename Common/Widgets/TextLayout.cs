...
namespace Epsitec.Common.Widgets
{
    ...
    public class TextLayout
    {
        ...
        {
            get { return new FormattedText(this.Text); }
        ...
        public string Text
        {
            ...
            set
            {
                ...
                if ((this.text != value) && (this.GetSimplifiedText() != value))
                {
                    int offsetError;
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "Syntax error at char {0}.\nText: '{1}^{2}'",
                                offsetError.ToString(),
                                value.Substring(0, offsetError),
                                value.Substring(offsetError)
                            )
                        );
                    }
                }
        ...
        {
            get { return Support.Resources.DefaultManager; }
        }
        ...
        public double DefaultFontSize
        {
            ...
            get { return this.style.FontSize; }
            set
            {
        ...
        public double DefaultUnderlineWidth { get; set; }

        public double DefaultWaveWidth { get; set; }

        public Drawing.RichColor DefaultRichColor
        {
            get { return this.style.FontRichColor; }
            set
            {
        ...
        {
            get { return this.style.FontColor; }
            set
            {
        ...
        public Drawing.Color AnchorColor
        {
            ...
            get { return this.style.AnchorColor; }
            set
            {
        ...
        public Drawing.Color WaveColor
        {
            ...
            get { return this.style.WaveColor; }
            set
            {
        ...
        public Drawing.ContentAlignment Alignment
        {
            ...
            get
            {
                return this.alignment == Drawing.ContentAlignment.Undefined
        ...
        public Drawing.TextBreakMode BreakMode
        {
            ...
            get
            {
                return this.breakMode == Drawing.TextBreakMode.Undefined
                    ? this.style.BreakMode
                    : this.breakMode;
            }
            set
            {
        ...
        public Drawing.TextJustifMode JustifMode
        {
            ...
            get
            {
                return this.justifMode == Drawing.TextJustifMode.Undefined
                    ? this.style.JustifMode
                    : this.justifMode;
            }
            set
            {
        ...
        public bool ShowLineBreak
        {
            ...
            get { return this.style.ShowLineBreaks; }
            set
            {
        ...
        public bool ShowTab
        {
            ...
            get { return this.style.ShowTabMarks; }
            set
            {
        ...
        {
            get { return this.imageCallback; }
            set { this.imageCallback = value; }
        }
        ...
        public int TabCount
        {
            get { return this.style.TabCount; }
        }
        ...
        {
            get { return (this.BreakMode & Drawing.TextBreakMode.SingleLine) != 0; }
        }
        ...
        public void GetSingleLineGeometry(
            Drawing.Size boxSize,
            Drawing.ContentAlignment alignment,
            out double ascender,
            out double descender,
            out Drawing.Point origin,
            out Drawing.Size size
        )
        {
        ...
        public IDictionary<string, string> Parameters
        {
            get
            {
                ...
                return new Epsitec.Common.Types.Collections.ReadOnlyDictionary<string, string>(
                    this.parameters
                );
            }
        }
        ...
        internal void SetSelectionFontFace(TextLayoutContext context, string name)
        {
            ...
            //	Une chaîne vide indique la fonte par défaut.
            if (name == "")
                name = TextLayout.CodeDefault + this.DefaultFont.FaceName;
        ...
        internal Drawing.RichColor GetSelectionFontRichColor(TextLayoutContext context)
        {
            ...
            if (context.PrepareOffset != -1) // préparation pour l'insertion ?
            {
                return TextLayout.GetRichColorFromName(
                    this.FindLastPrepared(context, Attributes.Color)
                );
            }
            else
            {
        ...
        internal Drawing.TextListType GetSelectionList(TextLayoutContext context)
        {
            ...
            while (i >= 0)
            {
                ...
                if (block.List)
                {
                    return this.ProcessListType(
                        block.Parameters,
                        "type",
                        Drawing.TextListType.Fixed
                    );
                }
        ...
        {
            if (
                (value.Length > Support.ResourceBundle.Field.Null.Length)
        ...
        private void DeletePutCommand(TextLayoutContext context, string beginCmd, string endCmd)
        {
            ...
            i = this.text.IndexOf(
                endCmd,
                context.PrepareOffset,
                context.PrepareLength1 + context.PrepareLength2
            );
            if (i < 0)
                return;
        ...
        private void ListInsert(TextLayoutContext context, string cmd)
        {
            ...
            while (cursorFrom <= cursorTo)
            {
                ...
                if (context.CursorFrom >= cursor)
                    context.CursorFrom++;
                if (context.CursorTo >= cursor)
                    context.CursorTo++;
                cursor++;
        ...
        public void SelectWord(TextLayoutContext context)
        {
            ...
            {
                if (this.IsWordSeparator(simple[context.CursorFrom - 1]))
                    break;
                context.CursorFrom--;
            }
            ...
            {
                if (this.IsWordSeparator(simple[context.CursorTo]))
                    break;
                context.CursorTo++;
            }
        ...
        public bool ReplaceSelection(TextLayoutContext context, string ins)
        {
            ...
            else
            {
                ...
                if (prepare)
                    this.Simplify(context); // supprime les préparations <put...>
            }
        ...
        public bool MoveCursor(TextLayoutContext context, int move, bool select, bool word)
        {
            ...
            if (word) // déplacement par mots ?
            {
                if (move < 0)
                {
                    while (cursor > 0)
                    {
                        if (!this.IsWordSeparator(simple[cursor - 1]))
                            break;
                        cursor--;
                    }
                    while (cursor > 0)
                ...
                else
                {
                    ...
                    {
                        if (this.IsWordSeparator(simple[cursor]))
                            break;
                        cursor++;
                    }
                    while (cursor < simple.Length)
            ...
            if (cursor == context.CursorTo && cursor == context.CursorFrom)
                return false;
        ...
        )
        {
            ...
            foreach (JustifBlock block in this.blocks)
            {
                ...
                {
                    firstBlock = false;
                    double shift = block.IsImage
                        ? block.ImageAscender
                        : block.Font.Ascender * block.FontSize;
                ...
                else
                {
                    ...
                    blockRect.Bottom =
                        pos.Y + block.Pos.Y + block.Font.Descender * block.FontSize - offsetY;
                }
                ...
                {
                    var frame = Drawing.Rectangle.Deflate(
                        blockRect,
                        new Drawing.Margins(0, 0, 1, 0)
                    );
        ...
        private void UnderlinePoints(
            ...
            JustifBlock block,
            Drawing.Point pos,
            out Drawing.Point p1,
            out Drawing.Point p2
        )
        {
        ...
        private void PaintList(
            ...
            double baseLine,
            JustifBlock block,
            ref double listValue
        )
        {
            //	Dessine une puce.
            Drawing.TextListType type = this.ProcessListType(
                block.Parameters,
                "type",
                Drawing.TextListType.Fixed
            );
            ...
            {
                Drawing.TextListGlyph glyph = this.ProcessListGlyph(
                    block.Parameters,
                    "glyph",
                    Drawing.TextListGlyph.Circle
                );
                Drawing.Path path = new Drawing.Path();
        ...
        {
            return this.DetectIndex(
                new Drawing.Point(posx, 0),
                posLine,
                select,
                out index,
                out after
            ...
            foreach (JustifLine line in this.lines)
            {
                ...
                )
                {
                    for (int j = line.FirstBlock; j <= line.LastBlock; j++)
                    {
                        ...
                        if (pos.X >= block.Pos.X - before && pos.X <= block.Pos.X + width)
                        {
                            if (block.IsImage || block.Tab || block.List || block.HasReplacement)
                            {
                                index =
                                    (pos.X - block.Pos.X > width / 2)
                                        ? block.EndIndex
                                        : block.BeginIndex;
                            ...
                            else
                            {
                                ...
                                double left = 0;
                                double right;
                                int max = System.Math.Min(
                                    charsWidth.Length,
                                    block.EndIndex - block.BeginIndex
                                );
                                for (int k = 0; k < max; k++)
                                {
        ...
        public string FindAnchor(int index)
        {
            ...
            string[] tags;
            if (!this.AnalyzeTagsAtOffset(offset, out tags))
                return null;
        ...
        private double IndexToPosX(JustifBlock block, JustifLine line, int index)
        {
            ...
            if (index > block.EndIndex)
                index = block.BeginIndex + block.Text.Length;
        ...
        public SelectedArea[] FindTextRange(Drawing.Point pos, int indexBegin, int indexEnd)
        {
            ...
            foreach (JustifBlock block in this.blocks)
            {
                ...
                if (localBegin >= localEnd)
                    continue;
                if (localBegin >= block.EndIndex && !block.LineBreak)
                    continue;
            ...
            if (area.Rect.Top > -TextLayout.Infinite && area.Rect.Left < TextLayout.Infinite)
            {
                list.Add(area);
            }
        ...
        )
        {
            ...
            while (i >= 0 && i < this.blocks.Count)
            {
                ...
                if (block.Visible && index >= block.BeginIndex && index <= block.EndIndex)
                {
                    ...
                    if (context.PrepareOffset != -1)
                    {
                        angle = this.ScanItalic(context.PrepareOffset + context.PrepareLength1)
                            ? Drawing.Font.DefaultObliqueAngle
                            : 0.0;
                    }
                    if (angle != 0.0)
                    {
        ...
        private double ScanFontScale(int offset)
        {
            ...
            while (from < to)
            {
                ...
                if (tag == Tag.PutEnd || tag == Tag.EndOfText)
                {
                    break;
                }
            }
        ...
        public Drawing.Point FindTextEnd()
        {
            ...
            Drawing.Point pos = new Drawing.Point(
                ...
                block.Pos.Y + block.Font.Descender * block.FontSize
            );
            return pos;
        }
        ...
        public double FindTextHeight()
        {
            ...
            double a = System.Math.Max(
                TextLayout.GetBlockAscender(fb),
                TextLayout.GetBlockAscender(lb)
            );
            double d = System.Math.Max(
                TextLayout.GetBlockDescender(fb),
                TextLayout.GetBlockDescender(lb)
            );
                ...
                else
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case "</b>":
                            return Tag.BoldEnd;
                        case "</i>":
                            return Tag.ItalicEnd;
                        case "</u>":
                            return Tag.UnderlineEnd;
                        case "</m>":
                            return Tag.MnemonicEnd;
                        case "</w>":
                            return Tag.WaveEnd;

                        case "</a>":
                            return Tag.AnchorEnd;
                        case "</font>":
                            return Tag.FontEnd;
                        case "</put>":
                            return Tag.PutEnd;
        ...
        public static string SelectBestText(
            TextLayout model,
            ...
            if (this.textChangeNotificationSuspendCounter == 0)
            {
                if (this.embedder != null)
                {
                    ...
                    if (oldSimplifiedText != newSimplifiedText)
                    {
                        ...
                        this.embedder.InternalNotifyTextLayoutTextChanged(
                            oldSimplifiedText,
                            newSimplifiedText
                        );
                    }
                ...
                if ((this.textChangeEventQueue != null) && (this.textChangeEventQueue.Count > 0))
                {
        ...
        public string GetSimplify()
        {
            ...
            fontDefault = new FontDefinition(
                string.Concat(TextLayout.CodeDefault, this.DefaultFont.FaceName),
                "100%",
                string.Concat(
                    TextLayout.CodeDefault,
                    "#",
                    Drawing.RichColor.ToHexa(this.DefaultRichColor)
                )
            );
        ...
        private bool SimplifyPutFont(
            System.Text.StringBuilder buffer,
            /**/FontDefinition fontDefault,
            /**/FontDefinition fontCurrent,
            FontDefinition fontItem,
            /**/SupplSimplify supplCurrent,
            SupplSimplify supplItem,
            /**/bool fontCmd
        )
        {
            string itemFontFace =
                (supplItem.PutFontFace != "") ? supplItem.PutFontFace : fontItem.FontFace;
            string itemFontScale =
                (supplItem.PutFontScale != "") ? supplItem.PutFontScale : fontItem.FontScale;
            string itemFontColor =
                (supplItem.PutFontColor != "") ? supplItem.PutFontColor : fontItem.FontColor;

            string currFontFace =
                (supplCurrent.PutFontFace != "") ? supplCurrent.PutFontFace : fontCurrent.FontFace;
            string currFontScale =
                (supplCurrent.PutFontScale != "")
                    ? supplCurrent.PutFontScale
                    : fontCurrent.FontScale;
            string currFontColor =
                (supplCurrent.PutFontColor != "")
                    ? supplCurrent.PutFontColor
                    : fontCurrent.FontColor;

            if (
                itemFontFace != currFontFace
            ...
            )
            {
                ...
                if (
                    (
                        itemFontFace != ""
                        && itemFontFace != fontDefault.FontFace
                        && itemFontFace != currFontFace
                    )
                    || (
                        itemFontScale != ""
                        && itemFontScale != fontDefault.FontScale
                        && itemFontScale != currFontScale
                    )
                    || (
                        itemFontColor != ""
                        && itemFontColor != fontDefault.FontColor
                        && itemFontColor != currFontColor
                    )
                )
                {
        ...
        private double ParseScale(string size)
        {
            ...
            {
                return System.Double.Parse(size, System.Globalization.CultureInfo.InvariantCulture)
        ...
        private void ProcessFontTag(Stack<FontItem> stack, Dictionary<string, string> parameters)
        {
            if (parameters != null)
            {
                ...
                if (parameters.ContainsKey(Attributes.Color))
                {
                    Drawing.RichColor color = TextLayout.GetRichColorFromName(
                        parameters[Attributes.Color]
                    );
        ...
        private bool ProcessFormatTags(
            Tag tag,
        ...
        private Drawing.TextListType ProcessListType(
            Dictionary<string, string> parameters,
            string key,
            Drawing.TextListType def
        )
        {
            if (parameters == null)
                return def;
            ...
            {
                case "fix":
                    return Drawing.TextListType.Fixed;
                case "num":
                    return Drawing.TextListType.Numbered;
            }
            return def;
        }

        private Drawing.TextListGlyph ProcessListGlyph(
            Dictionary<string, string> parameters,
            string key,
            Drawing.TextListGlyph def
        )
        {
            if (parameters == null)
                return def;
            ...
            {
                case "circle":
                    return Drawing.TextListGlyph.Circle;
                case "square":
                    return Drawing.TextListGlyph.Square;
                case "dash":
                    return Drawing.TextListGlyph.Dash;
                case "triangle":
                    return Drawing.TextListGlyph.Triangle;
                case "arrow":
                    return Drawing.TextListGlyph.Arrow;
            }
            return def;
        }

        private void FontToRun(
        ...
        private void PutRun(
            List<Drawing.TextBreak.XRun> runList,
            Stack<FontItem> fontStack,
            SupplItem supplItem,
            int partIndex,
            ref int startIndex,
        ...
        private void GenerateRuns()
        {
            ...
            do
            {
                ...
                while (endOffset <= textLength)
                {
                    ...
                    if (
                        tag == Tag.Tab
                        || // partie terminée par un tabulateur ?
                        tag == Tag.List
                    )
                    {
                        ...
                        switch (tag)
                        {
                            case Tag.Image:
                                System.Diagnostics.Debug.Assert(
                                    parameters != null && parameters.ContainsKey("src")
                                );
                                ...
                                if (image is Drawing.Canvas)
                                {
                                    ...
                                    if (parameters.ContainsKey("dx"))
                                    {
                                        ...
                                        key.Size.Width = System.Double.Parse(
                                            s,
                                            System.Globalization.CultureInfo.InvariantCulture
                                        );
                                    }
                                    ...
                                    if (parameters.ContainsKey("dy"))
                                    {
                                        ...
                                        key.Size.Height = System.Double.Parse(
                                            s,
                                            System.Globalization.CultureInfo.InvariantCulture
                                        );
                                    }
                            ...
                            case Tag.Param:
                                ...
                                buffer.Append(TextLayout.CodeObject);
                                currentIndex++;
                                supplItem.BackColor = Drawing.Color.FromAlphaRgb(
                                    0.3,
                                    0.5,
                                    0.5,
                                    0.5
                            ...
                            case Tag.None:
                                ...
                                char c = Types.Converters.TextConverter.AnalyzeEntityChar(
                                    this.text,
                                    ref endOffset
                                );
                                buffer.Append(c);
        ...
        private void GenerateJustification()
        {
            ...
            while (beginLineBlock < this.blocks.Count)
            {
                ...
                while (true)
                {
                    ...
                    if (block.IsImage)
                    {
                        ...
                        else
                        {
                            height = System.Math.Max(
                                height,
                                block.ImageAscender - block.ImageDescender
                            );
                    ...
                    else
                    {
                        ...
                        else
                        {
                            height = System.Math.Max(
                                height,
                                block.Font.LineHeight * block.FontSize
                            );
                            ascender = System.Math.Max(
                                ascender,
                                block.Font.Ascender * block.FontSize
                            );
                            descender = System.Math.Min(
                                descender,
                                block.Font.Descender * block.FontSize
                            );
                        }
                    }
                    ...
                    nextLineBlock++;
                    if (nextLineBlock >= this.blocks.Count)
                        break;
                    block = this.blocks[nextLineBlock];
                    if (block.BoL)
                        break; // break si début nouvelle ligne
                }
                ...
                if (nextLineBlock - 1 >= this.blocks.Count - 1)
                    lastLine = true;
                if (
                    (this.JustifMode == Drawing.TextJustifMode.AllButLast && !lastLine)
        ...
        public void DebugDumpJustif(System.IO.TextWriter stream)
        {
            ...
            foreach (JustifBlock block in this.blocks)
            {
                string text = string.Format(
                    ...
                    block.LineBreak,
                    block.Font.FullName,
                    block.FontSize.ToString("F2"),
                    block.Pos.X.ToString("F2"),
                    block.Pos.Y.ToString("F2"),
        ...
        public static bool CheckSyntax(string text, out int offsetError)
        {
            ...
            for (int endOffset = 0; endOffset < text.Length; )
            {
                ...
                if (tag == Tag.SyntaxError || tag == Tag.Unknown)
                {
                    offsetError = beginOffset;
                    return false;
                }
        ...
        private Drawing.Image ResolveImage(string imageName)
        {
            ...
            if (image == null)
            {
                ...
                System.Diagnostics.Debug.WriteLine(
                    string.Format(
                        "<img> tag references unknown image '{0}' while painting. Current directory is {1}.",
                        imageName,
        ...
        public enum Tag
        {
            ...
            UnderlineEnd, // <u>...</u>
            Mnemonic,
            MnemonicEnd, // <m>...</m>  --> comme <u>...</u>
            Wave,
            WaveEnd, // <w>...</w> ou <w color="#FF00FF">
            Font,
            FontEnd, // <font ...>...</font>
            Anchor,
            AnchorEnd, // <a href="x">...</a>
            Image, // <img src="x"/>
        ...
        private class SupplSimplify
        {
            ...
            public bool IsItalic
            {
                get
                {
                    if (this.PutItalic == "yes")
                        return true;
                    if (this.PutItalic == "no")
                        return false;
            ...
            public bool IsUnderline
            {
                get
                {
                    if (this.PutUnderline == "yes")
                        return true;
                    if (this.PutUnderline == "no")
                        return false;
        ...
        private class FontItem
        {
            ...
            public Drawing.RichColor FontColor { get; set; }
        }
        ...
        private class JustifBlock
        {
            ...
            public double FontSize
            {
                get { return this.host.DefaultFontSize * this.FontScale; }
            }
        ...
        {
            public SelectedArea(Drawing.Rectangle rect)
                : this()
            {
                this.Rect = rect;
            }

            public Drawing.Rectangle Rect { get; internal set; }

            public Drawing.Color Color { get; internal set; }
        }
        ...
        {
            if ((this.style != null) && (this.style.IsReadOnly == false))
            {
            ...
            if ((this.style.IsReadOnly == false) && (this.isTemporaryLayout == false))
            {
                this.style.Changed += this.HandleTextStyleChanged;
            }
        }
        ...
        private static Dictionary<string, Drawing.RichColor> localColors =
            new Dictionary<string, Drawing.RichColor>();
