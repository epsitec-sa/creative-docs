...
namespace Epsitec.Common.Widgets
{
    ...
    public class ColorSelector : Widget
    {
        ...
        {
            get { return this.closeButton.Visibility; }
            set
            {
        ...
        {
            get { return this.blackReplacement; }
            set { this.blackReplacement = value; }
        }
        ...
        private void CreateUserInterface()
        {
            ...
            this.colorSpaceController = Helpers.GroupController.GetGroupController(
                this,
                "ColorSpace"
            );
            ...
            this.buttonRgb.IconUri = "manifest:Common/Widgets/Images/ColorSpaceRGB.icon";
            ...
            this.buttonCmyk.IconUri = "manifest:Common/Widgets/Images/ColorSpaceCMYK.icon";
            ...
            this.buttonGray.IconUri = "manifest:Common/Widgets/Images/ColorSpaceGray.icon";
        ...
        private void UpdateColorSpace()
        {
            ...
            this.buttonRgb.ActiveState =
                (cs == Drawing.ColorSpace.Rgb) ? ActiveState.Yes : ActiveState.No;
            this.buttonCmyk.ActiveState =
                (cs == Drawing.ColorSpace.Cmyk) ? ActiveState.Yes : ActiveState.No;
            this.buttonGray.ActiveState =
                (cs == Drawing.ColorSpace.Gray) ? ActiveState.Yes : ActiveState.No;
        }
        ...
        private static int ParseHexa(string hexa)
        {
            int result;
        ...
        {
            add { this.AddUserEventHandler(ColorSelector.ColorChangedEvent, value); }
            remove { this.RemoveUserEventHandler(ColorSelector.ColorChangedEvent, value); }
        }

        public event EventHandler CloseClicked
        {
            add { this.AddUserEventHandler(ColorSelector.CloseClickedEvent, value); }
            remove { this.RemoveUserEventHandler(ColorSelector.CloseClickedEvent, value); }
        }
