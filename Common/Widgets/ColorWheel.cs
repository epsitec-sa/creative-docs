...
namespace Epsitec.Common.Widgets
{
    ...
    public class ColorWheel : Widget
    {
        ...
        public ColorWheel(Widget embedder)
            : this()
        {
        ...
        public Drawing.RichColor Color
        {
            ...
            get
            {
                ...
                {
                    Drawing.RichColor color = Drawing.RichColor.FromAlphaHsv(
                        this.a,
                        this.h,
                        this.s,
                        this.v
            ...
            set
            {
                if (value.ColorSpace == Drawing.ColorSpace.Gray)
                {
                    ...
                    if (value.ColorSpace != this.colorSpace || g != this.g || a != this.a)
                    {
                ...
                else
                {
                    ...
                    if (
                        value.ColorSpace != this.colorSpace
                        || h != this.h
                        || s != this.s
                        || v != this.v
                        || a != this.a
        ...
        protected void UpdateGeometry()
        {
            ...
            Drawing.Point p1 =
                this.centerCircle + new Drawing.Point(this.radiusCircleMin * 0.95, 0);
            Drawing.Point p2 = Drawing.Transform.RotatePointDeg(
                this.centerCircle,
                180.0 + 60.0,
                p1
            );
            ...
            Drawing.Point p3 = Drawing.Transform.RotatePointDeg(
                this.centerCircle,
                180.0 + 45.0,
                p1
            );
        ...
        protected void ComputePosHandler()
        {
            ...
            this.posHandlerH =
                this.centerCircle
                + Drawing.Transform.RotatePointDeg(this.h, new Drawing.Point(0, radius));
        ...
        {
            add { this.AddUserEventHandler("Changed", value); }
            remove { this.RemoveUserEventHandler("Changed", value); }
        }

        //	Dessine un cercle inscrit dans un rectangle.
        protected void PathAddCircle(Drawing.Path path, Drawing.Rectangle rect)
        {
        ...
        protected bool IsGrey
        {
            ...
            get { return (this.s == 0.0 || this.v == 0.0); }
        }

        protected void PaintGradientCircle(
        ...
        )
        {
            ...
            if (this.IsEnabled)
            {
                ...
                graphics.AddLine(
                    rInside.Left,
                    (rInside.Bottom + rInside.Top) / 2,
                    rInside.Right,
                    (rInside.Bottom + rInside.Top) / 2
                );
                graphics.AddLine(
                    (rInside.Left + rInside.Right) / 2,
                    rInside.Bottom,
                    (rInside.Left + rInside.Right) / 2,
                    rInside.Top
                );
        ...
        protected void PaintGrayCircle(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            Drawing.Color colorBorder,
            Drawing.Color colorWindow
        ...
        protected void PaintGradientGray(
            Drawing.Graphics graphics,
            Drawing.Rectangle rect,
            Drawing.Color colorBorder
        )
        ...
        protected void PaintHandler(Drawing.Graphics graphics, Drawing.Point center, double radius)
        {
            //	Dessine une poignée.
