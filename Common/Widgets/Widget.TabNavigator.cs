...
namespace Epsitec.Common.Widgets
{
    public partial class Widget
    {
        ...
        class TabNavigator
        {
            ...
            public Widget FindTabWidget(
                Widget that,
                bool disableFirstEnter = false,
            ...
            )
            {
                ...
                var find =
                    this.FindTabWidgetAutoRadio(that)
                ...
                find =
                    (
                        (index == -1)
                            ? this.FindTabWidgetInChildren(that)
                ...
                if (find != null)
                {
                    System.Diagnostics.Debug.Assert(
                        find.TabNavigationMode.HasFlag(TabNavigationMode.ForwardOnly) == false
                    );
                }
            ...
            private Widget[] GetTabNavigationSiblings(Widget that)
            {
                ...
                if (parent != null)
                {
                    ...
                    for (int i = 0; i < siblings.Length; i++)
                    {
                        ...
                        if (
                            ((sibling.TabNavigationMode & this.mode) != 0)
                            && (sibling.IsEnabled)
                            && (sibling.Visibility)
                        ...
                        )
                        {
                            ...
                            if (
                                (readOnly != null)
                                && (
                                    sibling.TabNavigationMode.HasFlag(
                                        TabNavigationMode.SkipIfReadOnly
                                    )
                                )
                                && (readOnly.IsReadOnly)
                            )
                ...
                if ((this.mode == TabNavigationMode.ActivateOnTab) && (that.AutoRadio))
                {
            ...
            private Widget FindTabWidgetEnterChildren(
                Widget that,
                bool disableFirstEnter,
                bool acceptFocus
            )
            {
                if (
            ...
            private Widget FindTabWidgetAutoRadio(Widget that)
            {
                ...
                if (this.mode == TabNavigationMode.ActivateOnCursorX)
                {
                    ...
                    find = controller.FindXWidget(
                        that,
                        this.dir == TabNavigationDir.Backwards ? -1 : 1
                    );

                    if (
                        (find == null)
                        && (
                            controller.FindXWidget(
                                that,
                                this.dir == TabNavigationDir.Backwards ? 1 : -1
                            ) == null
                        )
                ...
                if (parent != null)
                {
                    ...
                    if ((parent.TabNavigationMode & TabNavigationMode.ForwardToChildren) != 0)
                    {
                        ...
                        switch (this.dir)
                        {
                            case TabNavigationDir.Backwards:
                                accept =
                                    (parent.TabNavigationMode & TabNavigationMode.ForwardOnly) == 0;
                                return this.FindTabWidget(
                                    parent,
                                    disableFirstEnter: true,
                                    acceptFocus: accept
                                );
                ...
                if (sibling != null)
                {
                    if (this.dir == TabNavigationDir.Backwards)
                    {
                        if ((sibling.TabNavigationMode & TabNavigationMode.ForwardToChildren) != 0)
                        {
                            ...
                            {
                                Widget[] candidates = this.GetTabNavigationSiblings(
                                    sibling.Children.Widgets[0]
                                );
                                int count = candidates.Length;
                                ...
                                if (count > 0)
                                {
                                    ...
                                    sibling.TabNavigationMode.HasFlag(TabNavigationMode.ForwardOnly)
                                )
                                {
                                    sibling = null;
                                }
                    ...
                    {
                        if (
                            ((sibling.TabNavigationMode & TabNavigationMode.ForwardToChildren) != 0)
