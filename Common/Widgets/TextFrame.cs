...
namespace Epsitec.Common.Widgets
{
    ...
    public class TextFrame : Widget, Epsitec.Common.Text.ITextRenderer
    {
        public TextFrame()
        {
            ...
            this.textFrame = new Epsitec.Common.Text.SimpleTextFrame(
                this.PreferredWidth,
        ...
        public TextFrame(TextFrame frame)
            : this(frame.textStory, frame.textFitter, frame.textNavigator) { }
        ...
        protected override void SetBoundsOverride(
            Epsitec.Common.Drawing.Rectangle oldRect,
            Epsitec.Common.Drawing.Rectangle newRect
        )
        {
            base.SetBoundsOverride(oldRect, newRect);

            if ((this.textFitter != null) && (this.textFrame != null))
            {
        ...
        public bool IsFrameAreaVisible(
            Epsitec.Common.Text.ITextFrame frame,
            double x,
            double y,
            double width,
            double height
                    ...
                    else
                    {
                        if (isInSelection)
                        {
                            ...
                            if (xx > selX)
                            {
                                ...
                                this.graphics.Rasterizer.Transform.TransformDirect(
                                    ref px1,
                                    ref py1
                                );
                                this.graphics.Rasterizer.Transform.TransformDirect(
        ...
        public void Render(
            Epsitec.Common.Text.Layout.Context layout,
            Epsitec.Common.Text.IGlyphRenderer glyphRenderer,
            string color,
            double x,
            double y,
            bool isLastRun
