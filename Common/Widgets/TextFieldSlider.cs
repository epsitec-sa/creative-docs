namespace Epsitec.Common.Widgets
{
    ...
    public class TextFieldSlider : TextFieldUpDown
    {
        ...
        {
            //	Couleur du slider.
            get { return this.slider.Color; }
            set { this.slider.Color = value; }
        }
        ...
        static TextFieldSlider()
        {
            ...
            Types.DependencyPropertyMetadata metadata =
                Visual.BackColorProperty.DefaultMetadata.Clone();

            metadata.DefineDefaultValue(Drawing.Color.Empty);
            metadata.SetValueOverride = new Epsitec.Common.Types.SetValueOverrideCallback(
                TextFieldSlider.SetBackColorValue
            );
        ...
        {
            get { return this.preferredRange; }
            set
            {
        ...
        {
            get { return this.slider.LogarithmicDivisor; }
            set { this.slider.LogarithmicDivisor = value; }
        }
