...
namespace Epsitec.Common.Widgets
{
    ...
    public class PaneBook : AbstractGroup, Collections.IWidgetCollectionHost<PanePage>
    {
        ...
        public PaneBook(Widget embedder)
            : this()
        {
        ...
        public PaneBookBehaviour PaneBehaviour
        {
            ...
            get { return this.paneBehaviour; }
            set { this.paneBehaviour = value; }
        }
        ...
        protected void StretchPages()
        {
            ...
            double lastSize =
                (this.type == PaneBookStyle.LeftRight)
                    ? this.lastWindowSize.Width
                    : this.lastWindowSize.Height;
        ...
        protected void CheckMinMax()
        {
            ...
            if (minOverflow == 0 && maxOverflow == 0)
                return; // tout est ok ?
        ...
        {
            add { this.AddUserEventHandler("PaneSizeChanged", value); }
            remove { this.RemoveUserEventHandler("PaneSizeChanged", value); }
        }
        ...
        public void NotifyInsertion(PanePage item)
        {
            ...
            item.PaneButton.PaneButtonStyle =
                (this.type == PaneBookStyle.LeftRight)
                    ? PaneButtonStyle.Vertical
                    : PaneButtonStyle.Horizontal;
        ...
        {
            public PanePageCollection(PaneBook book)
                : base(book) { }
        }
        #endregion
