...
namespace Epsitec.Common.Widgets
{
    ...
    public class ScrollArray : Widget, Support.Data.IStringSelection
    {
        ...
        public TextProviderCallback TextProviderCallback
        {
            ...
            get { return this.textProviderCallback; }
            set
            {
        ...
        {
            get { return this.textArrayStore; }
            set
            {
        ...
        {
            get { return this.GetCellText(row, column); }
            set { this.SetCellText(row, column, value); }
        }
        ...
        public int RowCount
        {
            ...
            set
            {
                if (this.maxRows != value)
                {
                    ...
                    if ((this.textProviderCallback == null) && (this.textArrayStore == null))
                    {
        ...
        {
            get { return this.FromVirtualRow(this.firstVirtvisRow); }
            set { this.SetFirstVirtualVisibleIndex(this.ToVirtualRow(value)); }
        }

        public int EditionZoneHeight
        {
            get { return this.editionAddRows + 1; }
            set
            {
                value--;
                if (value < 0)
        ...
        {
            get { return this.innerMargins.Top; }
            set
            {
        ...
        {
            get { return this.innerMargins.Bottom; }
            set
            {
        ...
        {
            get { return this.innerBounds.Width - this.totalWidth; }
        }
        ...
        public virtual string[] GetRowTexts(int row)
        {
            ...
            else
            {
                System.Collections.ArrayList line =
                    this.textArray[row] as System.Collections.ArrayList;
        ...
        public virtual void SetCellText(int row, int column, string value)
        {
            if (this.textProviderCallback != null)
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot set cell [{0},{1}] in this ScrollArray.", row, column)
                );
            }
        ...
        public virtual void SetRowTexts(int row, string[] values)
        {
            ...
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot set row [{0}] in this ScrollArray.", row)
                );
            }
        ...
        protected override void ProcessMessage(Message message, Drawing.Point pos)
        {
            ...
            switch (message.MessageType)
            {
                case MessageType.MouseDown:
                    if (
                        this.HitTestTable(pos, out row, out column)
        ...
        {
            if ((message.IsAltPressed) || (message.IsShiftPressed) || (message.IsControlPressed))
            {
                return false;
            }
        ...
        {
            if ((this.vScroller == null) || (this.hScroller == null) || (this.header == null))
            {
                return;
            }
        ...
        protected virtual void UpdateColumnCount()
        {
            ...
            {
                newColumns[i] = new ColumnDefinition(
                    this,
                    i,
                    this.defWidth,
        ...
        protected virtual void UpdateTableBounds()
        {
            ...
            this.tableMargins = new Drawing.Margins(
                0,
                this.vScroller.PreferredWidth - 1,
                this.rowHeight + this.titleHeight,
                this.hScroller.PreferredHeight - 1
            );
        ...
        protected virtual void UpdateLayoutCache()
        {
            ...
            if ((dx != this.cacheDx) || (dy != this.cacheDy))
            {
        ...
        protected virtual void UpdateScrollers()
        {
            ...
            if ((rows <= this.nFullyVisibleRows) || (rows <= 0) || (this.nFullyVisibleRows <= 0))
            {
            ...
            if ((width <= this.tableBounds.Width) || (width <= 0) || (this.tableBounds.Width <= 0))
            {
        ...
        protected virtual void UpdateTextLayouts()
        {
            ...
            bool refresh =
                (max != this.cacheVisibleRows)
                || (this.firstVirtvisRow != this.cacheFirstVirtvisRow);
            ...
            for (int row = 0; row < max; row++)
            {
                for (int column = 0; column < this.maxColumns; column++)
                {
                    ...
                    this.layouts[row, column].LayoutSize = new Drawing.Size(
                        this.Columns[column].Width - this.textMargin * 2,
                        this.rowHeight
                    );
        ...
        protected virtual void UpdateTagWidget()
        {
            if (this.tagWidget != null)
            {
                ...
                if (
                    (this.hScroller.Visibility) && (bounds.Bottom < this.hScroller.ActualBounds.Top)
                )
                {
        ...
        )
        {
            ...
            for (int row = 0; row < nRows; row++)
            {
                ...
                WidgetPaintState widgetState =
                    state & (WidgetPaintState.Enabled | WidgetPaintState.Focused);
                WidgetPaintState textState = state & (WidgetPaintState.Enabled);

                if ((this.selectedRow == rowLine) && (this.editionRow < 0))
                {
            ...
            }
            {
                ...
                for (int i = 0; i < this.maxColumns; i++)
                {
                    ...
                    if ((x < this.innerBounds.Left) || (x > this.innerBounds.Right))
                    {
                        continue;
                    }
        ...
        protected override void PaintForegroundImplementation(
            Drawing.Graphics graphics,
            Drawing.Rectangle clipRect
        )
        {
        ...
        protected virtual void PaintRowBackground(
            int row,
            int rowLine,
            Drawing.Graphics graphics,
            IAdorner adorner,
        ...
        protected virtual void PaintRowContents(
            int row,
            int rowLine,
            Drawing.Graphics graphics,
            IAdorner adorner,
        ...
        )
        {
            ...
            for (int column = 0; column < this.maxColumns; column++)
            {
                ...
                if ((x1 < clip.Right) && (x2 > clip.Left))
                {
                    ...
                    {
                        this.PaintCellContents(
                            rowLine,
                            column,
                            graphics,
                            adorner,
                            new Drawing.Point(x1, y1),
                            state,
                            layout
                        );
                    }
        ...
        public string SelectedItem
        {
            ...
            set { this.SelectedItemIndex = this.FindRow(value.Split(this.separator)); }
        }
        #endregion

        public event EventHandler InteractionModeChanging
        {
            add { this.AddUserEventHandler("InteractionModeChanging", value); }
            remove { this.RemoveUserEventHandler("InteractionModeChanging", value); }
        }

        public event EventHandler InteractionModeChanged
        {
            add { this.AddUserEventHandler("InteractionModeChanged", value); }
            remove { this.RemoveUserEventHandler("InteractionModeChanged", value); }
        }

        public event EventHandler ContentsChanged
        {
            add { this.AddUserEventHandler("ContentsChanged", value); }
            remove { this.RemoveUserEventHandler("ContentsChanged", value); }
        }

        public event EventHandler ContentsInvalidated
        {
            add { this.AddUserEventHandler("ContentsInvalidated", value); }
            remove { this.RemoveUserEventHandler("ContentsInvalidated", value); }
        }

        public event EventHandler SortChanged
        {
            add { this.AddUserEventHandler("SortChanged", value); }
            remove { this.RemoveUserEventHandler("SortChanged", value); }
        }

        public event EventHandler LayoutUpdated
        {
            add { this.AddUserEventHandler("LayoutUpdated", value); }
            remove { this.RemoveUserEventHandler("LayoutUpdated", value); }
        }

        public event EventHandler TextArrayStoreContentsChanged
        {
            add { this.AddUserEventHandler("TextArrayStoreContentsChanged", value); }
            remove { this.RemoveUserEventHandler("TextArrayStoreContentsChanged", value); }
        }

        public event EventHandler SelectedItemChanging
        {
            add { this.AddUserEventHandler("SelectedItemChanging", value); }
            remove { this.RemoveUserEventHandler("SelectedItemChanging", value); }
        }
        ...
        public class ColumnDefinition : System.IDisposable, Types.IReadOnly
        {
            ...
            {
                get { return this.editionWidget; }
                set { this.editionWidget = value; }
            }
            ...
            public System.Type EditionWidgetType
            {
                get
                {
                    if ((this.editionWidgetType == null) && (this.editionWidgetModel != null))
                    {
                ...
                set { this.editionWidgetType = value; }
            }

            public Widget EditionWidgetModel
            {
                get { return this.editionWidgetModel; }
                set
                {
