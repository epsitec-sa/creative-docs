namespace Epsitec.Common.Widgets
{
    ...
    public class TextFieldExList : TextFieldCombo
    {
        ...
        public TextFieldExList(Widget embedder)
            : this()
        {
        ...
        public bool AutoRejectEdition(bool changeFocus)
        {
            ...
            {
                if (
                    this.Items.FindIndexByValueExactMatch(this.acceptRejectBehavior.InitialText)
                    == -1
                )
                {
        ...
        {
            if ((this.mode == TextFieldExListMode.EditPassive) && (mode != TabNavigationMode.None))
            {
        ...
        protected override void CopyItemsToComboList(
            Epsitec.Common.Widgets.Collections.StringCollection list
        )
        {
        ...
        {
            if ((this.HasPlaceHolder) && (value >= 0))
            {
                value++;
            }
        ...
        protected override void UpdateButtonGeometry()
        {
            if (this.acceptRejectBehavior != null)
            {
                this.margins.Right =
                    this.mode == TextFieldExListMode.EditActive
                        ? this.acceptRejectBehavior.DefaultWidth
                        : this.button.PreferredWidth;
        ...
        {
            if (
                (this.acceptRejectBehavior != null) && (this.mode == TextFieldExListMode.EditActive)
            )
            {
        ...
        protected override void UpdateButtonVisibility()
        {
            ...
            if ((this.button != null) && (this.acceptRejectBehavior != null))
            {
                if (this.mode == TextFieldExListMode.EditActive)
                {
        ...
        protected override void CloseCombo(CloseMode mode)
        {
            ...
            if ((this.HasPlaceHolder) && (this.Text == this.PlaceHolder))
            {
                this.SwitchToState(TextFieldExListMode.EditPassive);
            }
        }
