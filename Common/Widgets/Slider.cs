...
namespace Epsitec.Common.Widgets
{
    ...
    public sealed class Slider : AbstractSlider, Support.Data.INumValue
    {
        ...
        {
            get { return this.hasFrame; }
            set { this.hasFrame = value; }
        }

        public Drawing.Color Color
        {
            get { return (Drawing.Color)this.GetValue(Slider.ColorProperty); }
            set { this.SetValue(Slider.ColorProperty, value); }
        }
        ...
        {
            get { return new Drawing.Point(0, 0); }
        }
