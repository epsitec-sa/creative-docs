...
namespace Epsitec.Common.Widgets
{
    ...
    public class MenuItem : AbstractButton
    {
        ...
        public MenuItem(Widget embedder)
            : this()
        {
        ...
        public MenuItem(string command, string text)
            : this()
        {
        ...
        public MenuItem(string command, string icon, string text, string shortcut)
            : this()
        {
            this.CommandObject = Command.Get(command);
            this.IconUri = icon;
        ...
        public MenuItem(string command, string icon, string text, string shortcut, string name)
            : this(command, icon, text, shortcut)
        {
            this.Name = name;
        }

        public MenuItem(Widget submenu, string icon, string text, string shortcut)
            : this()
        {
            this.IconUri = icon;
            this.Text = text;
        ...
        public MenuItem(Widget submenu, string icon, string text, string shortcut, string name)
            : this(submenu, icon, text, shortcut)
        {
            this.Name = name;
        }
        ...
        {
            get { return (MenuOrientation)this.GetValue(MenuItem.MenuOrientationProperty); }
        }

        public MenuItemState ItemState
        {
            get { return (MenuItemState)this.GetValue(MenuItem.ItemStateProperty); }
            set { this.SetValue(MenuItem.ItemStateProperty, value); }
        }

        public string IconUriActiveNo
        {
            get { return this.iconUriActiveNo; }
            set
            {
        ...
        {
            get { return this.iconUriActiveYes; }
            set
            {
        ...
        {
            get { return this.GetValue(MenuItem.SubmenuProperty) as Widget; }
            set { this.SetValue(MenuItem.SubmenuProperty, value); }
        }

        public double IconWidth
        {
            get { return this.iconSize.Width; }
            set
            {
        ...
        public static MenuItem CreateYesNo(
            string command,
            string text,
            string shortcut,
            string name
        ...
        private void UpdateIconSize()
        {
            ...
            if ((this.iconUriActiveNo != null) && (this.iconUriActiveNo.Length > 0))
            {
            ...
            if ((this.iconUriActiveYes != null) && (this.iconUriActiveYes.Length > 0))
            {
        ...
        protected virtual void OnUserAction(MessageEventArgs e)
        {
            ...
            {
                Behaviors.MenuBehavior.OpenItemSubmenu(
                    this,
                    Behaviors.MenuBehavior.Animate.Automatic
                );
            }
        }
        ...
        protected void UpdateGeometry()
        {
            ...
            else
            {
                ...
                if (this.shortcut != null)
                    this.shortcut.LayoutSize = this.shortcutSize;
            }
        }
        ...
        )
        {
            ...
            adorner.PaintMenuItemBackground(
                graphics,
                rect,
                state,
                Direction.Up,
            ...
            if (this.textOnly || this.MenuOrientation == MenuOrientation.Horizontal)
            {
                ...
                adorner.PaintMenuItemTextLayout(
                    graphics,
                    pos,
                    this.TextLayout,
                    state,
            ...
            else
            {
                ...
                {
                    if ((this.ActiveState == ActiveState.Yes) && (icon != this.iconUriActiveYes))
                    {
                ...
                pos.X =
                    rect.Width
                    - this.submenuMarkWidth
                    - this.shortcutSize.Width
                    + MenuItem.MarginItem;
        ...
        public static Behaviors.MenuBehavior GetMenuBehavior(Widget widget)
        {
            ...
            if (parent == null)
            {
                return (root == null)
                    ? null
                    : root.GetValue(MenuItem.MenuBehaviorProperty) as Behaviors.MenuBehavior;
            }
            else
            {
        ...
        public static MenuItem GetParentMenuItem(Widget widget)
        {
            return (widget == null)
                ? null
                : widget.GetValue(MenuItem.ParentMenuItemProperty) as MenuItem;
        }
        ...
        private static void NotifySubmenuChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty SubmenuProperty = DependencyProperty.Register(
            "Submenu",
            typeof(Widget),
            typeof(MenuItem),
            new DependencyPropertyMetadata(
                null,
                new PropertyInvalidatedCallback(MenuItem.NotifySubmenuChanged)
            )
        );
        public static readonly DependencyProperty ItemStateProperty = DependencyProperty.Register(
            "ItemState",
            typeof(MenuItemState),
            typeof(MenuItem),
        ...
        public static readonly DependencyProperty MenuOrientationProperty =
            DependencyProperty.Register(
                ...
                typeof(MenuItem),
                new VisualPropertyMetadata(
                    MenuOrientation.Undefined,
                    VisualPropertyMetadataOptions.AffectsDisplay
                )
            );

        public static readonly DependencyProperty MenuBehaviorProperty =
            DependencyProperty.RegisterAttached(
                "MenuBehavior",
                typeof(Behaviors.MenuBehavior),
                typeof(MenuItem)
            );
        ...
        public static readonly DependencyProperty MenuHostProperty =
            DependencyProperty.RegisterAttached("MenuHost", typeof(IMenuHost), typeof(MenuItem));
        public static readonly DependencyProperty ZeroDelayProperty =
            DependencyProperty.RegisterAttached(
                "ZeroDelay",
                typeof(bool),
                typeof(MenuItem),
