...
namespace Epsitec.Common.Widgets
{
    ...
    public class MenuItemContainer : MenuItem
    {
        ...
        public MenuItemContainer(Widget embedder)
            : this()
        {
                ...
                foreach (Widget widget in widgets)
                {
                    if (widget.IsFocused)
                    {
                        System.Diagnostics.Debug.WriteLine(
                            "Removing focus from " + widget.ToString()
                        );
            ...
            if (this.Children.Count > 0)
            {
                ...
                foreach (Widget widget in widgets)
                {
                    if (widget.AcceptsFocus)
                    {
                        ...
                        {
                            System.Diagnostics.Debug.WriteLine(
                                "Setting focus on " + widget.ToString()
                            );
                            this.DisableFilter();
                            widget.Focus();
                        }
        ...
        {
            if ((this.filterDisabled) && (message.MessageType == MessageType.KeyDown))
            {
                ...
                if (forward)
                {
                    ...
                    if ((behavior != null) && (window != null))
                    {
                        System.Diagnostics.Debug.WriteLine(
                            "Bubbling up message " + message.ToString()
                        );
