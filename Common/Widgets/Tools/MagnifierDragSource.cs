...
namespace Epsitec.Common.Widgets.Tools
{
    ...
    public class MagnifierDragSource : Widget, Behaviors.IDragBehaviorHost
    {
        ...
        public Drawing.Point DragLocation
        {
            get
            {
                Drawing.Point pos = this.MapClientToScreen(
                    new Drawing.Point(this.Client.Size.Width / 2, this.Client.Size.Height / 2)
                );
        ...
        {
            add { this.AddUserEventHandler("HotColorChanged", value); }
            remove { this.RemoveUserEventHandler("HotColorChanged", value); }
        }
