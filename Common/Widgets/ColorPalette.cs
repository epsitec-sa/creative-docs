...
namespace Epsitec.Common.Widgets
{
    ...
    public class ColorPalette : Widget
    {
        ...
        {
            get { return this.optionButton.Visibility; }
            set
            {
        ...
        {
            get { return (bool)this.GetValue(ColorPalette.HiliteSelectedColorProperty); }
            set { this.SetValue(ColorPalette.HiliteSelectedColorProperty, value); }
        }
        ...
        {
            get { return this.includeOpenSaveCommands; }
            set { this.includeOpenSaveCommands = value; }
        }

        public int SelectedColorIndex
        {
            get { return (int)this.GetValue(ColorPalette.SelectedColorIndexProperty); }
            set
            {
                if (value == -1)
                {
        ...
        {
            get { return this.GetColorSample(this.SelectedColorIndex); }
        }
        ...
        {
            get { return (bool)this.GetValue(ColorPalette.DragSourceEnableProperty); }
            set
            {
                if (value)
                {
        ...
        private void CreateColorSamples(int columns, int rows)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                this.palette[i]
                    .AddEventHandler(ColorSample.ColorProperty, this.HandleColorSampleColorChanged);
        ...
        private void DisposeColorSamples()
        {
            if (this.palette != null)
            {
                foreach (ColorSample sample in this.palette)
                {
                    ...
                    sample.RemoveEventHandler(
                        ColorSample.ColorProperty,
                        this.HandleColorSampleColorChanged
                    );
                    sample.Dispose();
                }
        ...
        {
            if ((this.palette == null) || (this.optionButton == null))
            {
                return;
            }
            ...
            switch (this.ContentAlignment)
            {
                ...
                case Drawing.ContentAlignment.TopCenter:
                    offset = System.Math.Floor(
                        (availableWidth - internalMargin - contentsWidth) / 2
                    );
                    break;
        ...
        private void HandleOptionButtonClicked(object sender, MessageEventArgs e)
        {
            if (e.Message.Button == MouseButtons.Left)
            {
                ...
                Drawing.Point pos = button.MapClientToScreen(
                    new Drawing.Point(0, button.ActualHeight)
                );
        ...
        private void HandleColorClicked(object sender, MessageEventArgs e)
        {
            ...
            if ((e.Message.IsShiftPressed) || (e.Message.IsControlPressed))
            {
        ...
        {
            if ((this.colorCollection != null) && (this.palette != null))
            {
        ...
        private void HandleColorSampleColorChanged(
            object sender,
        ...
        )
        {
            ...
            Drawing.RichColor oldColor =
                e.OldValue == null ? Drawing.RichColor.Empty : (Drawing.RichColor)e.OldValue;
            Drawing.RichColor newColor =
                e.NewValue == null ? Drawing.RichColor.Empty : (Drawing.RichColor)e.NewValue;
        ...
        {
            add { this.AddUserEventHandler(ColorPalette.ExportEvent, value); }
            remove { this.RemoveUserEventHandler(ColorPalette.ExportEvent, value); }
        }

        public event EventHandler ImportSelectedColor
        {
            add { this.AddUserEventHandler(ColorPalette.ImportEvent, value); }
            remove { this.RemoveUserEventHandler(ColorPalette.ImportEvent, value); }
        }
        ...
        internal static void NotifySelectedColorIndexChanged(
        ...
        internal static void NotifyDragSourceEnableChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty SelectedColorIndexProperty =
            DependencyProperty.Register(
                ...
                typeof(int),
                typeof(ColorPalette),
                new DependencyPropertyMetadata(-1, ColorPalette.NotifySelectedColorIndexChanged)
            );
        public static readonly DependencyProperty HiliteSelectedColorProperty =
            DependencyProperty.Register(
                "HiliteSelectedColor",
                typeof(bool),
                typeof(ColorPalette),
        ...
        public static readonly DependencyProperty DragSourceEnableProperty =
            DependencyProperty.Register(
                "DragSourceEnable",
                typeof(bool),
                typeof(ColorPalette),
                new DependencyPropertyMetadata(true, ColorPalette.NotifyDragSourceEnableChanged)
            );
