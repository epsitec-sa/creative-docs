...
namespace Epsitec.Common.Widgets
{
            ...
            Support.Data.IKeyedStringSelection
    {
        public ScrollList()
        {
            ...
            this.scroller = new VScroller() { IsInverted = true, Parent = this };
        ...
        {
            get { return this.scrollListStyle; }
            set
            {
        ...
        public bool AllRowsHaveSameWidth
        {
            ...
            get { return this.allRowsHaveSameWidth; }
            set { this.allRowsHaveSameWidth = value; }
        }

        public bool AutomaticScrollEnable { get; set; }
        ...
        public int FirstVisibleRow
        {
            ...
            set
            {
                ...
                value = System.Math.Min(
                    value,
                    System.Math.Max(this.items.Count - this.visibleRows, 0)
                );
        ...
        {
            get { return this.disableListDisplay; }
            set
            {
        ...
        public void ShowSelected(ScrollShowMode mode)
        {
            ...
            if (
                ...
                && this.selectedRow < this.firstRow + this.visibleRows
            )
                return;
        ...
        public Rectangle GetRowBounds(int index)
        {
            ...
            if ((index < 0) || (index >= this.textFrames.Length))
            {
        ...
        public Rectangle GetRowBounds(int index, int count)
        {
            ...
            if ((endIndex < 0) || (beginIndex >= this.textFrames.Length))
            {
                return Rectangle.Empty;
            }
        ...
        public Size GetBestFitSizeBasedOnContent()
        {
            ...
            int max = this.allRowsHaveSameWidth
                ? (this.items.Count == 0 ? 0 : 1)
                : this.items.Count;
        ...
        private void UpdateTextLayouts()
        {
            ...
            if (this.isDirty)
            {
                ...
                Point pos = new Point(
                    ...
                    rect.Height - ScrollList.TextOffsetY
                );
                ...
                for (int i = 0; i < max; i++)
                {
                    ...
                    string text =
                        (i + this.firstRow < this.items.Count) ? this.items[i + this.firstRow] : "";
        ...
        private void UpdateContentPadding()
        {
            ...
            this.contentPadding = new Margins(
                adorner.GeometryScrollListXMargin,
        ...
        private void UpdateScrollerGeometry(double availableHeight)
        {
            ...
            var rect = new Rectangle(
                x: this.Client.Size.Width
                    - adorner.GeometryScrollerRightMargin
                    - this.scroller.PreferredWidth,
                y: adorner.GeometryScrollerBottomMargin
                    + ScrollList.TextOffsetY
                    - this.contentPadding.Bottom,
                width: this.scroller.PreferredWidth,
                height: availableHeight
                    - adorner.GeometryScrollerTopMargin
                    - adorner.GeometryScrollerBottomMargin
                    + this.contentPadding.Height
            );
        ...
        {
            int index = this.items.FindIndexByValueStartMatch(
                search,
                this.SelectedItemIndex + (continued ? 0 : 1)
            );
        ...
        )
        {
            var margins = new Margins(
                0,
                0,
                ScrollList.TextOffsetY - this.contentPadding.Top,
                ScrollList.TextOffsetY - this.contentPadding.Bottom
            );
        ...
        private void PaintContents(Graphics graphics, IAdorner adorner, WidgetPaintState state)
        {
            ...
            for (int i = 0; i < max; i++)
            {
                ...
                if (
                    (this.IsItemSelected(this.firstRow + i))
        ...
        public string SelectedItem
        {
            ...
            set { this.SelectedItemIndex = this.Items.IndexOf(value); }
        }
                    ...
                    if (value != null)
                    {
                        ...
                        if (index < 0)
                        {
                            throw new System.ArgumentException(
                                string.Format("No element named '{0}' in list", value)
                            );
                        }
                    }
        ...
        {
            add { this.AddUserEventHandler("SelectionActivated", value); }
            remove { this.RemoveUserEventHandler("SelectionActivated", value); }
        }
