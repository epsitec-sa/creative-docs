...
namespace Epsitec.Common.Widgets
{
    ...
    public class Scrollable : AbstractGroup, Behaviors.IDragBehaviorHost
    {
        ...
        {
            get { return (Viewport)this.GetValue(Scrollable.ViewportProperty); }
            private set { this.SetValue(Scrollable.ViewportProperty, value); }
        }

        public Point ViewportOffset
        {
            get { return this.viewportOffset; }
            set
            {
        ...
        {
            get { return this.viewportOffset.X; }
            set
            {
        ...
        {
            get { return this.viewportOffset.Y; }
            set
            {
        ...
        {
            get { return this.scrollWithHand; }
            set
            {
        ...
        {
            get { return this.viewportFrameMargins; }
            set
            {
        ...
        {
            get { return this.viewportPadding; }
            set
            {
        ...
        protected void UpdateGeometry()
        {
            ...
            if ((this.hScroller == null) || (this.vScroller == null))
            {
                return;
            }
            ...
            if (this.hScroller.Visibility)
            {
                if (this.hScrollerMode == ScrollableScrollerMode.ShowAlwaysOppositeSide)
                {
                    var bounds = new Rectangle(
                        ...
                        rect.Top,
                        rect.Width,
                        this.hScroller.PreferredHeight
                    );
        ...
        protected virtual void UpdateViewportLocation()
        {
            ...
            for (; ; )
            {
                ...
                if ((deltaDx > 0) && (this.hScrollerMode != ScrollableScrollerMode.HideAlways))
                {
                ...
                if ((deltaDy > 0) && (this.vScrollerMode != ScrollableScrollerMode.HideAlways))
                {
            ...
            if ((viewportDx > 0) && (deltaDx > 0) && (visDx > 0))
            {
            ...
            if ((viewportDy > 0) && (deltaDy > 0) && (visDy > 0))
            {
            ...
            viewport.SetManualBounds(
                new Rectangle(
                    this.viewportAperture.Left - offsetX,
                    this.viewportAperture.Top - viewportDy + offsetY,
                    viewportDx,
                    viewportDy
                )
            );
        ...
        private static void HandleViewportChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty ViewportProperty =
            DependencyProperty<Scrollable>.Register(
                x => x.Viewport,
                new DependencyPropertyMetadata(null, Scrollable.HandleViewportChanged)
            );
        public static readonly DependencyProperty ViewportOffsetXProperty =
            DependencyProperty.Register(
                "ViewportOffsetX",
                typeof(double),
                typeof(Scrollable),
                new DependencyPropertyMetadata(
                    Scrollable.GetViewportOffsetXValue,
                    Scrollable.SetViewportOffsetXValue
                )
            );
        public static readonly DependencyProperty ViewportOffsetYProperty =
            DependencyProperty.Register(
                "ViewportOffsetY",
                typeof(double),
                typeof(Scrollable),
                new DependencyPropertyMetadata(
                    Scrollable.GetViewportOffsetYValue,
                    Scrollable.SetViewportOffsetYValue
                )
            );
