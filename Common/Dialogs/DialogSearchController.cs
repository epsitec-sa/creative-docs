...
namespace Epsitec.Common.Dialogs
{
    ...
    public sealed class DialogSearchController : System.IDisposable, IPaintFilter
    {
        ...
        {
            get { return this.entityResolver; }
            set { this.entityResolver = value; }
        }
        ...
        {
            get { return this.activeSearchContext; }
        }
        ...
        {
            get { return this.activePlaceholder; }
        }
        ...
        {
            get { return this.defaultSuggestion; }
            set
            {
        ...
        {
            if ((this.searchEntityId == searchEntityId) && (this.searchCriteria == searchCriteria))
            {
                return;
            }
        ...
        public bool SetFocus(EntityFieldPath path)
        {
            ...
            {
                AbstractPlaceholder placeholder = DialogSearchController.FindPlaceholder(
                    this.dialogData.Panel,
                    path
                );
        ...
        private void HandlePlaceholderContextActivated(object sender)
        {
            UI.Controllers.AbstractController controller =
                sender as UI.Controllers.AbstractController;

            if (
                (PlaceholderContext.Depth == 1)
            ...
            )
            {
                ...
                Placeholder placeholder = PlaceholderContext.GetInteractivePlaceholder(
                    this.DialogWindow
                );
        ...
        {
            if ((PlaceholderContext.Depth == 0) && (this.dialogDataEventArgsCache != null))
            {
        ...
        {
            AbstractPlaceholder oldPlaceholder = DialogSearchController.FindParentPlaceholder(
                e.OldValue as Widgets.Visual
            );
            AbstractPlaceholder newPlaceholder = DialogSearchController.FindParentPlaceholder(
                e.NewValue as Widgets.Visual
            );
        ...
        private void HandleWindowFocusedWidgetChanging(
            object sender,
            Widgets.FocusChangingEventArgs e
        )
        {
        ...
        {
            if ((this.suspendSearchHandler > 0) || (this.entityResolver == null))
            {
                return;
            }
            ...
            else
            {
                ...
                if (newContext == null)
                {
                    ...
                    {
                        newContext = new SearchContext(
                            this,
                            this.dialogData.Data,
                            EntityFieldPath.CreateRelativePath()
                        );
                    ...
                    {
                        IEntityProxyProvider proxyProvider = DialogSearchController
                            .GetEntityDataAndField(placeholder)
                            .Entity;
                        DialogData.FieldProxy proxy =
                            proxyProvider.GetEntityProxy() as DialogData.FieldProxy;
        ...
        private void HandleDialogDataChanged(AbstractPlaceholder placeholder, object value)
        {
            ...
            else
            {
                ...
                if (fieldPath != null)
                {
                    ...
                    {
                        this.OnDialogDataChanging(
                            new DialogDataEventArgs(fieldPath, placeholder, oldValue, newValue)
                        );
                    }
                }
            }
        ...
        private static AbstractPlaceholder FindPlaceholder(
            Widgets.Widget root,
            EntityFieldPath path
        )
        {
            foreach (
                AbstractPlaceholder placeholder in root.FindAllChildren(child =>
                    child is AbstractPlaceholder
                )
            )
            {
        ...
        private static EntityFieldPath GetPlaceholderPath(AbstractPlaceholder placeholder)
        {
            ...
            if ((sourceType == DataSourceType.StructuredData) && (path.StartsWith(pathPrefix)))
            {
            ...
            else
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format("Unexpected binding: source type={0}, path={1}", sourceType, path)
                );
                return null;
            }
        }
        ...
        private void NotifySuggestionChanged(
            EntityFieldPath path,
            AbstractEntity oldSuggestion,
            AbstractEntity newSuggestion
        )
        {
            if (oldSuggestion != newSuggestion)
            {
                this.OnSuggestionChanged(
                    new DialogDataEventArgs(path, null, oldSuggestion, newSuggestion)
                );
            }
        }
        ...
        private void NotifySuggestionChangedDialogDataValidty(
            AbstractEntity suggestion,
            bool oldValidity,
            bool newValidity
        )
        {
            System.Diagnostics.Debug.WriteLine(
                "Suggestion set to " + (suggestion == null ? "<null>" : suggestion.Dump())
            );

            if ((oldValidity != newValidity) && (this.dialogPanel != null))
            {
                Widgets.CommandContext commandContext =
                    Widgets.Helpers.VisualTree.GetCommandContext(this.dialogPanel);
                Widgets.ValidationContext validationContext =
                    Widgets.Helpers.VisualTree.GetValidationContext(this.dialogPanel);

                if ((commandContext != null) && (validationContext != null))
                {
        ...
        private void AsyncResolveSearch()
        {
            ...
            {
                if ((this.activeSearchContext != null) && (this.entityResolver != null))
                {
                    this.activeSearchContext.Resolve(
                        this.entityResolver,
                        this.searchEntityId,
                        this.searchCriteria
                    );
        ...
        private void ActivatePlaceholder(AbstractPlaceholder placeholder)
        {
            ...
            if (oldPlaceholder != newPlaceholder)
            {
                ...
                this.OnActivePlaceholderChanged(
        ...
        private void ActivateSearchContext(SearchContext context)
        {
            ...
            if (oldContext != newContext)
            {
                ...
                this.OnSearchContextChanged(
                    new DependencyPropertyChangedEventArgs("SearchContext", oldContext, newContext)
                );
            }
        }
        ...
        private void OnPlaceholderPostProcessing(
            AbstractPlaceholder sender,
            Widgets.MessageEventArgs e
        )
        {
        ...
        private static EntityField GetEntityDataAndField(AbstractPlaceholder placeholder)
        {
            ...
            DataSourceType sourceType =
                binding == null ? DataSourceType.None : binding.GetSourceType();
        ...
        void IPaintFilter.NotifyAboutToProcessChildren(Widget sender, PaintEventArgs e)
        {
            ...
            )
            {
                if (Widgets.Helpers.VisualTree.IsAncestor(this.dialogPanel, sender))
                {
                    ...
                    Drawing.Rectangle rootRect = placeholder.MapClientToRoot(
                        placeholder.Client.Bounds
                    );
                    Drawing.Rectangle localRect = Drawing.Rectangle.Deflate(
                        sender.MapRootToClient(rootRect),
                        0.5,
                        0.5
                    );
                    ...
                    e.Graphics.RenderSolid(
                        Drawing.Color.FromRgb(255.0 / 255.0, 186.0 / 255.0, 1.0 / 255.0)
                    );
                    e.Graphics.Rasterizer.AddOutline(
                        path,
                        1,
                        Drawing.CapStyle.Round,
                        Drawing.JoinStyle.Round
                    );
        ...
        {
            public AbstractPlaceholder Placeholder { get; set; }

            public EntityFieldPath Path { get; set; }

            public SearchContext Context { get; set; }

            public bool IsEmpty
            {
                get { return this.Placeholder == null; }
            }
        ...
        private sealed class SearchContext : System.IDisposable, ISearchContext
        {
            ...
            public SearchContext(
                ...
                AbstractEntity rootData,
                EntityFieldPath rootPath
            )
            {
            ...
            {
                get { return this.resolverResult; }
            }
            ...
            public void AnalyzePlaceholderGraph(Widgets.Widget root, bool initialSearchValues)
            {
                ...
                else
                {
                    ...
                    entityData =
                        this.searchRootPath.NavigateRead(this.searchRootData) as AbstractEntity;
                }
                ...
                foreach (Node node in this.GetPlaceholderGraph(root))
                {
                    ...
                    if ((initialSearchValues) && (entityData != null))
                    {
                        node.Path.NavigateWrite(
                            this.searchTemplate,
                            node.Path.NavigateRead(entityData)
                        );
                    }
                }
            }
            ...
            public IEnumerable<Node> GetPlaceholderGraph(Widgets.Widget root)
            {
                ...
                )
                {
                    ...
                    {
                        EntityFieldPath fieldPath = EntityFieldPath.CreateRelativePath(
                            proxy.GetFieldPath(),
                            field
                        );
            ...
            public void Clear()
            {
                ...
                {
                    if (
                        node.Placeholder.SuggestionMode
                        == PlaceholderSuggestionMode.DisplayActiveHint
                    )
                    {
                        node.Placeholder.SuggestionMode =
                            PlaceholderSuggestionMode.DisplayHintResetText;
            ...
            public void SetSuggestionValue(Node node, AbstractEntity entity)
            {
                ...
                object newValue =
                    entity == null ? UndefinedValue.Value : readPath.NavigateRead(entity);
            ...
            {
                get { return this.searchController; }
            }
            ...
            {
                get { return this.searchTemplate; }
            }
            ...
            {
                get { return this.activeSuggestion; }
            }
            ...
            public void SetSuggestion(AbstractEntity suggestion)
            {
                ...
                this.searchController.dialogData.SetReferenceReplacement(
                    this.searchRootPath,
                    suggestion
                );
                ...
                {
                    this.searchController.NotifySuggestionChangedDialogDataValidty(
                        suggestion,
                        oldValidity,
                        newValidity
                    );
                ...
                if (oldSuggestion != newSuggestion)
                {
                    ...
                    if (this.searchController.DialogData.Mode != DialogDataMode.Search)
                    {
                        ReferencePlaceholder reference =
                            this.searchController.activePlaceholder as ReferencePlaceholder;

                        if (reference != null)
                        {
                            if (suggestion == null)
                            {
                                EntityContext context = this.searchController
                                    .DialogData
                                    .EntityContext;
                    ...
                    this.searchController.NotifySuggestionChanged(
                        this.searchRootPath,
                        oldSuggestion,
                        newSuggestion
                    );
            ...
            public IEnumerable<Druid> GetEntityIds()
            {
                ...
                else
                {
                    return new Druid[]
                    {
                        this.searchRootPath.NavigateReadSchema(this.searchRootData).TypeId
                    };
                }
            }
            ...
            )
            {
                ...
                {
                    this.resolverResult = EntityResolver.Resolve(
                        entityResolver,
                        searchEntityId,
                        searchCriteria
                    );
                ...
                AbstractEntity suggestion =
                    this.searchController.defaultSuggestion
                    ?? this.activeSuggestion
                    ?? this.GetDefaultSuggestion();

                this.searchController.defaultSuggestion = null;

                if ((suggestion != null) && (this.resolverResult.AllResults.Contains(suggestion)))
                {
            ...
            {
                if ((e.Message.Handled == false) && (e.Message.IsKeyType))
                {
                    this.searchController.OnPlaceholderPostProcessing(
                        sender as AbstractPlaceholder,
                        e
                    );
                }
            }
            ...
            {
                AbstractEntity item =
                    this.searchRootPath.NavigateRead(this.searchController.dialogData.Data)
                    as AbstractEntity;

                int pos = Types.Collection.FindIndex(
                    this.resolverResult.AllResults,
                    x => EntityContext.CompareEqual(x, item)
                );
        ...
        {
            add { DialogSearchController.globalContext.ContextChanged += value; }
            remove { DialogSearchController.globalContext.ContextChanged -= value; }
        }
