...
namespace Epsitec.Common.Dialogs
{
    ...
    public class FileListItem
        : System.IComparable<FileListItem>,
            System.IEquatable<FileListItem>,
            Epsitec.Common.Types.IStructuredData,
            Epsitec.Common.Types.IStructuredTypeProvider
    {
        public FileListItem(
            string iconUri,
            string fileName,
        ...
        public string DefaultDescription
        {
            ...
            set { this.defaultDescription = value; }
        }

        public FolderItem FolderItem
        {
            get { return this.folderItem; }
            set
            {
        ...
        public FolderItemIcon GetSmallIcon()
        {
            ...
            {
                this.SmallIcon = FileManager.GetFolderItemIcon(
                    this.FolderItem,
        ...
        public FolderItemIcon GetLargeIcon()
        {
            ...
            {
                this.LargeIcon = FileManager.GetFolderItemIcon(
                    this.FolderItem,
        ...
        public string GetResolvedFileName()
        {
            ...
            if (this.cachedFileName == null)
            {
                if (this.IsShortcut)
                {
                    FolderItem item = FileManager.ResolveShortcut(
                        this.folderItem,
        ...
        public string ShortFileName
        {
            ...
            get
            {
                if (this.cachedShortFileName == null)
                {
                    ...
                    {
                        this.cachedShortFileName = FolderItem.GetShortFileName(
                            this.folderItem.FullPath
                        );
                    }
                }
            ...
            set { this.cachedShortFileName = value; }
        }

        public bool IsSynthetic
        {
            //	Retourne true si c'est un 'Nouveau document vide'
            get { return this.isSynthetic; }
        }

        public bool IsDefaultItem
        {
            get { return this.isDefaultItem; }
            set { this.isDefaultItem = value; }
        }
            ...
            get
            {
                ...
                else
                {
                    return string.Concat(
                        this.cachedDateTime.ToShortDateString(),
                        " ",
                        this.cachedDateTime.ToShortTimeString()
                    );
                }
            }
        }
            ...
            if (this.cachedDateTime.Ticks == 0)
            {
                ...
                else if (!string.IsNullOrEmpty(this.folderItem.FullPath))
                {
                    try
                    {
                        ...
                        {
                            System.IO.DirectoryInfo info = new System.IO.DirectoryInfo(
                                this.folderItem.FullPath
                            );
                ...
                else
                {
                    ...
                    if (size / 1024 < 10)
                    {
                        ...
                        return string.Format(
                            Res.Strings.Dialog.File.Size.Kilo.ToSimpleText(),
                            s.ToString()
                        );
                    }
                    ...
                    if (size / 1024 < 10)
                    {
                        ...
                        return string.Format(
                            Res.Strings.Dialog.File.Size.Mega.ToSimpleText(),
                            s.ToString()
                        );
                    }
                    ...
                    if (size / 1024 < 10)
                    {
                        ...
                        return string.Format(
                            Res.Strings.Dialog.File.Size.Giga.ToSimpleText(),
                            s.ToString()
                        );
                    }
        ...
        public string GetIconUri(FileInfoIconSize size)
        {
            if (size == FileInfoIconSize.Small)
            {
                if (this.smallIconUri == null)
                {
                    ...
                    if (icon != null)
                    {
                        if ((this.IsDirectoryOrShortcut) || (!this.GetAsyncImage()))
                        {
                    ...
                    this.documentInfo.GetAsyncThumbnail(
                        delegate(Image image)
                        {
                            ...
                            if (this.attachedImagePlaceholder != null)
                            {
                                ...
                                this.attachedImagePlaceholder.DisplayMode =
        ...
        {
            get { return this.attachedImagePlaceholder; }
            set { this.attachedImagePlaceholder = value; }
        }
        ...
        public bool SortAccordingToLevel
        {
            ...
            get { return this.sortAccordingToLevel; }
            set { this.sortAccordingToLevel = value; }
        }
        ...
        public static Epsitec.Common.Types.StructuredType GetStructuredType()
        {
            ...
            if (FileListItem.type == null)
            {
                ...
                FileListItem.type.Fields.Add(
                    "icon",
                    Epsitec.Common.Types.StringType.NativeDefault,
                    Support.Druid.Empty
                );
                FileListItem.type.Fields.Add(
                    "name",
                    Epsitec.Common.Types.StringType.NativeDefault,
                    Res.Captions.File.Column.Name.Id
                );
                FileListItem.type.Fields.Add(
                    "info",
                    Epsitec.Common.Types.IntegerType.Default,
                    Res.Captions.File.Column.Info.Id
                );
                FileListItem.type.Fields.Add(
                    "date",
                    Epsitec.Common.Types.DateTimeType.Default,
                    Res.Captions.File.Column.Date.Id
                );
                FileListItem.type.Fields.Add(
                    "size",
                    Epsitec.Common.Types.LongIntegerType.Default,
                    Res.Captions.File.Column.Size.Id
                );
            }
        ...
        void Epsitec.Common.Types.IStructuredData.AttachListener(
            string id,
            EventHandler<Epsitec.Common.Types.DependencyPropertyChangedEventArgs> handler
        ) { }

        void Epsitec.Common.Types.IStructuredData.DetachListener(
            string id,
            EventHandler<Epsitec.Common.Types.DependencyPropertyChangedEventArgs> handler
        ) { }
        ...
        void Epsitec.Common.Types.IValueStore.SetValue(
            string id,
            object value,
            Epsitec.Common.Types.ValueStoreSetMode mode
        )
        {
            throw new System.InvalidOperationException();
        }
        ...
        private static DriveInfo GetDriveInfo(string fullPath)
        {
            lock (FileListItem.globalExclusion)
            {
                ...
                if ((delta > 1000) || (FileListItem.driveInfos == null))
                {
