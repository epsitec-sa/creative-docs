...
namespace Epsitec.Common.Dialogs
{
    ...
    public sealed class HintListController : DependencyObject
    {
        ...
        public HintListController()
        {
            ...
            this.searchController.DialogFocusChanged +=
                this.HandleSearchControllerDialogFocusChanged;
            this.searchController.PlaceholderPostProcessing +=
                this.HandleSearchControllerPlaceholderPostProcessing;
            ...
            this.searchController.SearchContextChanged +=
                this.HandleSearchControllerSearchContextChanged;
            this.searchController.ActivePlaceholderChanged +=
                this.HandleSearchControllerActivePlaceholderChanged;

            this.emptyCollectionView = new CollectionView(new System.Collections.ArrayList());

            DialogSearchController.GlobalSearchContextChanged +=
                this.HandleGlobalSearchContextChanged;
        }
        ...
        public void RefreshHintList()
        {
            ...
            if ((this.searchResult != null) && (this.searchController.ActiveSearchContext != null))
            {
                ICollectionView view = this.searchResult.CollectionView;
                AbstractEntity suggestion = this.searchController
                    .ActiveSearchContext
                    .ActiveSuggestion;
        ...
        private void RefreshHintListHeader()
        {
            ...
            if (entityId.IsValid)
            {
                ResourceManager manager =
                    Epsitec.Common.Widgets.Helpers.VisualTree.GetResourceManager(
                        this.hintListWidget
                    );
            ...
            this.hintListWidget.Header.Enable =
                (this.searchController.ActiveSearchContext == null) ? false : true;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                this.searchController.SuggestionChanged -=
                    this.HandleSearchControllerSuggestionChanged;
                this.searchController.DialogDataChanged -=
                    this.HandleSearchControllerDialogDataChanged;
                this.searchController.DialogFocusChanged -=
                    this.HandleSearchControllerDialogFocusChanged;
                this.searchController.PlaceholderPostProcessing -=
                    this.HandleSearchControllerPlaceholderPostProcessing;
        ...
        private void CreateUserInterface()
        {
            if (this.hintListWidget == null)
            {
                ...
                this.hintListWidget.Header.SearchWidget.ValueChanged +=
                    this.HandleHintListSearchWidgetValueChanged;
                this.hintListWidget.CurrentItemChanged +=
                    this.HandleHintListWidgetCurrentItemChanged;
            }

            if (
                (this.hintListEmbedder == null)
                && (this.Visibility == HintListVisibilityMode.AutoHide)
            )
            {
                this.hintListEmbedder = new HintListEmbedder(
                    this.searchController.DialogWindow,
                    this.hintListWidget
                );
            }
        }
        ...
        private void HandleHintListSearchWidgetValueChanged(
            object sender,
        ...
        )
        {
            ...
            {
                UI.ReferencePlaceholder reference =
                    this.searchController.ActivePlaceholder as UI.ReferencePlaceholder;

                if ((reference != null) && (reference.EntityType.CaptionId.IsValid))
                {
                    this.searchController.SetSearchCriteria(
                        reference.EntityType.CaptionId,
        ...
        private void HandleSearchControllerSearchContextChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
        ...
        private void HandleSearchControllerActivePlaceholderChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
        ...
        private void HandleGlobalSearchContextChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
            ...
            if ((context != null) && (context.SearchController == this.searchController))
            {
        ...
        private void HandleSearchControllerSuggestionChanged(
            object sender,
            DialogDataEventArgs e
        ) { }

        private void HandleSearchControllerDialogDataChanged(
            object sender,
            DialogDataEventArgs e
        ) { }
        ...
        {
            ReferencePlaceholder placeholder =
        ...
        private void HandleSearchControllerPlaceholderPostProcessing(
            object sender,
            MessageEventArgs e
        )
        {
        ...
        private void HandleSearchControllerResolved(object sender)
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                string.Format("Found {0} results", this.searchResult.AllResults.Count)
            );
