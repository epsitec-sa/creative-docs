...
namespace Epsitec.Common.Dialogs
{
    ...
    public class PrinterDocumentPropertiesDialog : PrintDialog
    {
        ...
        static extern int DocumentProperties(
            ...
            System.IntPtr printeHandle,
            string deviceName,
            System.IntPtr devModeOut,
            System.IntPtr devModeIn,
            int mode
        );
        ...
        static extern bool OpenPrinter(
            string printerName,
            out System.IntPtr printerHandle,
            System.IntPtr defaultPtr
        );
        ...
        static extern bool ClosePrinter(System.IntPtr printerHandle);

        [System.Runtime.InteropServices.DllImport("kernel32.dll")]
        static extern System.IntPtr GlobalFree(System.IntPtr handle);

        [System.Runtime.InteropServices.DllImport("kernel32.dll")]
        static extern System.IntPtr GlobalLock(System.IntPtr handle);

        [System.Runtime.InteropServices.DllImport("kernel32.dll")]
        static extern bool GlobalUnlock(System.IntPtr handle);
        #endregion

        private System.Windows.Forms.DialogResult InternalShowDialog(
            System.Windows.Forms.IWin32Window owner
        )
        {
            ...
            try
            {
                ...
                if (
                    PrinterDocumentPropertiesDialog.OpenPrinter(
                        printerName,
                        out printerHandle,
                        printerDefaults
                    )
                ...
                {
                    int result = PrinterDocumentPropertiesDialog.DocumentProperties(
                        owner == null ? System.IntPtr.Zero : owner.Handle,
                        printerHandle,
                        deviceName,
                        devModePtr,
                        devModePtr,
