...
namespace Epsitec.Common.Dialogs
{
    ...
    public class Dialog : AbstractDialog
    {
        ...
        {
            get { return this.userInterfaceResourceId; }
            set
            {
                if (this.HasWindow)
                {
                    throw new System.InvalidOperationException(
                        "UserInterfaceResourceId may not be changed while the dialog has a window"
                    );
                }
        ...
        public DialogData Data
        {
            ...
            set
            {
                ...
                {
                    if ((this.dialogData != null) && (this.panel != null))
                    {
        ...
        {
            get { return this.dialogSearchController; }
            set { this.dialogSearchController = value; }
        }
        ...
        protected override void OnDialogWindowCreated()
        {
            ...
            this.CommandDispatcher.Register(
                Res.Commands.Dialog.Generic.Cancel,
                this.HandleCancelCommand
            );
            this.CommandDispatcher.Register(
                Res.Commands.Dialog.Generic.Ok,
                this.HandleAcceptCommand
            );
            this.CommandDispatcher.Register(
                Res.Commands.Dialog.Generic.Apply,
                this.HandleApplyCommand
            );
        }
        ...
        private void InitializeDataBinding()
        {
            ...
            if ((this.panel != null) && (this.dialogData != null) && (this.isDataBound == false))
            {
                ...
                this.validationContext.CommandContext =
                    Widgets.Helpers.VisualTree.GetCommandContext(this.panel);
        ...
        {
            if ((this.panel != null) && (this.dialogData != null) && (this.isDataBound))
            {
        ...
        private UI.Panel CreateUserInterfaceFromForm(ResourceBundle bundle)
        {
            ...
            FormEngine.Engine formEngine = new FormEngine.Engine(
                new FormEngine.DefaultResourceProvider(this.resourceManager)
            );
