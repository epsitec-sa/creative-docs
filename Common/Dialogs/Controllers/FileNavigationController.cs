...
namespace Epsitec.Common.Dialogs.Controllers
{
    public class FileNavigationController
    {
        ...
        public FolderItem ActiveDirectory
        {
            ...
            set { this.SetActiveDirectory(value, RecordInHistory.Yes); }
        }
        ...
        public FolderItemIcon ActiveSmallIcon
        {
            get
            {
                ...
                {
                    this.activeSmallIcon = FileManager.GetFolderItemIcon(
        ...
        {
            get { return this.ActiveDirectory.FullPath; }
        }

        public string ActiveDirectoryDisplayName
        {
            get { return this.ActiveDirectory.DisplayName; }
        }
        ...
        private void CreateUserInterface()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.navigateCombo,
                Epsitec.Common.Dialogs.Res.Strings.Dialog.File.Tooltip.VisitedMenu
            );
        ...
        public void NavigatePrev()
        {
            if (this.visitedIndex > 0)
            {
                this.SetActiveDirectory(
                    this.visitedFolderItems[--this.visitedIndex],
                    RecordInHistory.No
                );
            }
        }
        ...
        {
            FolderItem parent = FileManager.GetParentFolderItem(
                this.ActiveDirectory,
        ...
        protected virtual void OnActiveDirectoryChanged(string oldPath, string newPath)
        {
            ...
            {
                this.ActiveDirectoryChanged(
                    this,
                    new DependencyPropertyChangedEventArgs("ActiveDirectory", oldPath, newPath)
                );
            }
        }
        ...
        private void RegisterCommands()
        {
            this.dispatcher.Register(
                Epsitec.Common.Dialogs.Res.Commands.Dialog.File.NavigatePrev,
                this.NavigatePrev
            );
            this.dispatcher.Register(
                Epsitec.Common.Dialogs.Res.Commands.Dialog.File.NavigateNext,
                this.NavigateNext
            );
            this.dispatcher.Register(
                Epsitec.Common.Dialogs.Res.Commands.Dialog.File.ParentFolder,
                this.NavigateParent
            );
        }
        ...
        private void UpdateCommandStates()
        {
            ...
            this.context.GetCommandState(Res.Commands.Dialog.File.NavigatePrev).Enable = (
                this.visitedIndex > 0
            );
            this.context.GetCommandState(Res.Commands.Dialog.File.NavigateNext).Enable = (
                this.visitedIndex < this.visitedFolderItems.Count - 1
            );
            this.context.GetCommandState(Res.Commands.Dialog.File.ParentFolder).Enable =
                parent.IsValid;
        }
