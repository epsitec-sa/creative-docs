...
namespace Epsitec.Common.Printing
{
    ...
    public sealed class XmlPort : IPaintPort
    {
        ...
        {
            get { return this.currentState.lineWidth; }
            set { this.currentState.lineWidth = value; }
        }

        public JoinStyle LineJoin
        {
            get { return this.currentState.lineJoin; }
            set { this.currentState.lineJoin = value; }
        }

        public CapStyle LineCap
        {
            get { return this.currentState.lineCap; }
            set { this.currentState.lineCap = value; }
        }

        public double LineMiterLimit
        {
            get { return this.currentState.lineMiterLimit; }
            set { this.currentState.lineMiterLimit = value; }
        }

        public RichColor RichColor
        {
            get { return RichColor.FromColor(this.currentState.originalColor); }
            set
            {
        ...
        public Color Color
        {
            get { return this.currentState.originalColor; }
            set
            {
        ...
        {
            get { return RichColor.FromColor(this.currentState.color); }
            set { this.FinalColor = value.Basic; }
        }

        public Color FinalColor
        {
            get { return this.currentState.color; }
            set { this.currentState.color = value; }
        }

        public Transform Transform
        {
            get { return this.currentState.transform; }
            set { this.currentState.transform = value; }
        }

        public FillMode FillMode
        {
            get { return this.currentState.fillMode; }
            set { this.currentState.fillMode = value; }
        }

        public ImageFilter ImageFilter
        {
            get { return this.currentState.imageFilter; }
            set { this.currentState.imageFilter = value; }
        }

        public Margins ImageCrop
        {
            get { return this.currentState.imageCrop; }
            set { this.currentState.imageCrop = value; }
        }

        public Size ImageFinalSize
        {
            get { return this.currentState.imageFinalSize; }
            set { this.currentState.imageFinalSize = value; }
        }

        public bool HasEmptyClippingRectangle
        {
            get { return this.currentState.clip.IsSurfaceZero; }
        }
        ...
        private void UpdateGraphicState(XElement xml)
        {
            ...
            if (this.lastState.lineMiterLimit != this.currentState.lineMiterLimit)
            {
                ...
                xml.Add(
                    new XAttribute("lineMiterLimit", this.Truncate(this.lastState.lineMiterLimit))
                );
            }
            ...
            if (this.lastState.imageFinalSize != this.currentState.imageFinalSize)
            {
                ...
                xml.Add(
                    new XAttribute(
                        "imageFinalSizeWidth",
                        this.Truncate(this.lastState.imageFinalSize.Width)
                    )
                );
                xml.Add(
                    new XAttribute(
                        "imageFinalSizeHeight",
                        this.Truncate(this.lastState.imageFinalSize.Height)
                    )
                );
            }
