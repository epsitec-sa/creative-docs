...
namespace Epsitec.Common.Printing
{
    ...
    public sealed class PrintPort : Drawing.IPaintPort
    {
        ...
        private static System.Drawing.Rectangle GetRealMarginsBounds(
            System.Drawing.Printing.PrintPageEventArgs e
        )
        {
            int cx = 0;
        ...
        {
            get { return Drawing.RichColor.FromColor(this.originalColor); }
            set
            {
        ...
        {
            get { return Drawing.RichColor.FromColor(this.color); }
            set
            {
                ...
                if (this.color != basic)
                {
                    ...
                    else
                    {
                        throw new System.FormatException(
                            string.Format(
                                "The color {0} is not compatible with the PrintPort.",
                                value.ToString()
                            )
                        );
                    }
                ...
                if (this.imageFilter != value)
                {
                    ...
                    switch (this.imageFilter.Mode)
                    {
                        case Epsitec.Common.Drawing.ImageFilteringMode.None:
                            this.graphics.InterpolationMode = System
                                .Drawing
                                .Drawing2D
                                .InterpolationMode
                                .NearestNeighbor;
        ...
        public Drawing.Transform Transform
        {
            ...
            set
            {
                if (this.transform != value)
                {
                    ...
                    this.graphics.MultiplyTransform(
                        matrix,
        ...
        private void SetClippingRectangle(double x, double y, double width, double height)
        {
            ...
            this.clip = Drawing.Rectangle.Intersection(
                this.clip,
        ...
        {
            get { return this.clip.IsSurfaceZero; }
        }
        ...
        {
            Drawing.Transform rotation = Drawing.Transform.CreateRotationDegTransform(
                angle,
                cx,
                cy
            );
        ...
        {
            Drawing.Transform rotation = Drawing.Transform.CreateRotationRadTransform(
                angle,
                cx,
                cy
            );
        ...
        {
            if ((path != null) && (this.lineWidth > 0))
            {
                this.UpdatePen();

                System.Drawing.Drawing2D.GraphicsPath graPath = path.CreateSystemPath();
                graPath.FillMode =
                    this.fillMode == Drawing.FillMode.EvenOdd
        ...
        )
        {
            ...
            catch
            {
                System.Diagnostics.Debug.WriteLine(
                    "Cannot access OS font " + font.FullName + ", emulating using Path."
                );
                osFont = null;
            }
            ...
            else
            {
                ...
                if (true)
                {
                    ...
                    {
                        new System.Drawing.CharacterRange(10, 1)
                    };
        ...
        )
        {
            ...
            {
                if ((infos[i].Scale != 1.00) && (infos[i].GlyphClass == Drawing.GlyphClass.Space))
                {
        ...
        )
        {
            ...
            System.Drawing.RectangleF src = new System.Drawing.RectangleF(
                (float)(ix1),
                (float)(iy1),
                (float)(ix2 - ix1),
                (float)(iy2 - iy1)
            );
            System.Drawing.RectangleF dst = new System.Drawing.RectangleF(
                0,
                0,
                (float)(fillWidth),
                (float)(fillHeight)
            ...
            this.graphics.DrawImage(
                bitmap.BitmapImage.NativeBitmap,
                dst,
                src,
        ...
        public static void PrintToClipboardMetafile(
            System.Action<Drawing.IPaintPort> painter,
            int dx,
            int dy
        )
        {
        ...
        public static void PrintToMetafile(
            System.Action<Drawing.IPaintPort> painter,
            string path,
            int dx,
            int dy
        ...
        public static void PrintToBitmap(
            System.Action<Drawing.IPaintPort> painter,
            string path,
            int dx,
            int dy
        ...
        public static void PrintFittedSinglePage(
            System.Action<Drawing.IPaintPort> painter,
        ...
        )
        {
            ...
            transform = transform.Translate(
                (bounds.Width - scale * dx) / 2,
                (bounds.Height - scale * dy) / 2
            );
        ...
        class Metafile : System.IDisposable
        {
            ...
            public Metafile(string path, int dx, int dy)
            {
                ...
                this.bitmapGraphics.FillRectangle(
                    System.Drawing.Brushes.White,
                    bitmap.GetBounds(ref units)
                );

                this.hdc = bitmapGraphics.GetHdc();
                this.metafile = new System.Drawing.Imaging.Metafile(
                    path,
                    this.hdc,
            ...
            public void Dispose()
            {
                ...
                {
                    Epsitec.Common.Drawing.Platform.ClipboardMetafileHelper.PutMetafileOnClipboardAndDispose(
                        this.metafile
                    );
                }
                else
        ...
        class Bitmap : System.IDisposable
        {
            ...
            public System.Drawing.Graphics Graphics
            {
                get { return this.bitmapGraphics; }
            }
        ...
        {
            public SinglePagePrintEngine(
                System.Action<Drawing.IPaintPort> print,
                Drawing.Transform transform
            )
            {
                this.print = print;
