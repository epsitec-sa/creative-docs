...
namespace Epsitec.Common.Support.CodeGeneration
{
    ...
    public struct CodeAttributes
    {
        ...
        public CodeAttributes(
            ...
            CodeAccessibility accessibility,
        ...
        {
            get { return this.isPartialDefinition; }
        }
        ...
        public override string ToString()
        {
            ...
            switch (this.visibility)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("CodeVisibility.{0} not supported here", this.visibility)
                    );
            }
            ...
            switch (this.accessibility)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("CodeAccess.{0} not supported here", this.accessibility)
                    );
            }
