...
namespace Epsitec.Common.Support.EntityEngine
{
    ...
    public sealed class EntityExpression
    {
        ...
        {
            get { return this.encodedExpression.Encoding; }
        }
        ...
        /// <returns>The expression.</returns>
        public static EntityExpression FromSourceCode(
            ...
            switch (encoding)
            {
                ...
                default:
                    throw new System.ArgumentException(
                        string.Format("Invalid encoding '{0}' in this context", encoding)
                    );
            }
        ...
        static EntityExpression()
        {
            ...
            EntityExpression.stringToEncoding["λ/c#"] =
                EntityExpressionEncoding.LambdaCSharpSourceCode;

            foreach (
                KeyValuePair<
                    string,
                    EntityExpressionEncoding
                > pair in EntityExpression.stringToEncoding
            )
            {
        ...
        private struct EncodedExpression : System.IEquatable<EncodedExpression>
        {
            ...
            {
                return (this.encoding == other.encoding) && (this.expression == other.expression);
            }
            ...
            public override string ToString()
            {
                ...
                else
                {
                    return string.Concat(
                        EntityExpression.HeaderFromEncoding(this.encoding),
                        "\r\n",
                        this.expression
                    );
                }
