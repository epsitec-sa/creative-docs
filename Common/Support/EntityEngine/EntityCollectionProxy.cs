...
namespace Epsitec.Common.Support.EntityEngine
{
    ...
    public sealed class EntityCollectionProxy<T>
        : IList<T>,
        ...
        where T : AbstractEntity
    {
        ...
        private System.Collections.IList EntityCollection
        {
            get
            {
                return this.entityCollection
                    ?? this.container.InternalGetValue(this.containerFieldId)
        ...
        {
            get { return this.EntityCollection[index] as T; }
            set { this.EntityCollection[index] = value; }
        }
        ...
        public int Count
        {
            get { return this.EntityCollection.Count; }
        }

        public bool IsReadOnly
        {
            get { return this.EntityCollection.IsReadOnly; }
        }
        ...
        {
            get { return this.EntityCollection[index]; }
            set { this.EntityCollection[index] = value; }
        }
        ...
        {
            get { return this.EntityCollection.IsSynchronized; }
        }

        public object SyncRoot
        {
            get { return this.EntityCollection.SyncRoot; }
        }
        ...
        public INotifyCollectionChanged GetNotifyCollectionChangedSource()
        {
            INotifyCollectionChangedProvider provider =
                this.EntityCollection as INotifyCollectionChangedProvider;
