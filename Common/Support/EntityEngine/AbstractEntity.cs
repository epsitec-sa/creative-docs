...
namespace Epsitec.Common.Support.EntityEngine
{
            ...
            IReadOnly
    {
        ...
        {
            get { return !this.defineOriginalValues.IsZero; }
        }

        private bool IsUpdateSilent
        {
            get { return !this.silentUpdates.IsZero; }
        }

        internal bool AreEventsEnabled
        {
            get { return this.disableEvents.IsZero; }
        }

        private bool ReadOnlyChecksEnabled
        {
            get { return this.disableReadOnlyChecks.IsZero; }
        }
        ...
        {
            get { return this.GetEntityStatus().HasFlag(EntityStatus.Empty); }
        }

        public bool IsEntityValid
        {
            get { return this.GetEntityStatus().HasFlag(EntityStatus.Valid); }
        }

        public bool IsEntityPartiallyCreated
        {
            get { return this.GetEntityStatus().HasFlag(EntityStatus.PartiallyCreated); }
        }
        ...
        /// </summary>
        internal long? DataContextId { get; set; }
        ...
        private void Dump(
            ...
            int level = 0,
            HashSet<AbstractEntity> history = null,
            System.Predicate<StructuredTypeField> filter = null,
            bool includeLabels = false,
            bool topLevelOnly = false,
            bool skipUndefinedFields = false
        )
        {
            if (history == null)
            {
            ...
            if (history.Add(this))
            {
                ...
                foreach (string id in this.context.GetEntityFieldIds(this))
                {
                    ...
                    if ((filter != null) && (filter(field) == false))
                    {
                        continue;
                    }
                    ...
                    {
                        if ((value == null) || (value == UndefinedValue.Value))
                        {
                            continue;
                        }
                    }
                    ...
                    switch (this.InternalGetFieldRelation(id))
                    {
                        case FieldRelation.None:
                            buffer.AppendFormat(
                                ...
                                indent,
                                name,
                                value == null ? nullValue : value.ToString()
                            );
                            break;
        ...
        public static T Resolve<T>(AbstractEntity entity)
        ...
        public T GetField<T>(string id)
        {
            ...
            if (UnknownValue.IsUnknownValue(value))
            {
                throw new System.NotSupportedException(
                    string.Format("Field {0} not supported by value store", id)
                );
            }
            ...
            using (this.LockWrite())
            {
                ...
                if (list == null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            throw new System.NotSupportedException(
                                string.Format("Field {0} uses incompatible collection type", id)
                            );
                        }
        ...
        public static TResult GetCalculation<T, TResult>(
            T entityObject,
            string id,
            System.Func<T, TResult> func,
            System.Linq.Expressions.LambdaExpression expr
        )
        {
            ...
            if (entity == null)
            {
                throw new System.ArgumentException(
                    "Invalid entity specified; cannot resolve to AbstractEntity"
                );
            }
            ...
            else
            {
                ...
                return context.EvaluateFunc(
                    delegate
                    {
                        return func(entityObject);
                    },
                    entity,
                    typeof(T),
                    id,
        ...
        public static void SetCalculation<T, TResult>(T entityObject, string id, TResult newValue)
        {
            ...
            else
            {
                throw new System.NotSupportedException(
                    string.Format(
                        "Trying to modify calculation {0} for entity {1}",
                        id,
                        typeof(T).Name
                    )
                );
        ...
        internal void InternalSetValue(
            string id,
            object value,
            ValueStoreSetMode mode = ValueStoreSetMode.Default
        )
        {
            using (this.LockWrite())
            {
            ...
            using (this.LockWrite())
            {
                ...
                if (list == null)
                {
                    if (UndefinedValue.IsUndefinedValue(value))
                    {
                        ...
                        using (this.DefineOriginalValues())
                        {
                            ...
                            list = new EntityCollection<AbstractEntity>(
                                id,
                                this,
                                copyOnWrite: true
                            );
                ...
                else
                {
                    ...
                    if (collection.HasCopyOnWriteState)
                    {
                        ...
                        list =
                            System.Activator.CreateInstance(collectionType, id, this)
        ...
        internal EntityCollection<T> CopyFieldCollection<T>(
            string id,
        ...
        {
            var ids = EntityContext
                .GetValueStoreDataIds(this.originalValues)
            ...
            using (this.LockWrite())
            {
                ...
                if (field == null || field.Type == null)
                {
                    throw new System.ArithmeticException(
                        string.Format("Invalid field '{0}' specified", id)
                    );
                }
                ...
                if (isNullValue && (field.IsNullable || this.context.SkipConstraintChecking))
                {
                    ...
                    if (
                        (EntityNullReferenceVirtualizer.IsPatchedEntity(this))
                    ...
                    )
                    {
                        ...
                        nullValue = EntityNullReferenceVirtualizer.CreateNullEntityForField(
                            this,
                            field
                        );
                    }
                ...
                else
                {
                    ...
                    if (
                        (this.context.SkipConstraintChecking) || (constraint.IsValidValue(newValue))
                    )
                    {
                        object value;
                    ...
                    else
                    {
                        throw new System.ArgumentException(
                            string.Format(
                                "Invalid value '{0}' specified for field {1}",
                                newValue ?? "<null>",
                                id
                            )
                        );
        ...
        protected void NotifyEventHandlers(string id, object oldValue, object newValue)
        {
            if (this.eventHandlers != null)
            {
                ...
                {
                    ((EventHandler<DependencyPropertyChangedEventArgs>)fieldHandler)(
                        this,
                        new DependencyPropertyChangedEventArgs(id, oldValue, newValue)
                    );
                }
                if (contentHandler != null)
                {
                    ((EventHandler<DependencyPropertyChangedEventArgs>)contentHandler)(
                        this,
                        new DependencyPropertyChangedEventArgs(id, oldValue, newValue)
                    );
                }
        ...
        internal void SetModifiedValuesAsOriginalValues()
        {
            ...
            using (this.UseSilentUpdates())
            {
                ...
                {
                    AbstractEntity.SetModifiedValueAsOriginalValue(
                        originalValues,
                        modifiedValues,
                        fieldId
                    );
        ...
        private static void SetModifiedValueAsOriginalValue(
            IValueStore originalValues,
            IValueStore modifiedValues,
            Druid fieldId
        )
        {
            ...
            if (!UndefinedValue.IsUndefinedValue(modifiedValue))
            {
                ...
                modifiedValues.SetValue(
                    fieldName,
                    UndefinedValue.Value,
                    ValueStoreSetMode.ShortCircuit
                );
            }
        }
        ...
        internal void DefineLockFunctions(
            System.Func<System.IDisposable> readLockFunction,
            System.Func<System.IDisposable> writeLockFunction
        )
        {
