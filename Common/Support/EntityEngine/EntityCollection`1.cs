...
namespace Epsitec.Common.Support.EntityEngine
{
    ...
    public sealed class EntityCollection<T>
        : EntityCollection,
            ...
            IEntityCollection,
            INotifyCollectionChangedProvider
        where T : AbstractEntity
    {
                ...
                switch (this.state)
                {
                    ...
                    case CollectionState.Copied:
                        throw new System.InvalidOperationException(
                            "Copied collection may not be changed"
                        );
        ...
        {
            get { return this.Promote(index, this[index]); }
        ...
        {
            get { return this.state == CollectionState.CopyOnWrite; }
        }
        ...
        {
            if ((this.container != null) && (this.containerFieldId != null))
            {
