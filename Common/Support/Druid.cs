...
namespace Epsitec.Common.Support
{
    ...
    public struct Druid : System.IEquatable<Druid>, System.IComparable<Druid>, INullable
    {
        ...
        public bool IsEmpty
        {
            get { return (this.Type == DruidType.Invalid); }
        }
        ...
        {
            get { return this.Module == 0xfffff; }
        }
        ...
        {
            get { return this.DeveloperAndPatchLevel % Druid.DeveloperIdMultiplier; }
        }
        ...
        public string ToResourceId()
        {
            ...
            if (type != DruidType.Full)
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot convert {0} DRUID to a resource id", type)
                );
            }

            return string.Concat(
                "[",
                Druid.ToFullString(this.Module, this.DeveloperAndPatchLevel, this.Local),
                "]"
            );
        }
        ...
        public string ToFieldName()
        {
            ...
            if ((type != DruidType.Full) && (type != DruidType.ModuleRelative))
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot convert {0} DRUID to a field id name", type)
                );
            }
        ...
        public long ToFieldId()
        {
            ...
            {
                throw new System.InvalidOperationException(
                    string.Format("Cannot convert {0} DRUID to a field id", type)
                );
            }
        ...
        public long ToLong()
        {
            ...
            switch (type)
            {
                ...
                default:
                    throw new System.InvalidOperationException(
                        string.Format("Cannot convert {0} DRUID to a long", type)
                    );
            }
        }
        ...
        public override string ToString()
        {
            switch (this.Type)
            {
                ...
                case DruidType.ModuleRelative:
                    return Druid.ToPrefixedModuleString(
                        Resources.FieldIdPrefix,
                        this.DeveloperAndPatchLevel,
                        this.Local
                    );
        ...
        {
            if ((string.IsNullOrEmpty(value)) || (value == Strings.Invalid))
            {
                return new Druid();
            }
            ...
            if (value[0] == '_')
            {
                ...
                return new Druid(
                    Druid.GetModuleId(druid),
                    Druid.GetDevId(druid),
                    Druid.GetLocalId(druid)
                );
            }
            ...
            throw new System.FormatException(
                string.Format("Value '{0}' is not a valid DRUID encoding", value)
            );
        }
        ...
        public static bool TryParse(string value, out Druid druid)
        {
            ...
            if ((value[0] == '_') && (Druid.IsValidFullString(value.Substring(1))))
            {
            ...
            if ((value[0] == '$') && (Druid.IsValidModuleString(value.Substring(1))))
            {
        ...
        {
            if ((value != null) && (value.Length > 1) && (value[0] == '_'))
            {
        ...
        {
            return new Druid(
                Druid.GetModuleId(value),
                Druid.GetDevId(value),
                Druid.GetLocalId(value)
            );
        }
