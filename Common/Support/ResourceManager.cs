...
namespace Epsitec.Common.Support
{
    ...
    public sealed partial class ResourceManager
        : DependencyObject,
            System.IComparable<ResourceManager>,
            System.IEquatable<ResourceManager>,
            ...
            ICaptionResolver
    {
        ...
        public ResourceManager(ResourceManagerPool pool, ResourceModuleInfo info)
            : this(
                ...
                info == null ? null : info.FullId.Path
            )
        {
            if (info != null)
            {
        ...
        public ResourceManager(ResourceManagerPool pool, string executablePath, string modulePath)
        {
            ...
            foreach (
                Allocator<IResourceProvider, ResourceManager> allocator in Resources
                    .Factory
                    .Allocators
            )
            {
        ...
        {
            get { return this.MapToSuffix(ResourceLevel.Default, this.culture); }
        }

        public string LocalizedSuffix
        {
            get { return this.MapToSuffix(ResourceLevel.Localized, this.culture); }
        }
        ...
        {
            get { return this.defaultModuleId; }
        }

        public string DefaultModulePath
        {
            get { return this.defaultModulePath; }
        }

        public string DefaultModuleName
        {
            get { return this.defaultModuleName; }
        }
        ...
        public bool IsReady
        {
            get { return (this.defaultModuleName != null) && (this.defaultModuleId >= 0); }
        }

        public System.Func<int, ResourceManager> MissingModuleResolver { get; set; }
        ...
        public void DefineDefaultModuleName(string defaultModuleName)
        {
            ...
            if (this.defaultModuleName != null)
            {
                throw new System.InvalidOperationException(
                    "Resource Providers may not be setup more than once."
                );
            }
                ...
                if (module != null)
                {
                    ...
                    else if (this.defaultModuleId != module.ModuleInfo.Id)
                    {
                        throw new ResourceException(
                            string.Format(
                                "Inconsistent module id for module '{0}'",
        ...
        public ResourceManager GetManagerForReferenceModule()
        {
            ...
            if ((info != null) && (info.IsPatchModule))
            {
        ...
        public void AnalyzeFullId(
            string id,
            out string prefix,
            out string localId,
            out ResourceModuleId module
        )
        {
        ...
        public string NormalizeFullId(string prefix, string localId)
        {
            ...
            if (string.IsNullOrEmpty(prefix))
            {
                ...
                if (string.IsNullOrEmpty(prefix))
                {
                    throw new ResourceException(
                        string.Format(
                            "Cannot normalize resource name; prefix is empty for resource '{0}'",
                            localId
                        )
                    );
                }
        ...
        public string MapToSuffix(ResourceLevel level, CultureInfo culture)
        {
            ...
            switch (level)
            {
                case ResourceLevel.Default:
                    return Resources.DefaultTwoLetterISOLanguageName;
                case ResourceLevel.Localized:
                    return Resources.GetTwoLetterISOLanguageName(culture);
                case ResourceLevel.Customized:
                    return string.Concat("X", culture.TwoLetterISOLanguageName);
            }

            throw new ResourceException(
                string.Format("Invalid level {0} specified in MapToSuffix.", level)
            );
        }
        ...
        public void MapFromSuffix(string suffix, out ResourceLevel level, out CultureInfo culture)
        {
            ...
            throw new ResourceException(
                string.Format("Invalid suffix ({0}) specified in MapFromSuffix.", suffix)
            );
        }
        ...
        public string GetLevelCaption(ResourceLevel level, CultureInfo culture)
        {
            ...
            switch (level)
            {
                ...
                case ResourceLevel.Customized:
                    return string.Concat("Pers. ", culture.DisplayName);
            }

            throw new ResourceException(
                string.Format("Invalid level {0} specified in GetLevelCaption.", level)
            );
        }
        ...
        )
        {
            ...
            switch (level)
            {
                ...
                default:
                    throw new ResourceException(
                        string.Format("Invalid level {0} specified in GetBundleIds.", level)
                    );
            }
        ...
        public ResourceBundle GetBundleOrThrow(string id)
        {
            ...
            if (bundle == null)
            {
                throw new System.InvalidOperationException(
                    string.Format(
                        "Bundle '{0}' cannot be found for module {1} (root path is {2}). "
                            + "Did you properly mark the resource file as 'Content' and did you include the project in the application?",
                        id,
        ...
        )
        {
            ...
            {
                throw new ResourceException(
                    string.Format("'{0}' is not a bundle id (resolves to '{1}')", id, resourceId)
                );
            }
            ...
            if (provider != null)
            {
                ...
                string key = Resources.CreateBundleKey(
                    prefix,
                    module,
                    resourceId,
                    level,
                ...
                CultureInfo defaultCulture = Resources.FindCultureInfo(
                    Resources.GetDefaultTwoLetterISOLanguageName()
                );
                ...
                else
                {
                    switch (level)
                    {
                        ...
                        default:
                            throw new ResourceException(
                                string.Format("Invalid level {0} for resource '{1}'", level, id)
                            );
                    }
            ...
            if ((bundle != null) && (bundle.IsEmpty) && (bundle.Type == ""))
            {
                bundle = null;
            }
        ...
        public ResourceBundle.Field GetStringsBundleField(
            Druid druid,
            ResourceLevel level,
            CultureInfo culture
        )
        ...
        public void Bind(
            Types.DependencyObject targetObject,
            Types.DependencyProperty targetProperty,
            Druid druid
        )
        {
        ...
        )
        {
            ...
            if ((targetObject == null) || (targetProperty == null) || (resourceId == null))
            {
            ...
            {
                throw new ResourceException(
                    string.Format("Cannot bind to ressource '{0}'", resourceId)
                );
            }
        ...
        public bool ClearCaptionCache(Druid druid, ResourceLevel level, CultureInfo culture)
        {
            ...
            switch (level)
            {
                ...
                case ResourceLevel.Customized:
                case ResourceLevel.Default:
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, ResourceLevel.Merged, culture)
                    );
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, level, culture)
                    );
                    break;

                case ResourceLevel.All:
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, ResourceLevel.Default, culture)
                    );
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, ResourceLevel.Localized, culture)
                    );
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, ResourceLevel.Customized, culture)
                    );
                    removed |= this.captionCache.Remove(
                        Resources.CreateCaptionKey(druid, ResourceLevel.Merged, culture)
                    );
        ...
        )
        {
            ...
            if ((cache) && (this.captionCache.TryGetValue(key, out weakCaption)))
            {
            ...
            if (caption == null)
            {
                ...
                {
                    case ResourceLevel.Merged:
                        this.MergeWithCaption(
                            this.GetBundle(bundleName, ResourceLevel.Default, culture),
                            druid,
                            ref caption
                        );
                        ...
                        {
                            this.MergeWithCaption(
                                this.GetBundle(bundleName, ResourceLevel.Localized, defaultCulture),
                                druid,
                                ref caption
                            );
                        }
                        ...
                        {
                            this.MergeWithCaption(
                                this.GetBundle(bundleName, ResourceLevel.Localized, culture),
                                druid,
                                ref caption
                            );
                        }
                        ...
                        this.MergeWithCaption(
                            this.GetBundle(bundleName, ResourceLevel.Customized, culture),
                            druid,
                            ref caption
                        );
                        ...
                        if (caption != null)
                        {
                            this.ResolveDruidReferencesInCaption(
                                caption,
                    ...
                    case ResourceLevel.Customized:
                        this.MergeWithCaption(
                            this.GetBundle(bundleName, level, culture),
                            druid,
                            ref caption
                        );
                        break;
                ...
                if (caption != null)
                {
                    ...
                    if (cache)
                    {
                        ...
                        var bundleRelatedCache = this.GetBundleRelatedCache(
                            bundleName,
                            level,
                            culture
                        );
        ...
        private void ResolveDruidReferencesInCaption(
            Caption caption,
            ResourceLevel level,
            CultureInfo culture
        )
        {
            TransformCallback<string> transform = delegate(string value)
            {
                return this.ResolveDruidReferenceInText(value, level, culture);
            };

            caption.TransformTexts(transform);
        }

        private string ResolveDruidReferenceInText(
            string value,
            ResourceLevel level,
            CultureInfo culture
        )
        ...
        private void MergeWithCaption(ResourceBundle bundle, Druid druid, ref Caption caption)
        {
            if (bundle != null)
            {
                ...
                System.Diagnostics.Debug.Assert(
                    AbstractType.CheckComplexTypeBindingToCaption(caption)
                );
        ...
        {
            if ((mode == ResourceSetMode.None) || (mode == ResourceSetMode.InMemory))
            {
                return true;
            }
        ...
        public void DebugDumpProviders()
        {
            foreach (ProviderRecord provider in this.providers.Values)
            {
                System.Diagnostics.Debug.WriteLine(
                    string.Format(
                        "Prefix '{0}' implemented by class {1}",
                        provider.Prefix,
                        provider.DefaultProvider.GetType().FullName
                    )
                );
            }
        }
        ...
        private static void PatchAllStringBundles()
        {
            ...
            var stringTypes = assemblies.SelectMany(x =>
                x.GetTypes().Where(t => t.IsClass && t.FullName.EndsWith(".Res+Strings"))
            );
            var resources = (
                from type in stringTypes
                let field = type.GetField(
                    "_stringsBundle",
        ...
        public override string ToString()
        {
            return string.Format(
                "[ResMan lang={1}/mod={2} ({3})/serial={0}]",
                this.serialId,
                this.culture == null ? "--" : this.culture.TwoLetterISOLanguageName,
                this.defaultModuleName ?? "*",
                this.defaultModuleId
            );
        }
        ...
        internal bool SetResourceBinding(ResourceBinding binding)
        {
            ...
            if (
                (Resources.SplitFieldId(resourceId, out bundleName, out fieldName))
                && (bundleName.Length > 0)
                && (fieldName.Length > 0)
            )
            {
                BundleRelatedCache cache = this.GetBundleRelatedCache(
                    bundleName,
                    ResourceLevel.Merged,
                    this.culture
                );
        ...
        private BundleRelatedCache GetBundleRelatedCache(
            string bundleName,
            ResourceLevel level,
            CultureInfo culture
        )
        {
            ...
            if (this.bundleRelatedCache.TryGetValue(key, out cache) == false)
            {
                ...
                System.Diagnostics.Debug.Assert(
                    level == ResourceLevel.Default
                        || Resources.EqualCultures(cache.Bundle.Culture, culture)
                );
        ...
        private IResourceProvider FindProvider(
            string fullId,
            out string localId,
            out ResourceModuleId module
        )
        ...
        private IResourceProvider FindProviderFromPrefix(string prefix, ref ResourceModuleId module)
        {
            if (!string.IsNullOrEmpty(prefix))
            {
                ...
                if (this.providers.TryGetValue(prefix, out provider))
                {
                    if ((string.IsNullOrEmpty(module.Name)) && (module.Id < 0))
                    {
                        module = new ResourceModuleId(
                            this.defaultModuleName,
                            this.defaultModulePath,
                    ...
                    if ((module.Id < 0) && (string.IsNullOrEmpty(module.Path)))
                    {
        ...
        private class ProviderRecord
        {
            public ProviderRecord(
                ...
                Allocator<IResourceProvider, ResourceManager> allocator
            )
            {
            ...
            {
                get { return this.activeProvider; }
                set { this.activeProvider = value; }
            }
        ...
        public delegate SetBundleOperation SetBundleCallback(
            ResourceBundle bundle,
            ResourceSetMode mode
        );
        ...
        public static readonly DependencyProperty SourceBundleProperty =
            DependencyProperty.RegisterAttached(
                "SourceBundle",
                typeof(ResourceBundle),
                typeof(ResourceManager),
                new DependencyPropertyMetadata().MakeNotSerializable()
            );
        public static readonly DependencyProperty ReferenceManagerProperty =
