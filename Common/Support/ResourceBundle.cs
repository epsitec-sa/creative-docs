...
namespace Epsitec.Common.Support
{
    ...
    public sealed class ResourceBundle : Types.DependencyObject, System.ICloneable
    {
        ...
        private ResourceBundle(ResourceManager resourceManager, string name)
        ...
        {
            get { return this.caption == null ? "" : this.caption; }
        }

        public Druid Id
        {
            get { return this.druid; }
        }
        ...
        public string Type
        {
            get { return this.type == null ? "" : this.type; }
        }
            ...
            get
            {
                if (this.BasedOnPatchModule)
                {
                    if (this.refBundle == null)
                    {
                        ...
                        ResourceBundle bundle = manager.GetBundle(
                            string.IsNullOrEmpty(this.prefix)
                                ? string.Concat(this.prefix, ":", this.name)
                                : this.name,
                            this.level,
                            this.culture
                        );
        ...
        {
            get { return Resources.JoinFullPrefix(this.prefix, this.module.ToString()); }
        }

        public string PrefixedName
        {
            get { return this.manager.NormalizeFullId(this.Prefix, this.name); }
        }

        public bool IsEmpty
        {
            get { return this.FieldCount == 0; }
        }

        public long FieldsChangedCount
        {
            get { return this.fieldsChangedCount; }
        }
        ...
        {
            get { return this.fieldNameRequired; }
            set { this.fieldNameRequired = value; }
        }
        ...
        {
            get { return this[this.IndexOf(druid)]; }
        }
        ...
        public void DefineName(string name)
        {
            ...
            {
                if (
                    (!RegexFactory.ResourceBundleName.IsMatch(name))
                    && (!Druid.IsValidBundleId(name))
                )
                {
                    throw new ResourceException(
                        string.Format("Name '{0}' is not a valid bundle name.", name)
                    );
                }
            }
        ...
        public void DefineCaption(string caption)
        {
            ...
            else
            {
                ...
                {
                    throw new ResourceException(
                        string.Format("Caption '{0}' is not a valid bundle caption.", caption)
                    );
                }
        ...
        public void DefineType(string type)
        {
            if (type != null)
            {
                ...
                {
                    throw new ResourceException(
                        string.Format("Type '{0}' is not a valid type name.", type)
                    );
                }
            }
        ...
        internal void DefinePrefix(string prefix)
        {
            if (prefix != null)
            {
                switch (prefix)
                {
                    ...
                    default:
                        throw new System.NotImplementedException(
                            string.Format("Support for prefix {0} not implemented.", prefix)
                        );
                }
                ...
                {
                    throw new ResourceException(
                        string.Format("Prefix '{0}' is not a valid prefix name.", prefix)
                    );
                }
            }
        ...
        public void Insert(int index, Field field)
        {
            if ((index < 0) || (index > this.fields.Length))
            {
                throw new System.IndexOutOfRangeException(
                    string.Format("ResourceBundle field index {0} is out of range", index)
                );
            }
        ...
        public void Merge(ResourceLevel dataLevel)
        {
            ...
            for (int i = 0; i < this.fields.Length; i++)
            {
                ...
                if (string.IsNullOrEmpty(name))
                {
                    ...
                    if ((this.refInclusion == false) || (this.fieldNameRequired == false))
                    {
                    ...
                    {
                        throw new ResourceException(
                            string.Format("Field has no name. XML: {0}.", field.Xml.OuterXml)
                        );
                    }
                }
        ...
        public void Compile(System.Xml.XmlNode xmlroot, ResourceLevel dataLevel)
        {
            ...
            if (xmlroot.Name != "bundle")
            {
                throw new ResourceException(
                    string.Format(
                        "Bundle does not start with <bundle> tag (<{0}> is an unsupported root).",
                        xmlroot.Name
                    )
                );
            }
        ...
        public System.Xml.XmlNode CreateXmlNode(System.Xml.XmlDocument xmldoc)
        {
            ...
            rankAttr.Value =
                this.rank < 0
                    ? ""
                    : this.rank.ToString(System.Globalization.CultureInfo.InvariantCulture);
        ...
        public Field CreateField(ResourceFieldType type, object more)
        {
            ...
            throw new System.NotImplementedException(
                string.Format("{0} support not implemented.", type)
            );
        }
        ...
        private Field CreateFieldAsList(System.Collections.ICollection collection)
        {
            if (collection == null)
            {
                throw new System.ArgumentNullException(
                    "collection",
                    "List field needs a valid collection."
                );
            }
        ...
        private Field CreateFieldAsBundle(ResourceBundle bundle)
        {
            if (bundle == null)
            {
                throw new System.ArgumentNullException(
                    "bundle",
                    "Bundle field needs a valid bundle."
                );
            }
        ...
        private ResourceBundle ResolveRefBundle(System.Xml.XmlNode node)
        {
            ...
            if (targetField != null)
            {
                throw new ResourceException(
                    string.Format(
                        "<ref target='{0}'/> does not reference a bundle. XML: {1}.",
                        refTarget,
                        node.OuterXml
                    )
                );
            ...
            if (refType != null)
            {
                throw new ResourceException(
                    string.Format(
                        "<ref target='{0}'/> specifies type='{1}'. XML: {2}.",
                        refTarget,
                        refType,
                        node.OuterXml
                    )
            ...
            ResourceBundle bundle =
                this.manager.GetBundle(targetBundle, this.level, this.depth + 1) as ResourceBundle;

            if (bundle == null)
            {
                throw new ResourceException(
                    string.Format(
                        "<ref target='{0}'/> could not be resolved. Missing bundle. XML: {1}.",
                        refTarget,
                        node.OuterXml
                    )
                );
        ...
        private Field ResolveRefField(System.Xml.XmlNode node)
        {
            ...
            if (targetField == null)
            {
                throw new ResourceException(
                    string.Format(
                        "<ref target='{0}'/> does not reference a field. XML: {1}.",
                        refTarget,
                        node.OuterXml
                    )
                );
            ...
            if (field.IsEmpty)
            {
                throw new ResourceException(
                    string.Format(
                        "<ref target='{0}'/> could not be resolved. Missing field. XML: {1}.",
                        refTarget,
                        node.OuterXml
                    )
                );
        ...
        private byte[] ResolveRefBinary(System.Xml.XmlNode node)
        {
            ...
            if ((targetBundle != null) && (targetField == null))
            {
                ...
                if (data == null)
                {
                    throw new ResourceException(
                        string.Format(
                            "Binary target '{0}' cannot be resolved. XML: {1}.",
                            refTarget,
                            node.OuterXml
                        )
                    );
            ...
            throw new ResourceException(
                string.Format(
                    "Illegal reference to binary target '{0}'. XML: {1}.",
                    refTarget,
                    node.OuterXml
                )
            );
        ...
        private string GetTargetSpecification(string target)
        {
            ...
            if (Resources.ExtractPrefix(target) == null)
            {
                if (this.prefix == null)
                {
                    throw new ResourceException(
                        string.Format(
                            "No default prefix specified, target '{0}' cannot be resolved.",
                            target
                        )
                    );
                }
        ...
        public class Field
        {
            ...
            public Field(ResourceBundle parent, System.Xml.XmlNode xml)
            {
                ...
                if ((string.IsNullOrEmpty(id)) || (Druid.IsValidModuleString(id) == false))
                {
                    this.id = -1;
                }
                else
            ...
            public Druid Id
            {
                get { return Druid.FromFieldId(this.id); }
            }
            ...
            {
                get { return this.modificationId; }
            }
            ...
            public string AsString
            {
                get
                {
                    ...
                    throw new ResourceException(
                        string.Format(
                            "Cannot convert field '{0}' to string. XML: {1}.",
                            this.Name,
                            this.xml == null ? "-" : this.xml.OuterXml
                        )
                    );
                }
            }
            ...
            public byte[] AsBinary
            {
                get
                {
                    ...
                    throw new ResourceException(
                        string.Format(
                            "Cannot convert field '{0}' to binary. XML: {1}.",
                            this.Name,
                            this.xml == null ? "-" : this.xml.OuterXml
                        )
                    );
            ...
            public ResourceBundle AsBundle
            {
                get
                {
                    ...
                    throw new ResourceException(
                        string.Format(
                            "Cannot convert field '{0}' to bundle. XML: {1}.",
                            this.Name,
                            this.xml == null ? "-" : this.xml.OuterXml
                        )
                    );
            ...
            public FieldList AsList
            {
                get
                {
                    ...
                    throw new ResourceException(
                        string.Format(
                            "Cannot convert field '{0}' to list. XML: {1}.",
                            this.Name,
                            this.xml == null ? "-" : this.xml.OuterXml
                        )
                    );
            ...
            public void SetStringValue(string value)
            {
                ...
                if ((this.type != ResourceFieldType.Data) || ((string)this.data != value))
                {
            ...
            {
                if ((this.type == ResourceFieldType.None) && (this.xml != null))
                {
                    switch (this.xml.Name)
                    {
                        ...
                        case "ref":
                            throw new ResourceException(
                                string.Format(
                                    "Field contains unresolved <ref>, it cannot be compiled. XML: {0}.",
                                    this.xml.OuterXml
                                )
                            );
                        ...
                        default:
                            throw new ResourceException(
                                string.Format(
                                    "Unsupported tag <{0}> cannot be compiled. XML: {1}.",
                                    this.xml.Name,
                                    this.xml.OuterXml
                                )
                            );
            ...
            private void CompileDataElement(
            ...
            private void CompileDataReference(
                System.Xml.XmlNode node,
                System.Text.StringBuilder buffer
            )
            {
                ...
                if (field.Type != ResourceFieldType.Data)
                {
                    ...
                    throw new ResourceException(
                        string.Format(
                            "<ref target='{0}'/> resolution is not <data> compatible. XML: {1}.",
                            target,
                            field.Xml.OuterXml
                        )
                    );
