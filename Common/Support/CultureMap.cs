...
namespace Epsitec.Common.Support
{
    ...
    public class CultureMap : INotifyPropertyChanged
    {
                ...
                if (this.name != value)
                {
                    if (this.isNameFrozen)
                    {
                        throw new System.InvalidOperationException(
                            string.Format("Trying to rename frozen item {0}.", this.name)
                        );
                    }
                    ...
                    this.OnPropertyChanged(
                        null,
                        new DependencyPropertyChangedEventArgs("Name", oldName, newName)
                    );
                }
            }
        }
        ...
        public CultureMapSource Source
        {
            ...
            internal set
            {
                if (value != this.source)
                {
                    ...
                    this.OnPropertyChanged(
                        null,
                        new DependencyPropertyChangedEventArgs("Source", oldSource, newSource)
                    );
                }
            }
        }
        ...
        internal bool IsRefreshNeeded
        {
            ...
            set { this.isRefreshNeeded = value; }
        }
        ...
        public bool IsCultureDefined(string twoLetterISOLanguageName)
        {
            ...
            {
                if ((this.map[i].Key == twoLetterISOLanguageName) && (this.map[i].Value != null))
                {
                    return true;
                }
            }
        ...
        {
            if (
                (string.IsNullOrEmpty(twoLetterISOLanguageName))
            ...
            if (this.map != null)
            {
                ...
                {
                    if (
                        (this.map[i].Key == twoLetterISOLanguageName) && (this.map[i].Value != null)
                    )
                    {
        ...
        internal void RecordCultureData(string twoLetterISOLanguageName, Types.StructuredData data)
        {
            ...
            if (this.map == null)
            {
                ...
                this.map[0] = new KeyValuePair<string, Types.StructuredData>(
            ...
            else
            {
                ...
                for (int i = 0; i < this.map.Length; i++)
                {
                    ...
                    {
                        this.map[i] = new KeyValuePair<string, StructuredData>(
                            twoLetterISOLanguageName,
                            data
                        );
                        insert = false;
                ...
                if (insert)
                {
                    ...
                    KeyValuePair<string, Types.StructuredData>[] copy = new KeyValuePair<
                        string,
                        Types.StructuredData
                    >[pos + 1];

                    temp.CopyTo(copy, 0);
                    copy[pos] = new KeyValuePair<string, Types.StructuredData>(
                        twoLetterISOLanguageName,
                        data
                    );
