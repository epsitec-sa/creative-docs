...
namespace Epsitec.Common.Support
{
    ...
    public static class DynamicCodeFactory
    {
        ...
        public static PropertySetter CreatePropertySetter(System.Type type, string propertyName)
        {
            ...
            propertySetter = DynamicCodeFactory.CreatePropertySetter(
        ...
        /// A <see cref="PropertySetter"/> for the property.
        /// </returns>
        public static PropertySetter CreatePropertySetter(
        ...
        )
        {
            ...
            if ((method == null) || (propertyInfo.CanWrite == false))
            {
                return null;
            }
            ...
            if (hostType.IsValueType)
            {
                throw new System.InvalidOperationException(
                    "Cannot set property of boxed ValueType"
                );
            }
        ...
        public static PropertyGetter CreatePropertyGetter(System.Type type, string propertyName)
        {
            ...
            propertyGetter = DynamicCodeFactory.CreatePropertyGetter(
                type.GetProperty(propertyName)
            );
        ...
        /// A <see cref="PropertyGetter"/> for the property.
        /// </returns>
        public static PropertyGetter CreatePropertyGetter(
            System.Reflection.PropertyInfo propertyInfo
        )
        {
            if (propertyInfo == null)
            ...
            if ((method == null) || (propertyInfo.CanRead == false))
            {
                return null;
            }
        ...
        public static Allocator<T> CreateAllocator<T>(System.Type type)
        {
            ...
            System.Reflection.Emit.DynamicMethod allocator =
            ...
            System.Reflection.ConstructorInfo constructor =
                DynamicCodeFactory.GetBestParameterlessConstructor(type);
        ...
        public static Allocator<T, P> CreateAllocator<T, P>(System.Type type)
        {
            ...
            {
                throw new System.InvalidOperationException(
                    string.Format("Class {0} has no matching constructor", type.Name)
                );
            }
        ...
        public static PropertyComparer CreatePropertyComparer(System.Type type, string propertyName)
        {
            ...
            {
                if (
                    Types.TypeRosetta.DoesTypeImplementInterface(
                        type,
                        typeof(Types.IStructuredData)
                    )
                )
                {
        ...
        /// A <see cref="PropertyComparer"/> for the property.
        /// </returns>
        public static PropertyComparer CreatePropertyComparer(
            System.Reflection.PropertyInfo propertyInfo
        )
        {
            ...
            comparer = new System.Reflection.Emit.DynamicMethod(
                name,
                typeof(int),
                arguments,
                hostType
        ...
        private static System.Reflection.ConstructorInfo GetBestParameterlessConstructor(
            System.Type type
        )
        {
            ...
            if (constructor == null)
            {
                constructor = type.GetConstructor(
                    DynamicCodeFactory.PrivateBindingFlags,
                ...
                {
                    throw new System.InvalidOperationException(
                        string.Format("Class {0} has no parameterless constructor", type.Name)
                    );
                }
            }
        ...
        [System.ThreadStatic]
        private static Dictionary<string, PropertyGetter> getterCache =
            new Dictionary<string, PropertyGetter>();

        [System.ThreadStatic]
        private static Dictionary<string, PropertySetter> setterCache =
            new Dictionary<string, PropertySetter>();

        private const System.Reflection.BindingFlags PrivateBindingFlags =
