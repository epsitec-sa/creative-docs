...
namespace Epsitec.Common.Support.ResourceAccessors
{
    ...
    public partial class StructuredTypeResourceAccessor : CaptionResourceAccessor
    {
        ...
        public override void Load(ResourceManager manager)
        {
            ...
            AccessorsCollection accessors = StructuredTypeResourceAccessor.GetAccessors(
                manager.Pool
            );
        ...
        public override void NotifyItemChanged(
            CultureMap item,
        ...
        )
        {
            ...
            )
            {
                ...
                if (
                    (id == Res.Fields.Field.Expression)
                    && (
                        (CultureMapSource)container.GetValue(Res.Fields.Field.CultureMapSource)
                        == CultureMapSource.ReferenceModule
                    )
                )
                {
                    container.SetValue(
                        Res.Fields.Field.CultureMapSource,
                        CultureMapSource.DynamicMerge
                    );
                }
            }
        }
        ...
        public StructuredType GetStructuredTypeViewOfData(
            CultureMap item,
        ...
        )
        {
            ...
            Caption caption = base.CreateCaptionFromData(
                item.Id,
                null,
                data,
                item.Name,
        ...
        protected override void PromoteToOriginal(CultureMap item, StructuredData data)
        {
            ...
            ObservableList<StructuredData> fields =
                data.GetValue(Res.Fields.ResourceStructuredType.Fields)
                as ObservableList<StructuredData>;
            ObservableList<StructuredData> interfaceIds =
                data.GetValue(Res.Fields.ResourceStructuredType.InterfaceIds)
                as ObservableList<StructuredData>;
        ...
        protected override bool IsEmptyCaption(StructuredData data)
        {
            if (base.IsEmptyCaption(data))
            {
                ...
                IList<StructuredData> interfaceIds =
                    data.GetValue(Res.Fields.ResourceStructuredType.InterfaceIds)
                    as IList<StructuredData>;
                string designerLayouts =
                    data.GetValue(Res.Fields.ResourceStructuredType.SerializedDesignerLayouts)
                    as string;
                DataLifetimeExpectancy defaultLifetime =
                    data.GetValueOrDefault<DataLifetimeExpectancy>(
                        Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy
                    );
                StructuredTypeFlags flags = data.GetValueOrDefault<StructuredTypeFlags>(
                    Res.Fields.ResourceStructuredType.Flags
                );

                if (
                    (UndefinedValue.IsUndefinedValue(baseTypeValue))
                    &&
        ...
        )
        {
            ...
            AbstractCaptionResourceAccessor.CopyDeltaValue(
                rawData,
                patchData,
                Res.Fields.ResourceStructuredType.BaseType
            );

            string rawLayout =
                rawData.GetValue(Res.Fields.ResourceStructuredType.SerializedDesignerLayouts)
                as string;
            string refLayout =
                refData.GetValue(Res.Fields.ResourceStructuredType.SerializedDesignerLayouts)
                as string;
            ...
            if (rawLayout != refLayout)
            {
                AbstractCaptionResourceAccessor.CopyDeltaValue(
                    rawData,
                    patchData,
                    Res.Fields.ResourceStructuredType.SerializedDesignerLayouts
                );
            }

            var rawLifetime = rawData.GetValueOrDefault<DataLifetimeExpectancy>(
                Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy
            );
            var refLifetime = refData.GetValueOrDefault<DataLifetimeExpectancy>(
                Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy
            );
            ...
            var rawFlags = rawData.GetValueOrDefault<StructuredTypeFlags>(
                Res.Fields.ResourceStructuredType.Flags
            );
            var refFla = refData.GetValueOrDefault<StructuredTypeFlags>(
                Res.Fields.ResourceStructuredType.Flags
            );
            ...
            patchData.SetValue(
                Res.Fields.ResourceStructuredType.Class,
                refData.GetValue(Res.Fields.ResourceStructuredType.Class)
            );

            IList<StructuredData> refFields =
                refData.GetValue(Res.Fields.ResourceStructuredType.Fields) as IList<StructuredData>;
            IList<StructuredData> rawFields =
                rawData.GetValue(Res.Fields.ResourceStructuredType.Fields) as IList<StructuredData>;

            IList<StructuredData> refInterfaceIds =
                refData.GetValue(Res.Fields.ResourceStructuredType.InterfaceIds)
                as IList<StructuredData>;
            IList<StructuredData> rawInterfaceIds =
                rawData.GetValue(Res.Fields.ResourceStructuredType.InterfaceIds)
                as IList<StructuredData>;
            ...
            )
            {
                ...
                {
                    CultureMapSource fieldSource = (CultureMapSource)
                        field.GetValue(Res.Fields.Field.CultureMapSource);

                    if (
                        (fieldSource == CultureMapSource.DynamicMerge)
            ...
            )
            {
                ...
                {
                    CultureMapSource interfaceIdSource = (CultureMapSource)
                        interfaceId.GetValue(Res.Fields.InterfaceId.CultureMapSource);

                    System.Diagnostics.Debug.Assert(
                        interfaceIdSource != CultureMapSource.DynamicMerge
                    );
        ...
        protected override void HandleItemsCollectionChanged(
            object sender,
        ...
        private void HandleItemPropertyChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == Res.Fields.ResourceStructuredType.BaseType.ToString())
            {
                ...
                StructuredData data = item.GetCultureData(
                    Resources.DefaultTwoLetterISOLanguageName
                );
        ...
        protected override void RefreshItem(CultureMap item)
        {
            ...
            else
            {
                ...
                Druid baseTypeId = StructuredTypeResourceAccessor.ToDruid(
                    data.GetValue(Res.Fields.ResourceStructuredType.BaseType)
                );
        ...
        private StructuredType CreateTypeFromData(
            StructuredData data,
            Caption caption,
            System.Func<Druid, INamedType> namedTypeResolver
        )
        {
            if (
                UndefinedValue.IsUndefinedValue(
                    data.GetValue(Res.Fields.ResourceStructuredType.Class)
                )
            )
            {
                return null;
            ...
            StructuredTypeClass typeClass = StructuredTypeResourceAccessor.ToStructuredTypeClass(
                data.GetValue(Res.Fields.ResourceStructuredType.Class)
            );
            Druid baseType = StructuredTypeResourceAccessor.ToDruid(
                data.GetValue(Res.Fields.ResourceStructuredType.BaseType)
            );
            string layouts =
                data.GetValue(Res.Fields.ResourceStructuredType.SerializedDesignerLayouts)
                as string;
            DataLifetimeExpectancy lifetime = data.GetValueOrDefault<DataLifetimeExpectancy>(
                Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy
            );
            StructuredTypeFlags flags = data.GetValueOrDefault<StructuredTypeFlags>(
                Res.Fields.ResourceStructuredType.Flags
            ...
            if (interfaceIds != null)
            {
                foreach (StructuredData interfaceId in interfaceIds)
                {
                    Druid interfaceDruid = StructuredTypeResourceAccessor.ToDruid(
                        interfaceId.GetValue(Res.Fields.InterfaceId.CaptionId)
                    );
                    ...
                    else
                    {
                        System.Diagnostics.Debug.WriteLine(
                            "Fixed damaged interface definition for " + caption.Name
                        );
                    }
                }
            }

            IList<StructuredData> fieldsData =
                data.GetValue(Res.Fields.ResourceStructuredType.Fields) as IList<StructuredData>;
            ...
            if (fieldsData != null)
            {
                ...
                {
                    Druid fieldType = StructuredTypeResourceAccessor.ToDruid(
                        fieldData.GetValue(Res.Fields.Field.TypeId)
                    );
                    Druid fieldCaption = StructuredTypeResourceAccessor.ToDruid(
                        fieldData.GetValue(Res.Fields.Field.CaptionId)
                    );
                    FieldRelation relation = (FieldRelation)
                        fieldData.GetValue(Res.Fields.Field.Relation);
                    FieldMembership membership = StructuredTypeResourceAccessor.Simplify(
                        (FieldMembership)fieldData.GetValue(Res.Fields.Field.Membership)
                    );
                    FieldSource source = (FieldSource)fieldData.GetValue(Res.Fields.Field.Source);
                    FieldOptions options = (FieldOptions)
                        fieldData.GetValue(Res.Fields.Field.Options);
                    ...
                    Druid fieldDefiningType = StructuredTypeResourceAccessor.ToDruid(
                        fieldData.GetValue(Res.Fields.Field.DefiningTypeId)
                    );
                    bool? interfaceDefinition = StructuredTypeResourceAccessor.ToBoolean(
                        fieldData.GetValue(Res.Fields.Field.IsInterfaceDefinition)
                    );
                    ...
                    {
                        StructuredTypeField field = new CustomField(
                            fieldType,
                            fieldCaption,
                            rank++,
                            relation,
        ...
        )
        {
            ...
            if (type != null)
            {
                ...
                foreach (string fieldId in type.GetFieldIds())
                {
                    ...
                    StructuredTypeResourceAccessor.FillDataFromField(
                        item,
                        newField,
                        typeField,
                        recordFields ? item.Source : CultureMapSource.PatchModule
                    );

                    again:

                    if (
                        Types.Collection.TryFind(
                            fields,
                            /**/delegate(StructuredData find)
                            {
                                return StructuredTypeResourceAccessor.ToDruid(
                                        find.GetValue(Res.Fields.Field.CaptionId)
                                    ) == typeField.CaptionId;
                            },
                            /**/out oldField
                        )
                    )
                    {
                        ...
                        oldField.SetValue(
                            Res.Fields.Field.Expression,
                            newField.GetValue(Res.Fields.Field.Expression)
                        );
                        oldField.SetValue(
                            Res.Fields.Field.CultureMapSource,
                            CultureMapSource.DynamicMerge
                ...
                if ((state == UpdateState.None) && (recordFields == false))
                {
                    this.SnapshotReferenceFields(item, data, fields);
                }
                ...
                foreach (Druid interfaceId in type.InterfaceIds)
                {
                    ...
                    if (
                        Types.Collection.TryFind(
                            ...
                            {
                                return StructuredTypeResourceAccessor.ToDruid(
                                        find.GetValue(Res.Fields.InterfaceId.CaptionId)
                                    ) == interfaceId;
                            },
                            /**/out oldInterfaceId
                        )
                    ...
                    else
                    {
                        ...
                        newInterfaceId.SetValue(
                            Res.Fields.InterfaceId.CultureMapSource,
                            recordInterfaceIds ? item.Source : CultureMapSource.PatchModule
                        );
                ...
                if ((state == UpdateState.None) && (recordInterfaceIds == false))
                {
                ...
                if (
                    (!string.IsNullOrEmpty(type.SerializedDesignerLayouts))
                    || (
                        UndefinedValue.IsUndefinedValue(
                            data.GetValue(
                                Res.Fields.ResourceStructuredType.SerializedDesignerLayouts
                ...
                )
                {
                    data.SetValue(
                        Res.Fields.ResourceStructuredType.SerializedDesignerLayouts,
                        type.SerializedDesignerLayouts
                    );
                }
                ...
                if (type.DefaultLifetimeExpectancy != DataLifetimeExpectancy.Unknown)
                {
                    data.SetValue(
                        Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy,
                        type.DefaultLifetimeExpectancy
                    );
                }
            ...
            else
            {
                ...
                data.SetValue(
                    Res.Fields.ResourceStructuredType.DefaultLifetimeExpectancy,
                    DataLifetimeExpectancy.Unknown
                );
        ...
        private void SnapshotReferenceFields(
            CultureMap item,
            StructuredData data,
            ObservableList<StructuredData> fields
        )
        ...
        private void SnapshotReferenceInterfaceIds(
            CultureMap item,
            StructuredData data,
            ObservableList<StructuredData> interfaceIds
        )
        ...
        private static void FillDataFromField(
            CultureMap item,
            StructuredData data,
        ...
        )
        {
            ...
            data.SetValue(
                Res.Fields.Field.TypeId,
                field.Type == null ? Druid.Empty : field.Type.CaptionId
            );
        ...
        )
        {
            ...
            using (fields.DisableNotifications())
            {
                if ((baseTypeId.IsValid) || (interfaceIds.Count > 0))
                {
                    ...
                    {
                        Druid interfaceId = StructuredTypeResourceAccessor.ToDruid(
                            interfaceData.GetValue(Res.Fields.InterfaceId.CaptionId)
                        );
                    ...
                    StructuredTypeResourceAccessor.RemoveInheritedFields(
                        item,
                        fields,
                        updater.InterfaceIds
                    );
                    ...
                    foreach (StructuredData field in updater.Fields)
                    {
                        System.Diagnostics.Debug.Assert(
                            (
                                (FieldMembership)field.GetValue(Res.Fields.Field.Membership)
                                == FieldMembership.Inherited
                            )
                                /**/|| (
                                    StructuredTypeResourceAccessor
                                        .ToDruid(field.GetValue(Res.Fields.Field.CaptionId))
                                        .IsValid
                                )
                        );

                        int pos = StructuredTypeResourceAccessor.IndexOfCompatibleField(
                            fields,
                            field
                        );
                        ...
                        {
                            FieldMembership membership = (FieldMembership)
                                field.GetValue(Res.Fields.Field.Membership);
                            Druid definingTypeId = StructuredTypeResourceAccessor.ToDruid(
                                field.GetValue(Res.Fields.Field.DefiningTypeId)
                            );
                            ...
                            switch (membership)
                            {
                                case FieldMembership.Local:
                                    ...
                                    System.Diagnostics.Debug.Assert(
                                        updater.InterfaceIds.Contains(definingTypeId)
                                    );
                                    break;
                                ...
                                case FieldMembership.Inherited:
                                    ...
                                    field.SetValue(
                                        Res.Fields.Field.Membership,
                                        FieldMembership.LocalOverride
                                    );
                                    break;
                                ...
                                default:
                                    throw new System.NotImplementedException(
                                        string.Format(
                                            "Unsupported field override for field {0}",
                                            field.GetValue(Res.Fields.Field.CaptionId)
                                        )
                                    );
                            }
                            ...
                            field.PromoteToOriginalValue(
                                Res.Fields.Field.IsInterfaceDefinition.ToString()
                            );
                        ...
                        Druid DT = StructuredTypeResourceAccessor.ToDruid(
                            field.GetValue(Res.Fields.Field.DefiningTypeId)
                        );
                        bool? IID = StructuredTypeResourceAccessor.ToBoolean(
                            field.GetValue(Res.Fields.Field.IsInterfaceDefinition)
                        );
                        FieldMembership M = (FieldMembership)
                            field.GetValue(Res.Fields.Field.Membership);
                        Druid FI = StructuredTypeResourceAccessor.ToDruid(
                            field.GetValue(Res.Fields.Field.CaptionId)
                        );

                        System.Diagnostics.Debug.WriteLine(
                            string.Format(
                                "EntityName={0} EntityId={1} FieldId={2} DT={3} M={4} IID={5}",
                                item.Name,
                                item.Id,
                                FI,
                                DT,
                                M,
                                IID.HasValue ? IID.Value.ToString() : "<null>"
                            )
                        );
                    }
                }
        ...
        private static int IndexOfCompatibleField(
            IList<StructuredData> fields,
            StructuredData field
        )
        {
            Druid id = StructuredTypeResourceAccessor.ToDruid(
                field.GetValue(Res.Fields.Field.CaptionId)
            );
            ...
            for (int i = 0; i < fields.Count; i++)
            {
                if (
                    StructuredTypeResourceAccessor.ToDruid(
                        fields[i].GetValue(Res.Fields.Field.CaptionId)
                    ) == id
                )
                {
                    return i;
        ...
        private static void RemoveInheritedFields(
            CultureMap item,
            IList<StructuredData> fields,
            IList<Druid> interfaceIds
        )
        {
            for (int i = 0; i < fields.Count; i++)
            {
                ...
                {
                    if ((interfaceDefinition.HasValue) && (interfaceDefinition.Value == false))
                    {
        ...
        {
            ResourceBundle bundle = this.ResourceManager.GetBundle(
        ...
        {
            return obj.GetValue(StructuredTypeResourceAccessor.AccessorsProperty)
                as AccessorsCollection;
        }

        private static DependencyProperty AccessorsProperty = DependencyProperty.RegisterAttached(
            "Accessors",
            typeof(AccessorsCollection),
            typeof(StructuredTypeResourceAccessor),
