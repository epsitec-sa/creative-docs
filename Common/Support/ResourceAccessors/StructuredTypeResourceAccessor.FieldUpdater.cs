...
namespace Epsitec.Common.Support.ResourceAccessors
{
    public partial class StructuredTypeResourceAccessor : CaptionResourceAccessor
    {
        private sealed class FieldUpdater
        {
            ...
            private void IncludeType(
                Druid typeId,
                Druid definingTypeId,
            ...
            )
            {
                ...
                Druid baseId = StructuredTypeResourceAccessor.ToDruid(
                ...
                if (fields != null)
                {
                    ...
                    {
                        Druid fieldId = StructuredTypeResourceAccessor.ToDruid(
                        ...
                        copy.SetValue(
                            ...
                            field.GetValue(Res.Fields.Field.TypeId)
                        );
                        copy.SetValue(
                            Res.Fields.Field.CaptionId,
                            field.GetValue(Res.Fields.Field.CaptionId)
                        );
                        copy.SetValue(
                            Res.Fields.Field.Relation,
                            field.GetValue(Res.Fields.Field.Relation)
                        );
                        ...
                        copy.SetValue(
                            Res.Fields.Field.Source,
                            field.GetValue(Res.Fields.Field.Source)
                        );
                        copy.SetValue(
                            Res.Fields.Field.Options,
                            field.GetValue(Res.Fields.Field.Options)
                        );
                        copy.SetValue(
                            Res.Fields.Field.Expression,
                            field.GetValue(Res.Fields.Field.Expression)
                        );
