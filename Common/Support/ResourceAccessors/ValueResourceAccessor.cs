    ...
    internal class ValueResourceAccessor : CaptionResourceAccessor
    {
        ...
        public override CultureMap CreateItem()
        {
            throw new System.InvalidOperationException(
                "CreateItem may not be called directly; use CreateValueItem instead"
            );
        }
        ...
        public PrefixedCultureMap CreateValueItem(string prefix)
        {
            ...
            ResourceBundle.Field field = new ResourceBundle.Field(
                string.Concat(this.Prefix, prefix, ".")
            );
        ...
        protected override CultureMap CreateItem(
