...
[assembly: Epsitec.Common.Types.DependencyClass(
    typeof(Epsitec.Common.Support.ResourceAccessors.AbstractCaptionResourceAccessor)
)]
    ...
    public abstract class AbstractCaptionResourceAccessor : AbstractResourceAccessor
    {
        ...
        public override void Load(ResourceManager manager)
        {
            ...
            if (this.ResourceManager.BasedOnPatchModule)
            {
                ...
                ResourceManager refModuleManager =
                    this.ResourceManager.GetManagerForReferenceModule();
                ...
                this.LoadFromBundle(
                    refModuleManager.GetBundle(this.GetBundleName(), ResourceLevel.Default),
                    Resources.DefaultTwoLetterISOLanguageName
                );
                this.LoadFromBundle(
                    patchModuleManager.GetBundle(this.GetBundleName(), ResourceLevel.Default),
                    Resources.DefaultTwoLetterISOLanguageName
                );
            }
            else
            {
                this.LoadFromBundle(
                    this.ResourceManager.GetBundle(this.GetBundleName(), ResourceLevel.Default),
                    Resources.DefaultTwoLetterISOLanguageName
                );
            }
        ...
        /// </returns>
        public override Types.StructuredData LoadCultureData(
            CultureMap item,
        ...
        )
        {
            ...
            ResourceBundle.Field refField =
                refBundle == null ? ResourceBundle.Field.Empty : refBundle[item.Id];
            ResourceBundle.Field patchField =
                patchBundle == null ? ResourceBundle.Field.Empty : patchBundle[item.Id];

            if (
                (refField.IsEmpty || ResourceBundle.Field.IsNullString(refField.AsString))
        ...
        public Caption GetCaptionViewOfData(CultureMap item, string twoLetterISOLanguageName)
        {
            if (this.ContainsCaption(twoLetterISOLanguageName))
            {
                ...
                Caption caption = this.CreateCaptionFromData(
                    item.Id,
                    null,
                    data,
                    item.Name,
        ...
        protected override Druid CreateId()
        {
            ...
            return AbstractResourceAccessor.CreateId(
                accessors.AllCollections,
        ...
        protected override void DeleteItem(CultureMap item)
        {
            foreach (string twoLetterISOLanguageName in item.GetDefinedCultures())
            {
                ...
                {
                    bundle = this.ResourceManager.GetBundle(
                        this.GetBundleName(),
                        ResourceLevel.Default
                    );
        ...
        protected override void PersistItem(CultureMap item)
        {
            ...
            foreach (string twoLetterISOLanguageName in item.GetDefinedCultures())
            {
                ...
                if (usePatchModule)
                {
                    ...
                    ResourceBundle refBundle = refModuleManager.GetBundle(
                        this.GetBundleName(),
                        level,
                        culture
                    );
                    ...
                    )
                    {
                        ...
                        if ((level == ResourceLevel.Default) && (nonEmptyFieldCount > 0))
                        {
                ...
                else
                {
                    ...
                    if ((level == ResourceLevel.Localized) && (this.IsEmpty(data)))
                    {
                        deleteField = true;
                    }
                }
                ...
                else
                {
                    ...
                    if (bundle == null)
                    {
                        ResourceModuleId moduleId = this.ResourceManager.GetModuleFromFullId(
                            item.Id.ToString()
                        );
                        bundle = ResourceBundle.Create(
                            this.ResourceManager,
                            this.ResourceManager.ActivePrefix,
                            moduleId,
                            this.GetBundleName(),
                            level,
                            culture,
                    ...
                    if ((capName == null) && (this.IsEmptyCaption(data)))
                    {
                        caption = null;
                    }
        ...
        protected abstract void ComputeDataDelta(
        ...
        protected abstract Caption CreateCaptionFromData(
            Druid captionId,
        ...
        protected abstract void FillDataFromCaption(
            CultureMap item,
            Types.StructuredData data,
            Caption caption,
        ...
        /// </returns>
        protected override Types.StructuredData LoadFromField(
        ...
        )
        {
            ...
            data.SetValue(
                Res.Fields.ResourceBase.Comment,
                ResourceBundle.Field.IsNullString(field.About) ? null : field.About
            );
            data.SetValue(Res.Fields.ResourceBase.ModificationId, field.ModificationId);

            if (
                (fieldSource == CultureMapSource.ReferenceModule)
            ...
            string name = string.IsNullOrEmpty(field.Name)
                ? null
                : this.GetNameFromFieldName(item, field.Name);
        ...
        /// <returns>A new <see cref="CultureMap"/> item.</returns>
        protected virtual CultureMap CreateItem(
            ResourceBundle.Field field,
            Druid id,
        ...
        protected bool ContainsCaption(string twoLetterISOLanguageName)
        {
            ...
            if ((refBundle == null) && (patchBundle == null))
            {
                return false;
            }
            else
        ...
        private void ResolveBundles(
            string twoLetterISOLanguageName,
            out ResourceBundle refBundle,
            out ResourceBundle patchBundle
        )
        {
            CultureInfo culture;
            ResourceLevel level;
            ...
            {
                refBundle = this
                    .ResourceManager.GetManagerForReferenceModule()
                    .GetBundle(this.GetBundleName(), level, culture);
        ...
        /// otherwise, <c>false</c>.
        /// </returns>
        private bool ComputeDelta(
            CultureMap item,
            ref StructuredData rawData,
            ResourceBundle refBundle,
            Druid druid,
            ResourceBundle dataBundle,
            string twoLetterISOLanguageName
        )
        {
            if (refBundle == null)
            ...
            StructuredData refData = this.CreateStructuredData(
                ...
                refBundle,
                refField,
                DataCreationMode.Temporary
            );
            StructuredData patchData = this.CreateStructuredData();

            int dataModifId = StringResourceAccessor.GetModificationId(
                StringResourceAccessor.GetDeltaValue(
                    rawData,
                    Res.Fields.ResourceBase.ModificationId
                )
            );
        ...
        protected static void CopyDeltaValue(
        ...
        private StructuredData CreateStructuredData(
            CultureMap item,
            ResourceBundle bundle,
            ResourceBundle.Field field,
            DataCreationMode mode
        ...
        {
            return obj.GetValue(AbstractCaptionResourceAccessor.AccessorsProperty)
                as AccessorsCollection;
        }

        private static readonly DependencyProperty AccessorsProperty =
            DependencyProperty.RegisterAttached(
                "Accessors",
                typeof(AccessorsCollection),
                typeof(AbstractCaptionResourceAccessor),
