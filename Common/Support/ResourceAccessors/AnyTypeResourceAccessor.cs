    ...
    public class AnyTypeResourceAccessor : CaptionResourceAccessor
    {
        ...
        public CultureMap CreateValueItem(CultureMap item)
        {
            ...
            System.Diagnostics.Debug.Assert(
                AnyTypeResourceAccessor.ToTypeCode(
                    data.GetValue(Res.Fields.ResourceBaseType.TypeCode)
                ) == TypeCode.Enum
            );
        ...
        public bool CreateMissingValueItems(CultureMap item)
        {
            ...
            TypeCode code = AnyTypeResourceAccessor.ToTypeCode(
                data.GetValue(Res.Fields.ResourceBaseType.TypeCode)
            );

            System.Diagnostics.Debug.Assert(code == TypeCode.Enum);

            IList<StructuredData> values =
                data.GetValue(Res.Fields.ResourceEnumType.Values) as IList<StructuredData>;
            System.Type systemType =
                data.GetValue(Res.Fields.ResourceEnumType.SystemType) as System.Type;
            ...
            else
            {
                ...
                foreach (EnumValue value in template.EnumValues)
                {
                    if (!value.IsHidden)
                    {
                        ...
                        {
                            if ((valueItem.Prefix == typeName) && (valueItem.Name == name))
                            {
                                found = true;
                                break;
                            }
                        ...
                        if (!found)
                        {
                            ...
                            foreach (StructuredData v in values)
                            {
                                if (
                                    StructuredTypeResourceAccessor
                                        .ToDruid(v.GetValue(Res.Fields.EnumValue.CaptionId))
                                        .IsEmpty
                                )
                                {
                                    dataValue = v;
                            ...
                            if (dataValue == null)
                            {
                                ...
                                dataValue = this.GetDataBroker(
                                        data,
                                        Res.Fields.ResourceEnumType.Values.ToString()
                                    )
                                    .CreateData(item);
                                insert = true;
                            }
        ...
        )
        {
            ...
            {
                EnumValueListener listener = Listener.FindListener<EnumValueListener>(
                    container,
                    fieldId
                );
        ...
        protected override void PromoteToOriginal(CultureMap item, StructuredData data)
        {
            ...
            ObservableList<StructuredData> enumValues =
                data.GetValue(Res.Fields.ResourceEnumType.Values) as ObservableList<StructuredData>;
            ...
            if (enumValues != null)
            {
                ...
                Listener
                    .FindListener<EnumValueListener>(enumValues)
                    .HandleCollectionChanging(enumValues);
            }
        }
        ...
        public INamedType GetAnyTypeViewOfData(
            CultureMap item,
        ...
        )
        {
            ...
            {
                data.SetValue(
                    Res.Fields.ResourceBaseType.DefaultControllerParameters,
                    controllerParameter
                );
            }
            if (type != null)
        ...
        {
            if (
                (base.IsEmptyCaption(data))
                && (
                    ResourceBundle.Field.IsNullString(
                        data.GetValue(Res.Fields.ResourceBaseType.DefaultController) as string
                    )
                )
                && (
                    ResourceBundle.Field.IsNullString(
                        data.GetValue(Res.Fields.ResourceBaseType.DefaultControllerParameters)
                            as string
                    )
                )
                && (
                    UndefinedValue.IsUndefinedValue(
                        data.GetValue(Res.Fields.ResourceBaseType.DefaultValue)
                    )
                )
            )
            {
                ...
                switch (code)
                {
                    ...
                    case TypeCode.Binary:
                        if (
                            ResourceBundle.Field.IsNullString(
                                data.GetValue(Res.Fields.ResourceBinaryType.MimeType) as string
                            )
                        )
                        {
                            return true;
                    ...
                    case TypeCode.LongInteger:
                        if (
                            (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceNumericType.Range)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceNumericType.PreferredRange)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceNumericType.SmallStep)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceNumericType.LargeStep)
                                )
                            )
                        )
                        {
                    ...
                    case TypeCode.Collection:
                        if (
                            (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceCollectionType.ItemType)
                                )
                            )
                            || (
                                (
                                    (Druid)data.GetValue(Res.Fields.ResourceCollectionType.ItemType)
                                ).IsEmpty
                            )
                        )
                        {
                    ...
                    case TypeCode.Time:
                        if (
                            (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.Resolution)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.MinimumDate)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.MaximumDate)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.MinimumTime)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.MaximumTime)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.DateStep)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceDateTimeType.TimeStep)
                                )
                            )
                        )
                        {
                    ...
                    case TypeCode.Enum:
                        IList<StructuredData> values =
                            data.GetValue(Res.Fields.ResourceEnumType.Values)
                            as IList<StructuredData>;
                        System.Type enumSystemType =
                            data.GetValue(Res.Fields.ResourceEnumType.SystemType) as System.Type;
                    ...
                    case TypeCode.Other:
                        if (
                            (data.GetValue(Res.Fields.ResourceOtherType.SystemType) as System.Type)
                            == null
                        )
                        {
                            return true;
                    ...
                    case TypeCode.String:
                        object useMultilingualStorage = data.GetValue(
                            Res.Fields.ResourceStringType.UseMultilingualStorage
                        );
                        object useFormattedText = data.GetValue(
                            Res.Fields.ResourceStringType.UseFormattedText
                        );

                        if (
                            (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceStringType.MinimumLength)
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(Res.Fields.ResourceStringType.MaximumLength)
                                )
                            )
                            && (
                                (UndefinedValue.IsUndefinedValue(useMultilingualStorage))
                                || ((bool)useMultilingualStorage == false)
                            )
                            && (
                                (UndefinedValue.IsUndefinedValue(useFormattedText))
                                || ((bool)useFormattedText == false)
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(
                                        Res.Fields.ResourceStringType.DefaultSearchBehavior
                                    )
                                )
                            )
                            && (
                                UndefinedValue.IsUndefinedValue(
                                    data.GetValue(
                                        Res.Fields.ResourceStringType.DefaultComparisonBehavior
                                    )
                                )
                            )
                        )
                    ...
                    default:
                        throw new System.NotSupportedException(
                            string.Format("Type code '{0}' not supported", code)
                        );
                }
            }
        ...
        )
        {
            ...
            TypeCode refCode = AnyTypeResourceAccessor.ToTypeCode(
                refData.GetValue(Res.Fields.ResourceBaseType.TypeCode)
            );
            TypeCode rawCode = AnyTypeResourceAccessor.ToTypeCode(
                rawData.GetValue(Res.Fields.ResourceBaseType.TypeCode)
            );

            if (refCode != rawCode)
            {
                throw new System.InvalidOperationException(
                    string.Format("Mismatched type codes '{0}' and '{1}'", refCode, rawCode)
                );
            }
            ...
            AbstractCaptionResourceAccessor.CopyDeltaValue(
                rawData,
                patchData,
                Res.Fields.ResourceBaseType.DefaultController
            );
            AbstractCaptionResourceAccessor.CopyDeltaValue(
                rawData,
                patchData,
            ...
            AbstractCaptionResourceAccessor.CopyDeltaValue(
                rawData,
                patchData,
                Res.Fields.ResourceBaseType.Nullable
            );
            AbstractCaptionResourceAccessor.CopyDeltaValue(
                rawData,
                patchData,
                Res.Fields.ResourceBaseType.DefaultValue
            );
            ...
            switch (rawCode)
            {
                ...
                case TypeCode.Binary:
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceBinaryType.MimeType
                    );
                    break;
                ...
                case TypeCode.LongInteger:
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceNumericType.Range
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceNumericType.PreferredRange
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceNumericType.SmallStep
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceNumericType.LargeStep
                    );
                    break;
                ...
                case TypeCode.Collection:
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceCollectionType.ItemType
                    );
                    break;
                ...
                case TypeCode.Time:
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.Resolution
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.MinimumDate
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.MaximumDate
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.MinimumTime
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.MaximumTime
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.DateStep
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceDateTimeType.TimeStep
                    );
                    break;

                case TypeCode.Enum:
                    IList<StructuredData> refValues =
                        refData.GetValue(Res.Fields.ResourceEnumType.Values)
                        as IList<StructuredData>;
                    IList<StructuredData> rawValues =
                        rawData.GetValue(Res.Fields.ResourceEnumType.Values)
                        as IList<StructuredData>;
                    ...
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceEnumType.SystemType
                    );
                    break;
                ...
                case TypeCode.Other:
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceOtherType.SystemType
                    );
                    break;
                ...
                case TypeCode.String:
                    ...
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceStringType.MinimumLength
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                        Res.Fields.ResourceStringType.MaximumLength
                    );
                    AbstractCaptionResourceAccessor.CopyDeltaValue(
                        rawData,
                        patchData,
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("Type code '{0}' not supported", rawCode)
                    );
            }
        }
        ...
        private static IList<StructuredData> MergeEnumValues(
            IList<StructuredData> sourceA,
            IList<StructuredData> sourceB
        )
        {
            List<StructuredData> list = new List<StructuredData>();
            List<StructuredData> temp =
                sourceA == null ? new List<StructuredData>() : new List<StructuredData>(sourceA);

            //	If the first list starts with elements not found in the second
            //	list, copy them into the resulting list :

            AnyTypeResourceAccessor.FillEnumValuesListFromFirstSourceNotInSecondSource(
                list,
                temp,
                sourceB
            );
            ...
            foreach (StructuredData data in sourceB)
            {
                ...
                int indexBinA = Types.Collection.FindIndex(
                    temp,
        ...
        private static void FillEnumValuesListFromFirstSourceNotInSecondSource(
            List<StructuredData> list,
            List<StructuredData> sourceA,
            IList<StructuredData> sourceB
        )
        {
            while (sourceA.Count > 0)
            {
                ...
                int indexAinB = Types.Collection.FindIndex(
                    sourceB,
                    delegate(StructuredData findData)
                    {
        ...
        {
            System.Diagnostics.Debug.Assert(
                type.TypeCode == (TypeCode)data.GetValue(Res.Fields.ResourceBaseType.TypeCode)
            );
            ...
            string controllerParameter =
                data.GetValue(Res.Fields.ResourceBaseType.DefaultControllerParameters) as string;
        ...
        private void FillDataFromNumericType(
            StructuredData data,
            Caption caption,
            AbstractNumericType type
        )
        {
        ...
        private void FillDataFromCollectionType(
            StructuredData data,
            Caption caption,
            CollectionType type
        )
        ...
        private void FillDataFromDateTimeType(
            StructuredData data,
            Caption caption,
        ...
        private void FillDataFromEnumType(
            CultureMap item,
            StructuredData data,
            Caption caption,
            EnumType type,
        ...
        )
        {
            ...
            ObservableList<StructuredData> values =
                data.GetValue(Res.Fields.ResourceEnumType.Values) as ObservableList<StructuredData>;
            ...
            else if (source.Count > 0)
            {
                ...
                foreach (StructuredData value in values)
                {
                    System.Diagnostics.Debug.Assert(
                        !UndefinedValue.IsUndefinedValue(
                            value.GetValue(Res.Fields.EnumValue.CaptionId)
                        )
                    );
                    System.Diagnostics.Debug.Assert(
                        !UnknownValue.IsUnknownValue(value.GetValue(Res.Fields.EnumValue.CaptionId))
                    );
                    System.Diagnostics.Debug.Assert(
                        !value.IsValueLocked(Res.Fields.EnumValue.CaptionId)
                    );
                ...
                {
                    StructuredData find;
                    Druid valueId = StructuredTypeResourceAccessor.ToDruid(
                        value.GetValue(Res.Fields.EnumValue.CaptionId)
                    );
                        ...
                        Types.Collection.TryFind(
                            ...
                            /**/delegate(StructuredData candidate)
                            {
                                return StructuredTypeResourceAccessor.ToDruid(
                                        candidate.GetValue(Res.Fields.EnumValue.CaptionId)
                                    ) == valueId;
                            },
                            /**/out find
                        )
                    ...
                    {
                        find.SetValue(
                            Res.Fields.EnumValue.CultureMapSource,
            ...
            if (source.Count > 0)
            {
                foreach (StructuredData value in source)
                {
                    ...
                    x.SetValue(
                        Res.Fields.EnumValue.CaptionId,
                        value.GetValue(Res.Fields.EnumValue.CaptionId)
                    );
                    x.SetValue(
                        Res.Fields.EnumValue.CultureMapSource,
                        value.GetValue(Res.Fields.EnumValue.CultureMapSource)
                    );
            ...
            if (
                (
                    UndefinedValue.IsUndefinedValue(
                        data.GetValue(Res.Fields.ResourceEnumType.SystemType)
                    )
        ...
        private void FillDataFromStringType(StructuredData data, Caption caption, StringType type)
        {
            ...
            if (caption.ContainsLocalValue(StringType.DefaultComparisonBehaviorProperty))
            {
                data.SetValue(
                    Res.Fields.ResourceStringType.DefaultComparisonBehavior,
                    type.DefaultComparisonBehavior
                );
            }
        }
        ...
        {
            public EnumValueListener(
                AnyTypeResourceAccessor accessor,
                CultureMap item,
                StructuredData data
            )
            ...
            public override void HandleCollectionChanging(object sender)
            {
                if (this.SaveField(Res.Fields.ResourceEnumType.Values))
                {
                    ...
                    IList<StructuredData> values =
                        this.Data.GetValue(Res.Fields.ResourceEnumType.Values)
                        as IList<StructuredData>;
        ...
        {
            System.Diagnostics.Debug.Assert(
                item.IsCultureDefined(Resources.DefaultTwoLetterISOLanguageName)
            );
