...
namespace Epsitec.Common.Support.ResourceAccessors
{
    ...
    public abstract class AbstractResourceAccessor : DependencyObject, IResourceAccessor
    {
        ...
        public void Save(ResourceBundleSaver saverCallback)
        {
            ...
            foreach (
                ResourceBundle bundle in pool.FindAllLoadedBundles(
                    delegate(ResourceBundle candidate)
                    {
                        if (
                            (candidate.ResourceManager == manager)
        ...
        {
            if ((this.BasedOnPatchModule) && (item.Source == CultureMapSource.DynamicMerge))
            {
        ...
        {
            get { return this.ResourceManager.BasedOnPatchModule; }
        }
        ...
        public IList<string> GetAvailableCultures()
        {
            ...
            string[] ids = this.resourceManager.GetBundleIds(
                this.GetBundleName(),
                ResourceLevel.All
            );
        ...
        public virtual void NotifyCultureDataCleared(
            CultureMap item,
        ...
        /// </returns>
        public abstract StructuredData LoadCultureData(
            CultureMap item,
            string twoLetterISOLanguageName
        );
        ...
        internal static Druid CreateId(
            IEnumerable<CultureMap> collection,
            ResourceManager manager,
            params ResourceBundle[] bundles
        )
        {
            return AbstractResourceAccessor.CreateId(
                collection,
                manager.DefaultModuleId,
                manager.PatchDepth,
                bundles
            );
        }
        ...
        )
        {
            ...
            object devIdValue = Support.Globals.Properties.GetProperty(
                AbstractResourceAccessor.DeveloperIdPropertyName
            );
            ...
            if ((patchDepth < 0) || (patchDepth >= Druid.DeveloperIdMultiplier))
            {
        ...
        protected CultureMapSource GetCultureMapSource(ResourceBundle.Field field)
        {
            ...
            {
                return field.BasedOnPatchModule
                    ? CultureMapSource.PatchModule
                    : CultureMapSource.ReferenceModule;
            }
        }
        ...
        protected abstract StructuredData LoadFromField(
        ...
        protected virtual void HandleItemsCollectionChanged(
            object sender,
