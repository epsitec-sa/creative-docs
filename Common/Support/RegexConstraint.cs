...
namespace Epsitec.Common.Support
{
    ...
    public class RegexConstraint : Types.IDataConstraint
    {
        ...
        public bool IsValidValue(object value)
        {
            ...
            if ((this.regex != null) && (Types.InvariantConverter.Convert(value, out text)))
            {
        ...
        public override string ToString()
        {
            ...
            else
            {
                throw new System.InvalidOperationException(
                    "Cannot convert empty RegexConstraint to string."
                );
            }
        ...
        public static RegexConstraint FromString(string value)
        {
            ...
            {
                case "pat":
                    return RegexConstraint.FromStringPattern(value.Substring(4));
                case "def":
                    return RegexConstraint.FromStringPredefined(value.Substring(4));
                case "exp":
                    return RegexConstraint.FromStringRegex(value.Substring(4));
            }
