...
namespace Epsitec.Common.Support.CodeCompilation
{
    ...
    public class BuildDriver : System.IDisposable
    {
        ...
        public BuildDriver()
        {
            string directory = string.Concat(
                "BuildDriver.",
        ...
        {
            get { return this.buildDirectory; }
            set { this.buildDirectory = value; }
        }
        ...
        {
            get { return this.deleteOnDispose; }
            set { this.deleteOnDispose = value; }
        }
        ...
        public bool Compile(CodeProject project)
        {
            ...
            System.IO.File.WriteAllText(
                projectFilePath,
                project.CreateProjectSource(),
                System.Text.Encoding.UTF8
            );

            string msbuildPath = System.IO.Path.Combine(Paths.V35Framework, "msbuild.exe");
            string msbuildArgs =
                "/ToolsVersion:3.5 /nologo /noautoresponse /verbosity:quiet /t:Build /p:Configuration=Debug";
            ...
            try
            {
                ...
                )
                {
                    ...
                    if (System.IO.File.Exists(assemblyFilePath))
                    {
                        ...
                        this.buildAssemblyPdbPath = string.Concat(
                            assemblyFilePath.Remove(assemblyFilePath.Length - 3),
                            "pdb"
                        );
        ...
        public IEnumerable<string> GetBuildMessages()
        {
            ...
            {
                string[] lines = this.buildMessages.Split(
                    new char[] { '\r', '\n' },
        ...
        public CodeProjectSettings CreateSettings(string assemblyName)
        {
            ...
            settings.TemporaryDirectory = System.IO.Path.Combine(
                this.BuildDirectory,
                Paths.BuildTemp
            );
        ...
        {
            string assemblyDirectory = System
        ...
        {
            if (
                (System.IO.Directory.Exists(Paths.V20Framework))
        ...
        )
        {
            ...
            process.StartInfo.StandardOutputEncoding = System.Text.Encoding.GetEncoding(
                oemCodePage
            );
        ...
        internal static class Paths
        {
            static Paths()
            {
                Paths.v30ReferenceAssemblies = System.IO.Path.Combine(
                    Paths.ReferenceAssemblies,
                    "v3.0"
                );
                Paths.v35ReferenceAssemblies = System.IO.Path.Combine(
                    Paths.ReferenceAssemblies,
                    "v3.5"
                );
            ...
            {
                get { return Paths.v35ReferenceAssemblies; }
            }

            public static string V35Framework
            {
                get { return Paths.v35Framework; }
            }

            public static string V30ReferenceAssemblies
            {
                get { return Paths.v30ReferenceAssemblies; }
            }

            public static string V30Framework
            {
                get { return Paths.v30Framework; }
            }

            public static string V20Framework
            {
                get { return Paths.v20Framework; }
            }

            private static readonly string ReferenceAssemblies = System.IO.Path.Combine(
                Globals.Directories.ProgramFiles,
                @"Reference Assemblies\Microsoft\Framework"
            );
            private static readonly string Framework = System.IO.Path.Combine(
                Globals.Directories.Windows,
