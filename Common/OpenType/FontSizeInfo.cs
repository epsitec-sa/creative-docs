...
namespace Epsitec.Common.OpenType
{
    ...
    internal sealed class FontSizeInfo : System.IDisposable
    {
        public FontSizeInfo(int pointSize, Platform.IFontHandle handle)
        {
            ...
            Platform.Neutral.FillFontHeights(
                handle,
                /**/out this.height,
                out this.ascender,
                out this.descender,
                /**/out this.internalLeading,
                out this.externalLeading
            );
        }

        public Platform.IFontHandle Handle
        {
            get { return this.fontHandle; }
        }
        ...
        public int GetGlyphWidth(int glyph)
        {
            ...
            if (this.glyphWidths[block] == null)
            {
                ...
                Platform.Neutral.FillFontWidths(
                    this.fontHandle,
                    block * FontSizeInfo.BlockSize,
                    FontSizeInfo.BlockSize,
                    this.glyphWidths[block],
                    null,
                    null
                );
            }
