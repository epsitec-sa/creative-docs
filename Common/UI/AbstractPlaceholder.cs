...
namespace Epsitec.Common.UI
{
    ...
    public abstract class AbstractPlaceholder : Widgets.FrameBox
    {
        ...
        {
            get { return this.GetBindingExpression(this.GetValueProperty()); }
        }
        ...
        public Caption ValueCaption
        {
            get
            {
                ...
                Support.ICaptionResolver resolver = Widgets.Helpers.VisualTree.GetCaptionResolver(
                    this
                );
        ...
        {
            get { return this.GetValue(AbstractPlaceholder.ValueProperty); }
            set
            {
        ...
        public PlaceholderSuggestionMode SuggestionMode
        {
            ...
            set { this.SetValue(Placeholder.SuggestionModeProperty, value); }
        }
        ...
        public abstract IController ControllerInstance { get; }
        ...
        private void UpdateValueType()
        {
            ...
            else if ((oldValueType == null) || (oldValueType.Equals(newValueType) == false))
            {
        ...
        public static readonly DependencyProperty ValueProperty = DependencyProperty.Register(
            "Value",
            typeof(object),
            typeof(AbstractPlaceholder),
            new DependencyPropertyMetadata(
                UndefinedValue.Value,
                AbstractPlaceholder.NotifyValueChanged
            ).MakeNotSerializable()
        );
        public static readonly DependencyProperty SuggestionModeProperty =
            DependencyProperty.Register(
                "SuggestionMode",
                typeof(PlaceholderSuggestionMode),
                typeof(AbstractPlaceholder),
                new DependencyPropertyMetadata(PlaceholderSuggestionMode.None)
            );
