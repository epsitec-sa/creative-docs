...
namespace Epsitec.Common.UI
{
    ...
    public class Placeholder : AbstractPlaceholder, Widgets.Layouts.IGridPermeable
    {
        ...
        {
            get { return (string)this.GetValue(Placeholder.ControllerProperty); }
            set { this.SetValue(Placeholder.ControllerProperty, value); }
        }

        public string ControllerParameters
        {
            get { return (string)this.GetValue(Placeholder.ControllerParametersProperty); }
            set { this.SetValue(Placeholder.ControllerParametersProperty, value); }
        }
        ...
        public Widgets.Layouts.IGridPermeable ControllerIGridPermeable
        {
            get
            {
                ...
                {
                    Controllers.ControllerParameters parameters =
                        new Controllers.ControllerParameters(this.controllerParameters);
                    IController temp = Controllers.ControllerFactory.CreateController(
                        this.controllerName,
                        parameters
                    );
        ...
        {
            get { return (Verbosity)this.GetValue(Placeholder.VerbosityProperty); }
            set { this.SetValue(Placeholder.VerbosityProperty, value); }
        }

        public Druid LabelReplacement
        {
            get { return (Druid)this.GetValue(Placeholder.LabelReplacementProperty); }
            set { this.SetValue(Placeholder.LabelReplacementProperty, value); }
        }
        ...
        public bool IsReadOnlyValueBinding
        {
            get
            {
                ...
                if ((mode == BindingMode.OneTime) || (mode == BindingMode.OneWay))
                {
                    return true;
                }
                else
        ...
        public bool GetMinSpan(
            Widget parent,
            int column,
            int row,
            out int minColumnSpan,
            out int minRowSpan
        )
        {
            minColumnSpan = 0;
        ...
        {
            foreach (
                Placeholder placeholder in root.FindAllChildren(
        ...
        protected override void LayoutArrange(Widgets.Layouts.ILayoutEngine engine)
        {
            ...
            {
                Widgets.Layouts.ILayoutEngine parentEngine =
                    Widgets.Layouts.LayoutEngine.GetLayoutEngine(parent);
        ...
        )
        {
            ...
            if (this.editPanel != null)
            {
                ...
                this.editPanel.Aperture = Widgets.Helpers.VisualTree.MapVisualToAncestor(
                    this,
                    panelStack,
                    this.Client.Bounds
                );
        ...
        private void UpdateController()
        {
            ...
            if (
                (newControllerName != oldControllerName)
        ...
        protected virtual void GetAssociatedController(
        ...
        )
        {
            ...
            {
                Controllers.ControllerFactory.GetDefaultController(
                    expression,
                    out newControllerName,
                    out newControllerParameters
                );
        ...
        private void CreateUserInterface()
        {
            if ((this.controller == null) && (this.controllerName != null))
            {
                Controllers.ControllerParameters parameters = new Controllers.ControllerParameters(
                    this.controllerParameters
                );
                this.controller = Controllers.ControllerFactory.CreateController(
                    this.controllerName,
                    parameters
                );
        ...
        IEnumerable<Widgets.Layouts.PermeableCell> Widgets.Layouts.IGridPermeable.GetChildren(
            int column,
            int row,
            int columnSpan,
            int rowSpan
        ...
        private class NoOpGridPermeableHelper : Widgets.Layouts.IGridPermeable
        {
            ...
            public IEnumerable<Widgets.Layouts.PermeableCell> GetChildren(
                int column,
                int row,
                int columnSpan,
                int rowSpan
        ...
        private static void NotifyControllerChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        private static void NotifyVerbosityChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        private static void NotifyLabelReplacementChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty ControllerProperty = DependencyProperty.Register(
            ...
            typeof(string),
            typeof(Placeholder),
            new DependencyPropertyMetadata("*", Placeholder.NotifyControllerChanged)
        );
        public static readonly DependencyProperty ControllerParametersProperty =
        ...
        public static readonly DependencyProperty VerbosityProperty = DependencyProperty.Register(
            "Verbosity",
            typeof(Verbosity),
            typeof(Placeholder),
            new DependencyPropertyMetadata(Verbosity.Default, Placeholder.NotifyVerbosityChanged)
        );
        public static readonly DependencyProperty LabelReplacementProperty =
            DependencyProperty.Register(
                "LabelReplacement",
                typeof(Druid),
                typeof(Placeholder),
                new DependencyPropertyMetadata(
                    Druid.Empty,
                    Placeholder.NotifyLabelReplacementChanged
                )
            );

        static readonly NoOpGridPermeableHelper noOpGridPermeableHelper =
            new NoOpGridPermeableHelper();
