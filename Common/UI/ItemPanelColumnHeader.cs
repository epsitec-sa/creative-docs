...
namespace Epsitec.Common.UI
{
    ...
    public class ItemPanelColumnHeader : Widgets.FrameBox
    {
        ...
        {
            get { return (ItemPanel)this.GetValue(ItemPanelColumnHeader.ItemPanelProperty); }
            set { this.SetValue(ItemPanelColumnHeader.ItemPanelProperty, value); }
        }
        ...
        public void SetColumnSort(int index, ListSortDirection sortDirection)
        {
            if (sortDirection != ListSortDirection.None)
            {
                this.SetColumnSort(
                    ...
                    new SortDescription(
                        sortDirection,
                        this.columns[index].PropertyName,
                        this.GetColumnComparer(index)
                    )
                );
            }
        }
        ...
        public void UpdateColumnSorts()
        {
            ...
            for (int i = this.sorts.Count; --i >= 0; )
            {
                ...
                {
                    this.columns[index].Button.SortMode =
                        record.Sort.Direction == ListSortDirection.Ascending
                            ? SortMode.Down
                            : SortMode.Up;
                    break;
                }
        ...
        public void SetColumnWidth(int index, double width)
        {
            ...
            {
                ColumnWidthChangeEventArgs e = new ColumnWidthChangeEventArgs(
                    index,
                    oldWidth,
                    newWidth
                );
                ...
                if (width != oldWidth)
                {
                    ...
                    this.OnColumnWidthChanged(
                        new ColumnWidthChangeEventArgs(index, oldWidth, width)
                    );
                }
            }
        }
        ...
        {
            Support.EventHandler<ColumnWidthChangeEventArgs> handler =
                this.GetUserEventHandler<ColumnWidthChangeEventArgs>(
                    ItemPanelColumnHeader.ColumnWidthChangingEventName
                );
        ...
        protected virtual void OnColumnWidthChanged(ColumnWidthChangeEventArgs e)
        {
            Support.EventHandler<ColumnWidthChangeEventArgs> handler =
                this.GetUserEventHandler<ColumnWidthChangeEventArgs>(
                    ItemPanelColumnHeader.ColumnWidthChangedEventName
                );
        ...
        private void UpdateSliderPositions()
        {
            ...
            foreach (Column column in this.columns)
            {
                if (column.Button.Visibility)
                {
                    ...
                    column.Slider.Margins = new Drawing.Margins(
                        offset - (column.Slider.PreferredWidth - 1) / 2,
                        0,
                        0,
                        0
                    );
        ...
        private void HandleColumnClicked(object sender, MessageEventArgs e)
        {
            ...
            this.SetColumnSort(
                index,
                column.Button.SortMode == SortMode.Down
        ...
        private class Column
        {
            ...
            {
                get { return this.property.PropertyName; }
            }
            ...
            {
                string[] names = this.property.GetGroupNamesForItem(
                    item,
        ...
        private static void NotifyItemPanelChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty ColumnHeaderProperty =
            DependencyProperty.RegisterAttached(
                "ColumnHeader",
                typeof(ItemPanelColumnHeader),
                typeof(ItemPanelColumnHeader),
                new DependencyPropertyMetadata()
            );
        public static readonly DependencyProperty ItemPanelProperty = DependencyProperty.Register(
            "ItemPanel",
            typeof(ItemPanel),
            typeof(ItemPanelColumnHeader),
            new DependencyPropertyMetadata(ItemPanelColumnHeader.NotifyItemPanelChanged)
        );
