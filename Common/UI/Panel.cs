...
namespace Epsitec.Common.UI
{
    ...
    public class Panel : Widgets.FrameBox
    {
        ...
        {
            get { return Support.ResourceManager.GetResourceManager(this); }
            set { Support.ResourceManager.SetResourceManager(this, value); }
        }
        ...
        {
            get { return this.GetPanel(PanelMode.Edition); }
        }
        ...
        {
            get { return this.GetPanel(PanelMode.Search); }
        }
        ...
        public static void FillSerializationContext(
            Types.Serialization.Context context,
            DataSource dataSource,
            Support.ResourceManager resourceManager
        )
        {
            context.ExternalMap.Record(
                Types.Serialization.Context.WellKnownTagDataSource,
                dataSource
            );
            context.ExternalMap.Record(
                Types.Serialization.Context.WellKnownTagResourceManager,
                resourceManager
            );
        }
        ...
        public static string SerializePanel(Panel panel)
        {
            ...
            using (
                Types.Serialization.Context context = new Types.Serialization.SerializerContext(
                    new Types.Serialization.IO.XmlWriter(xmlWriter)
                )
            )
            {
        ...
        public static Panel DeserializePanel(
            string xml,
            DataSource dataSource,
        ...
        )
        {
            ...
            Types.Serialization.Context context = new Types.Serialization.DeserializerContext(
                new Types.Serialization.IO.XmlReader(xmlReader)
            );
        ...
        public static Drawing.Size GetPanelDefaultSize(
            Support.Druid panelId,
            Support.ResourceManager manager
        )
        {
            if (manager == null)
                        ...
                        else if (message.MessageType == Widgets.MessageType.MouseUp)
                        {
                            if (this.isMouseDown)
                            {
                                ...
                                this.StartEdition(
                                    ...
                                    this.FindChild(
                                        pos,
                                        Widgets.WidgetChildFindMode.Deep
                                            | Widgets.WidgetChildFindMode.SkipHidden
                                            | Widgets.WidgetChildFindMode.SkipDisabled
                                    ),
                                    panelStack
                                );
                            }
        ...
        public override Widgets.TabNavigationMode TabNavigationMode
        {
            get
            {
                if (this.HasValidEditionPanel)
                {
                    return base.TabNavigationMode
                        & ~Widgets.TabNavigationMode.ForwardToChildren
                        & ~Widgets.TabNavigationMode.ForwardOnly;
                }
                else
                {
                    return base.TabNavigationMode;
            ...
            set { base.TabNavigationMode = value; }
        }

        private void StartEdition(
            Widgets.Message message,
            Widgets.Widget focusWidget,
            PanelStack panelStack
        )
        {
            string focusWidgetName = null;

            if ((focusWidget != null) && (focusWidget != this))
            {
                focusWidgetName = focusWidget.Name;
            }

            PanelActivationEventArgs e = new PanelActivationEventArgs(
                this,
                panelStack,
                focusWidgetName
            );
        ...
        protected virtual bool OnPanelActivation(PanelActivationEventArgs e)
        {
            Support.EventHandler<PanelActivationEventArgs> handler =
                this.GetUserEventHandler<PanelActivationEventArgs>(Panel.PanelActivationEventName);
        ...
        private static void NotifyPanelModeChanged(
        ...
        private static void SetEditionPanelValue(DependencyObject obj, object value)
        {
            ...
            if ((panel.editionPanel != null) && (panel.PanelMode == PanelMode.Default))
            {
        ...
        private static void SetSearchPanelValue(DependencyObject obj, object value)
        {
            ...
            if ((panel.searchPanel != null) && (panel.PanelMode == PanelMode.Default))
            {
                panel.SetupDataContextChangeHandler();
        ...
        {
            add { this.AddUserEventHandler(Panel.PanelActivationEventName, value); }
            remove { this.RemoveUserEventHandler(Panel.PanelActivationEventName, value); }
        }
        ...
        public static readonly DependencyProperty PanelProperty =
            DependencyProperty.RegisterAttached("Panel", typeof(Panel), typeof(Panel));
        ...
        public static readonly DependencyProperty DataSourceMetadataProperty =
            DependencyProperty.RegisterReadOnly(
                "DataSourceMetadata",
                typeof(DataSourceMetadata),
                typeof(Panel),
                new DependencyPropertyMetadata(
                    Panel.GetDataSourceMetadataValue,
                    Panel.SetDataSourceMetadataValue
        ...
        public static readonly DependencyProperty DataSourceProperty = DependencyProperty.Register(
            ...
            typeof(DataSource),
            typeof(Panel),
            new DependencyPropertyMetadata(Panel.GetDataSourceValue, Panel.SetDataSourceValue)
        );
        public static readonly DependencyProperty EditionPanelProperty =
            DependencyProperty.Register(
                "EditionPanel",
                typeof(Panels.EditPanel),
                typeof(Panel),
                new DependencyPropertyMetadata(
                    Panel.GetEditionPanelValue,
                    Panel.SetEditionPanelValue
                )
            );
        public static readonly DependencyProperty SearchPanelProperty = DependencyProperty.Register(
            "SearchPanel",
            typeof(Panels.SearchPanel),
            typeof(Panel),
            new DependencyPropertyMetadata(Panel.GetSearchPanelValue, Panel.SetSearchPanelValue)
        );
