    ...
    public class ItemPanel : Widgets.Widget
    {
        ...
        static ItemPanel()
        {
            DependencyPropertyMetadata metadata =
                Widgets.Widget.AutoDoubleClickProperty.DefaultMetadata.Clone();
        ...
        {
            get { return (ICollectionView)this.GetValue(ItemPanel.ItemsProperty); }
            set { this.SetValue(ItemPanel.ItemsProperty, value); }
        }
        ...
        {
            get { return this.parentGroup == null; }
        }
        ...
        {
            get { return (ItemPanelLayout)this.GetValue(ItemPanel.LayoutProperty); }
            set { this.SetValue(ItemPanel.LayoutProperty, value); }
        }
        ...
        {
            get { return (ItemPanelLayout)this.GetValue(ItemPanel.LayoutGroupsProperty); }
            set { this.SetValue(ItemPanel.LayoutGroupsProperty, value); }
        }
        ...
        {
            get { return (ItemPanelLayout)this.GetValue(ItemPanel.LayoutSubgroupsProperty); }
            set { this.SetValue(ItemPanel.LayoutSubgroupsProperty, value); }
        }
        ...
        {
            get { return this.customItemViewFactoryGetter; }
            set { this.customItemViewFactoryGetter = value; }
        }
                ...
                switch (this.GetPanelLayout())
                {
                    ...
                    default:
                        throw new System.NotSupportedException(
                            string.Format("Layout {0} not supported", this.GetPanelLayout())
                        );
                }
            }
        }
        ...
        public CurrentItemTrackingMode CurrentItemTrackingMode
        {
            get
            {
                return (CurrentItemTrackingMode)
                    this.GetValue(ItemPanel.CurrentItemTrackingModeProperty);
            }
            set { this.SetValue(ItemPanel.CurrentItemTrackingModeProperty, value); }
        }
        ...
        public ItemPanelSelectionBehavior SelectionBehavior
        {
            get
            {
                return (ItemPanelSelectionBehavior)
                    this.GetValue(ItemPanel.SelectionBehaviorProperty);
            }
            set { this.SetValue(ItemPanel.SelectionBehaviorProperty, value); }
        }
        ...
        public ItemPanelSelectionMode ItemSelectionMode
        {
            get
            {
                return (ItemPanelSelectionMode)
                    this.RootPanel.GetValue(ItemPanel.ItemSelectionModeProperty);
            }
            set { this.RootPanel.SetValue(ItemPanel.ItemSelectionModeProperty, value); }
        }
        ...
        public ItemPanelSelectionMode GroupSelectionMode
        {
            ...
            {
                return (ItemPanelSelectionMode)
                    this.RootPanel.GetValue(ItemPanel.GroupSelectionModeProperty);
            }
            set { this.RootPanel.SetValue(ItemPanel.GroupSelectionModeProperty, value); }
        }
        ...
        {
            get { return (Drawing.Size)this.GetValue(ItemPanel.ItemViewDefaultSizeProperty); }
            set { this.SetValue(ItemPanel.ItemViewDefaultSizeProperty, value); }
        }
        ...
        {
            get { return (bool)this.GetValue(ItemPanel.ItemViewDefaultExpandedProperty); }
            set { this.SetValue(ItemPanel.ItemViewDefaultExpandedProperty, value); }
        }
        ...
        {
            get { return (Drawing.Margins)this.GetValue(ItemPanel.AperturePaddingProperty); }
            set { this.SetValue(ItemPanel.AperturePaddingProperty, value); }
        }

        public override bool ContainsKeyboardFocus
        {
            get { return this.containsKeyboardFocus || base.ContainsKeyboardFocus; }
        }
        ...
        public Drawing.Rectangle GetExpandedItemViewBounds(ItemView view)
        {
            ...
            while (panel != this)
            {
                ...
                {
                    bounds.Top +=
                        group.GetInternalPadding().Top + group.Padding.Top + panel.Margins.Top;
                }
                if (view.Bounds.Right == right)
                {
                    bounds.Right +=
                        group.GetInternalPadding().Right
                        + group.Padding.Right
                        + panel.Margins.Right;
                }
                ...
                {
                    bounds.Bottom -=
                        group.GetInternalPadding().Bottom
                ...
                {
                    bounds.Left -=
                        group.GetInternalPadding().Left + group.Padding.Left + panel.Margins.Left;
                }
        ...
        public ItemView DetectItemView(Drawing.Point pos)
        {
            return this.FindItemView(
                ...
                {
                    if ((item.IsVisible) && (item.Bounds.Contains(pos)))
                    {
                        return true;
                    }
                    else
        ...
        /// be found.
        /// </returns>
        public IList<ItemView> FindItemViews(
            System.Predicate<ItemView> match,
            System.Predicate<ItemView> groupMatch
        )
        {
            ...
            foreach (ItemView view in views)
            {
                ...
                if (view.IsGroup)
                {
                    if ((groupMatch == null) || (groupMatch(view)))
                    {
        ...
        public void Show(ItemView view)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ((aperture.Right < bounds.Right) && (aperture.Left < bounds.Left))
                    {
                        ox = System.Math.Max(
                            aperture.Right - bounds.Right,
                            aperture.Left - bounds.Left
                        );
                    }
                    else if ((aperture.Right > bounds.Right) && (aperture.Left > bounds.Left))
                    {
                        ox = System.Math.Min(
                            aperture.Right - bounds.Right,
                            aperture.Left - bounds.Left
                    ...
                    if ((aperture.Top < bounds.Top) && (aperture.Bottom < bounds.Bottom))
                    {
                        oy = System.Math.Max(
                            aperture.Top - bounds.Top,
                            aperture.Bottom - bounds.Bottom
                        );
                    }
                    else if ((aperture.Top > bounds.Top) && (aperture.Bottom > bounds.Bottom))
                    {
                        oy = System.Math.Min(
                            aperture.Top - bounds.Top,
                            aperture.Bottom - bounds.Bottom
        ...
        private class RefreshInfo : System.IComparable<RefreshInfo>, System.IEquatable<RefreshInfo>
        {
            ...
            {
                return (this.panel == other.panel) && (this.depth == other.depth);
            }
        ...
        internal void NotifyItemViewSizeChanged(
            ItemView view,
            Drawing.Size oldSize,
        ...
        protected virtual void HandleItemsChanged(
            ICollectionView oldValue,
            ICollectionView newValue
        )
        {
            if (oldValue != null)
            {
            ...
            if (newValue != null)
            {
                ...
                this.HandleItemCollectionChanged(
                    this,
                    new CollectionChangedEventArgs(CollectionChangedAction.Reset)
                );
                this.HandleItemCollectionCurrentChanged(this);
            }
        }

        protected virtual void HandleLayoutChanged(
            ItemPanelLayout oldValue,
            ItemPanelLayout newValue
        )
        {
        ...
        protected virtual void HandleLayoutGroupsChanged(
            ItemPanelLayout oldValue,
            ItemPanelLayout newValue
        )
        {
        ...
        protected virtual void HandleLayoutSubgroupsChanged(
            ItemPanelLayout oldValue,
            ItemPanelLayout newValue
        )
        {
        ...
        protected virtual void HandleItemSelectionModeChanged(
            ItemPanelSelectionMode oldValue,
            ItemPanelSelectionMode newValue
        ) { }

        protected virtual void HandleGroupSelectionModeChanged(
            ItemPanelSelectionMode oldValue,
            ItemPanelSelectionMode newValue
        ) { }

        protected virtual void HandleSelectionBehaviorChanged(
            ItemPanelSelectionBehavior oldValue,
            ItemPanelSelectionBehavior newValue
        ) { }

        protected virtual void HandleItemCollectionChanged(
            object sender,
        ...
        private void TrackCurrentItem(bool autoSelect)
        {
            ...
            if (this.PanelDepth == 0)
            {
                ...
                else
                {
                    ...
                    if (view == null)
                    {
                        ...
                        IList<CollectionViewGroup> path = CollectionView.GetGroupPath(
                            this.Items,
                            item
                        );
            ...
            else
            {
                System.Diagnostics.Debug.WriteLine(
                    "TrackCurrentItem: called for panel at depth=" + this.PanelDepth
                );
            }
        }
        ...
        private void TrackCurrentItem(ItemView view, bool focus, bool autoSelect)
        {
            ...
            if (view == null)
            {
                ...
                autoSelect =
                    (
                        (mode == CurrentItemTrackingMode.AutoSelectAndDeselect)
                        || (this.Items.IsEmpty)
                    )
                        ? autoSelect
                        : false;
            ...
            if ((focus) && (view.HasValidUserInterface))
            {
                view.Widget.Focus();
            }
        ...
        protected virtual void HandleItemViewDefaultSizeChanged(
            Drawing.Size oldValue,
            Drawing.Size newValue
        )
        {
            this.AsyncRefresh();
        }

        protected virtual void HandleItemViewDefaultExpandedChanged(
            bool oldValue,
            bool newValue
        ) { }

        protected virtual void HandleApertureChanged(
        ...
        )
        {
            ...
            if (this.ApertureChanged != null)
            {
                this.ApertureChanged(
                    this,
                    new DependencyPropertyChangedEventArgs("Aperture", oldValue, newValue)
                );
            }
        }
        ...
        private void NotifySelectionChanged()
        {
            if (this.selectionChanged)
            {
                ...
                {
                    ItemPanelSelectionChangedEventArgs e = new ItemPanelSelectionChangedEventArgs(
                        this.selectionSelected,
                        this.selectionDeselected
                    );
        ...
        protected override bool AboutToGetFocus(
            Widgets.TabNavigationDir dir,
            Widgets.TabNavigationMode mode,
            out Widgets.Widget focus
        )
        {
        ...
        public bool Navigate(Widgets.Message message)
        {
            ...
            if (this.ProcessNavigationKeys(message.KeyCode))
            {
                ...
                if ((newCurrentItemView != null) && (newCurrentItemView != oldCurrentItemView))
                {
                ...
                if (group != null)
                {
                    if (group.IsExpanded == expand)
                    {
                        if (expand == false)
                        {
                            ...
                            if ((parent != null) && (parent.ParentGroup != null))
                            {
        ...
        internal void NotifyWidgetPressed(
            ItemViewWidget widget,
            Widgets.Message message,
            Drawing.Point pos
        )
        {
            Widgets.MessageEventArgs e = new Widgets.MessageEventArgs(
                message,
                widget.MapClientToParent(pos)
            );
        ...
        private void ContinuousKeySelection(
            IList<ItemView> list,
            ItemView oldCurrent,
            ItemView newCurrent
        )
        ...
        private void ContinuousMouseSelection(
            IList<ItemView> list,
            ItemView current,
            ItemView clicked,
        ...
        )
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                string.Format("Current: {0} Clicked: {1}", currentIndex, clickedIndex)
            );
        ...
        private void ProcessVerticalListPageDownMove()
        {
            ...
            if (layout == ItemPanelLayout.RowsOfTiles)
            {
                ...
                {
                    pos =
                        last / this.totalColumnCount * this.totalColumnCount
                        + pos % this.totalColumnCount;
                }
            }
        ...
        private static ItemView GetFirstSelectedItemView(
            System.Collections.IList collection,
            IEnumerable<ItemView> list
        )
        {
        ...
        private static ItemView GetLastSelectedItemView(
            System.Collections.IList collection,
            IEnumerable<ItemView> list
        )
        {
        ...
        {
            if (
                (message.MessageType == MessageType.MouseUp)
            ...
            )
            {
                if (message.Captured)
                {
                    switch (message.ButtonDownCount)
                    {
                        case 1:
                            this.OnReleased(
                                new Epsitec.Common.Widgets.MessageEventArgs(message, pos)
                            );
                            break;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            this.CreateItemViews(
                                views,
                                group.Items as System.Collections.IList,
                                currentViews
                            );
                        }
                    }
        ...
        private void CreateItemViews(
            ...
            Dictionary<object, ItemView> currentViews
        )
        {
        ...
        private ItemView Detect(IList<ItemView> views, Drawing.Point pos)
        {
            ...
            {
                foreach (
                    ItemView view in ItemPanel.GetNearbyItemViews(views, this.hotItemViewIndex, 5)
                )
                {
        ...
        private static IEnumerable<ItemView> GetNearbyItemViews(
            IList<ItemView> views,
            int index,
            int count
        )
        ...
        class RefreshState
        {
            ...
            public void GenerateEvents()
            {
                ...
                {
                    this.panel.OnContentsSizeChanged(
        ...
        private static void NotifyItemsChanged(
        ...
        private static void NotifyLayoutGroupsChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        ...
        private static void NotifyLayoutSubgroupsChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        {
            ItemPanel panel = (ItemPanel)obj;
            panel.HandleLayoutSubgroupsChanged(
                (ItemPanelLayout)oldValue,
                (ItemPanelLayout)newValue
            );
        }

        private static void NotifyItemSelectionModeChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        {
            ItemPanel panel = (ItemPanel)obj;
            panel.HandleItemSelectionModeChanged(
                (ItemPanelSelectionMode)oldValue,
                (ItemPanelSelectionMode)newValue
            );
        }

        private static void NotifyGroupSelectionModeChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        {
            ItemPanel panel = (ItemPanel)obj;
            panel.HandleGroupSelectionModeChanged(
                (ItemPanelSelectionMode)oldValue,
                (ItemPanelSelectionMode)newValue
            );
        }

        private static void NotifySelectionBehaviorChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        {
            ItemPanel panel = (ItemPanel)obj;
            panel.HandleSelectionBehaviorChanged(
                (ItemPanelSelectionBehavior)oldValue,
                (ItemPanelSelectionBehavior)newValue
            );
        }

        private static void NotifyItemViewDefaultSizeChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        ...
        private static void NotifyItemViewDefaultExpandedChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty ItemsProperty = DependencyProperty.Register(
            ...
            typeof(ItemPanel),
            new DependencyPropertyMetadata(ItemPanel.NotifyItemsChanged)
        );
        public static readonly DependencyProperty LayoutProperty = DependencyProperty.Register(
            "Layout",
            typeof(ItemPanelLayout),
            typeof(ItemPanel),
            new DependencyPropertyMetadata(
                ItemPanelLayout.VerticalList,
                ItemPanel.NotifyLayoutChanged
            )
        );
        public static readonly DependencyProperty LayoutGroupsProperty =
            DependencyProperty.Register(
                ...
                new DependencyPropertyMetadata(
                    ItemPanelLayout.VerticalList,
                    ItemPanel.NotifyLayoutGroupsChanged
                )
            );
        public static readonly DependencyProperty LayoutSubgroupsProperty =
            DependencyProperty.Register(
                "LayoutSubgroups",
                typeof(ItemPanelLayout),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(
                    ItemPanelLayout.VerticalList,
                    ItemPanel.NotifyLayoutSubgroupsChanged
                )
            );
        public static readonly DependencyProperty ItemSelectionModeProperty =
            DependencyProperty.Register(
                "ItemSelectionMode",
                typeof(ItemPanelSelectionMode),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(
                    ItemPanelSelectionMode.None,
                    ItemPanel.NotifyItemSelectionModeChanged
                )
            );
        public static readonly DependencyProperty GroupSelectionModeProperty =
            DependencyProperty.Register(
                ...
                new DependencyPropertyMetadata(
                    ItemPanelSelectionMode.None,
                    ItemPanel.NotifyGroupSelectionModeChanged
                )
            );
        public static readonly DependencyProperty SelectionBehaviorProperty =
            DependencyProperty.Register(
                "SelectionBehavior",
                typeof(ItemPanelSelectionBehavior),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(
                    ItemPanelSelectionBehavior.Automatic,
                    ItemPanel.NotifySelectionBehaviorChanged
                )
            );
        public static readonly DependencyProperty ItemViewDefaultSizeProperty =
            DependencyProperty.Register(
                "ItemViewDefaultSize",
                typeof(Drawing.Size),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(
                    new Drawing.Size(80, 20),
                    ItemPanel.NotifyItemViewDefaultSizeChanged
                )
            );
        public static readonly DependencyProperty ItemViewDefaultExpandedProperty =
            DependencyProperty.Register(
                "ItemViewDefaultExpanded",
                typeof(bool),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(
                    false,
                    ItemPanel.NotifyItemViewDefaultExpandedChanged
                )
            );
        public static readonly DependencyProperty AperturePaddingProperty =
            DependencyProperty.Register(
                "AperturePadding",
                typeof(Drawing.Margins),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(Drawing.Margins.Zero)
            );
        public static readonly DependencyProperty CurrentItemTrackingModeProperty =
            DependencyProperty.Register(
                "CurrentItemTrackingMode",
                typeof(CurrentItemTrackingMode),
                typeof(ItemPanel),
                new DependencyPropertyMetadata(CurrentItemTrackingMode.None)
            );
