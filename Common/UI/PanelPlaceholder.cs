...
namespace Epsitec.Common.UI
{
    public class PanelPlaceholder : AbstractPlaceholder, Types.Serialization.IDeserialization
    {
        ...
        {
            get { return (Support.Druid)this.GetValue(PanelPlaceholder.PanelIdProperty); }
            set { this.SetValue(PanelPlaceholder.PanelIdProperty, value); }
        }
        ...
        public static IEnumerable<Support.Druid> GetAllPanelIds(Widgets.Widget root)
        {
            ...
            foreach (
                PanelPlaceholder widget in root.FindAllChildren(
        ...
        private void UpdatePanelDataContext()
        {
            if (this.panel != null)
            {
                ...
                if ((binding == null) || ((binding.Source == null) && (binding.Path == null)))
                {
                    DataObject.ClearDataContext(this.panel);
                }
                else
        ...
        bool Types.Serialization.IDeserialization.NotifyDeserializationStarted(
        ...
        void Types.Serialization.IDeserialization.NotifyDeserializationCompleted(
            Types.Serialization.Context context
        )
        {
            this.suspendUserInterfaceCreation--;
        ...
        {
            if ((this.suspendUserInterfaceCreation == 0) && (this.PanelId.IsValid))
            {
                ...
                if (manager == null)
                {
                    throw new System.InvalidOperationException(
                        "Cannot create user interface: ResourceManager is undefined (add the PanelPlaceholder into a valid Panel)"
                    );
                }
                ...
                {
                    throw new System.InvalidOperationException(
                        string.Format("Cannot create user interface: bundle {0} not found", panelId)
                    );
                }
        ...
        private static void NotifyPanelIdChanged(
        ...
        public static readonly DependencyProperty PanelIdProperty = DependencyProperty.Register(
            "PanelId",
            typeof(Support.Druid),
            typeof(PanelPlaceholder),
            new DependencyPropertyMetadata(
                Support.Druid.Empty,
                PanelPlaceholder.NotifyPanelIdChanged
            )
        );
