...
namespace Epsitec.Common.UI
{
    ...
    public class ItemTable : Widget, IListHost<ItemTableColumn>
    {
        ...
        public ItemTable()
        {
            ...
            this.itemPanel.AddEventHandler(
                ItemPanel.LayoutProperty,
                this.HandleItemPanelLayoutChanged
            );
            this.itemPanel.AddEventHandler(
                ItemPanel.LayoutGroupsProperty,
                this.HandleItemPanelLayoutChanged
            );
            this.itemPanel.AddEventHandler(
                ItemPanel.LayoutSubgroupsProperty,
                this.HandleItemPanelLayoutChanged
            );
        ...
        private void HandleColumnHeaderColumnWidthChanged(
            object sender,
            ColumnWidthChangeEventArgs e
        )
        {
        ...
        private void UpdateGeometry()
        {
            ...
            this.surface.Margins = new Margins(
                frameMargin,
        ...
        {
            get { return this.ItemPanel.Items; }
            set
            {
                if (this.Items != value)
                {
                    ...
                    )
                    {
                        ...
                        else
                        {
                            ...
                            System.Type itemType = TypeRosetta.GetEnumerableItemType(
                                collectionType
                            );
        ...
        {
            get { return this.headerStripe.Visibility; }
            set
            {
        ...
        {
            get { return this.separatorVisibility; }
            set
            {
        ...
        public ItemTableScrollMode HorizontalScrollMode
        {
            ...
            set { this.SetValue(ItemTable.HorizontalScrollModeProperty, value); }
        }

        public ItemTableScrollMode VerticalScrollMode
        {
            get { return (ItemTableScrollMode)this.GetValue(ItemTable.VerticalScrollModeProperty); }
            set { this.SetValue(ItemTable.VerticalScrollModeProperty, value); }
        }

        public bool FrameVisibility
        {
            get { return (bool)this.GetValue(ItemTable.FrameVisibilityProperty); }
            set { this.SetValue(ItemTable.FrameVisibilityProperty, value); }
        }
        ...
        )
        {
            ...
            {
                if ((focus == this) && (this.itemPanel != null))
                {
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            double x1 = 0;
            double x2 = this.vScroller.Visibility
                ? this.vScroller.ActualBounds.Left
                : this.Client.Bounds.Right;
            double y1 = this.hScroller.Visibility
                ? this.hScroller.ActualBounds.Top
                : this.Client.Bounds.Bottom;
            double y2 = this.headerStripe.Visibility
                ? this.headerStripe.ActualBounds.Bottom
                : this.Client.Bounds.Top;
            ...
            if (this.BackColor.IsEmpty)
            {
                ...
                if (
                    (this.GetItemTableLayout() == ItemPanelLayout.VerticalList)
        ...
        private void PaintColumnSeparators(
            Graphics graphics,
            Widgets.IAdorner adorner,
            Rectangle bounds
        )
        {
            ...
            graphics.RenderSolid(
                Color.FromAlphaRgb(
                    0.2,
                    adorner.ColorBorder.R,
                    adorner.ColorBorder.G,
                    adorner.ColorBorder.B
                )
            );
        }
        ...
        private void UpdateAperture()
        {
            ...
            switch (this.GetVerticalScrollMode())
            {
                case ItemTableScrollMode.Linear:
                    ...
                    {
                        this.vScroller.SmallChange = (decimal)(
                            this.itemPanel.ItemViewDefaultSize.Height / scrollSize.Height
                        );
                        this.vScroller.LargeChange = (decimal)(
                            apertureSize.Height / scrollSize.Height
                        );
                    }
                    break;
                ...
                case ItemTableScrollMode.ItemBased:
                    ...
                    this.vScroller.LargeChange = this.itemPanel.GetVisibleRowCount(
                        this.apertureSize.Height
                    );
                    this.vScroller.MinValue = 0;
                    this.vScroller.MaxValue = System.Math.Max(
                        0,
                        this.itemPanel.GetTotalRowCount() - this.vScroller.LargeChange
                    );
                    padding.Bottom =
                        this.apertureSize.Height
                        - this.itemPanel.GetRowHeight() * (double)(this.vScroller.LargeChange);
                    break;
            }
            ...
            this.columnHeader.SetManualBounds(
                new Rectangle(-ox, 0, headerSize.Width, headerSize.Height)
            );
        }
        ...
        private ItemTableScrollMode GetVerticalScrollMode()
        {
            ...
            if (mode == ItemTableScrollMode.ItemBased)
            {
                ...
                if ((this.Items != null) && (this.Items.Groups.Count > 0))
                {
        ...
        {
            double hRatio = System.Math.Max(
                0,
                System.Math.Min(1, (apertureSize.Width + 1) / (this.itemPanel.PreferredWidth + 1))
            );
            double vRatio = System.Math.Max(
                0,
                System.Math.Min(1, (apertureSize.Height + 1) / (this.itemPanel.PreferredHeight + 1))
            );
        ...
        private double GetVerticalScrollOffsetItemBased()
        {
            ...
            double pos =
                (view == null)
                    ? this.itemPanel.GetContentsSize().Height
                    : this.itemPanel.GetItemViewBounds(view).Top;
        ...
        {
            double pos =
                offset + this.apertureSize.Height - this.itemPanel.AperturePadding.Height - 0.5;
            ...
            ItemView view = this.itemPanel.FindItemView(
                delegate(ItemView candidate)
                {
                    ...
                    if ((bounds.Bottom < pos) && (bounds.Top > pos))
                    {
                        return true;
                    }
        ...
        private ItemPanelLayout GetItemTableLayout()
        {
            ...
            if ((this.Items != null) && (this.Items.GroupDescriptions.Count > 0))
            {
            ...
            )
            {
                ...
                for (int i = 0; i < this.columns.Count; i++)
                {
                    ...
                    if (useRealColumns)
                    {
                        ...
                        this.columnHeader.SetColumnSortable(
                            headerIndex,
                            column.SortDirection != ListSortDirection.None
                        );
                        this.columnHeader.SetColumnVisibility(headerIndex, true);
                        this.columnHeader.SetColumnContentAlignment(
                            headerIndex,
        ...
        private void HandleItemPanelLayoutChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
        ...
        private static void NotifyFrameVisibilityChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            ...
            that.OnFrameVisibilityChanged(
                new DependencyPropertyChangedEventArgs(
                    ItemTable.FrameVisibilityProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        private static void NotifyHorizontalScrollModeChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            ItemTable that = o as ItemTable;
            that.OnScrollModeChanged(
                new DependencyPropertyChangedEventArgs(
                    ItemTable.HorizontalScrollModeProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        private static void NotifyVerticalScrollModeChanged(
            DependencyObject o,
            object oldValue,
            object newValue
        )
        {
            ...
            that.OnScrollModeChanged(
                new DependencyPropertyChangedEventArgs(
                    ItemTable.VerticalScrollModeProperty,
                    oldValue,
                    newValue
                )
            );
        ...
        public static readonly DependencyProperty ItemTableProperty =
            DependencyProperty.RegisterAttached("ItemTable", typeof(ItemTable), typeof(ItemTable));
        ...
        public static readonly DependencyProperty FrameVisibilityProperty =
            DependencyProperty.Register(
                ...
                typeof(bool),
                typeof(ItemTable),
                new DependencyPropertyMetadata(true, ItemTable.NotifyFrameVisibilityChanged)
            );
        public static readonly DependencyProperty VerticalScrollModeProperty =
            DependencyProperty.Register(
                "VerticalScrollMode",
                typeof(ItemTableScrollMode),
                typeof(ItemTable),
                new DependencyPropertyMetadata(
                    ItemTableScrollMode.Linear,
                    ItemTable.NotifyVerticalScrollModeChanged
                )
            );
        public static readonly DependencyProperty HorizontalScrollModeProperty =
            DependencyProperty.Register(
                ...
                new DependencyPropertyMetadata(
                    ItemTableScrollMode.Linear,
                    ItemTable.NotifyHorizontalScrollModeChanged
                )
            );
