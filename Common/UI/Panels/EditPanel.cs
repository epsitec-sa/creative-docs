...
namespace Epsitec.Common.UI.Panels
{
    internal class EditPanel : Panel, Widgets.ILogicalTree
    {
        ...
        {
            get { return this.owner.DataSource; }
            set { this.owner.DataSource = value; }
        }

        public override DataSourceMetadata DataSourceMetadata
        {
            get { return this.owner.DataSourceMetadata; }
        }
        ...
        {
            get { return this.owner ?? this.Parent; }
        }
        ...
        )
        {
            ...
            if (path == null)
            {
                graphics.AddFilledRectangle(
                    Drawing.Rectangle.Intersection(clipRect, this.Client.Bounds)
                );
            ...
            else
            {
                ...
                graphics.Rasterizer.AddOutline(
                    path,
                    2.0,
                    Epsitec.Common.Drawing.CapStyle.Round,
        ...
        protected override bool ProcessTabChildrenExit(
        ...
        public static DependencyProperty OwnerProperty = DependencyProperty.Register(
            ...
            typeof(Panel),
            typeof(EditPanel),
            new DependencyPropertyMetadata(EditPanel.GetOwnerValue, EditPanel.SetOwnerValue)
        );
