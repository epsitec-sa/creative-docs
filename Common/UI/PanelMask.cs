...
namespace Epsitec.Common.UI
{
    ...
    public class PanelMask : Widgets.Widget
    {
        ...
        {
            get { return (Drawing.Color)this.GetValue(PanelMask.MaskColorProperty); }
            set { this.SetValue(PanelMask.MaskColorProperty, value); }
        }

        public Drawing.Color ArrowColor
        {
            get { return (Drawing.Color)this.GetValue(PanelMask.ArrowColorProperty); }
            set { this.SetValue(PanelMask.ArrowColorProperty, value); }
        }

        public Widgets.Direction Arrow
        {
            get { return (Widgets.Direction)this.GetValue(PanelMask.ArrowProperty); }
            set { this.SetValue(PanelMask.ArrowProperty, value); }
        }
        ...
        )
        {
            ...
            else
            {
                ...
                Drawing.Path shape = Drawing.Path.Combine(
                    path,
                    this.aperturePath,
                    Drawing.PathOperation.AMinusB
                );
        ...
        public static readonly DependencyProperty MaskColorProperty = DependencyProperty.Register(
            ...
            typeof(PanelMask),
            new Widgets.Helpers.VisualPropertyMetadata(
                Drawing.Color.FromAlphaRgb(0.5, 0.8, 0.8, 1.0),
                Widgets.Helpers.VisualPropertyMetadataOptions.AffectsDisplay
            )
        );
        public static readonly DependencyProperty ArrowColorProperty = DependencyProperty.Register(
            ...
            typeof(PanelMask),
            new Widgets.Helpers.VisualPropertyMetadata(
                Drawing.Color.FromRgb(1.0, 1.0, 1.0),
                Widgets.Helpers.VisualPropertyMetadataOptions.AffectsDisplay
            )
        );
        public static readonly DependencyProperty ArrowProperty = DependencyProperty.Register(
            "Arrow",
            typeof(Widgets.Direction),
            typeof(PanelMask),
            new Widgets.Helpers.VisualPropertyMetadata(
                Widgets.Direction.None,
                Epsitec.Common.Widgets.Helpers.VisualPropertyMetadataOptions.AffectsDisplay
            )
        );
