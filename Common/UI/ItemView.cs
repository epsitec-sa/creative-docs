    ...
    public class ItemView
    {
        ...
        public IItemViewFactory Factory
        {
            get
            {
                ...
                {
                    if ((this.owner != null) && (this.owner.CustomItemViewFactoryGetter != null))
                    {
        ...
        {
            get { return this.widget as ItemPanelGroup; }
        }
        ...
        public bool IsGroup
        {
            get { return this.item is CollectionViewGroup; }
        }
        ...
        internal void CreateUserInterface()
        {
            ...
            if (this.widget != null)
            {
                ...
                if ((this.owner.GetFocusedItemView() == this) && (this.owner.ContainsKeyboardFocus))
                {
