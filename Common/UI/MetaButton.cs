...
namespace Epsitec.Common.UI
{
    ...
    public sealed class MetaButton : Button
    {
        ...
        {
            get { return this.GetValue<ButtonMarkDisposition>(MetaButton.MarkDispositionProperty); }
            set { this.SetValue(MetaButton.MarkDispositionProperty, value); }
        }

        public double MarkLength
        {
            get { return this.GetValue<double>(MetaButton.MarkLengthProperty); }
            set { this.SetValue(MetaButton.MarkLengthProperty, value); }
        }

        public Drawing.Color BulletColor
        {
            get { return this.GetValue<Drawing.Color>(MetaButton.BulletColorProperty); }
            set { this.SetValue(MetaButton.BulletColorProperty, value); }
        }

        public string PreferredIconLanguage
        {
            get { return (string)this.GetValue(MetaButton.PreferredIconLanguageProperty); }
            set { this.SetValue(MetaButton.PreferredIconLanguageProperty, value); }
        }

        public string PreferredIconStyle
        {
            get { return this.GetValue<string>(MetaButton.PreferredIconStyleProperty); }
            set { this.SetValue(MetaButton.PreferredIconStyleProperty, value); }
        }

        public Drawing.Size PreferredIconSize
        {
            get { return this.GetValue<Drawing.Size>(MetaButton.PreferredIconSizeProperty); }
            set { this.SetValue(MetaButton.PreferredIconSizeProperty, value); }
        }

        public override ButtonStyle ButtonStyle
        {
            get { return base.ButtonStyle; }
            set { throw new System.InvalidOperationException("Use ButtonClass instead"); }
        }
        ...
        )
        {
            ...
            if (
                ...
                && (this.MarkDisposition != ButtonMarkDisposition.None)
            ) // dessine la marque triangulaire ?
            {
        ...
        protected override void OnCommandObjectChanged(DependencyPropertyChangedEventArgs e)
        {
            ...
            if ((command != null) && (!this.ContainsValue(MetaButton.ButtonClassProperty)))
            {
                this.cachedButtonClass = command.CommandParameters.GetValueOrDefault(
        ...
        private void UpdateIcon()
        {
            ...
            if ((string.IsNullOrEmpty(iconUri)) || (this.ButtonClass == ButtonClass.DialogButton))
            {
                if (this.iconLayout != null)
                {
            ...
            else
            {
                ...
                string iconSource = IconButton.GetSourceForIconText(
                    iconUri,
                    iconBounds.Size,
            ...
            switch (aspect)
            {
                ...
                default:
                    throw new System.NotSupportedException(
                        string.Format("ButtonClass.{0} not supported", aspect)
                    );
            }
        }
        ...
        private Drawing.Rectangle GetIconBounds()
        {
            ...
            else
            {
                ...
                var image = Support.ImageProvider.Instance.GetImage(
                    this.IconUri,
                ...
                if ((image != null) && (size.Width != size.Height))
                {
        ...
        private Drawing.Rectangle GetInnerBounds()
        {
            ...
            Drawing.Rectangle bounds = IconButtonMark.GetFrameBounds(
                this.Client.Bounds,
                this.MarkDisposition,
                this.MarkLength
            );
        ...
        static MetaButton()
        {
            DependencyPropertyMetadata metadataButtonStyle =
                Button.ButtonStyleProperty.DefaultMetadata.Clone();
            DependencyPropertyMetadata metadataAlign =
                Visual.ContentAlignmentProperty.DefaultMetadata.Clone();
            DependencyPropertyMetadata metadataDy =
        ...
        private static void HandleButtonClassChanged(
        ...
        private static void HandleIconDefinitionChanged(
            DependencyObject obj,
            object oldValue,
            object newValue
        )
        ...
        public static readonly DependencyProperty ButtonClassProperty = DependencyProperty.Register(
            "ButtonClass",
            typeof(ButtonClass),
            typeof(MetaButton),
            new DependencyPropertyMetadata(ButtonClass.None, MetaButton.HandleButtonClassChanged)
        );
        public static readonly DependencyProperty MarkDispositionProperty =
            DependencyProperty.Register(
                "MarkDisposition",
                typeof(ButtonMarkDisposition),
                typeof(MetaButton),
                new DependencyPropertyMetadata(
                    ButtonMarkDisposition.None,
                    MetaButton.HandleIconDefinitionChanged
                )
            );
        public static readonly DependencyProperty MarkLengthProperty = DependencyProperty.Register(
            "MarkLength",
            typeof(double),
            typeof(MetaButton),
            new DependencyPropertyMetadata(8.0, MetaButton.HandleIconDefinitionChanged)
        );
        ...
        public static readonly DependencyProperty PreferredIconLanguageProperty =
            DependencyProperty.Register(
                "PreferredIconLanguage",
                typeof(string),
                typeof(MetaButton),
                new DependencyPropertyMetadata(
        ...
        public static readonly DependencyProperty PreferredIconStyleProperty =
            DependencyProperty.Register(
                "PreferredIconStyle",
                typeof(string),
                typeof(MetaButton),
                new DependencyPropertyMetadata(null, MetaButton.HandleIconDefinitionChanged)
            );
        public static readonly DependencyProperty PreferredIconSizeProperty =
            DependencyProperty.Register(
                "PreferredIconSize",
                typeof(Drawing.Size),
                typeof(MetaButton),
