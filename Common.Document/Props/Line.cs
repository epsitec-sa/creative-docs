...
namespace Epsitec.Common.Document.Properties
{
    ...
    public class Line : Abstract, Support.IXMLSerializable<Line>
    {
            ...
            get
            {
                if (this.dash)
                {
                    ...
                    if (
                        ...
                        return StandardDashType.LineDense;
                    ...
                    if (
                        ...
                        return StandardDashType.LineExpand;
                    ...
                    if (
                        ...
                        return StandardDashType.Dot;

                    if (
                        this.dashPen[0] == this.dashGap[0] / 2.0
                        && this.dashPen[1] == 0.0
                        && this.dashGap[1] == this.dashGap[0]
                        && this.dashPen[2] == 0.0
                        && this.dashGap[2] == 0.0
                    )
                        return StandardDashType.LineDot;
                    ...
                    if (
                        ...
                        && this.dashGap[1] == this.dashGap[0]
                        && this.dashPen[2] == 0.0
                        && this.dashGap[2] == this.dashGap[0]
                    )
                        return StandardDashType.LineDotDot;
        ...
        public static string GetName(StandardDashType type)
        {
            ...
            {
                case StandardDashType.Full:
                    name = Res.Strings.Property.Line.Full;
                    break;
                case StandardDashType.Line:
                    name = Res.Strings.Property.Line.Lines;
                    break;
                case StandardDashType.LineDense:
                    name = Res.Strings.Property.Line.LineDense;
                    break;
                case StandardDashType.LineExpand:
                    name = Res.Strings.Property.Line.LineExpand;
                    break;
                case StandardDashType.Dot:
                    name = Res.Strings.Property.Line.Dot;
                    break;
                case StandardDashType.LineDot:
                    name = Res.Strings.Property.Line.LineDot;
                    break;
                case StandardDashType.LineDotDot:
                    name = Res.Strings.Property.Line.LineDotDot;
                    break;
                case StandardDashType.Custom:
                    name = Res.Strings.Property.Line.Custom;
                    break;
            }
            return name;
        }
        ...
        public static string GetIconText(StandardDashType type)
        {
            ...
            switch (type)
            {
                ...
                case StandardDashType.Line:
                    return "LineLine";
                case StandardDashType.LineDense:
                    return "LineLineDense";
                case StandardDashType.LineExpand:
                    return "LineLineExpand";
                case StandardDashType.Dot:
                    return "LineDot";
                case StandardDashType.LineDot:
                    return "LineLineDot";
                case StandardDashType.LineDotDot:
                    return "LineLineDotDot";
                case StandardDashType.Custom:
                    return "LineCustom";
            }
            return "";
        ...
        public static string GetName(CapStyle type)
        {
            ...
            {
                case CapStyle.Round:
                    name = Res.Strings.Property.Line.CapRound;
                    break;
                case CapStyle.Square:
                    name = Res.Strings.Property.Line.CapSquare;
                    break;
                case CapStyle.Butt:
                    name = Res.Strings.Property.Line.CapButt;
                    break;
            }
            return name;
        }
        ...
        public static string GetName(JoinStyle type)
        {
            ...
            switch (type)
            {
                case JoinStyle.Round:
                    name = Res.Strings.Property.Line.JoinRound;
                    break;
                case JoinStyle.Miter:
                    name = Res.Strings.Property.Line.JoinMiter;
                    break;
                case JoinStyle.Bevel:
                    name = Res.Strings.Property.Line.JoinBevel;
                    break;
            }
            return name;
        }
        ...
        public override string SampleText
        {
            ...
            get
            {
                return string.Concat(
                    Res.Strings.Property.Line.Short.Witdh,
                    this.document.Modifier.RealToString(this.width)
                );
            }
        }
        ...
        public override bool Compare(Abstract property)
        {
            ...
            for (int i = 0; i < Line.DashMax; i++)
            {
                if (p.dashPen[i] != this.dashPen[i])
                    return false;
                if (p.dashGap[i] != this.dashGap[i])
                    return false;
            }
