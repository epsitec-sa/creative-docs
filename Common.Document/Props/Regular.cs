...
namespace Epsitec.Common.Document.Properties
{
    ...
    public class Regular : Abstract, Support.IXMLSerializable<Regular>
    {
        ...
        public override string SampleText
        {
            ...
            get
            {
                ...
                return string.Concat(
                    Res.Strings.Property.Regular.Short.Faces,
                    this.nbFaces.ToString(),
                    star
                );
            }
        }
        ...
        public static string GetName(RegularType type)
        {
            ...
            switch (type)
            {
                case RegularType.Star:
                    return Res.Strings.Property.Regular.Star;
                case RegularType.Flower1:
                    return Res.Strings.Property.Regular.Flower1;
                case RegularType.Flower2:
                    return Res.Strings.Property.Regular.Flower2;
                default:
                    return Res.Strings.Property.Regular.Norm;
            }
        }
        ...
        public static string GetIconText(RegularType type)
        {
            ...
            switch (type)
            {
                case RegularType.Star:
                    return "RegularStar";
                case RegularType.Flower1:
                    return "RegularFlower1";
                case RegularType.Flower2:
                    return "RegularFlower2";
                default:
                    return "RegularNorm";
            }
        }
        ...
        public override bool Compare(Abstract property)
        {
            ...
            Regular p = property as Regular;
            if (p.regularType != this.regularType)
                return false;
            if (p.nbFaces != this.nbFaces)
                return false;
            if (p.deep != this.deep)
                return false;
            if (p.e1 != this.e1)
