...
namespace Epsitec.Common.Document
{
    ...
    public class DrawingContext
    {
        ...
        public bool IsZoomPage
        {
            ...
            get
            {
                if (System.Math.Abs(this.zoom - this.ZoomPage) > 0.00001)
                    return false;
                ...
                return (
                    System.Math.Abs(this.originX + originX) < 0.00001
                    && System.Math.Abs(this.originY + originY) < 0.00001
                );
            }
        }
        ...
        public bool IsZoomPageWidth
        {
            ...
            get
            {
                if (System.Math.Abs(this.zoom - this.ZoomPageWidth) > 0.00001)
                    return false;
        ...
        public void ZoomPageAndCenter()
        {
            ...
            this.ZoomAndCenter(
                this.ZoomPage,
                this.PageSize.Width / 2,
                this.PageSize.Height / 2,
                false
            );
        }
        ...
        public double FitScale
        {
            ...
            get { return this.fitScale; }
            set { this.fitScale = value; }
        }
        #endregion
        ...
        public Point Scale
        {
            ...
            get { return this.ScaleForZoom(this.zoom); }
        }
        ...
        {
            get { return this.fillEmptyPlaceholders; }
            set
            {
        ...
        public bool VisibleHandles
        {
            ...
            get { return this.visibleHandles; }
            set { this.visibleHandles = value; }
        }
        ...
        public bool IsBitmap
        {
            ...
            get { return this.isBitmap; }
            set { this.isBitmap = value; }
        }
        ...
        public double HandleSize
        {
            ...
            get { return DrawingContext.handleSize / this.ScaleX; }
        }

        public double HandleRedrawSize
        {
            //	Taille de la zone à redessiner d'une poignée.
            get { return (DrawingContext.handleSize + 1.0) / this.ScaleX; }
        }
        ...
        public double SelectMarginSize
        {
            ...
            get
            {
                return System.Math.Max(DrawingContext.handleSize + 4, this.hiliteSize)
                    / this.ScaleX
                    / 2;
            }
        }
        ...
        public bool MagnetSnapPos(ref Point pos)
        {
            ...
            if (this.magnetLineBegin.IsUsed && this.magnetLineBegin.Infinite)
                piston = this.magnetLineBegin;
            if (this.magnetLineEnd.IsUsed && this.magnetLineEnd.Infinite)
                piston = this.magnetLineEnd;
            if (this.magnetLineMiddle.IsUsed && this.magnetLineMiddle.Infinite)
                piston = this.magnetLineMiddle;
            if (this.magnetLinePerp.IsUsed && this.magnetLinePerp.Infinite)
                piston = this.magnetLinePerp;
            if (piston != null)
            {
            ...
            if (!perp)
            {
                ...
                if (!perp && this.magnetLineBegin.Detect(pos, margin))
                {
                    ...
                    if (first == null)
                        first = this.magnetLineBegin;
                    else
                        second = this.magnetLineBegin;
                }
                ...
                if (!perp && this.magnetLineEnd.Detect(pos, margin))
                {
                    ...
                    if (first == null)
                        first = this.magnetLineEnd;
                    else
                        second = this.magnetLineEnd;
                }
                ...
                if (!perp && this.magnetLineMiddle.Detect(pos, margin))
                {
                    ...
                    if (first == null)
                        first = this.magnetLineMiddle;
                    else
                        second = this.magnetLineMiddle;
                }
                ...
                if (!perp && this.magnetLinePerp.Detect(pos, margin))
                {
                    ...
                    if (first == null)
                        first = this.magnetLinePerp;
                    else
                        second = this.magnetLinePerp;
                }
            }
            ...
            if (first == null)
            {
                Point p1,
                    p2;
                if (
                    this.document.Modifier.MagnetLayerDetect(
                        pos,
                        new Point(0, 0),
                        new Point(0, 0),
                        out p1,
            ...
            else
            {
                if (first.IsMain && second == null)
                {
                    ...
                    if (
                        this.document.Modifier.MagnetLayerDetect(
                            pos,
                            this.magnetLineMain.P1,
                            this.magnetLineMain.P2,
                            out p1,
                            out p2
                        )
                    )
        ...
        public void ConstrainAddHV(Point pos, bool isVisible, int handleRank)
        {
            ...
            if (this.ConstrainAngle == ConstrainAngle.Quarter)
            {
                ...
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 45.0 * 1, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 45.0 * 3, r),
                    isVisible,
                    handleRank
                );
            }
            ...
            if (this.ConstrainAngle == ConstrainAngle.Sixth)
            {
                ...
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 30.0 * 1, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 30.0 * 2, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 30.0 * 4, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 30.0 * 5, r),
                    isVisible,
                    handleRank
                );
            }
            ...
            if (this.ConstrainAngle == ConstrainAngle.Eight)
            {
                ...
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 1, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 2, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 3, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 5, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 6, r),
                    isVisible,
                    handleRank
                );
                this.ConstrainAddLine(
                    pos,
                    Transform.RotatePointDeg(pos, 22.5 * 7, r),
                    isVisible,
                    handleRank
                );
            }
        ...
        public void SnapPos(ref Point pos)
        {
            ...
            if (this.ConstrainSnapPos(ref pos))
                return;
        ...
        public static Color ColorSelectEdit(bool active)
        {
        ...
        public static Color ColorTabZombie
        {
                ...
                if (newLayer != curLayer)
                {
                    ...
                    else
                    {
                        this.document.Modifier.OpletQueueBeginAction(
                            Res.Strings.Action.LayerChange
                        );
