...
namespace Epsitec.Common.Document
{
    ...
    public class TextFlow : ISerializable, IXMLSerializable<TextFlow>
    {
        ...
        protected void InitializeNavigator()
        {
            ...
            this.textStory.RenamingOplet += new Text.TextStory.RenamingCallback(
                this.HandleTextStoryRenamingOplet
            );
        ...
        public void MergeWith(TextFlow src)
        {
            ...
            if (src.textStory.TextContext == this.textStory.TextContext)
            {
                ...
                if (text.Length == 0)
                {
                    ...
                    this.textNavigator.SetMetaProperties(
                        Epsitec.Common.Text.Properties.ApplyMode.Set,
                        srcStyles
                    );
                }
                else
        ...
        public int Count
        {
            ...
            get { return this.objectsChain.Count; }
        }
        ...
        public bool HasActiveTextBox
        {
            ...
            get { return this.activeTextBox != null; }
        }
        ...
        public void UpdateClipboardCommands()
        {
            ...
            if (this.document.CommandDispatcher == null)
                return;
        ...
        private void ChangeObjectEdited()
        {
            ...
            if (this.HasActiveTextBox && this.textNavigator.GetCursorGeometry(out frame))
            {
        ...
        private void HandleTextStoryRenamingOplet(string name, ref string output)
        {
            ...
            if (name.IndexOf("TextDelete") >= 0)
            {
                ...
                this.textStory.GetOpletsText(
                    this.textStory.OpletQueue.LastActionOplets,
                    out insert,
                    out delete
                );
        ...
        public bool HasEquivalentData(IXMLWritable other)
        {
            ...
            bool equiv = otherTextFlow.objectsChain.HasEquivalentData(this.objectsChain);
            return equiv;
        }
        ...
        public XElement ToXMLReference()
        {
            return new XElement("TextFlowRef", new XAttribute("id", this.id));
        }
        ...
        private TextFlow(XElement xml)
        {
            ...
            this.objectsChain = NewUndoableList.FromXML(
                xml.Element("ObjectsChain"),
                this.LoadFromReference
            );
        }
        ...
        private TextFlow LoadFromReference(System.Type objectType, int objectId)
        {
            var myType = this.GetType();
            if (objectType != myType || objectId != this.id)
            {
            ...
            : this()
        {
            ...
            this.oldobjectsChain = (UndoableList)
                info.GetValue("ObjectsChain", typeof(UndoableList));
        ...
        {
            this.objectsChain = NewUndoableList.FromOld(this.oldobjectsChain);
        }
        #endregion
        ...
        protected UndoableList oldobjectsChain;
