...
namespace Epsitec.Common.Document.Ribbons
{
    ...
    public abstract class Abstract : RibbonSection
    {
        ...
        protected void AddIconButtonCombo(
            IconButtonCombo combo,
            string name,
            string icon,
            string text
        )
        ...
        protected void AddIconButtonComboDyn(
            IconButtonCombo combo,
            string name,
            string briefIcon,
            string menuIcon,
        ...
        protected void BriefIconButtonComboDyn(
            IconButtonCombo combo,
            string briefIcon,
            string parameter
        )
        ...
        protected void AddIconButtonsComboDyn(
            IconButtonsCombo combo,
            string name,
            string briefIcon,
            string menuIcon,
            string parameter,
        ...
        )
        {
            ...
            string selectedText = Misc.ImageDyn(menuIcon, parameter);
            briefIcon = Misc.IconDyn(briefIcon, parameter);
            IconButtonsCombo.Item item = new IconButtonsCombo.Item(
                name,
                briefIcon,
                regularText,
                selectedText,
        ...
        protected GlyphButton CreateMenuButton(
            string command,
            string tooltip,
