...
namespace Epsitec.Common.Document.Containers
{
    ...
    {
        public Operations(Document document)
            : base(document)
        {
            this.tabIndex = 0;
            ...
            this.CreateFieldMove(
                this.toolBarMove,
                ref this.fieldMoveH,
                Res.Strings.Action.MoveValueX
            );
            this.CreateButton(
                this.toolBarMove,
                ref this.buttonMoveHi,
                "MoveHi",
                Res.Strings.Action.MoveLeft,
                this.HandleButtonMoveHi
            );
            this.CreateButton(
                this.toolBarMove,
                ref this.buttonMoveH,
                "MoveH",
                Res.Strings.Action.MoveRight,
                this.HandleButtonMoveH
            );
            this.CreateSeparator(this.toolBarMove);
            this.CreateFieldMove(
                this.toolBarMove,
                ref this.fieldMoveV,
                Res.Strings.Action.MoveValueY
            );
            this.CreateButton(
                this.toolBarMove,
                ref this.buttonMoveVi,
                "MoveVi",
                Res.Strings.Action.MoveDown,
                this.HandleButtonMoveVi
            );
            this.CreateButton(
                this.toolBarMove,
                ref this.buttonMoveV,
                "MoveV",
                Res.Strings.Action.MoveUp,
                this.HandleButtonMoveV
            );
            ...
            this.CreateButton(
                this.toolBarRot,
                ref this.buttonRotate90,
                "Rotate90",
                Res.Strings.Action.Rotate90,
                this.HandleButtonRotate90
            );
            this.CreateButton(
                this.toolBarRot,
                ref this.buttonRotate180,
                "Rotate180",
                Res.Strings.Action.Rotate180,
                this.HandleButtonRotate180
            );
            this.CreateButton(
                this.toolBarRot,
                ref this.buttonRotate270,
                "Rotate270",
                Res.Strings.Action.Rotate270,
                this.HandleButtonRotate270
            );
            this.CreateSeparator(this.toolBarRot);
            this.CreateFieldRot(
                this.toolBarRot,
                ref this.fieldRotate,
                Res.Strings.Action.RotateValue
            );
            this.CreateButton(
                this.toolBarRot,
                ref this.buttonRotate,
                "RotateFreeCCW",
                Res.Strings.Action.RotateFreeCCW,
                this.HandleButtonRotate
            );
            this.CreateButton(
                this.toolBarRot,
                ref this.buttonRotatei,
                "RotateFreeCW",
                Res.Strings.Action.RotateFreeCW,
                this.HandleButtonRotatei
            );

            //	Miroir.
            this.CreateHeader(
                ref this.boxMirror,
                ref this.toolBarMirror,
                Res.Strings.Action.MirrorMain
            );
            this.CreateButton(
                this.toolBarMirror,
                ref this.buttonMirrorH,
                "MirrorH",
                Res.Strings.Action.MirrorH,
                this.HandleButtonMirrorH
            );
            this.CreateButton(
                this.toolBarMirror,
                ref this.buttonMirrorV,
                "MirrorV",
                Res.Strings.Action.MirrorV,
                this.HandleButtonMirrorV
            );

            //	Echelle.
            this.CreateHeader(
                ref this.boxScale,
                ref this.toolBarScale,
                Res.Strings.Action.ScaleMain
            );
            this.CreateButton(
                this.toolBarScale,
                ref this.buttonScaleDiv2,
                "ScaleDiv2",
                Res.Strings.Action.ScaleDiv2,
                this.HandleButtonScaleDiv2
            );
            this.CreateButton(
                this.toolBarScale,
                ref this.buttonScaleMul2,
                "ScaleMul2",
                Res.Strings.Action.ScaleMul2,
                this.HandleButtonScaleMul2
            );
            this.CreateSeparator(this.toolBarScale);
            this.CreateFieldScale(
                this.toolBarScale,
                ref this.fieldScale,
                Res.Strings.Action.ScaleValue
            );
            this.CreateButton(
                this.toolBarScale,
                ref this.buttonScaleDivFree,
                "ScaleDivFree",
                Res.Strings.Action.ScaleDivFree,
                this.HandleButtonScaleDivFree
            );
            this.CreateButton(
                this.toolBarScale,
                ref this.buttonScaleMulFree,
                "ScaleMulFree",
                Res.Strings.Action.ScaleMulFree,
                this.HandleButtonScaleMulFree
            );
            ...
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignGrid,
                "AlignGrid",
                Res.Strings.Action.AlignGrid,
                this.HandleButtonAlignGrid
            );
            this.CreateSeparator(this.toolBarAlign);
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignLeft,
                "AlignLeft",
                Res.Strings.Action.AlignLeft,
                this.HandleButtonAlignLeft
            );
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignCenterX,
                "AlignCenterX",
                Res.Strings.Action.AlignCenterX,
                this.HandleButtonAlignCenterX
            );
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignRight,
                "AlignRight",
                Res.Strings.Action.AlignRight,
                this.HandleButtonAlignRight
            );
            this.CreateSeparator(this.toolBarAlign);
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignTop,
                "AlignTop",
                Res.Strings.Action.AlignTop,
                this.HandleButtonAlignTop
            );
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignCenterY,
                "AlignCenterY",
                Res.Strings.Action.AlignCenterY,
                this.HandleButtonAlignCenterY
            );
            this.CreateButton(
                this.toolBarAlign,
                ref this.buttonAlignBottom,
                "AlignBottom",
                Res.Strings.Action.AlignBottom,
                this.HandleButtonAlignBottom
            );
            ...
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareSpaceX,
                "ShareSpaceX",
                Res.Strings.Action.ShareSpaceX,
                this.HandleButtonShareSpaceX
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareLeft,
                "ShareLeft",
                Res.Strings.Action.ShareLeft,
                this.HandleButtonShareLeft
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareCenterX,
                "ShareCenterX",
                Res.Strings.Action.ShareCenterX,
                this.HandleButtonShareCenterX
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareRight,
                "ShareRight",
                Res.Strings.Action.ShareRight,
                this.HandleButtonShareRight
            );
            this.CreateSeparator(this.toolBarShare);
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareSpaceY,
                "ShareSpaceY",
                Res.Strings.Action.ShareSpaceY,
                this.HandleButtonShareSpaceY
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareTop,
                "ShareTop",
                Res.Strings.Action.ShareTop,
                this.HandleButtonShareTop
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareCenterY,
                "ShareCenterY",
                Res.Strings.Action.ShareCenterY,
                this.HandleButtonShareCenterY
            );
            this.CreateButton(
                this.toolBarShare,
                ref this.buttonShareBottom,
                "ShareBottom",
                Res.Strings.Action.ShareBottom,
                this.HandleButtonShareBottom
            );

            //	Ajustements.
            this.CreateHeader(
                ref this.boxAdjust,
                ref this.toolBarAdjust,
                Res.Strings.Action.Adjust
            );
            this.CreateButton(
                this.toolBarAdjust,
                ref this.buttonAdjustWidth,
                "AdjustWidth",
                Res.Strings.Action.AdjustWidth,
                this.HandleButtonAdjustWidth
            );
            this.CreateButton(
                this.toolBarAdjust,
                ref this.buttonAdjustHeight,
                "AdjustHeight",
                Res.Strings.Action.AdjustHeight,
                this.HandleButtonAdjustHeight
            );
            ...
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorToRgb,
                "ColorToRgb",
                Res.Strings.Action.ColorToRgb,
                this.HandleButtonColorToRgb
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorToCmyk,
                "ColorToCmyk",
                Res.Strings.Action.ColorToCmyk,
                this.HandleButtonColorToCmyk
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorToGray,
                "ColorToGray",
                Res.Strings.Action.ColorToGray,
                this.HandleButtonColorToGray
            );
            this.CreateSeparator(this.toolBarColor);
            this.CreateFieldColor(
                this.toolBarColor,
                ref this.fieldColor,
                Res.Strings.Action.ColorValue
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorStrokeDark,
                "ColorStrokeDark",
                Res.Strings.Action.ColorStrokeDark,
                this.HandleButtonColorStrokeDark
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorStrokeLight,
                "ColorStrokeLight",
                Res.Strings.Action.ColorStrokeLight,
                this.HandleButtonColorStrokeLight
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorFillDark,
                "ColorFillDark",
                Res.Strings.Action.ColorFillDark,
                this.HandleButtonColorFillDark
            );
            this.CreateButton(
                this.toolBarColor,
                ref this.buttonColorFillLight,
                "ColorFillLight",
                Res.Strings.Action.ColorFillLight,
                this.HandleButtonColorFillLight
            );
        }
        ...
        protected void CreateButton(
            HToolBar bar,
            ref IconButton button,
            string icon,
            string tooltip,
            Support.EventHandler<MessageEventArgs> handler
        )
        {
            //	Crée un IconButton.
