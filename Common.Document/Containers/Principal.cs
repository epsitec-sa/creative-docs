...
namespace Epsitec.Common.Document.Containers
{
    ...
    {
        public Principal(Document document)
            : base(document)
        {
            ...
            this.detailButton.TabNavigationMode =
                TabNavigationMode.ActivateOnTab
                | TabNavigationMode.ForwardToChildren
                | TabNavigationMode.ForwardOnly;
            ...
            this.colorSelector.TabNavigationMode =
                TabNavigationMode.ActivateOnTab
                | TabNavigationMode.ForwardToChildren
                | TabNavigationMode.ForwardOnly;
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                this.selectorName.ComboOpening -= new EventHandler<CancelEventArgs>(
                    this.HandleSelectorNameComboOpening
                );
        ...
        public HToolBar SelectorToolBar
        {
            ...
            get { return this.selectorToolBar; }
        }
        ...
        protected void CreateSelectorToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.selectorAuto,
                Res.Strings.Container.Principal.Button.Auto
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorIndividual,
                Res.Strings.Container.Principal.Button.Individual
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorScaler,
                Res.Strings.Container.Principal.Button.Scaler
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorStretch,
                Res.Strings.Container.Principal.Button.Stretch
            );
            ...
            ToolTip.Default.SetToolTip(
                selectorStretchType,
                Res.Strings.Container.Principal.Button.StretchType
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorTotal,
                Res.Strings.Container.Principal.Button.Total
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorPartial,
                Res.Strings.Container.Principal.Button.Partial
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorAdaptLine,
                Res.Strings.Container.Principal.Button.AdaptLine
            );
        ...
        protected void CreateAggregateToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.aggregateCombo,
                Res.Strings.Container.Principal.Button.AggregateCombo
            );
        ...
        protected void CreateTextToolBar()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.textFrequently,
                Res.Strings.TextPanel.Filter.Tooltip.Frequently
            );
            ...
            ToolTip.Default.SetToolTip(
                this.textParagraph,
                Res.Strings.TextPanel.Filter.Tooltip.Paragraph
            );
            ...
            ToolTip.Default.SetToolTip(
                this.textCharacter,
                Res.Strings.TextPanel.Filter.Tooltip.Character
            );
        ...
        protected void UpdateText()
        {
            ...
            this.textUsual.ActiveState =
                (this.textFilter == "Usual") ? ActiveState.Yes : ActiveState.No;
            this.textFrequently.ActiveState =
                (this.textFilter == "Frequently") ? ActiveState.Yes : ActiveState.No;
            this.textAll.ActiveState =
                (this.textFilter == "All") ? ActiveState.Yes : ActiveState.No;
            this.textParagraph.ActiveState =
                (this.textFilter == "Paragraph") ? ActiveState.Yes : ActiveState.No;
            this.textCharacter.ActiveState =
                (this.textFilter == "Character") ? ActiveState.Yes : ActiveState.No;
        }
        ...
        protected void CreateSelectorPanel()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.selectorName,
                Res.Strings.Container.Principal.Button.SelName
            );
            ...
            ToolTip.Default.SetToolTip(
                this.selectorGo,
                Res.Strings.Container.Principal.Button.SelGoHelp
            );
        ...
        {
            get { return this.showOnlyPanels; }
            set
            {
            ...
            foreach (Widget widget in this.scrollable.Viewport.Children.Widgets)
            {
                if (widget is Panels.Abstract)
                {
                    ...
                    if (this.document.Modifier.PropertiesDetailMany)
                    {
                        ...
                        panel.IsHilite = Abstract.IsObjectUseByProperty(
                            panel.Property,
                            hiliteObject
                        );
                    }
        ...
        protected override void DoUpdateContent()
        {
            ...
            this.helpText.Visibility =
                this.document.GlobalSettings.LabelProperties && !this.showOnlyPanels;
            ...
            if (this.document.Modifier.ActiveViewer.IsCreating)
            {
                ...
                for (int i = 0; i < 100; i++)
                {
                    string cmd,
                        name,
                        text;
                    if (!creatingObject.CreateAction(i, out cmd, out name, out text))
                        break;
                ...
                if (editObject != null)
                {
                    ...
                    if (list != null)
                    {
                        ...
                        foreach (TextPanels.Abstract panel in list)
                        {
                            ...
                            panel.TabNavigationMode =
                                TabNavigationMode.ActivateOnTab
                                | TabNavigationMode.ForwardToChildren
                                | TabNavigationMode.ForwardOnly;
                            panel.Dock = DockStyle.Top;
                            panel.Margins = new Margins(0, 1, tm, -1);
                            panel.IsExtendedSize = this.document.Modifier.IsTextPanelExtended(
                                panel
                            );
                            panel.OriginColorChanged += this.HandleOriginColorChanged;
            ...
            else
            {
                ...
                {
                    this.detailButton.ActiveState = this.document.Modifier.PropertiesDetail
                        ? ActiveState.Yes
                        : ActiveState.No;
                ...
                foreach (Properties.Abstract property in list)
                {
                    ...
                    panel.IsExtendedSize = this.document.Modifier.IsPropertiesExtended(
                        property.Type
                    );
        ...
        public VMenu CreateStretchTypeMenu(Support.EventHandler<MessageEventArgs> message)
        {
            ...
            this.CreateStretchTypeMenu(
                menu,
                message,
                SelectorTypeStretch.Free,
                Res.Strings.Container.Principal.Menu.Stretch.Free
            );
            menu.Items.Add(new MenuSeparator());
            this.CreateStretchTypeMenu(
                menu,
                message,
                SelectorTypeStretch.TrapezeH,
                Res.Strings.Container.Principal.Menu.Stretch.TrapezeH
            );
            this.CreateStretchTypeMenu(
                menu,
                message,
                SelectorTypeStretch.TrapezeV,
                Res.Strings.Container.Principal.Menu.Stretch.TrapezeV
            );
            menu.Items.Add(new MenuSeparator());
            this.CreateStretchTypeMenu(
                menu,
                message,
                SelectorTypeStretch.ParallelH,
                Res.Strings.Container.Principal.Menu.Stretch.ParallelH
            );
            this.CreateStretchTypeMenu(
                menu,
                message,
                SelectorTypeStretch.ParallelV,
                Res.Strings.Container.Principal.Menu.Stretch.ParallelV
            );
        ...
        protected void CreateStretchTypeMenu(
            VMenu menu,
            Support.EventHandler<MessageEventArgs> message,
            SelectorTypeStretch type,
            string text
        )
        {
        ...
        protected static string GetSelectorTypeStretchIcon(SelectorTypeStretch type)
        {
            ...
            if (type == SelectorTypeStretch.Free)
                return Misc.Icon("SelectorStretch");
            if (type == SelectorTypeStretch.ParallelH)
                return Misc.Icon("SelectorStretchParallelH");
            if (type == SelectorTypeStretch.ParallelV)
                return Misc.Icon("SelectorStretchParallelV");
            if (type == SelectorTypeStretch.TrapezeH)
                return Misc.Icon("SelectorStretchTrapezeH");
            if (type == SelectorTypeStretch.TrapezeV)
                return Misc.Icon("SelectorStretchTrapezeV");
            return "";
        }
        #endregion
