...
namespace Epsitec.Common.Document.Containers
{
    ...
    {
        public Guides(Document document)
            : base(document)
        {
            ...
            foreach (int value in System.Enum.GetValues(typeof(Settings.GuideType)))
            {
                ...
                if (type == Settings.GuideType.None)
                    continue;
        ...
        {
            //	Repère sélectionné.
            get { return this.document.Settings.GuidesSelected; }
            set
            {
        ...
        protected void UpdateTable()
        {
            ...
            this.radioGlobal.ActiveState = this.document.Settings.GlobalGuides
                ? ActiveState.Yes
                : ActiveState.No;
            this.radioPage.ActiveState = !this.document.Settings.GlobalGuides
                ? ActiveState.Yes
                : ActiveState.No;
        ...
        protected void TableFillRow(int row)
        {
            ...
            for (int column = 0; column < this.table.Columns; column++)
            {
                if (this.table[column, row].IsEmpty)
                {
                    ...
                    st.ContentAlignment =
                        (column == 0) ? ContentAlignment.MiddleLeft : ContentAlignment.MiddleRight;
        ...
        protected void CreateGuide(Settings.GuideType type)
        {
            ...
            string action =
                (type == Settings.GuideType.HorizontalBottom)
                    ? Res.Strings.Action.GuideNewH
                    : Res.Strings.Action.GuideNewV;
        ...
        private void HandleButtonDown(object sender, MessageEventArgs e)
        {
            ...
            int sel = this.document.Settings.GuidesSelected;
            if (sel > this.document.Settings.GuidesCount - 2)
                return;
        ...
        private void HandleEditTypeChanged(object sender)
        {
            ...
            this.document.Modifier.OpletQueueBeginAction(
                Res.Strings.Action.GuideChangeType,
                "ChangeGuide",
                sel
            );
        ...
        private void HandleEditPositionChanged(object sender)
        {
            ...
            this.ignoreChanged = true;
            this.document.Modifier.OpletQueueBeginAction(
                Res.Strings.Action.GuideChangePosition,
                "ChangeGuide",
                sel
            );
