...
namespace Epsitec.Common.Document.Containers
{
    ...
    public class Pages : Abstract
    {
            ...
            : base(document)
        {
            ...
            this.panelMisc.PreferredHeight =
                (this.document.Type == DocumentType.Pictogram) ? 186 + 24 + 24 : 186;
            ...
            this.pageSizeWidth.FactorMaxRange =
                (this.document.Type == DocumentType.Pictogram) ? 1.28M : 1.0M;
            ...
            this.pageSizeHeight.FactorMaxRange =
                (this.document.Type == DocumentType.Pictogram) ? 1.28M : 1.0M;
            ...
            ToolTip.Default.SetToolTip(
                this.pageSizeHeight,
                Res.Strings.Container.Pages.Size.Height
            );
            ...
            this.specificMasterPage.ComboOpening += new EventHandler<CancelEventArgs>(
                this.HandleComboOpening
            );
            ...
            this.specificSlavePage.ComboOpening += new EventHandler<CancelEventArgs>(
                this.HandleComboOpening
            );
        ...
        protected void TableFillRow(int row)
        {
            ...
            for (int column = 0; column < this.table.Columns; column++)
            {
                if (this.table[column, row].IsEmpty)
                {
                    StaticText st = new StaticText();
                    st.ContentAlignment =
                        (column == 0) ? ContentAlignment.MiddleCenter : ContentAlignment.MiddleLeft;
        ...
        protected void UpdatePanel()
        {
            ...
            if (this.pageSizeWidth != null)
            {
                ...
                this.pageSizeWidth.TextDisplayMode = widthDefined
            ...
            if (this.pageSizeHeight != null)
            {
                ...
                this.pageSizeHeight.TextDisplayMode = heightDefined
                    ? TextFieldDisplayMode.OverriddenValue
                    : TextFieldDisplayMode.InheritedValue;
            }
            ...
            this.radioSlave.ActiveState =
                (page.MasterType == Objects.MasterType.Slave) ? ActiveState.Yes : ActiveState.No;
            this.radioMaster.ActiveState =
                (page.MasterType != Objects.MasterType.Slave) ? ActiveState.Yes : ActiveState.No;
            ...
            this.radioAll.ActiveState =
                (page.MasterType == Objects.MasterType.All) ? ActiveState.Yes : ActiveState.No;
            this.radioEven.ActiveState =
                (page.MasterType == Objects.MasterType.Even) ? ActiveState.Yes : ActiveState.No;
            this.radioOdd.ActiveState =
                (page.MasterType == Objects.MasterType.Odd) ? ActiveState.Yes : ActiveState.No;
            this.radioNone.ActiveState =
                (page.MasterType == Objects.MasterType.None) ? ActiveState.Yes : ActiveState.No;

            this.radioNever.ActiveState =
                (page.MasterUse == Objects.MasterUse.Never) ? ActiveState.Yes : ActiveState.No;
            this.radioDefault.ActiveState =
                (page.MasterUse == Objects.MasterUse.Default) ? ActiveState.Yes : ActiveState.No;
            this.radioSpecific.ActiveState =
                (page.MasterUse == Objects.MasterUse.Specific) ? ActiveState.Yes : ActiveState.No;
        ...
        private void HandleLanguageChanged(object sender)
        {
            ...
            this.document.Modifier.OpletQueueBeginAction(
                Res.Strings.Container.Pages.Language.Label,
                "SpecialPageLanguage"
            );
        ...
        private void HandleStyleChanged(object sender)
        {
            ...
            this.document.Modifier.OpletQueueBeginAction(
                Res.Strings.Container.Pages.Style.Label,
                "SpecialPageStyle"
            );
        ...
        private void HandlePageWidthEditionAccepted(object sender)
        {
            ...
            this.document.Modifier.OpletQueueBeginAction(
                Res.Strings.Container.Pages.Size.Label,
                "SpecialPageSize"
            );
        ...
        private void HandleComboClosed(object sender)
        {
            ...
            for (int i = 0; i < total; i++)
            {
                ...
                {
                    this.document.Modifier.OpletQueueBeginAction(
                        Res.Strings.Action.PageChangeStatus
                    );
                    Objects.Page currentPage = context.RootObject(1) as Objects.Page;
