...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class TextFieldLabel : AbstractGroup
    {
        ...
        public TextFieldLabel(Widget embedder, Type type)
            : this(type)
        {
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                if (this.buttonUnit != null)
                    this.buttonUnit.Dispose();
                if (this.textFieldSimple != null)
                    this.textFieldSimple.Dispose();
                if (this.textFieldReal != null)
                    this.textFieldReal.Dispose();
                if (this.textFieldPercent != null)
                    this.textFieldPercent.Dispose();
        ...
        {
            get { return this.shortLongLabelLimit; }
            set
            {
        ...
        )
        {
            ...
            TextFieldReal field =
                (this.type == Type.TextFieldUnit) ? this.textFieldPercent : this.textFieldReal;
        ...
        public string LabelShortText
        {
            ...
            get { return this.labelShortText; }
            set { this.labelShortText = value; }
        }

        public string LabelLongText
        {
            //	Texte long du label.
            get { return this.labelLongText; }
            set { this.labelLongText = value; }
        }

        public bool LabelVisibility
        {
            //	Visibilité du label.
            get { return this.labelVisibility; }
            set { this.labelVisibility = value; }
        }
