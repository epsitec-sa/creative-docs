...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class FontSample : Widget
    {
        ...
        public FontSample(Widget embedder)
            : this()
        {
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            if (this.fontIdentity != null)
            {
                ...
                if (this.isSampleAbc)
                {
                    path = Common.Widgets.Helpers.FontPreviewer.GetPathAbc(
                        this.fontIdentity,
                        ox,
                        oy,
                        size
                ...
                {
                    path = Common.Widgets.Helpers.FontPreviewer.GetPath(
                        this.fontIdentity,
                        ox,
                        oy,
                        size
