...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class Sample : AbstractSample
    {
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            {
                Properties.Gradient fillColor =
                    this.aggregate.Property(Properties.Type.FillGradient, this.isDeep)
                    as Properties.Gradient;
                Properties.Gradient fillColorVT =
                    this.aggregate.Property(Properties.Type.FillGradientVT, this.isDeep)
                    as Properties.Gradient;
                Properties.Gradient fillColorVL =
                    this.aggregate.Property(Properties.Type.FillGradientVL, this.isDeep)
                    as Properties.Gradient;
                Properties.Gradient fillColorVR =
                    this.aggregate.Property(Properties.Type.FillGradientVR, this.isDeep)
                    as Properties.Gradient;
                Properties.Gradient lineColor =
                    this.aggregate.Property(Properties.Type.LineColor, this.isDeep)
                    as Properties.Gradient;
                Properties.Line lineMode =
                    this.aggregate.Property(Properties.Type.LineMode, this.isDeep)
                    as Properties.Line;
                Properties.Line lineDimension =
                    this.aggregate.Property(Properties.Type.LineDimension, this.isDeep)
                    as Properties.Line;
                Properties.Corner corner =
                    this.aggregate.Property(Properties.Type.Corner, this.isDeep)
                    as Properties.Corner;
                Properties.Arc arc =
                    this.aggregate.Property(Properties.Type.Arc, this.isDeep) as Properties.Arc;
                Properties.Arrow arrow =
                    this.aggregate.Property(Properties.Type.Arrow, this.isDeep) as Properties.Arrow;
                Properties.Arrow arrowDimension =
                    this.aggregate.Property(Properties.Type.DimensionArrow, this.isDeep)
                    as Properties.Arrow;
                Properties.Font font =
                    this.aggregate.Property(Properties.Type.TextFont, this.isDeep)
                    as Properties.Font;
                ...
                NewUndoableList styles = this.aggregate.Styles;
        ...
        protected void PaintArrow(Graphics graphics, Rectangle rect, Properties.Arrow arrow)
        {
            ...
            if (outlineStart)
                graphics.PaintOutline(pathStart);
            if (outlineEnd)
                graphics.PaintOutline(pathEnd);
            if (surfaceStart)
                graphics.PaintSurface(pathStart);
            if (surfaceEnd)
                graphics.PaintSurface(pathEnd);
