    ...
    public class Cropper : AbstractGroup
    {
        ...
        public Cropper()
        {
            ...
            ToolTip.Default.SetToolTip(
                this.buttonReset,
                Res.Strings.Panel.Image.Crop.Tooltip.Reset
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldCropTop,
                Res.Strings.Panel.Image.Crop.Tooltip.CropTop
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldCropLeft,
                Res.Strings.Panel.Image.Crop.Tooltip.CropLeft
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldCropRight,
                Res.Strings.Panel.Image.Crop.Tooltip.CropRight
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldCropBottom,
                Res.Strings.Panel.Image.Crop.Tooltip.CropBottom
            );
        ...
        protected bool IsSingleSelection
        {
            ...
            get { return (this.document.Modifier.TotalSelected == 1); }
        }
        ...
        protected bool IsFillEnabled
        {
            ...
            get
            {
                ...
                return System.Math.Abs(
                        rect.Width / rect.Height - objectSize.Width / objectSize.Height
                    ) > 0.0001;
            }
        }
        ...
        protected void MovePart(Point pos, bool isConstrain)
        {
            ...
            if (
                this.hilited == Part.Left
                || this.hilited == Part.BottomLeft
                || this.hilited == Part.TopLeft
            )
            {
                crop.Left = pos.X;
            }
            ...
            if (
                this.hilited == Part.Right
                || this.hilited == Part.BottomRight
                || this.hilited == Part.TopRight
            )
            {
                ...
                else
                {
                    ...
                    else
                    {
                        Rectangle left = new Rectangle(
                            bounds.Left,
                            bounds.Bottom,
                            crop.Left - bounds.Left,
                            bounds.Height
                        );
                        Rectangle right = new Rectangle(
                            crop.Right,
                            bounds.Bottom,
                            bounds.Right - crop.Right,
                            bounds.Height
                        );
                        ...
                        graphics.Rasterizer.AddOutline(
                            Misc.GetHatchPath(left, 4, bounds.BottomLeft)
                        );
                        graphics.Rasterizer.AddOutline(
                            Misc.GetHatchPath(right, 4, bounds.BottomLeft)
                        );
                        graphics.Rasterizer.AddOutline(
                            Misc.GetHatchPath(bottom, 4, bounds.BottomLeft)
                        );
                        graphics.Rasterizer.AddOutline(
                            Misc.GetHatchPath(top, 4, bounds.BottomLeft)
                        );
        ...
        protected static void InitTextFieldReal(TextFieldReal field)
        {
        ...
        {
            add { this.AddUserEventHandler("CropChanged", value); }
            remove { this.RemoveUserEventHandler("CropChanged", value); }
        }
