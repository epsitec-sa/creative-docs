...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public abstract class AbstractRuler : Widget, Common.Widgets.Helpers.IToolTipHost
    {
        ...
        protected AbstractRuler(Widget embedder, bool vertical)
            : this(vertical)
        {
