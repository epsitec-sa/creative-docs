...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class HRuler : AbstractRuler
    {
        ...
        static HRuler()
        {
            ...
            Common.Widgets.Visual.PreferredHeightProperty.OverrideMetadata(
                typeof(HRuler),
                metadataDy
            );
        }
        ...
        protected void PaintGrad(Graphics graphics, Rectangle clipRect)
        {
            ...
            double step =
                System.Math.Pow(10.0, System.Math.Ceiling(System.Math.Log(scale * space, 10.0)))
                * mul;
            ...
            while (grad < this.ending)
            {
                ...
                if (posx >= clipRect.Left - 1.0 && posx <= clipRect.Right + 1.0)
                {
        ...
        protected void PaintMarker(Graphics graphics)
        {
            ...
            if (this.marker < this.starting || this.marker > this.ending)
                return;
        ...
        protected void PaintMarginLeftFirst(Graphics graphics, bool hilite)
        {
            ...
            if (this.marginLeftFirst < this.starting || this.marginLeftFirst > this.ending)
                return;
        ...
        protected void PaintMarginLeftBody(Graphics graphics, bool hilite)
        {
            ...
            if (this.marginLeftBody < this.starting || this.marginLeftBody > this.ending)
                return;
        ...
        protected void PaintMarginRight(Graphics graphics, bool hilite)
        {
            ...
            if (this.marginRight < this.starting || this.marginRight > this.ending)
                return;
        ...
        protected void PaintTabs(Graphics graphics)
        {
            ...
            {
                if (pass == 2 && this.draggingTabDest == null)
                    continue;

                foreach (Tab tab in this.tabs)
                {
                    if (tab.Tag == this.draggingTabToDelete)
                        continue;
                    ...
                    {
                        colorBack = tab.Zombie
                            ? DrawingContext.ColorTabZombie
                            : this.ColorBackgroundEdited;
                    }
                    ...
                    else if (pass == 3)
                    {
                        ...
                        Common.Widgets.WidgetPaintState state = Common
                            .Widgets
                            .WidgetPaintState
                            .Enabled;
                        adorner.PaintGlyph(
                            ...
                            colorGlyph,
                            glyph,
                            Common.Widgets.PaintTextStyle.Button
                        );
                    }
                }
            }
        ...
        protected void PaintTabChoice(Graphics graphics)
        {
            ...
            adorner.PaintGlyph(
                graphics,
                rect,
                Common.Widgets.WidgetPaintState.Enabled,
                glyph,
                Common.Widgets.PaintTextStyle.Button
            );
        }
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            if (this.edited) // édition en cours ?
            {
                ...
                this.PaintMarginLeftFirst(
                    graphics,
                    this.HiliteHandle == "LeftFirst" || this.HiliteHandle == "FirstBody"
                );
                this.PaintMarginLeftBody(
                    graphics,
                    this.HiliteHandle == "LeftBody" || this.HiliteHandle == "FirstBody"
                );
        ...
        protected override string DraggingDetect(Point pos, string exclude)
        {
            ...
            if (this.DetectHandle("Right", pos))
                return "Right";
            if (this.DetectHandle("FirstBody", pos))
                return "FirstBody";
            if (this.DetectHandle("LeftBody", pos))
                return "LeftBody";
            if (this.DetectHandle("LeftFirst", pos))
                return "LeftFirst";
            ...
            for (int i = this.tabs.Length - 1; i >= 0; i--)
            {
                ...
                if (tab.Tag == exclude)
                    continue;
                if (tab.Shared)
                    continue; // tabulateur d'un style ?
        ...
        protected bool DetectHandle(string handle, Point pos)
        {
            ...
            if (handle == "LeftFirst" && pos.Y < this.Client.Bounds.Top - 4)
                return false;
            if (handle == "LeftBody" && pos.Y > this.Client.Bounds.Bottom + 8)
                return false;
            if (handle == "FirstBody" && pos.Y > this.Client.Bounds.Bottom + 4)
                return false;
        ...
        protected override void DraggingStart(ref string handle, Point pos)
        {
            ...
            this.GetMargins(
                out this.draggingInitialFirst,
                out this.draggingInitialBody,
                out this.draggingInitialRight
            );
        }
        ...
        protected double GetHandleHorizontalPos(string handle)
        {
            ...
            if (handle == "LeftFirst")
                return this.DocumentToScreen(this.marginLeftFirst);
            if (handle == "LeftBody")
                return this.DocumentToScreen(this.marginLeftBody);
            if (handle == "FirstBody")
                return this.DocumentToScreen(this.marginLeftBody);
            if (handle == "Right")
                return this.DocumentToScreen(this.marginRight);
        ...
        protected void SetHandleHorizontalPos(ref string handle, Point pos)
        {
            ...
            if (tab.Tag == null)
            {
                if (handle == "LeftFirst")
                {
                    ...
                    this.document.Wrappers.ParagraphWrapper.Defined.MarginUnits = Common
                        .Text
                        .Properties
                        .SizeUnits
                        .Points;
        ...
        protected static bool TabCompare(Tab[] list1, Tab[] list2)
        {
            ...
            {
                if (list1[i].Pos != list2[i].Pos)
                    return false;
                if (list1[i].Type != list2[i].Type)
                    return false;
                if (list1[i].Zombie != list2[i].Zombie)
                    return false;
                if (list1[i].Shared != list2[i].Shared)
                    return false;
            }
            return true;
        }
        ...
        protected override string GetTooltipEditedText(Point pos)
        {
            ...
            if (this.isDragging) // déplacement en cours ?
            {
                if (this.draggingTabDest == null)
                {
                    if (this.draggingHandle == "Right")
                    {
                        ...
                        string w = this.document.Modifier.RealToString(
                            x - this.draggingInitialBody
                        );
                        return string.Format(
                            Res.Strings.Action.Text.Ruler.HandleMoveRight,
                            vp,
                            vn,
                            w
                        );
                    ...
                    )
                    {
                        ...
                        string w = this.document.Modifier.RealToString(
                            width - this.draggingInitialRight - x
                        );
                    ...
                    else // tabulateur ?
                    {
                        ...
                        else
                        {
                            ...
                            string r = this.document.Modifier.RealToString(
                                x - this.draggingInitialBody
                            );
                            if (!r.StartsWith("-"))
                                r = string.Concat("+", r);
            ...
            if (handle == "LeftFirst")
                return Res.Strings.Action.Text.Ruler.HandleLeftFirst;
            if (handle == "LeftBody")
                return Res.Strings.Action.Text.Ruler.HandleLeftBody;
            if (handle == "FirstBody")
                return Res.Strings.Action.Text.Ruler.HandleFirstBody;
            if (handle == "Right")
                return Res.Strings.Action.Text.Ruler.HandleRight;
        ...
        protected static Common.Widgets.GlyphShape ConvType2Glyph(TextTabType type)
        {
            ...
            switch (type)
            {
                case Drawing.TextTabType.Left:
                    return Common.Widgets.GlyphShape.TabLeft;
                case Drawing.TextTabType.Right:
                    return Common.Widgets.GlyphShape.TabRight;
                case Drawing.TextTabType.Center:
                    return Common.Widgets.GlyphShape.TabCenter;
                case Drawing.TextTabType.Indent:
                    return Common.Widgets.GlyphShape.TabIndent;
                default:
                    return Common.Widgets.GlyphShape.TabDecimal;
            }
        }
        ...
        protected static string ConvType2String(TextTabType type)
        {
            ...
            {
                case Drawing.TextTabType.Left:
                    return Res.Strings.Action.Text.Ruler.TabLeft;
                case Drawing.TextTabType.Right:
                    return Res.Strings.Action.Text.Ruler.TabRight;
                case Drawing.TextTabType.Center:
                    return Res.Strings.Action.Text.Ruler.TabCenter;
                case Drawing.TextTabType.Indent:
                    return Res.Strings.Action.Text.Ruler.TabIndent;
            }
        ...
        public static string ConvType2Mark(TextTabType type)
        {
            ...
            switch (type)
            {
                case Drawing.TextTabType.DecimalDot:
                    return ".";
                case Drawing.TextTabType.DecimalComma:
                    return ",";
                case Drawing.TextTabType.DecimalColon:
                    return ":";
                case Drawing.TextTabType.DecimalSColon:
                    return ";";
                case Drawing.TextTabType.DecimalAdd:
                    return "+";
                case Drawing.TextTabType.DecimalSub:
                    return "-";
                case Drawing.TextTabType.DecimalMul:
                    return "*";
                case Drawing.TextTabType.DecimalDiv:
                    return "/";
                case Drawing.TextTabType.DecimalSpace:
                    return " ";
                case Drawing.TextTabType.DecimalAt:
                    return "@";
                case Drawing.TextTabType.DecimalP100:
                    return "%";
                case Drawing.TextTabType.DecimalEq:
                    return "=";
                case Drawing.TextTabType.DecimalLt:
                    return "<";
                case Drawing.TextTabType.DecimalGt:
                    return ">";
                case Drawing.TextTabType.DecimalAmp:
                    return "&";
                case Drawing.TextTabType.DecimalQuot:
                    return "\"";
                case Drawing.TextTabType.DecimalNumber:
                    return "#";
                case Drawing.TextTabType.DecimalApos:
                    return "'";
                case Drawing.TextTabType.DecimalVert:
                    return "|";
                case Drawing.TextTabType.DecimalTilde:
                    return "~";
                case Drawing.TextTabType.DecimalExclam:
                    return "!";
                case Drawing.TextTabType.DecimalQuestion:
                    return "?";
                case Drawing.TextTabType.DecimalOpPar:
                    return "(";
                case Drawing.TextTabType.DecimalClPar:
                    return ")";
                case Drawing.TextTabType.DecimalOpSBr:
                    return "[";
                case Drawing.TextTabType.DecimalClSBr:
                    return "]";
                case Drawing.TextTabType.DecimalOpCBr:
                    return "{";
                case Drawing.TextTabType.DecimalClCBr:
                    return "}";
                case Drawing.TextTabType.DecimalEuro:
                    return "€";
                case Drawing.TextTabType.DecimalDollar:
                    return "$";
                case Drawing.TextTabType.DecimalLivre:
                    return "£";
                case Drawing.TextTabType.DecimalCopy:
                    return "©";
                case Drawing.TextTabType.DecimalReg:
                    return "®";
                case Drawing.TextTabType.DecimalTM:
                    return "™";
            }
            return null;
        }
        ...
        public static TextTabType ConvMark2Type(string mark)
        {
            ...
            {
                case ".":
                    return Drawing.TextTabType.DecimalDot;
                case ",":
                    return Drawing.TextTabType.DecimalComma;
                case ":":
                    return Drawing.TextTabType.DecimalColon;
                case ";":
                    return Drawing.TextTabType.DecimalSColon;
                case "+":
                    return Drawing.TextTabType.DecimalAdd;
                case "-":
                    return Drawing.TextTabType.DecimalSub;
                case "*":
                    return Drawing.TextTabType.DecimalMul;
                case "/":
                    return Drawing.TextTabType.DecimalDiv;
                case " ":
                    return Drawing.TextTabType.DecimalSpace;
                case "@":
                    return Drawing.TextTabType.DecimalAt;
                case "%":
                    return Drawing.TextTabType.DecimalP100;
                case "=":
                    return Drawing.TextTabType.DecimalEq;
                case "<":
                    return Drawing.TextTabType.DecimalLt;
                case ">":
                    return Drawing.TextTabType.DecimalGt;
                case "&":
                    return Drawing.TextTabType.DecimalAmp;
                case "\"":
                    return Drawing.TextTabType.DecimalQuot;
                case "#":
                    return Drawing.TextTabType.DecimalNumber;
                case "'":
                    return Drawing.TextTabType.DecimalApos;
                case "|":
                    return Drawing.TextTabType.DecimalVert;
                case "~":
                    return Drawing.TextTabType.DecimalTilde;
                case "!":
                    return Drawing.TextTabType.DecimalExclam;
                case "?":
                    return Drawing.TextTabType.DecimalQuestion;
                case "(":
                    return Drawing.TextTabType.DecimalOpPar;
                case ")":
                    return Drawing.TextTabType.DecimalClPar;
                case "[":
                    return Drawing.TextTabType.DecimalOpSBr;
                case "]":
                    return Drawing.TextTabType.DecimalClSBr;
                case "{":
                    return Drawing.TextTabType.DecimalOpCBr;
                case "}":
                    return Drawing.TextTabType.DecimalClCBr;
                case "€":
                    return Drawing.TextTabType.DecimalEuro;
                case "$":
                    return Drawing.TextTabType.DecimalDollar;
                case "£":
                    return Drawing.TextTabType.DecimalLivre;
                case "©":
                    return Drawing.TextTabType.DecimalCopy;
                case "®":
                    return Drawing.TextTabType.DecimalReg;
                case "™":
                    return Drawing.TextTabType.DecimalTM;
            }
        ...
        public static string ConvType2Image(TextTabType type)
        {
            ...
            {
                case Drawing.TextTabType.Left:
                    return Misc.Image("TabLeft");
                case Drawing.TextTabType.Right:
                    return Misc.Image("TabRight");
                case Drawing.TextTabType.Center:
                    return Misc.Image("TabCenter");
                case Drawing.TextTabType.Indent:
                    return Misc.Image("TabIndent");
            }
        ...
        public static VMenu CreateMenu(
            ...
            Drawing.TextTabType currentType
        )
        {
            ...
            HRuler.CreateMenu(
                menu,
                menuMath,
                Res.Strings.Action.Text.Ruler.TabDecimalMath,
                currentType
            );
            HRuler.CreateMenu(
                menu,
                menuBus,
                Res.Strings.Action.Text.Ruler.TabDecimalBus,
                currentType
            );
            HRuler.CreateMenu(
                menu,
                menuSign,
                Res.Strings.Action.Text.Ruler.TabDecimalSign,
                currentType
            );
            HRuler.CreateMenu(
                menu,
                menuPar,
                Res.Strings.Action.Text.Ruler.TabDecimalPar,
                currentType
            );
