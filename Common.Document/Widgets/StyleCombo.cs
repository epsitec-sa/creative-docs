...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class StyleCombo : TextFieldCombo
    {
        ...
        public StyleCombo(Widget embedder)
            : this()
        {
        ...
        {
            get { return this.styleCategory; }
            set { this.styleCategory = value; }
        }

        public int ExcludeRank
        {
            //	Ligne éventuelle à exclure.
            get { return this.excludeRank; }
            set { this.excludeRank = value; }
        }
        ...
        public bool IsNoneLine
        {
            ...
            get { return this.isNoneLine; }
            set { this.isNoneLine = value; }
        }
        ...
        protected override AbstractMenu CreateMenu()
        {
            ...
            if (
                this.styleCategory == StyleCategory.Paragraph
                || this.styleCategory == StyleCategory.Character
            )
            {
        ...
        protected int GetSelectedStyle(NewUndoableList aggregates, string currentStyle)
        {
        ...
        public class StyleMenuHost : IMenuHost
        {
            ...
            )
            {
                ...
                Drawing.Point pos = Common.Widgets.Helpers.VisualTree.MapVisualToScreen(
                    item,
                    new Drawing.Point(0, 1)
                );
                Drawing.Point hot = Common.Widgets.Helpers.VisualTree.MapVisualToScreen(
                    item,
                    new Drawing.Point(0, 1)
                );
                ...
                if (h > maxHeight) // dépasse en bas ?
                {
                    ...
                    {
                        pos = Common.Widgets.Helpers.VisualTree.MapVisualToScreen(
                            item,
                            new Drawing.Point(0, item.ActualHeight - 1)
                        );
