...
namespace Epsitec.Common.Document.Widgets
{
    ...
    public class TextFieldUnit : TextField
    {
        ...
        public TextFieldUnit(Widget embedder)
            : this()
        {
        ...
        {
            get { return this.minValue / this.scale; }
            set { this.minValue = value * this.scale; }
        }

        public double MaxValue
        {
            get { return this.maxValue / this.scale; }
            set { this.maxValue = value * this.scale; }
        }

        public double DefaultValue
        {
            get { return this.defaultValue / this.scale; }
            set { this.defaultValue = value * this.scale; }
        }

        public double Step
        {
            get { return this.step / this.scale; }
            set { this.step = value * this.scale; }
        }

        public double ScalePercent
        {
            get { return this.scalePercent; }
            set { this.scalePercent = value; }
        }

        public double MinPercent
        {
            get { return this.minPercent / this.scalePercent; }
            set { this.minPercent = value * this.scalePercent; }
        }

        public double MaxPercent
        {
            get { return this.maxPercent / this.scalePercent; }
            set { this.maxPercent = value * this.scalePercent; }
        }

        public double DefaultPercent
        {
            get { return this.defaultPercent / this.scalePercent; }
            set { this.defaultPercent = value * this.scalePercent; }
        }

        public double StepPercent
        {
            get { return this.stepPercent / this.scalePercent; }
            set { this.stepPercent = value * this.scalePercent; }
        }
