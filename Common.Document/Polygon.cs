...
namespace Epsitec.Common.Document
{
    ...
    public class Polygon
    {
        ...
        public int Count
        {
            get { return this.typedPoints.Count; }
        }
        ...
        public void Simplify()
        {
            ...
            while (i < this.typedPoints.Count)
            {
                if (i < this.typedPoints.Count - 1)
                {
                    ...
                    if (
                        p0.PointType == PointType.Primary
        ...
        public static Path GetPolygonPathCorner(
        ...
        public static List<Polygon> InflateAndMakeConvexe(
            List<Polygon> polygons,
            double inflate,
            double convexe
        )
