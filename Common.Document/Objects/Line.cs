...
namespace Epsitec.Common.Document.Objects
{
    ...
    public class Line : Objects.Abstract, Support.IXMLSerializable<Line>
    {
        ...
        public Line(Document document, Objects.Abstract model, bool floating)
            : base(document, model)
        {
        ...
        )
        {
            ...
            Point pp1 = this.PropertyArrow.PathExtremity(
                pathStart,
                0,
                w,
                cap,
            ...
            Point pp2 = this.PropertyArrow.PathExtremity(
                pathEnd,
                1,
                w,
                cap,
