...
namespace Epsitec.Common.Document.Objects
{
    ...
    public class Page : Objects.Abstract, Support.IXMLSerializable<Page>
    {
            ...
            get
            {
                ...
                if (this.PageSize.Width != 0 && this.PageSize.Height == 0)
                {
                    text = string.Format(
                        "{0} ({1}x...)",
                        text,
                        this.document.Modifier.RealToString(this.PageSize.Width)
                    );
                }
                ...
                if (this.PageSize.Width == 0 && this.PageSize.Height != 0)
                {
                    text = string.Format(
                        "{0} (...x{1})",
                        text,
                        this.document.Modifier.RealToString(this.PageSize.Height)
                    );
                }
        ...
        public Page MasterPageToUse
        {
            ...
            get { return this.masterPageToUse; }
            set
            {
        ...
        public bool MasterAutoStop
        {
            ...
            get { return this.masterAutoStop; }
            set
            {
        ...
        public bool MasterSpecific
        {
            ...
            get { return this.masterSpecific; }
            set
            {
        ...
        protected override void CacheBitmapCreate()
        {
            ...
            else
            {
                ...
                this.cacheBitmap = this.document.Printer.CreateMiniatureBitmap(
                    size,
                    false,
                    this.PageNumber,
                    -1
