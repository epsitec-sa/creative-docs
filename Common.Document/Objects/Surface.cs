    ...
    public class Surface : Objects.Abstract, Support.IXMLSerializable<Surface>
    {
        ...
        protected override bool ExistingProperty(Properties.Type type)
        {
            ...
            if (type == Properties.Type.FillGradient)
                return true;
            if (type == Properties.Type.Surface)
                return true;
        ...
        )
        {
            ...
            //	Forme de la surface.
            {
                ...
                if (
                    type == Properties.SurfaceType.SpiralCCW
