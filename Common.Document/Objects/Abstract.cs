...
namespace Epsitec.Common.Document.Objects
{
    ...
    public abstract class Abstract : ISerializable, IXMLWritable
    {
        public Abstract(Document document, Objects.Abstract model)
        {
            ...
            this.properties = new NewUndoableList(
                this.document,
        ...
        public virtual void Dispose()
        {
            foreach (Properties.Abstract property in this.properties)
            {
                ...
                if (!property.IsStyle && !property.IsFloating && property.Owners.Count == 0)
                {
        ...
        public static Objects.Abstract CreateObject(
            Document document,
            string name,
        ...
        )
        {
            ...
            {
                case "ObjectLine":
                    obj = new Line(document, model);
                    break;
                case "ObjectRectangle":
                    obj = new Rectangle(document, model);
                    break;
                case "ObjectCircle":
                    obj = new Circle(document, model);
                    break;
                case "ObjectEllipse":
                    obj = new Ellipse(document, model);
                    break;
                case "ObjectPoly":
                    obj = new Poly(document, model);
                    break;
                case "ObjectFree":
                    obj = new Free(document, model);
                    break;
                case "ObjectBezier":
                    obj = new Bezier(document, model);
                    break;
                case "ObjectRegular":
                    obj = new Regular(document, model);
                    break;
                case "ObjectSurface":
                    obj = new Surface(document, model);
                    break;
                case "ObjectVolume":
                    obj = new Volume(document, model);
                    break;
                case "ObjectTextLine":
                    obj = new TextLine(document, model);
                    break;
                case "ObjectTextLine2":
                    obj = new TextLine2(document, model);
                    break;
                case "ObjectTextBox":
                    obj = new TextBox(document, model);
                    break;
                case "ObjectTextBox2":
                    obj = new TextBox2(document, model);
                    break;
                case "ObjectImage":
                    obj = new Image(document, model);
                    break;
                case "ObjectDimension":
                    obj = new Dimension(document, model);
                    break;
            }
        ...
        {
            get { return this.popupInterfaceFrame; }
        ...
        public NewUndoableList Objects
        {
        ...
        public virtual int CreationLastHandle
        {
            ...
            get { return this.TotalMainHandle - 1; }
        }
        ...
        public void HandlePropertiesUpdate()
        {
            ...
            bool sel =
                ...
                && !this.edited
                && !this.globalSelected
                && !this.document.Modifier.IsToolShaper;
        ...
        public void SelectHandle(int rank, bool add)
        {
            ...
            if (!add && rank != -1)
            {
                Handle handle = this.Handle(rank);
                if (!handle.IsShaperDeselected)
                    return; // poignée déjà sélectionnée ?
            }
        ...
        public void ShaperHiliteHandles(bool hilite)
        {
            ...
            for (int i = 0; i < total; i++)
            {
                ...
                if (handle.PropertyType != Properties.Type.None)
                    continue;
                if (handle.Type == HandleType.Secondary)
                    continue;
        ...
        public virtual void MoveSelectedSegmentStarting(
            int rank,
            Point pos,
        ...
        public virtual void MoveSelectedSegmentProcess(
            int rank,
            Point pos,
            DrawingContext drawingContext
        )
        ...
        public virtual void MoveSelectedSegmentEnding(
            int rank,
            Point pos,
            DrawingContext drawingContext
        )
        ...
        public virtual void MoveSelectedHandlesProcess(Point mouse, DrawingContext drawingContext)
        {
            ...
            if (this.moveSelectedHandleList == null)
                return;
        ...
        protected void TextInfoModifLine()
        {
            ...
            string text = string.Format(
                Res.Strings.Object.Abstract.InfoLine,
        ...
        protected void TextInfoModifRect()
        {
            ...
            {
                string text = string.Format(
                    Res.Strings.Object.Abstract.InfoRectangle,
                    this.document.Modifier.RealToString(width),
                    this.document.Modifier.RealToString(height)
                );
                this.document.Modifier.TextInfoModif = text;
            }
        }
        ...
        protected void TextInfoModifCircle()
        {
            ...
            double len = Point.Distance(this.Handle(0).Position, this.Handle(1).Position);
            string text = string.Format(
                Res.Strings.Object.Abstract.InfoCircle,
                this.document.Modifier.RealToString(len)
            );
            this.document.Modifier.TextInfoModif = text;
        }
        ...
        public virtual void MoveCellStarting(
            int rank,
            Point pos,
            bool isShift,
            bool isCtrl,
        ...
        public Drawing.Rectangle BoundingBoxDetect
        {
            ...
            get { return this.BoundingBoxGeom; }
        }
        ...
        public virtual Shape[] ShapesBuild(
            IPaintPort port,
            DrawingContext drawingContext,
            bool simplify
        )
            ...
            if (!this.document.IsSurfaceRotation)
            {
                foreach (Shape shape in shapes)
                {
                    ...
                    if (shape.Type == Type.Surface && shape.PropertySurface != null)
                    {
                        ...
                        shape.PropertySurface.InflateBoundingBox(
                            this.surfaceAnchor,
                            ref this.bboxFull
                        );
                    }
        ...
        public Properties.Gradient AdditionnalPropertyFrameSurface
        {
            get
            {
                return this.GetAdditionnalProperty(Properties.Type.FrameSurface)
        ...
        public Properties.Gradient AdditionnalPropertyFrameBackground
        {
            get
            {
                return this.GetAdditionnalProperty(Properties.Type.FrameBackground)
                    as Properties.Gradient;
            }
        }
        ...
        public Properties.Gradient AdditionnalPropertyFrameShadow
        {
            get
            {
                return this.GetAdditionnalProperty(Properties.Type.FrameShadow)
                    as Properties.Gradient;
            }
        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (!property.Compare(idem))
                        {
                            ...
                            {
                                Properties.Abstract multi = Properties.Abstract.NewProperty(
                                    this.document,
                                    idem.Type
                                );
                                idem.CopyTo(multi);
        ...
        public void PropertiesList(System.Collections.ArrayList list, Objects.Abstract filter)
        {
            ...
            foreach (Properties.Abstract property in this.properties)
            {
                if (property.Type == Properties.Type.ModColor)
                    continue;
                if (property.Type == Properties.Type.BackColor)
                    continue;
                if (filter != null && !filter.ExistingProperty(property.Type))
                    continue;
                list.Add(property);
            }
        }
        ...
        public void PickerProperties(Objects.Abstract model)
        {
            ...
            if (this is Objects.Memory)
            {
                ...
                foreach (Properties.Abstract mp in model.properties)
                {
                    ...
                    {
                        Properties.Abstract style = Properties.Abstract.NewProperty(
                            this.document,
                            mp.Type
                        );
                        mp.CopyTo(style);
        ...
        public void ChangePropertyPolyClose(bool close)
        {
            ...
            if (pb == null)
                return;
            if (pb.BoolValue == close)
                return; // on ne veut rien changer

            bool oqe;
            NewUndoableList properties = this.document.PropertiesAuto;
        ...
        protected void SplitProperties()
        {
            ...
            for (int i = 0; i < this.properties.Count; i++)
            {
                ...
                if (property.IsStyle)
                    continue;
                if (property.IsSelected == this.selected)
                    continue;
        ...
        protected Properties.Abstract SearchProperty(Properties.Abstract item, bool selected)
        {
            ...
            NewUndoableList properties = this.document.Modifier.PropertyList(selected);
        ...
        public void AggregateFree(Properties.Abstract property)
        {
            ...
            if (this is Objects.Memory)
            {
                if (property.IsStyle)
                {
                    Properties.Abstract free = Properties.Abstract.NewProperty(
                        this.document,
                        property.Type
                    );
        ...
        public virtual bool Detect(Drawing.Rectangle rect, bool partial)
        {
            ...
            if (partial)
            {
                foreach (Handle handle in this.handles)
                {
                    if (handle.Type != HandleType.Primary && handle.Type != HandleType.Starting)
                    {
                        continue;
                    }
        ...
        public virtual bool ShaperHandleState(
            string family,
            ref bool enable,
        ...
        protected static void ShaperHandleStateAdd(
            System.Collections.ArrayList actives,
            string state
        )
        {
        ...
        public virtual void FillOneCharList(
            IPaintPort port,
            DrawingContext drawingContext,
        ...
        protected abstract Objects.Abstract CreateNewObject(
            Document document,
            Objects.Abstract model
        );
        ...
        public void DrawGeometry(IPaintPort port, DrawingContext drawingContext)
        {
            ...
            if (shapes != null)
            {
                bool skipText = drawingContext.Drawer.DrawShapes(
                    port,
                    drawingContext,
                    this,
                    Drawer.DrawShapesMode.NoText,
                    shapes
                );
                ...
                if (port is Graphics)
                {
                    if (this.IsHilite && drawingContext.IsActive)
                    {
                        ...
                        drawingContext.Drawer.DrawShapes(
                            port,
                            drawingContext,
                            this,
                            Drawer.DrawShapesMode.All,
                            shapes
                        );
                ...
                if (skipText)
                {
                    drawingContext.Drawer.DrawShapes(
                        ...
                        drawingContext,
                        this,
                        Drawer.DrawShapesMode.OnlyText,
                        shapes
                    );
                }
            }
        ...
        public void DrawLabel(Graphics graphics, DrawingContext drawingContext)
        {
            ...
            if (m + ta + m <= bbox.Width)
            {
                ...
                graphics.AddText(
                    pos.X + 1.0 / drawingContext.ScaleX,
                    pos.Y - 1.0 / drawingContext.ScaleX,
                    s,
                    font,
                    fs
                );
        ...
        public virtual void DrawHandle(Graphics graphics, DrawingContext drawingContext)
        {
            ...
            if (this.isHide)
                return;
            if (!drawingContext.VisibleHandles)
                return;
        ...
        private void GetPdfComplexSurface(
            IPaintPort port,
            Properties.Abstract property,
            IList<Properties.Abstract> list
        )
        {
            for (int i = 0; i < 2; i++)
            {
        ...
        public Drawing.Size CacheBitmapSize
        {
            ...
            get { return this.cacheBitmapSize; }
            set
            {
        ...
        protected static HandleConstrainType ComputeConstrain(Point s1, Point p, Point s2)
        {
            ...
            if (
                System.Math.Abs(System.Math.Abs(a1 - a2)) < 0.1
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue("Properties", new UndoableList(this.properties));
            ...
            info.AddValue("Objects", new UndoableList(this.objects));
            info.AddValue("Direction", this.direction);
            info.AddValue("Aggregates", new UndoableList(this.aggregates));
        }
        ...
        protected Abstract(SerializationInfo info, StreamingContext context)
        {
            ...
            else if (this.document.IsRevisionGreaterOrEqual(1, 0, 24))
            {
                ...
                Properties.Aggregate agg = (Properties.Aggregate)
                    info.GetValue("Aggregate", typeof(Properties.Aggregate));
                if (agg != null)
                {
                    this.aggregates.Add(agg);
                }
        ...
        private void CreateMissingProperties()
        {
            ...
            if (this.document.Type != DocumentType.Pictogram) // pour gagner du temps lors de la génération d'icônes
            {
                foreach (int value in System.Enum.GetValues(typeof(Properties.Type)))
                {
                    Properties.Type type = (Properties.Type)value;
                    if (
                        this.ExistingProperty(type)
                        && // propriété utilisée par ce type d'objet ?
        ...
        protected static void ReadCheckFonts(
