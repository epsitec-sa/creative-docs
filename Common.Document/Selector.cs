...
namespace Epsitec.Common.Document
{
    ...
    public class Selector
    {
        ...
        {
            get { return this.finalData.TypeChoice; }
            set
            {
        ...
        {
            get { return this.finalData.TypeInUse; }
            set
            {
        ...
        {
            get { return this.finalData.TypeStretch; }
            set
            {
        ...
        public bool Visible
        {
            get { return this.finalData.Visible; }
            set
            {
        ...
        public bool Handles
        {
            get { return this.finalData.Handles; }
            set
            {
        ...
        {
            get { return this.finalData.Rectangle; }
        }
        ...
        public Point Position(int rank)
        {
            ...
            if (rank == 0)
                return this.h1.Position;
            if (rank == 1)
                return this.h1.Position;
            if (rank == 2)
                return this.h2.Position;
            if (rank == 3)
                return this.h3.Position;
            if (rank == 4)
                return this.h4.Position;
            if (rank == 5)
        ...
        public bool Detect(Point mouse, bool global, out int rank)
        {
            ...
            if (this.finalData.Visible)
            {
                ...
                {
                    if (this.rotate.Detect(mouse))
                    {
                        rank = 6;
                        return true;
                    }
                    if (this.center.Detect(mouse))
                    {
                        rank = 5;
                        return true;
                    }
                ...
                if (this.h4.Detect(mouse))
                {
                    rank = 4;
                    return true;
                }
                if (this.h3.Detect(mouse))
                {
                    rank = 3;
                    return true;
                }
                if (this.h2.Detect(mouse))
                {
                    rank = 2;
                    return true;
                }
                if (this.h1.Detect(mouse))
                {
                    rank = 1;
                    return true;
                }
            ...
            else
            {
                if (this.finalData.TypeInUse == SelectorType.Stretcher)
                {
                    this.document.Modifier.OpletQueueNameAction(
                        Res.Strings.Action.Selector.Stretcher
                    );
                }
                else
                {
        ...
        public void MoveStarting(int rank, Point pos, DrawingContext drawingContext)
        {
            ...
            else
            {
                ...
                if (rank == 1)
                    origin = this.finalData.P2; // inf/gauche ?
                if (rank == 2)
                    origin = this.finalData.P1; // sup/droite ?
                if (rank == 3)
                    origin = this.finalData.P4; // sup/gauche ?
                if (rank == 4)
                    origin = this.finalData.P3; // inf/droite ?
        ...
        protected void MoveCorner(int rank, Point pos)
        {
            ...
            if (this.finalData.TypeInUse != SelectorType.Stretcher)
                return;
            if (this.finalData.TypeStretch == SelectorTypeStretch.Free)
                return;
        ...
        protected void MoveTextInfoModif(int rank)
        {
            ...
            if (rank == 0) // tout ?
            {
                ...
                text = string.Format(
                    Res.Strings.Action.Selector.Info.Move,
                    this.document.Modifier.RealToString(dx),
                    this.document.Modifier.RealToString(dy)
                );
            }
            else if (rank <= 4) // coin ?
            {
                ...
                text = string.Format(
                    Res.Strings.Action.Selector.Info.Scale,
                    zx.ToString("F1"),
                    zy.ToString("F1")
                );
            }
            else if (rank == 5) // center ?
            {
                ...
                text = string.Format(
                    Res.Strings.Action.Selector.Info.Center,
                    this.document.Modifier.RealToString(dx),
                    this.document.Modifier.RealToString(dy)
                );
            }
            else if (rank == 6) // rotate ?
            {
                ...
                if (a < 0.0)
                    a += 360.0;
                text = string.Format(
                    Res.Strings.Action.Selector.Info.Rotate,
                    this.document.Modifier.AngleToString(a)
                );
            }
        ...
        protected void UpdateHandlePos()
        {
            ...
            this.rotate.Position =
                this.finalData.Center + Transform.RotatePointDeg(angle, new Point(0, radius));
        }
        ...
        )
        {
            ...
            Drawer.DrawPathDash(
                ...
                5.0,
                5.0,
                drawingContext.HiliteOutlineColor
            );
        }
        ...
        public Point DotTransform(Point pos)
        {
            ...
            {
                sx =
                    (pos.X - this.initialData.P1.X)
                    / (this.initialData.P2.X - this.initialData.P1.X);
            }

            if (this.initialData.P1.Y != this.initialData.P2.Y)
            {
                sy =
                    (pos.Y - this.initialData.P1.Y)
                    / (this.initialData.P2.Y - this.initialData.P1.Y);
            }
            ...
            if (this.finalData.TypeInUse == SelectorType.Stretcher)
            {
                ...
                if (
                    this.initialData.P3.X == this.initialData.P1.X
        ...
        public double GetTransformAngle
        {
            ...
            get { return this.finalData.Angle - this.initialData.Angle; }
        }

        public double GetTransformScale
        {
            //	Retourne le facteur de mise à l'échelle moyen.
            get { return (this.GetTransformScaleX + this.GetTransformScaleY) / 2.0; }
        }
        ...
        protected class SelectorData
        {
            ...
            public Point Center
            {
                get { return this.p1 + Point.ScaleMul(this.p2 - this.p1, this.center); }
                set
                {
                    ...
                    if (b.X == 0)
                        this.center.X = this.p1.X;
                    else
                        this.center.X = a.X / b.X;

                    if (b.Y == 0)
                        this.center.Y = this.p1.Y;
                    else
                        this.center.Y = a.Y / b.Y;
                }
            }
