...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Margins(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.fieldLeftMarginFirst = this.CreateTextFieldLabel(
                ...
                Res.Strings.TextPanel.Margins.Short.LeftFirst,
                Res.Strings.TextPanel.Margins.Long.LeftFirst,
                0.0,
                0.1,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleMarginChanged
            );
            this.fieldLeftMarginBody = this.CreateTextFieldLabel(
                Res.Strings.Action.Text.Ruler.HandleLeftBody,
                Res.Strings.TextPanel.Margins.Short.LeftBody,
                Res.Strings.TextPanel.Margins.Long.LeftBody,
                0.0,
                0.1,
                0.0,
                1.0,
            ...
            this.fieldRightMargin = this.CreateTextFieldLabel(
                ...
                Res.Strings.TextPanel.Margins.Short.Right,
                Res.Strings.TextPanel.Margins.Long.Right,
                0.0,
                0.1,
                0.0,
                1.0,
            ...
            this.fieldLevel = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Margins.Tooltip.Level,
                Res.Strings.TextPanel.Margins.Short.Level,
                Res.Strings.TextPanel.Margins.Long.Level,
                0.0,
                100.0,
                0.0,
                1.0,
        ...
        protected override void UpdateClientGeometry()
        {
            ...
            if (this.fieldLeftMarginFirst == null)
                return;
        ...
        protected void UpdateButtonClear()
        {
            if (this.isExtendedSize)
            {
                this.buttonClear.Visibility =
                    !this.ParagraphWrapper.IsAttachedToDefaultParagraphStyle;
            }
            else
            {
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            this.SetTextFieldRealValue(
                this.fieldLeftMarginFirst.TextFieldReal,
                leftFirst,
            ...
            this.SetTextFieldRealValue(
                this.fieldLeftMarginBody.TextFieldReal,
                leftBody,
                Common.Text.Properties.SizeUnits.Points,
                isLeftBody,
                false
            ...
            this.SetTextFieldRealValue(
                this.fieldRightMargin.TextFieldReal,
                right,
                Common.Text.Properties.SizeUnits.Points,
                isRight,
                false
        ...
        private void HandleMarginChanged(object sender)
        {
            ...
            if (field == this.fieldLeftMarginFirst.TextFieldReal)
            {
                if (isDefined)
                {
                    ...
                    this.ParagraphWrapper.Defined.MarginUnits = Common
                        .Text
                        .Properties
                        .SizeUnits
                        .Points;
            ...
            if (
                !this.ParagraphWrapper.Defined.IsLeftMarginFirstDefined
