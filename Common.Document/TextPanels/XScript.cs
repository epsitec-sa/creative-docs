...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Xscript(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonSubscript = this.CreateIconButton(
                Misc.Icon("FontSubscript"),
                Res.Strings.Action.FontSubscript,
                this.HandleButtonSubscriptClicked
            );
            this.buttonSuperscript = this.CreateIconButton(
                Misc.Icon("FontSuperscript"),
                Res.Strings.Action.FontSuperscript,
                this.HandleButtonSuperscriptClicked
            );

            this.fieldScale = this.CreateTextFieldLabelPercent(
                Res.Strings.TextPanel.Xscript.Tooltip.Scale,
                Res.Strings.TextPanel.Xscript.Short.Scale,
                Res.Strings.TextPanel.Xscript.Long.Scale,
                25.0,
                100.0,
                50.0,
                5.0,
                this.HandleScaleOffsetChanged
            );
            this.fieldOffset = this.CreateTextFieldLabelPercent(
                Res.Strings.TextPanel.Xscript.Tooltip.Offset,
                Res.Strings.TextPanel.Xscript.Short.Offset,
                Res.Strings.TextPanel.Xscript.Long.Offset,
                10.0,
                100.0,
                50.0,
                5.0,
        ...
        private void HandleButtonSubscriptClicked(object sender, MessageEventArgs e)
        {
            ...
            Common.Text.Wrappers.TextWrapper.XscriptDefinition xscript = this.TextWrapper
                .Defined
                .Xscript;
            ...
            {
                if (
                    this.TextWrapper.Active.Xscript.IsDisabled
        ...
        private void FillSubscriptDefinition(
            Common.Text.Wrappers.TextWrapper.XscriptDefinition xscript,
            bool def
        )
        {
        ...
        private void FillSuperscriptDefinition(
            Common.Text.Wrappers.TextWrapper.XscriptDefinition xscript,
            bool def
        )
        {
