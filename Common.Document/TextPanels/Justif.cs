...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Justif(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonAlignLeft = this.CreateIconButton(
                ...
                Res.Strings.Action.ParagraphAlignLeft,
                this.HandleJustifClicked
            );
            this.buttonAlignCenter = this.CreateIconButton(
                Misc.Icon("JustifHCenter"),
                Res.Strings.Action.ParagraphAlignCenter,
                this.HandleJustifClicked
            );
            this.buttonAlignRight = this.CreateIconButton(
                Misc.Icon("JustifHRight"),
                Res.Strings.Action.ParagraphAlignRight,
                this.HandleJustifClicked
            );
            this.buttonAlignJustif = this.CreateIconButton(
                Misc.Icon("JustifHJustif"),
                Res.Strings.Action.ParagraphAlignJustif,
                this.HandleJustifClicked
            );
            this.buttonAlignAll = this.CreateIconButton(
                Misc.Icon("JustifHAll"),
                Res.Strings.Action.ParagraphAlignAll,
                this.HandleJustifClicked
            );

            this.buttonHyphen = this.CreateIconButton(
                Misc.Icon("TextHyphen"),
                Res.Strings.Action.ParagraphHyphen,
                this.HandleHyphenClicked
            );
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            Common.Text.Wrappers.JustificationMode justif = this.ParagraphWrapper
                .Active
                .JustificationMode;
            ...
            this.ActiveIconButton(
                this.buttonAlignJustif,
                justif == Common.Text.Wrappers.JustificationMode.JustifyAlignLeft,
                isJustif
            );
            this.ActiveIconButton(
                this.buttonAlignAll,
                justif == Common.Text.Wrappers.JustificationMode.JustifyJustfy,
                isJustif
            );
        ...
        private void HandleJustifClicked(object sender, MessageEventArgs e)
        {
            ...
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphJustif",
                Res.Strings.Action.ParagraphJustif
            );
