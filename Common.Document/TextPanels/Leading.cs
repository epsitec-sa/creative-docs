...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Leading(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.fieldLeading = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Leading.Tooltip.Leading,
                Res.Strings.TextPanel.Leading.Short.Leading,
                Res.Strings.TextPanel.Leading.Long.Leading,
                0,
                0,
                0,
                0,
                Widgets.TextFieldLabel.Type.TextFieldUnit,
                this.HandleLeadingChanged
            );
            ...
            this.buttonLeadingMenu = this.CreateComboButton(
                null,
                Res.Strings.TextPanel.Leading.Tooltip.Leading,
                this.HandleButtonLeadingMenuClicked
            );

            this.buttonAlignFirst = this.CreateIconButton(
                Misc.Icon("ParagraphLeadingAlignFirst"),
                Res.Strings.TextPanel.Leading.Tooltip.AlignFirst,
                this.HandleButtonAlignFirstClicked
            );
            this.buttonAlignAll = this.CreateIconButton(
                Misc.Icon("ParagraphLeadingAlignAll"),
                Res.Strings.TextPanel.Leading.Tooltip.AlignAll,
                this.HandleButtonAlignAllClicked
            );
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            bool alignFirst = (
                this.ParagraphWrapper.Active.AlignMode == Common.Text.Properties.AlignMode.First
            );
            bool alignAll = (
                this.ParagraphWrapper.Active.AlignMode == Common.Text.Properties.AlignMode.All
            );
            ...
            this.SetTextFieldRealValue(
                this.fieldLeading.TextFieldReal,
                leading,
                units,
                isLeading,
                false
        ...
        private void HandleButtonUnitClicked(object sender, MessageEventArgs e)
        {
            ...
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphLeading",
                Res.Strings.Action.ParagraphLeading
            );
        ...
        private void HandleButtonAlignFirstClicked(object sender, MessageEventArgs e)
        {
            ...
            Common.Text.Properties.AlignMode mode = align
                ? Common.Text.Properties.AlignMode.First
                : Common.Text.Properties.AlignMode.None;
        ...
        private void HandleButtonAlignAllClicked(object sender, MessageEventArgs e)
        {
            ...
            Common.Text.Properties.AlignMode mode = align
                ? Common.Text.Properties.AlignMode.All
                : Common.Text.Properties.AlignMode.None;
            this.ParagraphWrapper.Defined.AlignMode = mode;
        }
        ...
        protected VMenu CreateMenu()
        {
            ...
            return Menus.LeadingMenu.CreateLeadingMenu(
                this.document,
                leading,
                isPercent ? "%" : "",
                isDefault,
