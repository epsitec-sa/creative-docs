...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Numerator(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            ToolTip.Default.SetToolTip(
                this.fieldStart,
                Res.Strings.TextPanel.Numerator.Tooltip.Start
            );
        ...
        private void HandleStartEditionAccepted(object sender)
        {
            ...
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphNumerator",
                Res.Strings.TextPanel.Numerator.Title
            );
