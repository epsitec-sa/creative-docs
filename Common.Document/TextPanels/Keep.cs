...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Keep(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonKeepNext = this.CreateIconButton(
                Misc.Icon("ParagraphKeepNext"),
                Res.Strings.TextPanel.Keep.Tooltip.KeepNext,
                this.HandleButtonKeepNextClicked
            );
            this.buttonKeepPrev = this.CreateIconButton(
                Misc.Icon("ParagraphKeepPrev"),
                Res.Strings.TextPanel.Keep.Tooltip.KeepPrev,
                this.HandleButtonKeepPrevClicked
            );

            this.fieldKeepStart = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Keep.Tooltip.KeepStart,
                Res.Strings.TextPanel.Keep.Short.KeepStart,
                Res.Strings.TextPanel.Keep.Long.KeepStart,
                0.0,
                100.0,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleKeepStartChanged
            );
            this.fieldKeepEnd = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Keep.Tooltip.KeepEnd,
                Res.Strings.TextPanel.Keep.Short.KeepEnd,
                Res.Strings.TextPanel.Keep.Long.KeepEnd,
                0.0,
                100.0,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleKeepEndChanged
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldNextStyle,
                Res.Strings.TextPanel.Keep.Tooltip.NextStyle
            );
        ...
        {
            if (text == Res.Strings.TextPanel.Keep.StartMode.Anywhere)
                return Common.Text.Properties.ParagraphStartMode.Anywhere;
            if (text == Res.Strings.TextPanel.Keep.StartMode.NewFrame)
                return Common.Text.Properties.ParagraphStartMode.NewFrame;
            if (text == Res.Strings.TextPanel.Keep.StartMode.NewPage)
                return Common.Text.Properties.ParagraphStartMode.NewPage;
            if (text == Res.Strings.TextPanel.Keep.StartMode.NewOddPage)
                return Common.Text.Properties.ParagraphStartMode.NewOddPage;
            if (text == Res.Strings.TextPanel.Keep.StartMode.NewEvenPage)
                return Common.Text.Properties.ParagraphStartMode.NewEvenPage;
        ...
        public static string ModeToString(Common.Text.Properties.ParagraphStartMode mode)
        {
            switch (mode)
            {
                case Common.Text.Properties.ParagraphStartMode.Anywhere:
                    return Res.Strings.TextPanel.Keep.StartMode.Anywhere;
                case Common.Text.Properties.ParagraphStartMode.NewFrame:
                    return Res.Strings.TextPanel.Keep.StartMode.NewFrame;
                case Common.Text.Properties.ParagraphStartMode.NewPage:
                    return Res.Strings.TextPanel.Keep.StartMode.NewPage;
                case Common.Text.Properties.ParagraphStartMode.NewOddPage:
                    return Res.Strings.TextPanel.Keep.StartMode.NewOddPage;
                case Common.Text.Properties.ParagraphStartMode.NewEvenPage:
                    return Res.Strings.TextPanel.Keep.StartMode.NewEvenPage;
            }
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            Common.Text.Properties.ParagraphStartMode mode = this.ParagraphWrapper
                .Active
                .ParagraphStartMode;
            ...
            this.SetTextFieldRealValue(
                this.fieldKeepStart.TextFieldReal,
                keepStart,
            ...
            this.SetTextFieldRealValue(
                this.fieldKeepEnd.TextFieldReal,
                keepEnd,
                Common.Text.Properties.SizeUnits.Points,
                isKeepEnd,
                false
            ...
            this.fieldStartMode.TextDisplayMode = isMode
                ? TextFieldDisplayMode.OverriddenValue
                : TextFieldDisplayMode.InheritedValue;
            ...
            if (currentStyle != null)
            {
                ...
                if (nextStyle != null)
                {
                    nextStyleName = Misc.UserTextStyleName(
                        this.document.TextContext.StyleList.StyleMap.GetCaption(nextStyle)
                    );
                }
            }
        ...
        private void HandleStartModeChanged(object sender)
        {
            ...
            Common.Text.Properties.ParagraphStartMode mode = Keep.StringToMode(
                this.fieldStartMode.Text
            );
        ...
        private void HandleStyleComboClosed(object sender)
        {
            ...
            else
            {
                ...
                this.fieldNextStyle.Text = Misc.UserTextStyleName(
                    this.document.TextContext.StyleList.StyleMap.GetCaption(nextStyle)
                );
            }
