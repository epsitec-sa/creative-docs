...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    public abstract class Abstract : Common.Widgets.Widget
    {
        ...
        )
        {
            ...
            if (name == "Justif")
                return new Justif(document, isStyle, styleCategory);
            if (name == "Leading")
                return new Leading(document, isStyle, styleCategory);
            if (name == "Margins")
                return new Margins(document, isStyle, styleCategory);
            if (name == "Spaces")
                return new Spaces(document, isStyle, styleCategory);
            if (name == "Keep")
                return new Keep(document, isStyle, styleCategory);
            if (name == "Tabs")
                return new Tabs(document, isStyle, styleCategory);
            if (name == "Generator")
                return new Generator(document, isStyle, styleCategory);
            if (name == "Numerator")
                return new Numerator(document, isStyle, styleCategory);
            if (name == "Font")
                return new Font(document, isStyle, styleCategory);
            if (name == "Xline")
                return new Xline(document, isStyle, styleCategory);
            if (name == "Xscript")
                return new Xscript(document, isStyle, styleCategory);
            if (name == "Box")
                return new Box(document, isStyle, styleCategory);
            if (name == "Language")
                return new Language(document, isStyle, styleCategory);
            return null;
        }
        ...
        protected double LabelHeight
        {
            ...
            get { return this.IsLabelProperties ? 14 : 0; }
        }
        ...
        protected GlyphButton CreateComboButton(
            string command,
            string tooltip,
            Support.EventHandler<MessageEventArgs> handler
        )
        ...
        protected Widgets.TextFieldLabel CreateTextFieldLabel(
            string tooltip,
            string shortText,
            string longText,
            double minRange,
            ...
            double defRange,
            double step,
            Widgets.TextFieldLabel.Type type,
        ...
        protected Widgets.TextFieldLabel CreateTextFieldLabelPercent(
            string tooltip,
            string shortText,
            string longText,
            double minRange,
        ...
        )
        {
            ...
            Widgets.TextFieldLabel field = new Widgets.TextFieldLabel(
                this,
        ...
        protected void SetTextFieldRealValue(
            TextFieldReal field,
            double value,
            Common.Text.Properties.SizeUnits units,
            bool isDefined,
            bool disabledIfUndefined
        )
        {
            ...
            {
                field.TextDisplayMode = isDefined
        ...
        protected void GetTextFieldRealValue(
            TextFieldReal field,
            out double value,
            out Common.Text.Properties.SizeUnits units,
            out bool isDefined
        )
        {
        ...
        protected void SetTextFieldRealPercent(
            TextFieldReal field,
            double value,
            bool isDefined,
            bool disabledIfUndefined
        ...
        protected void GetTextFieldRealPercent(
            TextFieldReal field,
            out double value,
            out bool isDefined
        )
        ...
        protected void ProposalTextFieldLabel(Widgets.TextFieldLabel field, bool proposal)
        {
            ...
            field.TextFieldReal.TextDisplayMode = proposal
                ? TextFieldDisplayMode.InheritedValue
                : TextFieldDisplayMode.OverriddenValue;
        }
        ...
        protected void ProposalTextFieldCombo(TextFieldCombo field, bool proposal)
        {
            ...
            field.TextDisplayMode = proposal
                ? TextFieldDisplayMode.InheritedValue
                : TextFieldDisplayMode.OverriddenValue;
        }
        ...
        protected ColorSample CreateColorSample(
            string tooltip,
            Support.EventHandler<MessageEventArgs> handlerClicked,
            EventHandler handlerChanged
        )
        {
        ...
        protected Text.Wrappers.TextWrapper TextWrapper
        {
            ...
            {
                if (this.isStyle)
                    return this.document.Wrappers.StyleTextWrapper;
        ...
        protected Text.Wrappers.ParagraphWrapper ParagraphWrapper
        {
            ...
            {
                if (this.isStyle)
                    return this.document.Wrappers.StyleParagraphWrapper;
        ...
        protected bool IsWrappersAttached
        {
            ...
            {
                if (this.isStyle)
                    return this.document.Wrappers.StyleParagraphWrapper.IsAttached;
