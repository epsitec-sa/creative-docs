...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    public class Generator : Abstract
    {
        ...
        public Generator(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.buttonAdd = this.CreateIconButton(
                Misc.Icon("ShaperHandleAdd"),
                Res.Strings.TextPanel.Generator.Tooltip.Generator.Add,
                this.HandleAddClicked
            );
            this.buttonSub = this.CreateIconButton(
                Misc.Icon("ShaperHandleSub"),
                Res.Strings.TextPanel.Generator.Tooltip.Generator.Sub,
                this.HandleSubClicked
            );

            this.buttonNone = this.CreateIconButton(
                Misc.Icon("BulletJustifNone"),
                Res.Strings.TextPanel.Generator.Tooltip.Justif.None,
                this.HandleJustifClicked
            );
            this.buttonLeft = this.CreateIconButton(
                Misc.Icon("BulletJustifLeft"),
                Res.Strings.TextPanel.Generator.Tooltip.Justif.Left,
                this.HandleJustifClicked
            );
            this.buttonCenter = this.CreateIconButton(
                Misc.Icon("BulletJustifCenter"),
                Res.Strings.TextPanel.Generator.Tooltip.Justif.Center,
                this.HandleJustifClicked
            );
            this.buttonRight = this.CreateIconButton(
                Misc.Icon("BulletJustifRight"),
                Res.Strings.TextPanel.Generator.Tooltip.Justif.Right,
                this.HandleJustifClicked
            );

            this.buttonContinue = this.CreateIconButton(
                Misc.Icon("BulletContinue"),
                Res.Strings.TextPanel.Generator.Tooltip.Continue,
            ...
            ToolTip.Default.SetToolTip(
                this.buttonPerso,
                Res.Strings.TextPanel.Generator.Tooltip.Perso
            );

            this.buttonSuppressBefore = this.CreateIconButton(
                Misc.Icon("SuppressBefore"),
                Res.Strings.TextPanel.Generator.Tooltip.SuppressBefore,
                this.HandleSuppressBeforeClicked
            );
            ...
            this.colorText = this.CreateColorSample(
                Res.Strings.TextPanel.Generator.Tooltip.Color,
                this.HandleSampleColorClicked,
                this.HandleSampleColorChanged
            );

            this.labelTabs = new StaticText(this);
            this.labelTabs.Text = Res.Strings.TextPanel.Generator.Label.Tabs;

            this.fieldTab = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Generator.Tooltip.Tab,
                Res.Strings.TextPanel.Generator.Short.Tab,
                "",
                0.0,
                0.1,
                0.0,
            ...
            this.fieldIndent = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Generator.Tooltip.Indent,
                Res.Strings.TextPanel.Generator.Short.Indent,
                "",
                0.0,
                0.1,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleIndentChanged
            );
            this.fieldFontSize = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Generator.Tooltip.Size,
                Res.Strings.TextPanel.Generator.Short.Size,
                "",
                0.0,
                0.1,
                0.0,
            ...
            this.fieldFontOffset = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Generator.Tooltip.Offset,
                Res.Strings.TextPanel.Generator.Short.Offset,
                "",
                -0.1,
                0.1,
                0.0,
        ...
        protected void CreateGenerator(string type)
        {
            ...
            {
                this.ParagraphWrapper.Defined.IndentationLevelAttribute = string.Concat(
                    TabList.LevelMultiplier,
                    "0 pt"
                );
            }
            ...
            if (
                type == "Bullet1"
                || (type == "Custom" && !this.ParagraphWrapper.Defined.IsManagedParagraphDefined)
            )
            {
            ...
            if (type == "Num1")
            {
                ...
                this.SetValue(
                    ...
                    Part1.Value,
                    Part2.Text,
                    Res.Strings.TextPanel.Generator.Numerator.Numeric
                );
                ...
                this.SetValue(
                    ...
                    Part1.Value,
                    Part2.Text,
                    Res.Strings.TextPanel.Generator.Numerator.AlphaLower
                );
                ...
                this.SetValue(
                    ...
                    Part1.Value,
                    Part2.Text,
                    Res.Strings.TextPanel.Generator.Numerator.RomanLower
                );
            ...
            if (type == "Num3")
            {
                ...
                this.SetValue(
                    ...
                    Part1.Value,
                    Part2.Text,
                    Res.Strings.TextPanel.Generator.Numerator.AlphaUpper
                );
                this.SetValue(p, 1, Part1.Generic, Part2.Tab, "8");
                this.SetValue(p, 1, Part1.Generic, Part2.Indent, "10");
            ...
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphGeneratorCreate",
                Res.Strings.Action.ParagraphGenerator
            );
        ...
        protected int GetCount()
        {
            ...
            if (!this.ParagraphWrapper.Defined.IsManagedParagraphDefined)
                return 0;
            Text.ParagraphManagers.ItemListManager.Parameters p = this.ParagraphWrapper
                .Defined
                .ItemListParameters;
            if (p == null)
                return 0;
        ...
        protected string GetValue(int level, Part1 part1, Part2 part2)
        {
            ...
            if (level == 0)
            {
                if (part2 == Part2.Text)
                {
                    if (part1 == Part1.Prefix)
                        return p.Generator.GlobalPrefix;
                    if (part1 == Part1.Suffix)
                        return p.Generator.GlobalSuffix;
                }

                if (part1 == Part1.Prefix)
                    properties = p.Generator.GlobalPrefixProperties;
                if (part1 == Part1.Suffix)
                    properties = p.Generator.GlobalSuffixProperties;
            ...
            else if (level - 1 < p.Generator.Count)
            {
                ...
                if (part1 == Part1.Prefix)
                    properties = sequence.PrefixProperties;
                if (part1 == Part1.Suffix)
                    properties = sequence.SuffixProperties;
                if (part1 == Part1.Value)
                    properties = sequence.ValueProperties;
                ...
                if (part2 == Part2.Tab || part2 == Part2.Indent)
                {
                    if (p.TabItem == null)
                        return "None";
                    string ta = this.document.TextContext.TabList.GetTabAttribute(
                        (part2 == Part2.Tab) ? p.TabItem : p.TabBody
                    );
                    if (ta == null)
                        return null;
            ...
            if (properties != null)
            {
                if (part2 == Part2.FontFace)
                {
                    foreach (Common.Text.Property property in properties)
                    {
                        ...
                        {
                            Common.Text.Properties.FontProperty font =
                                property as Common.Text.Properties.FontProperty;
                ...
                if (part2 == Part2.FontSize)
                {
                    foreach (Common.Text.Property property in properties)
                    {
                        ...
                        {
                            Common.Text.Properties.FontSizeProperty size =
                                property as Common.Text.Properties.FontSizeProperty;
                ...
                if (part2 == Part2.FontColor)
                {
                    ...
                    {
                        if (
                            property.WellKnownType == Common.Text.Properties.WellKnownType.FontColor
                        )
                        {
                            Common.Text.Properties.FontColorProperty color =
                                property as Common.Text.Properties.FontColorProperty;
                ...
                if (part2 == Part2.FontOffset)
                {
                    ...
                    {
                        if (
                            property.WellKnownType
                            == Common.Text.Properties.WellKnownType.FontOffset
                        )
                        {
                            Common.Text.Properties.FontOffsetProperty offset =
                                property as Common.Text.Properties.FontOffsetProperty;
        ...
        )
        {
            ...
            {
                p.Generator.Add(
                    Common.Text.Generator.CreateSequence(Common.Text.Generator.SequenceType.Empty)
                );
            }
            ...
            if (level == 0)
            {
                ...
                {
                    if (part1 == Part1.Prefix)
                        p.Generator.GlobalPrefix = value;
                    if (part1 == Part1.Suffix)
                        p.Generator.GlobalSuffix = value;
                }
                ...
                if (part2 == Part2.Disposition)
                {
                    ...
                    else
                    {
                        if (p.TabItem == null)
                        {
                            ...
                            double inc = System.Globalization.RegionInfo.CurrentRegion.IsMetric
                                ? 100
                                : 127; // 10mm ou 0.5in
                            ...
                            p.TabItem = tabs.NewTab(
                                Common.Text.TabList.GenericSharedName,
                                0.0,
                                Common.Text.Properties.SizeUnits.Points,
                                0.0,
                                null,
                                TabPositionMode.LeftRelative,
                                attributeItem
                            );
                            p.TabBody = tabs.NewTab(
                                Common.Text.TabList.GenericSharedName,
                                0.0,
                                Common.Text.Properties.SizeUnits.Points,
                                0.0,
                                null,
                                TabPositionMode.LeftRelativeIndent,
                                attributeBody
                            );
                        }
            ...
            else
            {
                ...
                {
                    p.Generator.Add(
                        Common.Text.Generator.CreateSequence(
                            Common.Text.Generator.SequenceType.Empty
                        )
                    );
                }
            ...
            if (part2 == Part2.FontFace)
            {
                Common.Text.Properties.FontProperty current =
                    Generator.PropertyGet(properties, Common.Text.Properties.WellKnownType.Font)
                    as Common.Text.Properties.FontProperty;
                if (value == null)
                {
                    properties = Generator.PropertyRemove(
                        properties,
                        Common.Text.Properties.WellKnownType.Font
                    );
                }
                else
                {
                    Common.Text.Properties.FontProperty n = new Text.Properties.FontProperty(
                        value,
                        Misc.DefaultFontStyle(value)
                    );
                    if (current == null)
                    {
            ...
            if (part2 == Part2.FontSize)
            {
                Common.Text.Properties.FontSizeProperty current =
                    Generator.PropertyGet(properties, Common.Text.Properties.WellKnownType.FontSize)
                    as Common.Text.Properties.FontSizeProperty;
                if (value == null)
                {
                    properties = Generator.PropertyRemove(
                        properties,
                        Common.Text.Properties.WellKnownType.FontSize
                    );
                }
                else
                {
                    Common.Text.Properties.FontSizeProperty n =
                        new Text.Properties.FontSizeProperty(
                            Generator.ConvTextToFontSize(value),
                            Common.Text.Properties.SizeUnits.Points
                        );
                    if (current == null)
                    {
            ...
            if (part2 == Part2.FontColor)
            {
                Common.Text.Properties.FontColorProperty current =
                    Generator.PropertyGet(
                        properties,
                        Common.Text.Properties.WellKnownType.FontColor
                    ) as Common.Text.Properties.FontColorProperty;
                if (value == null)
                {
                    properties = Generator.PropertyRemove(
                        properties,
                ...
                {
                    Common.Text.Properties.FontColorProperty n =
                        new Text.Properties.FontColorProperty(value);
                    if (current == null)
                    {
                        properties = Generator.PropertyAdd(properties, n);
                    }
            ...
            if (part2 == Part2.FontOffset)
            {
                Common.Text.Properties.FontOffsetProperty current =
                    Generator.PropertyGet(
                        properties,
                        Common.Text.Properties.WellKnownType.FontOffset
                    ) as Common.Text.Properties.FontOffsetProperty;
                if (value == null)
                {
                    properties = Generator.PropertyRemove(
                        properties,
                ...
                {
                    Common.Text.Properties.FontOffsetProperty n =
                        new Text.Properties.FontOffsetProperty(
                            this.ConvTextToDistance(value),
                            Common.Text.Properties.SizeUnits.Points
                        );
                    if (current == null)
                    {
            ...
            if (properties != null)
            {
                ...
                {
                    if (part1 == Part1.Prefix)
                        p.Generator.GlobalPrefixProperties = properties;
                    if (part1 == Part1.Suffix)
                        p.Generator.GlobalSuffixProperties = properties;
                }
                else
                {
                    Common.Text.Generator.Sequence sequence = p.Generator[level - 1];
                    ...
                    if (part1 == Part1.Prefix)
                        sequence.PrefixProperties = properties;
                    if (part1 == Part1.Suffix)
                        sequence.SuffixProperties = properties;
                    if (part1 == Part1.Value)
                        sequence.ValueProperties = properties;
                }
            }
        ...
        protected static Common.Text.Property PropertyGet(
            Common.Text.Property[] properties,
            Common.Text.Properties.WellKnownType type
        )
        {
        ...
        protected static void PropertyModify(
            Common.Text.Property[] properties,
            Common.Text.Property n
        )
        {
        ...
        protected static Common.Text.Property[] PropertyAdd(
            Common.Text.Property[] properties,
            Common.Text.Property n
        )
        {
        ...
        protected static Common.Text.Property[] PropertyRemove(
            Common.Text.Property[] properties,
            Common.Text.Properties.WellKnownType type
        )
        {
        ...
        protected static string ConvTypeToText(string type)
        {
            ...
            {
                case "None":
                    return Res.Strings.TextPanel.Generator.Type.None;
                case "Bullet1":
                    return Res.Strings.TextPanel.Generator.Type.Bullet1;
                case "Bullet2":
                    return Res.Strings.TextPanel.Generator.Type.Bullet2;
                case "Bullet3":
                    return Res.Strings.TextPanel.Generator.Type.Bullet3;
                case "Num1":
                    return Res.Strings.TextPanel.Generator.Type.Num1;
                case "Num2":
                    return Res.Strings.TextPanel.Generator.Type.Num2;
                case "Num3":
                    return Res.Strings.TextPanel.Generator.Type.Num3;
                case "Num4":
                    return Res.Strings.TextPanel.Generator.Type.Num4;
                case "Num5":
                    return Res.Strings.TextPanel.Generator.Type.Num5;
                case "Custom":
                    return Res.Strings.TextPanel.Generator.Type.Custom;
            }
            return "?";
        }
        ...
        {
            if (text == Res.Strings.TextPanel.Generator.Type.None)
                return "None";
            if (text == Res.Strings.TextPanel.Generator.Type.Bullet1)
                return "Bullet1";
            if (text == Res.Strings.TextPanel.Generator.Type.Bullet2)
                return "Bullet2";
            if (text == Res.Strings.TextPanel.Generator.Type.Bullet3)
                return "Bullet3";
            if (text == Res.Strings.TextPanel.Generator.Type.Num1)
                return "Num1";
            if (text == Res.Strings.TextPanel.Generator.Type.Num2)
                return "Num2";
            if (text == Res.Strings.TextPanel.Generator.Type.Num3)
                return "Num3";
            if (text == Res.Strings.TextPanel.Generator.Type.Num4)
                return "Num4";
            if (text == Res.Strings.TextPanel.Generator.Type.Num5)
                return "Num5";
            if (text == Res.Strings.TextPanel.Generator.Type.Custom)
                return "Custom";
            return null;
        }
        ...
        protected static void ConvTextToSequence(
            string text,
            out Common.Text.Generator.SequenceType type,
            out Common.Text.Generator.Casing casing
        )
        {
            ...
            if (
                text == Res.Strings.TextPanel.Generator.Numerator.None
                || text == ""
                || text == null
            )
            {
        ...
        public override void OriginColorSelect(int rank)
        {
            ...
            if (rank != -1)
            {
                ...
                if (rank == 0)
                    this.originFieldColor = this.colorText;
            }
            if (this.originFieldColor == null)
                return;
        ...
        public override Drawing.RichColor OriginColorGet()
        {
            ...
            if (this.originFieldColor == null)
                return Drawing.RichColor.FromBrightness(0.0);
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            if (this.ParagraphWrapper.IsAttached == false)
                return;
        ...
        protected void UpdateFields()
        {
            ...
            this.buttonSuppressBefore.ActiveState =
                (text == "true") ? ActiveState.Yes : ActiveState.No;
            ...
            if (part1 == Part1.Prefix || part1 == Part1.Suffix)
            {
                ...
                ToolTip.Default.SetToolTip(
                    this.fieldText,
                    Res.Strings.TextPanel.Generator.Tooltip.Fix
                );
            }
            ...
            if (part1 == Part1.Value)
            {
                ...
                ToolTip.Default.SetToolTip(
                    this.fieldText,
                    Res.Strings.TextPanel.Generator.Tooltip.Value
                );
            }
        ...
        protected void UpdateWidgets()
        {
            ...
            if (this.GetValue(0, Part1.Generic, Part2.Disposition) == "None")
                enable = false;
        ...
        private void HandleTypeChanged(object sender)
        {
            if (this.ignoreChanged)
                return;
            if (!this.ParagraphWrapper.IsAttached)
                return;
        ...
        private void HandleJustifClicked(object sender, MessageEventArgs e)
        {
            ...
            if (sender == this.buttonLeft)
                text = "Left";
            if (sender == this.buttonCenter)
                text = "Center";
            if (sender == this.buttonRight)
                text = "Right";
            this.SetValue(0, Part1.Generic, Part2.Disposition, text);
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphGeneratorJustif",
                Res.Strings.Action.ParagraphGenerator
            );
        }
        ...
        private void HandleSuppressBeforeClicked(object sender, MessageEventArgs e)
        {
            ...
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphGeneratorSuppressBefore",
                Res.Strings.Action.ParagraphGenerator
            );
        }
        ...
        private void HandleSampleColorClicked(object sender, MessageEventArgs e)
        {
            ...
            if (this.originFieldColor == this.colorText)
        ...
        private void HandleClearClicked(object sender, MessageEventArgs e)
        {
            ...
            this.ParagraphWrapper.Defined.ClearIndentationLevelAttribute();
            this.ParagraphWrapper.DefineOperationName(
                "ParagraphGeneratorClear",
                Res.Strings.TextPanel.Clear
            );
            this.ParagraphWrapper.ResumeSynchronizations();
            this.ActionMade();
        }
