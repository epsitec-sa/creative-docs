...
namespace Epsitec.Common.Document.TextPanels
{
    ...
    {
        public Spaces(Document document, bool isStyle, StyleCategory styleCategory)
            : base(document, isStyle, styleCategory)
        {
            ...
            this.fieldBefore = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Spaces.Tooltip.Before,
                Res.Strings.TextPanel.Spaces.Short.Before,
                Res.Strings.TextPanel.Spaces.Long.Before,
                0.0,
                0.1,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleBeforeChanged
            );
            this.fieldAfter = this.CreateTextFieldLabel(
                Res.Strings.TextPanel.Spaces.Tooltip.After,
                Res.Strings.TextPanel.Spaces.Short.After,
                Res.Strings.TextPanel.Spaces.Long.After,
                0.0,
                0.1,
                0.0,
                1.0,
                Widgets.TextFieldLabel.Type.TextFieldReal,
                this.HandleAfterChanged
            );
        ...
        protected override void UpdateAfterChanging()
        {
            ...
            this.SetTextFieldRealValue(
                this.fieldBefore.TextFieldReal,
                before,
        ...
        private void HandleBeforeChanged(object sender)
        {
            ...
            if (isDefined)
            {
                ...
                this.ParagraphWrapper.Defined.SpaceBeforeUnits = Common
                    .Text
                    .Properties
                    .SizeUnits
                    .Points;
        ...
        private void HandleAfterChanged(object sender)
        {
            ...
            if (isDefined)
            {
                ...
                this.ParagraphWrapper.Defined.SpaceAfterUnits = Common
                    .Text
                    .Properties
                    .SizeUnits
                    .Points;
