    ...
    public class Wrappers
    {
        public Wrappers(Document document)
        {
            ...
            if (this.document.Mode == DocumentMode.Modify)
            {
                ...
                image = new Drawing.DynamicImage(
                    new Drawing.Size(140, 16),
                    new Drawing.DynamicImagePaintCallback(this.DrawDynamicImageFontBrief)
                );
                ...
                image = new Drawing.DynamicImage(
                    new Drawing.Size(200, 30),
                    new Drawing.DynamicImagePaintCallback(this.DrawDynamicImageFontMenu)
                );
                image.IsCacheEnabled = true;
                Epsitec.Common.Support.ImageProvider.Instance.AddDynamicImage(tag, image);
                ...
                image = new Drawing.DynamicImage(
                    new Drawing.Size(53, 45),
                    new Drawing.DynamicImagePaintCallback(this.DrawDynamicImageStyleBrief)
                );
                image.IsCacheEnabled = true;
                Epsitec.Common.Support.ImageProvider.Instance.AddDynamicImage(tag, image);
                ...
                image = new Drawing.DynamicImage(
                    new Drawing.Size(200, 32),
                    new Drawing.DynamicImagePaintCallback(this.DrawDynamicImageStyleMenu)
                );
                image.IsCacheEnabled = true;
                Epsitec.Common.Support.ImageProvider.Instance.AddDynamicImage(tag, image);
            }
        ...
        public bool IsWrappersAttached
        {
            ...
            get { return this.textWrapper.IsAttached; }
        }
        ...
        protected void HandleParagraphWrapperChanged(object sender)
        {
            ...
            if (leading == 0.8)
                leadingState = "ParagraphLeading08";
            if (leading == 1.0)
                leadingState = "ParagraphLeading10";
            if (leading == 1.2)
                leadingState = "ParagraphLeading12";
            if (leading == 1.5)
                leadingState = "ParagraphLeading15";
            if (leading == 2.0)
                leadingState = "ParagraphLeading20";
            if (leading == 3.0)
                leadingState = "ParagraphLeading30";

            string justifState = "Justif?";
            switch (justif)
            {
                case Text.Wrappers.JustificationMode.AlignLeft:
                    justifState = "ParagraphJustifLeft";
                    break;
                case Text.Wrappers.JustificationMode.Center:
                    justifState = "ParagraphJustifCenter";
                    break;
                case Text.Wrappers.JustificationMode.AlignRight:
                    justifState = "ParagraphJustifRight";
                    break;
                case Text.Wrappers.JustificationMode.JustifyAlignLeft:
                    justifState = "ParagraphJustifJustif";
                    break;
                case Text.Wrappers.JustificationMode.JustifyJustfy:
                    justifState = "ParagraphJustifAll";
                    break;
            }
        ...
        protected void HandleStyleWrapperChanged(object sender)
        {
            ...
            Text.TextStyle[] styles =
                this.document.TextContext.StyleList.StyleMap.GetSortedStyles();
        ...
        public bool IsFreeName(Text.TextStyle style, string name)
        {
            ...
            foreach (Text.TextStyle existing in styles)
            {
                if (existing == style)
                    continue;
                if (existing.TextStyleClass != style.TextStyleClass)
                    continue;
        ...
        public System.Collections.ArrayList ArrangeParentStyles(
        ...
        public void GetStyleBrief(Text.TextStyle style, out string brief, out int lines)
        {
            ...
            if (
                this.styleParagraphWrapper.Defined.IsJustificationModeDefined
            ...
            )
            {
                ...
                {
                    Text.Wrappers.JustificationMode justif = this.styleParagraphWrapper
                        .Defined
                        .JustificationMode;
                    switch (justif)
                    {
                        case Text.Wrappers.JustificationMode.AlignLeft:
                            builder.Append(Res.Strings.Action.ParagraphAlignLeft);
                            break;
                        case Text.Wrappers.JustificationMode.Center:
                            builder.Append(Res.Strings.Action.ParagraphAlignCenter);
                            break;
                        case Text.Wrappers.JustificationMode.AlignRight:
                            builder.Append(Res.Strings.Action.ParagraphAlignRight);
                            break;
                        case Text.Wrappers.JustificationMode.JustifyAlignLeft:
                            builder.Append(Res.Strings.Action.ParagraphAlignJustif);
                            break;
                        case Text.Wrappers.JustificationMode.JustifyJustfy:
                            builder.Append(Res.Strings.Action.ParagraphAlignAll);
                            break;
                    }
                    first = false;
                }
            ...
            if (
                this.styleParagraphWrapper.Defined.IsLeadingDefined
            ...
            )
            {
                ...
                if (this.styleParagraphWrapper.Defined.IsLeadingDefined)
                {
                    ...
                    Text.Properties.SizeUnits units = this.styleParagraphWrapper
                        .Defined
                        .LeadingUnits;
                    builder.Append(
                        this.GetBriefValue(leading, units, this.document.Modifier.RealScale)
                    );
                    first = false;
                }
                ...
                {
                    bool alignFirst = (
                        this.styleParagraphWrapper.Defined.AlignMode
            ...
            if (
                this.styleParagraphWrapper.Defined.IsLeftMarginFirstDefined
            ...
            )
            {
                ...
                if (this.styleParagraphWrapper.Defined.IsLeftMarginFirstDefined)
                {
                    ...
                    Text.Properties.SizeUnits units = this.styleParagraphWrapper
                        ...
                        .MarginUnits;
                    builder.Append(
                        this.GetBriefValue(margin, units, this.document.Modifier.RealScale)
                    );
                    first = false;
                }
            ...
            if (
                this.styleParagraphWrapper.Defined.IsSpaceBeforeDefined
            ...
            if (
                this.styleParagraphWrapper.Defined.IsKeepWithNextParagraphDefined
            ...
            )
            {
                ...
                if (this.styleParagraphWrapper.Defined.IsParagraphStartModeDefined)
                {
                    if (!first)
                        builder.Append(", ");
                    Text.Properties.ParagraphStartMode mode = this.styleParagraphWrapper
                        .Defined
                        .ParagraphStartMode;
                ...
                foreach (string tab in tabs)
                {
                    ...
                    builder.Append(
                        this.GetBriefValue(
                            ...
                            this.document.Modifier.RealScale
                        )
                    );
                    first = false;
                }
            ...
            if (this.styleParagraphWrapper.Defined.IsManagedParagraphDefined)
            {
                ...
                Text.ParagraphManagers.ItemListManager.Parameters p = this.styleParagraphWrapper
                    .Defined
                    .ItemListParameters;
            ...
            if (
                this.styleTextWrapper.Defined.IsFontFaceDefined
            ...
            )
            {
                ...
                if (this.styleTextWrapper.Defined.IsFontGlueDefined)
                {
                    ...
                    builder.Append(
                        this.GetBriefValue(
                            size,
                            Text.Properties.SizeUnits.Percent,
                            this.document.Modifier.RealScale
                        )
                    );
                    first = false;
            ...
            if (
                this.styleTextWrapper.Defined.IsUnderlineDefined
            ...
            if (
                this.styleTextWrapper.Defined.IsLanguageHyphenationDefined
        ...
        public void ExecuteCommand(string name, string advanceState)
        {
            ...
            switch (name)
            {
                case Commands.FontBold:
                    this.ChangeBold();
                    break;
                case Commands.FontItalic:
                    this.ChangeItalic();
                    break;
                case Commands.FontUnderline:
                    this.ChangeUnderline();
                    break;
                case Commands.FontOverline:
                    this.ChangeOverline();
                    break;
                case Commands.FontStrikeout:
                    this.ChangeStrikeout();
                    break;
                case Commands.FontSubscript:
                    this.ChangeSubscript();
                    break;
                case Commands.FontSuperscript:
                    this.ChangeSuperscript();
                    break;
                case Commands.FontSizePlus:
                    this.IncrementFontSize(1);
                    break;
                case Commands.FontSizeMinus:
                    this.IncrementFontSize(-1);
                    break;

                case "ParagraphLeading":
                    this.ChangeParagraphLeading(advanceState);
                    break;
                case "ParagraphJustif":
                    this.ChangeParagraphJustif(advanceState);
                    break;

                case "ParagraphLeadingPlus":
                    this.IncrementParagraphLeading(1);
                    break;
                case "ParagraphLeadingMinus":
                    this.IncrementParagraphLeading(-1);
                    break;
                case "ParagraphIndentPlus":
                    this.IncrementParagraphIndent(1);
                    break;
                case "ParagraphIndentMinus":
                    this.IncrementParagraphIndent(-1);
                    break;

                case Commands.FontClear:
                    this.FontClear();
                    break;
                case "ParagraphClear":
                    this.ParagraphClear();
        ...
        protected void ChangeParagraphLeading(string advanceState)
        {
            ...
            switch (advanceState)
            {
                case "ParagraphLeading08":
                    value = 0.8;
                    break;
                case "ParagraphLeading10":
                    value = 1.0;
                    break;
                case "ParagraphLeading12":
                    value = 1.2;
                    break;
                case "ParagraphLeading15":
                    value = 1.5;
                    break;
                case "ParagraphLeading20":
                    value = 2.0;
                    break;
                case "ParagraphLeading30":
                    value = 3.0;
                    break;
            }
        ...
        protected void IncrementParagraphIndent(int delta)
        {
            ...
            if (
                this.paragraphWrapper.Active.IsIndentationLevelAttributeDefined
            ...
            this.paragraphWrapper.DefineOperationName(
                "ParagraphIndent",
                Res.Strings.Action.ParagraphIndent
            );
            this.paragraphWrapper.ResumeSynchronizations();
        }
        ...
        protected void ChangeParagraphJustif(string advanceState)
        {
            ...
            switch (advanceState)
            {
                case "ParagraphJustifLeft":
                    mode = Text.Wrappers.JustificationMode.AlignLeft;
                    break;
                case "ParagraphJustifCenter":
                    mode = Text.Wrappers.JustificationMode.Center;
                    break;
                case "ParagraphJustifRight":
                    mode = Text.Wrappers.JustificationMode.AlignRight;
                    break;
                case "ParagraphJustifJustif":
                    mode = Text.Wrappers.JustificationMode.JustifyAlignLeft;
                    break;
                case "ParagraphJustifAll":
                    mode = Text.Wrappers.JustificationMode.JustifyJustfy;
                    break;
            }
        ...
        protected void ParagraphClear()
        {
            ...
            this.paragraphWrapper.DefineOperationName(
                "ParagraphClear",
                Res.Strings.Action.ParagraphClear
            );
            this.paragraphWrapper.ResumeSynchronizations();
        }
        ...
        public void FillSubscriptDefinition(
        ...
        public void FillSuperscriptDefinition(
            Common.Text.Wrappers.TextWrapper.XscriptDefinition xscript
        )
        {
            xscript.IsDisabled = false;
        ...
        protected bool UnderlineActiveState
        {
            ...
            get { return this.textWrapper.Active.IsUnderlineDefined; }
        }

        protected bool OverlineActiveState
        {
            //	Donne l'état de la commande 'surligné'.
            get { return this.textWrapper.Active.IsOverlineDefined; }
        }

        protected bool StrikeoutActiveState
        {
            //	Donne l'état de la commande 'biffé'.
            get { return this.textWrapper.Active.IsStrikeoutDefined; }
        }
        ...
        protected bool SubscriptActiveState
        {
            ...
            get
            {
                return this.textWrapper.Defined.IsXscriptDefined
                    && this.textWrapper.Defined.Xscript.Offset < 0.0;
            }
        }
        ...
        public void FontFaceComboUpdate(IconButtonsCombo combo)
        {
            ...
            foreach (OpenType.FontIdentity id in fontList)
            {
                ...
                string briefIcon = Misc.IconDyn(
                    string.Concat(this.document.UniqueName, ".TextFontBrief"),
                    parameter
                );
                string regularText = Misc.ImageDyn(
                    string.Concat(this.document.UniqueName, ".TextFontMenu"),
                    parameter
                );
                string tooltip = string.Format(
                    Res.Strings.Action.Apply.Tooltip.Font,
                    TextLayout.ConvertToTaggedText(id.InvariantFaceName)
                );

                combo.Items.Add(
                    new IconButtonsCombo.Item(
        ...
        protected bool DrawDynamicImageFontBrief(
            Graphics graphics,
            Size size,
            string argument,
        ...
        protected bool DrawDynamicImageFontMenu(
            Graphics graphics,
            Size size,
            string argument,
            GlyphPaintStyle style,
        ...
        )
        {
            ...
            if (graphics != null)
            {
                ...
                Path path = Common.Widgets.Helpers.FontPreviewer.GetPathAbc(
                    id,
                    140 + 5,
                    oy,
                    fontSize
        ...
        protected bool DrawDynamicImageStyleBrief(
            Graphics graphics,
            Size size,
            string argument,
            GlyphPaintStyle style,
        ...
        )
        {
            ...
            if (graphics != null)
            {
                ...
                Text.TextStyle textStyle = this.document.TextContext.StyleList.GetTextStyle(
                    styleName,
                    styleClass
                );
                ...
                string text = Misc.UserTextStyleName(
                    this.document.TextContext.StyleList.StyleMap.GetCaption(textStyle)
                );
                Color c = adorner.ColorText(WidgetPaintState.Enabled);
        ...
        protected bool DrawDynamicImageStyleMenu(
            Graphics graphics,
            Size size,
            string argument,
            GlyphPaintStyle style,
