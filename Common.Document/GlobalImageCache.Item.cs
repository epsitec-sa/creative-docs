        ...
        public class Item : System.IDisposable
        {
            public Item(string filename, string zipPath, System.DateTime date)
            {
                ...
                else
                {
                    GlobalImageCache.ExtractZipPathNames(
                        zipPath,
                        out this.zipFilename,
                        out this.zipEntryName
                    );
                }
            ...
            public bool IsFreeable(ImagePart part)
            {
                ...
                if (part == ImagePart.LargeOriginal)
                {
                    return (
                        this.originalImage != null
                        && this.originalImage.IsAlive
                        && this.IsLargeOriginal
                    );
                }
            ...
            public long KBOriginalWeight
            {
                ...
                get
                {
                    return ((long)this.originalSize.Width * (long)this.originalSize.Height)
                        / (1024 / 4);
                }
            }
            ...
            protected bool IsLargeOriginal
            {
                ...
                get { return (this.KBOriginalWeight > GlobalImageCache.ImageLimit); }
            }
            ...
            public double LowResScale
            {
                ...
                get { return this.lowResScale; }
            }

            public string LocalKeyName
            {
                get { return ImageManager.GetKey(this.filename, this.date); }
            }
            ...
            protected Drawing.Image ReadLowresImage(bool read)
            {
                ...
                string path =
                    this.zipFilename == null
                        ? string.Concat("file:", this.filename)
                        : GlobalImageCache.CreateZipPath(this.zipFilename, this.zipEntryName);
                ImageData imageData = GlobalImageCache.ImageManager.GetImage(
                    path,
                    this.filename,
                    this.date
                );
            ...
            protected Drawing.Image ReadOriginalImage(bool read)
            {
                ...
                if (this.originalImage != null)
                {
                    System.Diagnostics.Debug.WriteLine(
                        string.Format("GC collected image {0}", this.filename)
                    );
                }
            ...
            public ImageFileReference GetLowLevelFileReference()
            {
                ...
                else
                {
                    ...
                    if (ok)
                    {
                        return new ImageFileReference(
                            zip[this.zipEntryName].Data,
                            this.zipEntryName
                        );
                    }
                }
