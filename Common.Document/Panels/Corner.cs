...
namespace Epsitec.Common.Document.Panels
{
    ...
    public class Corner : Abstract
    {
            ...
            : base(document)
        {
            ...
            this.fieldRadius = new Widgets.TextFieldLabel(
                this,
            ...
            this.fieldEffect1 = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldEffect2 = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
        ...
        protected void AddRadioIcon(Properties.CornerType type, bool endOfLine)
        {
            this.grid.AddRadioIcon(
                Misc.Icon(Properties.Corner.GetIconText(type)),
                Properties.Corner.GetName(type),
                (int)type,
                endOfLine
            );
        }
                ...
                if (this.isExtendedSize) // panneau étendu ?
                {
                    if (this.IsLabelProperties) // étendu/détails ?
                    {
                        ...
                        if (type == Properties.CornerType.Right)
                        {
                            ...
                            type == Properties.CornerType.Round
        ...
        protected void EnableWidgets()
        {
            ...
            double effect2,
                min2,
                max2;
            Properties.Corner.GetFieldsParam(
                type,
                out enableRadius,
                out enable1,
                out effect1,
