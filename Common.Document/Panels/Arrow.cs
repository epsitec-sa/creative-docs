...
namespace Epsitec.Common.Document.Panels
{
    ...
    {
        public Arrow(Document document)
            : base(document)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                this.fieldLength[j] = new Widgets.TextFieldLabel(
                    this,
                ...
                this.document.Modifier.AdaptTextFieldRealDimension(
                    this.fieldLength[j].TextFieldReal
                );
                ...
                ToolTip.Default.SetToolTip(
                    this.fieldLength[j],
                    Res.Strings.Panel.Arrow.Tooltip.Length
                );

                this.fieldEffect1[j] = new Widgets.TextFieldLabel(
                    this,
                    Widgets.TextFieldLabel.Type.TextFieldReal
                );
                ...
                ToolTip.Default.SetToolTip(
                    this.fieldEffect1[j],
                    Res.Strings.Panel.Arrow.Tooltip.Effect1
                );

                this.fieldEffect2[j] = new Widgets.TextFieldLabel(
                    this,
                    Widgets.TextFieldLabel.Type.TextFieldReal
                );
                ...
                ToolTip.Default.SetToolTip(
                    this.fieldEffect2[j],
                    Res.Strings.Panel.Arrow.Tooltip.Effect2
                );
            }
        ...
        protected void AddRadioIcon(int j, Properties.ArrowType type, bool endOfLine)
        {
            this.grid[j]
                .AddRadioIcon(
                    Misc.Icon(Properties.Arrow.GetIconText(type)),
                    Properties.Arrow.GetName(type),
                    (int)type,
                    endOfLine
                );
        }
        ...
        protected override void PropertyToWidgets()
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                ...
                this.fieldEffect1[j].TextFieldReal.InternalValue =
                    (decimal)p.GetEffect1(j ^ 1) * 100;
                this.fieldEffect2[j].TextFieldReal.InternalValue =
                    (decimal)p.GetEffect2(j ^ 1) * 100;
            }
        ...
        protected int GetTotalTextField(int j)
        {
            ...
            if (type == Properties.ArrowType.Right)
                return 0;
            if (type == Properties.ArrowType.ArrowOutline)
                return 2;
            if (type == Properties.ArrowType.Slash)
                return 2;
            if (type == Properties.ArrowType.Dot)
                return 1;
            if (type == Properties.ArrowType.Square)
                return 1;
            if (type == Properties.ArrowType.Diamond)
                return 1;
            return 3;
        }
