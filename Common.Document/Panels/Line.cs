...
namespace Epsitec.Common.Document.Panels
{
    ...
    public class Line : Abstract
    {
            ...
            : base(document)
        {
            ...
            this.field = new Widgets.TextFieldLabel(
                this,
            ...
            this.fieldStandardLength = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.document.Modifier.AdaptTextFieldRealDimension(
                this.fieldStandardLength.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldStandardLength,
                Res.Strings.Panel.Line.Tooltip.DashLength
            );

            this.fieldDashPen = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldDashGap = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
        ...
        protected void AddRadioIcon(Properties.StandardDashType type)
        {
            this.grid.AddRadioIcon(
                Misc.Icon(Properties.Line.GetIconText(type)),
                Properties.Line.GetName(type),
                (int)type,
                false
            );
        }
            ...
            get
            {
                ...
                if (this.isExtendedSize) // panneau étendu ?
                {
                    if (this.IsLabelProperties) // étendu/détails ?
                    {
                        ...
                        Properties.StandardDashType type = (Properties.StandardDashType)
                            this.grid.SelectedValue;
        ...
        protected override void WidgetsToProperty()
        {
            ...
            Properties.StandardDashType newType = (Properties.StandardDashType)
                this.grid.SelectedValue;
        ...
        protected int RadioSelected
        {
            ...
            set
            {
                for (int i = 0; i < Properties.Line.DashMax; i++)
                {
                    this.radioDashRank[i].ActiveState =
                        (i == value) ? ActiveState.Yes : ActiveState.No;
                }
            }
        }
        ...
        protected void EnableWidgets()
        {
            ...
            if (this.isExtendedSize) // panneau étendu ?
            {
                ...
                {
                    if (
                        type != Properties.StandardDashType.Full
        ...
        protected override void UpdateClientGeometry()
        {
            ...
            if (this.isExtendedSize) // panneau étendu ?
            {
                ...
                else // étendu/compact ?
                {
                    ...
                    for (int i = 0; i < Properties.Line.DashMax; i++)
                    {
                        if (i == Properties.Line.DashMax - 1)
                            r.Width = 32;
                        this.radioDashRank[i].SetManualBounds(r);
                        r.Offset(r.Width, 0);
                    }
