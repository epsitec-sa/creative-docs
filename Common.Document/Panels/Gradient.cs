...
namespace Epsitec.Common.Document.Panels
{
    ...
    {
        public Gradient(Document document)
            : base(document)
        {
            ...
            ToolTip.Default.SetToolTip(
                this.nothingButton,
                Res.Strings.Panel.Gradient.Tooltip.Nothing
            );
            ...
            this.fieldAngle = new Widgets.TextFieldLabel(
                this,
            ...
            ToolTip.Default.SetToolTip(
                this.radioHatchRank[0],
                Res.Strings.Panel.Gradient.Tooltip.Hatch1
            );
            ToolTip.Default.SetToolTip(
                this.radioHatchRank[1],
                Res.Strings.Panel.Gradient.Tooltip.Hatch2
            );
            this.RadioSelected = 0;

            this.fieldRepeat = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldMiddle = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldSmooth = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.fieldHatchAngle = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldHatchAngle,
                Res.Strings.Panel.Gradient.Tooltip.HatchAngle
            );

            this.fieldHatchWidth = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldHatchWidth,
                Res.Strings.Panel.Gradient.Tooltip.HatchWidth
            );

            this.fieldHatchDistance = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            this.document.Modifier.AdaptTextFieldRealDimension(
                this.fieldHatchDistance.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fieldHatchDistance,
                Res.Strings.Panel.Gradient.Tooltip.HatchDistance
            );
        ...
        protected void AddRadioIcon(Properties.GradientFillType type, bool endOfLine)
        {
            this.grid.AddRadioIcon(
                Misc.Icon(Properties.Gradient.GetIconText(type)),
                Properties.Gradient.GetName(type),
                (int)type,
                endOfLine
            );
        }
            ...
            get
            {
                ...
                if (this.isExtendedSize) // panneau étendu ?
                {
                    if (this.IsLabelProperties) // étendu/détails ?
                    {
                        ...
                        Properties.GradientFillType type = (Properties.GradientFillType)
        ...
        protected int RadioSelected
        {
            ...
            set
            {
                for (int i = 0; i < Properties.Gradient.HatchMax; i++)
                {
                    this.radioHatchRank[i].ActiveState =
        ...
        protected override void UpdateClientGeometry()
        {
            ...
            if (this.isExtendedSize) // panneau étendu ?
            {
                ...
                if (this.IsLabelProperties) // étendu/détails ?
                {
                    ...
                    if (
                        type == Properties.GradientFillType.None
                        || type == Properties.GradientFillType.Linear
                        || type == Properties.GradientFillType.Circle
                        || type == Properties.GradientFillType.Diamond
                        || type == Properties.GradientFillType.Conic
                    ...
                    if (
                        type == Properties.GradientFillType.Hatch
                ...
                else // étendu/compact ?
                {
                    ...
                    for (int i = 0; i < Properties.Gradient.HatchMax; i++)
                    {
                        if (i == Properties.Gradient.HatchMax - 1)
                            r.Width = 32;
                        this.radioHatchRank[i].SetManualBounds(r);
                        r.Offset(r.Width, 0);
                    }
        ...
        private void HandleFieldColorClicked(object sender, MessageEventArgs e)
        {
            ...
            if (this.originFieldColor == this.fieldColor1)
                this.originFieldRank = 0;
            if (this.originFieldColor == this.fieldColor2)
                this.originFieldRank = 1;
