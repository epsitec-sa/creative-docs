...
namespace Epsitec.Common.Document.Panels
{
    ...
    public class Dimension : Abstract
    {
            ...
            : base(document)
        {
            ...
            this.addLength = new Widgets.TextFieldLabel(
                this,
            ...
            ToolTip.Default.SetToolTip(
                this.addLength,
                Res.Strings.Panel.Dimension.Tooltip.AddLength
            );

            this.outLength = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.outLength,
                Res.Strings.Panel.Dimension.Tooltip.OutLength
            );
            ...
            ToolTip.Default.SetToolTip(
                this.rotateText,
                Res.Strings.Panel.Dimension.Tooltip.RotateText
            );

            this.fontOffset = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextFieldReal
            );
            ...
            ToolTip.Default.SetToolTip(
                this.fontOffset,
                Res.Strings.Panel.Dimension.Tooltip.FontOffset
            );

            this.dimensionText = new Widgets.TextFieldLabel(
                this,
                Widgets.TextFieldLabel.Type.TextField
            );
            ...
            ToolTip.Default.SetToolTip(
                this.dimensionText,
                Res.Strings.Panel.Dimension.Tooltip.Text
            );
        ...
        {
            this.gridForm.AddRadioIcon(
                Misc.Icon(Properties.Dimension.GetIconText(type)),
                Properties.Dimension.GetName(type),
                (int)type,
                false
            );
        }
        ...
        private void HandleRotateTextClicked(object sender, MessageEventArgs e)
        {
            ...
            button.ActiveState =
                (button.ActiveState == ActiveState.No) ? ActiveState.Yes : ActiveState.No;
