...
namespace Epsitec.Common.Document.Panels
{
    ...
    {
        public Regular(Document document)
            : base(document)
        {
            ...
            this.fieldNbFaces = new Widgets.TextFieldLabel(
                this,
        ...
        protected void AddRadioIcon(Properties.RegularType type)
        {
            this.grid.AddRadioIcon(
                Misc.Icon(Properties.Regular.GetIconText(type)),
                Properties.Regular.GetName(type),
                (int)type,
                false
            );
        }
        ...
        public override double DefaultHeight
        {
            ...
            get
            {
                return (
                    this.isExtendedSize
                        ? this.LabelHeight + 5 + 25 * 7
                        : this.LabelHeight + 5 + 25 * 1
                );
            }
        }
        ...
        protected override void WidgetsToProperty()
        {
            ...
            p.Deep = new Polar(
                (double)this.fieldDeep.TextFieldR.InternalValue / 100,
                (double)this.fieldDeep.TextFieldA.InternalValue
            );
            p.E1 = new Polar(
                (double)this.fieldE1.TextFieldR.InternalValue / 100,
                (double)this.fieldE1.TextFieldA.InternalValue
            );
            p.E2 = new Polar(
                (double)this.fieldE2.TextFieldR.InternalValue / 100,
                (double)this.fieldE2.TextFieldA.InternalValue
            );
            p.I1 = new Polar(
                (double)this.fieldI1.TextFieldR.InternalValue / 100,
                (double)this.fieldI1.TextFieldA.InternalValue
            );
            p.I2 = new Polar(
                (double)this.fieldI2.TextFieldR.InternalValue / 100,
                (double)this.fieldI2.TextFieldA.InternalValue
            );
        ...
        private struct Sample
        {
            ...
            public Sample(
                string text,
                Properties.RegularType regularType,
                int nbFaces,
                Polar deep,
                Polar i1,
                Polar i2,
            ...
            public bool Compare(Properties.Regular reg)
            {
                ...
                return (
                    reg.RegularType == this.RegularType
        ...
        {
            new Sample(
                Res.Strings.Panel.Regular.Sample01,
                Properties.RegularType.Norm,
                3,
                new Polar(0.50, 0.0),
                new Polar(0.60, 10.0),
                new Polar(0.60, -10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample02,
                Properties.RegularType.Norm,
                4,
                new Polar(0.50, 0.0),
                new Polar(0.60, 10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample03,
                Properties.RegularType.Norm,
                6,
                new Polar(0.50, 0.0),
                new Polar(0.60, 10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample04,
                Properties.RegularType.Norm,
                8,
                new Polar(0.50, 0.0),
                new Polar(0.60, 10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample05,
                Properties.RegularType.Star,
                6,
                new Polar(0.42, 0.0),
                new Polar(0.60, 10.0),
                new Polar(0.60, -10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample06,
                Properties.RegularType.Star,
                24,
                new Polar(0.05, -8.0),
                new Polar(0.60, 10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample07,
                Properties.RegularType.Star,
                20,
                new Polar(0.65, 0.0),
                new Polar(0.60, 10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample08,
                Properties.RegularType.Flower2,
                20,
                new Polar(0.65, -50.0),
                new Polar(0.55, -8.0),
                new Polar(0.40, -12.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample09,
                Properties.RegularType.Flower1,
                6,
                new Polar(0.50, 0.0),
                new Polar(0.60, 10.0),
                new Polar(0.60, -10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample10,
                Properties.RegularType.Flower1,
                4,
                new Polar(0.80, 0.0),
                new Polar(0.25, 30.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample11,
                Properties.RegularType.Flower1,
                16,
                new Polar(0.25, 0.0),
                new Polar(0.35, 8.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample12,
                Properties.RegularType.Flower1,
                8,
                new Polar(0.55, 0.0),
                new Polar(0.25, 16.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample13,
                Properties.RegularType.Flower2,
                6,
                new Polar(0.85, 20.0),
                new Polar(0.40, -16.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample14,
                Properties.RegularType.Flower2,
                8,
                new Polar(0.75, -10.0),
                new Polar(0.50, -10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample15,
                Properties.RegularType.Flower1,
                4,
                new Polar(0.80, 0.0),
                new Polar(0.70, 0.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample16,
                Properties.RegularType.Flower1,
                16,
                new Polar(0.75, 0.0),
                new Polar(0.65, 3.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample17,
                Properties.RegularType.Flower1,
                24,
                new Polar(0.55, 0.0),
                new Polar(0.60, 0.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample18,
                Properties.RegularType.Flower2,
                3,
                new Polar(0.80, -30.0),
                new Polar(0.40, 30.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample19,
                Properties.RegularType.Flower2,
                4,
                new Polar(0.90, 0.0),
                new Polar(0.50, -10.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample20,
                Properties.RegularType.Flower2,
                5,
                new Polar(0.75, -90.0),
                new Polar(0.60, 30.0),
            ...
            new Sample(
                Res.Strings.Panel.Regular.Sample21,
                Properties.RegularType.Flower2,
                8,
                new Polar(1.00, -90.0),
                new Polar(0.15, 90.0),
