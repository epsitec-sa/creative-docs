...
namespace Epsitec.Common.Document.Panels
{
    ...
    public abstract class Abstract : Common.Widgets.Widget
    {
        ...
        protected double LabelHeight
        {
            ...
            get { return (this.IsLabelProperties || this is ModColor) ? 14 : 0; }
        }
        ...
        public bool IsObjectHilite
        {
            ...
            get { return this.isObjectHilite; }
            set
            {
        ...
        private void HandleMouseExited(object sender, MessageEventArgs e)
        {
            ...
            if (this.document.Modifier == null)
                return;
            if (this.document.Modifier.PropertiesDetailMany == false)
                return;
            if (this.property == null)
                return;
        ...
        public Properties.Abstract Property
        {
            ...
            {
                this.property = value;
                this.backgroundIntensity = Properties.Abstract.BackgroundIntensity(
                    this.property.Type
                );
                ...
                ToolTip.Default.SetToolTip(
                    this.fixIcon,
                    Properties.Abstract.Text(this.property.Type)
                );
            }
        }
        ...
        protected void UpdateButtons()
        {
            ...
            this.extendedButton.GlyphShape = this.isExtendedSize
                ? GlyphShape.ArrowUp
        ...
        protected virtual void OnChanged()
        {
            ...
            if (this.property != null)
            {
                ...
                string name = string.Format(
                    Res.Strings.Action.PropertyChange,
                    Properties.Abstract.Text(this.property.Type)
                );
        ...
        protected override void PaintBackgroundImplementation(Graphics graphics, Rectangle clipRect)
        {
            ...
            Drawing.Color color = Drawing.Color.FromAlphaRgb(
                1.0 - this.backgroundIntensity,
                0.5 + cap.R * 0.5,
                0.5 + cap.G * 0.5,
                0.5 + cap.B * 0.5
            );
