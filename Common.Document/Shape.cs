...
namespace Epsitec.Common.Document
{
    ...
    public class Shape
    {
        ...
        public bool IsMisc
        {
            ...
            get { return this.isMisc; }
            set { this.isMisc = value; }
        }
        ...
        public bool IsLinkWithNext
        {
            ...
            get { return this.isLinkWithNext; }
            set { this.isLinkWithNext = value; }
        }
        ...
        {
            get { return this.propertySurface; }
        }

        public Properties.Line PropertyStroke
        {
            get { return this.propertyStroke; }
        }
        ...
        protected void PropertyVisibility(IPaintPort port)
        {
            ...
            if (this.Type == Type.Stroke)
            {
                ...
                {
                    this.IsVisible =
                        this.propertyStroke.IsVisible(port) && this.propertySurface.IsVisible(port);
                }
            }
        }
        ...
        protected void PropertyVisibilityInvert(IPaintPort port)
        {
            ...
            if (this.Type == Type.Stroke)
            {
                ...
                {
                    this.IsVisible =
                        !this.propertyStroke.IsVisible(port)
                        || !this.propertySurface.IsVisible(port);
                }
            }
        }
        ...
        public static void Hilited(IPaintPort port, Shape[] shapes)
        {
            ...
            foreach (Shape shape in shapes)
            {
                if (shape == null)
                    continue;
                if (shape.Aspect == Aspect.InvisibleBox)
                    continue;
                if (shape.Aspect == Aspect.OnlyDetect)
                    continue;
