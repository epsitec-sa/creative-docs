...
namespace Epsitec.Common.Document.PDF
{
    ...
    public sealed class ImageSurface : System.IDisposable
    {
        ...
        {
            get { return this.fileReference == null ? null : this.fileReference.Path; }
        }
        ...
        public bool Exists
        {
            ...
            get { return this.BitmapSize != Size.Zero; }
        }
        ...
        public PdfImageStream ImageStream { get; set; }

        public ImageCompression ImageCompression { get; set; }

        public PdfComplexSurfaceType SurfaceType { get; set; }

        public BitmapColorType ColorType { get; set; }
        ...
        public void Update(string source)
        {
            ...
            this.ColorType = Epsitec.Common.Types.InvariantConverter.ToEnum<BitmapColorType>(
                (string)surface.Attribute("colorType")
            );
        }
        ...
        public static ImageSurface Deserialize(string source)
        {
            ...
            item.ColorType = Epsitec.Common.Types.InvariantConverter.ToEnum<BitmapColorType>(
                (string)surface.Attribute("colorType")
            );
            item.ColorConversion = Epsitec.Common.Types.InvariantConverter.ToEnum<ColorConversion>(
                (string)surface.Attribute("colorConv")
            );
            item.JpegQuality = (double)surface.Attribute("jpegQuality");
            item.SurfaceType =
                Epsitec.Common.Types.InvariantConverter.ToEnum<PdfComplexSurfaceType>(
                    (string)surface.Attribute("surfaceType")
                );
            item.ImageCompression =
                Epsitec.Common.Types.InvariantConverter.ToEnum<ImageCompression>(
                    (string)surface.Attribute("compression")
                );
        ...
        public static ImageSurface Search(
            IEnumerable<ImageSurface> list,
            string filename,
            Size size,
            Margins crop,
            ImageFilter filter
