...
namespace Epsitec.Common.Document.Settings
{
    ...
    public class Guide : ISerializable, IXMLSerializable<Guide>
    {
        ...
        public bool IsHorizontal
        {
            ...
            {
                return (
                    this.type == GuideType.HorizontalBottom
        ...
        public static string TypeToString(GuideType type)
        {
            ...
            {
                case GuideType.HorizontalBottom:
                    return Res.Strings.Container.Guides.HorizontalBottom;
                case GuideType.HorizontalCenter:
                    return Res.Strings.Container.Guides.HorizontalCenter;
                case GuideType.HorizontalTop:
                    return Res.Strings.Container.Guides.HorizontalTop;
                case GuideType.VerticalLeft:
                    return Res.Strings.Container.Guides.VerticalLeft;
                case GuideType.VerticalCenter:
                    return Res.Strings.Container.Guides.VerticalCenter;
                case GuideType.VerticalRight:
                    return Res.Strings.Container.Guides.VerticalRight;
            }
            return "?";
        }
        ...
        public static GuideType StringToType(string text)
        {
            foreach (int value in System.Enum.GetValues(typeof(GuideType)))
            {
                ...
                if (text == Guide.TypeToString(type))
                    return type;
            }
