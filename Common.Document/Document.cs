    ...
    public class Document : ISerializable, IXMLSerializable<Document>
    {
        ...
        public Document DocumentForSamples
        {
            ...
            get
            {
                ...
                {
                    this.documentForSamples = new Document(
                        DocumentType.Graphic,
                        DocumentMode.Samples,
                        InstallType.Full,
                        DebugMode.Release,
                        this.GlobalSettings,
                        null,
        ...
        public Objects.TextBox2 ObjectForSamplesParagraph
        {
            ...
            get
            {
                ...
                {
                    this.objectForSamplesParagraph = new Objects.TextBox2(
                        this.DocumentForSamples,
                        null
                    );
                    this.objectForSamplesParagraph.CreateForSample();
                    this.objectForSamplesParagraph.EditInsertText(
                        Res.Strings.Sample.Paragraph,
                        "",
                        ""
                    );
                }
        ...
        public Objects.TextLine2 ObjectForSamplesCharacter
        {
            ...
            get
            {
                ...
                {
                    this.objectForSamplesCharacter = new Objects.TextLine2(
                        this.DocumentForSamples,
                        null
                    );
                    this.objectForSamplesCharacter.CreateForSample();
                    this.objectForSamplesCharacter.EditInsertText(
                        Res.Strings.Sample.Character,
                        "",
                        ""
                    );
                }
        ...
        public DocumentManager DocumentManager
        {
            ...
            //	pas avant.
            get { return this.ioDocumentManager; }
        }
        ...
        */
        public bool IsSurfaceRotation
        {
            ...
            get { return this.isSurfaceRotation; }
            set { this.isSurfaceRotation = value; }
        }

        public double SurfaceRotationAngle
        {
            //	Angle de la rotation spéciale pour calculer SurfaceAnchor.
            get { return this.surfaceRotationAngle; }
            set { this.surfaceRotationAngle = value; }
        }
        ...
        public Size DocumentSize
        {
            ...
            set
            {
                if (this.size != value)
                {
                    ...
                    {
                        this.modifier.OpletQueueBeginAction(
                            Res.Strings.Action.DocumentSize,
                            "ChangeDocSize"
                        );
        ...
        public Size GetPageSize(Objects.Page page)
        {
            ...
            if (page != null)
            {
                if (page.PageSize.Width != 0)
                    size.Width = page.PageSize.Width;
                if (page.PageSize.Height != 0)
                    size.Height = page.PageSize.Height;
            }
        ...
        public int ExportFilter
        {
            ...
            get { return this.exportFilter; }
            set { this.exportFilter = value; }
        }

        public bool IsDirtySerialize
        {
            //	Indique si la sérialisation est nécessaire.
            get { return this.isDirtySerialize; }
        }
        ...
        protected void SetDirtyCacheBitmap(CacheBitmapChanging changing)
        {
            ...
            if (
                changing == CacheBitmapChanging.None
                || this.pageMiniatures == null
                || this.layerMiniatures == null
            )
            {
                return;
            }
            ...
            try
            {
                ...
                if (
                    ...
                    && zip.TryLoadFile(
                        ...
                        {
                            return entryName == "document.data" || entryName.StartsWith("fonts/");
                        }
                    )
                )
                {
        ...
        private string Read(Stream stream, string directory, ZipFile zip, bool isCrDoc)
        {
            ...
            if (type == IOType.BinaryCompress)
            {
                ...
                try
                {
                    if (zip == null)
                    {
                        ...
                        using (
                            Stream compressor = IO.Decompression.CreateStream(
                                stream,
                                out compressorName
                            )
                        )
            ...
            if ((this.imageCache != null) && (doc.imageCache != null))
            {
        ...
        private void ReadFinalize()
        {
            ...
            if (this.textContext != null)
            {
                ...
                if (list.Length == 0)
                {
                    ...
                    Text.TextStyle paraStyle = this.textContext.StyleList[
                        "Default",
                        Text.TextStyleClass.Paragraph
                    ];
                    Text.TextStyle charStyle = this.textContext.StyleList[
                        "Default",
                        Text.TextStyleClass.Text
                    ];
                    ...
                    if (paraStyle == null)
                        throw new System.ArgumentNullException("No default paragraph style found");

                    this.textContext.DefaultParagraphStyle = paraStyle;
                    this.textContext.StyleList.StyleMap.SetRank(null, paraStyle, 0);
                    this.textContext.StyleList.StyleMap.SetCaption(
                        null,
                        paraStyle,
                        Res.Strings.Style.Paragraph.Base
                    );
                    ...
                    if (charStyle == null)
                    {
                        charStyle = this.textContext.StyleList.NewTextStyle(
                            null,
                            "Default",
                            Text.TextStyleClass.Text
                        );
                    ...
                    this.textContext.StyleList.StyleMap.SetCaption(
                        null,
                        charStyle,
                        Res.Strings.Style.Character.Base
                    );
                }
            }
        ...
        protected Properties.Aggregate OldStylesSearchAggregate(
        ...
        )
        {
            ...
            {
                if (agg.Styles.Count != list.Length)
                    continue;
        ...
        protected Properties.Aggregate OldStylesCreateAggregate(
            Objects.Abstract obj,
            Properties.Type[] list
        )
        {
            ...
            {
                Properties.Abstract property = Properties.Abstract.NewProperty(
        ...
        protected void OldStylesUseAggregate(
            Objects.Abstract obj,
            Properties.Type[] list,
        ...
        {
            if (Misc.IsExtension(path, ".crdoc"))
                return DocumentFileExtension.CrDoc;
            if (Misc.IsExtension(path, ".crmod"))
                return DocumentFileExtension.CrMod;
            if (Misc.IsExtension(path, ".icon"))
                return DocumentFileExtension.Icon;
            if (Misc.IsExtension(path, ".iconmod"))
                return DocumentFileExtension.IconMod;
        ...
        protected Document(SerializationInfo info, StreamingContext context)
        {
            ...
            else
            {
                this.settings = (Settings.Settings)
                    info.GetValue("Settings", typeof(Settings.Settings));
                ...
                {
                    this.readObjectMemory = (Objects.Memory)
                        info.GetValue("ObjectMemory", typeof(Objects.Memory));
                    this.readObjectMemoryText = (Objects.Memory)
                        info.GetValue("ObjectMemoryText", typeof(Objects.Memory));
                }
                else
                {
                ...
                {
                    byte[] textContextData = (byte[])
                        info.GetValue("TextContextData", typeof(byte[]));
                ...
                {
                    this.fontList =
                        (List<OpenType.FontName>)
                            info.GetValue("FontList", typeof(List<OpenType.FontName>));
                }
                else
                {
                    this.fontList = null;
                ...
                {
                    this.fontIncludeMode = (FontIncludeMode)
                        info.GetValue("FontIncludeMode", typeof(FontIncludeMode));
                    this.imageIncludeMode = (ImageIncludeMode)
                        info.GetValue("ImageIncludeMode", typeof(ImageIncludeMode));
                }
                else
                {
                    this.fontIncludeMode = FontIncludeMode.Used;
        ...
        public static IDocumentInfo GetDocumentInfo(string path)
        {
            ...
            if (dataImage != null || dataDocInfo != null)
            {
                ...
                if (dataDocInfo != null)
                {
                    ...
                    {
                        Statistics loaded =
                            Serialization.DeserializeFromMemory(dataDocInfo) as Document.Statistics;
                        stat = loaded;
                    }
                    catch { }
                }
        ...
        private static void ReadDocumentData(
            string path,
            out byte[] dataImage,
            out byte[] dataDocInfo
        )
        {
        ...
        protected void WriteStatistics(ZipFile zip, int priority)
        {
            ...
            if (format == null)
            {
                stat.PageFormat = string.Format(
                    "{0} × {1}",
                    this.modifier.RealToString(stat.PageSize.Width),
                    this.modifier.RealToString(stat.PageSize.Height)
                );
            }
            else
            {
        ...
        protected void FontUpdate()
        {
            ...
            if (this.fontIncludeMode == FontIncludeMode.All)
            {
                ...
                {
                    Text.Property[] properties = style.FindProperties(
                        Text.Properties.WellKnownType.Font
                    );
                    foreach (Text.Property property in properties)
                    {
                        Text.Properties.FontProperty font =
                            property as Text.Properties.FontProperty;
                        OpenType.FontName f = new Epsitec.Common.OpenType.FontName(
                            font.FaceName,
                            font.StyleName
                        );
        ...
        protected static bool IsStandardFont(string faceName)
        {
            ...
            return (
                faceName == "Arial" || faceName == "Times New Roman" || faceName == "Courier New"
            );
        }
        ...
        {
            //	Dessine le document.
            if (drawingContext.RootStackIsEmpty)
                return;
        ...
        )
        {
            if (drawingContext.PreviewActive)
            {
                ...
                {
                    rankLayer++;
                    if (rankLayer < firstLayer || rankLayer > lastLayer)
                        continue;
                    if (layer.Print == Objects.LayerPrint.Hide)
                        continue;

                    Properties.ModColor modColor = layer.PropertyModColor;
                    graphics.PushColorModifier(
                        new ColorModifierCallback(drawingContext.DimmedColor)
                    );
                    ...
                    foreach (Objects.Abstract obj in this.Deep(layer))
                    {
                        ...
                        if (!obj.BoundingBox.IntersectsWith(clipRect))
                            continue;
            ...
            else
            {
                ...
                foreach (Objects.Layer layer in this.Flat(page))
                {
                    ...
                    {
                        if (
                            layer.Type == Objects.LayerType.Hide
                        ...
                        if (
                            layer.Type == Objects.LayerType.Dimmed
                    ...
                    foreach (DeepBranchEntry entry in this.DeepBranch(layer, branch))
                    {
                        ...
                        {
                            if (!drawingContext.HideHalfActive)
                                continue;
        ...
        */
        ...
        protected void CreateDefaultTextContext()
        {
            ...
            string indentAttribute = Text.TabList.PackToAttribute(
                System.Globalization.RegionInfo.CurrentRegion.IsMetric
                    ? "LevelMultiplier:10 mm"
                    : "LevelMultiplier:0.5 in"
            );
            double fontSize = (this.type == DocumentType.Pictogram) ? 1.2 : 12.0;

            System.Collections.ArrayList properties = new System.Collections.ArrayList();
            properties.Add(
                new Text.Properties.FontProperty(
                    "Arial",
                    Misc.DefaultFontStyle("Arial"),
                    "kern",
                    "liga"
                )
            );
            ...
            properties.Add(
                new Text.Properties.MarginsProperty(
                    0,
                    0,
                    0,
                    0,
                    ...
                    15,
                    1,
                    Text.Properties.ThreeState.True,
                    0,
                    indentAttribute
                )
            );
            ...
            properties.Add(
                new Text.Properties.LanguageProperty(
                    System.Globalization.CultureInfo.CurrentCulture.Name,
                    1.0
                )
            );
            properties.Add(
                new Text.Properties.LeadingProperty(
                    1.0,
                    Text.Properties.SizeUnits.PercentNotCombining,
                    0.0,
                    Text.Properties.SizeUnits.Points,
                    0.0,
                    Text.Properties.SizeUnits.Points,
                    Text.Properties.AlignMode.None
                )
            );
            properties.Add(
                new Text.Properties.KeepProperty(
                    2,
                    2,
                    Text.Properties.ParagraphStartMode.Anywhere,
                    Text.Properties.ThreeState.False,
                    Text.Properties.ThreeState.False
                )
            );
            Text.TextStyle paraStyle = this.textContext.StyleList.NewTextStyle(
                null,
                "Default",
                Text.TextStyleClass.Paragraph,
                properties
            );
            Text.TextStyle charStyle = this.textContext.StyleList.NewTextStyle(
                null,
                "Default",
                Text.TextStyleClass.Text
            );
        ...
        public Text.TextStyle[] TextStyles(StyleCategory category)
        {
            ...
            System.Diagnostics.Debug.Assert(
                category == StyleCategory.Paragraph || category == StyleCategory.Character
            );
            Text.TextStyle[] list = this.TextContext.StyleList.StyleMap.GetSortedStyles();
            int total = 0;
            foreach (Text.TextStyle style in list)
            {
                if (
                    category == StyleCategory.Paragraph
                    && style.TextStyleClass == Text.TextStyleClass.Paragraph
                )
                    total++;
                if (
                    category == StyleCategory.Character
                    && style.TextStyleClass == Text.TextStyleClass.Text
                )
                    total++;
            }
            ...
            this.SetSelectedTextStyle(
                category,
                System.Math.Min(this.GetSelectedTextStyle(category), extract.Length - 1)
            );
        ...
        public void SetSelectedTextStyle(StyleCategory category, int rank)
        {
            ...
            if (category == StyleCategory.Paragraph)
                this.selectedParagraphStyle = rank;
            if (category == StyleCategory.Character)
                this.selectedCharacterStyle = rank;
        }
        #endregion
        ...
        protected class FlatEnumerable
        ...
        protected class FlatReverseEnumerable
            : System.Collections.IEnumerable,
                System.Collections.IEnumerator
        {
            public FlatReverseEnumerable(
                Document document,
                Objects.Abstract root,
                bool onlySelected
            )
            {
                this.document = document;
        ...
        //	physiquement !
        protected class DeepEnumerable
            : System.Collections.IEnumerable,
                System.Collections.IEnumerator
        {
        ...
        #region DeepBranch
        public System.Collections.IEnumerable DeepBranch(
            Objects.Abstract root,
            Objects.Abstract branch
        )
        {
        ...
        protected class DeepBranchEnumerable
            : System.Collections.IEnumerable,
                System.Collections.IEnumerator
        {
            public DeepBranchEnumerable(
                Document document,
                Objects.Abstract root,
                Objects.Abstract branch
            )
        ...
        public string UniqueName
        {
            ...
            get
            {
                return string.Concat(
                    "Document-",
                    this.uniqueID.ToString(System.Globalization.CultureInfo.InvariantCulture)
                );
            }
        }
