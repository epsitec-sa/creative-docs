...
(function ($) {
    ...
    function Chat(options) {
        ...
        _this.playSound = function (filename) {
            ...
            $soundContainer.html('<audio autoplay="autoplay"><source src="../sound/' + filename + '.mp3" type="audio/mpeg" /><source src=../sound/"' + filename + '.ogg" type="audio/ogg" /><embed hidden="true" autostart="true" loop="false" src=../sound/"' + filename + '.mp3" /></audio>');
        };
