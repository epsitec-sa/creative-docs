...
namespace Epsitec.Common.Tests.FormEngine
{
    ...
    public class FormEngineTest
    {
        ...
        protected FormDescription GetForm(string name)
        {
            ...
            if (name == "Adresse")
            {
                ...
                fields.Add(
                    this.CreateField(
                        "[63083]",
                        FieldDescription.BackColorType.None,
                        FieldDescription.SeparatorType.Normal,
                        10,
                        2
                    )
                ); // Rue
            ...
            if (name == "Facture")
            {
                ...
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.All, 1, 7)
                );
                fields.Add(
                    this.CreateField(
                        "[630A2]",
                ...
                fields.Add(
                    this.CreateField(
                        "[630B2].[63003].[63043].[63053]",
                        FieldDescription.BackColorType.None,
                        FieldDescription.SeparatorType.Normal,
                        10,
                        1
                    )
                ); // Affaire.Paiements.Valeur.PrixSimple.Montant
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
                        "[630B2].[63003].[63043].[63063].[630A]",
                        FieldDescription.BackColorType.None,
                        FieldDescription.SeparatorType.Normal,
                        10,
                        1
                    )
                ); // Affaire.Paiements.Valeur.PrixSimple.Monnaie.Désignation
                fields.Add(
                    this.CreateField(
                        "[630B2].[63003].[63043].[63063].[630B]",
                        FieldDescription.BackColorType.None,
                        FieldDescription.SeparatorType.Normal,
                        10,
                        1
                    )
                ); // Affaire.Paiements.Valeur.PrixSimple.Monnaie.TauxChangeVersChf
                fields.Add(this.CreateBoxEnd());

                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.All, 1, 3)
                );
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
                ...
                ); // Affaire.SoldeDû.Montant
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Glue));
                fields.Add(
                    this.CreateField(
                        "[630B2].[63013].[63063].[630A]",
                        FieldDescription.BackColorType.None,
                        FieldDescription.SeparatorType.Normal,
                        4,
                        1
                    )
                ); // Affaire.SoldeDû.Monnaie.Designation

                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
                        "[630L2].[630M].[630H]",
                        FieldDescription.BackColorType.Red,
                        FieldDescription.SeparatorType.Normal,
                        4,
                        1
                    )
                ); // TotalFacturé.Prix.Ht
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
                        "[630L2].[630N]",
                        FieldDescription.BackColorType.Yellow,
                        FieldDescription.SeparatorType.Normal,
                        4,
                        1
                    )
                ); // TotalFacturé.TotalHt
                fields.Add(
                    this.CreateField(
                        "[630L2].[630O]",
                        FieldDescription.BackColorType.Yellow,
            ...
            if (name == "Affaire")
            {
                ...
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.All, 1, 10)
                );
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
            ...
            if (name == "Tree")
            {
                ...
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.None, 0, 7)
                );
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.All, 1, 10)
                );
                ...
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.Gray, FrameEdges.All, 5, 10)
                );
                ...
                fields.Add(
                    this.CreateBoxBegin(FieldDescription.BackColorType.None, FrameEdges.Left, 1, 3)
                );
                fields.Add(this.CreateSeparator(FieldDescription.FieldType.Title));
                fields.Add(
                    this.CreateField(
        ...
        protected FieldDescription CreateBoxBegin(
            FieldDescription.BackColorType backColor,
            FrameEdges frame,
            double width,
            int columns
        )
        ...
        protected FieldDescription CreateField(
            string listDruids,
            FieldDescription.BackColorType backColor,
            FieldDescription.SeparatorType separator,
            int columns,
            int rows
        )
        {
