...
namespace Epsitec.Common.Tests.Types
{
    ...
    public class DataGraphTest
    {
        ...
        public void CheckCopyValues()
        {
            ...
            v1.WriteValue(1);
            root_1.Add(v1.Clone() as IDataItem);
            v1.WriteValue(2);
            root_2.Add(v1.Clone() as IDataItem);
            v1.WriteValue(5);
            root_3.Add(v1.Clone() as IDataItem);

            v2.WriteValue("X"); //root_1.Add (v2.Clone () as IDataItem);
            v2.WriteValue("Y");
            root_2.Add(v2.Clone() as IDataItem);
            v2.WriteValue("Z");
            root_3.Add(v2.Clone() as IDataItem);

            v3.WriteValue(1.0);
            root_1.Add(v3.Clone() as IDataItem);
            v3.WriteValue(2.0); //root_2.Add (v3.Clone () as IDataItem);
            v3.WriteValue(5.0);
            root_3.Add(v3.Clone() as IDataItem);
        ...
        private class Folder : AbstractDataCollection, IDataFolder
        {
            ...
            {
                get { return DataItemClasses.Folder; }
            }
            #endregion
        ...
        private class Value : IDataValue
        {
            ...
            public DataItemClasses Classes
            {
                get { return DataItemClasses.Value; }
            }
            #endregion
