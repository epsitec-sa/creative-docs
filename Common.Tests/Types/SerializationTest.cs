...
[assembly: Epsitec.Common.Types.DependencyClass(
    typeof(Epsitec.Common.Tests.Types.SerializationTest.MyItem)
)]
[assembly: Epsitec.Common.Types.DependencyClass(
    typeof(Epsitec.Common.Tests.Types.SerializationTest.MySimpleObject)
)]
    ...
    public class SerializationTest
    {
        ...
        public void CheckAllocationSpeed()
        {
            ...
            System.Reflection.Emit.DynamicMethod dm = new System.Reflection.Emit.DynamicMethod(
                ...
                typeof(SerializationTest).Module,
                true
            );
            ...
            System.Console.Out.WriteLine(
                "DynamicMethod + ILGen: {0} µs, {1} executions.",
                1.0M * stopwatch.ElapsedMilliseconds / (steps / 1000),
                steps
            );
            ...
            stopwatch.Stop();
            System.Console.Out.WriteLine(
                "Activator.CreateInstance: {0} µs, {1} executions.",
                1.0M * stopwatch.ElapsedMilliseconds / (steps / 1000),
                steps
            );
            ...
            stopwatch.Stop();
            System.Console.Out.WriteLine(
                "CreateEmptyObject: {0} µs, {1} executions.",
                1.0M * stopwatch.ElapsedMilliseconds / (steps / 1000),
                steps
            );
        }
        ...
        public void CheckAttributes()
        {
            ...
            foreach (
                System.Type type in DependencyClassAttribute.GetRegisteredTypes(
        ...
        public class ContainerX : DependencyObject
        {
            ...
            {
                get { return (INamedType)this.GetValue(ContainerX.TypeProperty); }
                set { this.SetValue(ContainerX.TypeProperty, value); }
            }

            static ContainerX()
            {
                ContainerX.TypeProperty.DefineSerializationConverter(
        ...
        public void CheckSerializeToXml()
        {
            ...
            Assert.AreEqual(
                "_2.DataContext",
                context.GetPropertyName(DataObject.DataContextProperty)
            );
            Assert.AreEqual(
                DataObject.DataContextProperty,
                context.GetProperty(root, "_2.DataContext")
            );
        ...
        public void CheckXmlReader()
        {
            ...
            string xml =
                @"<books><book price=""58.00"">The Firebird Book</book><magazine price=""10.00"">MSDN</magazine><type id=""abc""/></books>";
        ...
        public class MyItem : DependencyObject, IListHost<MyItem>
        {
            ...
            public string Name
            {
                get { return this.GetValue(MyItem.NameProperty) as string; }
                set { this.SetValue(MyItem.NameProperty, value); }
            }
            ...
            {
                get { return this.children == null ? false : (this.children.Count > 0); }
            }
            public string Value
            {
                get { return this.GetValue(MyItem.ValueProperty) as string; }
                set { this.SetValue(MyItem.ValueProperty, value); }
            }
            public string Cascade
            {
                get { return this.GetValue(MyItem.CascadeProperty) as string; }
                set { this.SetValue(MyItem.CascadeProperty, value); }
            }
            public MyItem Friend
            {
                get { return this.GetValue(MyItem.FriendProperty) as MyItem; }
                set { this.SetValue(MyItem.FriendProperty, value); }
            }
            public decimal Price
            {
                get { return (decimal)this.GetValue(MyItem.PriceProperty); }
                set { this.SetValue(MyItem.PriceProperty, value); }
            }
            public SomeStruct SomeStruct
            {
                get { return (SomeStruct)this.GetValue(MyItem.SomeStructProperty); }
                set { this.SetValue(MyItem.SomeStructProperty, value); }
            }
            ...
            {
                DependencyObjectTreeSnapshot snapshot =
                    DependencyObjectTree.CreateInheritedPropertyTreeSnapshot(item);
            ...
            static MyItem()
            {
                MyItem.LabelsProperty.DefaultMetadata.DefineFilter(
                    delegate(object item)
                    {
                        ...
                        if ((string.IsNullOrEmpty(x)) || (x.StartsWith("*") == false))
                        {
                            return true;
                        }
                        else
            ...
            public static DependencyProperty NameProperty =
                DependencyObjectTree.NameProperty.AddOwner(typeof(MyItem));
            public static DependencyProperty ParentProperty =
                DependencyObjectTree.ParentProperty.AddOwner(
                    typeof(MyItem),
                    new DependencyPropertyMetadata(MyItem.GetParentValue)
                );
            ...
            public static DependencyProperty HasChildrenProperty =
                DependencyObjectTree.HasChildrenProperty.AddOwner(
                    typeof(MyItem),
                    new DependencyPropertyMetadata(MyItem.GetHasChildrenValue)
                );
            ...
            public static DependencyProperty CascadeProperty = DependencyProperty.Register(
                "Cascade",
                typeof(string),
                typeof(MyItem),
                new DependencyPropertyMetadataWithInheritance(UndefinedValue.Value)
            );
            public static DependencyProperty FriendProperty = DependencyProperty.Register(
                "Friend",
                typeof(MyItem),
                typeof(MyItem)
            );
            public static DependencyProperty PriceProperty = DependencyProperty.Register(
                "Price",
                typeof(decimal),
                typeof(MyItem)
            );
            public static DependencyProperty SomeStructProperty = DependencyProperty.Register(
                "SomeStruct",
                typeof(SomeStruct),
                typeof(MyItem)
            );
            public static DependencyProperty LabelsProperty = DependencyProperty.RegisterReadOnly(
                "Labels",
                typeof(IList<string>),
                typeof(MyItem),
                new DependencyPropertyMetadata(MyItem.GetLabelsValue).MakeReadOnlySerializable()
            );
