    ...
    public class ObjectTest
    {
            ...
            for (int i = 0; i < 50; i++)
            {
                ...
                if (value != "-")
                {
                    System.Console.Out.WriteLine(
                        "Value {1} after approximatively {0} ms",
                        i * 10,
                        value
                    );
        ...
        public void CheckBinding1()
        {
            ...
            Assert.AreEqual(
                ...
                myTarget.GetBindingExpression(MyObject.FooProperty).DataSourceType
            );
        ...
        public void CheckBinding4()
        {
            ...
            Assert.AreEqual(
                ...
                myData1.GetBindingExpression(MyObject.NameProperty).DataSourceType
            );
        ...
        public void CheckObjectType()
        {
            ...
            Assert.AreEqual(
                "DependencyObject",
                DependencyObjectType.FromSystemType(typeof(DependencyObject)).Name
            );
            Assert.AreEqual("MyObject", DependencyObjectType.FromSystemType(typeof(MyObject)).Name);
            Assert.AreEqual(
                "DependencyObject",
                DependencyObjectType.FromSystemType(typeof(MyObject)).BaseType.Name
            );
            ...
            Assert.AreEqual(
                oa.ObjectType.BaseType.Name,
                DependencyObjectType.FromSystemType(typeof(DependencyObject)).Name
            );
            Assert.AreSame(
                oa.ObjectType.BaseType,
                DependencyObjectType.FromSystemType(typeof(DependencyObject))
            );

            Assert.IsTrue(
                oa.ObjectType.IsSubclassOf(
                    DependencyObjectType.FromSystemType(typeof(DependencyObject))
                )
            );
            Assert.IsTrue(
                ob.ObjectType.IsSubclassOf(
                    DependencyObjectType.FromSystemType(typeof(DependencyObject))
                )
            );
            Assert.IsTrue(
                ox.ObjectType.IsSubclassOf(
                    DependencyObjectType.FromSystemType(typeof(DependencyObject))
                )
            );
            Assert.IsTrue(
                ob.ObjectType.IsSubclassOf(DependencyObjectType.FromSystemType(typeof(ObjectA)))
            );
            Assert.IsFalse(
                oa.ObjectType.IsSubclassOf(DependencyObjectType.FromSystemType(typeof(ObjectA)))
            );
            Assert.IsFalse(
                oa.ObjectType.IsSubclassOf(DependencyObjectType.FromSystemType(typeof(ObjectB)))
            );
            Assert.IsFalse(
                oa.ObjectType.IsSubclassOf(DependencyObjectType.FromSystemType(typeof(ObjectX)))
            );
            Assert.IsFalse(
                ob.ObjectType.IsSubclassOf(DependencyObjectType.FromSystemType(typeof(ObjectX)))
            );
        ...
        {
            Assert.Throws<WrongBaseTypeException>(
        ...
        public void CheckPropertyPath()
        {
            ...
            DependencyPropertyPath pp3 = new DependencyPropertyPath(
                "{0}.{1}",
                MyObject.FooProperty,
                MyObject.NameProperty
            );
            DependencyPropertyPath pp4 = new DependencyPropertyPath(
                "Bar.{0}",
                MyObject.XyzProperty
            );
            DependencyPropertyPath pp5 = new DependencyPropertyPath(
                "{*}",
                MyObject.FooProperty,
                MyObject.NameProperty
            );
            ...
            Assert.AreEqual(
                "Foo.Name.Bar.Xyz",
                DependencyPropertyPath.Combine(pp3, pp4).GetFullPath()
            );
        ...
        public void CheckTree()
        {
            ...
            Assert.IsTrue(
                TreeTest.ChildrenProperty.GetMetadata(typeof(TreeTest)).CanSerializeReadOnly
            );
            ...
            DependencyObjectTreeSnapshot snapshot = DependencyObjectTree.CreatePropertyTreeSnapshot(
                a,
                TreeTest.ValueProperty
            );
            ...
            search = DependencyObjectTree.FindAll(
                a,
        ...
        public void CheckTreeWithPropertyInheritance()
        {
            ...
            Assert.AreEqual(
                "a-Cascade:A,a.b-Cascade:A,a.c1-Cascade:A,a.c3-Cascade:A,a.c3-Cascade:a,c.",
                handler.Log
            );
            handler.Clear();
            ...
            z.AddChild(b);
            Assert.AreEqual(
                "b-Cascade:y,<UndefinedValue>.c1-Cascade:y,<UndefinedValue>.c3-Cascade:y,<UndefinedValue>.",
                handler.Log
            );
            handler.Clear();
            ...
            x.AddChild(b);
            Assert.AreEqual(
                "b-Cascade:<UndefinedValue>,a.c1-Cascade:<UndefinedValue>,a.c3-Cascade:<UndefinedValue>,a.",
                handler.Log
            );
            handler.Clear();
        }
        ...
        private static class TestAttachedProperties
        {
            ...
            public static void TestC()
            {
                ...
                Assert.AreEqual(
                    "DependencyProperty 'Attached' changed from 'Hello' to 'Good bye'",
                    ObjectTest.log
                );
        ...
        private static void HandleTest1AttachedChanged(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
            ObjectTest.log = string.Format(
                "DependencyProperty '{2}' changed from '{0}' to '{1}'",
                e.OldValue,
                e.NewValue,
                e.PropertyName
            );
        ...
        private void PrivateCreateObjects(int runs)
        {
            ...
            System.Console.WriteLine(
                "Creating objects: {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs
            );
            System.Console.WriteLine(
                "Allocated {0} bytes/object.",
                (System.GC.GetTotalMemory(true) - before) / runs
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Setting int Xyz [native] : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Reading default string Name ({1}) : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                text
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Reading local int Xyz ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Reading local int Xyz [native] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Inc. local int Xyz [same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Inc. local int Xyz [native/same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Get local int Xyz [same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Get local int Xyz [native/same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Set local int Xyz [same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Set local int Xyz [native/same] ({1}) : {0:0.000} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                xyz
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Reading local string Name ({1}) : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs,
                text
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Setting string Foo, initial : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Setting string Foo, changed : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs
            );
            System.Console.Out.Flush();
            ...
            stopwatch.Stop();
            System.Console.WriteLine(
                "Setting string Foo, unchanged : {0:0.00} us.",
                stopwatch.ElapsedMilliseconds * 1000.0 / runs
            );
            System.Console.Out.Flush();
        ...
        private class MyObject : DependencyObject, IListHost<MyObject>
        {
            ...
            public int Xyz
            {
                get { return (int)this.GetValue(MyObject.XyzProperty); }
                set { this.SetValue(MyObject.XyzProperty, value); }
            }
            public int Abc
            {
                get { return (int)this.GetValue(MyObject.AbcProperty); }
                set { this.SetValue(MyObject.AbcProperty, value); }
            }
            public int NativeXyz
            {
                get { return this.nativeXyz; }
                set { this.nativeXyz = value; }
            }
            public string Name
            {
                get { return (string)this.GetValue(MyObject.NameProperty); }
                set { this.SetValue(MyObject.NameProperty, value); }
            }
            public string Foo
            {
                get { return (string)this.GetValue(MyObject.FooProperty); }
                set { this.SetValue(MyObject.FooProperty, value); }
            }
            public MyObject Sibling
            {
                get { return this.GetValue(MyObject.SiblingProperty) as MyObject; }
                set { this.SetValue(MyObject.SiblingProperty, value); }
            }
            public string Cascade
            {
                get { return this.GetValue(MyObject.CascadeProperty) as string; }
                set { this.SetValue(MyObject.CascadeProperty, value); }
            }
            public MyObject Parent
            {
                get { return this.GetValue(MyObject.ParentProperty) as MyObject; }
                set
                {
            ...
            public static DependencyProperty XyzProperty = DependencyProperty.Register(
                "Xyz",
                typeof(int),
                typeof(MyObject)
            );
            public static DependencyProperty AbcProperty = DependencyProperty.Register(
                "Abc",
                typeof(int),
                typeof(MyObject),
                new DependencyPropertyMetadata(Binding.DoNothing)
            );
            public static DependencyProperty NameProperty = DependencyProperty.Register(
                "Name",
                typeof(string),
                typeof(MyObject),
                new DependencyPropertyMetadata("[default]")
            );
            public static DependencyProperty FooProperty = DependencyProperty.Register(
                "Foo",
                typeof(string),
                typeof(MyObject),
                new DependencyPropertyMetadata(
                    "[default]",
                    new PropertyInvalidatedCallback(MyObject.NotifyOnFooChanged)
                )
            );
            public static DependencyProperty SiblingProperty = DependencyProperty.Register(
                "Sibling",
                typeof(MyObject),
                typeof(MyObject)
            );
            ...
            public static DependencyProperty HasChildrenProperty =
                DependencyObjectTree.HasChildrenProperty.AddOwner(
                    typeof(MyObject),
                    new DependencyPropertyMetadata(MyObject.GetHasChildrenValue)
                );
            public static DependencyProperty ReadOnlyProperty = DependencyProperty.RegisterReadOnly(
                "ReadOnly",
                typeof(string),
                typeof(MyObject)
            );
            public static DependencyProperty NativeXyzProperty = DependencyProperty.Register(
                "NativeXyz",
                typeof(int),
                typeof(MyObject),
                new DependencyPropertyMetadata(
                    MyObject.GetNativeXyzValue,
                    MyObject.SetNativeXyzValue
                )
            );
            ...
            private static void NotifyOnFooChanged(
                DependencyObject o,
                object old_value,
                object new_value
            )
        ...
        private class SlowObject : DependencyObject
        {
            ...
            public string A
            {
                get { return (string)this.GetValue(SlowObject.AProperty); }
            }

            public string B
            {
                get { return (string)this.GetValue(SlowObject.BProperty); }
            }

            public string C
            {
                get { return (string)this.GetValue(SlowObject.CProperty); }
            }

            public SlowObject SlowFriend
            {
                get { return (SlowObject)this.GetValue(SlowObject.SlowFriendProperty); }
            }
            ...
            public static DependencyProperty AProperty = DependencyProperty.RegisterReadOnly(
                ...
                typeof(string),
                typeof(SlowObject),
                new DependencyPropertyMetadata(SlowObject.GetAValue)
            );
            public static DependencyProperty BProperty = DependencyProperty.RegisterReadOnly(
                "B",
                typeof(string),
                typeof(SlowObject),
                new DependencyPropertyMetadata(SlowObject.GetBValue)
            );
            public static DependencyProperty CProperty = DependencyProperty.RegisterReadOnly(
                "C",
                typeof(string),
                typeof(SlowObject),
                new DependencyPropertyMetadata(SlowObject.GetCValue)
            );
            public static DependencyProperty SlowFriendProperty =
                DependencyProperty.RegisterReadOnly(
                    "SlowFriend",
                    typeof(SlowObject),
                    typeof(SlowObject),
                    new DependencyPropertyMetadata(SlowObject.GetSlowFriendValue)
                );
        ...
        {
            public static DependencyProperty AProperty = DependencyProperty.Register(
                "A",
                typeof(ObjectA),
                typeof(ObjectX)
            );
            public static DependencyProperty BProperty = DependencyProperty.Register(
                "B",
                typeof(ObjectB),
                typeof(ObjectX)
            );
        ...
        public class Test1 : DependencyObject
        {
            ...
            public static DependencyProperty AttachedProperty = DependencyProperty.RegisterAttached(
                "Attached",
                typeof(string),
                typeof(Test1)
            );
            public static DependencyProperty StandardProperty = DependencyProperty.Register(
                "Standard",
                typeof(string),
                typeof(Test1)
            );
        ...
        public class Test1b : Test1
        {
            ...
            public static new DependencyProperty AttachedProperty =
                DependencyProperty.RegisterAttached("Attached", typeof(string), typeof(Test1b));
        }
        ...
        public class Test1c : Test1
        {
            ...
            public static new DependencyProperty AttachedProperty = DependencyProperty.Register(
                "Attached",
                typeof(string),
                typeof(Test1c)
            );
            public static new DependencyProperty StandardProperty =
                DependencyProperty.RegisterAttached("Standard", typeof(string), typeof(Test1c));
        }
        ...
        public class Test2b : Test2
        {
            ...
            public static new DependencyProperty StandardProperty = DependencyProperty.Register(
                "Standard",
                typeof(string),
                typeof(Test2b)
            );
        ...
        {
            public static DependencyProperty InvalidProperty = DependencyProperty.Register(
                null,
                typeof(string),
                typeof(Test3a)
            );
        ...
        class TreeTest : DependencyObject
        {
            public string Name
            {
                get { return this.GetValue(TreeTest.NameProperty) as string; }
                set { this.SetValue(TreeTest.NameProperty, value); }
            }
            ...
            public string Value
            {
                get { return this.GetValue(TreeTest.ValueProperty) as string; }
                set { this.SetValue(TreeTest.ValueProperty, value); }
            }
            public string Cascade
            {
                get { return this.GetValue(TreeTest.CascadeProperty) as string; }
                set { this.SetValue(TreeTest.CascadeProperty, value); }
            }
            ...
            public static DependencyProperty NameProperty =
                DependencyObjectTree.NameProperty.AddOwner(typeof(TreeTest));
            public static DependencyProperty ParentProperty =
                DependencyObjectTree.ParentProperty.AddOwner(
                    typeof(TreeTest),
                    new DependencyPropertyMetadata(TreeTest.GetParent)
                );
            public static DependencyProperty ChildrenProperty =
                DependencyObjectTree.ChildrenProperty.AddOwner(
                    typeof(TreeTest),
                    new DependencyPropertyMetadata(
                        TreeTest.GetChildrenValue
                    ).MakeReadOnlySerializable()
                );
            public static DependencyProperty HasChildrenProperty =
                DependencyObjectTree.HasChildrenProperty.AddOwner(
                    typeof(TreeTest),
                    new DependencyPropertyMetadata(TreeTest.GetHasChildrenValue)
                );
