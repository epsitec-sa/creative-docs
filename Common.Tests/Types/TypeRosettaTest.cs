...
namespace Epsitec.Common.Tests.Types
{
    ...
    public class TypeRosettaTest
    {
        ...
        {
            Assert.IsNotNull(
                TypeRosetta.GetTypeObject("Default.Boolean"),
                "Boolean type not found"
            );
            Assert.IsNotNull(
                TypeRosetta.GetTypeObject("Default.Decimal"),
                "Decimal type not found"
            );
            Assert.IsNotNull(TypeRosetta.GetTypeObject("Default.Double"), "Double type not found");
            Assert.IsNotNull(
                TypeRosetta.GetTypeObject("Default.Integer"),
                "Integer type not found"
            );
            Assert.IsNotNull(
                TypeRosetta.GetTypeObject("Default.LongInteger"),
                "LongInteger type not found"
            );
            ...
            Assert.AreEqual(
                typeof(decimal),
                TypeRosetta.GetTypeObject("Default.Decimal").SystemType
            );
            ...
            Assert.AreEqual(
                typeof(long),
                TypeRosetta.GetTypeObject("Default.LongInteger").SystemType
            );
            ...
            Assert.AreEqual(
                typeof(bool),
                TypeRosetta.GetTypeObject(Druid.Parse("[1003]")).SystemType
            );
            Assert.AreEqual(
                typeof(decimal),
                TypeRosetta.GetTypeObject(Druid.Parse("[1004]")).SystemType
            );
            Assert.AreEqual(
                typeof(double),
                TypeRosetta.GetTypeObject(Druid.Parse("[1005]")).SystemType
            );
            Assert.AreEqual(
                typeof(int),
                TypeRosetta.GetTypeObject(Druid.Parse("[1006]")).SystemType
            );
            Assert.AreEqual(
                typeof(long),
                TypeRosetta.GetTypeObject(Druid.Parse("[1007]")).SystemType
            );
            Assert.AreEqual(
                typeof(string),
                TypeRosetta.GetTypeObject(Druid.Parse("[1008]")).SystemType
            );
            Assert.AreEqual(
                typeof(void),
                TypeRosetta.GetTypeObject(Druid.Parse("[1009]")).SystemType
            );
            ...
            Caption caption = Epsitec.Common.Support.Resources.DefaultManager.GetCaption(
                Druid.Parse("[1003]")
            );
        ...
        public void CheckObjectTypeToSytemType()
        {
            ...
            Assert.AreEqual(
                typeof(double),
                TypeRosetta.GetSystemTypeFromTypeObject(typeof(double))
            );

            Assert.AreEqual(
                typeof(decimal),
                TypeRosetta.GetSystemTypeFromTypeObject(new DecimalType(0, 10, 0.1M))
            );
            Assert.AreEqual(
                typeof(int),
                TypeRosetta.GetSystemTypeFromTypeObject(new IntegerType(0, 1000))
            );
            Assert.AreEqual(
                typeof(string),
                TypeRosetta.GetSystemTypeFromTypeObject(new StringType())
            );
            Assert.AreEqual(
                typeof(BindingMode),
                TypeRosetta.GetSystemTypeFromTypeObject(new EnumType(typeof(BindingMode)))
            );
            Assert.AreEqual(
                typeof(BindingUpdateMode),
                TypeRosetta.GetSystemTypeFromTypeObject(new EnumType(typeof(BindingUpdateMode)))
            );

            Assert.AreEqual(
                typeof(string),
                TypeRosetta.GetSystemTypeFromTypeObject(DependencyObjectTree.NameProperty)
            );

            Assert.AreEqual(
                typeof(DataObject),
                TypeRosetta.GetSystemTypeFromTypeObject(
                    DependencyObjectType.FromSystemType(typeof(DataObject))
                )
            );
        }
        ...
        public void CheckValueToObjectType()
        {
            ...
            Assert.AreEqual(
                DependencyObjectType.FromSystemType(typeof(MyObject)),
                TypeRosetta.GetTypeObjectFromValue(obj2)
            );
            Assert.AreEqual(objType1, TypeRosetta.GetTypeObjectFromValue(record));
            Assert.AreEqual(
                typeof(DynamicStructuredType),
                TypeRosetta.GetTypeObjectFromValue(data).GetType()
            );
        }
        ...
        public void CheckObjectTypeToStructuredType()
        {
            ...
            IStructuredType t1 = TypeRosetta.GetStructuredTypeFromTypeObject(
                TypeRosetta.GetTypeObjectFromValue(obj1)
            );
            IStructuredType t2 = TypeRosetta.GetStructuredTypeFromTypeObject(
                TypeRosetta.GetTypeObjectFromValue(obj2)
            );
            IStructuredType t3 = TypeRosetta.GetStructuredTypeFromTypeObject(
                TypeRosetta.GetTypeObjectFromValue(record)
            );
            IStructuredType t4 = TypeRosetta.GetStructuredTypeFromTypeObject(
                TypeRosetta.GetTypeObjectFromValue(data)
            );
            ...
            Assert.AreEqual(
                "DynamicStructure",
                TypeRosetta.GetNamedTypeFromTypeObject(t4self).Name
            );
            Assert.AreEqual(
                "System.Int16",
                TypeRosetta.GetNamedTypeFromTypeObject(typeof(short)).Name
            );
        }
        ...
        public void CheckVerifyValueValidity()
        {
            ...
            Assert.IsTrue(
                TypeRosetta.IsValidValue(10, new StructuredTypeField("X", IntegerType.Default))
            );
        }
        ...
        {
            Assert.IsTrue(
                TypeRosetta.IsValidValueForCollectionOfType(new List<int>(), IntegerType.Default)
            );
            Assert.IsTrue(
                TypeRosetta.IsValidValueForCollectionOfType(new List<int>(), typeof(int))
            );
            Assert.IsFalse(
                TypeRosetta.IsValidValueForCollectionOfType(
                    new List<int>(),
                    StringType.NativeDefault
                )
            );
            Assert.IsFalse(
                TypeRosetta.IsValidValueForCollectionOfType(new List<int>(), typeof(string))
            );
            Assert.IsTrue(
                TypeRosetta.IsValidValueForCollectionOfType(
                    new List<string>(),
            ...
            Assert.IsFalse(
                TypeRosetta.IsValidValueForCollectionOfType(new List<string>(), IntegerType.Default)
            );
            ...
            Assert.IsFalse(
                TypeRosetta.IsValidValue(
                    new List<StructuredData>(),
                    new StructuredTypeField("X", typeA, Druid.Empty, 0, FieldRelation.None)
                )
            );
            Assert.IsTrue(
                TypeRosetta.IsValidValue(
                    new List<StructuredData>(),
                    new StructuredTypeField("X", typeA, Druid.Empty, 0, FieldRelation.Collection)
                )
            );
