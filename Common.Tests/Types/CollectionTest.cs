...
namespace Epsitec.Common.Tests.Types
{
    ...
    public class CollectionTest
    {
        ...
        public void CheckCollectionBinding1()
        {
            ...
            ui.SetBinding(
                UserInterface.InvoiceIdProperty,
                new Binding(BindingMode.TwoWay, "InvoiceId")
            );
            ui.SetBinding(
                UserInterface.ArticleProperty,
                new Binding(BindingMode.OneWay, "Articles")
            );
            ui.SetBinding(
                UserInterface.ArticleNameProperty,
                new Binding(BindingMode.TwoWay, "Articles.Name")
            );
        ...
        public void CheckCollectionBinding2()
        {
            ...
            ui.SetBinding(
                UserInterface.ArticlesProperty,
                new Binding(BindingMode.OneWay, "Articles")
            );
        ...
        [Test]
        [Ignore(
            "Implementation of IsValidValue validation based on generic IEnumerable<> type is missing"
        )]
        ...
        public void CheckObservableListCopyOnWrite()
        {
            ...
            original.CollectionChanged += delegate
            {
                Assert.Fail();
            };
            original.CollectionChanging += delegate
            {
                Assert.Fail();
            };
            ...
            copy.CollectionChanging += delegate
            {
                changeCount++;
            };
        ...
        public void CheckObservableListNotifyBeforeChange()
        {
            ...
            list.CollectionChanging += delegate
            {
                changeCount++;
            };
        ...
        public void CheckPropertyGroupDescription()
        {
            ...
            Assert.AreEqual(
                ...
                string.Join(
                    ...
                    group.GetGroupNamesForItem(
                        1.1,
                        System.Globalization.CultureInfo.GetCultureInfoByIetfLanguageTag("fr-FR")
                    )
                )
            );
            ...
            Assert.AreEqual(
                0,
                group
                    .GetGroupNamesForItem(null, System.Globalization.CultureInfo.InvariantCulture)
                    .Length
            );
            ...
            Assert.AreEqual(
                1,
                group
                    .GetGroupNamesForItem(item, System.Globalization.CultureInfo.InvariantCulture)
                    .Length
            );
            Assert.AreEqual(
                "MyItem=X",
            ...
            Assert.AreEqual(
                "Epsitec.Common.Types.CollectionTest+MyItem",
                string.Join(
                    ":",
                    group.GetGroupNamesForItem(
                        item,
            ...
            Assert.AreEqual(
                1,
                group
                    .GetGroupNamesForItem(record, System.Globalization.CultureInfo.InvariantCulture)
                    .Length
            );
            Assert.AreEqual(
                "ElectronicEquipment",
        ...
        public void CheckSortDescription()
        {
            ...
            ISerializationConverter conv = InvariantConverter.GetSerializationConverter(
        ...
        private class UserInterface : DependencyObject
        {
            ...
            {
                get { return (string)this.GetValue(UserInterface.InvoiceIdProperty); }
                set { this.SetValue(UserInterface.InvoiceIdProperty, value); }
            }

            public Article Article
            {
                get { return (Article)this.GetValue(UserInterface.ArticleProperty); }
                set { this.SetValue(UserInterface.ArticleProperty, value); }
            }

            public string ArticleName
            {
                get { return (string)this.GetValue(UserInterface.ArticleNameProperty); }
                set { this.SetValue(UserInterface.ArticleNameProperty, value); }
            }

            public static readonly DependencyProperty InvoiceIdProperty =
                DependencyProperty.Register("InvoiceId", typeof(string), typeof(UserInterface));
            public static readonly DependencyProperty ArticleProperty = DependencyProperty.Register(
                "Article",
                typeof(Article),
                typeof(UserInterface)
            );
            public static readonly DependencyProperty ArticleNameProperty =
                DependencyProperty.Register("ArticleName", typeof(string), typeof(UserInterface));
        ...
        private class Article : DependencyObject
        {
            ...
            public string Name
            {
                get { return (string)this.GetValue(Article.NameProperty); }
                set { this.SetValue(Article.NameProperty, value); }
            }
        ...
        private class MyItem : DependencyObject
        {
            ...
            public string Name
            {
                get { return (string)this.GetValue(MyItem.NameProperty); }
