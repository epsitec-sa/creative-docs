...
namespace Epsitec.Common.Tests.Drawing
{
    ...
    public class GraphicsTest
    {
        ...
        [Test]
        public void CheckTextOutputStabilityCheck()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckTextOutputWingdings()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckPixmapRawData()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckPathAccumulationRasterizer()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckFontPreviewer()
        {
        ...
        [Test]
        public void CheckImageRectTIFF()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckImage100dpi200dpi()
        {
            Window window = new Window();
        ...
        private void Gamma_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                {
                    case 0:
                        e.Graphics.Rasterizer.Gamma = 0.80;
                        break;
                    case 1:
                        e.Graphics.Rasterizer.Gamma = 0.90;
                        break;
                    case 2:
                        e.Graphics.Rasterizer.Gamma = 1.00;
                        break;
                    case 3:
                        e.Graphics.Rasterizer.Gamma = 1.10;
                        break;
                    case 4:
                        e.Graphics.Rasterizer.Gamma = 1.20;
                        break;
                }
                ...
                e.Graphics.AddText(
                    10,
                    y + 5,
                    "to help you personalize your computer with one click. gamma="
                        + e.Graphics.Rasterizer.Gamma.ToString(),
                    font,
                    size
                );
                e.Graphics.RenderSolid(Color.FromBrightness(0));
        ...
        private void AlphaMask_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.ScaleTransform(
                root.Client.Size.Width / 300.0,
                root.Client.Size.Height / 250.0,
                0,
                0
            );
        ...
        private void Clipping_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.FillMode = FillMode.NonZero;
            e.Graphics.SetClippingRectangle(
                new Rectangle(50, 50, root.Client.Size.Width - 100, 50)
            );
        ...
        private void Image_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            Image bitmapImage = ImageProvider.Instance.GetImage(
        ...
        private void ImageRect_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bitmap = ImageProvider
                .Instance.GetImage(@"file:Images/test.png", Resources.DefaultManager)
                .BitmapImage;
        ...
        private void ImageAlpha_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bitmap = ImageProvider
                .Instance.GetImage(@"file:Images/4x4-alpha.png", Resources.DefaultManager)
                .BitmapImage;
        ...
        private void ImageRectTIFF_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bitmap = ImageProvider
                .Instance.GetImage(@"file:Images/image1.tif", Resources.DefaultManager)
                .BitmapImage;
            ...
            e.Graphics.PaintImage(
                bitmap,
                new Rectangle(60, 10, 64, 64),
                new Rectangle(32, 32, 32, 32)
            );
            e.Graphics.PaintImage(
                bitmap,
                new Rectangle(10, 60, 100, 100),
                new Rectangle(32, 32, 32, 32)
            );
        ...
        private void Image100dpi200dpi_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            Bitmap bitmap_1 = ImageProvider
                .Instance.GetImage(@"file:Images/100-dpi.tif", Resources.DefaultManager)
                .BitmapImage;
            Bitmap bitmap_2 = ImageProvider
                .Instance.GetImage(@"file:Images/200-dpi.tif", Resources.DefaultManager)
                .BitmapImage;
        ...
        private void Special4Fill_PaintForeground(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.SolidRenderer.Clear4Colors(
                10,
                10,
                dx - 20,
                dy - 20,
