...
namespace Epsitec.Common.Tests.Drawing
{
    ...
    public class PathTest
    {
        ...
        [Test]
        public void CheckGetElementsSetElements()
        {
        ...
        [Test]
        public void CheckGetBlobOfElementsSetBlobOfElements()
        {
            Font font = Font.GetFont("Times New Roman", "Regular");
            Path path = new Path();
        ...
        [Test]
        public void CheckGlyphPathToStringTimes()
        {
            Font font = Font.GetFont("Times New Roman", "Regular");
            Path path = new Path();
        ...
        [Test]
        public void CheckGlyphPathToStringTahoma()
        {
        ...
        [Test]
        public void CheckComputeBounds()
        {
            Path path = new Path();
            Rectangle bounds;
        ...
        */
        ...
        [Test]
        public void CheckAppendPathOutlines2()
        {
            Path p1 = new Path();
            Path p2 = new Path();
            Path p3 = new Path();
        ...
        [Test]
        public void CheckAppendPathOutlines3()
        {
            Path p1 = new Path();
            Path p2 = new Path();
            Path p3 = new Path();
        ...
        private void HandleFormPaint(object sender, System.Windows.Forms.PaintEventArgs e)
        {
            ...
            e.Graphics.DrawString(
                string.Format(
                    "Drawing & Filling the path: {1} ms, high speed.",
                    c2,
                    c2 / cpu_speed / 1000
                ),
                form.Font,
            ...
            e.Graphics.DrawString(
                string.Format(
                    "Drawing & Filling the path: {1} ms, high quality.",
                    c2,
                    c2 / cpu_speed / 1000
                ),
                form.Font,
