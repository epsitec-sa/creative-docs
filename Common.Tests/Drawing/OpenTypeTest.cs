...
namespace Epsitec.Common.Tests.Drawing
{
    ...
    public class OpenTypeTest
    {
        ...
        public void ListAllChameleonFontNames()
        {
            ...
            System.Console.WriteLine(
                "Chameleon fonts (different names for Microsoft or Macintosh)"
            );
            System.Console.WriteLine(
                "------------------------------------------------------------"
            );
            ...
            foreach (FontIdentity id in collection)
            {
                ...
                if (
                    (id.InvariantSimpleFaceName != id.MacintoshFaceName)
                ...
                )
                {
                    System.Console.WriteLine(
                        ...
                        id.InvariantSimpleFaceName,
                        id.InvariantSimpleStyleName,
                        id.MacintoshFaceName,
                        id.MacintoshStyleName
                    );
                }
            }
        ...
        [Test]
        public void ListAlternateFeatures()
        {
            FontCollection collection = new FontCollection();
