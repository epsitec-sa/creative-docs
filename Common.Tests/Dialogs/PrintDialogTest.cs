...
namespace Epsitec.Common.Tests.Dialogs
{
    ...
    public class PrintDialogTest
    {
        ...
        [Test]
        public void CheckPrinterSettingsInstalledPrinters()
        {
        ...
        public void CheckShow1()
        {
            ...
            using (Tool.InjectKey(System.Windows.Forms.Keys.Return))
            {
                ...
                System.Console.Out.WriteLine(
                    "Paper Source: {0}",
                    dialog.Document.PrinterSettings.DefaultPageSettings.PaperSource.Name
                );
                System.Console.Out.WriteLine(
                    "Paper Size:   {0}",
                    dialog.Document.PrinterSettings.DefaultPageSettings.PaperSize.Name
                );
                System.Console.Out.WriteLine(
                    "Page Bounds:  {0}",
                    dialog.Document.PrinterSettings.DefaultPageSettings.Bounds.ToString()
                );
                System.Console.Out.WriteLine(
                    "Page Margins: {0}",
                    dialog.Document.PrinterSettings.DefaultPageSettings.Margins.ToString()
                );
                System.Console.Out.WriteLine(
                    "Output Port:  {0}",
                    dialog.Document.PrinterSettings.OutputPort
                );
                System.Console.Out.WriteLine(
                    "Driver Name:  {0}",
                    dialog.Document.PrinterSettings.DriverName
                );
                System.Console.Out.WriteLine(
                    "Collation:    {0}, {1} copies",
                    dialog.Document.PrinterSettings.Collate,
                    dialog.Document.PrinterSettings.Copies
                );
            }
        }

        [Test]
        public void CheckShow2()
        {
            PrintDialog dialog = new PrintDialog();
            ...
            Printing.PrinterResolution[] resols = dialog
                .Document
                .PrinterSettings
                .PrinterResolutions;
        ...
        public void CheckPrintToFile()
        {
            ...
            try
            {
                Adobe.AcrobatDistiller.PdfDistiller distiller =
                    new Adobe.AcrobatDistiller.PdfDistiller();
        ...
        private static void HandleDistillerOnJobStart(
            string strInputPostScript,
            string strOutputPDF
        )
        {
        ...
        protected class AggPreview : Widget
        {
            ...
            protected override void PaintBackgroundImplementation(
                ...
                Epsitec.Common.Drawing.Rectangle clip_rect
            )
            {
                ...
                using (bitmap)
                {
                    ...
                    Pixmap.RawData dst = new Pixmap.RawData(
                        bitmap,
                        System.Drawing.Imaging.PixelFormat.Format32bppPArgb
                    );
                    ...
                    graphics.PaintImage(
                        Bitmap.FromNativeBitmap(bitmap),
                        0,
                        0,
                        250,
                        120,
        ...
        protected class PrintEngine : Printing.IPrintEngine
        {
            ...
            public Printing.PrintEngineStatus PrintPage(Printing.PrintPort port)
            {
                ...
                port.PaintText(
                    50,
                    145,
                    "Image de Délos, définie à 300 dpi, 100mm x 100mm, codé au format JPEG.",
                    font,
                    2.5
                );
                port.PaintText(
                    50,
                    141,
                    "Imprimé avec les mécanismes de bas niveau de Crésus Réseau.",
                    font,
                    2.5
                );
        ...
        private class Helper
        {
            ...
            public static void HandleFormPaintSmooth(
                object sender,
            ...
            )
            {
                ...
                Printing.PrintPort port = new Printing.PrintPort(
                    e.Graphics,
            ...
            public static void HandleFormPaintDefault(
                object sender,
                System.Windows.Forms.PaintEventArgs e
            )
            {
