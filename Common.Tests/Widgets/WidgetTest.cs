...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class WidgetTest
    {
        ...
        [Test]
        public void CheckAllocationWithText()
        {
            int runs = 10000;
            Widget dummy = new Widget();
            Widget[] widgets = new Widget[runs];
        ...
        public void CheckTextFrame()
        {
            ...
            TextStyle style = story.TextContext.StyleList.NewTextStyle(
                null,
                "Default",
        ...
        class TextFrameManager
        {
            ...
            private void CheckTextFrameButtonClicked(object sender, MessageEventArgs e)
            {
                ...
                {
                    case "default":
                        this.frame.TextNavigator.SetParagraphStyles(
                            this.frame.TextStory.TextContext.DefaultParagraphStyle
                        );
                        this.frame.TextNavigator.SetParagraphProperties(
                            Common.Text.Properties.ApplyMode.Overwrite,
                            new Property[0]
                        );
                        break;

                    case "style:regular":
                        this.frame.TextNavigator.SetTextProperties(
                            Common.Text.Properties.ApplyMode.Set,
                            new Common.Text.Properties.FontProperty(null, "Regular")
                        );
                        break;
                    case "style:bold":
                        this.frame.TextNavigator.SetTextProperties(
                            Common.Text.Properties.ApplyMode.Combine,
                            new Common.Text.Properties.FontProperty(null, "!Bold")
                        );
                        break;
                    case "style:italic":
                        this.frame.TextNavigator.SetTextProperties(
                            Common.Text.Properties.ApplyMode.Combine,
                            new Common.Text.Properties.FontProperty(null, "!Italic")
                        );
                        break;
                    case "style:reset":
                        this.frame.TextNavigator.SetTextProperties(
                            Common.Text.Properties.ApplyMode.Clear,
                            new Common.Text.Properties.FontProperty()
                        );
                        break;
                    ...
                    case "size:8":
                        this.frame.TextNavigator.SetTextProperties(
                            Common.Text.Properties.ApplyMode.Set,
                            new Common.Text.Properties.FontSizeProperty(
                                8.0,
                    ...
                    case "size:+20%":
                        this.frame.TextNavigator.SetTextProperties(
                            ...
                            new Common.Text.Properties.FontSizeProperty(
                                120.0,
                                Common.Text.Properties.SizeUnits.Percent
                            )
                        );
                        break;
                    case "size:reset":
                    ...
                    case "left-aligned":
                        this.frame.TextNavigator.SetParagraphProperties(
                            Common.Text.Properties.ApplyMode.Set,
                            new Common.Text.Properties.MarginsProperty(
                                double.NaN,
                                double.NaN,
                                double.NaN,
                                double.NaN,
                                Common.Text.Properties.SizeUnits.None,
                                0,
                                0,
                                0,
                                double.NaN,
                                double.NaN,
                                Common.Text.Properties.ThreeState.Undefined
                            )
                        );
                        break;
                    case "right-aligned":
                    ...
                    case "lead:auto":
                        this.frame.TextNavigator.SetParagraphProperties(
                            Common.Text.Properties.ApplyMode.Set,
                            new Common.Text.Properties.LeadingProperty(
                                0.0,
                                Common.Text.Properties.SizeUnits.Points,
                                Common.Text.Properties.AlignMode.Undefined
                            )
                        );
                        break;
                    case "lead:150%":
        ...
        [Test]
        public void CheckParentChanged()
        {
        ...
        private void HandleCheckParentChangedParentChanged(
            object sender,
        ...
        [Test]
        public void CheckTextLayoutInfo()
        {
            Window window = new Window();
            ...
            text.PreferredSize =
                new Size(text.PreferredSize.Width / 2, text.PreferredSize.Height * 2) * 3;
        ...
        [Test]
        public void CheckTransformToClient()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        [Test]
        public void CheckTransformRectToClient()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        [Test]
        public void CheckTransformRectToParent()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        [Test]
        public void CheckTransformToParent()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        [Test]
        public void CheckTransformParentClientIdentity()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        [Test]
        public void CheckTransformHierarchy()
        {
            Widget root = new Widget();
            Widget widget = new Widget();
        ...
        public void CheckTextFieldReal()
        {
            ...
            real.PreferredWidth = 50;
            real.Value = 10;
            real.SetManualBounds(
                new Rectangle(
                    8 + 50 + 4,
                    200 - 5 - real.PreferredHeight,
                    real.PreferredWidth,
        ...
        private class FlowPanel : Widget
        {
            ...
            protected override void MeasureMinMax(ref Size min, ref Size max)
            {
                ...
                min.Height = System.Math.Max(
                    min.Height,
                    height + this.Padding.Height + this.GetInternalPadding().Height
                );
            }
            ...
            protected override void ManualArrange()
            {
                ...
                foreach (Widget child in this.Children)
                {
                    ...
                    child.SetManualBounds(
                        new Rectangle(
                            rect.Left + x,
                            rect.Top - y - child.PreferredHeight,
                            child.PreferredWidth,
                            child.PreferredHeight
                        )
                    );
        ...
        public void CheckAliveWidgets()
        {
            System.Console.Out.WriteLine(
                "{0} widgets and {1} windows alive before GC.Collect",
                Widget.DebugAliveWidgetsCount,
                Window.DebugAliveWindowsCount
            );
            System.GC.Collect();
            System.Console.Out.WriteLine(
                "{0} widgets and {1} windows alive after GC.Collect",
                Widget.DebugAliveWidgetsCount,
                Window.DebugAliveWindowsCount
            );
            ...
            {
                System.Console.Out.WriteLine(
                    "{0}: Name='{1}', Text='{2}', Parent={3}",
                    widget.GetType().Name,
                    widget.Name,
                    widget.Text,
                    (widget.Parent == null) ? "<null>" : (widget.Parent.GetType().Name)
                );
            }
        }

        [Test]
        public void CheckButtonNew()
        {
            Button button = new Button();
        }

        [Test]
        public void CheckButtonNewDispose()
        {
            Button button = new Button();
            button.Dispose();
        }
        ...
        [Test]
        public void CheckFindChildBasedOnName()
        {
            Widget root = new Widget();
            Widget w1 = new Widget();
            w1.Name = "a";
        ...
        [Test]
        public void CheckSmartTagColor()
        {
            Window window = new Window();
        ...
        private void HandleSelectorChangedForeground(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
        ...
        private void HandleSelectorChangedBackground(
            object sender,
            DependencyPropertyChangedEventArgs e
        )
        {
