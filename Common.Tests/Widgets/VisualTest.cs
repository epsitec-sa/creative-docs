...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class VisualTest
    {
        ...
        public void CheckDisplayCaption()
        {
            ...
            visual.DisplayCaptionChanged += delegate(object sender)
            {
                count++;
            };
            ...
            Assert.AreEqual(
                "Sél. tout",
                Collection.Extract(visual.GetDisplayCaption().SortedLabels, 1)
            );
            Assert.AreEqual(
                "Sélectionner tout",
                Collection.Extract(visual.GetDisplayCaption().SortedLabels, 2)
            );
        }
        ...
        public void CheckVisualVisibility()
        {
            ...
            Assert.AreEqual(
                "a-IsVisible:True,False.b-IsVisible:True,False.c1-IsVisible:True,False.c2-IsVisible:True,False.",
                handler.Log
            );
            ...
            Assert.IsTrue(c2.IsVisible);
            Assert.AreEqual(
                "a-IsVisible:False,True.b-IsVisible:False,True.c1-IsVisible:False,True.c2-IsVisible:False,True.",
                handler.Log
            );
            ...
            Assert.IsFalse(c2.IsVisible);
            Assert.AreEqual(
                "b-IsVisible:True,False.c1-IsVisible:True,False.c2-IsVisible:True,False.",
                handler.Log
            );
        ...
        public void CheckVisualChildren2()
        {
            ...
            Assert.AreEqual(
                "r1-Inherited:<null>,W1.a-Inherited:<null>,W1.b-Inherited:<null>,W1.c1-Inherited:<null>,W1.c2-Inherited:<null>,W1.",
                handler.Log
            );
            handler.Clear();
            ...
            Assert.AreEqual(
                "a-Inherited:W1,<null>.b-Inherited:W1,<null>.c1-Inherited:W1,<null>.c2-Inherited:W1,<null>.",
                handler.Log
            );
            handler.Clear();
            ...
            Assert.AreEqual(
                "a-Inherited:<null>,W2.b-Inherited:<null>,W2.c1-Inherited:<null>,W2.c2-Inherited:<null>,W2.",
                handler.Log
            );
            handler.Clear();
            ...
            Assert.AreEqual(
                "c1-Inherited:W2,WX.c10-Inherited:W2,WX.c11-Inherited:W2,WX.",
                handler.Log
            );
            handler.Clear();
        ...
        {
            public static DependencyProperty InheritedProperty =
                DependencyProperty.RegisterAttached(
                    "Inherited",
                    typeof(string),
                    typeof(Dummy),
                    new DependencyPropertyMetadataWithInheritance(null)
                );
        }
        ...
        public void CheckMemoryUse()
        {
            ...
            System.Console.Out.WriteLine(
                "Allocated {0} bytes for {1} objects, {2:0.0} byte/int",
                after - before,
                array.Length,
                (after - before) * 1.0 / array.Length
            );
        }
        ...
        public void CheckVisualSpeed()
        {
            ...
            for (int j = 0; j < 100; j++)
            {
                ...
                System.Console.WriteLine(
                    "Created tree of 150 elements, top-down: {0:0} ms.",
                ...
                System.Console.WriteLine(
                    "Created tree of 150 elements, bottom-up: {0:0} ms.",
                    stopwatch.ElapsedMilliseconds
                );
                System.Console.Out.Flush();
            }
