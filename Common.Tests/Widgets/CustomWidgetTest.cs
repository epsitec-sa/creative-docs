...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class CustomWidgetTest
    {
        ...
        [Test]
        public void CheckCustomWidgetSimpleWindow()
        {
            ...
            a.Name = "A";
            a.Margins = new Margins(0, 10, 0, 40);
            a.PreferredSize = new Size(80, 20);
            a.Text = "OK";
            a.Anchor = AnchorStyles.BottomRight;
            b.Name = "B";
            b.Margins = new Margins(0, 10, 0, 10);
            b.PreferredSize = new Size(80, 20);
            b.Text = "Cancel";
            b.Anchor = AnchorStyles.BottomRight;
        ...
        private void HandleWidgetClicked(object sender, MessageEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                "Cliqué sur " + widget.Name + " avec le bouton " + e.Message.Button.ToString()
            );
        }
        ...
        private void HandleWidgetPressed(object sender, MessageEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                "Souris pressée dans " + widget.Name + ", bouton " + e.Message.Button.ToString()
            );
        }
        ...
        private void HandleWidgetReleased(object sender, MessageEventArgs e)
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                "Souris relâchée dans " + widget.Name + ", bouton " + e.Message.Button.ToString()
            );
        }
    ...
    public class CustomWidget : Widget
    {
        ...
        protected override void ProcessMessage(Message message, Point pos)
        {
            switch (message.MessageType)
            {
                ...
                case MessageType.KeyPress:
                    System.Diagnostics.Debug.WriteLine(
                        "Key pressed: " + message.KeyChar + " in " + this.Name
                    );
        ...
        {
            System.Diagnostics.Debug.WriteLine(
                "Shortcut pressed: " + shortcut.ToString() + " in " + this.Name
            );
