...
[assembly: Epsitec.Common.Types.DependencyClass(
    typeof(Epsitec.Common.Tests.Widgets.CommandTest.MyCommandTest)
)]
...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class CommandTest
    {
        ...
        public void Initialize()
        {
            ...
            Epsitec.Common.Support.Resources.DefaultManager.ActiveCulture =
        ...
        public void Check0TemporaryCommand()
        {
            ...
            Caption caption2 = Epsitec.Common.Support.Resources.DefaultManager.GetCaption(
                Druid.Parse("[0004]")
            );
            Caption caption3 = Epsitec.Common.Support.Resources.DefaultManager.GetCaption(
                Druid.Parse("[0004]")
            );

            Command command = Command.Get(Druid.Parse("[0005]"));

            Command tempCmd1 = Command.CreateTemporary(
                caption1,
                Epsitec.Common.Support.Resources.DefaultManager
            );
            Command tempCmd2 = Command.CreateTemporary(
                caption2,
                Epsitec.Common.Support.Resources.DefaultManager
            );
        ...
        public class MyCommandTest : DependencyObject
        {
            ...
            {
                get { return (Command)this.GetValue(MyCommandTest.CommandProperty); }
                set { this.SetValue(MyCommandTest.CommandProperty, value); }
            }

            public static readonly DependencyProperty CommandProperty = DependencyProperty.Register(
                "Command",
                typeof(Command),
                typeof(MyCommandTest)
            );
        }
    }
}
