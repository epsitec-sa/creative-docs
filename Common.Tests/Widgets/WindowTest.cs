...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class WindowTest
    {
        ...
        [Test]
        public void CheckFrameCreation()
        {
        ...
        [Test]
        public void CheckMapWindowAndScreen()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckMakeFramelessWindow()
        {
        ...
        [Test]
        public void CheckWindowParentChildRelationship()
        {
        ...
        [Test]
        public void CheckLayeredWindows()
        {
            double zoom = 2.0;
        ...
        public void CheckTabNavigation()
        {
            ...
            text.Text =
                "<b>Group 1:</b> cannot be entered with TAB<br/>"
        ...
        private void Window_MessageFilter(object sender, Message message)
        {
            ...
            System.Diagnostics.Debug.WriteLine(
                string.Format("Window {0}: message={1}", window.Name, message.ToString())
            );
        }
        ...
        private void button_Clicked(object sender, MessageEventArgs e)
        {
            ...
            button.SetManualBounds(
                new Rectangle(
                    button.ActualLocation.X,
                    button.ActualLocation.Y + 5,
                    button.ActualWidth,
                    button.ActualHeight
                )
            );
