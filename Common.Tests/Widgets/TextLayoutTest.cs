...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class TextLayoutTest
    {
        ...
        [Test]
        public void CheckPaintUnderline()
        {
            Window window = new Window();
        ...
        [Test]
        public void CheckAnchorAsStaticText()
        {
            Window window = new Window();
            ...
            text.Text =
                @"abracadabra abracadabra<br/><a href=""x"">abc <img src=""file:images/icon.png"" width=""5"" height=""4""/> def</a><br/>abracadabra abracadabra <a href=""y"">bla bla bla&#160;!</a>";
        ...
        public void CheckJustif()
        {
            ...
            layout.Text =
                "Normal, <b>gras</b>, <i><i>italique</i></i>, <b><i>italique+gras</b></i>, <font face=\"Arial\">arial <font size=\"20\">grand</font></font>, fin";
            layout.DebugDumpJustif(System.Console.Out);

            layout.Text =
                "<font size=\"12\">Premier deuxième troisième quatrième cinquième sixième septième huitième neuvième et dixième.</font>";
            layout.DebugDumpJustif(System.Console.Out);
        ...
        [Test]
        public void CheckTextManipulation()
        {
            TextLayout layout = this.NewTextLayout();

            string reference =
                "Link, Bold text, normal text, italic text...\nAnd some <more> text, \ufffc nice & clean.";
        ...
        [Test]
        public void CheckAnalyzeTagsAtOffset()
        {
            TextLayout layout = this.NewTextLayout();
            string[] tags;
        ...
        [Test]
        public void CheckParseTags()
        {
            TextLayout layout = this.NewTextLayout();
            TextLayout.Tag[] expected_tags = new TextLayout.Tag[]
            {
                TextLayout.Tag.Anchor,
                TextLayout.Tag.AnchorEnd,
                TextLayout.Tag.Bold,
                TextLayout.Tag.BoldEnd,
                TextLayout.Tag.Italic,
                TextLayout.Tag.ItalicEnd,
            ...
            index = 0;
            Assert.AreEqual(
                TextLayout.Tag.SyntaxError,
                TextLayout.ParseTag(text, ref index, out parameters)
            );
        ...
        public void CheckTextWithParamElements()
        {
            ...
            text.Dock = DockStyle.Fill;
            text.Text =
                @"Hello <param code=""X"" value=""10""/> et <param code=""Y"" value=""20""/>...";
            text.SetParent(window.Root);
            window.Show();
            Window.RunInTestEnvironment(window);
        }
        ...
        [Test]
        public void CheckFindIndexFromOffset()
        {
        ...
        [Test]
        public void CheckFindOffsetFromIndex()
        {
            TextLayout text = new TextLayout();
            text.Text = "<b>&lt;x<br/>y&gt;</b>";
        ...
        private void CheckPaint_Paint1(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"Ceci est un <a href=""x"">petit texte <b>ridicule</b></a>, juste pour <font color=""#ff0000"">tester</font> le comportement de la <font size=""20"">classe</font> <font face=""Courier New"">TextLayout</font>, mes premiers pas en &quot;C#&quot;&#160;!<br/>Et voilà une image <img src=""file:images/icon.png""/> simple.";
        ...
        private void CheckPaint_PaintUnderline1(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"On <u>donnait</u> ce jour-là <u>un grand dîner</u>, où, pour la <u>première <b>fois</b></u>, je vis avec beaucoup <u>d'étonnement le maître d'hôtel servir l'épée au côté et le chapeau sur la tête</u>.";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
            layout.DefaultFontSize = 11.0;
            layout.Alignment = ContentAlignment.MiddleLeft;
            layout.JustifMode = TextJustifMode.AllButLast;
        ...
        private void CheckPaint_PaintCourier(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"<font face=""Courier New"">On <u>donnait</u> ce jour-là <u>un grand dîner</u>, où, pour la <u>première <b>fois</b></u>, je vis avec beaucoup <u>d'étonnement le maître d'hôtel servir l'épée au côté et le chapeau sur la tête</u>.</font>";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
            layout.DefaultFontSize = 11.0;
            layout.Alignment = ContentAlignment.MiddleLeft;
            layout.JustifMode = TextJustifMode.AllButLast;
        ...
        private void CheckPaint_PaintWave1(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"On <w>donnait</w> ce jour-là <w color=""#0000FF"">un grand dîner</w>, où, pour la <w>première <b>fois</b></w>, je vis avec beaucoup <w>d'étonnement le maître d'hôtel servir l'épée au côté et le chapeau sur la tête</w>.";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
            layout.DefaultFontSize = 11.0;
            layout.Alignment = ContentAlignment.MiddleLeft;
            layout.JustifMode = TextJustifMode.AllButLast;
        ...
        private void CheckPaint_PaintParam(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"Dimensions: <param code=""H"" value=""200""/> x <param code=""L"" value=""80""/> sous forme de paramètres.";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
            layout.DefaultFontSize = 11.0;
            layout.Alignment = ContentAlignment.MiddleLeft;
            layout.JustifMode = TextJustifMode.AllButLast;
        ...
        private void CheckRectangle_Paint1(object sender, PaintEventArgs e)
        {
            ...
            layout.Text =
                @"Juste <font size=""30"">trois</font> lignes de texte <font size=""10"">(et une image <img src=""file:images/icon.png""/>)</font> pour rigoler !";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
        ...
        private TextLayout NewTextLayout()
        {
            ...
            layout.Text =
                @"<a href=""x"">Link</a>, <b>Bold text</b>, normal text, <i>italic text</i>...<br/>And some &lt;more&gt; text, <img src=""file:images/icon.png""/> nice &amp; clean.";
            layout.DefaultFont = Font.GetFont("Tahoma", "Regular");
            layout.DefaultFontSize = 11.0;
