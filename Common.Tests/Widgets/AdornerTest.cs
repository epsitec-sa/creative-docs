    ...
    public class AdornerTest
    {
        ...
        public void Initialize()
        {
            ...
            DynamicImage image = new DynamicImage(
                new Size(30, 18),
                new DynamicImagePaintCallback(this.DynamicImageXyz)
            );
        ...
        [Test]
        public void CheckAdornerWidgets()
        {
            Window.RunInTestEnvironment(AdornerTest.CreateAdornerWidgets());
        }

        [Test]
        public void CheckAdornerWidgetsDisabled()
        {
        ...
        public static Window CreateAdornerWidgets()
        {
            ...
            fileMenu.Items.Add(
                new MenuItem("open", @"file:images/open.icon", "Ouvrir...", "Ctrl+O")
            );
            fileMenu.Items.Add(new MenuItem("close", "", "Fermer", ""));
            fileMenu.Items.Add(new MenuSeparator());
            fileMenu.Items.Add(
                new MenuItem("save", @"file:images/save.icon", "Enregistrer", "Ctrl+S")
            );
            ...
            editMenu.Items.Add(
                new MenuItem("paste", @"file:images/paste.icon", "Coller", "Ctrl+V")
            );
            editMenu.AdjustSize();
            ...
            tip_widget.PreferredSize = new Size(
                120,
                4 + tip_check1.PreferredHeight + 1 + tip_check2.PreferredHeight + 4
            );
            ...
            multi.Text =
                "Ceci est une petite phrase ridicule.<br/>Mais elle est assez longue pour faire des essais.";
            ...
            text_ex_1.SetManualBounds(
                new Rectangle(10, page3.ActualHeight - 30, 120, text_ex_1.PreferredHeight)
            );
            ...
            text_ex_2.SetManualBounds(
                new Rectangle(10, page3.ActualHeight - 30 - 28, 120, text_ex_2.PreferredHeight)
            );
            text_ex_2.TabIndex = 2;

            TextFieldEx text_ex_3 = new TextFieldEx();
            text_ex_3.SetParent(page3);
            text_ex_3.SetManualBounds(
                new Rectangle(10, page3.ActualHeight - 30 - 28 - 28, 120, text_ex_3.PreferredHeight)
            );
            ...
            text_ex_4.SetManualBounds(
                new Rectangle(
                    10,
                    page3.ActualHeight - 30 - 28 - 28 - 28,
                    120,
                    text_ex_4.PreferredHeight
                )
            );
            ...
            text_ex_5.SetManualBounds(
                new Rectangle(
                    10,
                    page3.ActualHeight - 30 - 28 - 28 - 28 - 28,
                    120,
                    text_ex_5.PreferredHeight
                )
            );
            ...
            text_ex_6.SetManualBounds(
                new Rectangle(10 + 120 + 5, page3.ActualHeight - 30, 120, text_ex_6.PreferredHeight)
            );
            ...
            text_ex_7.SetManualBounds(
                new Rectangle(
                    10 + 120 + 5,
                    page3.ActualHeight - 30 - 28,
                    120,
                    text_ex_7.PreferredHeight
                )
            );
            ...
            text_ex_8.SetManualBounds(
                new Rectangle(
                    10 + 120 + 5,
                    page3.ActualHeight - 30 - 28 - 28,
                    120,
                    text_ex_8.PreferredHeight
                )
            );
            ...
            text_1.SetManualBounds(
                new Rectangle(10, page5.ActualHeight - 30, 120, text_1.PreferredHeight - 4)
            );
            text_1.TabIndex = 1;

            TextField text_2 = new TextField();
            text_2.SetParent(page5);
            text_2.SetManualBounds(
                new Rectangle(10, page5.ActualHeight - 30 - 28, 120, text_2.PreferredHeight - 2)
            );
            text_2.TabIndex = 2;

            TextField text_3 = new TextField();
            text_3.SetParent(page5);
            text_3.SetManualBounds(
                new Rectangle(10, page5.ActualHeight - 30 - 28 - 28, 120, text_3.PreferredHeight)
            );
            text_3.TabIndex = 3;

            TextField text_4 = new TextField();
            text_4.SetParent(page5);
            text_4.SetManualBounds(
                new Rectangle(
                    10,
                    page5.ActualHeight - 30 - 28 - 28 - 28,
                    120,
                    text_4.PreferredHeight + 2
                )
            );
            text_4.TabIndex = 4;
        ...
        private Window CreateBigText()
        {
            ...
            s += "<br/>";
            s +=
                "<b>FIN</b><br/><br/>aaaaaaaaaaaaaaaaaaaaaaaVoici une image <img src=\"file:images/icon.png\"/> intégrée dans le texte.";
#else
        ...
        {
            this.bigText.TextNavigator.SelectionItalic = !this.bigText
                .TextNavigator
                .SelectionItalic;
        }
        ...
        {
            this.bigText.TextNavigator.SelectionUnderline = !this.bigText
                .TextNavigator
                .SelectionUnderline;
        }
        ...
        public void CheckAdornerTab1()
        {
            ...
            multi.Text =
                "1. Introduction<br/><br/>Les onglets permettent de mettre beaucoup de widgets sur une petite surface, ce qui s'avère extrèmement utile et diablement pratique.<br/><br/>2. Conclusion<br/><br/>Un truc chouette, qui sera certainement très utile dans le nouveau Crésus !";
            multi.Anchor = AnchorStyles.All;
            ...
            scrollv.SetManualBounds(
                new Rectangle(
                    10,
                    10,
                    17,
                    tb.Client.Bounds.Height - tb.GetInternalPadding().Height - 20
                )
            );
            scrollv.MaxValue = 10;
            scrollv.VisibleRangeRatio = 0.3M;
        ...
        public void CheckAdornerCell1()
        {
            ...
            for (int y = 0; y < 12; y++)
            {
                for (int x = 0; x < 5; x++)
                {
                    ...
                    if (x != 0 || y != 0)
                        text.Text = string.Format("{0}.{1}", y + 1, x + 1);
        ...
        [Test]
        public void CheckAdornerScrollArray()
        {
            Window window = new Window();
        ...
        public static void CreateListLook(
            Widget parent,
            double mx,
            double my,
            ToolTip tooltip,
        ...
        [Test]
        public void CheckAdornerPaneBook1()
        {
            Window window = new Window();
            ...
            button1.SetManualBounds(
                new Rectangle(10, 10, p1.PreferredWidth - 20, p1.PreferredHeight - 20)
            );
            ...
            button4.SetManualBounds(
                new Rectangle(10, 10, p4.PreferredWidth - 20, p4.PreferredHeight - 20)
            );
            ...
            buttonv1.SetManualBounds(
                new Rectangle(10, 10, v1.PreferredWidth - 20, v1.PreferredHeight - 20)
            );
            ...
            buttonv2.SetManualBounds(
                new Rectangle(10, 10, v2.PreferredWidth - 20, v2.PreferredHeight - 20)
            );
        ...
        [Test]
        public void CheckAdornerPaneBook2()
        {
            Window window = new Window();
            ...
            button2.SetManualBounds(
                new Rectangle(10, 10, p2.PreferredWidth - 20, p2.PreferredHeight - 20)
            );
        ...
        [Test]
        public void CheckAdornerPaneBook3()
        {
            Window window = new Window();
