...
namespace Epsitec.Common.Tests.Widgets
{
    ...
    public class FicheTest
    {
        ...
        protected void CreateLayout()
        {
            ...
            fileMenu.Items.Add(
                new MenuItem("open", @"file:images/open.png", "Ouvrir...", "Ctrl+O")
            );
            fileMenu.Items.Add(new MenuItem("close", "", "Fermer", ""));
            fileMenu.Items.Add(new MenuSeparator());
            fileMenu.Items.Add(
                new MenuItem("save", @"file:images/save.png", "Enregistrer", "Ctrl+S")
            );
            fileMenu.Items.Add(new MenuItem("saveas", "", "Enregistrer sous...", ""));
            fileMenu.Items.Add(new MenuSeparator());
            fileMenu.Items.Add(
                new MenuItem("print", @"file:images/print.png", "Imprimer...", "Ctrl+P")
            );
            fileMenu.Items.Add(
                new MenuItem("preview", @"file:images/preview.png", "Apercu avant impression", "")
            );
            ...
            helpMenu.Items.Add(
                new MenuItem("ctxhelp", @"file:images/help.png", "Aide contextuelle", "")
            );
        ...
        {
            if ((this.leftPane == null) || (this.topPane == null))
            {
                return;
            }
        ...
        protected void ResizeLayout()
        {
            ...
            this.title.SetManualBounds(
                new Rectangle(10, this.topPane.ActualHeight - 50, this.topPane.ActualWidth, 50)
            );
            this.editCrit.SetManualBounds(
                new Rectangle(
                    10,
                    this.topPane.ActualHeight - 50 - this.buttonHeight,
                    this.topPane.ActualWidth - this.buttonWidth - 30,
                    this.buttonHeight
                )
            );
            this.buttonSearch.SetManualBounds(
                new Rectangle(
                    this.topPane.ActualWidth - this.buttonWidth - 10,
                    this.topPane.ActualHeight - 50 - this.buttonHeight,
                    this.buttonWidth,
                    this.buttonHeight
                )
            );
            this.listCrit.SetManualBounds(
                new Rectangle(
                    10,
                    this.topPane.ActualHeight - 50 - this.buttonHeight - 10 - this.listCritHeight,
                    200,
                    this.listCritHeight
                )
            );
            this.listLook.SetManualBounds(
                new Rectangle(
                    220,
                    this.topPane.ActualHeight - 50 - this.buttonHeight - 10 - this.listCritHeight,
                    100,
            ...
            this.table.SetManualBounds(
                new Rectangle(
                    10,
                    10,
                    this.bottomPane.ActualWidth - 20,
                    this.bottomPane.ActualHeight - 20
                )
            );
            ...
            this.buttonCreate.SetManualBounds(
                new Rectangle(posx, posy, this.buttonWidth, this.buttonHeight)
            );
            posx += this.buttonWidth + 10;
            this.buttonDuplicate.SetManualBounds(
                new Rectangle(posx, posy, this.buttonWidth, this.buttonHeight)
            );
            posx += this.buttonWidth + 10;
            this.buttonDelete.SetManualBounds(
                new Rectangle(posx, posy, this.buttonWidth, this.buttonHeight)
            );
            ...
            this.buttonValidate.SetManualBounds(
                new Rectangle(posx, posy, this.buttonWidth, this.buttonHeight)
            );

            posx += this.buttonWidth + 10;
            this.buttonCancel.SetManualBounds(
                new Rectangle(posx, posy, this.buttonWidth, this.buttonHeight)
            );
        }
