...
[assembly: EntityClass(
    "[70062]",
    typeof(Epsitec.Common.Tests.Support.EntityTest.MyEnumValueEntity)
)]
[assembly: EntityClass(
    "[7013]",
    typeof(Epsitec.Common.Tests.Support.EntityTest.MyTestInterfaceUserEntity)
)]
[assembly: EntityClass(
    "[7007]",
    typeof(Epsitec.Common.Tests.Support.EntityTest.MyResourceStringEntity)
)]
[assembly: EntityClass(
    "[700G]",
    typeof(Epsitec.Common.Tests.Support.EntityTest.MyResourceCommandEntity)
)]
...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class EntityTest
    {
        ...
        public void CheckBasicAccess1()
        {
            ...
            Assert.AreEqual(
                null,
                entity.GetField<string>(
                    Epsitec.Common.Support.Res.Fields.ResourceBase.Comment.ToString()
                )
            );
        ...
        public void CheckBasicAccess3()
        {
            ...
            list1 = entity.GetFieldCollection<MyEnumValueEntity>(
                Epsitec.Common.Support.Res.Fields.ResourceEnumType.Values.ToString()
            );
            ...
            list1.Add(new MyEnumValueEntity());
            list2 = entity.GetFieldCollection<MyEnumValueEntity>(
                Epsitec.Common.Support.Res.Fields.ResourceEnumType.Values.ToString()
            );
            ...
            (
                (IEntityCollection)
                    entity.InternalGetFieldCollection(
                        Epsitec.Common.Support.Res.Fields.ResourceEnumType.Values.ToString()
                    )
            ).CopyOnWrite();

            list3 = entity.InternalGetFieldCollection(
                Epsitec.Common.Support.Res.Fields.ResourceEnumType.Values.ToString()
            );
        ...
        public void CheckBasicAccessEx1()
        {
            ...
            list0 =
                entity.InternalGetValue(
                    Epsitec.Common.Support.Res.Fields.ResourceEnumType.Values.ToString()
                ) as IList<MyEnumValueEntity>;
        ...
        public void CheckCollections1()
        {
            ...
            Assert.AreEqual(
                typeof(EntityCollection<MyShortcutEntity>),
                cmd2.InternalGetFieldCollection("[700O]").GetType()
            );
            Assert.AreEqual(
                typeof(EntityCollection<AbstractEntity>),
                cmd3.GetFieldCollection<AbstractEntity>("[700O]").GetType()
            );

            Assert.AreEqual(typeof(EntityCollection<MyShortcutEntity>), cmd1.Shortcuts.GetType());
            Assert.AreEqual(typeof(EntityCollection<MyShortcutEntity>), cmd2.Shortcuts.GetType());
            Assert.AreEqual(
                typeof(EntityCollectionProxy<MyShortcutEntity>),
                cmd3.Shortcuts.GetType()
            );

            Assert.AreEqual(
                typeof(EntityCollection<MyShortcutEntity>),
                cmd1.InternalGetFieldCollection("[700O]").GetType()
            );
            Assert.AreEqual(
                typeof(EntityCollection<MyShortcutEntity>),
                cmd2.InternalGetFieldCollection("[700O]").GetType()
            ...
            Assert.AreEqual(
                typeof(EntityCollection<AbstractEntity>),
                cmd3.InternalGetFieldCollection("[700O]").GetType()
            );

            Assert.AreEqual(
                typeof(EntityCollectionProxy<AbstractEntity>),
                cmd1.GetFieldCollection<AbstractEntity>("[700O]").GetType()
            );
            Assert.AreEqual(
                typeof(EntityCollectionProxy<AbstractEntity>),
                cmd2.GetFieldCollection<AbstractEntity>("[700O]").GetType()
            );
            Assert.AreEqual(
                typeof(EntityCollection<AbstractEntity>),
                cmd3.GetFieldCollection<AbstractEntity>("[700O]").GetType()
        ...
        public void CheckCreation()
        {
            ...
            entity = context.CreateEmptyEntity(
                Epsitec.Common.Support.Res.Types.ResourceEnumType.CaptionId
            );
        ...
        public void CheckIStructuredData()
        {
            ...
            System.Console.Out.WriteLine(
                "SetValue : {1} us ({0} calls)",
                n,
                watch.ElapsedMilliseconds * 100 * 1000 / n / 100.0M
            );
        ...
        class TestProxy : IEntityProxy
        {
            ...
            {
                get { return this.readCounter; }
            }

            public int WriteCounter
            {
                get { return this.writeCounter; }
            }

            public int DiscardCounter
            {
                get { return this.discardCounter; }
            }
        ...
        internal class MyResourceCommandEntity : AbstractEntity
        {
            ...
            {
                get { return this.GetFieldCollection<MyShortcutEntity>("[700O]"); }
            }
        }
