...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class WordBreakTest
    {
        ...
        public void CheckWordBreak()
        {
            ...
            {
                Assert.Fail(
                    string.Format("{0} errors listed in Console.Error !", this.errorCounter)
                );
            }
            else
            {
        ...
        protected void CheckWord(string word)
        {
            ...
            List<int> result = new List<int>(
                Common.Text.BreakEngines.FrenchWordBreakEngine.Break(brut)
            );
            ...
            if (!WordBreakTest.AreEqual(hope, result)) // résultat incorrect ?
            {
                ...
                System.Console.Error.WriteLine(
                    string.Format("Correct: {0}   Result: {1}", word, wrong)
                );
        ...
        protected static bool AreEqual(List<int> list1, List<int> list2)
        {
        ...
        protected static void RemoveSeparators(
            string wordWithSep,
            out string wordWithout,
            out List<int> list
        )
        {
        ...
        protected static string AddSeparators(string wordWithout, List<int> list)
        {
