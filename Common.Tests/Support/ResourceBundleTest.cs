...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class ResourceBundleTest
    {
        ...
        public void CheckCompile()
        {
            ...
            string test_string =
                "<bundle type='String'><data name='a'>A</data><data name='b'>B</data></bundle>";
        ...
        public void CheckCompileRefBundle()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='a'>A</data><bundle name='b'><ref target='file:button.cancel'/></bundle></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCompileSubBundle()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='a'>A0</data><bundle name='b'><data name='a'>A1</data><data name='b'>B1</data></bundle></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCompileCDATA()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='text'><![CDATA[Small <b>text</b> to <i>check</i> if CDATA&lt;..&gt; works.]]></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
            ...
            Assert.AreEqual(
                "Small <b>text</b> to <i>check</i> if CDATA&lt;..&gt; works.",
                bundle["text"].AsString
            );
        }
        ...
        public void CheckCompileEmbeddedXml()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='text'><xml>Small <b>text</b> to <i>check</i> if embedded &lt;xml&gt; works.</xml></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
            ...
            Assert.AreEqual("text", names[0]);
            Assert.AreEqual(
                "Small <b>text</b> to <i>check</i> if embedded &lt;xml&gt; works.",
                bundle["text"].AsString
            );
        }
        ...
        public void CheckCompileAndMerge()
        {
            ...
            string test_string_1 =
                "<bundle><data name='a'>A</data><data name='b'>B</data></bundle>";
            string test_string_2 =
                "<bundle><data name='a'>X</data><data name='c'>C</data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
        ...
        public void CheckCompileEx3()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<invalid_root><data name='a'>A</data><data name='b'>B</data></invalid_root>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            Assert.Throws<ResourceException>(() => bundle.Compile(test_data));
        }
        ...
        public void CheckCompileRefLevel1()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                @"<bundle><data name=""aaa"">A</data><ref target=""file:button.cancel""/></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCompileRefLevel2()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='a'>A</data><data name='b'><ref target='file:strings#label.Hello'/></data><data name='c'><ref target='file:strings#title.MainWindow'/></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
            ...
            System.Console.Out.WriteLine(
                "Referenced field 'b' contains '{0}'.",
                bundle["b"].AsString
            );
            System.Console.Out.WriteLine(
                "Referenced field 'c' contains '{0}'.",
                bundle["c"].AsString
            );
        }
        ...
        public void CheckCompileRefLevel2AutoPrefix()
        {
            ...
            string test_string =
                "<bundle><data name='a'>A</data><data name='b'><ref target='button.cancel#Text'/></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCompileRefEx2()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='a'>A</data><data name='b'><ref target='file:does-not-exist#Text'/></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCompileRefEx3()
        {
            ResourceBundle bundle = ResourceBundle.Create(Resources.DefaultManager, "test");
            string test_string =
                "<bundle><data name='a'>A</data><data name='b'><ref target='file:button.cancel#does-not-exist'/></data></bundle>";
            System.Text.UTF8Encoding encoding = new System.Text.UTF8Encoding();
            byte[] test_data = encoding.GetBytes(test_string);
            bundle.Compile(test_data);
        ...
        public void CheckCreateXmlNode1()
        {
            ...
            Assert.IsTrue(
                ResourceBundleTest.XmlTestEqual(test_data, live_data),
                "Serialized data not equal to source data"
            );
        }
        ...
        static void XmlDumpIfDifferent(byte[] a, byte[] b, ResourceBundle bundle)
        {
            ...
            if (ResourceBundleTest.XmlTestEqual(a, b) == false)
            {
                ...
                System.Console.Out.WriteLine();
                System.Console.Out.WriteLine(
                    "Bundle original XML source uses {0} bytes:",
                    a.Length
                );
                ResourceBundleTest.XmlDumpData(a);
                System.Console.Out.WriteLine(
                    "Bundle produced XML source uses {0} bytes:",
                    b.Length
                );
