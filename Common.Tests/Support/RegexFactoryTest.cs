...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class RegexFactoryTest
    {
        ...
        public void CheckFromSimpleJoker3()
        {
            ...
            Regex r5 = RegexFactory.FromSimpleJoker(
                "x\\*\\.\\\\x\\?x",
                RegexFactory.Options.Capture
            );
        ...
        {
            Regex r1 = RegexFactory.FromSimpleJoker(
                "*.jpg|*.bmp|*.tiff",
                RegexFactory.Options.Capture | RegexFactory.Options.IgnoreCase
            );
