...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class DynamicCodeTest
    {
        ...
        public void CheckAllocators()
        {
            ...
            Allocator<Dummy, string> allocator2 = DynamicCodeFactory.CreateAllocator<
                Dummy,
                string
            >();
        ...
        {
            PropertyComparer nameComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Dummy),
                "Name"
            );
            ...
            System.Console.Out.WriteLine(
                "{0} dynamic property CompareTo take {1} ms",
                count,
            ...
            System.Console.Out.WriteLine(
                "{0} optimal property CompareTo take {1} ms",
                count,
                watch.ElapsedMilliseconds
            );
            ...
            System.Console.Out.WriteLine(
                "{0} Comparer-based property CompareTo take {1} ms",
                count,
                watch.ElapsedMilliseconds
            );
        }
        ...
        {
            PropertyComparer ageComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Dummy),
                "Age"
            );
            PropertyComparer dateComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Dummy),
                "Date"
            );
            PropertyComparer valueComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Dummy),
                "Value"
            );
        ...
        {
            PropertyGetter articleGetter = DynamicCodeFactory.CreatePropertyGetter(
                typeof(Record),
                "Article"
            );
            PropertyComparer articleComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Record),
                "Article"
            );
            PropertyComparer stockComparer = DynamicCodeFactory.CreatePropertyComparer(
                typeof(Record),
                "Stock"
            );
        ...
        public void CheckValueTypePropertyAccessEx1()
        {
            ...
            {
                PropertySetter articleSetter = DynamicCodeFactory.CreatePropertySetter(
                    typeof(Record),
                    "Article"
                );
            });
        ...
        {
            PropertyGetter nameGetter = DynamicCodeFactory.CreatePropertyGetter(
                typeof(Dummy),
                "Name"
            );
            PropertyGetter ageGetter = DynamicCodeFactory.CreatePropertyGetter(
                typeof(Dummy),
                "Age"
            );
            PropertyGetter dateGetter = DynamicCodeFactory.CreatePropertyGetter(
                typeof(Dummy),
                "Date"
            );
            ...
            for (int i = 0; i < count; i++)
            {
                if ((dummy.Name == "Bill") && (dummy.Age == 50) && (dummy.Date == date))
                {
                    ok++;
                }
            }
        ...
        {
            PropertySetter nameSetter = DynamicCodeFactory.CreatePropertySetter(
                typeof(Dummy),
                "Name"
            );
            PropertySetter ageSetter = DynamicCodeFactory.CreatePropertySetter(
                typeof(Dummy),
                "Age"
            );
            PropertySetter dateSetter = DynamicCodeFactory.CreatePropertySetter(
                typeof(Dummy),
                "Date"
            );
