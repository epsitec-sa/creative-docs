...
namespace Epsitec.Common.Tests.Support
{
    ...
    public class ResourcesTest
    {
        ...
        [Test]
        public void CheckDebugDumpProviders()
        {
            System.Diagnostics.Debug.WriteLine(
                string.Format("Found {0} providers.", Resources.DefaultManager.ProviderCount)
            );
            Resources.DefaultManager.DebugDumpProviders();
        }

        [Test]
        public void CheckValidateAndDumpResults()
        {
            ...
            foreach (string prefix in prefixes)
            {
                ...
                foreach (string name in names)
                {
                    System.Console.Out.WriteLine(
                        " '{0}' is {1}",
                        name,
                        Resources.DefaultManager.ValidateId(prefix + ":" + name)
                            ? "valid"
                            : "not valid"
                    );
                }
        ...
        [Test]
        public void CheckValidateFile()
        {
            string[] good_names = new string[]
            {
                "123",
                "@123",
                "ABC-123",
            ...
            {
                Assert.IsTrue(
                    Resources.DefaultManager.ValidateId("file:" + name),
                    string.Format("{0} should be accepted", name)
                );
            }
            ...
            foreach (string name in bad_names)
            {
                Assert.IsTrue(
                    !Resources.DefaultManager.ValidateId("file:" + name),
                    string.Format("{0} should be rejected", name)
                );
            }
        }

        [Test]
        public void CheckFileContains()
        {
        ...
        [Test]
        public void CheckFileGetBundle()
        {
        ...
        [Test]
        public void CheckGetBundleRecursive()
        {
        ...
        [Test]
        public void CheckGetComplexBundle()
        {
            ResourceBundle bundle;
        ...
        {
            string text_default = Resources.DefaultManager.GetText(
            ...
            string text_miss_2 = Resources.DefaultManager.GetText(
                "file:does_not_exist#DoesNotExist"
            );
        ...
        [Test]
        public void CheckGetBundleIds()
        {
            string[] names_1 = Resources.DefaultManager.GetBundleIds("file:*");
            string[] names_2 = Resources.DefaultManager.GetBundleIds(
                "file:*",
                ResourceLevel.Localized
            );
            string[] names_3 = Resources.DefaultManager.GetBundleIds(
                "file:*",
                "String",
                ResourceLevel.Localized
            );
            string[] names_4 = Resources.DefaultManager.GetBundleIds(
                "file:strings",
                ResourceLevel.All
            );
