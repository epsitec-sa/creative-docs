...
{
    [TestFixture]
    public class OpletTest
    {
        [Test]
        public void CheckInsertUndoRedo()
        {
        ...
        [Test]
        public void CheckInsertUndoRedoEmpty()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckPurgeSingleUndo()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckMergeLastActions()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckDisableUndoRedo()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx1()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx2()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx3()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx4()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx5()
        {
            OpletQueue queue = new OpletQueue();
        ...
        [Test]
        public void CheckInsertUndoRedoEx6()
        {
            OpletQueue queue = new OpletQueue();
