...
namespace Epsitec.Common.Tests.Support
{
    ...
    {
        [Test]
        public void CheckCheckForDuplicates1()
        {
        ...
        [Test]
        public void CheckCheckForDuplicates2()
        {
        ...
        [Test]
        public void CheckCheckForDuplicates3()
        {
        ...
        class SpecialData
        {
            ...
            public static System.Collections.IComparer NumComparer
            {
                get { return new SpecialCompare1(); }
            }
            public static System.Collections.IComparer TextComparer
            {
                get { return new SpecialCompare2(); }
            }
        ...
        [Test]
        public void CheckStringSimplify()
        {
            string s1 = @"'xyz'";
            string s2 = @"'ab''cd'";
            string s3 = @"'abcd'''";
        ...
        [Test]
        public void CheckTextToXmlBreak()
        {
            Assert.AreEqual(
                "&lt;#&apos;&quot;&gt;\u00A0\u2014x<br/>",
                Utilities.TextToXmlBreak("<#'\">\u00A0\u2014x\n")
            );
        }

        [Test]
        public void CheckXmlBreakToText()
        {
            Assert.AreEqual(
                "<#'\">\u00A0\u2014x\n",
