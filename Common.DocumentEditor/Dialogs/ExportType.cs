...
namespace Epsitec.Common.DocumentEditor.Dialogs
{
    ...
    {
        public ExportType(DocumentEditor editor)
            : base(editor)
        {
        ...
        public override void Show()
        {
            ...
            if (this.window == null)
            {
                ...
                for (int i = 0; i < this.extensions.Count; i++)
                {
                    ...
                    radio.Text = string.Format(
                        Res.Strings.Dialog.Export.FormatDescription,
                        this.formatDescriptions[i],
                        this.shortDescriptions[i]
                    );
        ...
        protected void UpdateRadio()
        {
            if (this.radioButtons != null)
            {
                ...
                for (int i = 0; i < this.radioButtons.Count; i++)
                {
                    ...
                    radio.ActiveState =
                        (radio.Name == this.fileType) ? ActiveState.Yes : ActiveState.No;
                }
        ...
        protected void UpdateDescription()
        {
            if (this.fullDescription != null)
            {
                ...
                {
                    this.fullDescription.Text = string.Concat(
                        "<b><font size=\"140%\">",
                        this.formatDescriptions[i],
                        "</font></b><br/>",
                        this.longDescriptions[i]
                    );
                }
            }
        }
