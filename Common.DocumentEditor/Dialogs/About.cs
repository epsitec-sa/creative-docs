...
namespace Epsitec.Common.DocumentEditor.Dialogs
{
    ...
    {
        public About(DocumentEditor editor)
            : base(editor) { }
        ...
        public override void Show()
        {
            ...
            if (this.window == null)
            {
                ...
                www.Text = string.Format(
                    "<a href=\"{0}\">{1}</a><br/>",
                    Res.Strings.Dialog.About.Link,
                    Res.Strings.Dialog.About.Web
                );
        ...
        public static StaticText CreateWidgetSplash(
            Widget parent,
            InstallType type,
        ...
        )
        {
            ...
            if (type == InstallType.Freeware)
            {
                ...
                sv.Text = string.Format(
                    "<font size=\"80%\"><font size=\"140%\"><b>{0} {1}</b></font>    {2}</font>",
                    Res.Strings.Dialog.About.Version,
                    version,
                    Res.Strings.Dialog.About.Language
                );
            ...
            else
            {
                ...
                if (sk != null)
                {
                    ...
                    key.Text = string.Format(
                        @"<font size=""80%"">{0}: {1}</font>",
                        Res.Strings.Dialog.About.Key,
                        sk
                    );
            ...
            if (type == InstallType.Demo)
            {
                ...
                warning.Text =
                    "<font size=\"250%\"><b>" + Res.Strings.Dialog.About.Demo + "</b></font>";
            ...
            if (type == InstallType.Expired)
            {
                StaticText warning = new StaticText(parent);
                warning.Text =
                    "<font size=\"250%\"><b>" + Res.Strings.Dialog.About.Expired + "</b></font>";
                warning.SetManualBounds(new Rectangle(280, y, 84, 40));
            }
            ...
            if (type == InstallType.Freeware)
            {
                StaticText warning = new StaticText(parent);
                warning.Text =
                    "<font size=\"180%\"><b>" + Res.Strings.Dialog.About.Freeware + "</b></font>";
