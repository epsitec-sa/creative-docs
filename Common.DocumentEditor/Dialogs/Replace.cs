...
namespace Epsitec.Common.DocumentEditor.Dialogs
{
    ...
    {
        public Replace(DocumentEditor editor)
            : base(editor) { }
        ...
        protected void UpdateWidgets()
        {
            ...
            this.SetActiveState(
                this.checkEqualAccent,
                (this.mode & Misc.StringSearch.IgnoreAccent) == 0
            );
            this.SetActiveState(
                this.checkWholeWord,
                (this.mode & Misc.StringSearch.WholeWord) != 0
            );
        ...
        protected void ReadWidgets()
        {
            ...
            if (!this.GetActiveState(this.checkEqualMaj))
                mode |= Misc.StringSearch.IgnoreMaj;
            if (!this.GetActiveState(this.checkEqualAccent))
                mode |= Misc.StringSearch.IgnoreAccent;
            if (this.GetActiveState(this.checkWholeWord))
                mode |= Misc.StringSearch.WholeWord;
            if (this.GetActiveState(this.radioReverse))
        ...
        protected Misc.StringSearch mode =
            Misc.StringSearch.IgnoreMaj | Misc.StringSearch.IgnoreAccent;
    }
}
